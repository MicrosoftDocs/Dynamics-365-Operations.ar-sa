...
## <a name="features-that-have-been-deprecated-in-dynamics-365-for-finance-and-operations-enterprise-edition-july-2017-with-platform-update-8"></a>الميزات التي تم إهمالها في Dynamics 365 for Finance and Operations, Enterprise Edition (يوليو 2017) مع التحديث 8 للنظام الأساسي
...
| **هل تم الاستبدال بميزة أخرى؟** | نعم. تم استبدال هذه الميزة بواسطة Finance and Operations - التخزين. للحصول على مزيد من المعلومات حول الإعداد والمتطلبات الأساسية، راجع [تثبيت وتكوين Microsoft Dynamics 365 for Finance and Operations - التخزين](../../supply-chain/warehousing/install-configure-warehousing-app.md). |
...
## <a name="features-that-have-been-deprecated-in-dynamics-ax-70-releases"></a>الميزات التي تم إهمالها في إصدارات Dynamics AX 7.0
