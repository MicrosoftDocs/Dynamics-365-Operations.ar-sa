...
## <a name="dynamics-365-for-finance-and-operations-81-with-platform-update-20"></a>Dynamics 365 for Finance and Operations، الإصدار 8.1 مع تحديث النظام الأساسي 20
...
وضع التحويل المتزامن مهمل حاليًا في ‏‫معلمات دفتر الأستاذ العام‬.  يتم استبدال هذا الوضع بدفعة غير متزامنة ومجدولة فقط، وتوجد هذه الدفعة بالفعل كخيارات للتحويل. 
...
| **خيارات النشر**              | ‏‏الكل  |
| **الحالة**                         | مهمل - هو الإطار الزمني الهدف للوظيفة المطلوب إزالتها هو إصدار 10.0.|
...
| **خيارات النشر**              | ‏‏الكل |
| **الحالة**                         | تمت الإزالة اعتبارًا من الإصدار Dynamics 365 for Finance and Operations، الإصدار 8.1 مع تحديث النظام الأساسي 20. |
...
|   |  |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | الميزة غير متوافقة مع طراز قابلية توسعة Dynamics 365 for Finance and Operations. |
...
|   |  |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | بالتغيير إلى عميل يستند إلى ويب، فمن الممكن توفير وظيفة مشابهة من خلال عميل Dynamics AX 7.0 الأصلي. يوفر جهاز بطاقة الوظيفة واجهة مستخدم طابق الإنتاج المحسنة للأجهزة التي تعمل باللمس والأجهزة اللوحية من العوامل. |
| **هل تم الاستبدال بميزة أخرى؟**   | نعم. جهاز بطاقة الوظيفة، الذي يمثل جزءًا أصيلًا من Dynamics AX 7.0.                                                                           |
