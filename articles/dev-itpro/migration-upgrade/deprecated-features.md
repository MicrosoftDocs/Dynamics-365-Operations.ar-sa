...
|   |  |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | في الإصدارات التي تسبق Platform update 25، كان من الممكن إنشاء فئة أو جدول يشتق من فئة داخلية/جدول داخلي محدد في وحدة/حزمة أخرى. لا يعتبر هذا الأمر طريقة آمنة لكتابة التعليمات البرمجية. اعتبارًا من Platform update 25، سيعرض المحول البرمجي رسالة تحذير إذا حاولت القيام بذلك.|
| **هل تم الاستبدال بميزة أخرى؟**   | سيتم استبدال تحذير المحول البرمجي بخطأ في تحديث قادم للنظام الأساسي. يتوافق هذا التغيير مع الإصدارات السابقة في وقت التشغيل، مما يعني أنك إذا كنت تقوم بتشغيل Platform update 25 أو إصدار لاحق، يمكنك نشر هذا التغيير على أي بيئة وضع حماية أو بيئة إنتاج من دون الحاجة إلى تعديل التعليمات البرمجية المخصصة. يؤثر هذا التغيير فقط على وقت التطوير والتحويل البرمجي. |
| **مناطق المنتجات المتأثرة**         | أدوات تطوير Visual Studio. |
| **خيارات النشر**              | الكل |
| **الحالة**                         | مهملة - سيتحوّل التحذير إلى خطأ تحويل برمجي في تحديث قادم للنظام الأساسي. |

#### <a name="overriding-internal-methods-is-deprecated"></a>تم إهمال تجاوز الأساليب الداخلية

|   |  |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | في الإصدارات التي تسبق Platform update 25، كان من الممكن تجاوز أسلوب داخلي في فئة مشتقة محددة في وحدة/حزمة أخرى. لا يعتبر هذا الأمر طريقة آمنة لكتابة التعليمات البرمجية. اعتبارًا من Platform update 25، سيعرض المحول البرمجي رسالة تحذير إذا حاولت القيام بذلك.|
| **هل تم الاستبدال بميزة أخرى؟**   | سيتم استبدال هذا التحذير بخطأ تحويل برمجي في تحديث قادم للنظام الأساسي. يتوافق هذا التغيير مع الإصدارات السابقة في وقت التشغيل، مما يعني أنك إذا كنت تقوم بتشغيل Platform update 25 أو إصدار لاحق، يمكنك نشر هذا التغيير على أي بيئة وضع حماية أو بيئة إنتاج من دون الحاجة إلى تعديل التعليمات البرمجية المخصصة. يؤثر هذا التغيير فقط على وقت التطوير والتحويل البرمجي. |
| **مناطق المنتجات المتأثرة**         | أدوات تطوير Visual Studio. |
| **خيارات النشر**              | الكل |
| **الحالة**                         | مهملة - سيتحوّل التحذير إلى خطأ تحويل برمجي في تحديث قادم للنظام الأساسي. |
...
### <a name="print-to-screen-functionality"></a>وظيفة الطباعة إلى الشاشة
بإمكان المستخدمين استخدام إجراء **الاستيراد** الذي يوفره عنصر تحكم "عارض التقرير" لتنزيل المستندات التي أنشأتها تطبيقات Finance and Operations. يقدم هذا العرض القائم على HTML للمستخدمين معاينة غير مفصولة الصفحات للمستند.

|   |  |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | **لا** تقدم الطبيعة غير مفصولة الصفحات لتجربة المعاينة القائمة على HTML الدقة مع المستندات الفعلية المُنشأة بشكل أساسي بواسطة Finance and Operations. من خلال اعتماد PDF بشكل كامل كتنسيق قياسي للعمليات التجارية، يمكننا تبسيط خيارات المستخدم بشكل ملحوظ فيما يتعلق بالتفاعل مع تقارير التطبيقات وتسهيل عملية عرض المستند. |
...
| **مناطق المنتجات المتأثرة**         | أدوات تطوير Visual Studio. |
| **خيارات النشر**              | الكل. |
| **الحالة**                         | مهمل - سيتحوّل التحذير إلى خطأ في وقت التحويل البرمجي في المستقبل. نحن نستهدف حاليًا Platform update 30. |
...
| **هل تم الاستبدال بميزة أخرى؟**   | نعم. تم استبدال هذه الميزة بواسطة Finance and Operations - التخزين. لمزيد من المعلومات حول الإعداد والمتطلبات الأساسية، راجع [تثبيت وتكوين Microsoft Dynamics 365 for Finance and Operations - التخزين](https://docs.microsoft.com/en-us/dynamics365/unified-operations/supply-chain/warehousing/install-configure-warehousing-app). |
