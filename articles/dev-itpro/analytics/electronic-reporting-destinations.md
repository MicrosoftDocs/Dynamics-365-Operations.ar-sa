...
> [!NOTE]
> يجب أن يكون خادم البروتوكول البسيط لنقل رسائل البريد (SMTP) مكونًا ومتوفرًا. يمكنك تحديد خادم SMTP في Finance and Operations في **إدارة النظام** &gt; **إعداد** &gt; **البريد الإلكتروني** &gt; **معلمات البريد الإلكتروني**.
...
> [!NOTE]
> يمكنك تحديد نوع مستند لأرشيف الوظيفة في Finance and Operations، في **إدارة المؤسسة** &gt; **مساحات العمل** &gt; **التقارير الإلكترونية** &gt; **معلمات التقارير الإلكترونية**.
