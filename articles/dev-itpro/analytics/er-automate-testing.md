...
---
# <a name="automate-testing-with-electronic-reporting"></a>أتمته الاختبار باستخدام التقارير الإلكترونية

[!include[banner](../includes/banner.md)]

يشرح هذا الموضوع كيفية استخدام الميزة الأساسية في إطار عمل التقارير الإلكترونية (ER) لأتمتة اختبار الوظائف في Microsoft Dynamics 365 for Finance and Operations. يوضح المثال الموجود في هذا الموضوع كيفية تنفيذ اختبار معالجة دفع المورد تلقائيًا.

يستخدم تطبيق Finance and Operations إطار عمل ER لإنشاء ملفات الدفع والمستندات المقابلة أثناء معالجة دفع المورد. يتألف إطار عمل ER من نموذج بيانات وتعيينات نماذج ومكونات تنسيق تدعم معالجة الدفع لأنواع دفع مختلفة وإنشاء المستندات بتنسيقات مختلفة. يمكن تنزيل هذه المكونات من Microsoft DynamicsLifecycle Services (LCS) واستيرادها إلى مثيل Finance and Operations.
...
يمكنك استخدام تنسيقات ER المخصصة في مثيل Finance and Operations لمعالجه ملفات الدفع التي تقوم بإنشاء مدفوعات المورد وكذلك لمعالجة تقارير التحكم. يتم دعم تعيين الإصدار لمكونات التقارير الإلكترونية ER. بالتالي، يمكن أن توفر Microsoft إصدارات محدثة لحلول ER الخاصة بمعالجة دفع المورد، ويمكنك دمج الإصدار المحدث تلقائيا مع المكون المخصص عن طريق إعادة تعيين الأساس له. ومع ذلك، يجب عليك اختبار الإصدار الذي تمت إعادة تعيين الأساس له للتأكد من أنه يعمل كما هو متوقع.

تعتبر نماذج البيانات الخاصة بـ ER وتعيينات نماذج ER شائعه للعديد من تنسيقات ER المستخدمة لمعالجة المدفوعات الخاصة بأنواع مختلفة ولإنشاء مستندات الدفع الخاصة بالبلد/المنطقة. التالي، فإنه من المستحسن أتمتة قبول المستخدم واختبار التكامل لكي يتم تنفيذه تلقائيا في العديد من شركات Finance and Operations ولكن مع اعتبار سياق البلد/المنطقة لكل شركة مستهدفة واستخدام مجموعات بيانات مختلفة وهكذا.
...
- استخدم مسجل المهام لتسجيل حالات الاختبار، وتضمين التقييم الأساسي. لمزيد من المعلومات، راجع [مسجل المهام](../user-interface/task-recorder.md).
- تجميع حالات الاختبار لسيناريوهات الاختبار المطلوبة. لمزيد من المعلومات ، راجع [إنشاء مكتبات اختبار قبول المستخدم باستخدام تسجيلات المهام وBPM.](../lifecycle-services/using-task-guides-and-bpm-to-create-user-acceptance-tests.md)
...
- نشر مخطط Finance and Operations الذي يدعم التنفيذ التلقائي للاختبار. يجب أن يكون لديك حق الوصول إلى مثيل Finance and Operations بهذا المخطط لدور **مسؤول النظام**. يجب أن يحتوي هذا المخطط على البيانات التجريبية لـ Finance and Operations التي سيتم استخدامها في هذا المثال. لمزيد من المعلومات ، راجع [نشر مخططات تدعم البناء المستمر والتنفيذ التلقائي للاختبار‬ات](../perf-test/continuous-build-test-automation.md).
- لتشغيل اختبارات قبول المستخدم والتكامل تلقائيا، يجب عليك تثبيت RSAT في المخطط الذي تستخدمه وتكوينه بالطريقة المناسبة. للحصول على معلومات حول كيفية تثبيت RSAT وتكوينه للعمل مع Finance and Operations وAzure DevOps، راجع  [Dynamics 365 for Finance and Operations، أداة Regression Suite Automation Tool](https://www.microsoft.com/download/details.aspx?id=57357) انتبه إلى المتطلبات الأساسية لاستخدام الأداة. يبين الرسم التوضيحي التالي مثالاً لإعدادات RSAT. المستطيل الأزرق يحيط بالمعلمات التي تحدد الوصول إلى Azure DevOps. المستطيل الأخضر يحيط بالمعلمات التي تحدد الوصول إلى مثيل التمويل Finance and Operations.

    ![إعدادات RSAT](media/GER-Configure.png "لقطة شاشة لمربع حوار RSAT")

- لتنظيم حالات الاختبار في مجموعات للمساعدة في ضمان التسلسل الصحيح للتنفيذ، لكي يمكنك تجميع سجلات عمليات تنفيذ الاختبارات لمزيد من التقارير والاستقصاء، يجب أن يكون لديك حق الوصول إلى Azure DevOpsمن مخطط Finance and Operations المنشور.
...
5. إنشاء مثل للدفع للمورد:
    ...
    2. تأكد من أنك لم تقم بترحيل دفتر يومية المدفوعات.
        ...
        ![صفحة دفتر يومية المدفوعات](media/GER-APJournal.png "لقطة شاشة لصفحة دفتر يومية المدفوعات")
    ...
    ![صفحة مدفوعات الموردين](media/GER-APJournalLines.png "لقطة شاشة لصفحة مدفوعات الموردين")
...
9. استخرج الملفات التالية من الملف الذي تم تنزيله:
    ...
    ![الملفات المستخرجة](media/GER-APJournalProcessed.png "لقطة شاشة لأسماء الملفات المستخرجة في Windows explorer")
...
7. أضف أساسًا جديدًا لتقرير التحكم الخاص بدفع المورد:
    ...
    ![الأسس لملف دفع المورد وتقرير التحكم](media/GER-BaselineAttachments.png "لقطة شاشة لصفحة التكوينات مع تحديد تقرير التحكم XLSX")
...
10. حدد **جديد** لتكوين أساس لتقرير التحكم:
    ...
    ![علامة التبويب السريع للأسس في صفحة التكوينات](media/GER-BaselineRules.png "علامة التبويب السريع للأسس في صفحة التكوينات")
...
1. افتح لوحة معلومات Finance and Operations الافتراضية.
...
1. قم بتعيين حالة بند الدفع الذي تمت معالجته إلى **بلا**.
    ...
    ![تسجيل المهام الخطوات 3 حتى 4](media/GER-Recording1Review1.png "لقطة شاشة لتسجيل المهام الخطوات 3 حتى 4")

2. شغل معلمة مستخدم ER **تشغيل في وضع التصحيح**.

    ![تسجيل المهام الخطوات 9 حتى 10](media/GER-Recording1Review2.png "لقطة شاشة لتسجيل المهام الخطوات 9 حتى 10")

3. نظّف سجل تصحيح ER والذي يحتوي على نتائج مقارنة الملفات التي تم إنشاؤها بالأسس.

    ![تسجيل المهام الخطوات 13 حتى 15](media/GER-Recording1Review3.png "لقطة شاشة لتسجيل المهام الخطوات 13 حتى 15")
...
2. حدد معلمات وقت التشغيل الصحيحة، ثم قم بتشغيل إنشاء تقرير التحكم.
    ...
    ![تسجيل المهام الخطوات 3 حتى 8](media/GER-Recording2Review1.png "لقطة شاشة لتسجيل المهام الخطوات 3 حتى 8")
...
3. قم بالوصول إلى سجل تصحيح ER لتسجيل نتائج مقارنة المخرجات التي تم إنشاؤها بالأسس المقابلة.
    ...
    ![الإدخالات في صفحة سجلات تشغيل التقارير الإلكترونية](media/GER-ERDebugLog.png "لقطة لشاشة للإدخالات في صفحة سجلات تشغيل التقارير الإلكترونية")
...
4. يتم تسجيل مقارنة الإخراج الحالي بالأساس بواسطة استخدام خيار مسجل المهام **التحقق من الصحة** واختيار  **القيمة الحالية**.
    ...
    ![خطوات تسجيل المهم 13و 15](media/GER-Recording2Review2.png "لقطة شاشة لخطوات تسجيل المهم 13و 15")
...
5. قم بإنشاء حالة اختبار جديدة لخطة الاختبار المحددة:
    ...
    ![حالات اختبار جديدة لخطة الاختبار المحددة](media/GER-RSAT-DevOps-Tests-Passed.png "لقطة شاشة لحالات اختبار جديدة لخطة الاختبار المحددة")
...
2. حدد **تحميل** لتحميل الاختبارات الموجودة حاليا في Azure DevOps إلى RSAT.
    ...
    ![الاختبارات المحملة إلى RSAT](media/GER-RSAT-RSAT-Tests-Loaded.png "لقطة شاشة للاختبارات المحملة إلى RSAT")
...
2. حدد **جديد** لإنشاء ملفات الأتمتة والمعلمات لـ RSAT.
    ...
    ![ملفات الأتمتة والمعلمات لـ RSAT التي تم إنشائها في RSAT](media/GER-RSAT-RSAT-Tests-Initiated.png "لقطة شاشة لملفات الأتمتة والمعلمات لـ RSAT التي تم إنشائها في RSAT")
...
لاحظ أنه يتم تشغيل حالات الاختبار تلقائيا في Finance and Operations باستخدام مستعرض ويب.
...
![اختبارات تم اجتيازها في RSAT](media/GER-RSAT-RSAT-Tests-Passed.png "لقطة شاشة لاختبارات تم اجتيازها RSAT")

لاحظ أنه يتم أيضًا إرسال نتائج تنفيذ الاختبار إلى Azure DevOpsحتى يمكنك إجراء مزيد من التحليل.

![نتائج تنفيذ الاختبار في Azure DevOps](media/GER-RSAT-DevOps-Tests-Added.png "لقطه شاشة لنتائج تنفيذ الاختبار في Azure DevOps")
...
1. افتح Finance and Operations في مستعرض الويب.
2. انتقل إلى **الحسابات الدائنة \> المدفوعات \> دفتر يومية المدفوعات**.
3. حدد **البنود**.
4. حدد بند الدفع، ثم قم بتحديد **حالة الدفع \> بلا**.
5. في الحقل **المدين**، قم بتغيير القيمة من **1,000.00** إلى **2,000.00**.
6. حدد **حفظ** لحفظ تغييراتك.
...
![نتائج الاختبار الفاشل في RSAT](media/GER-RSAT-RSAT-Tests-Failed.png "لقطة شاشة لنتائج الاختبار الفاشل في RSAT")

لاحظ أنه يتم أيضًا إرسال نتائج تنفيذ الاختبار إلى Azure DevOpsحتى يمكنك إجراء مزيد من التحليل.

![نتائج الاختبار الفاشل في Azure DevOps](media/GER-RSAT-DevOps-Tests-Failed.png "لقطة شاشة لنتائج الاختبار الفاشل في Azure DevOps")
...
![سجل التنفيذ لتحليل الفشل في Azure DevOps](media/GER-RSAT-DevOps-Tests-Failed-Log.png "لقطة شاشة لسجل التنفيذ لتحليل الفشل في Azure DevOps")
...
- [إنشاء مكتبات اختبارات قبول المستخدم باستخدام تسجيلات المهام وBPM](../lifecycle-services/using-task-guides-and-bpm-to-create-user-acceptance-tests.md)
- [نشر مخططات تدعم البناء المستمر والتنفيذ التلقائي للاختبار‬ات](../perf-test/continuous-build-test-automation.md)
- [تتبع نتائج التقارير المنشأة ومقارنتها بقيم أساس ER](er-trace-reports-compare-baseline.md)
- [ترقية تنسيق ER باعتماد إصدار أساسي جديد لهذا التنسيق](tasks/er-upgrade-format.md)
- [استيراد تكوين ER من Lifecycle Services](tasks/er-import-configuration-lifecycle-services.md)
