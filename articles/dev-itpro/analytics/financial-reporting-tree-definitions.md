...
|---|---|
| الشركة               | اسم الشركة لوحدة التقارير. تعمل قيمة **@ANY**، التي يتم تعيينها عادةً إلى مستوى التلخيص فقط، على تمكين شجرة التقارير المراد استخدامها لكافة الشركات. ويتم تعيين شركة لكافة الفروع التابعة.|
