...
|-----------------------|-------------|
| الشركة               | اسم الشركة لوحدة التقارير. تعمل قيمة **@ANY**، التي يتم تعيينها عادةً إلى مستوى التلخيص فقط، على تمكين شجرة التقارير المراد استخدامها لكافة الشركات. كل الفروع تم تعيينها إلى شركة. |
