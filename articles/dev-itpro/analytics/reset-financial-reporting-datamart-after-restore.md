...
‏‫للحصول على إصدار التقارير المالية 7.2.6.0 لـ Finance and Operations، يمكنك تنزيل قاعدة المعارف KB 4052514 من <https://fix.lcs.dynamics.com/Issue/Resolved?kb=4052514>.
...
[![إعادة تعيين مربع حوار متجر البيانات](./media/Reset-72.jpg)](./media/Reset-72.jpg)
...
[![إعادة تعيين متجر البيانات](./media/Integration.png)](./media/Integration.png)

> [!NOTE]
> تحقق أن جميع مهام إعادة تعيين متجر البيانات قد أكملت تحميل أولي قبل أن تبدأ إعادة تعيين. يمكنك تأكيد ذلك عن طريق البحث عن قيمة في العمود "‏‫وقت آخر تشغيل‬" عن طريق تحديد **أدوات** &gt; **حالة التكامل**.
...
[![عرض حالة التكامل](./media/New-integration.PNG)](./media/New-integration.PNG)

> [!NOTE]
> تنتهي عملية إعادة التعيين عند إظهار كافة التعيينات في الحالة RanToCompletion وظهور "‏‫اكتمل التكامل" في نافذة "حالة التكامل" في الركن السفلي الأيمن.
...
قم بتنزيل حزمة MinorVersionDataUpgrade.zip الأحدث. للحصول على إرشادات حول كيفية العثور على وتنزيل الإصدار الصحيح من حزمة ترقية البيانات، راجع[تنزيل حزمة ترقية البيانات الأحدث والقابلة للنشر](..\migration-upgrade\upgrade-data-to-latest-update.md#download-the-latest-data-upgrade-deployable-package). 

لا حاجة إلى إجراء عملية ترقية لتنزيل حزمة MinorVersionDataUpgrade.zip. ولذلك، ماعليك سوى اتباع الخطوات الواردة في قسم "تنزيل حزمة ترقية البيانات الأحدث والقابلة للنشر" في هذا الموضوع. يمكنك تخطي كل الخطوات الأخرى في الموضوع.
