...
2. في Finance and Operations، على صفحة **حالات الملف للمصادر** ، حدد **تحديث** لتحديث الصفحة. لاحظ ظهور ملف Excel الذي تم تحميله على SharePoint في هذه الصفحة في الحالة **جاهز**. الحالات التالية مدعومة حاليًا:
