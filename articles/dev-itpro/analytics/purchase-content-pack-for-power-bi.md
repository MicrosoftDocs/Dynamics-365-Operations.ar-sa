...
يتم عرض محتوى Power BI **تحليل نفقات الشراء** في صفحة **تحليل الشراء والنفقات** (**التدبير والتوريد** > **الاستعلامات والتقارير** > **تحليل أداء الشراء** > **تحليل الشراء والنفقات**). 
