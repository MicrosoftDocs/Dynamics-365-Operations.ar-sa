...
| UPT                     | تقييد المبالغ الموجودة في العمود، بحيث يتم تضمين الحركات غير المرّحلة فقط، إذا توفرت هذه الحركات.<p><strong>ملاحظة:</strong> لا يدعم جميع موفري البيانات الحركات غير المرَّحلة. لمزيد من المعلومات، راجع <a href='https://go.microsoft.com/fwlink/?LinkID=162565'>دليل تكامل البيانات</a> لنظام Microsoft Dynamics ERP.</p> |
