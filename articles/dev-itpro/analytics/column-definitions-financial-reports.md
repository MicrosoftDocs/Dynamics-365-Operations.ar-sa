...
-   تحتوي منطقة الرؤوس في تعريف العمود على نص العنوان والتنسيق الذي يظهر في التقرير. يمكن تطبيق رأس على عمود واحد من البيانات، أو توزيعه عبر أعمدة متعددة، أو تطبيقه على الأعمدة وفقًا لأساس شرطي. يمكن أن يتضمن تعريف العمود العديد من صفوف رؤوس الأعمدة كما تشاء. **ملاحظة:** تنطبق رؤوس الأعمدة على كل عمود بيانات في التقرير. تنطبق عناوين التقرير على التقرير الكامل. يمكنك تحديد رؤوس التقرير في علامة التبويب **الرؤوس والتذييلات** في تعريف التقرير.
...
باستطاعة مصمم التقارير أن ينشئ رؤوس الأعمدة تلقائيًا، استناداً إلى أكواد النص التلقائي. وأكواد النص التلقائي عبارة عن متغيرات يتم تحديثها في كل مرة يتم فيها إنشاء تقرير. ويمكن أن يشتمل كل رأس عمود على هذه الأكواد لتحديد معلومات التقرير التي قد تكون مختلفة، مثل التواريخ أو أرقام الفترات. ولذلك، يمكنك استخدام تعريف عمود واحد لعدة تعريفات تقارير وفترات زمنية وأشجار تقارير. ونظرًا لاعتماد رموز النصوص التلقائية على معلومات التقويم المستمدة من صفوف تفاصيل تعريف العمود، فتكون مدعومة للأعمدة من من نوع <strong>CALC</strong> و<strong>FD</strong> و<strong>WKS</strong> فقط. وتؤثر الطريقة التي يظهر بها كود النص التلقائي في خلية رأس العمود على مدى ظهور تلك المعلومات في التقرير. في مربع حوار <strong>رأس العمود</strong>، تظهر رموز النص التلقائي في حالة مختلطة. ولذلك، يظهر النص في حالة مختلطة في التقرير. على سبيل المثال، في سنة تقويم قياسية، يحول <strong>@CalMonthLong</strong> شهر <strong>7</strong> إلى <strong>يوليو</strong>. إذا كان اسم الشهر يجب أن يكون بأحرف كبيرة (على سبيل المثال <strong>JULY</strong>)، فأدخل كود النص التلقائي بأحرف كبيرة في حقل <strong>نص رأس العمود</strong>. على سبيل المثال، أدخل <strong>@CALMONTHLONG</strong>. يمكن خلط الأكواد والنص. على سبيل المثال، قمت بإدخال نص الرأس التالي: <strong>فترة @FiscalPeriod-@FiscalYear من @StartDate إلى @EndDate</strong>. ويشبه عنوان التقرير الذي تم إنشاؤه النص التالي: <strong>الفترة 1-02 من 02/01/01 إلى 31/01/02</strong>. <strong>ملاحظة:</strong> يعتمد تنسيق بعض النص، مثل التاريخ الطويل، على إعداداتك الإقليمية على خادم Finance and Operations. ولتغيير هذه الإعدادات، انقر فوق الزر <strong>ابدأ</strong>، وانقر فوق <strong>لوحة التحكم</strong>، ثم انقر فوق <strong>المنطقة واللغة</strong>. يسرد الجدول التالي خيارات النص التلقائي المتوفرة لرؤوس الأعمدة.
...
3.  حدد نوع عمود في القائمة. يصف الجدول التالي أنواع العمود المختلفة.
    ...
    <tr class="odd">
    <td>FD</td>
    <td>يعرض البيانات المالية أو البيانات من ورقة عمل Excel عند استخدامك لعمود <strong>ربط بالأبعاد المالية</strong> أو عمود <strong>ربط بورقة عمل</strong> في تعريف الصف. عند تحديدك لنوع العمود <strong>FD</strong>، يتم تحديد الإعدادات الافتراضية تلقائيًا للصفوف التالية: <ul>
...
يمكنك تغيير الإعدادات الافتراضية.</td>
    ...
    <tr class="even">
    <td>WKS</td>
    <td>عرض البيانات التي يتم سحبها من ورقة عمل Excel. عند تحديدك لنوع العمود <strong>WKS</strong>، يتم تحديد الإعدادات الافتراضية تلقائيًا في الصفوف التالية: <ul>
...
|----------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|         العملة الأصلية/العادية         | <strong>الين</strong> |                                                                   <strong>Y6,000</strong> – توضح النتيجة الحركات التي تم إدخالها بالين الياباني فقط.                                                                   |
| العملة الوظيفية من معلومات الشركة | <strong>الين</strong> |          <strong>$60</strong> – توضح النتيجة فقط الحركات التي تم إدخالها بالين الياباني وتعرضها بالدولار الأمريكي. <strong>ملاحظة:</strong> معدل التحويل هو 100 ين تقريبًا لكل دولار أمريكي.           |
| العملة الوظيفية من معلومات الشركة |        فارغ         | <strong>$2,310\*\</strong>* – تعرض النتيجة كافة البيانات بالعملة الوظيفية المحددة في معلومات الشركة. <strong>ملاحظة:</strong> هذا المبلغ هو مجموع كافة الحركات بالعملة الوظيفية. |
|         العملة الأصلية/العادية         |        فارغ         |                                                       <strong>$2,250</strong> – إظهار نتيجة كل المبالغ بالعملة التي تمت بها الحركة.                                                        |

### <a name="calculation-column-in-a-column-definition"></a>قيود الأعمدة في تعريف العمود

يدعم نوع العمود **CALC** في تعريف العمود العمليات الحسابية المعقدة في خلية  <strong>المعادلة</strong> ويمكن أن يتضمن عوامل التشغيل <strong>+</strong>، و<strong>-</strong>، و<strong>\</strong>، و**/*، بجانب عبارات <strong>IF/THEN/ELSE</strong>. يمكن أن يشير عمود الحساب أيضًا إلى أي عمود آخر، حتى الأعمدة التالية. بالإضافة إلى ذلك، يمكن أن يتضمن عمود العملية الحسابية السنة المالية والفترة لدعم رؤوس العمود. ويمكن أن يصل طول معادلة العملية الحسابية إلى 1,024 حرفًا. وللتعبير عن نتيجة العملية الحسابية كنسبة مئوية، استخدم تجاوز تنسيق خاص. <strong>ملاحظة:</strong> لا تتضمن نتائج معادلات الحساب القيم الموجودة في نطاقات الأعمدة غير المطبوعة. على سبيل المثال، سوف تطبع <strong>A:D</strong> القيمة <strong>0</strong> (صفر)، بينما ستقوم <strong>A+B+C</strong> بحساب القيمة للقيم غير المطبوعة.
