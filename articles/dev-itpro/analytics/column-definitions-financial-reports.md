...
| UPT                     | تقييد المبالغ الموجودة في العمود، بحيث يتم تضمين الحركات غير المرّحلة فقط، إذا توفرت هذه الحركات.<blockquote>[!NOTE] لا يدعم كل مزودي البيانات الحركات غير المرحلة. لمزيد من المعلومات، راجع <a href='http://go.microsoft.com/fwlink/?LinkID=162565'>دليل تكامل البيانات</a> لنظام Microsoft Dynamics ERP.</blockquote> |
...
> [!NOTE]
> يعتمد تنسيق بعض النص، مثل التاريخ الطويل، على إعداداتك الإقليمية على خادم Finance and Operations. ولتغيير هذه الإعدادات، انقر فوق الزر **ابدأ**، وانقر فوق **لوحة التحكم**، ثم انقر فوق **المنطقة واللغة**. يسرد الجدول التالي خيارات النص التلقائي المتوفرة لرؤوس الأعمدة.
...
| العملة الوظيفية من معلومات الشركة | **الين**              |**$60** – تعرض النتيجة الحركات التي تم إدخالها بالين الياباني فقط وتعرض تلك الحركات التي بالدولار الأمريكي.<blockquote>[!NOTE] معدل التحويل هو 100 ين ياباني تقريبًا لكل دولار أمريكي.</blockquote> |
| العملة الوظيفية من معلومات الشركة | فارغ                | **2,310 دولار أمريكي** – تعرض النتيجة كافة البيانات بالعملة الوظيفية المحددة في معلومات الشركة.<blockquote>[!NOTE] هذا المبلغ هو مجموع كافة الحركات بالعملة الوظيفية.</blockquote> |
...
| -        | A-C                 | أطرح المبلغ في العمود A من المبلغ في العمود C.<blockquote>[!NOTE] يمكنك أيضًا استخدام علامة الطرح (-) لعكس العلامات في العمود. على سبيل المثال، استخدم <strong>-A+B</strong> لإضافة عكس المبلغ في العمود A إلى المبلغ الموجود في العمود B.</blockquote> |
