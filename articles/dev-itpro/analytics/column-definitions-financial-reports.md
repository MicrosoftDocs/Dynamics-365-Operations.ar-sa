...
باستطاعة مصمم التقارير أن ينشئ رؤوس الأعمدة تلقائيًا، استناداً إلى أكواد النص التلقائي. وأكواد النص التلقائي عبارة عن متغيرات يتم تحديثها في كل مرة يتم فيها إنشاء تقرير. ويمكن أن يشتمل كل رأس عمود على هذه الأكواد لتحديد معلومات التقرير التي قد تكون مختلفة، مثل التواريخ أو أرقام الفترات. ولذلك، يمكنك استخدام تعريف عمود واحد لعدة تعريفات تقارير وفترات زمنية وأشجار تقارير. ونظراً لاستناد أكواد النص التلقائي إلى معلومات التقويم من صفوف التفاصيل في تعريف العمود، فإنه يتم دعمها فقط لأعمدة **CALC**، و**FD**، و**WKS**. وتؤثر الطريقة التي يظهر بها كود النص التلقائي في خلية رأس العمود على مدى ظهور تلك المعلومات في التقرير. وفي مربع حوار **رأس العمود**، تظهر أكواد النص التلقائي بحالة مختلطة. ولذلك، يظهر النص في حالة مختلطة في التقرير. على سبيل المثال، في سنة تقويم قياسي، يقوم **@CalMonthLong** بحل شهر **7** إلى **يوليو**. وإذا كان يجب أن يظهر اسم الشهر مكتوبًا بأحرفٍ كبيرة (كما هو الحال مثلاً في **JULY‎** (يوليو))، فأدخل رمز النص التلقائي بأحرفٍ كبيرة في حقل **نص رأس العمود**. على سبيل المثال، أدخل **@CALMONTHLONG**. يمكن خلط الأكواد والنص. على سبيل المثال، تقوم بإدخال نص الرأس التالي: **الفترة @FiscalPeriod-@FiscalYear من @StartDate إلى @EndDate**. ويشبه عنوان التقرير الذي تم إنشاؤه النص التالي: **الفترة 1-02 من 02/01/01 إلى 31/01/02**.
...
|                     |  أ   | ب             | ج             | د             | هـ             | و             | ز             | ح             | ط             | ي‎             | أ             | ل             | م             |
|---------------------|------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|---------------|
| الرأس 1            |      | الفعلي        | الموازنة        |               |               |               |               |               |               |               |               |               |               |
...
يمكن لتقرير متعدد العملات عرض المبالغ بعملة طبيعية (محلية) أو بالعملة الوظيفية (الافتراضية) أو عملة التقارير. يتم تحديد العملة الوظيفية للشركة في نظام Microsoft Dynamics ERP. ولا تخلط بين إعداد ERP هذا وإعداد الخيارات الإقليمية في نظام التشغيل، حيث يمكنك تكوين رموز العملة الافتراضية التي يتم استخدامها في التقارير. تتوفر الخلايا التالية ذات الصلة بالعملة في تعريف العمود:
