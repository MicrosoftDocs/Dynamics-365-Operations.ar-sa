...
> [!NOTE]
> عند إعادة تسمية كتلة إنشاء، يجب تحديث أي تعريفات تقارير تستخدم كتلة الإنشاء. وإلا، فقد يتعذر إنشاء تقرير جديد.

### <a name="rename-a-folder-or-building-block-in-report-designer"></a>إعادة تسمية مجلد أو كتلة إنشاء في مصمم تقرير

1. في مصمم التقارير، استخدم "جزء التنقل" لتحديد موقع المجلد أو الكائن المراد إعادة تسميته.
