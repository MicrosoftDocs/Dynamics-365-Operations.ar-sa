...
2. في قائمة **ملف**، انقر فوق **جديد** &gt; **تعريف مجموعة التقارير** لفتح مجموعة تقارير جديدة في نافذة العارض. أو، انقر فوق زر **مجموعة التقارير** ![مجموعة التقارير](media/report-group.gif "مجموعة التقارير") على شريط الأدوات.
...
4. في قائمة **ملف**، انقر فوق **حفظ** لحفظ مجموعة التقارير المعدّلة. أو، انقر فوق الزر **حفظ** ![حفظ](media/save.gif "حفظ") على شريط الأدوات.
...
3. انقر فوق الزر **إنشاء تقرير** ![إنشاء تقرير](media/generate-report.gif "إنشاء تقرير") لإنشاء تقارير.
