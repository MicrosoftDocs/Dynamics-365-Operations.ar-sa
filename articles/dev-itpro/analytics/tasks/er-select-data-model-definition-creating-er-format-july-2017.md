...
---
# <a name="select-data-model-definition-while-creating-format-for-electronic-reporting-er"></a>تحديد تعريف نموذج البيانات أثناء إنشاء تنسيق التقارير الإلكترونية (ER)
