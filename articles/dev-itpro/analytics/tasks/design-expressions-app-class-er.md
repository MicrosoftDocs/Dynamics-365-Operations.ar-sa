...
يمكن إتمام هذه الخطوات باستخدام أي مجموعة بيانات. يجب أيضًا تنزيل وحفظ الملف التالي في موقع محلي: (https://go.microsoft.com/fwlink/?linkid=862266): SampleIncomingMessage.txt.
...
1. انتقل إلى إدارة المؤسسة > مساحات العمل‬ > إعداد التقارير الإلكتروني‬.
    ...
    * لنفترض أنك تقوم بتصميم عملية لتحليل كشوف الحسابات البنكية الواردة لتحديث بيانات تطبيق. سوف تتلقى كشوف الحسابات البنكية الواردة كملفات TXT تحتوي على أكواد IBAN. كجزء من عملية استيراد كشف الحساب البنكي، يتعين عليك التحقق من صحة أكواد IBAN هذه باستخدام المنطق الموجود بالفعل في Dynamics 365 for Finance and Operations, Enterprise edition.   
