--- 
title: "تحديد تبعية التكوينات من المكونات الأخرى للتقارير الإلكترونية (ER)"
...
---
# <a name="define-the-dependency-of-configurations-from-othcomponents-for-electronic-reporting-er"></a>تحديد تبعية التكوينات من المكونات الأخرى للتقارير الإلكترونية (ER)
