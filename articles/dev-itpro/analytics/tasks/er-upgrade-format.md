--- 
title: "ترقية التنسيقات باعتماد إصدارات أساسية جديدة"
...
---
# <a name="upgrade-formats-by-adopting-new-base-versions"></a>ترقية التنسيقات باعتماد إصدارات أساسية جديدة
...
افترض أن هناك بعض المتطلبات جديدة خاصة بالبلد يجب أن تكون معتمدة من قبل Litware:  
- قيمة لرمز SWIFT البنكي لحساب الدائن في كل حركة دفع.  
- طول اسم المورّد محدد بـ 100 حرف عند إنشاء الملفات.  
