...
## [ترخيص ISV في الموقع المحلي](dev-tools/isv-licensing-on-prem.md)

# [تطوير واجهة المستخدم](user-interface/user-interface-development-home-page.md)
## البرامج التعليمية
### [إنشاء نموذج "نوع تكلفة الإيجار"](user-interface/build-rental-charge-type-form.md)
...
#### [نشر بيئات محلية باستخدام Platform update 8 و11](deployment/setup-deploy-on-premises-pu8-pu11.md)
