...
| --- | --- | --- |
| update 10.0.20 للنظام الأساسي | -- | [تحديثات النظام الأساسي للإصدار 10.0.20 من تطبيقات التمويل والعمليات (أغسطس 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20) |
