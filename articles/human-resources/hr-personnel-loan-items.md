...
فيما يلي بعض الأمثلة على العناصر التي قد تقرضها الشركة للعمال:
...
يمكن للموظفين استخدام مساحة عمل **الخدمة الذاتية للموظف** لعرض سجلات العناصر التي تم إقراضها لهم. ‏‫كما يمكنهم أيضًا تحرير سجلات موجودة أو إدخال أصناف قرض جديدة، إذا تلقيت أصناف إضافية فعلية. ويمكن إعداد سير عمل لتوجيه تغييرات لأصناف قرض جديدة أو موجودة من خلال عملية موافقة.‬‏‫ 
