...
description: توضح هذه المقالة كيفية قيام إدارة الميزات بتعقب المعلومات التي يتم رفع تقرير بها في نموذج 1095-B ونموذج 1095-C الخاصة بتفويض صاحب العمل وفق قانون الرعاية ميسورة التكلفة (ACA).
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
