...
description: يوضح هذا الموضوع كيفية قيام إدارة الميزات بتعقب المعلومات التي يتم رفع تقرير بها في النموذج 1095-B والنموذج 1095-C بشأن تكليف صاحب العمل وفق قانون الرعاية ميسورة التكلفة (ACA).
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
تتعقب إدارة الميزات المعلومات التي يتم رفع تقرير بها في النموذج 1095-B والنموذج 1095-C بشأن تكليف صاحب العمل وفق قانون الرعاية ميسورة التكلفة (ACA). كمثل إمكانية إعداد تقارير قانون الرعاية ميسورة التكلفة في مساحة عمل **المزايا** القديمة، يتم تطبيق هذه الوظيفة فقط على الكيانات القانونية في الولايات المتحدة.
...
2. قم بتغيير المعلمات كما هو مطلوب، ثم حدد **موافق**.
    ...
    > [!NOTE]
    > إذا كنت تقوم بطباعة نماذج 1095-C لأكثر من 500 موظف، فستتلقى ملف PDF واحدًا أو أكثر. ونوصي بزيادة قيمة حقل **الحد الأقصى لحجم الملف بالميغا بايت** في صفحة **معلمات إدارة المستندات** إلى **150**. (لفتح هذه الصفحة بسرعة، استخدم حقل البحث في شريط التنقل.)
    >
