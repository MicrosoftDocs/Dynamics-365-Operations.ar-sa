...
4. في **مركز حماية الحل** ، حدد الرمز **بحث متقدم** في الجزء العلوي الأيسر من الصفحة.

5. في صفحه **بحث متقدم** ، وفي القائمة المنسدلة **البحث عن** ، حدد **كيانات HR المتاحة** .

6. استخدم خيارات التصفية للعثور علي الكيان أو الكيانات التي ترغب في تمكينها.

7. قم بتحديد كيان من القائمة.

8. في صفحة الكيان، قم بتغيير الخاصية **تم إنشاؤه** إلى **نعم** للكيان.

9. احفظ الصفحة وأغلقها.

> [!NOTE]
> يمكنك إنشاء عده كيانات ظاهريه مره واحده باستخدام الصفحة **تغيير سجلات متعددة** . حدد سجلات متعددة في الصفحة، وحدد **تحرير** من الشريط. يمكنك بعد ذلك تغيير الخاصية **تم إنشاؤه** لكافة السجلات المحددة.

![كيانات الموارد البشرية المتاحة](./media/hr-admin-integration-virtual-entities-available.jpg)

> [!NOTE]
> لتسهيل عمليه إنشاء كيانات ظاهريه في الإصدارات المستقبلية، ستحدث العملية في صفحه في الموارد البشرية.
