...
description: توضح هذه المقالة كيفية تكوين الجداول الافتراضية الموجودة وإنشاؤها وتحديثها وتحليل الجداول المنشأة والمتاحة لـ Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
