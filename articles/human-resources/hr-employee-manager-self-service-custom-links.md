...
## <a name="enable-the-preview-feature"></a>تمكين ميزة المعاينة

لاستخدام هذه الميزة، قم بتمكين **(معاينة) ارتباطات مخصصة في الخدمة الذاتية للمدير‬** في مساحة العمل **إدارة الميزات**. لمزيد من المعلومات حول تمكين ميزات المعاينة، راجع [إدارة الميزات](hr-admin-manage-features.md).
