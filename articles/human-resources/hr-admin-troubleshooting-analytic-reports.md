...
description: توضح هذه المقالة كيفية استكشاف المشكلات وإصلاحها وتشخيصها إذا لم تظهر تغييرات بيانات العميل في أي من مساحات عمل العميل.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
