...
ms.locfileid: "5125920"
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="5a4fe-103">مثال لاستعلام عن طلب تعيين</span><span class="sxs-lookup"><span data-stu-id="5a4fe-103">Example query for Recruiting request</span></span>

<span data-ttu-id="5a4fe-104">يقدم هذا الموضوع مثالا للاستعلام عن كيان طلب التعيين في Dynamics 365 Human Resources.</span><span class="sxs-lookup"><span data-stu-id="5a4fe-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="5a4fe-105">يوضح الاستعلام التالي كيف يمكن استخدام خيار الاستعلام $expand في عملية GET لاسترداد سجل طلب تعيين محدد وكافة المناصب المقترنة والمهارات المطلوبة والمتطلبات التعليمية للطلب المحدد.</span><span class="sxs-lookup"><span data-stu-id="5a4fe-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="5a4fe-106">يُظهر الرد على المثال طلب تعيين لمنصبين والمهارات المطلوبة والتعليم للمناصب المطلوبة.</span><span class="sxs-lookup"><span data-stu-id="5a4fe-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="5a4fe-107">**الطلب**</span><span class="sxs-lookup"><span data-stu-id="5a4fe-107">**Request**</span></span>
...
<span data-ttu-id="5a4fe-108">**استجابة**</span><span class="sxs-lookup"><span data-stu-id="5a4fe-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="5a4fe-109">راجع أيضًا</span><span class="sxs-lookup"><span data-stu-id="5a4fe-109">See also</span></span>

[<span data-ttu-id="5a4fe-110">مقدمة واجهة برمجة التطبيقات لتكامل نظام تعقب مقدم الطلب</span><span class="sxs-lookup"><span data-stu-id="5a4fe-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>