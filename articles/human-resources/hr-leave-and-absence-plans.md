...
حدد خطط الإجازات والغياب في Dynamics 365 Human Resources لكل نوع من الإجازات التي تقدمها. يمكن ان يتم استحقاق خطط الإجازات بترددات مختلفه ، مثل السنوية أو الشهرية أو السيميمونثليه. يمكن أيضًا تحديد خطة كمنحة، عند حدوث استحقاق فردي في تاريخ محدد. علي سبيل المثال ، يمكنك إنشاء خطه تمنح أيام العطل العائمة سنويا.
...
يمكنك تحديد الحد الأقصى للمبالغ التي تم تنفيذها فوق الحد الأدنى أو الحد الأدنى من الارصده لضمان ان الموظفين يستخدمون ساعات الميزة التي تم استحقاقها.

علي سبيل المثال ، باستخدام خطه المستوي ، يمكنك منح فائده من 80 ساعة من الوقت المدفوع (PTO) للموظفين الجدد. ثم يمكنك منح 120 ساعات من 60 شهرا من الخدمة.
...
3. حدد الاستحقاقات في علامة التبويب **الاستحقاقات**. تحدد الاستحقاقات متى يتم منح الموظف الوقت وعدد مرات التوقف. في هذه الخطوة ، تقوم بتعريف السياسات عند القيام بمنح الاستحقاقات والسياسات الخاصة بالتحقق من ميزات الإجازات.
   ...
   3. حدد أحد الخيارات مربع القائمة المنسدلة **تاريخ منح الاستحقاق**:
      ...
      - **تاريخ انتهاء فترة الاستحقاق** – يُمنح الموظف زمن توقف في اليوم الأخير من فترة المنحة. لتمكين استحقاق القيمة الصحيحة، يجب أن تتضمن عملية الاستحقاق الفترة بأكملها. علي سبيل المثال ، إذا كانت فتره الاستحقاق 1 يناير 2020 حتى 31 يناير ، 2020 ، فيجب عليك تشغيل الاستحقاق لمده 1 فبراير ، 2020 لتضمين شهر يناير.
...
1. **ميزه المعاينة: قم بتكوين أنواع الإجازات المتعددة لخطه الاجازه والغياب الفردية**. بالنسبة لكل سجل في جدول جدولة الاستحقاق ، يمكنك تحديد نوع الاجازه.

   > [!IMPORTANT]
   > بعد تمكين هذه الميزة، لا يمكنك إيقاف تشغيلها.

2. **ميزه المعاينة: استخدام معادلة الوقت الكامل**. إذا قمت بتمكين ميزه المعاينة هذه ، تستخدم Human Resources معادلة الوقت الكامل (FTE) المحدد للمنصب وذلك لتقسيم استحقاق الموظف بالتناسب. علي سبيل المثال، إذا كانت FTE تبلغ  .5 وكانت قيمه الاستحقاق هي 10، سيقوم الموظف باستحقاق 5. يمكنك استخدام هذه الميزة فقط في حاله تمكين العديد من أنواع الإجازات.
