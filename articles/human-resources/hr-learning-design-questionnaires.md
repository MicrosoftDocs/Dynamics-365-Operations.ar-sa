...
description: يوضح هذا الموضوع عملية إنشاء استبيان.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
...
**أنواع الأسئلة** مطلوبة ويجب تعيينها عند قيامك بإنشاء سؤال. 

استخدم **أنواع الأسئلة** لتصنيف الأسئلة للتقارير. كما تعمل **أنواع الأسئلة** على تسهيل البحث عن الأسئلة، لأنه يمكنك استخدام أنواع مثل عوامل التصفية في صفحة **الأسئلة**. فيما يلي بعض الأمثلة على أنواع الأسئلة:
...
يمكن استخدام **مجموعات الإجابات** لأكثر من سؤال في نفس الاستبيان، ويمكن أيضًا استخدامها في أكثر من استبيان واحد. 
...
**مجموعات النتائج** اختيارية عند إرفاق أسئلة باستبيان. 
