...
| --- | --- | --- |
| تحديث النظام الأساسي 10.0.16 (40) | -- | [تحديثات النظام الأساسي للإصدار 10.0.16 من تطبيقات Finance and Operations (فبراير 2021)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-16.md) |
