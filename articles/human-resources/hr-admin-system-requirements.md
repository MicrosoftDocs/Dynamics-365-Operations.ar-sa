...
description: توضح هذه المقالة متطلبات النظام في Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/11/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8879326"
---
# <a name="system-requirements"></a>متطلبات النظام

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

توضح هذه المقالة متطلبات النظام في Microsoft Dynamics 365 Human Resources. كما يوضح البلدان والمناطق التي يتوفر فيها Human Resources، بالإضافة إلى معلومات حول لغات وترجمة بيانات Human Resources.
