...
3. حدد **جديد**.
4. أدخل اسمًا لنوع الإجازة ضمن **النوع**، وأدخل وصفًا ضمن **الوصف**، وحدد سير عمل في حقل **معرف سير العمل**. بناءً على نوع الإجازة، حدد نوع الطلب في حقل **نوع الطلب**. على سبيل المثال، حدد **إجازة** أو **إذن الغياب‬**.
5. في **عام**، حدد **بلا** أو **مجدول** أو **غير مجدول** من القائمة المنسدلة **الفئة**.
6. حدد كود دخل من القائمة المنسدلة **رمز الدخل**.
7. ضمن **كود السبب مطلوب**، حدد ما إذا كنت تريد طلب كود السبب. إذا كنت تريد طلب أكواد الأسباب، فقد تضطر إلى إضافتها. ضمن **أكواد السبب**، حدد **إضافة**، وحدد كود السبب، ثم حدد خانة الاختيار **ممكن** بجوارها.
8. إذا كان نوع الطلب **إجازة غياب**، فاتبع الخطوات التالية:

      1. ضمن **نهاية مفتوحة**، حدد ما إذا كان يجب أن يتمكن المستخدمون من إنشاء أوراق مفتوحة.
      2. إذا تم تمكين **النهاية المفتوحة**، يمكنك تحديد ما إذا كان يجب على العمال إرسال إشعار بالعودة إلى العمل عند عودتهم من إجازة الغياب.
      3. إذا كان يجب على العمال إرسال إشعار العودة إلى العمل، فيمكنك تمكين **تمكين إشعار العودة إلى العمل**. إذا تم تمكين **إشعار تمكين العودة إلى العمل**، فسيتم تمكين **المرفقات المطلوبة** تلقائيًا ولا يمكن تعطيلها.

9. إذا كان يجب على المستخدمين تحميل المستندات عند إنشاء طلبات الإجازة أو تحديثها، فيمكنك تمكين **المرفقات المطلوبة**.
10. ضمن **تقييد الوصول إلى الأدوار المحددة**، حدد ما إذا كنت تريد تقييد الوصول. بعد ذلك، ضمن **أدوار الأمان لنوع الإجازة هذا**، حدد أدوار الأمان. تم تعريف أدوار الأمان في سير العمل الذي حددته ضمن **معرف سير العمل** سابقًا في هذا الإجراء.
11. ضمن **لون التقويم**، حدد اللون الذي تريد إظهاره في تقويمات الإجازات والغياب لنوع الإجازة هذا.
11. ضمن **علاقات التعليق**، حدد ما إذا كان يجب تعليق نوع الإجازة هذا أو تعليقه بنوع إجازة آخر. عند تقديم طلب إذن غياب لنوع الإجازة المعلق، سيتم إنشاء تعليق الإجازة بشكل تلقائي لنوع الإجازة المعلق.
12. حدد **حفظ**.
...
2. حدد **نوع الإجازة والغياب** في القائمة. في القسم **عام**، استخدم الحقل **المرفق المطلوب** لتحديد ما إذا كان يجب تحميل مرفق عندما يرسل الموظف طلب إجازة جديدًا لنوع الإجازة المحدد. 
