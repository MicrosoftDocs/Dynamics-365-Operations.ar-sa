...
تجيب هذه المقالة عن الأسئلة الشائعة عن البيانات التي تتم مزامنتها عندما يتكامل Dynamics 365 Human Resources مع Dynamics 365 Finance.
...
عند إنشاء اتصالاتك، تأكد من اختيار Dynamics 365 Finance وDataverse.
