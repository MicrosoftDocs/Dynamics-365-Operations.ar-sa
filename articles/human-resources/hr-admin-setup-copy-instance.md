...
> [!IMPORTANT]
> لا تدعم البنية الأساسية للعمليات والمالية وظيفة مثيل النسخ. يمكنك نشر بيئات جديده واستخدام حركات قاعده البيانات لإنشاء نسخ. لمزيد من المعلومات حول عمليات نشر الخدمة الذاتية ، راجع [نظرة عامة على نشر الخدمة الذاتية](../fin-ops-core/dev-itpro/deployment/infrastructure-stack.md). لمزيد من المعلومات حول حركات قاعده البيانات علي التصديق الأساسي للعمليات والتمويل ، راجع [الصفحة ](../fin-ops-core/dev-itpro/database/dbmovement-operations.md)الرئيسية لعمليات حركه قاعده البيانات.
...
> [!Note]
> يتم تضمين المستندات الموجودة في التخزين الثنائي Microsoft Azure أغسطس 2022 عند نسخ بيئة إنتاج إلى بيئة الحماية. سيتم نسخ أي مستندات وقوالب مرفقة من بيئة المصدر إلى البيئة المستهدفة.
...
- لن تتوفر كافة المستخدمين باستثناء المستخدمين الذين لديهم دور أمان "مسؤول النظام" وحسابات مستخدم الخدمة الداخلية الأخرى. يمكن للمستخدم المسؤول حذف البيانات قبل السماح للمستخدمين الآخرين بالعودة إلى النظام.
...
4. في جزء المهام **نسخ مثيل**، حدد المثيل المراد استبداله، ثم حدد **نسخ**. انتظر حتي يتم تحديث **نسخ الحالة** إلى **مكتمل**.
...
لمزيد من المعلومات حول النسخ Power Apps البيئات، انظر [انسخ بيئة](/power-platform/admin/copy-environment#copy-an-environment-1).
...
يتم استبدال كافة المستخدمين في بيئة الحماية الهدف، بما في ذلك المسؤولين، بالمستخدمين في البيئة المصدر. قبل نسخ مثيل، تأكد من أنك مسؤول في البيئة المصدر. إذا لم تكن كذلك، فلا يمكنك تسجيل الدخول إلى بيئة وضع الحماية الهدف بعد اكتمال النسخة.
