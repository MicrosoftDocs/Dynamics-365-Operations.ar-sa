...
---
# <a name="process-life-event-eligibility"></a>معالجة أهلية الحدث الحياتي

يوضح هذا المقال كيفية تشغيل معالجة أهلية الحدث الحياتي.

1. في مساحة العمل **إدارة المزايا**، تحت **معالجة**، حدد **معالجة أهلية الحدث الحياتي**.

2. في مربع الحوار **تشغيل معالجة أهلية الحدث الحياتي**، حدد قيم الحقول التالية:

   | الحقل | ‏‏الوصف |
   | --- | --- |
   | **فترة التسجيل** | فترة التسجيل المراد معالجة أهلية الحدث الحياتي لها. |
