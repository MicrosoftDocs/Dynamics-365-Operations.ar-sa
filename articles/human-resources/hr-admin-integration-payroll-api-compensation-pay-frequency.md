...
description: توفر هذه المقالة تفاصيل ومثال استعلام لكيان تكرار دفع التعويض‬‏‫ في Dynamics 365 Human Resources.
author: marcelbf
ms.date: 09/01/2021
ms.topic: article
ms.prod: ''
...
توضح هذه المقالة كيان تكرار دفع التعويض‬‏‫ في Dynamics 365 Human Resources.
