...
- <span data-ttu-id="a2fd3-111">بيانات الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="a2fd3-141">تكوين بياناتك</span><span class="sxs-lookup"><span data-stu-id="a2fd3-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="a2fd3-158">ميزات</span><span class="sxs-lookup"><span data-stu-id="a2fd3-158">Benefits</span></span>
...
<span data-ttu-id="a2fd3-187">لمزيد من المعلومات حول كيفية تحديد وإدارة برنامج ميزات، راجع المقالات التالية:</span><span class="sxs-lookup"><span data-stu-id="a2fd3-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="a2fd3-206">تسجيل موظف في خطة التعويض المتغيرة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-206">Enroll an employee in a variable compensation plan</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/enroll-employee-variable-compensation-plan)
...
### <a name="worker-data"></a><span data-ttu-id="a2fd3-265">بيانات العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-265">Worker data</span></span>
...
#### <a name="personal-information"></a><span data-ttu-id="a2fd3-281">معلومات شخصية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-281">Personal information</span></span>
...
##### <a name="earning-codes"></a><span data-ttu-id="a2fd3-303">أكواد الأرباح</span><span class="sxs-lookup"><span data-stu-id="a2fd3-303">Earning codes</span></span>
...
- <span data-ttu-id="a2fd3-324">تاريخ بدء التوظيف (مطلوب)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-324">Employment start date (required)</span></span>
...
### <a name="reason-codes"></a><span data-ttu-id="a2fd3-418">رموز السبب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-418">Reason codes</span></span>
...
|------------------------|----------------------|
| <span data-ttu-id="a2fd3-454">متزوج</span><span class="sxs-lookup"><span data-stu-id="a2fd3-454">Married</span></span>                | <span data-ttu-id="a2fd3-455">متزوج</span><span class="sxs-lookup"><span data-stu-id="a2fd3-455">Married</span></span>              |
...
| <span data-ttu-id="a2fd3-462">شراكة مسجلة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-462">Registered Partnership</span></span> | <span data-ttu-id="a2fd3-463">الشراكة المحلية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-463">Domestic Partnership</span></span> |
| <span data-ttu-id="a2fd3-464">بلا</span><span class="sxs-lookup"><span data-stu-id="a2fd3-464">None</span></span>                   | <span data-ttu-id="a2fd3-465">بلا</span><span class="sxs-lookup"><span data-stu-id="a2fd3-465">None</span></span>                 |
| <span data-ttu-id="a2fd3-466">تعايش</span><span class="sxs-lookup"><span data-stu-id="a2fd3-466">Cohabiting</span></span>             | <span data-ttu-id="a2fd3-467">تعايش</span><span class="sxs-lookup"><span data-stu-id="a2fd3-467">Cohabiting</span></span>           |

### <a name="gender"></a><span data-ttu-id="a2fd3-468">الجنس</span><span class="sxs-lookup"><span data-stu-id="a2fd3-468">Gender</span></span>

<span data-ttu-id="a2fd3-469">يتم تعيين الجنس إلى Dayforce وترجمته، حسب الحاجة، إلى القيم المقبولة عند التكامل.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-469">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a2fd3-470">يعرض الجدول التالي كيفية تعيين الجنس إلى Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-470">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="a2fd3-471">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-471">Human Resources</span></span>       | <span data-ttu-id="a2fd3-472">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-472">Dayforce</span></span>        |
|--------------|-----------------|
| <span data-ttu-id="a2fd3-473">ذكر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-473">Male</span></span>         | <span data-ttu-id="a2fd3-474">ذكر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-474">Male</span></span>            |
| <span data-ttu-id="a2fd3-475">أنثى</span><span class="sxs-lookup"><span data-stu-id="a2fd3-475">Female</span></span>       | <span data-ttu-id="a2fd3-476">أنثى</span><span class="sxs-lookup"><span data-stu-id="a2fd3-476">Female</span></span>          |
| <span data-ttu-id="a2fd3-477">غير محدد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-477">Non-specific</span></span> | <span data-ttu-id="a2fd3-478">*غير مدعوم*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-478">*Not supported*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="a2fd3-479">أكواد الأرباح</span><span class="sxs-lookup"><span data-stu-id="a2fd3-479">Earning codes</span></span>

<span data-ttu-id="a2fd3-480">تحدد أكواد الأرباح بشكل فريد كل نوع من أنواع الأرباح التي يحصل عليها العاملون.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-480">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="a2fd3-481">تغطي الأكواد معلمات متنوعة ترتبط بالأرباح، مثل قواعد المحاسبة وقوانين الضرائب ومتطلبات إعداد التقارير وقدرات المبلغ الإجمالي.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-481">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="a2fd3-482">إذا تم استخدام تكرار غير معتمد، يُستخدم التكرار **كل عملية دفع** بشكل افتراضي للحساب.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-482">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="a2fd3-483">التكرارات المدعومة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-483">Supported frequencies</span></span>

- <span data-ttu-id="a2fd3-484">الكل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-484">All</span></span>
- <span data-ttu-id="a2fd3-485">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="a2fd3-485">EVERYPAY</span></span>
- <span data-ttu-id="a2fd3-486">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="a2fd3-486">EACHPAYPERIOD</span></span>
- <span data-ttu-id="a2fd3-487">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="a2fd3-487">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="a2fd3-488">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="a2fd3-488">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="a2fd3-489">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-489">1OFMTH</span></span>
- <span data-ttu-id="a2fd3-490">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-490">LASTOFMTH</span></span>
- <span data-ttu-id="a2fd3-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-491">2OFMTH</span></span>
- <span data-ttu-id="a2fd3-492">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-492">3OFMTH</span></span>
- <span data-ttu-id="a2fd3-493">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-493">4OFMTH</span></span>
- <span data-ttu-id="a2fd3-494">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-494">5OFMTH</span></span>
- <span data-ttu-id="a2fd3-495">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-495">1N2OFMTH</span></span>
- <span data-ttu-id="a2fd3-496">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-496">3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-497">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-497">1N3OFMTH</span></span>
- <span data-ttu-id="a2fd3-498">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-498">1N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-499">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-499">2N3OFMTH</span></span>
- <span data-ttu-id="a2fd3-500">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-500">2N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-501">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-501">1N2N3OFMTH</span></span>
- <span data-ttu-id="a2fd3-502">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-502">1N2N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-503">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-503">1N3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-504">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-504">2N3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-506">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="a2fd3-506">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="a2fd3-507">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-507">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="a2fd3-508">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-508">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="a2fd3-509">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-509">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="a2fd3-510">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-510">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="a2fd3-511">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-511">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="a2fd3-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="a2fd3-513">العناوين</span><span class="sxs-lookup"><span data-stu-id="a2fd3-513">Addresses</span></span>

<span data-ttu-id="a2fd3-514">يتطلب تعريف أكواد بلد أو منطقة وولاية وإقليم (بلدية) معينة تنسيقات معينة تستطيع Dayforce والموفرين في البلد/في المنطقة التعرف عليها.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="a2fd3-515">على الرغم من أن تنسيق المدن يعتبر مرنًا، يجب أن تكون كل مدينة مقترنة بولاية.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="a2fd3-516">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-516">Human Resources</span></span>          | <span data-ttu-id="a2fd3-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="a2fd3-518">البلد/المنطقة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-518">Country/Region</span></span>  | <span data-ttu-id="a2fd3-519">كود البلد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-519">Country Code</span></span>          |
| <span data-ttu-id="a2fd3-520">الرمز البريدي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-520">Zip/Postal Code</span></span> | <span data-ttu-id="a2fd3-521">الرمز البريدي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-521">Postal Code</span></span>           |
| <span data-ttu-id="a2fd3-522">المنطقة‬</span><span class="sxs-lookup"><span data-stu-id="a2fd3-522">State</span></span>           | <span data-ttu-id="a2fd3-523">كود الولاية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-523">State Code</span></span>            |
| <span data-ttu-id="a2fd3-524">المدينة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-524">City</span></span>            | <span data-ttu-id="a2fd3-525">المدينة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-525">City</span></span>                  |
| <span data-ttu-id="a2fd3-526">الإقليم</span><span class="sxs-lookup"><span data-stu-id="a2fd3-526">County</span></span>          | <span data-ttu-id="a2fd3-527">المقاطعة (بلدية)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-527">County (Municipality)</span></span> |
| <span data-ttu-id="a2fd3-528">الشارع</span><span class="sxs-lookup"><span data-stu-id="a2fd3-528">Street</span></span>          | <span data-ttu-id="a2fd3-529">سطر العنوان 1</span><span class="sxs-lookup"><span data-stu-id="a2fd3-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="a2fd3-530">مناطق الضريبة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-530">Tax regions</span></span>

<span data-ttu-id="a2fd3-531">تُستخدم مناطق الضريبة لتحديد الضريبة المناسبة التي يجب تطبيقها أثناء إنشاء كشف المرتبات.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="a2fd3-532">يتم تعيين مناطق الضريبة إلى Dayforce كعناوين موقع.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="a2fd3-533">يجب أن تكون منطقة الضريبة الافتراضية مقترنة بمنصب العامل النشط.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="a2fd3-534">منطقة الضريبة (مطلوبة)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-534">Tax region (required)</span></span>
- <span data-ttu-id="a2fd3-535">البلد/المنطقة (مطلوب)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-535">Country/Region (required)</span></span>
- <span data-ttu-id="a2fd3-536">الولاية (مطلوبة)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-536">State (required)</span></span>
- <span data-ttu-id="a2fd3-537">الإقليم</span><span class="sxs-lookup"><span data-stu-id="a2fd3-537">County</span></span> 
- <span data-ttu-id="a2fd3-538">المدينة (مطلوبة)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="a2fd3-539">تكوين بياناتك لإنشاء كشف المرتبات في المكسيك</span><span class="sxs-lookup"><span data-stu-id="a2fd3-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="a2fd3-540">إذا كنت تقوم بإنشاء الدفع للموظفين في المكسيك، يجب أن يتم تكوين العناصر التالية:</span><span class="sxs-lookup"><span data-stu-id="a2fd3-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="a2fd3-541">الأقسام مطلوبة على المناصب.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-541">Departments are required on positions.</span></span>
- <span data-ttu-id="a2fd3-542">يجب تعيين مراكز التكلفة كأبعاد مالية ويجب أن تكون العنصر الأول في سلسلة الأبعاد المالية الافتراضية.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="a2fd3-543">أنواع الوظيفة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-543">Job types</span></span>

<span data-ttu-id="a2fd3-544">يتم استخدام أنواع الوظائف لتجميع وظائف مماثلة في فئات.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="a2fd3-545">أنواع الوظائف مطلوبة لمعالجة كشف المرتبات في المكسيك.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="a2fd3-546">تتضمن أمثلة عن أنواع الوظائف الدوام الكامل والدوام الجزئي أو الراتب والدفع بالساعة.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="a2fd3-547">يتم تعيين أنواع الوظائف إلى Dayforce كأنواع دفع تشير إلى ما إذا كان الموظف يتقاضى أجره بالساعة أو يتقاضى راتبًا.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="a2fd3-548">أنواع الوظائف التالية وأوصافها مطلوبة.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="a2fd3-549">نوع الوظيفة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-549">Job type</span></span>   | <span data-ttu-id="a2fd3-550">الوصف</span><span class="sxs-lookup"><span data-stu-id="a2fd3-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="a2fd3-551">كل ساعة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-551">Hourly</span></span>     | <span data-ttu-id="a2fd3-552">الحد الأقصى للأجر في الساعة‬</span><span class="sxs-lookup"><span data-stu-id="a2fd3-552">MX Hourly</span></span>   |
| <span data-ttu-id="a2fd3-553">يتقاضى راتبًا</span><span class="sxs-lookup"><span data-stu-id="a2fd3-553">Salaried</span></span>   | <span data-ttu-id="a2fd3-554">الحد الأقصى للراتب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="a2fd3-555">أنواع المناصب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-555">Position types</span></span> 

<span data-ttu-id="a2fd3-556">يمكنك استخدام أنواع المناصب لوصف ما إذا كانت المناصب عبارة عن دوام كامل أو دوام جزئي أو شيء آخر.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="a2fd3-557">يتم تعيين أنواع المناصب إلى Dayforce كفئات دفع تشير إلى ما إذا كان الموظف يعمل بدوام كامل أو دوام جزئي.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="a2fd3-558">أنواع المناصب التالية وأوصافها مطلوبة.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="a2fd3-559">نوع المنصب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-559">Position type</span></span>   | <span data-ttu-id="a2fd3-560">الوصف</span><span class="sxs-lookup"><span data-stu-id="a2fd3-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="a2fd3-561">دوام كامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-561">Full-time</span></span>       | <span data-ttu-id="a2fd3-562">موظف بدوام كامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-562">Full time employee</span></span> |
| <span data-ttu-id="a2fd3-563">دوام جزئي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-563">Part-time</span></span>       | <span data-ttu-id="a2fd3-564">موظف بدوام جزئي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="a2fd3-565">رموز السبب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-565">Reason codes</span></span>

<span data-ttu-id="a2fd3-566">توفير أكواد الأسباب معلومات حول حالة الموظف.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="a2fd3-567">يتم تعيين أكواد الأسباب إلى Dayforce كأسباب الحالة للإشارة إلى السبب الذي يكمن خلف التغييرات في منصب الموظف أو حالة توظيفه.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="a2fd3-568">أكواد الأسباب التالية وأوصافها مطلوبة.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="a2fd3-569">رمز السبب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-569">Reason code</span></span>            | <span data-ttu-id="a2fd3-570">الوصف</span><span class="sxs-lookup"><span data-stu-id="a2fd3-570">Description</span></span>                    | <span data-ttu-id="a2fd3-571">السيناريوهات القابلة للتطبيق</span><span class="sxs-lookup"><span data-stu-id="a2fd3-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="a2fd3-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="a2fd3-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="a2fd3-573">المغادرة قبل كشف المرتبات الأول</span><span class="sxs-lookup"><span data-stu-id="a2fd3-573">Departure before first payroll</span></span> | <span data-ttu-id="a2fd3-574">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-574">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-575">الاستقالة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-575">RESIGNATION</span></span>            | <span data-ttu-id="a2fd3-576">الاستقالة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-576">Resignation</span></span>                    | <span data-ttu-id="a2fd3-577">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-577">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-578">المعاش</span><span class="sxs-lookup"><span data-stu-id="a2fd3-578">PENSION</span></span>                | <span data-ttu-id="a2fd3-579">المعاش</span><span class="sxs-lookup"><span data-stu-id="a2fd3-579">Pension</span></span>                        | <span data-ttu-id="a2fd3-580">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-580">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-581">إنهاء الخدمة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-581">TERMINATION</span></span>            | <span data-ttu-id="a2fd3-582">إنهاء الخدمة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-582">Termination</span></span>                    | <span data-ttu-id="a2fd3-583">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-583">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-584">التقاعد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-584">RETIREMENT</span></span>             | <span data-ttu-id="a2fd3-585">التقاعد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-585">Retirement</span></span>                     | <span data-ttu-id="a2fd3-586">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-586">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-587">الغائب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-587">ABSENTEE</span></span>               | <span data-ttu-id="a2fd3-588">الغائب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-588">Absentee</span></span>                       | <span data-ttu-id="a2fd3-589">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-589">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-590">‏‏غير ذلك</span><span class="sxs-lookup"><span data-stu-id="a2fd3-590">OTHER</span></span>                  | <span data-ttu-id="a2fd3-591">أسباب أخرى</span><span class="sxs-lookup"><span data-stu-id="a2fd3-591">Other Reasons</span></span>                  | <span data-ttu-id="a2fd3-592">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-592">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-593">إقفال</span><span class="sxs-lookup"><span data-stu-id="a2fd3-593">CLOSURE</span></span>                | <span data-ttu-id="a2fd3-594">إقفال الشركة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-594">Business Closure</span></span>               | <span data-ttu-id="a2fd3-595">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-595">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-596">الوفاة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-596">DEATH</span></span>                  | <span data-ttu-id="a2fd3-597">الوفاة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-597">Death</span></span>                          | <span data-ttu-id="a2fd3-598">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-598">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="a2fd3-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="a2fd3-600">إذن غياب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-600">Leave of Absence</span></span>               | <span data-ttu-id="a2fd3-601">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-601">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="a2fd3-602">CONTRACTEND</span></span>            | <span data-ttu-id="a2fd3-603">انتهاء العقد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-603">End of Contract</span></span>                | <span data-ttu-id="a2fd3-604">فصل العامل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-604">Terminate worker</span></span>     |
| <span data-ttu-id="a2fd3-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="a2fd3-605">SALARYCHANGE</span></span>           | <span data-ttu-id="a2fd3-606">تغيير الراتب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-606">Change of Salary</span></span>               | <span data-ttu-id="a2fd3-607">التعويض</span><span class="sxs-lookup"><span data-stu-id="a2fd3-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="a2fd3-608">شروط التوظيف</span><span class="sxs-lookup"><span data-stu-id="a2fd3-608">Terms of employment</span></span>

<span data-ttu-id="a2fd3-609">يتم استخدام شروط التوظيف لإنشاء فئات شروط التوظيف.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="a2fd3-610">يتم تعيين الشروط إلى Dayforce كقيم مؤشر التوظيف.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="a2fd3-611">شروط التوظيف التالية وأوصافها مطلوبة.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="a2fd3-612">شروط التوظيف</span><span class="sxs-lookup"><span data-stu-id="a2fd3-612">Terms of employment</span></span>   | <span data-ttu-id="a2fd3-613">الوصف</span><span class="sxs-lookup"><span data-stu-id="a2fd3-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="a2fd3-614">عادي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-614">Regular</span></span>               | <span data-ttu-id="a2fd3-615">عادي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-615">Regular</span></span>     |
| <span data-ttu-id="a2fd3-616">مباشر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-616">Direct</span></span>                | <span data-ttu-id="a2fd3-617">مباشر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-617">Direct</span></span>      |
| <span data-ttu-id="a2fd3-618">فترة تدريب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-618">Internship</span></span>            | <span data-ttu-id="a2fd3-619">فترة تدريب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-619">Internship</span></span>  |
| <span data-ttu-id="a2fd3-620">دائم</span><span class="sxs-lookup"><span data-stu-id="a2fd3-620">Permanent</span></span>             | <span data-ttu-id="a2fd3-621">دائم</span><span class="sxs-lookup"><span data-stu-id="a2fd3-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="a2fd3-622">الحالة الاجتماعية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-622">Marital status</span></span>

<span data-ttu-id="a2fd3-623">يتم تعيين قيم الحالة الاجتماعية إلى Dayforce وترجمتها، حسب الحاجة، إلى القيم المقبولة عند التكامل.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a2fd3-624">يعرض الجدول التالي كيفية تعيين قيم الحالة الاجتماعية إلى Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="a2fd3-625">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-625">Human Resources</span></span>                 | <span data-ttu-id="a2fd3-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="a2fd3-627">متزوج</span><span class="sxs-lookup"><span data-stu-id="a2fd3-627">Married</span></span>                | <span data-ttu-id="a2fd3-628">متزوج</span><span class="sxs-lookup"><span data-stu-id="a2fd3-628">Married</span></span>                   |
| <span data-ttu-id="a2fd3-629">أعزب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-629">Single</span></span>                 | <span data-ttu-id="a2fd3-630">أعزب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-630">Single</span></span>                    |
| <span data-ttu-id="a2fd3-631">أرمل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-631">Widowed</span></span>                | <span data-ttu-id="a2fd3-632">أرمل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-632">Widowed</span></span>                   |
| <span data-ttu-id="a2fd3-633">مطلق</span><span class="sxs-lookup"><span data-stu-id="a2fd3-633">Divorced</span></span>               | <span data-ttu-id="a2fd3-634">مطلق</span><span class="sxs-lookup"><span data-stu-id="a2fd3-634">Divorced</span></span>                  |
| <span data-ttu-id="a2fd3-635">شراكة مسجلة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-635">Registered Partnership</span></span> | <span data-ttu-id="a2fd3-636">الشراكة المحلية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="a2fd3-637">بلا</span><span class="sxs-lookup"><span data-stu-id="a2fd3-637">None</span></span>                   | <span data-ttu-id="a2fd3-638">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a2fd3-639">تعايش</span><span class="sxs-lookup"><span data-stu-id="a2fd3-639">Cohabiting</span></span>             | <span data-ttu-id="a2fd3-640">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="a2fd3-641">الجنس</span><span class="sxs-lookup"><span data-stu-id="a2fd3-641">Gender</span></span>

<span data-ttu-id="a2fd3-642">يتم تعيين الجنس إلى Dayforce وترجمته، حسب الحاجة، إلى القيم المقبولة عند التكامل.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a2fd3-643">يعرض الجدول التالي كيفية تعيين الجنس إلى Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="a2fd3-644">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-644">Human Resources</span></span>       | <span data-ttu-id="a2fd3-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="a2fd3-646">ذكر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-646">Male</span></span>         | <span data-ttu-id="a2fd3-647">ذكر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-647">Male</span></span>                      |
| <span data-ttu-id="a2fd3-648">أنثى</span><span class="sxs-lookup"><span data-stu-id="a2fd3-648">Female</span></span>       | <span data-ttu-id="a2fd3-649">أنثى</span><span class="sxs-lookup"><span data-stu-id="a2fd3-649">Female</span></span>                    |
| <span data-ttu-id="a2fd3-650">غير محدد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-650">Non-specific</span></span> | <span data-ttu-id="a2fd3-651">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="a2fd3-652">أسلوب الدفع</span><span class="sxs-lookup"><span data-stu-id="a2fd3-652">Payment method</span></span>

<span data-ttu-id="a2fd3-653">تقدم طرق دفع للموظف والشركة طريقة لوصف كيفية تسديد مرتبات وأجور الموظفين.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="a2fd3-654">يتم تعيين طرق الدفع إلى Dayforce وترجمتها، حسب الحاجة، إلى القيم المقبولة عند التكامل.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a2fd3-655">يعرض الجدول التالي كيفية تعيين طرق الدفع إلى Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="a2fd3-656">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-656">Human Resources</span></span>             | <span data-ttu-id="a2fd3-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="a2fd3-658">نقدي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-658">Cash</span></span>               | <span data-ttu-id="a2fd3-659">نقدي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-659">Cash</span></span>                      |
| <span data-ttu-id="a2fd3-660">دفع إلكتروني</span><span class="sxs-lookup"><span data-stu-id="a2fd3-660">Electronic Payment</span></span> | <span data-ttu-id="a2fd3-661">التحويل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-661">Transfer</span></span>                  |
| <span data-ttu-id="a2fd3-662">فحص</span><span class="sxs-lookup"><span data-stu-id="a2fd3-662">Check</span></span>              | <span data-ttu-id="a2fd3-663">شيك</span><span class="sxs-lookup"><span data-stu-id="a2fd3-663">Cheque</span></span>                    |
| <span data-ttu-id="a2fd3-664">حوالة مصرفية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-664">Bank Draft</span></span>         | <span data-ttu-id="a2fd3-665">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a2fd3-666">‏‏غير ذلك</span><span class="sxs-lookup"><span data-stu-id="a2fd3-666">Other</span></span>              | <span data-ttu-id="a2fd3-667">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="a2fd3-668">نوع الحساب البنكي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-668">Bank account type</span></span>

<span data-ttu-id="a2fd3-669">يتم استخدام أنواع الحسابات البنكية للدفع الإلكتروني للموظفين.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="a2fd3-670">يتم تعيين أنواع الحسابات البنكية إلى Dayforce كمعلومات حساب التحويل.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="a2fd3-671">وتتم ترجمة أنواع الحسابات البنكية، كما هو مناسب، إلى القيم المقبولة عند التكامل.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="a2fd3-672">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-672">Human Resources</span></span>            | <span data-ttu-id="a2fd3-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="a2fd3-674">حساب شيكات</span><span class="sxs-lookup"><span data-stu-id="a2fd3-674">Checking Account</span></span>  | <span data-ttu-id="a2fd3-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="a2fd3-675">CheckingAccount</span></span>           |
| <span data-ttu-id="a2fd3-676">حساب الراتب</span><span class="sxs-lookup"><span data-stu-id="a2fd3-676">Payroll Account</span></span>   | <span data-ttu-id="a2fd3-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="a2fd3-677">PayrollAccount</span></span>            |
| <span data-ttu-id="a2fd3-678">حساب توفير</span><span class="sxs-lookup"><span data-stu-id="a2fd3-678">Savings Account</span></span>   | <span data-ttu-id="a2fd3-679">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a2fd3-680">حساب BankGirot</span><span class="sxs-lookup"><span data-stu-id="a2fd3-680">BankGirot account</span></span> | <span data-ttu-id="a2fd3-681">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a2fd3-682">حساب PlusGirot</span><span class="sxs-lookup"><span data-stu-id="a2fd3-682">PlusGirot account</span></span> | <span data-ttu-id="a2fd3-683">*غير مدعوم بواسطة المكسيك*</span><span class="sxs-lookup"><span data-stu-id="a2fd3-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="a2fd3-684">أكواد الأرباح</span><span class="sxs-lookup"><span data-stu-id="a2fd3-684">Earning codes</span></span>

<span data-ttu-id="a2fd3-685">تحدد أكواد الأرباح بشكل فريد كل نوع من أنواع الأرباح التي يحصل عليها العاملون.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="a2fd3-686">تغطي الأكواد معلمات متنوعة ترتبط بالأرباح، مثل قواعد المحاسبة وقوانين الضرائب ومتطلبات إعداد التقارير وقدرات المبلغ الإجمالي.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="a2fd3-687">إذا تم استخدام تكرار غير معتمد، يُستخدم التكرار **كل عملية دفع** بشكل افتراضي للحساب.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="a2fd3-688">التكرارات المدعومة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-688">Supported frequencies</span></span>

- <span data-ttu-id="a2fd3-689">الكل</span><span class="sxs-lookup"><span data-stu-id="a2fd3-689">All</span></span>
- <span data-ttu-id="a2fd3-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="a2fd3-690">EVERYPAY</span></span>
- <span data-ttu-id="a2fd3-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="a2fd3-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="a2fd3-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="a2fd3-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="a2fd3-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="a2fd3-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="a2fd3-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-694">1OFMTH</span></span>
- <span data-ttu-id="a2fd3-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-695">LASTOFMTH</span></span>
- <span data-ttu-id="a2fd3-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-696">2OFMTH</span></span>
- <span data-ttu-id="a2fd3-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-697">3OFMTH</span></span>
- <span data-ttu-id="a2fd3-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-698">4OFMTH</span></span>
- <span data-ttu-id="a2fd3-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-699">5OFMTH</span></span>
- <span data-ttu-id="a2fd3-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-700">1N2OFMTH</span></span>
- <span data-ttu-id="a2fd3-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-701">3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-702">1N3OFMTH</span></span>
- <span data-ttu-id="a2fd3-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-703">1N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-704">2N3OFMTH</span></span>
- <span data-ttu-id="a2fd3-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-705">2N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="a2fd3-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a2fd3-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="a2fd3-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="a2fd3-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="a2fd3-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="a2fd3-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="a2fd3-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="a2fd3-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="a2fd3-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="a2fd3-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a2fd3-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="a2fd3-718">العناوين</span><span class="sxs-lookup"><span data-stu-id="a2fd3-718">Addresses</span></span>

<span data-ttu-id="a2fd3-719">يتطلب تعريف أكواد بلد أو منطقة وولاية وإقليم (بلدية) معينة تنسيقات معينة تستطيع Dayforce والموفرين في البلد/في المنطقة التعرف عليها.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="a2fd3-720">على الرغم من أن تنسيق المدن يعتبر مرنًا، يجب أن تكون كل مدينة مقترنة بولاية.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="a2fd3-721">الموارد البشرية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-721">Human Resources</span></span>              | <span data-ttu-id="a2fd3-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a2fd3-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="a2fd3-723">البلد/المنطقة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-723">Country/Region</span></span>      | <span data-ttu-id="a2fd3-724">كود البلد</span><span class="sxs-lookup"><span data-stu-id="a2fd3-724">Country Code</span></span>          |
| <span data-ttu-id="a2fd3-725">الرمز البريدي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-725">Zip/Postal Code</span></span>     | <span data-ttu-id="a2fd3-726">الرمز البريدي</span><span class="sxs-lookup"><span data-stu-id="a2fd3-726">Postal Code</span></span>           |
| <span data-ttu-id="a2fd3-727">المنطقة‬</span><span class="sxs-lookup"><span data-stu-id="a2fd3-727">State</span></span>               | <span data-ttu-id="a2fd3-728">كود الولاية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-728">State Code</span></span>            |
| <span data-ttu-id="a2fd3-729">المدينة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-729">City</span></span>                | <span data-ttu-id="a2fd3-730">المدينة</span><span class="sxs-lookup"><span data-stu-id="a2fd3-730">City</span></span>                  |
| <span data-ttu-id="a2fd3-731">الإقليم</span><span class="sxs-lookup"><span data-stu-id="a2fd3-731">County</span></span>              | <span data-ttu-id="a2fd3-732">المقاطعة (بلدية)</span><span class="sxs-lookup"><span data-stu-id="a2fd3-732">County (Municipality)</span></span> |
| <span data-ttu-id="a2fd3-733">الشارع</span><span class="sxs-lookup"><span data-stu-id="a2fd3-733">Street</span></span>              | <span data-ttu-id="a2fd3-734">سطر العنوان 1</span><span class="sxs-lookup"><span data-stu-id="a2fd3-734">Address Line 1</span></span>        |
| <span data-ttu-id="a2fd3-735">رقم الشارع</span><span class="sxs-lookup"><span data-stu-id="a2fd3-735">Street Number</span></span>       | <span data-ttu-id="a2fd3-736">سطر العنوان 2</span><span class="sxs-lookup"><span data-stu-id="a2fd3-736">Address Line 2</span></span>        |
| <span data-ttu-id="a2fd3-737">ملحق المبنى</span><span class="sxs-lookup"><span data-stu-id="a2fd3-737">Building Complement</span></span> | <span data-ttu-id="a2fd3-738">سطر العنوان 5</span><span class="sxs-lookup"><span data-stu-id="a2fd3-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="a2fd3-739">رقم جواز السفر</span><span class="sxs-lookup"><span data-stu-id="a2fd3-739">Passport number</span></span>

<span data-ttu-id="a2fd3-740">بإمكان الموظفين إعلان معلومات جواز السفر.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-740">Employees can declare passport information.</span></span> <span data-ttu-id="a2fd3-741">هذه المعلومات هي نوع من أنواع تعريف **جواز السفر** وهي تتكامل في Dayforce كجزء من معلومات الموظف خاصة بالمكسيك.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="a2fd3-742">نوع التعريف = "جواز سفر"</span><span class="sxs-lookup"><span data-stu-id="a2fd3-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="a2fd3-743">تاريخ الإصدار</span><span class="sxs-lookup"><span data-stu-id="a2fd3-743">Issued Date</span></span>
- <span data-ttu-id="a2fd3-744">تاريخ انتهاء الصلاحية</span><span class="sxs-lookup"><span data-stu-id="a2fd3-744">Expiration Date</span></span>

<span data-ttu-id="a2fd3-745">بإمكان الموظفين الإعلان عن أرقام تعريف متعددة من نوع التعريف **جواز سفر**.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="a2fd3-746">ومع ذلك، يتم دمج إدخال جواز السفر النشط الحالي فقط في Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="a2fd3-747">إذا انتهت صلاحية جميع إدخالات جوازات السفر، فسيتكامل جواز السفر الذي تم إصداره مؤخرًا في Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a2fd3-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
