...
## <a name="cant-remove-activities-from-performance-review-form-403542"></a>لا يمكن إزالة أنشطة من نموذج مراجعة الأداء (403542)

يمكنك الآن حذف الأنشطة المحددة باستخدام الزر **إزالة** في نموذج **مراجعة الأداء**.
