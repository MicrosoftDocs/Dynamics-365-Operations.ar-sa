...
description: توضح هذه المقالة كيفية إعداد معلمات الموارد البشرية الخاصة بالشركة في Dynamics 365 Human Resources.
author: twheeloc
ms.date: 11/03/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9065633"
---
# <a name="configure-human-resources-parameters"></a>تكوين معلمات Human Resources

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

تتم مشاركة إعدادات بعض معلمات الموارد البشرية بين الشركات، بينما تكون إعدادات المعلمات الأخرى خاصة بكل شركة. توضح هذه المقالة كيفية إعداد معلمات الموارد البشرية الخاصة بالشركة.

يتم استخدام صفحتين لتعيين معلمات الموارد البشرية. وبالنسبة للمعلمات التي تتم مشاركتها بين الشركات، تستخدم صفحة **المعلمات المشتركة للموارد البشرية**. بالنسبة للمعلمات الخاصة بالشركة ، يمكنك استخدام ملحق **معلمات الموارد البشرية** صفحة.
...
> [!NOTE]
> في البنية التحتية المدمجة ، تمت أزاله معلمه العملة الافتراضية **الموجودة في** علامة التبويب التعويض **في صفحه معلمات** الموارد **البشرية**. الانتقال إلى الامام ، ستتم معالجه العملة بواسطة معلمه عمله **دفتر الأستاذ** لضمان عدم وجود إيه تعارضات لهذه الميزة المالية ووظائف العمليات ولمنع التكرار. لمزيد من المعلومات حول كيفية استخدام وظيفة عملة دفتر الأستاذ [تكوين دفاتر الأستاذ](/general-ledger/configure-ledger#configuring-currencies-for-the-ledger.md). 
...
- المعلومات التي يمكن للمديرين عرضها في السجلات المنتهية الصلاحية
