...
- **تحديثات الخدمة**: تتم التحديثات كل أسبوعين وتشمل إصلاحات الأخطاء والميزات الجديدة. تتضمن تحديثات الخدمة أيضًا تحديثات النظام الأساسي القابلة للتطبيق عند إصدارها. لمزيد من المعلومات حول إصدارات النظام الأساسي، راجع [الجديد أو المتغير في تحديثات النظام الأساسي](../fin-ops-core/dev-itpro/get-started/whats-new-home-page.md). التحديثات لها طرح عالمي مرحلي عبر المناطق. لمزيد من المعلومات حول التحديثات ، راجع [راجع ما هو الجديد أو المتغير في Dynamics 365 Human Resources](hr-admin-whats-new.md).
