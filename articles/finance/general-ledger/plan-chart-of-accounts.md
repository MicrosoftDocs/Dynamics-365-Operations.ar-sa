...
description: توفر هذه المقالة معلومات ستساعدك على وضع تخطيط لدليل الحسابات في مؤسستك.
author: aprilolson
ms.date: 04/02/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9070623"
---
# <a name="plan-your-chart-of-accounts"></a>تخطيط دليل الحسابات

[!include [banner](../includes/banner.md)]

توفر هذه المقالة معلومات ستساعدك على وضع تخطيط لدليل الحسابات في مؤسستك.
...
> [!NOTE]
> في Dynamics 365 Finance الإصدار 8.0 (أبريل 2018)، يمكنك تعديل مخطط مخطط الحسابات من ملف **معلمات دفتر الأستاذ العام** صفحة.
