...
بداية من الإصدار 10.0.7، تم إدخال مفهوم تواريخ انتهاء الصلاحية. سوف يتم تمكين ميزة مطلوبة جديدة في مساحة عمل إدارة الميزة. تحتوي هذه الميزة على التغييرات التالية:
...
عندما يتم تحديد انتهاء صلاحية في خيار 90 يومًا، يتم تطبيق 90 يومًا اعتبارًا من اليوم، وهو سلوك مختلف عن 90 يومًا من تاريخ الإنشاء الأصلية المُعين عند إنشاء التقرير. تم تقديم مفهوم تواريخ انتهاء الصلاحية في الإصدار 10.0.8. تم تمكين ميزة جديدة مطلوبة في صفحة **الكل** ضمن مساحة عمل إدارة الميزات. تحتوي ميزة **سياسات الاحتفاظ بالتقرير المالي** على التغييرات التالية:
* وسوف يتم تمييز التقارير التي تم إنشاؤها حديثًا تلقائيًا على أن تاريخ انتهاء صلاحيتها 90 يومًا من تاريخ إنشائها.
* سوف يتم منح أي تقارير موجودة قبل تثبيت الميزة فترة انتهاء صلاحية 90 يومًا.  قد يظهر التاريخ فارغًا لفترة قصيرة من الزمن حتى يتم تشغيل خدمة التقارير المالية وإنشاء التقرير وتقوم الخدمة بتنفيذ التحديث إلى التقارير الموجودة بتاريخ انتهاء صلاحية فارغ. 
* يكون للمستخدمين الذين لديهم ميزة **الحفاظ على أمان التقرير المالي** الوصول إلى هذه الوظيفة. وسوف يكون أيضًا لأي مستخدم في واجب **الحفاظ على التقرير المالي** ممنوح امتياز **الحفاظ على انتهاء صلاحية التقرير المالي** القدرة على تعديل فترة انتهاء الصلاحية. يوجد حاليًا خياران احتفاظ متاحين: 
  * انتهاء صلاحية مدته 90 يومًا.
...
عندما يتم تحديد انتهاء صلاحية في خيار 90 يومًا، فإنه يُمنح 90 يومًا من اليوم، وهو سلوك مختلف عن 90 يومًا من تاريخ الإنشاء الأصلية المُعين خلال إنشاء التقرير. 
