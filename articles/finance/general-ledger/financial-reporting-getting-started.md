...
بداية من الإصدار 10.0.7، تم إدخال مفهوم تواريخ انتهاء الصلاحية. سوف يتم تمكين ميزة إلزامية جديدة في مساحة عمل إدارة الميزة. تحتوي هذه الميزة على التغييرات التالية:
...
* يكون للمستخدمين الذين لديهم ميزة **الحفاظ على أمان التقرير المالي** الوصول إلى هذه الوظيفة. وسوف يكون أيضًا لأي مستخدم في واجب **الحفاظ على التقرير المالي** ممنوح امتياز **الحفاظ على انتهاء صلاحية التقرير المالي** القدرة على تعديل فترة انتهاء الصلاحية. حاليًا يوجد خيارين احتفاظ متاحين- 
