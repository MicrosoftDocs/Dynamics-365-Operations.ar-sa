...
تتوفر مهام Financial reporting للمستخدمين الذين تم تعيين الامتيازات والواجبات المناسبة لهم من خلال أدوار الأمان الخاصة بهم. تسرد الأقسام التالية هذه الامتيازات والواجبات، جنبًا إلى جنب مع الأدوار المرتبطة بها.
...
> 1.    نسخ الملف RegisterETW.zip إلى محطة عمل العميل (ويفضل سطح المكتب) واستخراج [RegisterETW.zip](https://dev.azure.com/msdyneng/e6f12261-a46a-4af1-ac0c-e22bc2c5a478/_apis/git/repositories/ff923027-67f0-43fb-b63c-6d6b6423840f/Items?path=%2F.attachments%2FRegisterETW-c1a35291-6aa6-4462-a2bc-4ba117fd5f8e.zip&download=false&resolveLfs=true&%24format=octetStream&api-version=5.0-preview.1&sanitize=true&versionDescriptor.version=wikiMaster).
...
إعادة فتح عارض الأحداث وسترى الآن هذه السجلات تحت **Microsoft > Dynamics**: * MR-Client * MR-DVT * MR-Integration * MR-Logger * MR-Reporting * MR_SchedulerTasks * MR-Sql * MR-TraceManager
...
* العمل مع مستخدم لديه حقوق مسؤول الأمان في Dynamics 365 Finance ، وحقوق المسؤول إلى مجال شبكة الاتصال لتسجيل الدخول إلى محطة العمل لمعرفة ما إذا كان يمكن الاتصال. إذا كان بإمكانهم الاتصال، فقد تكون المشكلة متعلقة بأذونات الشبكة.
