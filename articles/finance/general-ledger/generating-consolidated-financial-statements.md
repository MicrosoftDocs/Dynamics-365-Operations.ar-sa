...
description: تصف هذه المقالة السيناريوهات المختلفة التي قد تقوم فيها بإنشاء قوائم مالية مدمجة.
author: aprilolson
ms.date: 07/09/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8846788"
---
# <a name="generate-consolidated-financial-statements"></a>إنشاء قوائم مالية مدمجة

[!include [banner](../includes/banner.md)]

تصف هذه المقالة السيناريوهات المختلفة التي قد تقوم فيها بإنشاء قوائم مالية مدمجة.
...
> [!TIP]
> للحصول على مزيد من المعلومات حول كيفية إنشاء وإدارة تعريفات الصفوف وتعريفات الأعمدة وأشجار التقارير، راجع [مكونات التقارير المالية](../../fin-ops-core/dev-itpro/analytics/financial-report-components.md).
...
![تجميع مستوى ملخص المبلغ.](./media/consolidate-amount-summary-level.png "تجميع مستوي ملخص المبلغ")
...
![تعريف شجرة التقارير متعددة المستويات مع التجميع حسب المنطقة.](./media/multilevel-reporting-tree-definition-roll-ups-worldwide-region.png "تعريف شجره التقارير متعددة المستويات مع التجميع حسب المنطقة")

يبين الرسم التوضيحي التالي تعريف شجرة تقارير متعددة المستويات لديها تجميعات حسب الوظائف.

![تعريف شجرة التقارير متعددة المستويات مع التجميع حسب الوظيفة.](./media/multilevel-reporting-tree-definition-roll-ups-by-function.png "تعريف شجره التقارير متعددة المستويات مع التجميع حسب الوظيفة")
...
![بيان الدخل للتقرير الموحد.](./media/consolidated-report-income-statement.png "بيان الدخل للتقريرالموحد")
...
![إظهار الملكية كصف منفصل في تقرير موحد.](./media/Showing-ownership-separate-row-consolidated-report.png "إظهار الملكية كصف منفصل في تقرير مدمج")
...
![رقم فترة تعريف تقرير الخيارات.](./media/options-report-definition-period-number.png "رقم فتره تعريف تقرير الخيارات")

## <a name="business-unit-consolidations"></a>عمليات دمج وحدات الأعمال
تركز هذه المقالة على تعريفات شجرة التقارير والتدرجات الهرمية للمؤسسات في التقارير المالية لأغراض تتعلق بعمليات الدمج. يمكنك أيضًا استخدام شجرة التقارير لإنشاء تقارير تتعلق بدمج وحدات الأعمال، مثل التقارير حول المبيعات أو العمليات في جميع أنحاء العالم. وتعتبر هذه التقارير من المتطلبات العامة. لإنشائها، حدد شركة وبُعدًا لكل وحدة تريد إجراء الدمج عليها. على سبيل المثال، في الرسم التوضيحي التالي، تم الحصول على تجميع وحدات الأعمال عن طريق تكرار كل شركة في عمود **الشركة** (العمود A) وتحديد مجموعة من قيم أبعاد القسم لكل شركة في عمود **البُعد** (العمود D).
...
- ضع كافة الحسابات في نطاق، من الأصول إلى المصروفات. كما هو مبين في الرسم التوضيحي التالي، سيكون الفرق المبلغ نفسه كما في تعديل التقريب. وبالتالي، يمكنك استخدامه كفحص إجمالي للتأكد من أن صفحة تعديل التقريب لا تتضمن أي أرصدة حسابات تم تجاهلها.
    ...
    ![التحقق من نموذج تسوية التقريب.](./media/rounding-adjustment-form-check.png "التحقق من نموذج تسويه التقريب")
