...
لتكوين بنيات الحساب لدفتر الأستاذ الخاص بك، في الصفحة **دفتر الأستاذ**، في علامة التبويب السريعة **بنيات الحساب**، حدد **إضافة**، وحدد بنية حساب في القائمة، ثم حدد **تحديد**. سيستغرق الأمر بضع دقائق حتى تتم إضافة بنية الحساب وحفظها. عند حفظ بنيه الحساب المتغيرة إلى دفتر الأستاذ ، ستبدا عملية مزامنة كافة الحركات غير المُرحلة. يجب الانتظار حتى اكتمال التغيير لدفتر الأستاذ الحالي في الكيان القانوني حيث يتم اجراء التغيير قبل أن تتمكن من إجراء تغيير في بنية الحساب لدفتر الأستاذ في كيان قانوني آخر. لاحظ أن بنيات الحساب التي تحددها يجب أن تكون نشطة. وبخلاف ذلك، لن تكون تفاصيل بنيات الحسابات فعالة في الكيانات القانونية حيث ترتبط بها.
