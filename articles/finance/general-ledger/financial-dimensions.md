...
description: تصف هذه المقالة مختلف أنواع الأبعاد المالية وكيفية إعدادها.
author: aprilolson
ms.date: 03/07/2022
ms.topic: article
ems.prod: ''
...
ms.locfileid: "9799616"
---
# <a name="financial-dimensions"></a>الأبعاد المالية

[!include [banner](../includes/banner.md)]

تصف هذه المقالة مختلف أنواع الأبعاد المالية وكيفية إعدادها.
...
## <a name="financial-dimension-service"></a>خدمة البعد المالي

تتوفر الوظيفة الإضافية لخدمة البعد المالي في بيئة Microsoft Dynamics Lifecycle Services الخاصة بك. يوفر أداءً محسنًا عند استخدام إطار عمل إدارة البيانات لاستيراد دفتر يومية يحتوي على عدد كبير من البنود. لاستخدام الخدمة، يجب تمكينها في صفحة **معلمات خدمة الأبعاد المالية**. حاليًا، تعمل الخدمة فقط على المجلات المستوردة التي تحتوي على 500 بند أو أكثر. بالإضافة إلى ذلك، يمكنه حاليًا معالجة المجلات العامة فقط حيث يتم تعيين نوع حساب **دفتر الأستاذ** في بنود دفتر اليومية. أنواع الحسابات الأخرى في بنود دفتر اليومية، مثل **العميل** و **المورد** و **البنك**، غير مدعومة حاليًا. لن يتم استدعاء هذه الخدمة عند إعداد الأبعاد المشتقة في النظام.

توفر خدمة البعد المالي أداءً محسنًا عند استيراد دفاتر اليومية باستخدام خدمة جديدة تعمل بالتوازي مع استيراد البيانات. يتم تشغيله فقط على الحساب الرئيسي وبيانات البعد المالي في دفتر اليومية، ويقوم بإنشاء مجموعات الأبعاد المحددة في حقل سلسلة حساب دفتر الأستاذ في بنود دفتر اليومية. تحول المعالجة هذه السلسلة إلى تخزين البيانات المنظمة الذي يستخدمه إطار عمل البعد المالي في بقية المنتج للتحقق من الصحة وإعداد التقارير الموجزة والاستفسارات. لمزيد من المعلومات حول التقارير الموجزة لبيانات الأبعاد المالية، راجع [مجموعات الأبعاد المالية](financial-dimension-sets.md).
