...
يتم استخدام قواعد توزيع دفتر الأستاذ لحساب وإنشاء دفاتر يومية التوزيع وإدخالات الحسابات لتوزيع أرصدة دفتر الأستاذ أو المبالغ الثابتة تلقائيًا. وقد تكون طرق التوزيع متغيرة أو ثابتة. يعتمد التخصيص على قيمة عملة المعاملة. على سبيل المثال، يتم ترحيل إدخالات محاسبة مكاسب / خسائر العملات الأجنبية لتعديل مبالغ عملة التقارير والمحاسبة. لا تخضع هذه الإدخالات لقواعد التخصيص لأن قيمة عملة الحركة الخاصة بها هي 0.00. ويمكن استخدام طرق التوزيع التالية لقواعد توزيع دفتر الأستاذ:
