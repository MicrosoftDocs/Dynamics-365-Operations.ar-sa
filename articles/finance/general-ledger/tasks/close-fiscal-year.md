...
إذا تم تعيين الخيار إلى **نعم**، فسيتم تعيين حالة السنة المالية إلى **تم الإقفال بشكل دائم**. ونظرًا لتعذر إعادة فتح سنة مقفلة بشكل دائم، فمن الأفضل تعيين هذا الخيار إلى **لا**.  
