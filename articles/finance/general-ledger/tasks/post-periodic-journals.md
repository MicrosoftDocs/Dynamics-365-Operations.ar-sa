...
7. في حقل **التاريخ**، أدخل تاريخًا. يحتوي حقل **التاريخ** على تاريخ الترحيل لعملية التحويل التالية إلى دفتر اليومية اليومي. بالنسبة إلى المجلات التي سيتم استردادها كل شهر، يوصى باستخدام التاريخ في الشهر الذي سيتم فيه ترحيلها. عادة ما يكون هذا هو التاريخ الأول أو الأخير في الفترة. باستخدام حقل **التاريخ الفارغ**، يمكن ترك حقل **التاريخ** فارغًا وإعطاء تاريخ عند استرجاع دفتر اليومية. سيتم تحديث الحقل وفق التاريخ المتكرر التالي عندما يتم استرجاع المعاملات. 
...
26. في الحقل **إلى تاريخ**، أدخل تاريخًا. يعمل الخيار **إلى ‏‏تاريخ** بمثابة تاريخ الانقطاع لبنود الإيصال الدورية. استنادًا إلى إعداد التكرار، قد يتم تضمين **آخر تاريخ** و **إلى تاريخ** على البند نفسه أكثر من مرة في دفتر اليومية الناتج. يتم تحديث **التاريخ إلى** تلقائيًا استنادًا إلى تاريخ الجلسة في المرة الأخيرة التي تم فيها تحويل البند الدوري إلى دفتر يومية. 
