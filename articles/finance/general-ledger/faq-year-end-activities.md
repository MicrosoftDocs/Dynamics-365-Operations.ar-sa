...
description: يسرد هذا الموضوع الأسئلة التي يمكن أن تظهر عند إقفال السنة، والإجابات التي يمكن أن تساعد في أنشطة إقفال نهاية السنة.
author: moaamer
ms.date: 12/21/2021
ms.topic: index-page
ms.prod: ''
...
يسرد هذا الموضوع الأسئلة التي يمكن أن تظهر عند إقفال السنة، والإجابات التي يمكن أن تساعد في أنشطة إقفال نهاية السنة. تركز المعلومات الموجودة في هذا الموضوع بشكل أساسي على الأسئلة المتعلقة بأنشطة إقفال نهاية السنة لدفتر الأستاذ العام والحسابات الدائنة.
