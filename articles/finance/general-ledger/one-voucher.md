...
- قم بإعداد اسم دفتر اليومية (**دفتر الأستاذ العام** \> **إعداد دفتر اليومية** \> **أسماء دفاتر اليومية**) حتى يتم تعيين الحقل **إيصال جديد** إلى **رقم إيصال واحد فقط**. يتم الآن تضمين كل بند تضيفه إلى دفتر اليومية في الإيصال نفسه. وبالتالي، يمكن إدخال الإيصال كإيصال متعدد البنود، كحساب/ حساب مقابل في البند نفسه أو كمجموعة.
    ...
    > [!IMPORTANT]
    > **لا** يتضمن تعريف "الإيصال الواحد" الحالات التي تم فيها إعداد أسماء دفاتر اليومية على أنها **رقم إيصال واحد فقط**، ولكن يقوم المستخدم عندئذٍ بإدخال إيصال يتضمن أنواع حسابات دفتر الأستاذ فقط. في هذه المقالة، الإيصال الواحد يعني أنه يوجد إيصال واحد يحتوي على أكثر من مورّد أو عميل أو بنك أو أصل ثابت أو مشروع.
...
- **إصدار ربيع 2018** – تم إيقاف هذه الوظيفة عن التشغيل بشكل افتراضي من خلال المعلمة **السماح بحركات متعددة في إيصال واحد‬** على علامة التبويب **عام** في صفحة **معلمات دفتر الأستاذ العام**. ومع ذلك، يمكنك إعادة تشغيله إذا كان لدى مؤسستك سيناريو يقع في إحدى الفجوات الوظيفية المذكورة لاحقاً في هذه المقالة.

    - إذا لم يطلب سيناريو العمل الخاص بك إيصال واحد، فإننا نوصي بأن تترك الوظيفة متوقفة عن العمل. إذا كنت تستخدمها حتى في حالة وجود حل آخر، فلن تقوم Microsoft بإصلاح "الأخطاء" في النواحي التي تم تحديدها لاحقاً في هذه المقالة.
...
يعتبر الإهلاك الخاص بالإيصال الواحد تغييرًا كبيرًا سيتم الإبلاغ عنه على نطاق واسع. وكجزء من ذلك الاتصال، ستقوم Microsoft بتحديث هذه المقالة، ونشر مدونة على Microsoft Dynamics 365 Finance وتحديث مقالة "الميزات المزالة والمهملة" والتواصل بشأن التغيير في مؤتمرات Microsoft المناسبة، وما إلى ذلك.
...
مع الإصدار 10.0.21 والإصدارات الأحدث، سيتم إنشاء حركات الأصول الثابتة لاستهلاك الإهلاك، وتقسيم الأصل، وحساب الإهلاك للتخلص من الأصل باستخدام أرقام إيصالات مختلفة.
