...
description: توفر هذه المقالة معلومات عن قواعد الاستبعاد والخيارات المختلفة لعمل التقارير عن عمليات الاستبعاد.
author: aprilolson
ms.date: 01/11/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864299"
---
# <a name="elimination-rules"></a>قواعد الاستبعاد

[!include [banner](../includes/banner.md)]

توفر هذه المقالة معلومات عن قواعد الاستبعاد والخيارات المختلفة لعمل التقارير عن عمليات الاستبعاد.
...
تركز هذه المقالة على قواعد الاستبعاد التي تمت معالجتها في شركة الدمج أو الاستبعاد. يمكنك إعداد قواعد الاستبعاد لإنشاء حركات استبعاد في كيان قانوني محدد على انه كيان قانوني الوجهة لعمليات الاستبعاد. كما يُعرف الكيان القانوني الوجهة بالكيان القانوني لعملية الاستبعاد. يمكن إنشاء دفاتر يومية الاستبعاد إما أثناء عملية التجميع أو عن طريق استخدام مُقترح دفتر يومية الاستبعاد. قبل إعداد قواعد الاستبعاد، يجب التعرف أولاً على المصطلحات التالية:
