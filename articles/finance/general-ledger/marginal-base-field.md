...
description: توضح هذه المقالة كيف تحدد القيم في القاعدة الهامشية للحقول وأسلوب الحساب معدل الضريبة في معاملات المبيعات والمشتريات.
author: kailiang
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
توضح هذه المقالة كيف تحدد القيم في القاعدة الهامشية للحقول وأسلوب الحساب معدل الضريبة في معاملات المبيعات والمشتريات.
