...
description: توفر هذه المقالة معلومات عن العملة المزدوجة حيث تُستخدم عملة التقارير كعملة محاسبة ثانية لتطبيق Microsoft Dynamics 365 Finance.
author: kweekley
ms.date: 04/17/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9065735"
---
# <a name="dual-currency"></a>العملة المزدوجة

[!include [banner](../includes/banner.md)]

تسمح الوظيفة التي تم تقديمها في الإصدار 8.1 من Microsoft Dynamics 365 Finance (أكتوبر 2018) بتغيير الغرض من عملة التقارير واستخدامها كعملة محاسبة ثانية. يشار إلى هذه الوظيفة باسم *العملة المزدوجة*. لا يمكن إيقاف تشغيل تغييرات العملة المزدوجة من خلال مفتاح أو معلمة تكوين. ونظرًا لاستخدام عملة التقارير كعملة محاسبة ثانية، طرأ تغيير على طريقة حساب عملة التقارير في منطق الترحيل.
...
بعد الترقية، يجب إكمال خطوات معينة لإدارة النقد والبنوك‬ والأصول الثابتة. لذلك، احرص على قراءة وفهم الأقسام ذات الصلة بهذه المقالة.
...
- أعادت عملية إعادة تقييم العملة الأجنبية تقييم المبالغ بعملة التقارير. ومع ذلك، يتم الآن حساب عملة التقارير من خلال مبلغ عملة المعاملة، كما ورد في مقطع [عملية الترحيل](#posting-process) سابقًا في هذه المقالة.
...
وظيفة تم تقديمها في الإصدار 10.0.5 (أكتوبر 2019) من Dynamics 365 Finance تمكّن الوظيفة عبر إدارة الميزات للحصول على مرونة محسنة للدمج والعملة المزدوجة. لتمكين هذه الوظيفة، انتقل إلى مساحة عمل **إدارة الميزات** وحدد **تمكين وظيفة العملة المزدوجة في توحيد دفتر الأستاذ العام‬**.
