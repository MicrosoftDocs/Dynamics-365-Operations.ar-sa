...
يتم تمكين الميزات الجديدة حاليًا لعملاء المعاينة الخاصة. لتمكين الميزات، قم برفع طلب الخدمة من خلال القنوات المطابقة إلى Microsoft.
...
لمنع السيناريو السابق، نوصي بتغيير قيمة هذه المعلمة في فترة تسوية ضرائب جديدة (نظيفة) لا تحتوي علي أية حركات ضريبة لم تتم تسويتها. لتغيير هذه القيمة في منتصف فترة تسوية ضريبة، يُرجى تشغيل برنامج "تسوية ضريبة المبيعات وترحيها" لفترة تسوية الضرائب الحالية قبل تغيير قيمة المعلمة هذه.
