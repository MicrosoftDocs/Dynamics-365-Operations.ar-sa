...
description: توفر هذه المقالة نظرة عامة على عملية إعادة تقييم العملة الأجنبية لدفتر الأستاذ العام- الإعداد وتشغيل العملية وحساب العملية وكيفية عكس معاملات إعادة التقييم، إذا لزم الأمر.
author: kweekley
ms.date: 11/15/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9779978"
---
# <a name="foreign-currency-revaluation-for-general-ledger"></a>إعادة تقييم العملة الأجنبية لدفتر الأستاذ العام

[!include [banner](../includes/banner.md)]

توفر هذه المقالة نظرة عامة على عملية إعادة تقييم العملة الأجنبية لدفتر الأستاذ العام- الإعداد وتشغيل العملية وحساب العملية وكيفية عكس معاملات إعادة التقييم، إذا لزم الأمر. 
...
حدد الحسابات الرئيسية لإعادة تقييمها: الكل أو الميزانية العمومية أو الأرباح والخسائر. وسوف يعاد تقييم الحسابات الرئيسية المحددة لإعادة التقييم فقط (في صفحة **الحساب الرئيسي** ). إذا كنت ترغب في تقييد نطاق الحسابات الرئيسية كذلك، استخدام علامة تبويب **السجلات المراد تضمينها** لتحديد نطاق الحسابات الرئيسية أو الحسابات الفردية الرئيسية. 
...
إذا كنت ترغب في استبعاد التعديلات التي تم ترحيلها باستخدام **‏‫ترحيل دفتر يومية تسويات عملة التقارير‬** من عملية إعادة التقييم، فقم بتعيين **‏‫استبعاد تسويات عملة التقارير** إلى **نعم**. افتراضيًا، يتم تضمين تعديلات عملة التقارير في إعادة التقييم. 
...
|--------------------|---------------------------|----------------------------------|------------------------------------|-----------------------------|
| 500 يورو            | 1000 دولار أمريكي                  | 166.6667                         | 833.33 دولار أمريكي (500 x 1.666667)        | 166.67 خسارة (833.33 – 1000) |
