---
title: شروط التوزيع
description: توفر هذه المقالة معلومات عن استخدام شروط التخصيص على حساب رئيسي.
...
ms.locfileid: "8859816"
---
# <a name="allocation-terms"></a>شروط التوزيع

[!include [banner](../includes/banner.md)]

توفر هذه المقالة معلومات عن استخدام شروط التخصيص على حساب رئيسي. تستخدم شروط التوزيع لتوزيع مبالغ عبر مجموعات متعددة من حسابات دفتر الأستاذ. وهي تساعد على ضمان تحميل النفقات أو الإيرادات للكائن الصحيح في المحاسبة.
