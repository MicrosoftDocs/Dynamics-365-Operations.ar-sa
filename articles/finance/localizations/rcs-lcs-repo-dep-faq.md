...
- دفع التكوينات مباشره من مصمم RCS إلى تطبيق متصل ، مثل بيئة Dynamics 365 Finance، بحيث يمكنك اجراء تغييرات علي التكوينات واختبارها بسرعة.
...
يتم توفير RCS ومستودع العولمة مجانا كجزء من تراخيص تطبيق Finance and Operations الموجودة. ولا تقترن إيه تكاليف منفصلة باستخدام خدمه التصميم RCS أو تخزين التكوينات في المستودع العمومي. لا يوجد حاليا اي حد لعدد التكوينات أو التطبيقات المتصلة.
