...
عملية إعداد ميزة الفوترة الإلكترونية هي عملية إنشاء التكوين المطلوب عبر بيئة Regulatory Configuration Services (RCS) ونشر هذا التكوين في خادم الفوترة الإلكترونية. يتيح لك الإعداد إنشاء القواعد القابلة للتكوين التي تمكّن الفوترة الإلكترونية من استخدام بروتوكول آمن عبر الإنترنت للاتصال وتبادل البيانات مع كيان خارجي من خلال خدمات الويب.
...
"ميزة الفوترة الإلكترونية" هي الاسم العام للمورد الذي تم تكوينه ونشره لاستهلاك خادم الفوترة الإلكترونية. يجمع إعداد الميزة، من ضمن أشياء أخرى، استخدام تنسيقات تكوين التقارير الإلكترونية لإنشاء ملفات تصدير واستيراد قابلة للتكوين، واستخدام إجراءات وسير مهام إجراءات لتمكين إنشاء قواعد قابلة للتكوين لإرسال الطلبات واستيراد الاستجابات وتحليل محتويات الاستجابات.
...
## <a name="set-up-the-electronic-invoicing-feature"></a>إعداد ميزة الفوترة الإلكترونية

يجب إكمال عملية الإعداد في بيئة RCS. اتبع الخطوات التالية لإنشاء ميزة الفوترة الإلكترونية الجديدة.
...
تحتوي التكوينات على تكوينات تنسيقات التقارير الإلكترونية المطلوبة لعمليات التحويل ولإنشاء الملفات التي سيتم تبادلها أثناء الاتصال بخدمات ويب خارجية. بإمكان ميزة الفوترة الإلكترونية أن تتضمن العدد المطلوب من تكوينات تنسيقات ملفات التقارير الإلكترونية، استنادًا إلى المواصفات التقنية للتكامل التي يوفرها موفر خدمة الويب.

اتبع الخطوات التالية لإضافة تنسيقات التقارير الإلكترونية إلى ميزة الفوترة الإلكترونية.
...
تغلف عمليات إعداد الميزة قواعد الاتصال والأمان مع خدمة ويب خارجية. بإمكان ميزة الفوترة الإلكترونية‬ أن تتكوّن من العدد المطلوب من عمليات إعداد الميزة، استنادًا إلى قاعدة العمل التي تريد تنفيذها.

اتبع الخطوات التالية لإضافة عمليات إعداد الميزة لميزة الفوترة الإلكترونية.
...
الإجراءات هي قائمة محددة مسبقًا من العمليات التي يتم تشغيلها في ترتيب متسلسل. تمثل هذه القائمة التصنيف التفصيلي للخطوات المطلوبة للتنفيذ الكامل لميزة الفوترة الإلكترونية. بإمكان الإجراءات أن تقوم بتغليف، في ميزة الفوترة الإلكترونية نفسها، الاتصال في الاتجاهين: إرسال طلب لوجهة، وتلقي استجابة وتحليل محتوياتها.
...
يمكنك إنشاء متغيرات ثم استخدامها كقيمة إدخال لمعلمة إجراء محدد. يمكنك أيضًا استخدامها لمبادلة، بين خدمات الفوترة الإلكترونية والعميل، معلومات هي نتيجة تنفيذ إجراء معين كجزء من تدفق عمليات الإرسال.
...
يجب أن تقترن بيئة الفوترة الإلكترونية بميزة الفوترة الإلكترونية ويجب تمكينها لها. يجب إنشاء بيئات الفوترة الإلكترونية ونشرها بشكل مسبق من خلال تكوين ميزات العولمة في حساب RCS لمؤسستك.

اتبع خطوات تمكين بيئة الفوترة الإلكترونية لميزة الفوترة الإلكترونية.
...
يمكن مشاركة ميزة الفوترة الإلكترونية عبر العديد من المؤسسات.

- في الصفحة **ميزات الفوترة الإلكترونية**، على علامة تبويب **المؤسسات**، حدد **مشاركة مع** لإضافة المؤسسة التي تريد مشاركة الفوترة الإلكترونية معها.

لإيقاف مشاركة ميزة الفوترة الإلكترونية مع المؤسسة، حدد **إلغاء المشاركة**.

## <a name="versions"></a>الإصدارات

تساعد الإصدارات على التحكم في دورة حياة ميزة الفوترة الإلكترونية من خلال إدارة حالتها. يمكنك إنشاء إصدار جديد من ميزة الفوترة الإلكترونية، أو عند اكتمال جميع تكوينات ميزة الفوترة الإلكترونية للفوترة الكترونيه، يمكنك تغيير حالة الميزة إلى **مكتملة** ثم **نشر**.

### <a name="create-a-new-version-of-an-existing-electronic-invoicing-feature"></a>إنشاء إصدار جديد من ميزة موجودة للفوترة الإلكترونية

1. في الصفحة **ميزات الفوترة الإلكترونية**، في الشبكة إلى اليسار، حدد ميزة الفوترة الإلكترونية.
2. في علامة التبويب **الإصدارات**، حدد **جديد** لإضافة إصدار جديد من الفوترة الإلكترونية.

### <a name="change-the-status-of-the-electronic-invoicing-feature"></a>تغيير حالة ميزة الفوترة الإلكترونية.

اتبع الخطوات التالية لإدارة دورة حياة ميزة الفوترة الإلكترونية.

1. في الصفحة **ميزات الفوترة الإلكترونية**، في الشبكة إلى اليسار، حدد ميزة الفوترة الإلكترونية.
2. في علامة التبويب **الإصدارات**، حدد **تغيير الحالة**، ثم قم بتغيير الحالة من **مسودة** إلى **مكتملة**.
3. تتم مطالبتك بتأكيد رغبتك في إكمال ميزة الفوترة الإلكترونية وكافة مكوناتها. حدد  **نعم** لتأكيد الإجراء أو **لا** لإلغائه.

    > [!NOTE]
    > عند تحديد **نعم**، تتغير بشكل تلقائي حالة إصدارات التكوين، والتي تعتبر مكونات ميزة الفوترة الإلكترونية من **مسودة** إلى **مكتملة**.

4. حدد **تغيير الحالة** ثم قم بتغيير الحالة من **مكتملة** إلى **نشر**.
5. تتم مطالبتك بتأكيد رغبتك في نشر ميزة الفوترة الإلكترونية وكافة مكوناتها في المستودع العمومي. حدد  **نعم** لتأكيد الإجراء أو **لا** لإلغائه.
