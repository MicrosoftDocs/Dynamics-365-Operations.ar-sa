...
2. في المشروع، على لوحة معلومات البيئة، حدد مشروع نشر. يجب أن يكون المشروع المحدد قيد التشغيل.
...
6. في الحقل **معرف مستأجر AAD**، أدخل معرف المستأجر لحساب اشتراك Azure.
...
### <a name="enable-flighting-keys"></a>تمكين مفاتيح الطيران

قم بتمكين مفاتيح الطيران لـ Microsoft Dynamics 365 Finance أو Microsoft Dynamics 365 Supply Chain Management الإصدار 10.0.17 أو إصدار أقدم. 
