...
إذا تم إرسال مستند عمل من Finance أو Supply Chain Management إلى مجموعة قدرات الفوترة الإلكترونية، فإن مستند العمل يحتوي على السمات التالية التي تمت تعبئتها على الشكل التالي:

- البلد = BR
- الكيان القانوني = BRMF

ستقوم مجموعة قدرات الفوترة الإلكترونية بتحديد ميزة الفوترة الإلكترونية **A** لمعالجة عملية الإرسال وإنشاء الفاتورة الإلكترونية.

وبنفس الطريقة، إذا احتوى مستند العمل على:

- البلد = MX
- الكيان القانوني = MXMF

يتم تحديد ميزة الفوترة الإلكترونية **B** لإنشاء الفاتورة الإلكترونية.

لا يمكن أن يكون تكوين قواعد قابلية التطبيق ملتبسًا. وهذا يعني تعذر وجود البنود نفسها لدى ميزتين أو أكثر من ميزات الفوترة الإلكترونية، وإلا فقد يؤدي ذلك إلى عدم وجود تحديد. في حالة وجود تكرار لميزات الفوترة الإلكترونية، ولتفادي الالتباس، استخدم بنودًا إضافية للسماح لمجموعة قدرات الفوترة الإلكتروني بالتمييز بين ميزتين للفوترة الإلكترونية.

على سبيل المثال، لنأخذ في الاعتبار ميزة الفوترة الإلكترونية **C**. هذه الميزة هي نسخة من ميزة الفوترة الإلكترونية **A**.

| ميزة الفوترة الإلكترونية | قواعد قابلية التطبيق        |
|------------------------------|--------------------------- |
| أ                            | <p>البلد = BR</p><p>و</p><p>الكيان القانوني = BRMF</p>  |
| C                            | <p>البلد = BR</p><p>و</p><p>الكيان القانوني = BRMF</p>  |

في هذا المثال، الميزة **C** هي أمام إرسال مستند عمل يحتوي على ما يلي:

- البلد = BR
- الكيان القانوني = BRMF

يتعذر على قدرة الفوترة الإلكترونية التمييز بين ميزات الفوترة الإلكترونية التي يجب استخدامها لمعالجة عملية الإرسال لأن عمليات الإرسال تحتوي على البنود الدقيقة نفسها.

لإنشاء تمييز بين الميزتين من خلال قواعد قابلية التطبيق، يجب إضافة بند جديد إلى إحدى الميزتين للسماح بمجموعة قدرات الفوترة الإلكترونية بتحديد ميزة الفوترة الإلكترونية المناسبة.

| ميزة الفوترة الإلكترونية | قواعد قابلية التطبيق        |
|------------------------------|--------------------------- |
| أ                            | <p>البلد = BR</p><p>و</p><p>الكيان القانوني = BRMF</p>  |
| C                            | <p>البلد = BR</p><p>و</p><p>الكيان القانوني = BRMF</p><p>و</p><p>النموذج=55</p>  |

لدعم إنشاء بنود أكثر تعقيدًا، تتوفر الموارد التالية:
