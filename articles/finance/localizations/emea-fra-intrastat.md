...
يعرض الجدول التالي الحقول المضمنة في تعريف الاتحاد الأوروبي الفرنسي بتنسيق SAISUNIC 330. يشير الجدول أيضًا إلى مستوى التقرير للحقل. بإمكان الحقل أن يكون **4** (مبسط) أو **1** (كامل)، أو كليهما.
...
| عدد الإعلانات       | 4, 1              |
| رقم البند                 | 4, 1              |
| كود ISO للبلد (FR)       | 4, 1              | 
| الكود التكميلي          | 4, 1              | 
| رقم صفارات الإنذار                | 4, 1              | 
| كود العميل لضريبة القيمة المضافة        | 4, 1              | 
| كود الاتجاه              | 4, 1              |
| نوع الحركة            | 4, 1              | 
| مستوى الالتزام            | 4, 1              |
| كود السلعة              | 1                | 
...
| طبيعة الحركة       | 1                | 
| بلد المنشأ      | 1                | 
| تقرير بلد المنشأ - عمليات الاستيراد | 1                | 
| الوجهة النهائية - عمليات التصدير | 1                | 
| قيمة الفاتورة               | 4, 1              | 
| القيمة الإحصائية           | 1                |
| الوزن الصافي                  | 1                | 
| وحدات إضافية            | 1                |
...
يشير الجدول أيضًا إلى مستوى التقرير للحقل. بإمكان الحقل أن يكون **4** (مبسط) أو **1** (كامل)، أو كليهما.
...
2.  في Dynamics 365 Finance، انتقل إلى **الضريبة** > **‏‎إعداد** >  **التجارة الخارجية** > **معلمات التجارة الخارجية**، واتبع الخطوات التالية:
    ...
    6. في حقل **مستوى الالتزام للتصدير**، أدخل مستوى التفاصيل لتقرير التصدير. يؤثر المستوى الذي تحدده على البنود المعروضة في التقرير. لمزيد من المعلومات، راجع الجداول الموجودة في بداية هذه المقالة.

3. انتقل إلى **إدارة المؤسسة** > **المؤسسات** > **الكيانات القانونية**، وحدد شركتك، ثم اتبع الخطوات التالية:
...
5. لتحديد أكواد NAF وأرقام الإعفاء الضريبي للمورّدين، انتقل إلى **حسابات مدينة** > **المورّدون** > **جميع المورّدين**، واتبع الخطوات التالية:
...
7. انتقل إلى **إدارة المستودعات** > **إعداد‏‎** > **المستودع** > **المستودعات‏‎**، وحدد مستودعًا، ثم اتبع الخطوات التالية:
...
انتقل إلى **الضريبة** > **الإقرارات** > **التجارة** **الخارجية** > **نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي** لإدارة حركاتك التي تنطبق على التجارة الخارجية مع دول الاتحاد الأوروبي. لمزيد من المعلومات، راجع [‬‏‫نظرة عامة على نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي](emea-intrastat.md).
