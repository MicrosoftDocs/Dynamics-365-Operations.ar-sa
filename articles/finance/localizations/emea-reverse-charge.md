...
description: تشرح هذه المقالة كيفية إعداد ضريبة القيمة المضافة (VAT) للرسوم العكسية للمملكة العربية السعودية والدول الأوروبية وسنغافورة‬.
author: EricWangChen
ms.date: 10/05/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9292225"
---
# <a name="reverse-charge-mechanism-for-vatgst-scheme"></a>إلغاء اليه الرسوم لنظام ضريبة القيمة المضافة/GST

[!include [banner](../includes/banner.md)]

تصف هذه المقالة طريقة عامة لإعداد وظيفةإلغاء الرسوم للبلدان/المناطق التي تقوم بتحصيل مخططات ضريبة القيمة المضافة أو ضريبة السلع والخدمات (GST).
...
| تمكين آلية إلغاء الرسوم لنظام ضريبة القيمة المضافة/ضريبة السلع والخدمات | كافة البلدان/المناطق الأخرى باستثناء:  </br>البرازيل  </br>الهند  </br>روسيا                                                                                                                                                                                                                                                                                                                                                                                         |
 ...
 لمزيد من المعلومات، راجع قسم [تمكين تقنية إلغاء الرسوم لنظام ضريبة القيمة المضافة وضريبة السلع والخدمات VAT/GST](#enable-reverse-charge) لاحقًا في هذه المقالة.
