...
ms.locfileid: "8558302"
---
# <a name="get-started-with-tax-calculation"></a>الشروع في العمل مع حساب الضريبة

[!include [banner](../includes/banner.md)]

يوفر هذا الموضوع معلومات حول كيفيه الشروع في العمل باستخدام حساب الضريبة. ترشدك الأقسام الواردة في هذا الموضوع خلال خطوات التكوين والتصميم عالي المستوى في Microsoft Dynamics Lifecycle Services (‏LCS)، وRegulatory Configuration Service (‏RCS)، وDynamics 365 Finance، وDynamics 365 Supply Chain Management. 
...
توفر الأقسام المتبقية في هذا الموضوع خطوات تكوين أكثر تفصيلاً.

## <a name="prerequisites"></a>المتطلبات الأساسية

قبل أن تتمكن من استكمال الإجراءات المتبقية في هذا الموضوع، يجب تلبية المتطلبات الأساسية التالية:<!--TO HERE-->
...
21. في علامة التبويب **إمكانية استخدام مجموعة الضرائب**، حدد الأعمدة المطلوبة لتحديد مجموعة الضرائب الصحيحة، ثم حدد **إضافة**. أدخل قيمًا لكل عمود أو قم بتحديدها. حقل **مجموعة الضرائب** سيكون ناتج هذه المصفوفة. إذا لم يتم تكوين علامة التبويب هذه، سيتم استخدام مجموعة ضريبة المبيعات في بند الحركة.
    ...
    > [!NOTE]
    > إذا كانت مجموعة ضريبة المبيعات الافتراضية في بنود المستند الخاضعة للضريبة صحيحة، فاترك هذه المصفوفة فارغة. لمزيد من المعلومات، انظر القسم [تصميم وقت التشغيل](#runtime) لاحقًا في هذا الموضوع.
...
22. في علامة التبويب **إمكانية استخدام مجموعة ضرائب الأصناف**، حدد الأعمدة المطلوبة لتحديد رمز الضريبة الصحيح، ثم حدد **إضافة**. أدخل قيمًا لكل عمود أو قم بتحديدها. حقل **مجموعة ضرائب الأصناف** سيكون ناتج هذه المصفوفة. إذا لم يتم تكوين علامة التبويب هذه، سيتم استخدام مجموعة ضريبة مبيعات الأصناف في بند الحركة.
    ...
    > [!NOTE]
    > إذا كانت مجموعة ضريبة مبيعات الصنف الافتراضية في بنود المستند الخاضع للضريبة صحيحة، فاترك هذه المصفوفة فارغة. لمزيد من المعلومات، انظر القسم [تصميم وقت التشغيل](#runtime) لاحقًا في هذا الموضوع.
