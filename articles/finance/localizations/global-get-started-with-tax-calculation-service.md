...
- يجب تشغيل الميزات التالية في مساحة عمل **إدارة الميزات** في بيئة Finance أو Supply Chain Management المنشورة، استنادا إلى احتياجات عملك:
    ...
    - تقارير نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي حسب معرف ضريبة متعددة‬
    - تقارير قائمة مبيعات الاتحاد الأوروبي من خلال معرّف ضريبة متعدد
    - إقرار ضريبة المبيعات حسب معرف ضريبة متعددة
...
- يجب أن يكون لديك حق الوصول إلى حساب LCS الخاص بك، ويجب أن يكون لديك مشروع LCS منشور له بيئة من المستوى 2 أو أعلى تقوم بتشغيل Dynamics 365 الإصدار 10.0.18 مع KB4616360، أو إصدار أحدث.
- يجب إنشاء بيئة RCS للمؤسسة الخاصة بك، ويجب أن يكون لديك حق الوصول إلى حسابك. لمزيد من المعلومات حول كيفية إنشاء بيئة RCS، راجع [نظرة عامة حول Regulatory Configuration Service](rcs-overview.md).
