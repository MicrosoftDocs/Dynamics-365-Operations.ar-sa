...
- لديك حق الوصول إلى حساب LCS الخاص بك، وقمت بنشر مشروع LCS مع بيئة المستوى 2 (أو أعلى) التي تشغل Dynamics 365 الإصدار 10.0.18 باستخدام [KB4616360](https://fix.lcs.dynamics.com/Issue/Details?kb=4616360&bugId=568738&dbType=3&qc=1f1c04ff39adad74ef871f539e8d73e14c1893ef7cc4b6e3f7d5c5864ec2781a) أو أحدث.
...
2. انتقل إلى مساحة عمل **إدارة الميزات**، ثم قم بتمكين **ميزات العولمة**.
3. في مساحة عمل **التقارير الإلكترونية**، أضف موفر تكوين جديدًا. استخدم اسم شركتك كاسم الموفر. لمزيد من المعلومات، راجع [إنشاء موفري التكوين ووضع علامة عليهم كنشطين](../../fin-ops-core/dev-itpro/analytics/tasks/er-configuration-provider-mark-it-active-2016-11.md).
4. حدد موفر التكوين الذي قمت بإنشائه للتو، ثم حدد **تعيين كنشط**.
5. حدد موفر التكوينات من **Microsoft**، ثم حدد **المستودعات**.
6. في حقل **النوع**، حدد **عمومي**.
7. حدد **فتح**.
8. انتقل إلى **نموذج بيانات الضريبة**، ثم قم بتوسيع شجرة الملفات، ثم حدد **تكوين الضريبة**.
9. حدد أحدث إصدار، ثم حدد **استيراد**.
10. عد إلى مساحة العمل **ميزات العولمة**، وحدد **الميزات**، وحدد الإطار المتجانب **حساب الضريبة**، ثم حدد **إضافة**.
11. حدد أحد أنواع الميزات التالية:
