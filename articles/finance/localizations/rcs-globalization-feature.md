...
description: توضح هذه المقالة كيفية استخدام Microsoft Regulatory Configuration Services‏ (RCS) والمستودع العمومي لإنشاء ميزات العولمة واستخدامها.
author: JaneA07
ms.date: 06/04/2020
ms.topic: article
ms.prod: ''
...
في مثيل تطبيق التمويل والعمليات، اتبع الخطوات التالية:
...
1. تأكد من أن ميزة **ميزات العولمة** قيد التشغيل في إدارة الميزات، كما ورد وصفه في قسم سابق من هذه المقالة.
...
- **إعادة تعريف** – إعادة تعريف الميزة. لمزيد من المعلومات، راجع قسم [إعادة تعريف ميزات العولمة المشتقة](#rebase) في قسم لاحق في هذه المقالة.
...
- **تمكين** – لإصدار ميزة محددة، حدد بيئة منشورة، وحدد تاريخ **ساري من** عندما يجب أن يكون متوفرًا. لمزيد من المعلومات، راجع قسم [تكوين البيئات لتمكينها](#configureenvironment) في قسم لاحق من هذه المقالة.
