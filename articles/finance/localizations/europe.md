...
- [نظرة عامة على أصحاب السُلف](emea-advance-holders.md)
 ...
 - [الدفع المقدم لموظف](tasks/advance-payment-employee.md)
- [فواتير السُلف‬‬‬ لأوروبا الشرقية](emea-advance-invoice.md)
- [كشف الحساب البنكي وتسوية الدفع](emea-bank-reconciliation.md)
...
- ملفات ISO20022
  ...
  - [استيراد تكوين تحويل الائتمان ISO20022](tasks/import-iso20022-credit-transfer-configuration.md)
  - [إعداد الحسابات البنكية للشركة لتحويلات الائتمان ISO20022](tasks/set-up-company-bank-accounts-iso20022-credit-transfers.md)
  - [إعداد الحسابات البنكية للشركة للديون المباشرة ISO20022](tasks/set-up-company-bank-accounts-iso20022-direct-debits.md)
  - [إعداد طريقة دفع لتحويل الائتمان ISO20022](tasks/set-up-method-payment-iso20022-credit-transfer.md)
  - [إعداد طريقة دفع للدين المباشر ISO20022](tasks/setup-method-payment-iso20022-direct-debit.md)
  - [إعداد العملاء والحسابات البنكية للعملاء للديون المباشرة ISO20022](tasks/set-up-bank-accounts-iso20022-direct-debits.md)
  - [إعداد المورّدين والحسابات البنكية للمورّدين لتحويلات الائتمان ISO20022](tasks/set-up-vendor-iso20022-credit-transfers.md)
  - [إنشاء وتصدير دفعات المورّد باستخدام تنسيق الدفع ISO20022](tasks/create-export-vendor-payments-iso20022-payment-format.md)
- [نظرة عامة على نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي](emea-intrastat.md)
  - [تحويل الحركات إلى نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي](tasks/transfer-transactions-intrastat.md)
  - [تعيين عنوان الشحن لحركة مشتركة بين المجتمعات‬](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [الموعد النهائي لإصدار الفاتورة](emea-invoice-issue-deadline.md)
...
- [مصروفات نثرية لأوروبا الشرقية وروسيا](emea-petty-cash.md)
...
- [استلام شهادة دخول الاتحاد الأوروبي](tasks/eur-00012-receive-eu-entry-certificate.md)
...
- ضريبة القيمة المضافة (VAT)
  - [إعداد معرف ضريبة قيمة مضافة صالح](tasks/eur-00015-vat-id.md)
  - [تسجيل معرف ضريبة القيمة المضافة للمورّد](tasks/eur-00015-registration-vendor-vat-id.md)
  - [نظرة عامة على سعر صرف ضريبة القيمة المضافة](emea-vat-exchange-rate.md)
  - [تقرير تسوية ضريبة القيمة المضافة](tasks/eur-00018-vat-reconciliation-report.md)
  ...
  - [عرض حركات التسوية لأوروبا الشرقية](emea-transactions-settlement-form.md)
  - [تاريخ نقطه الضريبة (تاريخ سجل ضريبة القيمة المضافة)](emea-tax-point-date.md)
  - [تاريخ سجل ضريبة القيمة المضافة للمورد](emea-date-vendor-VAT-register.md)
- [ملحق ميزة السبب المالي](emea-financial-reason.md)
