...
description: يوضح هذا الموضوع كيفية إعداد إقرار ضريبة القيمة المضافة (VAT) المقدم وإنشائه للدانمرك.
author: anasyash
ms.date: 03/10/2022
ms.topic: article
...
ms.locfileid: "8402975"
---
# <a name="vat-declaration-denmark"></a>إقرار ضريبة القيمة المضافة (الدانمرك)

[!include [banner](../includes/banner.md)]

يوضح هذا الموضوع كيفية إعداد إقرار ضريبة القيمة المضافة (VAT) المقدم للدانمرك ومعاينته في Microsoft Excel.
...
بالنسبة للدانمرك، يجب عليك تكوين **البحث في حقل التقرير**. لمزيد من المعلومات حول كيفية إعداد المعلمات الخاصة بالتطبيق، راجع القسم [إعداد المعلمات الخاصة بالتطبيق لحقول إقرار ضريبة القيمة المضافة](#set-up-application-specific-parameters) لاحقًا في هذا الموضوع.
...
عند استخدام الرسائل الإلكترونية لإنشاء التقرير، فإنه يمكنك جمع بيانات الضريبة من كيانات قانونية متعددة. لمزيد من المعلومات، راجع القسم [تشغيل إقرار ضريبة القيمة المضافة للعديد من الكيانات القانونية](#run-vat-declaration) لاحقًا في هذا الموضوع.
...
10. في مربع الحوار **معلمات التقارير الإلكترونية**، عيّن الحقول كما ورد في القسم [معاينة إقرار ضريبة القيمة المضافة في Excel من المهمة الدورية الإبلاغ عن ضريبة المبيعات لفترة التسوية‬](#preview-vat-excel) سابقًا في هذا الموضوع، ثم حدد **موافق**.
