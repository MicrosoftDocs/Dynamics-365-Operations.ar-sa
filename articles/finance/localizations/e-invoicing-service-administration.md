...
استخدم Microsoft Azure لإنشاء كلمات السر الخاصة بالمخزن الرئيسي وإعداد حساب تخزين. ثم استخدم كلمات السر المخزن الرئيسي ورمز SAS المميز لحساب التخزين في تكوين الفوترة الإلكترونية.

## <a name="lifecycle-services"></a>Lifecycle Services

استخدم Microsoft Dynamics Lifecycle Services (LCS) لتمكين الوظيفة الإضافية للفوترة الإلكترونية لمشروع نشر LCS الخاص بك.

> [!NOTE]
> يتطلب تثبيت الوظائف الإضافية في LCS وجود **بيئة طبقة 2** على الأقل. لمزيد من المعلومات حول تخطيط البيئة، راجع [تخطيط البيئة](../../fin-ops-core/fin-ops/imp-lifecycle/environment-planning.md).
...
#### <a name="service-endpoint"></a><a id='svc-endpoint-uris'></a>نقطة نهاية الخدمة
...
تعتبر بيئات الخدمة أقسامًا منطقية يتم إنشاؤها لدعم تنفيذ ميزات العولمة في الفوترة الإلكترونية. يجب تكوين أسرار الأمان والشهادات الرقمية، والتوجيه (بمعنى، أذونات الوصول)، على مستوى بيئة الخدمة.
...
- حساب تخزين Azure (تخزين ثنائي الوحدات) الذي يقوم بتخزين المستندات الإلكترونية، بما في ذلك الفواتير الإلكترونية ونتائج تحويلات المستندات والاستجابات من خدمات الويب الخارجية.
- مخزن رئيسي في Azure الذي يخزن الشهادات ومعرف موقع منتظم (URI) لحساب التخزين (رمز SAS المميز).
...
لتكوين نقطة نهاية الخدمة، انتقل إلى **إدارة المؤسسة \> الإعداد \> معلمة المستند الإلكتروني**، ثم، في علامة تبويب **الفوترة الإلكترونية**، في حقل **URL لنقطة النهاية**، أدخل URL المناسب من الجدول في قسم [نقطة نهاية الخدمة](#svc-endpoint-uris).
...
ويجب تكوين البيئة في علامة التبويب **الفوترة الإلكترونية** ضمن صفحة **معلمات المستند الإلكترونية**. بهذه الطريقة، فإن كل طلب لإصدار الفواتير الإلكترونية يحتوي على البيئة حيث يمكن للفوترة الإلكترونية تحديد أي من ميزات الفوترة الإلكترونية يجب أن تقوم بمعالجة الطلب.
