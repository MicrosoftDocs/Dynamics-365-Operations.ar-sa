...
1. افتح مركز الإدارة [Power Platform ](https://admin.powerplatform.microsoft.com/)، واتبع هذه الخطوات لإنشاء بيئة Dataverse جديدة في مستأجر خدمة Active Directory نفسه.
    ...
    11. دوِّن ملاحظة بمُعرف المؤسسة Dataverse.
...
4. من صفحة التفاصيل **Get insights**، أدخل القيم التالية.
    ...
    | قيمة                                                    | الوصف |
    |----------------------------------------------------------|-------------|
    | عنوان URL للمؤسسة CDS                                     | عنوان URL الخاص بمؤسسة Dataverse للمثيل Dataverse. للعثور على هذه القيمة، افتح المدخل [Power Apps](https://make.powerapps.com)، حدد الزر **إعدادات** (رمز الترس) في الزاوية العلوية اليمنى، حدد **إعدادات متقدمة**، وانسخ عنوان URL. (ينتهي عنوان URL ب "dynamics.com") |
    | معرف مؤسسة CDS                                               | معرف بيئة المثيل Dataverse. للعثور على هذه القيمة، افتح المدخل [Power Apps](https://make.powerapps.com)، حدد الزر **إعدادات** (رمز الترس) في الزاوية العلوية اليمنى، حدد **تخصيصات \> موارد المطور \> معلومات مرجع المثيل**، وانسخ قيمة **المعرف**. |
