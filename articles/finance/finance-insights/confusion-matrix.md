...
[![مثال توقع الأنواع](./media/species-prediction-matrix.png)](./media/species-prediction-matrix.png)
...
[![النموذج 1](./media/payment-prediction-matrix.png)](payment-prediction-matrix.png) النموذج 1
...
[![مثال على توقع الدفع بنموذج أكبر](./media/payment-prediction-matrix-2.png)](payment-prediction-matrix-2.png)
...
- نتائج إيجابية خاطئة، حيث يشير الاختبار إلى أن المريضة تعاني من المرض، ولكنها لا تعاني منه حقًا
- نتائج سلبية خاطئة، حيث يشير الاختبار إلى أن المريضة لا تعاني من المرض، ولكنها تعاني منه حقًا
...
يقارن القسم [دقة النموذج](#classify-machine-learning-accuracy) الخاص بهذا الموضوع بمقارنة مقياسي الالتباس. وعلى الرغم من أن النموذج الأول به دقة منخفضة، فقد يبدو نموذجًا أكثر إفادة لأنه يعرض تحسينًا أكبر من التخمين الافتراضي للدفع في الوقت المحدد.

[![مثال على تنبؤات الدفع مقابل القسم الفعلية](./media/payment-prediction-matrix.png)](payment-prediction-matrix.png)
