...
description: توفر هذه المقالة معلومات عن أعضاء الأبعاد الإحصائية وقوالب موفري القياسات الإحصائية.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
| Name        | موصل البيانات                                                                     | عضو البُعد الإحصائي |
|-------------|------------------------------------------------------------------------------------|------------------------------|
