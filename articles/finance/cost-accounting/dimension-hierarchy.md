...
description: توفر هذه المقالة معلومات عن التدرجات الهرمية للأبعاد. يمكنك استخدام التدرج الهرمي لتعريف هيكل التقارير وسياسات التكلفة، وإعداد الأمان في محاسبة التكاليف.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848624"
---
# <a name="dimension-hierarchy"></a>التدرج الهرمي للأبعاد

[!include [banner](../includes/banner.md)]

توفر هذه المقالة معلومات عن التدرجات الهرمية للأبعاد. يمكنك استخدام التدرج الهرمي لتعريف هيكل التقارير وسياسات التكلفة، وإعداد الأمان في محاسبة التكاليف.  
...
**المستخدمون ونطاقات أعضاء البُعد**

|   العُقد         |   معرف المستخدم        |   عضو بُعد البدء   |   إلى عضو البُعد   |
|-----------------|------------------|---------------------------|-------------------------|
