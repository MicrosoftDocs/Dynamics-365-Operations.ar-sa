...
وإنشاء هيكل تنظيم العمل عبارة عن عملية مكثفة وعادةً ما تتم لفترة طويلة، وتتطلب التعاون والمعلومات الواردة من مجموعة متنوعة من الأشخاص. يصف هذا الموضوع كيفية استخدام تحسينات WBS لتلبية متطلبات التعقب والتقديرات.
...
**‏‫جدولة المهام‬** تحدد العوامل التالية جدولة مهام العقده الطرفية:
...
**إصلاح كافة أخطاء الجدولة** إذا أردت من Finance إصلاح كافة أخطاء الجدولة في هيكل تنظيم العمل، في "جزء الإجراءات"، انقر فوق **إصلاح كافة تعارضات الجدولة**. 
...
يتضمن Finance ثلاث طرق عرض لهيكل تنظيم العمل لمشروع: عرض التخطيط، وعرض تعقب الجهد، وعرض تعقب التكلفة.
...
ويستخدم Finance قاعدة الكسب 0:100 عندما يرسم القيمة المخططة. وعملاً بهذه المادة، يتم ترحيل قيمة المهمة إلى المهمة اعتبارًا من تاريخ انتهائها. لا يتم ترحيل أية قيمة حتى اكتمال المهمة بنسبة 100 بالمائة. 
...
ويستخدم Finance قاعدة الكسب 0:100 عندما يرسم القيمة المكتسبة. وعملاً بهذه المادة، يتم ترحيل قيمة المهمة إلى المهمة اعتبارًا من تاريخ انتهائها. لا يتم ترحيل أية قيمة حتى اكتمال المهمة بنسبة 100 بالمائة. 
