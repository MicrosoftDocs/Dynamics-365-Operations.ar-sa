...
ms.locfileid: "8879729"
---
# <a name="invoice-matching-and-intercompany-purchase-orders"></a>مطابقة الفاتورة وأوامر الشراء بين الشركات الشقيقة

[!include [banner](../includes/banner.md)]

قد يتم إعداد الكيان القانوني المشتري المعني بحركة تجارية بين شركات شقيقة لاستخدام مطابقة فواتير الحسابات الدائنة. عند تعيين الحقل **ترحيل الفاتورة التي بها اختلافات** في الصفحة **محددات الحسابات الدائنة‬** إلى **طلب الموافقة**، سيتم تنفيذ التحقق من صحة مطابقة الفاتورة. في هذه الحالة، يجب تلبية متطلبات الترحيل لكل من مطابقة فواتير الحركات التجارية بين الشركات الشقيقة ومطابقة فواتير الحسابات الدائنة قبل ترحيل فواتير المورّد المشتركة بين الشركات الشقيقة.

تستخدم الأمثلة في هذه المقالة الإعداد التالي للمتاجرة بين الشركات الشقيقة:
...
-   في صفحة **معلمات الحسابات الدائنة**، يتم تحديد الخيار **تمكين التحقق من صحة مطابقة الفاتورة**.
-   في صفحة **معلمات الحسابات الدائنة**، تم تعيين حقل **ترحيل الفاتورة التي بها اختلافات** إلى **طلب الموافقة**.
...
3.  قم بإجراء تحديث لفاتورة ICSO888 في شركة Fabrikam Sales. حيث يكون سعر الوحدة هو 0.45 ويتم تحديث 100 صنف.
...
-   في صفحة **مجموعات نماذج الأصناف** لمجموعة النماذج المستخدمة بواسطة الصنف B-R14، يتم تحديد خيار **متطلبات الاستلام**.
