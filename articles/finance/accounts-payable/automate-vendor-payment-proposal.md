...
description: تشرح هذه المقالة كيف يمكن للمؤسسات، التي تدفع للمورّدين وفق جدول متكرر، أتمتة عملية إنشاء مقترحات الدفع للمورّد.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> يجب تمكين الميزة **أتمتة مقترحات دفع المورّد** في إدارة الميزات لاستخدام هذه الوظيفة. 
