...
ms.locfileid: "6722757"
---
# <a name="invoice-automation-for-scanned-documents"></a>التنفيذ التلقائي للفاتورة للمستندات الممسوحة ضوئيا

[!include [banner](../includes/banner.md)]

يشرح هذا الموضوع كيانات البيانات المتوفرة للتشغيل الآلي الشامل لفواتير المورد، بما في ذلك الفواتير مع المرفقات.
