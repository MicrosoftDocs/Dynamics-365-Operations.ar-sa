...
تمت إضافة ميزة تتحقق من صحة جدول التوزيع المحاسبي لضمان إعداد الحقول الجديدة بشكل صحيح. تسمى هذه الميزة **تمكين التحقق من صحة البيانات الإضافي للمستندات باستخدام إطار عمل محاسبة المستند المصدر**. تم تشغيل هذه الميزة افتراضيًا في الإصدار 10.0.29. 
