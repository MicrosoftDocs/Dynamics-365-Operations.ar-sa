...
-   خالد مراقب في مؤسسة الاتحاد للتصنيع. ويمكن لخالد مساعدة الأشخاص في المؤسسة الخاصة به على تحديد وحل المشاكل المتعلقة بطلب الأصناف وتلقيها والدفع لها (السلع والخدمات) من الموردين.
...
-   وتامر هو مدير الإنتاج في شعبة الولايات المتحدة التابعة لشركة الاتحاد للتصنيع. ويمكن لتامر وموظفو الإنتاج الآخرون التأكد من استلام الأصناف كما تم طلبها من الموردين، وتتم مساءلتهم عن ذلك حتى يتسنى للموظفين على الحصول على ما يحتاجونه لأداء الوظائف الخاص بهم.
...
-   ويقوم تامر بإدخال طلب لخمسة "آلات ميليكرون باستخدام الحاسب الآلي". تُصدر إليسا، كاتب أمر شراء في شركة الاتحاد للتصنيع، أمر شراء إلى كيان قانوني باسم Contoso لتوريد الأصناف.
...
-   يراجع جمال، وهو موظف حسابات مدينة في شركة Contoso، الشحنات الأسبوع القادم. ويحدد جمال حركات الشحن لإعداد فاتورة لشركة الاتحاد للتصنيع لتسليم "آلات ميليكرون باستخدام الحاسب الآلي". ويقوم جمال بتضمين رسم للشحن والمناولة. وستعتبر شركة الاتحاد للتصنيع التكلفة جزءًا من تكلفة الأصل.

### <a name="scenario"></a>سيناريو

1.  يتلقى سامي، وهو أحد العاملين في قسم الاستلام في شركة الاتحاد للتصنيع، الكمية الإجمالية للأجهزة التي يتم شحنها من Contoso. ويقوم سامي بإدخال كمية 5 في إيصال استلام منتجات. ولأنه تم استلام أمر الشراء بالكامل، تتغير حالة أمر الشراء إلى "مستلم".
2.  تقوم فوزية، وهي منسق الحسابات الدائنة في Contoso بإدخال والتحقق من صحة الفواتير التي قدمتها. وتتحقق من صحة المعلومات التالية:
    ...
    -   وبالنسبة للأصناف التي تتطلب مطابقة ثنائية أو ثلاثية الاتجاهات، توجد الأسعار في بند الفاتورة في نطاق التفاوتات التي تم تحديدها في Microsoft Dynamics 365 Finance. ويتضمن هذا الأنواع التالية من مطابقة الأسعار:
        ...
        -   مطابقة إجماليات الأسعار - يتطابق صافي المبلغ في بند الفاتورة مع صافي المبلغ في بند أمر الشراء، ضمن نسبة التفاوت أو المبلغ أو النسبة المئوية والمبلغ. وفي هذا المثال، تبلغ إجماليات الأسعار المطابقة للتفاوت +15%.

فاتورة ورقية من شركة Contoso تحتوي على المعلومات التالية.

| الصنف                        | الكمية | سعر الوحدة | صافي المبلغ |
|-----------------------------|----------|------------|------------|
...
-   تقوم كريمة بتعيين سياسة المطابقة على مستوى مجموعة الأصناف والموردين للصنف PH2500 – الكمبيوتر ومورد شركة Contoso إلى المطابقة ثلاثية الاتجاهات.
-   وتقوم إليسا، وهي كاتب أوامر شراء في القسم الماليزي من شركة الاتحاد للتصنيع، بإصدار أوامر الشراء لشركة Contoso لتوريد ثلاثة أصناف، كما هو موضح في الجدول التالي. وعندما تقوم بإنشاء أمر الشراء، تتجاوز سياسة المطابقة للماوس اللاسلكي لتكون مطابقة ثلاثية الاتجاهات بدلاً من مطابقة ثنائية الاتجاهات.
...
2.  تقوم فوزية، وهي منسق الحسابات الدائنة في Contoso بإدخال والتحقق من صحة الفواتير التي قدمتها. وتتحقق من صحة المعلومات التالية:
    -   بالنسبة للأصناف التي تتطلب المطابقة ثلاثية الاتجاهات، تتطابق الكمية الموجودة في بند الفاتورة مع الكمية التي تم استلامها. وتتم الإشارة إلى الكمية المستلمة في إيصال استلام المنتج المطابق للفاتورة.
    -   وبالنسبة للأصناف التي تتطلب مطابقة ثنائية أو ثلاثية الاتجاهات، توجد الأسعار في بند الفاتورة في نطاق التفاوتات التي تم تحديدها في التطبيق. ويتضمن هذا الأنواع التالية من مطابقة الأسعار:
        ...
        -   مطابقة إجماليات الأسعار - يتطابق صافي المبلغ في بند الفاتورة مع صافي المبلغ في بند أمر الشراء، ضمن نسبة التفاوت أو المبلغ أو النسبة المئوية والمبلغ. وفي هذا المثال، تبلغ إجماليات الأسعار المطابقة للتفاوت +10%.
...
لمزيد من المعلومات، راجع [نظرة عامة على مطابقة فاتورة الحسابات الدائنة‬](accounts-payable-invoice-matching.md).
