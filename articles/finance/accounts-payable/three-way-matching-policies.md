...
description: توفر هذه المقالة أمثلة عن المطابقة ثلاثية الاتجاهات.
author: abruer
ms.date: 02/11/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8904919"
---
# <a name="three-way-matching-policies"></a>سياسات المطابقة الثلاثية

[!include [banner](../includes/banner.md)]

توفر هذه المقالة أمثلة عن المطابقة ثلاثية الاتجاهات.
...
-   يقوم خالد بتعيين مفتاح التبديل **التحديث التلقائي لحالة مطابقة الرأس** على مستوى الكيان القانوني إلى **نعم**.
-   ويقوم خالد بتعيين حقل **مطابقة إجماليات الأسعار** للكيان القانوني إلى **النسبة المئوية**، ويقوم بإدخال 15% **كنسبة مئوية للتفاوت**.
-   يقوم خالد بتعيين سياسة مطابقة على مستوى الصنف للصنف 1500 – جهاز CNC Milicron إلى **المطابقة ثلاثية الاتجاهات**. هذا الصنف هو صنف أصل يُستخدم للإنتاج في شركة الاتحاد للتصنيع. وتتم مطابقة الفواتير الخاصة بهذا الصنف ببنود أمر الشراء للأسعار وإيصالات استلام المنتجات للكميات.
...
1.  يتلقى سامي، وهو أحد العاملين في قسم الاستلام في شركة الاتحاد للتصنيع، الكمية الإجمالية للأجهزة التي يتم شحنها من شركة "التعمير". ويقوم سامي بإدخال كمية 5 في إيصال استلام منتجات. ولأنه تم استلام أمر الشراء بالكامل، تتغير حالة أمر الشراء إلى "مستلم".
2.  تقوم فوزية، وهي منسق الحسابات الدائنة في شركة الاتحاد للتصنيع، بإدخال والتحقق من صحة الفواتير التي قدمتها شركة "التعمير". وتتحقق من صحة المعلومات التالية:
    ...
    -   وبالنسبة للأصناف التي تتطلب مطابقة ثنائية أو ثلاثية الاتجاهات، توجد الأسعار في بند الفاتورة في نطاق التفاوتات التي تم تحديدها في ‎365 Finance Microsoft Dynamics. ويتضمن هذا الأنواع التالية من مطابقة الأسعار:
...
إذا كانت الموافقة مطلوبة لترحيل الفواتير مع اختلافات مطابقة الفواتير، فيجب تحديد مفتاح التبديل **الموافقة على الترحيل مع وجود اختلافات في المطابقة** في صفحة **تفاصيل مطابقة الفواتير** قبل إمكانية ترحيل الفاتورة بأخطاء مطابقة الأسعار وأخطاء مطابقة الكميات. إذا لم يتم طلب الموافقة، يمكن لمعالجة الفاتورة المتابعة إذا لم تكن هناك أية أخطاء ترحيل أخرى.
