...
description: توفر هذه المقالة معلومات عن مساحة العمل مدفوعات المورد. تعرض مساحة عمل "مدفوعات المورد‬" المعلومات المتعلقة بمعالجة مدفوعات المورد.
author: abruer
ms.date: 10/16/2020
ms.topic: article
ms.prod: ''
