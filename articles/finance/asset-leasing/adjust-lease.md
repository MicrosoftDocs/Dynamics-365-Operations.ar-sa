...
description: توضح المقالة كيفية تسوية عقد الإيجار. قد تكون التسوية مطلوبة في حالة تعديل فترات الإيجار أو إذا كان عقد الإيجار ممتد أو إذا تغيرت ظروف أخرى.
author: moaamer
ms.date: 03/18/2022
ms.topic: article
ms.prod: ''
...
## <a name="adjust-a-lease-book"></a>تسوية دفتر عقد الإيجار.

اتبع هذه الخطوات لتسوية دفتر عقد الإيجار فقط.

1. انتقل إلى **تأجير الأصول** \> **عقود الإيجار** \> **عقود الإيجار**.
2. حدد عقد إيجار وافتحه.
3. في الصفحة **تفاصيل عقد الإيجار**، حدد **الدفاتر**.
4. في صفحة **تفاصيل الدفتر**، في جزء الإجراءات، في مجموعة **الصيانة**، حدد **تسوية القيمة الدفترية‬**. 
5. أزل بنود جدول الدفع.
6. في الحقل تاريخ **تاريخ تعديل عقد الإيجار**، أدخل تاريخ التعديل. بعد ذلك، يمكنك إزالة جميع اعتبارات الأصول/الالتزامات (التكلفة المباشرة لعقد الإيجار وحافز الإيجار والدفع المسبق لعقد الإيجار وتكلفة التفكيك وضمان القيمة المتبقية)، إن وجدت. 
7. للمساعدة على منع الحسابات غير الدقيقة لتسوية عقد الإيجار، أضف بنود جدول دفع جديدة لتواريخ الدفع الجديدة التي تطابق تاريخ التعديل. 

> [!NOTE] 
> نوصي باستخدام معالج **تسوية عقد الإيجار** لتسوية عقد الإيجار. يقوم المعالج بتقليل عدد الخطوات اليدوية، ويوفر معاينة للأرصدة بعد التسوية، ويتيح لك تغيير المبالغ قبل الترحيل.
