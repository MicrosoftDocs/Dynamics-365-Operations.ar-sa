...
description: توضح هذه المقالة كيفية عرض المعاملات لأحد الأصول المؤجرة. تتضمن هذه الحركات حركات التزامات الإيجار وحركات مصروفات تنفيذ العقد التي تم ترحيلها.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8906402"
---
# <a name="view-liability-asset-and-expense-transactions"></a>عرض حركات المسؤولية والأصول والمصروفات

[!include [banner](../includes/banner.md)]

توضح هذه المقالة كيفية عرض المعاملات لأحد الأصول المؤجرة. تتضمن هذه الحركات حركات التزامات الإيجار وحركات مصروفات تنفيذ العقد التي تم ترحيلها. يتم استخدام قيم حمل الالتزام وحق استخدام الأصل في العديد من التقارير. ويتم استخدامها أيضًا لحساب قيم التسوية.
