...
description: تسرد هذه المقالة وتصف التقارير المتوفرة في تأجير الأصول.
author: moaamer
ms.date: 04/05/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8856701"
---
# <a name="asset-leasing-reports"></a>تقارير تأجير الأصول

[!include [banner](../includes/banner.md)]

تسرد هذه المقالة وتصف التقارير المتوفرة في تأجير الأصول. تعرض معظم التقارير عن طريق إكمال هذه الخطوات أو الخطوات المشابهة للغاية، كما هو موضح). 
...
|     فترة الإيجار                     |     الإصدار الحالي من مدة عقد الإيجار.                            |
