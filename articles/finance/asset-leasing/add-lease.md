...
description: تصف هذه المقالة كيفية عمل عقد إيجار جديد عن طريق إدخال معلومات له في معلومات تأجير الأصل أو نسخه من عقد إيجار موجود.
author: moaamer
ms.date: 01/11/2022
ms.topic: article
ms.prod: ''
...
لا يمكن أن يكون تاريخ بدء دفعات الإيجار قبل تاريخ بدء التأجير. إذا قمت بإدخال تاريخ بدء لدفعات الإيجار قبل تاريخ بدء عقد الإيجار، فستتلقى رسالة خطأ.

بشكل افتر اضي، يتم تعيين الخيار **مبلغ تصنيف الدفع** على علامة التبويب السريعة **عام** في صفحة **تفاصيل عقد الإيجار** إلى **لا** إذا كان الخيار **السماح بتصنيف الدفعات** على الصفحة **معلمات تأجير الأصول** معينًا إلى **نعم**. 

إذا تم تعيين الخيار **مبلغ تصنيف الدفع** إلى **نعم**، سيتم تأمين الحقل **مبلغ الدفع** على علامة التبويب السريعة **بنود جدول الدفع**. سيتم تعيينه إلى إجمالي مبالغ الدفع التي يتم إدخالها لاحقًا في كتالوج **تصنيف مبلغ الدفع**.

حدد **تصنيف مبلغ الدفع** لفتح صفحة حيث يمكنك إضافة أنواع الدفع المفصلة. سيقوم الزر **إضافة الإجماليات إلى مبلغ الدفع** بنقل الإجماليات إلى حقل **مبلغ الدفع**.

> [!NOTE]
> إذا أضفت مبلغ دفع مفصل ثم حددت المفتاح **Esc**، فلن تُضاف المبالغ المدخلة إلى حقل **مبلغ الدفع** على علامة التبويب السريعة **بنود جدول الدفع**. بدلاً من ذلك، سيتم تخزينها في مربع الحوار **تصنيف مبلغ الدفع‬‏‫**. إذا كنت ترغب في أن يعرض مربع الحوار المبلغ الإجمالي، فحدد عمود **المبلغ**، وحدد باستمرار (أو انقر بزر الماوس الأيمن)، ثم حدد **إجمالي هذا العمود**. 

سيقوم الزر **نسخ البند** بنسخ تصنيف الدفع المفصل.
