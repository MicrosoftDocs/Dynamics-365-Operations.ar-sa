...
description: توضح هذه المقالة عملية إعادة تصنيف الأصول. لإعادة تصنيف أصل ثابت، يتعين عليك تحويله إلى مجموعة أصول ثابتة جديدة، أو تعيين رقم أصل ثابت جديد له في نفس المجموعة.
author: moaamer
ms.date: 05/14/2019
