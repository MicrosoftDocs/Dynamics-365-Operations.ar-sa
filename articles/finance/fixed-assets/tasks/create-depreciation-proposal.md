...
description: توضح هذه المقالة كيفية عمل مقترحات دُفعة الإهلاك، وتشرح كيفية اقتراح إهلاك الأصول الثابتة.
author: abruer
ms.date: 08/01/2019
...
ms.locfileid: "8858485"
---
# <a name="create-a-depreciation-proposal"></a>إنشاء مقترح الإهلاك

[!include [banner](../../includes/banner.md)]

توضح هذه المقالة كيفية عمل مقترحات دُفعة الإهلاك، وتشرح كيفية اقتراح إهلاك الأصول الثابتة. تستخدم هذه المهمة شركة العرض التوضيحي USMF ودور المحاسب.
