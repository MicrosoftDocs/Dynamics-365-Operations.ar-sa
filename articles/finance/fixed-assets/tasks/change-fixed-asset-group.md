...
تستخدم الخطوات التالية شركة العرض التوضيحي **USMF**.
...
5. حدد هذا الخيار لتعيين رقم أصل ثابت للأصل الثابت المحدد.
   ...
   يتوفر حقل **رقم الأصل الثابت** إذا حددت الخيار **رقم الأصل الثابت الجديد**. وفي حالة إعداد ترقيم تلقائي للأصول الثابتة، يعرض هذا الحقل رقم الأصل الثابت المتوفر التالي. ويمكنك تغيير الرقم. في حالة إعداد الترقيم اليدوي، يكون هذا الحقل فارغًا ويجب إدخال رقم الأصل الثابت الجديد.     
