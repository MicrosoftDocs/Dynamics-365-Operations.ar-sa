...
description: تصف هذه المقالة عملية إزالة المعاملات الخاصة بأصل ثابت تم التخلص منه كخردة.
author: moaamer
ms.date: 08/14/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8855422"
---
# <a name="dispose-of-a-fixed-asset-as-scrap"></a>التخلص من أصل ثابت كخردة

[!include [banner](../includes/banner.md)]

تصف هذه المقالة عملية إزالة المعاملات الخاصة بأصل ثابت تم التخلص منه كخردة. تشتمل أنواع الحركات التي يمكن إزالتها على حركات الاستحواذ على أصل والإهلاك التراكمي وحركات الأصول الثابتة الأخرى. تؤثر إزالة هذه الحركات على حسابات الميزانية العمومية، مثل تسويه الاستحواذ وتسوية الإهلاك وإعادة التقييم وحسابات رفع القيم وخفض القيم.
