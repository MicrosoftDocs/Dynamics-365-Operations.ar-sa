...
description: يوفر هذا الموضوع الوصول إلى الموارد التي يمكن أن تساعدك في استخدام الأصول الثابتة لـ Microsoft Dynamics 365 Finance.
author: moaamer
ms.date: 08/31/2017
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "7674841"
---
# <a name="fixed-assets-home-page"></a>الصفحة الرئيسية للأصول الثابتة

[!include [banner](../includes/banner.md)]

يوفر هذا الموضوع الوصول إلى الموارد التي يمكن أن تساعدك في استخدام الأصول الثابتة لـ Microsoft Dynamics 365 Finance. الأصول الثابتة هي عناصر ذات قيمة مملوكة من قِبل فرد أو مؤسسة. تشمل العناصر المباني والمركبات والأراضي والمعدات. 
