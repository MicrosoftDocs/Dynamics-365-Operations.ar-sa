...
description: تصف هذه المقالة قواعد إهلاك الأصول الثابتة.
author: moaamer
ms.date: 09/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858380"
---
# <a name="fixed-asset-depreciation-conventions"></a>قواعد إهلاك الأصول الثابتة

[!include [banner](../includes/banner.md)]

تصف هذه المقالة قواعد إهلاك الأصول الثابتة. يتم استخدام قواعد الإهلاك لتحديد متى وكيف يتم حساب الإهلاك لكلٍّ من السنة التي يتم فيها امتلاك الأصل الثابت والسنة التي يت فيها التخلص من الأصل الثابت.
