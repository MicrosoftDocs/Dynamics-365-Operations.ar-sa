...
description: توفر هذه المقالة معلومات عن مساحة عمل إدارة الأصول الثابتة. تعرض مساحة العمل هذه المعلومات المرتبطة بالأصول الثابتة التي تم إدخالها في النظام. وهي تتضمن طريقة عرض ملخصة وطريقة عرض التحليلات.
author: moaamer
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
