...
description: يستعرض هذا المقال سيناريو إعادة توزيع حيث يتم إدخال أمرين مبيعات، ولكن يتم تأكيدهما فقط. سينتج عن نفس السيناريو نتائج مماثلة إذا كان هناك أكثر من أمرين مبيعات في حالة مؤكدة.
author: kweekley
ms.date: 12/21/2020
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8876257"
---
# <a name="revenue-recognition-reallocation--scenario-1"></a>إعادة توزيع إقرار الإيرادات - السيناريو 1

[!include [banner](../includes/banner.md)]

يستعرض هذا المقال سيناريو إعادة توزيع حيث يتم إدخال أمرين مبيعات، ولكن يتم تأكيدهما فقط. سينتج عن نفس السيناريو نتائج مماثلة إذا كان هناك أكثر من أمرين مبيعات في حالة مؤكدة.
