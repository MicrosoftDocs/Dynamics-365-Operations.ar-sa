...
description: توضح هذه المقالة كيفية إعداد سياسات فواتير المورِّدين‬.
...
ms.locfileid: "8904719"
---
# <a name="set-up-vendor-invoice-policies"></a>إعداد سياسات فواتير المورِّدين

[!include [banner](../../includes/banner.md)]

توضح هذه المقالة كيفية إعداد سياسات فواتير المورِّدين‬. يتم تشغيل سياسات فاتورة المورّد عند ترحيل فاتورة مورّد باستخدام صفحة **فاتورة المورّد** وعند فتح صفحة **مخالفات سياسة فاتورة المورّد**‬. يمكنك أيضًا تكوين سير عمل فاتورة المورّد لتشغيل سياسات فواتير المورّدين في كل وقت تقوم فيه بإرسال فاتورة إلى سير العمل. 
