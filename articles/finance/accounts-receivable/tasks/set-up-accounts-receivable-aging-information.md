...
سوف يساعدك هذا الدليل في إعداد تعريف فترة تقادم، وأرصدة العميل القديمة‬، وعرض الأرصدة في قائمة **الأرصدة المتقادمة** وصفحة **التحصيلات‬**. يستخدم هذا التسجيل شركة بيانات العرض التوضيحي USMF.
