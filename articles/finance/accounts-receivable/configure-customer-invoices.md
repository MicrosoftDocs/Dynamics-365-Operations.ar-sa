...
## <a name="post-to-revenue-account-for-sales-order-lines-that-have-no-price"></a>الترحيل إلى حساب الإيرادات لبنود أوامر المبيعات بلا سعر
سيكون لديك خيار تحديث حساب **الإيراد** في **دفتر الأستاذ العام** لبنود أمر المبيعات التي ليس لديها سعر. لإعداد هذه المعلومات أو عرضها، انتقل إلى المعلمة **الترحيل إلى حساب الإيرادات لبنود فاتورة أوامر المبيعات بلا سعر‬** على علامة التبويب **دفتر الأستاذ وضريبة المبيعات** في صفحة **معلمات الحسابات المدينة**. (**الحسابات المدينة > الإعداد > معلمات الحسابات المدينة**). حدد **نعم** لتحديث حساب **الإيراد** لبنود فاتورة أمر المبيعات التي ليس لديها سعر. يتم تعريف حساب الإيراد في صفحة معلمة **ترحيل المخزون**، على علامة تبويب تعريف حساب **أمر المبيعات**. إذا لم يتم تحديد هذا الخيار، فلن يتم ترحيل البنود التي ليس لديها معلومات سعر إلى حساب **الإيراد**.
