...
18. حدد **ترحيل** لترحيل الفاتورة. تبقى لديك فرصة لإلغاء قبل ترحيل الفاتورة فعليًا.
    ...
    * في Microsoft Dynamics 365 Finance 10.0.30، تعمل ميزة **تحسن ميزة ترحيل فاتورة النص المجاني لحساب الإجماليات** على تحسين أداء الترحيل من خلال السماح لها بالعمل بكفاءة أكبر. عند تمكين هذه الميزة، سيؤدي الترحيل إلى حفظ الإجماليات المحسوبة، بدلاً من إعادة حساب الإجماليات عدة مرات أثناء عملية الترحيل. 
    * في Microsoft Dynamics 365 Finance 10.0.31، تعمل ميزة **تحسين عملية ترحيل دفعة فاتورة النص الحر على تحسين أداء الترحيل** من خلال السماح لها بالعمل بكفاءة أكبر. عند تمكين هذه الميزة، يستخدم الترحيل نمطًا يدير ذاتيًا حمل عمل ترحيل الدُفعة عبر عدد ثابت من سلاسل الرسائل، بدلاً من تعيين عدد ثابت من المستندات عبر عدد غير محدود من سلاسل الرسائل.
