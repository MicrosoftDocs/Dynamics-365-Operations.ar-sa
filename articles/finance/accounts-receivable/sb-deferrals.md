...
description: يشرح هذا الموضوع كيفية إعداد تأجيلات الإيرادات والمصروفات في فواتير الاشتراك.
...
ms.locfileid: "8544459"
---
# <a name="revenue-and-expense-deferrals-in-subscription-billing"></a>تأجيل الإيرادات والمصروفات في فواتير الاشتراكات

يشرح هذا الموضوع كيفية إعداد واستخدام تأجيلات الإيرادات والمصروفات في فواتير الاشتراك. تستند جداول التأجيل دائمًا إلى مستند منشأ أساسي أو جدول فوترة وتعتمد عليه. نظرًا لأنه تم إنشاؤها استنادًا إلى القيم الافتراضية، فلا يمكن إدخالها أو إنشاؤها بشكل منفصل.
