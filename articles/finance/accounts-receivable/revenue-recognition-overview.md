...
description: توفر هذه المقالة معلومات عن ميزة التعرف على الإيرادات. توفر هذه الميزة اطار عمل مرنًا يتيح لك تحديد القواعد الخاصة بالشركة للتعرف على سعر الإيرادات وجدول الإيرادات للأوامر متعددة العناصر.
author: bking
ms.date: 03/15/2022
ms.topic: overview
ms.prod: ''
...
>[!NOTE]
>سيتم إيقاف هذه الوظيفة في أكتوبر 2023 ، يجب على المستخدمين الجدد استخدام فواتير الاشتراك.
