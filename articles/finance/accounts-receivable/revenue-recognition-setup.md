...
description: يوضح هذا المقال خيارات إعداد إقرار الإيرادات وعواقبها.
author: bking
ms.date: 04/28/2022
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "9348399"
---
# <a name="revenue-recognition-setup"></a>إعداد إقرار الإيرادات
[!include [banner](../includes/banner.md)]

تمت إضافة وحدة **إقرار إيرادات** جديدة تتضمن عناصر قائمة لكافة الإعدادات المطلوبة. يوضح هذا المقال خيارات الإعداد وعواقبها.
