...
ms.locfileid: "3015105"
---
# <a name="credit-holds-for-sales-orders"></a>تعليقات الائتمان لأوامر المبيعات
...
6. أدخل **أيام انتهاء صلاحية الحد الائتماني** لقاعده الحظر المحددة قبل وضع أمر قيد التعليق في إدارة الائتمان. يمثل عدد الأيام المتأخرة أيام السماح الإضافية المضافة إلى عدد الأيام التي مرت منذ انتهاء صلاحية الحد الائتماني.
...
6. حدد **نوع القيمة** الذي يحدد نوع القيمة التي سيتم استخدامها لاختبار مقدار الحد الائتماني الذي تم استخدامه. تتطلب قواعد الحظر نسبة مئوية لكن يمكن أن يكون للاستثناء قيمة ثابتة أو نسبة مئوية.
الحد. يرتبط الحد بالحد الائتماني.
...
4. حدد نوع القاعدة التي تقوم بإعدادها.  
  - حدد **الحظر** لإنشاء قاعدة تقوم بحظر أحد الأوامر. 
  - حدد **الاستثناء** لإنشاء قاعدة تقوم باستثناء قاعدة أخرى من حظر أحد الأوامر. 
6. أدخل **مبلغ أمر المبيعات** لقاعدة الحظر المحددة قبل وضع أمر في تعليق إدارة الائتمان. 
...
- إذا قمت بتغيير الإعدادات **استثناء عميل من إدارة الائتمان** في **كافة العملاء > تحديد عميل > علامة التبويب السريعة لعمليات التحصيل والائتمان** إلى **نعم**، عندئذٍ لن تتم معالجة أي أمر لذلك العميل
...
تتيح قائمة تعليق إدارة الائتمان لمدراء الائتمان عرض كافة أوامر المبيعات التي تم وضعها في قائمه التعليق وتسمح لهم بإزالة التعليق عند تقليل مشاكل الائتمان. تعرض صفحة **قائمة تعليق إدارة الائتمان** كافة أوامر المبيعات التي تم وضعها قيد التعليق. يمكنك عرض قائمه التعليق في صفحة **كافة عمليات تعليق الائتمان** (**إدارة الائتمان > قائمة تعليق إدارة الائتمان > كافة عمليات تعليق الائتمان**).
...
يتم عرض سبب الحظر لكل أمر مبيعات في قائمة التعليق. وفي حال وجود أكثر من سبب للتعليق، سيظهر هذا السبب **كمتعدد**. يمكنك استخدام قائمة **أسباب الحظر** في جزء الإجراءات لعرض كافة أسباب وضع أمر المبيعات قيد التعليق. يمكنك أيضًا عرض **أسباب الحظر** في مربع الحقائق.
...
 
## <a name="free-text-invoices-retail-orders-and-project-invoice-support-in-credit-management"></a>فواتير النص الحر، وأوامر البيع بالتجزئة، ودعم فواتير المشروع في إدارة الائتمان 
يمكن استخدام إدارة الائتمان حاليًا لأوامر المبيعات فقط. ستقوم فواتير النص الحر، ونقطة البيع بالتجزئة الخاصة بأوامر المبيعات وأوامر مراكز الاتصال باستخدام الحدود الائتمانية المؤقتة والتأمين/الضمانات التي قمت بإضافتها لتعديل الحد الائتماني. ولن تستخدم قواعد الحظر ولن يتم وضعها في قائمة التعليق في حال وجود مشكلة في الحد الائتماني.
