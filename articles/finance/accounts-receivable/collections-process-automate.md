...
description: توضح هذه المقالة عملية إعداد استراتيجيات معالجة عمليات التحصيل التي تقوم تلقائيًا بتحديد فواتير العميل التي تتطلب تذكيرًا بالبريد الإلكتروني أو نشاط تحصيل أو إرسال خطاب تحصيل إلى العميل.
...
ms.locfileid: "8946136"
---
# <a name="collections-process-automation"></a>التنفيذ التلقائي لعمليات التحصيل

[!include [banner](../includes/banner.md)]

توضح هذه المقالة عملية إعداد استراتيجيات معالجة عمليات التحصيل التي تقوم تلقائيًا بتحديد فواتير العميل التي تتطلب تذكيرًا بالبريد الإلكتروني أو نشاط تحصيل أو إرسال خطاب تحصيل إلى العميل. 
