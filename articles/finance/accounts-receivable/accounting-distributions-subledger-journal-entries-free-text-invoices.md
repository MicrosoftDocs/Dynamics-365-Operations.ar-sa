...
يتعذر إنشاء توزيعات محاسبية للضرائب إلا بعد أن يتم حساب الضرائب. لحساب ضرائب المبيعات، يجب إكمال إحدى المهام التالية في صفحة **فاتورة النص الحر**:
-   عرض ضريبة المبيعات.
-   عرض إجمالي الفاتورة.
-   عرض التدفق النقدي.
