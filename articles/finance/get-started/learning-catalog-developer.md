...
| [بناء تطبيقات التمويل والعمليات](/learn/paths/build-finance-operations/) | يتطلب التطوير في تطبيقات التمويل والعمليات فهمًا أساسيًا للمهام المطلوبة لإنشاء عناصر جديدة وتخصيص تطبيقات التمويل والعمليات. وتشمل المهام فهم التعليمات البرمجية X++ وVisual Studio، بالإضافة إلى القدرة على إنشاء وتعديل العناصر الأساسية للنظام. | مسار تعليمي عبر الإنترنت مجاني يتحدد وفقًا لقدرات المستخدم | 13 ساعات |
