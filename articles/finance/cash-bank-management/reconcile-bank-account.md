...
>[!NOTE]
>لا تحدد خانة الاختيار **تمت تسويته‬** للحركات التي لا تظهر في كشف الحساب البنكي. سيستمر ظهور هذه الحركات في هذا الصفحة حتى تتم تسويتها مع كشف حساب بنكي مستقبلي.
>لا تتوفر خانة الاختيار **تمت تسويته‬** إذا كانت حالة الحركة **إلغاء معلق‬**. قد تظهر هذه الحالة للحركات إذا تم إعداد Finance بحيث يطالب بإرسال عمليات العكس أو الإلغاء للمراجعة قبل ترحيلها. بعد قيام أحد المراجعين بترحيل عملية العكس أو الإلغاء، فلن تكون الحالة **إلغاء معلق‬**، ويمكن تسوية الحساب البنكي مع كشف الحساب البنكي.
...
> [!NOTE]
> إذا كانت الفترة المحاسبية للحركة المراد تصحيحها مغلقة، فلا استخدام الحقل **قيمة التصحيح**. بدلاً من ذلك، أنشئ بندًا لديه تاريخ حركة في فترة مالية مفتوحة للتصحيح. في هذه الحالة، يجب إضافة الأبعاد المالية التي تم استخدامها في الحركة الأصلية، وكذلك الحساب الرئيسي المقابل.
