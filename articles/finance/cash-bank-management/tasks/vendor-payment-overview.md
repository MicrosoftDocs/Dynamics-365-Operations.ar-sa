...
description: سيوضح هذا الإجراء لك مختلف الطرق المُستخدمة لإنشاء مدفوعات المورد، بما في ذلك كيفية استخدام مقترح دفع أو إدخال دفع فريد يدويًا.
author: kweekley
ms.date: 06/25/2019
...
5. انقر فوق **البنود**.
6. في **‏‫جزء الإجراء‬**، انقر فوق **‏‫مُقترح الدفع‬**.
