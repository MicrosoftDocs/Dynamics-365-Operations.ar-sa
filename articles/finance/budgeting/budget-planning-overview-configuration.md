...
description: تصف هذه المقالة تخطيط الموازنة. وهو يحتوي على معلومات يمكنها المساعدة في تكوين تخطيط الموازنة وإعداد عمليات تخطيط الموازنة.
author: panolte
ms.date: 01/11/2018
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8853543"
---
# <a name="budget-planning-overview"></a>نظرة عامة على تخطيط الموازنة

[!include [banner](../includes/banner.md)]

تصف هذه المقالة تخطيط الموازنة. وهو يحتوي على معلومات يمكنها المساعدة في تكوين تخطيط الموازنة وإعداد عمليات تخطيط الموازنة.
...
تتضمن الوظيفة التي تم تقديمها في الإصدار 10.0.9 (أبريل 2020) من Dynamics 365 Finance ميزة تساعد على تحسين الأداء عندما تستخدم الزر **نشر** لتحديث السجلات الموجودة في Excel ثم نشرها مرة أخرى إلى العميل. تقوم هذه الميزة بتسريع عملية التحديث وتساعد أيضًا على تقليل احتمال حظر تحديث عند تحديث عدد كبير من السجلات في الوقت نفسه. لجعل هذه الوظيفة متوفرة، انتقل إلى مساحة عمل **إدارة الميزات**، وقم بتشغيل الميزة **تحسين استعلام تخطيط الموازنة من أجل الأداء** ضمن **إعداد الموازنة**. نوصي بتشغيل هذه الميزة.
...
ومن الممارسة الجيدة إنشاء سير عمل تخطيط موازنة لكل مستوى من مستويات التدرج الهرمي لإعداد الموازنة. وبعد ذلك، تقوم بتعيين سير عمل إعداد الموازنة الذي يحتوي على العناصر التي تتوافق مع المراحل الموجودة في سير عمل تخطيط الموازنة. في المخطط الذي ورد كمثال في وقت سابق في هذه المقالة، سيتم إنشاء عملية سير عمل تخطيط موازنة واحد لأقسام المبيعات، وسيتم إنشاء آخر للمقر الرئيسي. يقوم سير عمل إعداد الموازنة بنقل خطط الموازنة عبر المراحل.
...
في مثال المخطط الوارد في وقت سابق في هذا الموضوع، يتم التوزيع لنقل مبالغ من خطة موازنة والسيناريوهات الموجودة في المرحلة "الأساسية" للمقر الرئيسي إلى موازنة وسيناريوهات أخرى في مرحلة "التقدير" لقسم المبيعات. يبين الرسم التوضيحي التالي الجزء ذي الصلة من مثال المخطط.
