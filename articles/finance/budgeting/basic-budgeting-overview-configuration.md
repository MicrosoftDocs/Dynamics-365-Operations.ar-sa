...
أضافت الوظيفة المُقدمة في Microsoft Dynamics 365 Finance الإصدار 10.0.7 (يناير 2020) ميزات القدرة والمرونة لإدخالات سجل الموازنة. لتمكين هذه التحسينات، انتقل إلى مساحة عمل **إدارة الميزات** وحدد **إدخالات سجل الموازنة للكمية فقط** و/أو **إدخالات سجل الموازنة التي يتم تحديدها افتراضيًا حسب نوع المبلغ**.
...
تتيح ميزة **إدخالات سجل الموازنة التي يتم تحديدها افتراضيًا حسب نوع المبلغ** لنوع المبلغ الافتراضي في إدخال سجل الموازنة بأن يكون نوع مبلغ بخلاف المصروفات. سيتحول سطر إدخال سجل الموازنة الآن إلى المصروفات افتراضيًا عندما يكون نوع الحساب الرئيسي هو المصروفات؛ ستفترض أنها الإيرادات عندما يكون نوع الحساب الرئيسي هو الإيرادات؛ وسوف يتم حساب المصروفات لجميع أنواع الحسابات الأخرى بشكل افتراضي.
