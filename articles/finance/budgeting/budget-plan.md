...
A. إعداد &gt; الموازنة &gt; تخطيط الموازنة &gt; عمليات سير عمل الموازنة. إنشاء سير عمل جديد باستخدام مهام سير عمل تخطيط موازنة القالب:
