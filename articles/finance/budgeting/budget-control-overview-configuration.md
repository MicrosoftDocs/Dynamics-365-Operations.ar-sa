...
> [!NOTE]
> إذا تم تعديل العملية الحسابية أثناء دورة الموازنة، فلن تؤثر التغييرات في أي من المستندات التي تجاوزت اختبارات رقابة الموازنة في السابق وتم ترحيلها أو إكمالها. في إصدار التطبيق 10.0.17 ، أصبحت مبالغ المسار الوحيد الجديدة في ميزة **الحساب المتاحة لأموال الميزانية** متاحة للعملاء المحدودين. تتيح لك هذه الميزة تغيير البيانات التي يتم تعقبها في جداول BudgetSourceTracking. عند تشغيل هذه الميزة، يتم تخزين المبالغ فقط إذا تم تحديدها لاستخدامها في حساب أموال الموازنة المتوفرة. لطلب تمكين **ميزة الحساب المسار الوحيد في أموال الموازنة** المتوفرة، اتصل بالدعم. 
