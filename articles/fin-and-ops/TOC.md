...
#### حسابات قائمة مكونات الصنف (BOM) التي تستخدم كشف التكاليف (تشغيل دلائل المهام في التسلسل)
...
### حزمة محتوى Power BI
#### [حزمة محتوى إدارة التكلفة](../dev-itpro/analytics/cost-management-content-pack.md)
...
### [استيراد البيانات وتصدير الوظائف](../dev-itpro/data-entities/data-import-export-job.md)
...
#### [المعلومات المالية](../dev-itpro/analytics/financial-insights.md)
...
#### [تصميم تكوين لإنشاء التقارير بتنسيق Microsoft Word لإعداد التقارير الإلكتروني](../dev-itpro/analytics/tasks/er-design-configuration-word-2016-11.md)
#### [تصميم تكوين لإنشاء التقارير بتنسيق OpenXML لإعداد التقارير الإلكتروني](../dev-itpro/analytics/tasks/er-design-reports-openxml-2016-11.md)
...
#### [تعديل تنسيق تقارير إلكترونية من خلال إعادة تطبيق قالب Microsoft Excel](../dev-itpro/analytics/modify-electronic-reporting-format-reapply-excel-template.md)
#### [تحديد تعريف نموذج البيانات أثناء إنشاء تنسيق للتقارير الإلكترونية](../dev-itpro/analytics/tasks/er-select-data-model-definition-creating-er-format-july-2017.md)
...
##### [تصميم التكوينات لإنشاء التقارير بتنسيقات Microsoft Office مع الصور المضمنة لإعداد التقارير الإلكتروني (ER) (الجزء 1) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
...
#### [إنشاء مستندات إلكترونية وتحديث بيانات التطبيق باستخدام أداة إعداد التقارير الإلكتروني](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md)
...
##### [استيراد أحد التكوينات من Lifecycle Services لإعداد التقارير الإلكترونية](../dev-itpro/analytics/tasks/er-import-configuration-lifecycle-services.md)
...
##### [إدارة تكوينات تعيين النماذج لإعداد التقارير الإلكترونية](../dev-itpro/analytics/tasks/er-manage-model-mapping-configurations-july-2017.md)
##### [إنشاء التكوينات المطلوبة لاستيراد البيانات من ملف خارجي لإعداد التقارير الإلكترونية](../dev-itpro/analytics/tasks/er-required-configurations-import-data.md)
#### [استيراد تكوينات إعداد التقارير الإلكترونية](../dev-itpro/analytics/electronic-reporting-import-ger-configurations.md)
#### [توزيع المستندات الواردة لتحديث بيانات التطبيق](../dev-itpro/analytics/parse-incoming-electronic-documents.md)
#### [توزيع المستندات الواردة بتنسيق CSV](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md)

##### [التغييرات في واجهة برمجة التطبيقات (API) لإطار عمل التقارير الإلكترونية لـ Application update 7.3](../dev-itpro/analytics/er-apis-app73.md)
