...
#### [تحديث Platform رقم 12 (نوفمبر 2017)](get-started/whats-new-platform-update-12.md)
#### [تحديث Platform رقم 11 (أكتوبر 2017)](get-started/whats-new-platform-update-11.md)
#### [تحديث Platform رقم 10 (August 2017)](get-started/whats-new-platform-update-10.md)
...
### إعداد تقارير المستندات وطباعتها
#### [نظرة عامة على Document Reporting Services](../dev-itpro/analytics/document-reporting-services.md)
#### [تثبيت أجهزة طابعات الشبكة في البيئات المحلية](../dev-itpro/analytics/install-network-printer-onprem.md)
#### [تكوين SSRS لنشر محلي](../dev-itpro/analytics/configure-ssrs-on-premises.md)
#### [الطباعة](../dev-itpro/analytics/print-documents.md)
##### [تثبيت "وكيل توجيه المستند" لتمكين أجهزة طابعات الشبكة](../dev-itpro/analytics/install-document-routing-agent.md)
...
#### [قائمة تقارير SQL Server Reporting Services](../dev-itpro/analytics/SSRS-report.md)
...
##### [تحميل تكوين إلى Lifecycle Services لإعداد التقارير الإلكترونية](../dev-itpro/analytics/tasks/er-upload-configuration-into-lifecycle-services.md)
##### [التغييرات في واجهة برمجة التطبيقات (API) لإطار عمل التقارير الإلكترونية لتحديث التطبيق 7.3](../dev-itpro/analytics/er-apis-app73.md)
...
#### [كتابة التقارير التحليلية باستخدام Power BI Desktop](../dev-itpro/analytics/author-distribute-power-bi-reports.md)
#### [التصميم والبيانات التجميعية](../dev-itpro/analytics/model-aggregate-data.md)
#### [إضافة الأبعاد المالية إلى القياسات التجميعية](../dev-itpro/analytics/add-financial-dimensions-aggregate-measurements.md)
#### [إضافة التحليلات إلى مساحات العمل باستخدام Power BI Embedded](../dev-itpro/analytics/add-analytics-tab-workspaces.md)
#### [المساعدة في حماية مساحات العمل والتقارير التحليلية باستخدام Power BI Embedded](../dev-itpro/analytics/secure-analytical-workspaces.md)
...
#### [التعامل مع المخزون الاحتياطي](../supply-chain/master-planning/safety-stock-replenishment.md)
