...
| تنفيذ عمليات الإنشاء والاختبار والنشر بشكل تلقائي. | متوفر جزئيًا | نشر طوبولوجيا المطور باستخدام المطور والجهاز الظاهري للتصميم. وتكوين الجهاز الظاهري للتصميم بشكل تلقائي لاكتشاف وتصميم الوحدات من Visual Studio Online (VSO) وإجراء الاختبارات. تجدر الإشارة إلى أنه يتم دعم المراجع والتحويل البرمجي لوحدتي C\# وX++. | بعمل على زيادة إنتاجية المطورين بتقليل التكلفة والجهد للاختبارات وعمليات التحقق من الصحة. |
