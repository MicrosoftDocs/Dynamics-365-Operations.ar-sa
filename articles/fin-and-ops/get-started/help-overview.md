...
| [Lifecycle Services](https://lcs.dynamics.com/en/)\*                      | توفر مساحة عمل تعاونية تستند إلى السحابة يستطيع العملاء والشركاء استخدامها لإدارة مشاريع Dynamics 365 for Finance and Operations بدءًا من مرحلة ما قبل البيع حتى التنفيذ والعمليات. يفيد هذا الموقع في كافة مراحل التنفيذ. |
...
| [Docs.microsoft.com/previous versions](https://docs.microsoft.com/en-us/previous-versions/dynamics/)                                             | يستضيف محتوى من الإصدارات السابقة.                                                                                                                                                                       |
