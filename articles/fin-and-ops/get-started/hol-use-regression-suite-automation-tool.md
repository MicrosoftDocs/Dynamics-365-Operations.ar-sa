...
يمكن استخدام هذه الميزة للتحقق مما إذا كان الإجراء قد حدث أم لا. علي سبيل المثال، عند إنشاء أمر إنتاج وتقديره ثم بدء تشغيله، فإن Microsoft Dynamics 365 for Finance and Operations يعرض الرسالة "الإنتاج – بدء" لإعلامك بأنه قد تم بدء أمر الإنتاج.
...
بعد تشغيل حالة الاختبار، تتم مقارنة الرسالة الموجودة في ملف معلمة Excel بالرسالة الموضحة في Finance and Operations. في حالة عدم تطابق الرسائل، ستفشل حالة الاختبار.
