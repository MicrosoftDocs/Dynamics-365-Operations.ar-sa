...
5. في القائمة، قم بالبحث عن السجل المطلوب وحدده.
    * حدد غرضًا للتعيين إلى التدرج الهرمي للمؤسسات الخاصة بك.  
6. وانقر فوق إضافة.
7. في القائمة، قم بوضع علامة للصف المحدد.
    * ابحث عن التدرج الهرمي الذي قمت بإنشائه.  
8. انقر فوق "موافق".

## <a name="add-organizations-to-the-hierarchy"></a>إضافة مؤسسات إلى التدرج الهرمي
1. في القائمة، قم بالبحث عن السجل المطلوب وحدده.
    * قم بتحديد التدرج الهرمي.  
2. انقر فوق "عرض التدرج الهرمي".
    * قم بإضافة المؤسسات، حسب الحاجة.  
    * لإضافة مؤسسة ما، انقر فوق "تحرير" ثم "إدراج" لإضافة المؤسسة.     عند الانتهاء من إجراء التغييرات، يمكنك حفظ مسودة و/أو نشر التغييرات.  
