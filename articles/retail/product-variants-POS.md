...
# <a name="inventory-lookup-in-the-point-of-sale"></a>البحث في المخزون في نقطة البيع 
...
|  إظهار جميع المواقع  | قم بالتبديل إلى طريقة عرض البحث عن المخزون القياسي، وقم بتمييز معلومات توافر المخزون لمتغير الصنف عبر كافة المتاجر في مجموعة محدِّد مواقع المتاجر، وكذلك في مراكز التوزيع من النوع <strong>القياسي/الافتراضي</strong>. |
| عرض تفاصيل المنتج |                                                                         أعد توجيه المستخدم إلى صفحة <strong>تفاصيل المنتج</strong> لأصل المنتج المقترن.                                                                          |
