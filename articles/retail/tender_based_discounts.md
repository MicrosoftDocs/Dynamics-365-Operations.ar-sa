...
في Microsoft Dynamics 365 Retail، يمكن لبائعي التجزئة تكوين نسبه مئوية للخصم يتم تطبيقها على البنود المؤهلة في حاله دفع العميل باستخدام طريقة الدفع المفضلة. يمكن للعميل أن يقرر ما إذا كنت تريد إجراء دفع جزئي أو دفع كامل، ويقوم Retail بتحديد مبلغ الخصم المناسب. لاحظ أنه يتم دائما تقديم الخصم في مبلغ ما قبل الضريبة للأصناف المؤهلة.
...
> [!IMPORTANT]
> في Retail، يتم تحديد الخصومات المستندة إلى طريقة الدفع حاليا إلى نوعين من أنواع الدفع: بطاقات الائتمان والنقد.
...
غالبًا ما يختار بائعو التجزئة استبعاد بعض المنتجات، مثل الأصناف الجديدة أو الأصناف الموجودة في الطلب، من الخصومات. ومع ذلك، قد لا يزالوا يرغبون في تطبيق الخصومات المستندة إلى طريقة الدفع. على سبيل المثال، يقوم البائع بالتجزئة بتكوين Retail بحيث لا يسمح بالخصومات التي تعتمد على الأصناف أو الخصومات اليدوية. ومع ذلك، في حالة سداد العميل باستخدام طريقة الدفع المفضلة، يزال Retail يطبق الخصم المستند إلى طريقة الدفع. لإعداد Retail بهذه الطريقة، يجب على بائعي التجزئة إيقاف تشغيل خياري **‏‫منع جميع الخصومات‬** و **منع الخصومات المستندة إلى طريقة الدفع** وتشغيل خياري **منع خصومات البيع بالتجزئة** و **‏‫منع الخصومات اليدوية‬**. توجد الخيارات في صفحة **المنتجات الصادرة‬** ضمن علامة التبويب **Retail**.

> [!NOTE]
> عندما يكون تكوين **‏‫منع جميع الخصومات‬** قيد التشغيل، لن يتم تطبيق إيه خصومات على المنتج. ولن يتم تطبيق حتى الخصومات المستندة إلى طريقة الدفع.
