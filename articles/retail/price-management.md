...
### <a name="effect-of-the-price-includes-sales-tax-setting-on-financial-postings"></a>تأثير إعداد السعر شاملاً ضريبة المبيعات على عمليات الترحيل المالي
تتأثر جميع المبالغ التي تم ترحيلها إلى دفتر الأستاذ العام لحسابات الإيرادات والخصومات بإعداد **السعر شاملاً ضريبة المبيعات**. يوضح المثال التالي مدى تأثير هذا الإعداد على عمليات الترحيل المالي.

يتناول المثال عمليات ترحيل المبيعات فقط، نظراً لأن إعداد **السعر شاملاً ضريبة المبيعات** لا يؤثر على عمليات ترحيل تكاليف المخزون.

#### <a name="example"></a>مثال
وفي هذا المثال، يتم تكوين مبالغ الخصم بحيث يتم ترحيلها بشكل منفصل عن الإيراد.

تبيع أنت منتجًا بمبلغ 100 دولار ويشمل معدل ضريبة بنسبة 10 بالمائة، ويتم تطبيق خصم بنسبة 5 بالمائة. يتم استخدام الحسابات التالية من بيانات العرض التوضيحي لـ USRT:

- **الإيراد:** 401100
- **الخصم:** 403200
- **الضريبة:** 202100

**الحالة 1: الضريبة الخاصة (تُعرف أيضًا بضريبة المبيعات)**

- **الإيراد:**  100دولار
- **الخصم:** 5 دولارات
- **الضريبة:** 9.5 دولارات (= 10 بالمائة من 95 دولارًا)

**الحالة 2: الضريبة الشاملة (تُعرف أيضًا بضريبة القيمة المضافة \[VAT\])**

- **الإيراد:** 90 دولارًا
- **الخصم:** 4.5 دولار (= 5 بالمائة من 90 دولارًا)
- **الضريبة:** 10 دولارات
