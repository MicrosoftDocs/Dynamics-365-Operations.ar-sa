...
description: توفر هذه المقالة معلومات حول متاجر البيع بالتجزئة عبر الإنترنت وكيفية إعدادها في Dynamics 365 Retail.
author: kfend
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
ms.locfileid: "2017956"
---
# <a name="set-up-online-stores"></a>إعداد متاجر على الإنترنت

[!include [banner](includes/banner.md)]

توفر هذه المقالة معلومات حول متاجر البيع بالتجزئة عبر الإنترنت وكيفية إعدادها في Dynamics 365 Retail.
