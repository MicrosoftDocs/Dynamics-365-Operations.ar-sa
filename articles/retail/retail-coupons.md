...
لإنشاء قسيمة، يمكنك إنشاء الخصم والقسيمة بشكل منفصل. يمكنك عندئذٍ ربطها بتحديد الخصم في صفحة القسيمة في Microsoft Dynamics 365 for Retail.

> [!NOTE]
> بعد ربط قسيمة بخصم، تصبح عدة حقول في صفحة الخصم في Microsoft Dynamics 365 for Retail للقراءة فقط، نظرًا لإدارتها من خلال إعدادات القسيمة. تتضمن هذه الحقول حقول الحالة ونطاقات التاريخ القياسية.
...
تتضمن وظائف القسيمة العديد من الميزات البارزة في Dynamics 365 for Retail. يمكن تحديث مقر Microsoft Dynamics 365 for Retail والقناة بشكل جزئي عبر المكونات. لذلك، من المهم أن تفهم كيف تؤثر التحديثات الجزئية على وظائف القسيمة ككل.
