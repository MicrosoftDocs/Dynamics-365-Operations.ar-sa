...
> [!NOTE]
> إننا نعمل على إزالة الإصدار الحالي من خدمة توصيات المنتجات، إذا سنعيد تصميم هذه الميزة من خلال خوارزمية أفضل وقدرات أحدث موجهة نحو البيع بالتجزئة. للحصول على مزيد من المعلومات راجع [الميزات المهلكة أو التي تمت إزالتها‬](../dev-itpro/migration-upgrade/deprecated-features.md). انتقل إلى الجزء السفلي من الصفحة إذا كنت تواجه مشكلات مع توصيات المنتجات المُمكنة بالفعل لبيئتك. 
