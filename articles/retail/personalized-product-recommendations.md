...
2.  انتقل إلى **متجر الكيانات**، وحدد **بيع بالتجزئة‬**، ثم انقر فوق **تحديث**. سوف يستخدم هذا بيانات العرض التوضيحي (أو بياناتك) من قاعدة البيانات التشغيلية، ويقوم بنقلها إلى متجر الكيان.
