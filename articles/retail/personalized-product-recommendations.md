...
> - انتقل إلى **‏‫معلمات Retail** > **التعلم الآلي** > **تعطيل توصيات المنتج**، ثم قم بتشغيل **وظيفة التكوين العمومي**. في حالة عدم قدرتك على العثور على علامة تبويب **التعلم الآلي**، الرجاء الاتصال بدعم Dynamics. 
> 
