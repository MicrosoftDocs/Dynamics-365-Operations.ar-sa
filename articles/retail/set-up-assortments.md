...
description: توضح هذه المقالة ماهية عملية الفرز وتشرح كيفية إعداد عمليات الفرز في Dynamics 365 Retail.
author: jblucher
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
ms.locfileid: "2024904"
---
# <a name="set-up-assortments"></a>إعداد عمليات الفرز

[!include [banner](includes/banner.md)]

توضح هذه المقالة ماهية عملية الفرز وتشرح كيفية إعداد عمليات الفرز في Dynamics 365 Retail.
