...
11. إعداد أعضاء الفريق.
    ...
    > [!NOTE]
    > يجب أيضًا تعيين الأذونات المناسبة للعاملين، بحيث يمكنهم تسجيل الدخول وتنفيذ المهام باستخدام Dynamics 365 for Retail لنظام Retail POS.
