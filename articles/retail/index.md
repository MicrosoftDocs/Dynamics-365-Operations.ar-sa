...
ms.locfileid: "2811916"
---
# <a name="help-resources-for-dynamics-365-retail"></a>موارد تعليمات Dynamics 365 Retail

[!include [banner](includes/banner.md)]

إن Microsoft Dynamics 365 Retail عبارة عن حل شامل للبيع بالتجزئة يقدم تجارة موحدة عبر جميع القنوات. إنه يشتمل على المبيعات، وإمكانية التنقل، والمعلومات، والإنتاجية، لمساعدة تجار التجزئة والعمال على تحقيق المزيد بطريقة السحابة أولاً، الجهاز المحمول أولاً. يوفر Retail دعمًا شاملاً لتشغيل مجموعة كبيرة من إجراءات العمل، مثل إمكانات إدارة القنوات، وترويج البضائع، والمخزون. كما يقدم أيضًا للعملاء تجارب رائعة عبر جميع نقاط الاتصال.
...
- [Retail للمحترفين والمطورين في مجال تقنية المعلومات](dev-itpro/dev-retail-home-page.md)
