...
تحليل الحداثة والتكرار والقيم النقدية (RFM) هو أداة تسويق تستخدمها مؤسستك لتقييم البيانات التي يتم إنشاؤها بواسطة مشتريات العميل. بعد إعداد تحليل RFM، يتم تعيين مجموع RFM المحسوب للعملاء عند إجراء عمليات الشراء. يمكن أن يكون مجموع RFM تصنيف من ثلاثة أرقام أو عدد تجميع، اعتمادًا على كيفية تكوين المؤسسة لتحليل RFM. إليك كيفية عمل تصنيف إذا كانت مؤسستك تستخدم تصنيفًا مكوناً من ثلاثة أرقام للنتيجة:
...
1.  انتقل إلى **مركز اتصال** > **دوري** > **تحليل RFM**.
...
7.  في علامة التبويب السريعة **‏‫مبلغ نقدي‬**، قم بما يلي: 
    ...
    - إذا كان يجب طرح مبالغ مرتجعات العميل من حساب إجمالي الفاتورة للعميل، حدد خانة الاختيار **‏‫عائدات الخصم‬**. 
 
## <a name="view-a-customers-rfm-score"></a>عرض نقاط RFM للعميل
استخدم هذا الإجراء لعرض نقاط RFM للعميل. 

1.  انتقل إلى **مركز اتصال** > **دفاتر اليومية** > **خدمة العملاء**. 
