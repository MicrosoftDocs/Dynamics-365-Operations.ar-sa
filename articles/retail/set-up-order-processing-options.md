...
description: يوفر هذا الموضوع معلومات حول كيفية معالجة أوامر مراكز الاتصال باستخدام Dynamics 365 Retail.
author: josaw1
manager: AnnBe
ms.date: 04/16/2018
ms.topic: article
...
ms.locfileid: "2024811"
---
# <a name="set-up-call-center-channels"></a>إعداد قنوات مركز الاتصال

[!include [banner](includes/banner.md)]

بإمكان شركة تعريف قنوات مراكز اتصال متعددة في Dynamics 365 Retail. يتم تكوين قنوات مركز الاتصال في **Retail**\>**قنوات**\>**مراكز الاتصال**\>**كافة مراكز الاتصال**، وهي محددة لكيان قانوني.
