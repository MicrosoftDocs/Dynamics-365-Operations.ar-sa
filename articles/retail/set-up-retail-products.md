...
توضح هذه المقالة كيفية إعداد منتجات البيع بالتجزئة في Dynamics 365 Retail.

قبل أن تتمكن عرض المنتجات للبيع في قنوات البيع بالتجزئة، يجب عليك إنشاء المنتجات وتكوينها في Dynamics 365 Retail. يقوم Retail بإنشاء منتجات على مستوى المؤسسة في أصل المنتج. يمكنك إنشاء المنتجات وتحديد سمات وخصائص المنتجات وتعيين المنتجات للتدرجات الهرمية للبيع بالتجزئة. ولتوفير المنتجات لقنوات البيع بالتجزئة الخاصة بك وإضافتها إلى عملية فرز نشطة، يجب إصدار المنتجات للكيانات القانونية حيثما تكون متاحة. ولإعداد المنتجات التي تبيعها باستخدام قنوات البيع بالتجزئة، أكمل المهام التالية.
