...
هذا الموضوع هو نظرة عامة حول قدرات التكامل المالي المتوفرة في Microsoft Dynamics 365 for Retail. يتضمن التكامل المالي التكامل مع أجهزة وخدمات مالية مختلفة تمكّن التسجيل المالي لمبيعات البيع بالتجزئة المالية وفقًا للقوانين المالية المحلية التي تهدف إلى منع الاحتيال الضريبي في مجال البيع بالتجزئة. فيما يلي بعض السيناريوهات النموذجية التي يمكن تغطيتها باستخدام التكامل المالي: 

- تسجيل مبيعات البيع بالتجزئة على جهاز مالي متصل بنقطة بيع للبيع بالتجزئة، مثل طابعة الضرائب المحصلة، وطباعة إيصال مالي للعميل.
...
تعتبر وظيفة التكامل المالي في Retail إطار عمل يوفر حلاً مشتركًا لمزيد من التطوير والتخصيص للتكامل بين Retail POS والأجهزة والخدمات المالية. وتتضمن الوظيفة أيضًا نماذج التكامل المالي التي تدعم السيناريوهات الأساسية للبيع بالتجزئة لبلدان أو مناطق محددة، والتي تصلح لخدمات أو أجهزة مالية محددة. يتكون نموذج التكامل المالي من عدة ملحقات لمكونات Retail وهو مضمن في مجموعة تطوير برنامج (SDK) Retail. للحصول على مزيد من المعلومات حول نماذج التكامل المالي المتاحة في Retail SDK، راجع [نماذج التكامل المالي في Retail SDK](#fiscal-integration-samples-in-the-retail-sdk). للحصول على مزيد من المعلومات حول كيفية تثبيت واستخدام Retail SDK، راجع [نظرة عامة على Retail SDK](../dev-itpro/retail-sdk/retail-sdk-overview.md).
...
بإمكان عملية التسجيل المالي في Retail POS أن تتكون من خطوة واحدة أو أكثر. تشتمل كل خطوة على التسجيل المالي لأحداث أو حركات بيع بالتجزئة معينة في جهاز مالي واحد أو خدمة مالية واحدة. تشارك مكونات الحل التالية في التسجيل المالي في جهاز مالي متصل بمحطة أجهزة:

- **ملحق وقت التشغيل التجاري (CRT)** – يقوم هذا المكون بسلسة بيانات حدث/حركة البيع بالتجزئة بالتنسيق الذي يُستخدم أيضًا للتفاعل مع الجهاز المالي، ويقوم بتوزيع الاستجابات من الجهاز المالي ويخزن الاستجابات في قاعدة بيانات القناة. ويحدد الملحق أيضًا الحركات والأحداث المعينة التي يجب تسجيلها. يشار إلى هذا المكون في أغلب الأحيان بالاسم *موفر المستندات المالية*.
- **ملحق محطة الأجهزة** - يقوم هذا المكون بتهيئة الاتصال بالجهاز المالي، ويرسل الطلبات ويوجه الأوامر إلى الجهاز المالي استنادًا إلى بيانات حركة/حدث البيع بالتجزئة التي تم استخراجها من المستند المالي، و ويتلقى الاستجابات من الجهاز المالي. يشار إلى هذا المكون في أغلب الأحيان بالاسم *موصل مالي*.
...
4. يقوم CRT بتشغيل موفر المستندات المالية الذي يقوم بإنشاء مستند مالي (على سبيل المثال، مستند XML) يمثل حدث أو حركة البيع بالتجزئة.
...
يتم تحويل الحركات المالية Retail Headquarters بواسطة *وظيفة P*، مع حركات البيع بالتجزئة. على علامة التبويب السريعة **الحركات المالية** في صفحة **حركات متجر البيع بالتجزئة**، يمكنك عرض الحركات المالية المرتبطة بحركات البيع بالتجزئة.
...
في الوقت الحالي، تتوفر نماذج التكامل المالي التالية في Retail SDK التي تم إصدارها مع Retail:

- [نموذج تكامل طابعة الضرائب المحصلة لإيطاليا](emea-ita-fpi-sample.md)
- [نموذج تكامل طابعة الضرائب المحصلة لبولندا](emea-pol-fpi-sample.md)
...
- [نموذج تكامل وحدة التحكم للسويد](../dev-itpro/retail-sdk/retail-sdk-control-unit-sample.md)
