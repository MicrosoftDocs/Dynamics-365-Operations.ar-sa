...
description: يوفر هذا الموضوع نظرة عامة حول قدرات التكامل المالي المتوفرة في Dynamics 365 Retail.
author: josaw
manager: annbe
ms.date: 02/01/2019
ms.topic: article
...
تعتبر وظيفة التكامل المالي إطار عمل يوفر حلاً مشتركًا لمزيد من التطوير والتخصيص للتكامل بين Retail POS والأجهزة والخدمات المالية. وتتضمن الوظيفة أيضًا نماذج التكامل المالي التي تدعم السيناريوهات الأساسية للبيع بالتجزئة لبلدان أو مناطق محددة، والتي تصلح لخدمات أو أجهزة مالية محددة. يتكون نموذج التكامل المالي من عدة ملحقات لمكونات Retail وهو مضمن في مجموعة تطوير البرنامج (SDK). للحصول على مزيد من المعلومات حول عينات التكامل المالي، راجع [نظرة عامة على عينات التكامل المالي في Retail SDK](#fiscal-integration-samples-in-the-retail-sdk). للحصول على مزيد من المعلومات حول كيفية تثبيت واستخدام Retail SDK، راجع [نظرة عامة على Retail SDK](../dev-itpro/retail-sdk/retail-sdk-overview.md).
