...
لا تتوفر بعض العمليات حاليًا ‏‫في نقطة البيع الحديثة للبيع بالتجزئة ونقطة بيع المجموعة لـ Dynamics 365 for Retail.‬ تكون بعض هذه العمليات إما عمليات خاصة بالإعدادات المحلية التي تتطلب التكوين وملحقات إضافية. والأخرى تكون ميزات من Microsoft Dynamics AX 2012 غير مدعومة في الوقت الحالي.
...
ملاحظة: تنطبق العمليات المدرجة أدناه على أحدث إصدار من Dynamics 365 for Retail. ربما تم تغيير بعض العمليات أو قد لا تتوفر في الإصدارات السابقة.
...
| 919 | تسجيل الدخول الموسع | تعيين أو إزالة الأذونات لتسجيل الدخول عن طريق مسح الرمز الشريطي أو عن طريق تمرير بطاقة. | نعم | نعم | نعم | لا | لا |
...
| 2000 | إدارة الجداول | تتيح هذه العملية للمستخدمين إنشاء جداول الموظف أو تعديلها أو عرضها. | نعم | نعم | نعم | لا | لا |
| 2001 | جدولة الطلبات | تتيح هذه العملية للمستخدم طلب عطلة عمل أو تبديل الورديات أو عرض ورديات على الموظفين الآخرين. | نعم | نعم | نعم | لا | لا |
