...
تعتبر معظم الإجراءات التي يتخذها المستخدم في النقطة البيع (POS) من العمليات. يتم تكوين العمليات وإدارتها في مكتب الدعم في Dynamics 365 Retail. يمكن إضافة العديد من العمليات إلى الأزرار في شريط الأوامر لنقطة البيع. بعد ذلك، يتمكن المستخدمون من تحديد الأزرار لاستدعاء العمليات والقيام بوظيفتها. تكون العمليات الأخرى جزءًا من تطبيق نقطة البيع الأساسي، ويتم استدعاؤها إما من الأزرار التي تظهر على الشاشة أو كجزء من عمليات سير العمل أو عمليات أخرى.

يوفر الجدول التالي تفاصيل حول العمليات المتاحة في Retail Modern POS وCloud POS. يحدد الجدول أيضًا المكان في التطبيق حيث يمكن استدعاء العمليات، وما إذا كانت متوفرة عندما تكون نقطة البيع في الوضع "غير متصل".‬

ثمة عمليات غير متوفرة في Retail Modern POS أو Cloud POS. تكون بعض هذه العمليات إما عمليات خاصة بالإعدادات المحلية التي تتطلب التكوين وملحقات إضافية. أما البعض الآخر فعبارة عن ميزات من Microsoft Dynamics AX 2012 غير مدعومة في الوقت الحالي.
...
> [!NOTE]
> تنطبق العمليات المدرجة أدناه على أحدث إصدار من Retail. ربما تم تغيير بعض العمليات أو قد لا تتوفر في الإصدارات السابقة.
