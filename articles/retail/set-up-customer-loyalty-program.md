...
يجب إعداد العديد من المكونات لتمكين ميزة الولاء في Dynamics 365 for Retail. يوضح الرسم التخطيطي التالي مكونات الولاء وكيفية ارتباطها ببعضها البعض.

![تدفق عملية إعداد الولاء‬‏‫](./media/loyaltyprocess.gif "مكونات الولاء وكيفية ارتباطها ببعضها البعض‬")
...
|--------------------------------------|-------------|-----------|
| 1050 (معلومات الولاء)           | شغّل هذه العملية لإرسال بيانات تكوين الولاء من Dynamics 365 for Retail إلى متاجر البيع بالتجزئة. إنها لفكرة جيدة أن تتم جدولة هذه العملية ليتم تشغيلها بشكل متكرر، بحيث يتم إرسال بيانات الولاء إلى كافة المتاجر. | جدول التوزيع |
...
- يُعتبر الشحن المجاني أو المخصوم أحد أهم عوامل تحفيز العملاء للشراء عبر الإنترنت. لتمكين بائعي التجزئة من إعداد عروض ترويجية للشحن، قدمنا، في الإصدار 10.0، نوع عرض ترويجي جديدًا يسمى "خصم حد الشحن"، حيث يستطيع بائع التجزئة تعيين حدود تؤدي تلبيتها إلى تأهيل العميل للاستفادة من الشحن المجاني أو المخصوم. على سبيل المثال، أنفق مبلغ 35 دولارًا أمريكيًا مقابل "شحن لمدة يومين مجانًا" أو "شحن لمدة يومين مجانًا" لجميع عملاء برنامج الولاء. تطبق هذه الخصومات فقط على تكاليف الشحن المطبقة على الأوامر. يحتاج بائع التجزئة إلى تحديد التكاليف التي يعتبرها بمثابة تكاليف الشحن، وذلك بسبب قدرته على إعداد أنواع تكاليف متعددة، مثل المعالجة أو التثبيت. يسمى هذا التكوين "رمز رسوم الشحن" ويتوفر على علامة التبويب **أوامر العملاء** في صفحة **معلمات‏‎ البيع بالتجزئة**. يراعي هذا الخصم كافة قدرات الخصم القياسية الموجودة، مثل السماح لبائع التجزئة بحصر هذه الخصومات بالقسائم حتى يتمكن فقط العملاء الذين يستخدمون القسائم من الحصول هذه الخصومات. بالإضافة إلى ذلك، تستفيد هذه الخصومات من قدرة مجموعات الأسعار على تحديد الأهلية للاستفادة من مثل هذه الخصومات. على سبيل المثال، بإمكان بائع التجزئة أن يختار تشغيل هذه العروض الترويجية فقط في القنوات عبر الإنترنت و/أو عبر القنوات لمجموعات معينة من العملاء مثل عملاء برنامج الولاء. عندما تتمكن بنود الأمر مع وضع التسليم المحدد من تلبية الحد المعين، سيتم عندئذٍ تطبيق خصم الشحن الذي سيقلل تكاليف الشحن استنادًا إلى إعداد الخصم. 

> [!NOTE]
> بعكس الخصومات الدورية الأخرى مثل الخصومات على الكمية والخصومات البسيطة وخصومات المنتجات المختلفة وخصومات الحد، لا ينشئ خصم الشحن بنود خصم، يجب إدخال التعديلات على تكلفة الشحن بشكل مباشر.
