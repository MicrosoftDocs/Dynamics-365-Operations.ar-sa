...
يتم تعيين إعداد لغة مستخدم نقاط البيع من **جميع العمال** بصفحة **العامل** ضمن **‎البيع بالتجزئة &gt; اللغة**.  لم يتم التعيين إلى لا على علامة التبويب ملف التعريف الأساسي.  لا يتم استخدام هذا الإعداد بواسطة نقطة البيع. إذا لم يتم تعيين لغة المستخدم أو إذا تم تعيينها إلى لغة لا تتوفر فيها ترجمات، ستعود نقطة البيع إلى لغة المتجر.  
