...
تتوفر هذه الوظيفة في الإصدار 8.1.2 والإصدارات اللاحقة من Microsoft Dynamics 365 for Retail.

## <a name="configure-store-hours"></a>تكوين ساعات المتجر

اتبع الخطوات التالية لتكوين ساعات المتجر.

1. انتقل إلى **البيع بالتجزئة** \> **إعداد القناة** \> **ساعات المتجر**.
...
3. في مربع الحوار‏‎ **إضافة نطاق**، حدد نطاق التاريخ وساعات المتجر وأيام العطل المطلوبة.
    ...
    ![مربع الحوار "إضافة نطاق"](../dev-itpro/media/Storehours1.png "مربع الحوار \"إضافة نطاق\"")
...
4. اربط قالب ساعات المتجر بالمتاجر حيث سيتم استخدامه. في مربع الحوار **اختيار عُقد المؤسسة‬**، حدد المتاجر والمناطق والمؤسسات التي يجب ربط القالب بها.
    ...
    ![مربع الحوار "اختيار عُقد المؤسسة‬"](../dev-itpro/media/Storehours2.png "مربع الحوار \"اختيار عُقد المؤسسة‬\"")
...
![مثال عن إيصال](../dev-itpro/media/Storehours3.png "مثال عن إيصال")
