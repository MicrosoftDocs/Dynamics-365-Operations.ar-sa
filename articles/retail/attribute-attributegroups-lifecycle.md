...
تتيح لك إعدادات عامل التصفية للسمات تحديد كيفية إظهار عوامل التصفية للصفات في نقاط البيع بالتجزئة. للوصول إلى إعدادات عامل التصفية لسمة، على صفحة **السمات**، حدد السمة ثم في جزء الإجراءات، حدد **إعدادات عامل التصفية**.
...
6. في علامات التبويب السريعة التالية، قم بتحديث قيم السمات المطلوبة:
    ...
    > [!NOTE]
    > إذا تم إنشاء مشاركة وسائط المنتج ومشاركة سمات المنتج في، فستنطبق على جميع منتجات البيع بالتجزئة.
