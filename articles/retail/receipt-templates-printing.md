...
تصف هذه المقالة كيفية تعديل تخطيطات النماذج للتحكم في كيفية طباعة الإيصالات والفواتير والمستندات الأخرى. يتضمن Dynamics 365 Retail مصمم تخطيط النموذج الذي يمكنك استخدامه لإنشاء مختلف أنواع تخطيطات النماذج وتعديلها بسهولة.
...
5. بعد اكتمال عملية التثبيت، أدخل اسم مستخدم Retail وكلمة مرور، ثم انقر فوق **تسجيل الدخول** لبدء تشغيل المصمم.
