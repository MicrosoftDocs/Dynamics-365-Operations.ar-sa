---
title: ما الجديد أو المتغير في Dynamics 365 for Talent (13 أغسطس 2019)
...
ms.locfileid: "1887473"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-august-13-2019"></a>ما الجديد أو المتغير في Dynamics 365 for Talent (13 أغسطس 2019)
...
تنطبق التغييرات التي ورد وصفها في هذا القسم على الإصدار رقم 8.1.2421.0
...
نادرًا ما تصبح التغييرات في سجل الموظفين سارية المفعول على الفور. تحتاج إلى تحديث البيانات اعتبارًا من تاريخ بدء الموظف، والذي غالبًا ما يكون في المستقبل، وتحتاج أيضًا إلى تحديث المعلومات في الماضي. باستخدام نموذج التنقل المبسط هذا، ستتمكن من تحديث البيانات المستقبلية والسابقة دون الانتقال إلى نماذج متعددة أو تغيير سياق التاريخ. يؤدي هذا التغيير أيضًا إلى ترقية وعرض معلومات أساسية بطريقة ديناميكية في منطقه الشعار العلوي من سجل الموظف.
