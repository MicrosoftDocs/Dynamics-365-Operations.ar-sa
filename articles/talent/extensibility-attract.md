...
1. لتوسيع مجموعة خيارات **سبب الرفض**، انتقل إلى [موقع ويب لإدارة PowerApps.](Https://admin.powerapps.microsoft.com)
