...
ms.locfileid: "4528065"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-june-18-2019"></a>ما الجديد والمتغير في Dynamics 365 Talent (18 يونيو 2019)
...
تنطبق التغييرات التي ورد وصفها في هذا القسم على الإصدار رقم 8.1.2347.

### <a name="confirmation-of-course-participants-causes-an-error"></a>يؤدي التأكيد علي المشاركين في الدورة التدريبية إلى حدوث خطأ

تمت إزالة مربع الحوار الخاص بطباعة التقرير حول المشاركين في الدورة التدريبية. هذا التقرير غير مدعوم في Talent.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>لا يتوفر قسم تعويض صفحة تحويل العامل في بعض السيناريوهات

يتيح هذا التغيير للمستخدمين إدخال بيانات التعويض عند ملء صفحة **تحويل العامل**.
...
ستدعم الكيانات التالية الحقول المخصصة: كود إيرادات الرواتب والنقطة المرجعية للتعويض. 
