...
ms.locfileid: "1729716"
---
# <a name="email-templates"></a>قوالب البريد الإلكتروني
[!include[banner](../includes/banner.md)]

باستخدام مكتبة قوالب البريد الإلكتروني، يمكن للمسؤولين إنشاء نسق وسمة علامة تجارية موحدة لجميع رسائل البريد الإلكتروني التي تم إرسالها عن طريق Microsoft Dynamics 365 for Talent: Attract and Offer. بإمكان المسؤولين أيضًا تحديد مجموعة من قوالب محتوى البريد الإلكتروني التي يستطيع مستخدمون آخرون استعمالها. بإمكان فريق التوظيف استخدام هذه القوالب في سير عملهم لإرسال رسائل البريد الإلكتروني بطريقة أكثر كفاءة. تم تكوين بعض رسائل البريد الإلكتروني لإرسالها تلقائيًا، وباستطاعة المسؤول استخدام مكتبة قوالب البريد الإلكتروني لتخصيص محتوى رسائل البريد الإلكتروني هذه.
