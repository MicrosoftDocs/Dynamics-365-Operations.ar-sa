...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>ما الجديد أو المتغير في Dynamics 365 Talent‏ (14‏ يناير 2020)
...
تنطبق التغييرات التي ورد وصفها في هذا القسم على الإصدار رقم 8.1.2709. تشير الأرقام الموجودة بين أقواس في بعض العناوين إلى أرقام الدعم في Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>النظام غير قادر علي إنشاء أيام التقويم عند الاستيراد من خلال اطار عمل أداره البيانات (381195)

يقوم هذا التغيير بتصحيح مشكله عندما ينشئ استيراد أيام التقويم خطأ **تنسيق تاريخ غير صالح**. يمنع هذا الخطا إنشاء بنود تاريخ تقويم العمل.
