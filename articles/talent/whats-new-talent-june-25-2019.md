...
ms.locfileid: "2896855"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-june-25-2019"></a>ما الجديد والمتغير في Dynamics 365 Talent (25 يونيو 2019)
...
تنطبق التغييرات التي ورد وصفها في هذا القسم على الإصدار رقم 8.1.2357.

### <a name="incorrect-value-displayed-for-primary-position-314266"></a>عرض قيمة غير صحيحة للمنصب الأساسي (314266)

ستقوم هذه التغييرات بعرض إعداد **‏‫المنصب الأساسي** بصورة متناسقة علي كل الصفحات.

### <a name="cant-edit-after-recalling-the-workflow-in-review-318180"></a>لا يمكن التحرير بعد استدعاء سير العمل قيد المراجعة (318180)

يمكن الآن تحرير المراجعات التي تم استدعاؤها عبر سير العمل.

### <a name="final-comments-field-in-reviews-isnt-translated-325921"></a>حقل التعليقات النهائية في المراجعات غير مترجم (325921)

ستتم ترجمة تسمية **التعليقات النهائية** في Talent.
...
### <a name="feature-management-area-in-talent"></a>منطقة إدارة الميزات في Talent

ستتم إزالة **إدارة الميزات** من **إدارة النظام** بسبب المشكلات التي تحدث مع الميزة. سنقوم بإعادة تقديم **إدارة الميزات** في إصدار مستقبلي. 

### <a name="common-data-service-entity-support-for-custom-fields"></a>دعم كيان Common Data Service للحقول المخصصة

ستدعم الكيانات التالية الحقول المخصصة**كود أرباح كشف الرواتب‬** و**حدث التعويض الثابت** و**شبكة التعويض** و**فتر الدفع** و**النقطة المرجعية للتعويض**. 

### <a name="new-common-data-service-entities"></a>كيانات Common Data Service جديدة

ستتم إضافة كيان **أكواد الأسباب** إلى Common Data Service.
