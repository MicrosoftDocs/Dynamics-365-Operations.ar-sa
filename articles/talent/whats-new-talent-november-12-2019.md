...
ms.locfileid: "2896648"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>ما الجديد أو المتغير في Dynamics 365 Talent‏ (12 نوفمبر 2019)
...
تنطبق التغييرات التي ورد وصفها في هذا القسم على الإصدار رقم 8.1.2604. تشير الأرقام الموجودة بين أقواس في بعض العناوين إلى أرقام الدعم في Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>لم يتم تحديث موقع المكتب بواسطة مصنف Excel (369727)

وبهذا التغيير، يمكنك الآن تحديث موقع المكتب باستخدام "مصمم مصنف Office".
