...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-september-17-2019"></a>ما الجديد أو المتغير في Dynamics 365 for Talent‏ (17 سبتمبر 2019)
...
تنطبق التغييرات التي ورد وصفها في هذا القسم على الإصدار رقم 8.1.2492. تشير الأرقام الموجودة بين أقواس في بعض العناوين إلى أرقام الدعم في Microsoft Dynamics Lifecycle Services (LCS).
...
### <a name="human-resources-staff-cant-see-performance-review-details-once-assigned-to-them-by-workflow-370308"></a>لا يتسنى لموظفي الموارد البشرية رؤية تفاصيل مراجعة الأداء بمجرد تعيينها من قبل سير العمل (370308)

عبر تحديث هذا الأسبوع، سيتمكن موظو الموارد البشرية من رؤية تفاصيل مراجعة الأداء التي تم تعيينها لهم من خلال معالجة سير العمل. لعرض المراجعات، انتقل إلى **‏‫خدمة الموظف الذاتية‬> ‏‫عناصر عمل تم تعيينها إلي‬**.

### <a name="job-family-field-missing-in-the-manage-changes-page-for-job-details-346031"></a>الحقل "مجموعة الوظائف" مفقود في صفحة "إدارة التغييرات" لتفاصيل الوظيفة (346031)

في هذا الإصدار، تم إضافة الحقل "مجموعه الوظائف إلى صفحة **إدارة التغييرات** لتفاصيل الوظيفة.
...
لمزيد من المعلومات، راجع [إدخال الموظفين والتنقل المبسط‬](./streamlined-employee-entry.md). لرؤية التغييرات، شاهد الفيدو الموجهة 2 من إصدار [Dynamics 365 for Talent 2019](https://aka.ms/ROGT19RW2ROV)
