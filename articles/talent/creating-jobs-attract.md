...
---
# <a name="create-a-job-in-attract"></a>إنشاء وظيفة في Attract
...
وبحسب الإعدادات الموجودة في نشاط العرض لعملية التوظيف، يمكن استخدام رقم منصب ما مرتين في أحد العروض. لمزيد من المعلومات، راجع [الأنشطة في عمليات التوظيف](./activities-attract.md).
...
للحصول على مزيد من المعلومات حول الأنشطة التي يمكن إضافتها إلى عملية التوظيف، راجع [الأنشطة في عمليات التوظيف](./activities-attract.md).
...
للحصول على مزيد من المعلومات حول إعلانات الوظائف، راجع [إعداد موقع الوظائف في Microsoft Dynamics 365 Talent - Attract](career-site.md).
...
يتم تعيين الخيار المتعلق بإضافة موظفين محتملين إلى وظيفة في [الأنشطة في عمليات التوظيف](./activities-attract.md#prospect-activity) في عملية التوظيف. يجب تعيين هذا الخيار قبل تنشيط الوظيفة. وبعد تنشيط وظيفة، يمكن إضافة الموظفين المحتملين ومقدمي الطلبات إليها.
