...
عندما تقوم بإنشاء قاعدة تنبيه، يمكنك تحديد المعايير التي يجب أن تتحقق قبل أن يتم تشغيل أحد التنبيهات. ويمكنك التفكير في معايير تمثل حالة من التوافق بين حدوث حدث وتحقق شروط محددة. وعند حدوث حدث معين، يقوم النظام بتنفيذ عملية تحقق وفقًا للشروط التي تم إعدادها.
