...
ms.locfileid: "2180796"
---
# <a name="batch-processing-of-alerts"></a>المعالجة الدُفعية للتنبيهات

[!include [banner](../includes/banner.md)]

تتم معالجة التنبيهات بواسطة وظيفة المعالجة الدفعية. يجب عليك إعداد معالجة الدُفعات قبل تسليم التنبيهات.

هناك نوعان مدعومان من التنبيهات:
