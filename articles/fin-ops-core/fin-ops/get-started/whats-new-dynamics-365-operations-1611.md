...
description: تصف هذه المقالة الميزات الجديدة أو المتغيرة في الإصدار 1611 من تطبيق Dynamics 365 for Operations.
author: sericks007
ms.date: 10/15/2019
ms.topic: article
ms.prod: ''
...
تصف هذه المقالة الميزات الجديدة أو المتغيرة في الإصدار 1611 من تطبيق Dynamics 365 for Operations.
...
<p>اختصاصات الموظفين وتطويرهم</p>
<ul>
...
<td>يمكنك الآن تكوين ومعالجة كشوف المرتبات في الولايات المتحدة باستخدام مجموعة ميزات مكافئة لمجموعة الميزات في AX 2012 R3.
<ul>
...
- تتواصل Retail Modern POS وCloud POS دائمًا مع Retail Server في المتجر.
- دعم Retail Modern POS وCloud POS حيث لا يوجد اتصال HQ.
- دعم قاعدة بيانات غير متصلة خاصة بنقطة بيع Retail Modern POS (معزولة عن كل مثيل Retail Modern POS) حيث لا يوجد اتصال HQ.
- تستند المصادقة إلى خدمة بخدمة فقط لنظام المتجر.
- لا يتم دعم استدعاءات خدمة الوقت الحقيقي في حال عدم وجود اتصال بالإنترنت.
- اتصال قاعدة البيانات المباشرة لـ Retail Modern POS بقاعدة بيانات القنوات غير معتمد.
...
| يقوم بائع التجزئة بتشغيل Retail Modern POS في المتجر المحلي، ويمكنك القيام بعمليات في الوقت الحقيقي، مثل إصدار بطاقات الهدايا، عند وجود اتصال. | باستطاعة بائع التجزئة تنفيذ إجراءات في الوقت الحقيقي من نظام المتجر عند وجود اتصال. |
...
### <a name="universal-windows-platform-app-for-retail-modern-pos"></a>تطبيق النظام الأساسي العام لـ Windows في Retail Modern POS

تتوفر حاليًا Retail Modern POS فقط كتطبيق Windows 8.1 لأجهزة الكمبيوتر المكتبية واللوحية وكنقطة بيع Cloud POS لمستعرضات الأجهزة المكتبية أو اللوحية. في هذا الإصدار، يتم تحويل نقطة البيع الحديثة للبيع بالتجزئة إلى تطبيق النظام الأساسي العام لـ Windows.‬ سيمكّن هذا التغيير تشغيل Retail Modern POS على أي جهاز Windows 10 (جهاز مكتبي أو لوحي أو هاتف) وحتى التبديل بين طرق العرض للأجهزة التي تمكينها لـ Continuum.
...
| ما الذي يمكنك فعله؟ | لماذا يعتبر هذا الأمر مهمًا؟ |
|-----------------|-----------------------|
| بصفتك مورّد، يمكنك تخزين المواد الخام في المستودع الخاص بالعميل. بصفتك عميل، يمكنك تأجيل عملية الشراء الفعلية حتى تصبح المواد الخام مطلوبة للإنتاج. | من شأن الاحتفاظ بمخزون من المواد الخام يمكن أن يشتمل على تكلفة كبيرة. باستخدام مخزون الشحن، يستطيع المورّد تخزين المواد الخام في المستودع الخاص بالعميل. ويستطيع العميل عندئذٍ تأجيل عملية الشراء الفعلية حتى تصبح المواد الخام مطلوبة للإنتاج. يتم طلب المواد الخام واستلامها باستخدام أمر تزويد الشحن. يسجل أمر التزويد هذا الحركات الفعلية ولكنه لا يؤثر على دفتر الأستاذ العام. وللتمييز بين أصناف المخزون المملوك من العميل وأصناف المخزون المملوك من المورد، يمكنك استخدام بُعد مخزون "المالك". تتم معالجة تغيير ملكية المخزون بواسطة عملية في دفتر اليومية تعالج نقل الملكية للمواد الخام من المخزون المملوك من المورد إلى المخزون المملوك من العميل. تؤدي هذه العميلة إلى إنشاء أمر شراء وإيصال استلام المنتجات.<blockquote>[!NOTE] تقتصر هذه الميزة على الشحنة الوارد‬ة للمواد الخام الخاصة بالإنتاج. وهي غير متكاملة مع إدارة المستودعات (WHS) وإدارة النقل (TMS).</blockquote> |
...
### <a name="vendor-collaboration"></a>تعاون المورد
...
| مشاركة المستندات المتعلقة بأوامر الشراء مع الموردين. | عندما يتعين عليك مشاركة مستند مع أحد المورّدين، مثل مستند حول المتطلبات، يمكن ربط المستند بأمر الشراء المناسب. يستطيع المورد عندئذٍ مشاركة الملاحظات والمرفقات مع العميل عن طريق ربط المستند باستجابته لأمر الشراء. تعتبر إدارة المستندات إطار الدعم الأساسي، ويمكن مشاركة فقط الملاحظات والمرفقات المصنفة على أنها "خارجية" مع المورّدين. |
| تزويد مستخدمي موردين جدد. | إذا كان الموردون الذين تتعامل معهم يستخدمون واجهة تعاون المورد، فستتوفر لديهم طريقة سلسة لطلب حسابات مستخدمين جدد عندما تحتاج جهات اتصال جديدة إلى الوصول إلى تعاون المورد. يستطيع أخصائيو التدبير تقديم طلب الحصول على حساب مستخدم لجهة اتصال في مؤسسة المورد. باستطاعة الشخص الذي يعتبر جهة اتصال المورد ويستخدم واجهة تعاون المورد تقديم طلب من هذا النوع. يؤدي هذا الطلب في نهاية المطاف إلى إنشاء مستخدم جديد في Dynamics 365 for Operations لديه أدوار الأمان الخاصة بالمورّد. ويسهّل أيضًا إرسال طلب إلى مدخل Microsoft Azure B2B لتزويد المستخدم بحساب مستخدم جديد في Azure Active Directory (Azure AD). باستطاعة الموردين أيضًا طلب إلغاء تنشيط حسابات مستخدمين محددين لدى المورد أو تعديل أدوار الأمان. |
| اعرف المزيد حول دعم تعاون الموّرد في Dynamics 365 for Operations. | لمزيد من المعلومات حول تعاون المورد، راجع [تعاون المورد مع موردين خارجيين‬](../../../supply-chain/procurement/vendor-collaboration-work-external-vendors.md) و[تعاون المورد مع العملاء‬](../../../supply-chain/procurement/vendor-collaboration-work-customers-dynamics-365-operations.md) و[إدارة مستخدمي تعاون المورد‬‬](../../../supply-chain/procurement/manage-vendor-collaboration-users.md) و[إعداد تعاون المورد والحفاظ عليه](../../../supply-chain/procurement/set-up-maintain-vendor-collaboration.md) و[مساحة عمل فوترة تعاون المورد](../../../finance/accounts-payable/vendor-portal-invoicing-workspace.md). |
...
<tbody>
<tr>
<td>تعريف، على بنود أمر المبيعات بشكل مباشر، المكان الذي يجب توريد الطلب منه وكيفية توريده.
<p><strong>مثال</strong></p>
<p>إنشاء بند أمر مبيعات، مع تحديد التسليم المباشر كنوع التسليم. وتتم إضافة المورد الأساسي إلى بند أمر المبيعات كنقطة التوريد.</p>
</td>
...
<tr>
<td>إنشاء التعهد بالأمر‬ مباشرة من بنود أمر المبيعات.
<p><strong>مثال</strong></p>
<p>إنشاء بند أمر مبيعات يتم توريده من مورد بين الشركات شقيقة. اترك البند. يتم حساب تواريخ التسليم وفقًا للتوافر في شركة التوريد.</p>
</td>
