---
title: بحث التنقل
description: توضح هذه المقالة كيفية استخدام وظيفة البحث للانتقال إلى الصفحات.
author: jasongre
ms.date: 08/11/2021
ms.topic: article
ms.prod: ''
...
توضح هذه المقالة كيفية استخدام وظيفة البحث للانتقال إلى الصفحات.
