...
البحث عن التدريب الصحيح على الإنترنت، في ورش العمل الشخصية والأحداث الخاصة بدورك كمستخدم لتطبيقات Finance and Operations. 
...
:::row:::
    ...
    [البدء](learning-catalog-project-manager.md#get-started)
...
:::row:::
    ...
    [البدء](learning-catalog-functional-consultant.md#get-started)
