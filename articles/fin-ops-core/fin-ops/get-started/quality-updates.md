...
وفي هذا الوقت، لا تقوم تحديثات الجودة إلا باستهداف بيئات الاختبار المعزول. ستبدأ التحديثات علي بيئات التشغيل بعد شهر نوفمبر 2022.

## <a name="what-is-the-schedule-for-sandbox-quality-updates"></a>ما هو جدول تحديثات جوده ‏‫بيئة الاختبار المعزول؟
للحصول على معلومات حول الساعات الداكنة لكل منطقة، راجع [ما هو الجدول الخاص بتحديثات الجودة الاستباقية؟](../../dev-itpro/deployment/plannedmaintenance-selfservice.md#what-is-the-schedule-for-proactive-quality-updates).
...
## <a name="how-can-one-know-the-set-of-changes-that-went-into-a-quality-update-payload"></a>كيف يمكن لأي شخص معرفه مجموعه التغييرات التي حدثت في حمولة تحديث الجودة؟
ستتمكن من الاطلاع علي كافة مقالات KB في بنيه تحديث الجودة في صفحه **تفاصيل البيئة** في LCS، وذلك من خلال الانتقال إلى قسم **تحديث الجودة** . 
...
## <a name="can-customers-self-install-a-quality-update-build-by-themselves-ahead-of-the-schedule"></a>هل يمكن للعملاء تثبيت تحديث الجودة اعتمادًا على أنفسهم قبل الموعد المحدد؟
...
- لا يتم تطبيق تحديثات الجودة إذا تمت جدولة تحديث الخدمة الوشيك في غضون أسبوع من الوقت الذي يتم فيه جدولة تحديث الجودة.
...
ولا يزال الخطة الخاصة بالعملاء الخاضعين للتحقق واللوائح الخاصة بقوانين الفيدرالية الصادرة عن إدارة الأغذية والأدوية (FDA) في حالة تطور. من المتوقع وجود تحديثات اضافيه في هذا الجزء قريبًا. والآن، فإن كافة العملاء الآخرين معفيون من تحديثات الجودة.
...
لن يتلقى العملاء الموجودين علي الإصدارات الأقل من N-2 على تحديثات الجودة. 
...
ونظرًا لأن طبيعة الإصلاحات الضرورية لا تتغير في حمولة التحديثات الإصلاحية، فإننا لا نتوقع حدوث أي تأثير إضافي في هذه المرة بشكل خاص تتعلق بمكونات البيع بالتجزئة.
