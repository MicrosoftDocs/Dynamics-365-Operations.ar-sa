...
هناك ثلاث طرق لتضمين تطبيق لوحة في تطبيق Finance and Operations. يمكنك استخدام النهج الذي يناسب السيناريو الخاص بك. 
...
3. قم بتكوين التطبيق المضمن. لمزيد من المعلومات، راجع قسم [تكوين تطبيق لوحة](#configuring-a-canvas-app) لاحقًا في هذا الموضوع.
...
قد ترغب في تضمين تطبيق لوحة من لوحة المعلومات إذا لم يكن التطبيق مرتبطًا بصفحة حالية، أو إذا كنت تريد فقط إظهار التطبيق كتجربة صفحة كاملة داخل تطبيق Finance and Operations.
...
4. قم بتكوين التطبيق المضمن. لمزيد من المعلومات، راجع قسم [تكوين تطبيق لوحة](#configuring-a-canvas-app) لاحقًا في هذا الموضوع.
...
- **سياق الإدخال للتطبيق** – يمكنك اختياريًا تحديد الحقل الذي يحتوي على البيانات التي تريد تمريرها إلى التطبيق كإدخال. للحصول على معلومات حول كيفية وصول التطبيق إلى البيانات المرسلة من تطبيقات Finance and Operations، انظر القسم بعنوان [إنشاء تطبيق يستفيد من البيانات المرسلة من تطبيقات Finance and Operations](#building-a-canvas-app-that-uses-data-that-is-sent-from-finance-and-operations-apps) لاحقًا في هذا الموضوع.
