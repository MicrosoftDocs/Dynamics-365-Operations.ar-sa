...
6. حدد ما إذا كان يجب نشر طريقة العرض كطريقة العرض الافتراضية للمستخدمين المحددين. عند تحويل طريقة العرض إلى طريقة عرض افتراضية، سوف يراها المستخدمون في المرة التالية التي يفتحون فيها الصفحة الهدف. سيتم تغيير طريقة العرض الافتراضية العمومية الفردية لكل مستخدم مستهدف. ومع ذلك، لا يزال بإمكان المستخدمين تغيير طريقة العرض الافتراضية بعد حدوث النشر.
    ...
    >    - **الإصدار 10.0.21 أو أحدث:** إذا تم تشغيل **ميزة تحسين دعم الكيان القانوني لطرق العرض المحفوظة**، ونشرت طريقة العرض إلى مجموعة فرعية من الكيانات القانونية، سيتم تغيير طريقة العرض الافتراضية لتلك الكيانات القانونية لكل مستخدم مستهدف.
    >
...
10. أضف الكيانات القانونية التي يجب ان تكون طريقة العرض هذه متاحة لها. 
    ...
    > - **الإصدار 10.0.21 أو أحدث:** إذا تم تشغيل ميزة **تحسين دعم الكيان القانوني لطرق العرض المحفوظة**، محدد طريقة العرض سيظهر فقط طريقة العرض للكيانات القانونية المحددة.
...
- **الإصدار 10.0.21 أو أحدث:** إذا تم تشغيل ميزة **تحسين دعم الكيان القانوني لطرق العرض المحفوظة**، محدد طريقة العرض سيظهر فقط طريقة العرض للكيانات القانونية المحددة. يحدث هذا السلوك لأن الميزة تمكن طرق العرض (بما في ذلك طرق العرض الشخصية) أن تكون مرتبطة بكيانات قانونية معينة.
