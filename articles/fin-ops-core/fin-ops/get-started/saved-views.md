...
5. **الإصدار 10.0.9 والإصدارات اللاحقة:** حدد ما إذا كان يجب نشر طريقة العرض كطريقة العرض الافتراضية للمستخدمين المحددين. عند تحويل طريقة العرض إلى طريقة عرض افتراضية، سوف يراها المستخدمون في المرة التالية التي يفتحون فيها الصفحة الهدف. سيتم تغيير طريقة العرض الافتراضية العمومية الفردية لكل مستخدم مستهدف. ومع ذلك، لا يزال بإمكان المستخدمين تغيير طريقة العرض الافتراضية بعد حدوث النشر.
6. أضف أدوار أمان تتوافق مع المستخدمين الذين يتم استهدافهم بواسطة طريقة العرض هذه. 
7. **الإصدار 10.0.13 والإصدارات اللاحقة:** حدد ما إذا كنت ترغب في نشر طريقة العرض إلى الأدوار التابعة لكل دور أمان محدد إذا فعلت ذلك، فحدد خانة الاختيار **تضمين الأدوار الفرعية** في الصف الخاص بأدوار الأمان المناسبة. لاحظ أن خانة الاختيار هذه غير متاحة للأدوار التي ليس لها أدوار تابعة.
7. أضف الكيانات القانونية التي يجب ان تكون طريقة العرض هذه متاحة لها. 
8. حدد **نشر**.
...
4. حدد **نشر**. 
5. **الإصدار 10.0.8 والإصدارات السابقة:** إذا قمت بتحديث اسم طريقة العرض المنشورة، فيجب أيضًا حذف طريقة العرض المنشورة التي تحمل الاسم القديم لمزيد من المعلومات، راجع القسم [إدارة طرق العرض المنشورة](saved-views.md#managing-published-views).

**الإصدار 10.0.9 والإصدارات اللاحقة:** إذا حددت في الأصل طريقة العرض المنشورة هذه كطريقة العرض الافتراضية، فستكون طريقة العرض الافتراضية للمستخدمين من جديد بعد إعادة نشرها.
...
**الإصدار 10.0.13 والإصدارات اللاحقة:** أدخل التغييرات المطلوبة مباشرةً على طريقة العرض. يجب أن تظهر علامة نجمية (\*) إلى جانب اسم طريقة العرض.
...
**الإصدار 10.0.12 والإصدارات السابقة**
...
علاوةً على ذلك، بإمكان المستخدمين الذين يتمتعون بحق الوصول إلى صفحة **التخصيص** استيراد طرق العرض الشخصية أو طرق عرض المؤسسة باستخدام الزر **استيراد طرق العرض** في جزء الإجراءات. في الإصدار 10.0.12 والإصدارات الأحدث، تمت إضافة آلية لنشر طرق العرض فور استيرادها.
...
**الإصدار 10.0.13 والإصدارات اللاحقة**

لم تعد ميزة **طرق العرض المحفوظة** موجودة في المعاينة. وهي تتوفر الآن من خلال إدارة الميزات في أي بيئة بشكل مباشر.

**الإصدارات من 10.0.9 إلى 10.0.12**

تتوفر ميزة **طرق العرض المحفوظة** من خلال إدارة الميزات في أي بيئة بشكل مباشر.‬ كما هو الحال مع ميزات المعاينة الأخرى، يخضع تمكين هذه الميزة في الإنتاج إلى [الشروط الإضافية لاتفاقيه الاستخدام](https://go.microsoft.com/fwlink/?linkid=2105274).

**10.0.8 / Platform update 32 والتحديثات السابقة**

يمكن تمكين ميزة **طرق العرض المحفوظة** في بيئات المستوى 1 (التطوير/الاختبار) والمستوى 2 (بيئة الاختبار المعزولة) من أجل توفير المزيد من التغييرات في الاختبارات والتصميمات باتباع الخطوات أدناه.
