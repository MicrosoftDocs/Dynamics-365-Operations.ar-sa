...
## <a name="help-on-microsoft-learn"></a>تعليمات حول Microsoft Learn

يُعد ([Microsoft Dynamics 365 documentation](/dynamics365/)) في Microsoft Learn هو المصدر الافتراضي لوثائق المنتج للتطبيقات المدرجة سابقًا. يوفر هذا الموقع الميزات التالية:
...
يمكنك العثور على محتوى في Microsoft Learn باستخدام أي محرك بحث. للحصول على أفضل النتائج، ننصحك باستخدام البحث في الموقع، مثل **"مصطلح البحث" site:learn.microsoft.com dynamics 365**.

## <a name="get-notified-about-changes-through-an-rss-feed"></a>الحصول على إعلام بشأن التغييرات من خلال موجز RSS

للاشتراك في موجز RSS لجميع التحديثات التي تم إجراؤها على المحتوى الموجود في وثائق Microsoft الفنية عبر تطبيقات المالية والعمليات ، استخدم الارتباط التالي:
...
تم تضمين الفيديو [كيفية المساهمة في وثائق Microsoft Dynamics 365](https://youtu.be/m5djioozRbg) (مبيّن أعلاه) في قناة Microsoft Dynamics 365في YouTube.

لمزيد من المعلومات، راجع [دليل المساهم في Microsoft Docs](/contribute), الذي نشره الفريق الذي أنشأ موقع Microsoft Learn.
...
| الموقع | Description |
|------|-------------|
| [Microsoft Dynamics 365 وثيقة](/dynamics365/) | يستضيف هذا الموقع أو يرتبط بكافة وثائق المنتج لـ Dynamics 365. |
| [Microsoft Learn training](/training/) | هذا الموقع هو موقع التعليم الإلكتروني المجاني من Microsoft. |
| [Microsoft Dynamics Lifecycle Services (LCS)](https://lcs.dynamics.com/)\* | يوفر هذا الموقع مساحة عمل تعاونية قائمة على السحابة يستطيع العملاء والشركاء استخدامها لإدارة مشاريع بدءًا من مرحلة ما قبل البيع حتى التنفيذ والعمليات. وهو مفيد في كافة مراحل التنفيذ. |
| [مدونة الدعم](https://aka.ms/AXSupportBlog) | يوفر هذا الموقع تلميحات ونصائح ينشرها فريق دعم . |
| [الإصدارات السابقة](/previous-versions/dynamics/) | يستضيف هذا الموقع محتوى من الإصدارات السابقة. |
