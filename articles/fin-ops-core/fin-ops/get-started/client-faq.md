...
description: توفر هذه المقالة إجابات على الأسئلة المتداولة حول عميل التمويل والعمليات.
author: jasongre
ms.date: 09/11/2019
ms.topic: article
ms.prod: ''
...
توفر هذه المقالة إجابات على الأسئلة المتداولة حول عميل التمويل والعمليات.
