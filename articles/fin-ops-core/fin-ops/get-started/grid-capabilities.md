...
- يتم عرض قوائم البطاقات التي كانت تُعرض كأعمدة متعددة في صورة عمود فردي.
- لا يتم عرض القوائم المجمعة كمجموعات أو في أعمدة منفصلة.

### <a name="fixed-as-part-of-10013"></a>تم الإصلاح كجزء من 10.0.13

> [!NOTE]
> يجري توفير المعلومات التالية لكي تتمكن من التخطيط وفقًا لذلك. للحصول على مزيد من المعلومات حول جدول الإصدارات المستهدفة للإصدار 10.0.13، راجع [توافر تحديث الخدمة‬](../../fin-ops/get-started/public-preview-releases.md).

- [KB 4563317] لا يتم إظهار تلميحات الأداة للصور.
