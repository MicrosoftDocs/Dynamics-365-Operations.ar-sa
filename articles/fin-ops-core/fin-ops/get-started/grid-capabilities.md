...
لدعم هذا السلوك الجديد، تمت إضافة عمود جديد لحالة الصف إلى أعلى الشبكة عندما تكون الشبكة في وضع التحرير. ويشير هذا العمود إلى إحدى الحالات التالية:
...
- **تحذير التحقق من الصحة** - تشير هذه الحالة إلى أن النظام لا يمكنه حفظ التغييرات في الصف بسبب بعض المشكلات في التحقق من الصحة. في الشبكة القديمة، كان يتم فرض الرجوع إلى الصف لإصلاح المشكلة فورًا. مع ذلك، في الشبكة الجديدة، يتم إعلامك بأنه تمت مصادفة مشكلة في التحقق من الصحة، ولكن يمكنك تقرير متى تريد إصلاح أية مشكلات في الصف. وعندما تكون مستعدًا لحل هذه المشكلة، يمكنك نقل التركيز يدويًا إلى الصف مرة أخرى. بدلا من ذلك، يمكنك تحديد إجراء **إصلاح هذه المشكلة**. ويؤدي هذا الإجراء مباشرة إلى نقل التركيز مرة أخرى إلى الصف الذي يحتوي على المشكلة، ويتيح لك إجراء عمليات التحرير داخل الشبكة أو خارجها. لاحظ أن معالجة الصفوف المعلقة التالية تتوقف حتى يتم حل تحذير التحقق من الصحة هذا. 
...
- لا يتم إظهار تلميحات الأداة للصور.
- لا يعمل عرض خطوط الشبكة مع كافة أنواع الحقول.
- بشكل متقطع، لا يمكنك النقر خارج الشبكة بعد إجراء تحديد متعدد لبعض الصفوف.
- لا تتوفر خيارات مسجل المهام **التحقق من الصحة** و**نسخ** لعناصر تحكم التاريخ/الرقم.

### <a name="fixed-as-part-of-10012"></a>تم الإصلاح كجزء من 10.0.12

> [!Note]
> يجري توفير المعلومات التالية لكي تتمكن من التخطيط وفقًا لذلك. للحصول على مزيد من المعلومات حول جدول الإصدارات المستهدفة للإصدار 10.0.12، راجع [توافر تحديث الخدمة‬](../../fin-ops/get-started/public-preview-releases.md).

- [المشكلة 429126] لا يتم تحديث عناصر التحكم خارج الشبكة بعد حذف السجل الأخير.
- [المشكلة 430575] عناصر تحكم الجدول لا تحدّث محتويات العناصر المعروضة.
...
- [قاعدة المعارف 4558575] لا يتم تحديث الحقول بعد أن يصبح تغيير الصف/معالجة الشبكة عالقة بعد حذف الصفوف.
- [المشكلة 436980] لم يتم تطبيق التنميط المرتبط بلوحة القائمة **ExtendedStyle**.
- [قاعدة المعارف 4558573] لا يمكن إصلاح أخطاء التحقق من الصحة عندما يكون التغيير المطلوب خارج الشبكة.
    
### <a name="quality-update-for-10011"></a>تحديث الجودة لـ 10.0.11
...
- [قاعدة المعارف 4558369] صور الحالة تختفي في الشبكة الهرمية.
