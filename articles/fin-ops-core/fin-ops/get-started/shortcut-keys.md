...
| تنفيذ الزر الافتراضي في صفحة/مربع حوار | Alt+Enter                        |
...
| فتح جزء عامل التصفية (أو تبديل التركيز بين جزء عامل التصفية والصفحة الرئيسية إذا كان جزء عامل التصفية مفتوحاً مسبقاً) | Alt+M,F أو Ctrl+F3       |
...
## <a name="page-shortcuts"></a>اختصارات الصفحة
...
| الانتقال إلى الحقل الأول المرئي في الصفحة   | Alt+Shift+F       |
...
| أغلق الصفحة (حدد الزر "السابق")<br><br>**ملاحظة:** إذا كانت هناك نافذة منبثقة (أداة التلميح، منتقي التاريخ، القائمة المنسدلة، إلخ) مفتوحة، فإن الاستخدام الأول لـ Esc سيؤدي إلى استبعاد الإطار المنبثق.       | Esc               |
| إغلاق الصفحة بحفظ واضح             | Shift+Esc         |
| إغلاق الصفحة وتجاهل أية تغييرات غير محفوظة | Alt+Shift+Q       |

## <a name="page-navigation-shortcuts"></a>اختصارات التنقل في الصفحة
...
| الانتقال إلى الريشة رقم &lt;n&gt;th (علامة تبويب عمودية)        | Alt+Shift+&lt;n&gt; (&lt;n&gt; =‏ 1-9)        |
...
| إضافة/إزالة صفحة كعنصر مفضل (مع التركيز على صفحة في جزء التنقل)   | Shift+F                    |
| الانتقال إلى جزء الإجراءات القياسي                                              | Alt+M,A أو Ctrl+F6         |
...
| الانتقال إلى جزء قائمة التنقل (وقد يشمل ذلك فتحها)    | Alt+M,S أو Ctrl+F8         |
| نقل التركيز إلى صفحة المحتوى (مع التركيز في قائمة التنقل)            | Alt+M,M أو Ctrl+F8         |
| إغلاق قائمة التنقل (مع التركيز في قائمة التنقل) | Esc                        |
