...
## <a name="after-importing-addresses-when-i-access-the-records-why-am-i-unable-to-edit-imported-addresses"></a>بعد استيراد العناوين، عند الوصول إلى السجلات لماذا لا أستطيع تحرير العناوين المستوردة؟

عند استيراد العناوين، يوجد حقل يسمى **IsLocationOwner**، والذي يشير إلى ما إذا كان الطرف المرتبط بالموقع (العنوان) هي مالك العنوان. إذا كانت الطرف هو مالك العنوان، فيمكن تحرير العنوان عند الوصول إليه باستخدام الطرف الموجود في دفتر العناوين العمومي أو من نموذج السجل الرئيسي (مثل العميل أو المورد أو العامل). إذا لم يكن الطرف هو مالك العنوان، فلن يمكن تحرير السجل من النماذج التي تم سردها سابقًا. عند استيراد العناوين يجب تعيين **IsLocationOwner** إلى **نعم** إذا كنت ترغب في أن يكون العنوان قابلا للتحرير باستخدام الطرف المقترن. ومع ذلك، هناك أوقات يتم فيها استيراد هذا الحقل بشكل غير صحيح. لحل هذه المشكلة، يمكن تحديث مالك الموقع داخل دفتر العناوين العمومي من سجل الطرف أو من صفحة **تأكيد مالكي الموقع**. لتحديث سجل طرف واحد، انتقل إلى **دفتر العناوين العمومي > العنوان**. حدد **تحرير** لتشغيل صفحة **تحرير العنوان** لتغيير مالك الموقع. حدد **تغيير مالك الموقع** لرؤية المالك السابق للموقع مع كون الطرف المحدد حاليًا هو مالك الموقع الجديد. إذا كان مالك الموقع السابق فارغًا فهذا يعني أن مالك الموقع لم يتم تأسيسه. يؤدي تحديد الخيار **متقدم** إلى فتح صفحة **إدارة العناوين** التي يمكن تعيين مالك الموقع فيها أيضًا. حدد الموقع المراد تحديثه، ثم حدد **تعيين مالك الموقع** من القائمة. لتحديث مالك الموقع لسجلات متعددة، انتقل إلى **دفتر العناوين العمومي > المواقع > تأكد مالكي المواقع**. تحتوي القائمة على المواقع التي تم ربطها بطرف واحد، ولكن هذا الطرف ليس المالك. سيؤدي تحديد **تأكيد المالك** إلى تعيين **معرف الطرف المالك المقترح** ليكون مالك العنوان المرتبط. بعد تعيين الطرف كمالك، سيكون العنوان المرتبط قابلا للتحرير من سجل الطرف. لتغيير مالك الموقع، يجب أن يتم تعيين امتياز **تعيين مالك الموقع** لك في صفحة **تكوين الأمان**.  يتم منح مسؤول النظام هذا الامتياز افتراضيًا.
