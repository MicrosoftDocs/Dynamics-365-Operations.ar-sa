...
description: توضح هذه المقالة كيفية تكوين عدد من الخصائص لسير العمل.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
توضح هذه المقالة كيفية تكوين عدد من الخصائص لسير العمل.
...
> [!NOTE]
> لا يمكن أضافه العناصر النائبة باستخدام copy و لصق لأنه لم يتم لصق معلومات الهدف بشكل صحيح. استخدم الواجهة لأضافه عناصر نائبه.
