...
7. يمكنك إظهار علامات التبويب أو إخفاؤها مثل علامة تبويب المرفقات:
    ...
    1. في جزء الإجراء، حدد **إظهار الأقسام** لفتح مربع الحوار المنسدل.
...
18. حدد **إضافة قياس** لفتح مربع الحوار المنسدل.
...
32. حدد علامة التبويب **عام**.
    ...
    - تتحكم الحالات في الوصول إلى المراجعة. تسمح حالة **لم يتم البدء** للجميع بتحرير المراجعة. وتسمح الحالة **قيد التقدم** فقط للموظف بعرض المراجعة وتحريرها. وتسمح الحالة "جاهز للمراجعة" فقط للمدير بعرض وتحرير المراجعة. وتسمح حالة "المراجعة النهائية" لكل من الموظف والمدير بعرض المراجعة وأيضًا تحريرها إذا تم إعدادها في نوع المراجعة. وتجعل الحالات **مكتمل**، و**مرفوض**، و**ملغى** المراجعة للقراءة فقط.  
