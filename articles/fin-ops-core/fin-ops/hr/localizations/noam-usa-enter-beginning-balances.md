...
description: توضح هذه المقالة الخطوات الخاصة بإدخال أرصدة البداية لأكواد الأرباح‬ والخصومات والمزايا والضرائب.
author: twheeloc
ms.date: 11/20/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9167788"
---
# <a name="enter-payroll-beginning-balances"></a>إدخال أرصدة البداية لكشف الرواتب

[!include [banner](../../includes/banner.md)]

توضح هذه المقالة الخطوات الخاصة بإدخال أرصدة البداية لأكواد الأرباح‬ والخصومات والمزايا والضرائب. تعتبر هذه المعلومات قيمة بالنسبة إلى الشركاء الذين ينقلون البيانات الخاصة بتطبيق كشف رواتب‬ جديد من نظام آخر. استعدادًا لإدخال أرصدة البداية لكشف الرواتب، نتحقق من صحة المعلومات التالية:
