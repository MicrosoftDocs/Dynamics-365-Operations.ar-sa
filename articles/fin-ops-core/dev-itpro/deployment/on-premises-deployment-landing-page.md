...
- [ضبط حجم الأجهزة للبيئات المحلية](../../fin-ops/get-started/hardware-sizing-on-premises-environments.md)
- [شراء Finance + Operations (on-premises)](../../fin-ops/get-started/purchase-on-premises.md)
