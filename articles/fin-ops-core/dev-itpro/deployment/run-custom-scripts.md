...
description: يصف هذا الموضوع كيفية تحميل الحزم القابلة للنشر التي تحتوي على برامج نصية X + + مخصصة وكيفية من دون الحاجة إلى إيقاف النظام بشكل مرحلي.
author: AndersGirke
ms.date: 12/16/2021
ms.topic: article
ms.search.form: ''
...
1. ثم حدد **تحميل**.
1. حدد الحزمة القابلة للنشر التي أنشأتها كما ورد سابقًا في هذا الموضوع. ستتم مطالبتك بتحديد الغرض من البرنامج النصي.
