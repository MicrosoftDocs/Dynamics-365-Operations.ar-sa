...
description: يوضح هذا الموضوع كيفية تهيئه Commerce Scale Unit (السحابة) في Microsoft Dynamics 365 Commerce.
author: AamirAllaq
ms.date: 02/04/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8092203"
---
# <a name="initialize-commerce-scale-unit-cloud"></a>تهيئة Commerce Scale Unit (السحابة)

[!include[banner](../includes/banner.md)]

يوضح هذا الموضوع كيفية تهيئه Commerce Scale Unit (السحابة) في Microsoft Dynamics 365 Commerce.
...
| الموقع العمومي | المنطقة              | التوفر        |
|-----------------|---------------------|---------------------|
| الأمريكتان        | شرق الولايات المتحدة             | متوفرة بشكل عام |
| الأمريكتان        | شرق الولايات المتحدة 2           | متوفرة بشكل عام |
| الأمريكتان        | وسط شمال الولايات المتحدة    | متوفرة بشكل عام |
| الأمريكتان        | وسط جنوب الولايات المتحدة    | متوفرة بشكل عام |
| الأمريكتان        | وسط الولايات المتحدة          | متوفرة بشكل عام |
| الأمريكتان        | غرب الولايات المتحدة             | متوفرة بشكل عام |
| الأمريكتان        | منطقة غرب الولايات المتحدة الأمريكية 2           | متوفرة بشكل عام |
| الأمريكتان        | منطقة وسط كندا      | سعة محدودة    |
| الأمريكتان        | منطقة شرق كندا         | سعة محدودة    |
| الأمريكتان        | منطقة وسط غرب الولايات المتحدة الأمريكية     | سعة محدودة    |
| APAC            | شرق استراليا      | متوفرة بشكل عام |
| APAC            | جنوب شرق آسيا      | متوفرة بشكل عام |
| APAC            | شرق اليابان          | متوفرة بشكل عام |
| APAC            | غرب اليابان          | متوفرة بشكل عام |
| APAC            | جنوب شرق استراليا | سعة محدودة    |
| APAC            | شرق آسيا           | سعة محدودة    |
| APAC            | جنوب الهند         | سعة محدودة    |
| APAC            | وسط الهند       | سعة محدودة    |
| EMEA            | غرب أوروبا         | متوفرة بشكل عام |
| EMEA            | شمال أوروبا        | متوفرة بشكل عام |
| EMEA            | جنوب المملكة المتحدة            | سعة محدودة    |
| EMEA            | غرب المملكة المتحدة             | سعة محدودة    |

سعة النشر في المناطق المحدودة السعة مقيدة للغاية. يتم تقييم طلبات النشر على أساس كل حالة على حدة. إذا كانت لديك حاجة عمل ملحة للنشر في مناطق محدودة السعة، فيمكنك تقديم طلب دعم لإضافته إلى قائمة الانتظار.
