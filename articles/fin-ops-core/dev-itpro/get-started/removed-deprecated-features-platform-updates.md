...
## <a name="feature-removal-effective-march-14-2022"></a>أزاله الميزات اعتبارًا من 14 مارس 2022

### <a name="xslt-scripting-in-data-management"></a>البرمجة النصية XSLT في إدارة البيانات

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | تم إهمال البرمجة النصية XSLT في إدارة البيانات‬ لتحسين الأمان وحماية البيانات في تطبيقات التمويل والعمليات.  |
...
| **خيارات النشر**              | الكل. |
| **Status**                         | ميزة مهملة: تاريخ الإزالة المخطط له هو 14 مارس 2022.<br><br>الاستثناء: العملاء الذين يستخدمون البرمجة النصية XLST حاليًا. يمكنهم مواصلة استخدامها حتى التحديث إلى الإصدار 10.0.30 أو إصدار أحدث. لقد تلقى العملاء الذين لديهم هذا الاستثناء إعلامًا في مركز الرسائل المتوفر في مركز إدارة Microsoft 365. |
