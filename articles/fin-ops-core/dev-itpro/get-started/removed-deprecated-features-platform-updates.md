...
| **هل تم الاستبدال بميزة أخرى؟**   | بداية من يناير 2023 ، يمكن للعملاء استخدام مجموعات [التشفير القياسية الخاصة بنا](/power-platform/admin/server-cipher-tls-requirements) فقط. يؤثر هذا التغيير علي العملاء والخوادم التي تتصل بخوادمنا ، علي سبيل المثال ، قد يؤثر ذلك علي عمليات تكامل الجهات الخارجية غير الأدهيرينجه بالنسبة إلى مجموعات التشفير القياسية الخاصة بنا. |
| **مناطق المنتجات المتأثرة**         | تطبيقات التمويل والعمليات |
| **خيارات النشر**              | عمليات النشر السحابية |
| **Status**                         | مهملة. يجب على العملاء ترقية الخوادم الخاصة بهم قبل يناير 2023. لمزيد من المعلومات حول تكوين ترتيب مجموعه التشفير TLS ، راجع [أداره أمان طبقه النقل (TLS)](/windows-server/security/tls/manage-tls).  |
