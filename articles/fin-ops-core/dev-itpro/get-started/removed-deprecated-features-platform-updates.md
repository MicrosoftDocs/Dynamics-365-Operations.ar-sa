...
## <a name="feature-deprecation-effective-august-2022"></a>إهلاك الميزة الساري في أغسطس 2022

### <a name="lifecycle-services-lcs-features-deprecated-in-august-2022"></a>تم إيقاف ميزات Lifecycle Services (LCS) في أغسطس 2022

وكجزء من أحد مجهودات العمل الاساسيه [لنظام](/dynamics365-release-plan/2022wave2/finance-operations/finance-operations-crossapp-capabilities/one-dynamics-one-platform) واحد Dynamics ، يتم إهمال ميزات LCS التالية.

| اسم الميزة | يستخدم مع AX 2012؟ | تستخدم مع تطبيقات المالية والعمليات؟ | هل تم الاستبدال بميزة أخرى؟ |
|--------------|--------------------|----------------------------------------|------------------------------|
| إعلانات | ‏‏نعم‬ | ‏‏نعم‬ | نعم: توجد الشعارات في المشاريع الفردية وصفحات البيئة للاعلام. |
| مدير التكوين | ‏‏نعم‬ | لا | لا |
| تحليل الأعطال والتفريغ | ‏‏نعم‬ | لا | لا |
| الملاحظات والأخطاء | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| الاشتراك الخاص بي | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| Office 365 | ‏‏نعم‬ | ‏‏نعم‬ | نعم: Azure Active Directory أو مدخل مسؤولي Microsoft. |
| تحليل الأثر | لا | ‏‏نعم‬ | لا |
| مقدر الأثر الاقتصادي الكلي | لا | ‏‏نعم‬ | لا |
| طلبات الخدمة | لا | ‏‏نعم‬ | نعم: [عمليات نشر الخدمة الذاتية](../deployment/infrastructure-stack.md) |
| تكامل SharePoint | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| مدير التكوين والبيانات | لا | ‏‏نعم‬ | لا |
| حزم بيانات العمليات | لا | ‏‏نعم‬ | نعم: [إطار عمل استيراد البيانات (DIXF)](/dynamics365/fin-ops-core/dev-itpro/data-entities/data-import-export-job) |
| ترقية Envrionment | لا | ‏‏نعم‬ | نعم: [تتوفر تحديثات خدمه إصدار](../lifecycle-services/oneversion-overview.md) واحده. |
| أداة تقدير البنية الأساسية | ‏‏نعم‬ | لا | لا |
| حجم الرخصة | ‏‏نعم‬ | لا | لا |
| محلل الاستخدام | ‏‏نعم‬ | لا | لا |
| تحليل التخصيص | ‏‏نعم‬ | لا | لا |
| عمليات تشخيص أداء النظام | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| إدارة Visio مصمم عمليات الأعمال | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| AX 2012 إدارة البيئة السحابية | ‏‏نعم‬ | لا | لا |
| موصلات RDFE Azure | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| AX إصدارات 2012 | ‏‏نعم‬ | لا | لا |
| تم تخزين عناصر العمل في تخزين LCS | ‏‏نعم‬ | ‏‏نعم‬ | لا |
| طلبات الإصلاحات العاجلة | ‏‏نعم‬ | ‏‏نعم‬ | لا |


### <a name="transport-layer-security-tls-rsa-cipher-suites"></a>مجموعات تشفير أمان طبقه النقل (TLS) RSA

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | تتم أزاله قائمه مجموعات التشفير التالية للتوافق مع بروتوكولات الأمان الحالية الخاصة بنا.<br><br>TLS_RSA_WITH_AES_256_GCM_SHA384<br>TLS_RSA_WITH_AES_128_GCM_SHA256<br>TLS_RSA_WITH_AES_256_CBC_SHA256<br>TLS_RSA_WITH_AES_128_CBC_SHA256<br>TLS_RSA_WITH_AES_256_CBC_SHA<br>TLS_RSA_WITH_AES_256_CBC_SHA  |
| **هل تم الاستبدال بميزة أخرى؟**   | بداية من 31 يناير 2023 ، يمكن للعملاء استخدام مجموعات [التشفير القياسية الخاصة بنا](/power-platform/admin/server-cipher-tls-requirements) فقط. يؤثر هذا التغيير علي العملاء والخوادم التي تتصل بخوادمنا ، علي سبيل المثال ، قد يؤثر ذلك علي عمليات تكامل الجهات الخارجية غير الأدهيرينجه بالنسبة إلى مجموعات التشفير القياسية الخاصة بنا. |
| **مناطق المنتجات المتأثرة**         | تطبيقات التمويل والعمليات |
| **خيارات النشر**              | عمليات النشر السحابية |
| **Status**                         | مهملة. يجب على العملاء ترقية الخوادم الخاصة بهم قبل 31 يناير 2023. لمزيد من المعلومات حول تكوين ترتيب مجموعه التشفير TLS ، راجع [أداره أمان طبقه النقل (TLS)](/windows-server/security/tls/manage-tls).  |
...
## <a name="platform-updates-for-version-10023-of-finance-and-operations-apps"></a>تحديثات النظام الأساسي للإصدار 10.0.23 من تطبيقات التمويل والعمليات
...
| **خيارات النشر**              | ‏‏الكل |
| **الحالة**                         | ميزة مهملة: بعد التحديث، ستتم إزالة أدوات X + + السابقة من Visual Studio 2015، ولن يتم تثبيت الأدوات المحدثة على Visual Studio 2015. لا يوجد تاثير علي البناءات المستضافة. للحصول علي إنشاء أجهزه ظاهريه، يجب تحديث تدفقات البناء (تعريف البنية) يدويا لتغيير التبعية من MSBuild 14.0 (Visual Studio 2015) إلى msbuild 15.0 (Visual Studio 2017) كما هو موضح في [تحديث تدفقات قديمه في أنابيب Azure](../dev-tools/pipeline-msbuild-update.md). |
