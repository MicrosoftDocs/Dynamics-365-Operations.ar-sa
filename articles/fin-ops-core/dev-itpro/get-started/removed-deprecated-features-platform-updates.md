...
| اسم الميزة | يستخدم مع AX2012 ؟ | تستخدم مع تطبيقات المالية والعمليات؟ | هل تم الاستبدال بميزة أخرى؟ |
|--------------|--------------------|----------------------------------------|------------------------------|
...
| حزم بيانات العمليات | لا | ‏‏نعم‬ | نعم: إطار عمل استيراد البيانات (DIXF) |
...
| **هل تم الاستبدال بميزة أخرى؟**   | بداية من 30 نوفمبر ، 2022 ، يمكن للعملاء استخدام مجموعات [التشفير القياسية الخاصة بنا](/power-platform/admin/server-cipher-tls-requirements) فقط. يؤثر هذا التغيير علي العملاء والخوادم التي تتصل بخوادمنا ، علي سبيل المثال ، قد يؤثر ذلك علي عمليات تكامل الجهات الخارجية غير الأدهيرينجه بالنسبة إلى مجموعات التشفير القياسية الخاصة بنا. |
| **مناطق المنتجات المتأثرة**         | تطبيقات التمويل والعمليات |
| **خيارات النشر**              | عمليات النشر السحابية |
| **Status**                         | مهملة. يجب علي العملاء ترقيه الخوادم الخاصة بهم قبل 30 نوفمبر 2022. لمزيد من المعلومات حول تكوين ترتيب مجموعه التشفير TLS ، راجع [أداره أمان طبقه النقل (TLS)](/windows-server/security/tls/manage-tls).  |
