...
| **هل تم الاستبدال بميزة أخرى؟**   | يجب على العملاء الذين يستخدمون أقسام البيانات استخدام مثيلات Finance and Operations متعددة إذا كان الفصل على مستوى قاعدة البيانات يعتبر مشكلة حساسة.    |
| **مناطق المنتجات المتأثرة**         | جميع الوحدات النمطية  |
| **الحالة**                         | تمت إزالتها اعتبارًا من Dynamics AX 7.0.  |
...
| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | يتوافق Finance and Operations مع الأجهزة اللوحية. لم يعد تطبيق tablet مطلوبًا.    |
| **هل تم الاستبدال بميزة أخرى؟**   | الرقم          |
