...
description: توضح هذه المقالة الميزات التي تمت إزالتها أو التي تم التخطيط لإزالتها من Dynamics 365 for Finance and Operations والإصدارات السابقة.
author: sericks007
ms.date: 02/16/2021
ms.topic: article
ms.prod: ''
...
> [!IMPORTANT]
> توقف تحديث هذه المقالة. للاطلاع على القائمة الحالية بالميزات التي تمت ازالتها أو إهمالها من تطبيقات التمويل والعمليات، ابحث عن محتوى **"الميزات التي تمت ازالتها أو إهمالها"** الذي يتعلق بالتطبيق الذي تستخدمه.

تصف هذه المقالة الميزات التي تم إزالتها أو إهمالها من Dynamics 365 for Finance and Operations والإصدارات السابقة لهذا المنتج.
...
| **خيارات النشر**              | الكل |
| **الحالة**                         | ميزة مهملة: بحلول 1 أكتوبر 2020، سنتوقف عن دعم هذا التقرير. |
...
## <a name="finance-and-operations-1005-with-platform-update-29"></a>Finance and Operations 10.0.5 مع Platform update 29
...
## <a name="finance-and-operations-1004-with-platform-update-28"></a>Finance and Operations 10.0.4 مع Platform update 28
...
| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | محاذاة الرأس مع منتجات Dynamics وOffice الأخرى. لمزيد من التفاصيل، راجع [شريط التنقل المحدث الذي يتوافق مع رأس Office](/business-applications-release-notes/April19/dynamics365-finance-operations/updatednavbar).
...
## <a name="finance-and-operations-1002-with-platform-update-26"></a>Finance and Operations 10.0.2 مع Platform update 26
...
| **هل تم الاستبدال بميزة أخرى؟**   | اعتبارًا من Platform update 22، أصبحت تجربة التصفية "أحد مما يلي"‬‏‫ المحسنة متوفرة في صفحة **خيارات أداء العميل**. لمزيد من المعلومات، راجع [تجربة التصفية "أحد مما يلي" المحسنة](/business-applications-release-notes/October18/dynamics365-finance-operations/improved-isoneof-filtering). |
| **مناطق المنتجات المتأثرة**         | عميل الويب |
| **خيارات النشر**              | الكل |
...
## <a name="finance-and-operations-1001-with-platform-update-25"></a>Finance and Operations 10.0.1 مع Platform update 25
...
## <a name="finance-and-operations-1000-with-platform-update-24"></a>Finance and Operations 10.0.0 مع Platform update 24
...
| **خيارات النشر**              | الكل  |
| **الحالة**                         | تمت إزالتها اعتبارًا من Finance and Operations 10.0.0 مع Platform update 24.|


## <a name="finance-and-operations-813-with-platform-update-23"></a>Finance and Operations 8.1.3 مع Platform update 23
...
| **مناطق المنتجات المتأثرة**         | أدوات تطوير Visual Studio |
| **خيارات النشر**              | ‏‏الكل |
| **الحالة**                         | ميزة مهملة: أصبح التحذير خطأ بوقت التحويل مع تحديثات النظام الأساسي للإصدار 10.0.11 من تطبيقات التمويل والعمليات. |
...
## <a name="finance-and-operations-81-with-platform-update-20"></a>Finance and Operations 8.1 مع Platform update 20
...
| **مناطق المنتجات المتأثرة**         | دفتر الأستاذ العام |
| **خيارات النشر**              | الكل |
| **الحالة**                         | تمت إزالتها اعتبارًا من Finance and Operations 8.1 مع Platform update 20. |
...
| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | الميزة غير متوافقة مع نموذج قابلية توسعة Finance and Operations. |
| **هل تم الاستبدال بميزة أخرى؟**   | لا |
| **مناطق المنتجات المتأثرة**         | الضريبة |
| **خيارات النشر**              | الكل |
| **الحالة**                         | تمت إزالتها اعتبارًا من Finance and Operations 8.1 مع Platform update 20. |

### <a name="payroll-and-human-resources-for-russia"></a>كشوف الرواتب والموارد البشرية لروسيا
وحدة خاصة بالبلد روسية لإدارة معلومات إدارة الموظفين وتفاصيل الجدول الزمني للموظفين ومحاسبة كشوف الرواتب وإنشاء كشوف الأجور. 

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | لا يتم تضمين كشوف الرواتب في التركيز الاستراتيجي العالمي لمحفظة Dynamics 365. يتواجد الشركاء وبائعي البرامج المستقلين (ISV) في وضع أفضل لتوفير وظيفة كشوف الرواتب المتوافقة مع اللوائح المحلية والتحديثات الضريبية.|
| **هل تم الاستبدال بميزة أخرى؟**   | لا|
| **مناطق المنتجات المتأثرة**         | كشوف الرواتب وإدارة الموارد البشرية في روسيا |
| **خيارات النشر**              | ‏‏الكل |
| **الحالة**                         | مهمل: الإطار الزمني الهدف لإزالة الوظيفة هو أحد التحديثات المستقبلية للإصدار 10.0. |

## <a name="finance-and-operations-80-with-platform-update-15"></a>Finance and Operations 8.0 مع Platform update 15
...
تم إهمال حزم محتوى **إدارة التكلفة** و **الأداء المالي** و **Retail Channel Performance**، المتوفرة على موقع [Microsoft AppSource](https://appsource.microsoft.com) وذلك نتيجة لتحديثات المنتج في Microsoft Power BI. تم أيضًا إهمال نماذج إدارة النظام المستخدم لنشر حزم المحتوى هذه إلى PowerBI.com في Finance and Operations.
...
| **هل تم الاستبدال بميزة أخرى؟**   | نعم. تم استبدال هذه الميزة بواسطة Finance and Operations - التخزين. لمزيد من المعلومات حول الإعداد والمتطلبات الأساسية، راجع [نظرة عامة على تثبيت وتكوين تطبيق التخزين](../../../supply-chain/warehousing/install-configure-warehousing-app.md). |
...
| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | أعيد تصميم إدارة الأداء بالكامل في Finance and Operations.     |
...
تم استخدام هذه الأداة لدمج البيانات الرئيسية من Microsoft Dynamics CRM مع تطبيقات Dynamics ERP.
...
توفر تقسيمات البيانات فصلاً منطقيًا للبيانات في قاعدة بيانات Dynamics AX.

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | تم تقديم تقسيمات البيانات في Dynamics AX 2012 R2 لتمكين عزل البيانات. في سيناريو شائع، هناك شركة لها شركات فرعية، ويجب ألا تكون البيانات من إحدى الشركات الفرعية مرئية في شركة فرعية أخرى، على الرغم من خضوع الشركتين الفرعيتين لإدارة قسم تقنية المعلومات نفسه. ومع ذلك، برزت الحاجة إلى مصروفات إضافية تتعلق بالبرامج النصية والإدارة عبر البرنامج بكامله من أجل إنشاء تقسيمات جديدة وتعبئتها بالبيانات، ولإجراء نسخ احتياطي للبيانات الموجودة في التقسيمات. في السحابة، حيث لدينا إمكانية الوصول إلى خدمات قاعدة البيانات في النظام الأساسي كخدمة (PaaS) (قاعدة بيانات Microsoft Azure SQL)، من المستحسن استخدام قاعدة بيانات كحاوية عزل بدلاً من إجراء العزل في البرنامج لأن هذا الإجراء يُعد أكثر فاعلية. بغض النظر عما إذا كان تقسيم البيانات مطلوبًا للشركات الفرعية، أو لعدة مستأجرين، أو فقط كمقياس، نعتقد بأنه يمكن التعامل مع السيناريوهات بشكل أفضل من خلال مثيلات Finance and Operations متعددة. |
...
سمح Dynamics AX 2012 بتخزين الملحقات في قاعدة البيانات ومشاركة الملفات. توقف دعم هذين الخيارين.

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | توقف دعم تخزين مشاركة الملفات لأنه يتعذر على البيئات المستضافة على الشبكة السحابية التواصل مع مشاركات الملفات المحلية. تم إهمال التخزين في قاعدة البيانات لصالح مخزن البيانات الثنائية كبيرة الحجم لـ Azure. يكافئ مخزن البيانات الثنائية كبيرة الحجم في Azure مساحة التخزين في قاعدة البيانات، إذ يمكن الوصول فقط إلى المستندات عبر نماذج عميل Finance and Operations. يوفر هذا فائدة مضافة لتوفير تخزين لا يؤثر سلبًا على أداء قاعدة البيانات. يعتبر مخزن البيانات الثنائية كبيرة الحجم آلية التخزين الافتراضية لإدارة المستندات، وهو يعمل على الفور. |
...
### <a name="german-dtazv-payment-format-in-domestic-currency"></a>تنسيق الدفع DTAZV الألماني بالعملة المحلية
...
قام Dynamics AX 2012 بإدارة ضريبة القيمة المضافة (VAT) غير المحققة باستخدام الوظيفة الخاصة بالمكسيك للضريبة غير المحققة.
