...
يوضح هذا الموضوع الميزات التي تمت إزالتها أو إهمالها في Finance and Operations.
...
| **خيارات النشر**              | الكل  |
| **الحالة**                         | تمت إزالتها اعتبارًا من Finance and Operations 10.0.0 مع Platform update 24. في حالات استثنائية، مثل الاسترداد من إعادة تسمية سابقة للمفتاح الأساسي لمنتج صادر، يمكن الطلب من Microsoft إزالة هذا القيد مؤقتًا على عمليه إعادة تسمية المفتاح الأساسي للمنتجات الصادرة. |
