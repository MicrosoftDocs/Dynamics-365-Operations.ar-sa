...
لإظهار تسجيلات المهام المخصصة الخاصة بك في جزء "التعليمات" بحيث يمكنك تشغيلها كأدلة مهام أو عرضها كنص، يجب عليك حفظ تسجيلات المهام الخاصة بك إلى مكتبة BPM، ثم قم بتحديث معلمات نظام التعليمات للإشارة إلى مكتبة BPM. لمزيد من المعلومات، راجع [الاتصال بنظام التعليمات‬.](../../fin-ops/get-started/help-connect.md)

<a name="additional-resources"></a>الموارد الإضافية
--------

[نظرة عامة على التعليمات](../../fin-ops/get-started/help-overview.md)

[تعليمات الاتصال](../../fin-ops/get-started/help-connect.md)
