...
description: توضح هذه المقالة ما هو مسجل المهام ودلائل المهام‬ وكيفية إنشاء تسجيلات المهام وكيفية تخصيص دلائل مهام‬ Microsoft وتضمينها في نظام التعليمات الخاص بك.
author: jasongre
ms.date: 03/24/2020
ms.topic: article
ms.prod: ''
...
توضح هذه المقالة ما هو مسجل المهام ودلائل المهام، وكيفية إنشاء تسجيلات المهام وكيفية تخصيص دلائل مهام‬ Microsoft وتضمينها في نظام التعليمات الخاص بك.
