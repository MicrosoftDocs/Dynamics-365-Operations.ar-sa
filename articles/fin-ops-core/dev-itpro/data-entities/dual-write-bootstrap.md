...
1. لإعداد اتصال الكتابة الثنائية بين مثيلات Finance and Operations وCommon Data Service أو تطبيق Dynamics 365 آخر، قم بتسجيل الدخول إلى تطبيق Finance and Operations كمسؤول. 
...
4. قم بتمكين خريطة كيان **Cdm_companies**. ويقوم هذا بمزامنة الشركات من تطبيق Finance and Operations مع Common Data Service.  
    > [!div class="mx-imgBorder"]
...
6. عند الانتهاء من التمهيد والنظام جاهز للمزامنة المباشرة، قم بتمكين خرائط الكيانات.  
    ...
    يؤدي تمكين خرائط الكيانات إلى تشغيل مزامنة البيانات الأولية لخرائط الكيانات الممكّنة. تتم مزامنة البيانات المقابلة للشركات التي تم اختيارها في اتصال الكتابة الثنائية بين تطبيق Finance and Operations وCommon Data Service. 
