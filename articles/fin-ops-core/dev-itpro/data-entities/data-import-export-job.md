...
يجب تمكين الوظيفة في إدارة الميزات، ثم يمكن الوصول اليها من **إدارة البيانات‬ \> تنظيف محفوظات الوظائف**.
...
-   **عدد الساعات المطلوبة لتنفيذ الوظيفة** – بحسب مقدار المحفوظات التي سيتم تنظيفها، قد يختلف إجمالي وقت تنفيذ وظيفة التنظيف من دقائق قليلة إلى ساعات قليلة. ولأن تنظيف الجداول المذكورة يجب أن يتم عندما لا يكون هناك أي نشاط آخر لإدارة البيانات في النظام، يجب التأكد من تنفيذ وظيفة التنظيف وانتهائها قبل بدء نشاط العمل.
