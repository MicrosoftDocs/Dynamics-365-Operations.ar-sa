...
من المعتاد أن تتم عادة إدارة سجلات العملاء في أكثر من تطبيق واحد. على سبيل المثال، بإمكان نشاط المبيعات إحضار سجلات العملاء عبر تطبيق Sales، وبإمكان مبيعات التجزئة والتجارة الإلكترونية إحضار سجلات العملاء عبر تطبيق Finance and Operations. بغض النظر عن مصدر سجلات العملاء، فهي تتكامل في الخلفية عبر حدود التطبيق واختلافات البنية التحتية. تساعد إدارة العملاء المتكامل على التعامل مع سيناريوهات إدارة متعددة وتوفر طريقة عرض شاملة للعميل في مجموعة تطبيقات Dynamics 365.
...
يقوم هذا القالب بمزامنة المعلومات الرئيسية للعميل للعملاء التجاريين وعملاء المؤسسات بين تطبيقات Finance and Operations وCommon Data Service.
...
يقوم هذا القالب بمزامنة البيانات الرئيسية للعميل للعملاء المستهلكين والمستخدمين النهائيين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة جميع معلومات جهات الاتصال الرئيسية والثانوية والثلاثية لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة معلومات مجموعة عملاء بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة معلومات طرق دفع العميل بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة معلومات بطاقة الولاء للعميل بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة البيانات المرجعية لجدول الدفع لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم بمزامنة البيانات المرجعية لبنود جدول الدفع لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة البيانات المرجعية لأيام الدفع لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة البيانات المرجعية لبنود أيام الدفع لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة البيانات المرجعية لشروط الدفع لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
...
يقوم هذا القالب بمزامنة البيانات المرجعية لملحقات الأسماء لكل من العملاء والمورّدين بين Finance and Operations وتطبيقات Dynamics 365 الأخرى.
