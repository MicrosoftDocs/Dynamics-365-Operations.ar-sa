## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>إعدادات الأمر الافتراضية للمنتج V2 إلى msdyn_productspecificdefaultordersettings
