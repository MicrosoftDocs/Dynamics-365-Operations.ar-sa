...
> [!NOTE]
> في Dynamics 365 Sales، يشير كل من العميل المتوقع والعميل إلى سجل في جدول **الحساب** حيث يكون العمود **RelationshipType** اما **عميل متوقع** أو **عميل**. إذا تضمن منطق العمل الخاص بك عملية تأهيل **الحساب** حيث يتم إنشاء سجل **الحساب** وتأهيله كعميل متوقع أولاً، ثم كعميل، يقوم هذا السجل بالمزامنة مع التطبيق فقط عندما يكون عميلاً (`RelationshipType=Customer`). إذا كنت ترغب في ان يقوم صف **الحساب** بالمزامنة كعميل متوقع، ستحتاج إلى مخطط مخصص لدمج بيانات العميل المتوقع.
