...
تمت إضافة حقول جديدة إلى كيان **الأمر** وهي تظهر على الصفحة. يظهر معظم هذه الحقول على علامة تبويب **التكامل** في Sales. لمعرفة المزيد حول كيفية تعيين حقول الحالات، راجع موضوع الوثائق [لإعداد تعيين حقول حالات أمر المبيعات](https://review.docs.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/dual-write/sales-status-map?branch=robin-dw-status-map)
