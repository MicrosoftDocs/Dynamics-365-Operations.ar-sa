...
تمت إضافة حقول جديدة إلى كيان **الأمر** وهي تظهر على الصفحة. يظهر معظم هذه الحقول على علامة تبويب **التكامل** في Sales. لمعرفة المزيد حول كيفية تعيين حقول الحالات، راجع [إعداد تعيين حقول حالات أوامر المبيعات](sales-status-map.md).
