---
title: الترقية إلى نموذج الطرف ودفتر العناوين العمومي
description: تصف هذه المقالة كيفية ترقية بيانات الكتابة المزدوجة إلى الطرف ونموذج دفتر العناوين العمومي‬.
...
توضح هذه المقالة كيفية استخدام قوالب Data Factory وترقية البيانات الخاصة بك. إذا لم يكن لديك أية تخصيصات، فيمكنك استخدام القوالب كما هي. على الرغم من ذلك، إذا كانت لديك تخصيصات لبيانات **الحساب** و **جهة الاتصال** و **المورّد** ، فيجب فعليك تعديل القوالب كما هو موضح في هذه المقالة.
...
9. في مصنع البيانات ، قم بتشغيل العنوان الإلكتروني للحزب ثم قوالب العنوان البريدي للحزب، واحدًا تلو الآخر.
