...
![نموذج بيانات للمنتجات في التمويل والعمليات.](media/dual-write-products-5.jpg)
...
تم تصميم تخطيطات جدول الكتابة المزدوجة لتمكين تدفق البيانات باتجاه واحد، وهي عبارة عن تجربة قريبة من الوقت الحقيقي من تطبيقات التمويل والعمليات إلى Dataverse. ومع ذلك، فقد تم فتح البنية الأساسية للمنتجات لجعلها ثنائية الاتجاه إذا لزم الأمر. وعلى الرغم من ذلك، يمكنك تخصيصها على مسؤوليتك الخاصة، لأن Microsoft لا تنصح باتباع هذا الأسلوب.
...
مع تمكين وظيفة الكتابة المزدوجة، ستتم مزامنة المنتجات من التمويل والعمليات مع منتجات Dynamics 365 أخرى في حالة **المسودة**. تتم إضافتها إلى قائمة الأسعار الأولى بنفس العملة المستخدمة في تطبيق مشاركة العملاء واستخدام الفرز الأبجدي على اسم قائمة الأسعار. بمعنى آخر، تُضاف إلى أول قائمة أسعار في تطبيق Dynamics 365 التي تتطابق مع عملة الجدول القانوني حيث يتم إصدار المنتج في تطبيق التمويل والعمليات. في حاله عدم وجود قائمه أسعار للعملة المحددة، سيتم إنشاء قائمه أسعار تلقائيا سيتم تعيين المنتج اليها.

التنفيذ الحالي للوظائف الإضافية للكتابة المزدوجة التي تقوم بإقران قائمة الأسعار الافتراضية بالوحدة يبحث عن العملة المقترنة بتطبيق التمويل والعمليات ويعثر على قائمة الأسعار الأولى في تطبيق مشاركة العميل باستخدام الفرز الأبجدي في اسم قائمة الأسعار. لتعيين قائمة أسعار افتراضية لعملة محددة عندما يكون لديك قوائم أسعار متعددة لهذه العملة، يجب تحديث اسم قائمة الأسعار إلى اسم موجود بترتيب أبجدي يسبق ترتيب أي قوائم أسعار أخرى لنفس تلك العملة. إذا لم يكن لديها أي قائمة أسعار للعملة المحددة، يتم إنشاء عملة جديدة.
...
عند مزامنة المنتجات ، يجب إدخال قيمه لحقل **وحدة المبيعات** في تطبيق التمويل والعمليات، لأنه حقل إلزامي في المبيعات.
...
عند تمكين الكتابة الثنائية، تتم مزامنة تطبيقات Finance and Operations مع تطبيقات Dynamics 365 أخرى. تتضمن مجموعات الوحدات التي تتم مزامنتها من تطبيقات التمويل والعمليات في Dataverse مجموعة علامات تشير إلى أنها "محفوظة خارجيًا".
...
عند تمكين الكتابة المزدوجة، تتم مزامنة المنتجات من تطبيقات التمويل والعمليات إلى Dataverse وتطبيقات مشاركة العميل الأخرى. لن يتم تحديث المنتجات التي تم إنشاؤها في Dataverse وتطبيقات Dynamics 365 الأخرى قبل الكتابة المزدوجة ولن تتم مطابقتها مع بيانات المنتج من تطبيقات التمويل والعمليات.
