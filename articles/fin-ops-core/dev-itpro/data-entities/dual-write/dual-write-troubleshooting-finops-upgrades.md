...
*حقل المصدر المفقود \<اسم الحقل\> في المخطط.*
...
2. ابحث عن الكيان الذي يفتقد إلى الحقل. قم بتدوين الكيان الهدف والجدول المرحلي واسم الكيان وقيم الأعمدة الأخرى.
3. إذا كانت أي مجموعة من المجموعات المعالجة الخاصة بك تعتمد على هذا الكيان، فاتخذ الاجراء المناسب لمجموعات المعالجة قبل حذف الكيان.
4. احذف الكيان الذي يفتقد إلى الحقل.
5. حدد **جديد**، وأضف الكيان مرة أخرى. حدد القيم التي قمت بتدوين ملاحظة لها في الخطوة 2.
6. افتح صفحة **تعيين الكيان** من صفحة **الكتابة الثنائية** في تطبيق Finance and Operations.
7. حدد **تحديث قائمة الكيانات** لملء الحقول تلقائيًا في تعيينات الكيانات.
