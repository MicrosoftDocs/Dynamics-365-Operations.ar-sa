...
description: توضح هذه المقالة كيفية استخدام إطار عمل التقارير الإلكترونية لإنشاء نماذج قابلة للطباعة لفاتورة النص الحر (FTI) كمستندات Microsoft Office.
author: NickSelin
ms.date: 07/24/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8868818"
---
# <a name="generate-printable-fti-forms"></a>إنشاء نماذج فاتورة نص حر (FTI) قابلة للطباعة

[!include[banner](../includes/banner.md)]

يسمح لك إطار عمل التقارير الإلكترونية بإنشاء نماذج قابلة للطباعة لفاتورة النص الحر (FTI) كمستندات Microsoft Office. توفر هذه المقالة معلومات عن كيفية إنشاء تكوينات خاصة بك بالإضافة إلى تفاصيل عن قوالب التكوينات المتاحة.
...
> [!NOTE]
> إذا أردت البدء بالنظرة العامة على تكوينات التقارير الإلكترونية الموجودة لهذه العينة من حل نماذج فواتير النص الحر FTI القابلة للطباعة، يمكنك الانتقال مباشرة إلى قسم **تنزيل تكوينات التقارير الإلكترونية النموذجية لإنشاء نماذج فاتورة النص الحر FTI القابلة للطباعة** لاحقًا في هذه المقالة.
