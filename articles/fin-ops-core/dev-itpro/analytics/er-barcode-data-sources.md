...
description: تشرح هذه المقالة كيفية استخدام مصادر بيانات الأكواد الشريطية لإنشاء صور الأكواد الشريطية.
author: kfend
ms.date: 10/21/2020
ms.topic: article
ms.prod: ''
...
لمعرفة المزيد من المعلومات عن هذه الميزة، أكمل الامثلة في هذه المقالة.
...
يمكن إكمال الخطوات في شركة **USMF** في 365 Finance Microsoft Dynamics.
...
إذا لم تكن قد أكملت بعد المثال الموجود في [تضمين الصور والأشكال في المستندات التي تقوم بإنشائها باستخدام موضوع ER](electronic-reporting-embed-images-shapes.md) ، قم بتنزيل التكوينات التالية لنموذج حل التقارير الإلكترونية.
