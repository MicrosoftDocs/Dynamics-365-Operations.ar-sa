...
description: تقدم هذه المقالة التمارين التي تنقلك عبر عرض وإنشاء التقارير المالية لـ Microsoft Dynamics 365 Finance.
author: jcart1106
ms.date: 11/21/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9799508"
---
# <a name="view-and-design-financial-reports"></a>عرض التقارير المالية وتصميمها

[!include [banner](../includes/banner.md)]

تقدم هذه المقالة التمارين التي تنقلك عبر عرض وإنشاء التقارير المالية لـ Microsoft Dynamics 365 Finance. تتألف ميزة إعداد التقارير المالية من تجربة عرض داخل التطبيق ومصمم تقارير من نقرة واحدة يتيح لك إنشاء التقارير المالية وتحريرها.
...
7. قم بتغيير سنة الأساس إلى عام 2021، وحدد **إنشاء**. عند إنشاء تقرير من مصمم التقارير، سيتم فتحه في علامة تبويب جديدة في المستعرض. يمكنك إما استكشاف التقرير في علامة تبويب المستعرض الجديدة، أو الانتقال إلى علامة تبويب المستعرض الأصلية وفتح التقرير من هناك عن طريق تحديده من قائمة **التقارير المالية**.
...
4. حدد **ملف**، ثم **حفظ باسم**، وقم بتسمية التقرير باسم **ميزان المراجعة التفصيلية مع السمات**.
    ...
    > [!NOTE]
    > في أي وقت يتم فيه إنشاء تقرير جديد في Report Designer، يتم تحديث قائمة **التقارير المالية**.
...
23. انقر فوق **عمليات الخدمة** في العرض الرسومي. اضغط مع الاستمرار على زر الماوس الأيسر أثناء سحب الوحدة إلى **العمليات**. حرر زر الماوس الأيسر لإسقاط الوحدة في تجميع Operation. كرر **الإنتاج**، و **مراقبة الجودة**، و **اللوجستيات**، و **التدبير**، و **الإدارة**.
...
29. وقم بتغيير سنة الأساس إلى **2021**، و **احفظ** التغييرات وقم **بإنشاء** التقرير. بعد اكتمال عملية إنشاء التقرير وفتحه، يمكنك استكشاف التقرير.
...
5. قم بتغيير سنة الأساس إلى 2021.
...
16. قم قم بتغيير سنة الأساس إلى **2021**.
