...
| كائن                          | القياسات التجميعية الرئيسية | مصدر البيانات للتمويل والعمليات | الحقل               |
|---------------------------------|----------------------------|----------------------------------------|---------------------|
| CostObjectStatementCacheMonthly | ‏‏المبلغ‬                     | CostObjectStatementCache               | ‏‏المقدار              |
