...
description: وتصف هذه المقالة التحسينات التي تمت علي ميزة الأساس الخاصة بالتقارير الإلكترونية في Microsoft Dynamics 365 for Finance and Operations إصدار 10.0.3 (يونيو 2019).
author: NickSelin
ms.date: 06/19/2019
ms.topic: article
ms.prod: ''
...
تصف هذه المقالة مجموعة التحسينات الأولى التي تم إجراؤها للميزة الأساسية في إطار عمل التقارير الإلكترونية (ER). وتتوفر هذه التحسينات Microsoft Dynamics 365 for Finance and Operationsالإصدار 10.0.3 (يونيو 2019) والإصدارات الأحدث.

## <a name="automate-the-setting-of-baseline-rules"></a>أتمته إعداد القواعد الأساسية

توضح مقالة [‏‫تتبع نتائج التقارير المنشأة ومقارنتها بالقيم الأساسية‬](er-trace-reports-compare-baseline.md) كيفية تكوين إطار عمل التقارير الإلكترونية لجمع معلومات عن عمليات تنفيذ تنسيق التقارير الإلكترونية وتقييم نتائج عمليات التنفيذ هذه. يوضح المثال الوارد في هذه المقالة الخطوات التي يجب أن يتم إكمالها.
...
لإكمال الخطوات الموجودة في هذا المثال، يجب أولاً إكمال الخطوات في المثال الوارد في هذه المقالة [‏‫تتبع نتائج التقارير المنشأة ومقارنتها بالقيم الأساسية‬](er-trace-reports-compare-baseline.md) حتى قسم "إضافة أساس جديد لتنسيق التقارير الإلكترونية المصمم".
...
أنت الآن جاهز لإكمال الخطوات المتبقية في المثال الموجود في مقالة [تتبع نتائج التقارير المنشأة ومقارنتها بالقيم الأساسية](er-trace-reports-compare-baseline.md) بدءًا من قسم "تشغيل تنسيق التقارير الإلكترونية المصمم ومراجعة السجل لتحليل النتائج".
...
لإكمال الخطوات الموجودة في هذا المثال، يجب أولاً إكمال خطوات المثال في مقالة [‏‫تتبع نتائج التقارير المنشأة ومقارنتها بالقيم الأساسية‬](er-trace-reports-compare-baseline.md) .
...
اتبع الخطوات الموجودة في قسم "مثال: أتمتة إعداد القواعد الأساسية‬" الموجود سابقًا في هذه المقالة. يحذرك الإخطار من أنه تم إنشاء الملف الصادر باستخدام إعدادات الأساس، وأن الاستبدال الإجباري لروابط التنسيق قد حدث.
