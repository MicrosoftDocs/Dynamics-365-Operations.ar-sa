---
title: تتبع نتائج التقارير المنشأة ومقارنتها بالقيم الأساسية
description: تقدم هذه المقالة كيفية مقارنة نتائج تقارير إعداد التقارير الإلكترونية (ER) التي تم إنشاؤها باستخدام قيم تقرير الأساس.
author: NickSelin
ms.date: 06/17/2019
ms.topic: article
ms.prod: ''
