...
description: توضح هذه المقالة كيفية استخدام محرر المعادلات المتقدم لتكوين التعبيرات في تعيين نموذج ‏‫إعداد التقارير الإلكترونية (ER) ومكونات التنسيق.
author: NickSelin
ms.date: 06/17/2021
ms.topic: article
ms.prod: ''
...
أكمل الخطوات التالية لبدء استخدام محرر المعادلات المتقدم في مثيل 365‎ Finance Microsoft Dynamics..
...
البدء في الإصدار 10.0.19 في 365‎ Finance Microsoft Dynamics ، يمكنك التحكم فيما يقدمه محرر صيغة التقارير الإلكترونية بشكل افتراضي. أكمل الخطوات التالية لتمكين محرر الصيغ المتقدمة لكافة المستخدمين والشركات الخاصة بمثيل Finance الحالي.
