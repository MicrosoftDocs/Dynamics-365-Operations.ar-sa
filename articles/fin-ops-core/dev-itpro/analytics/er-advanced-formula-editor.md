...
## <a name="ActivateAdvEditor">تنشيط محرر المعادلات المتقدم</a>
...
## <a name="Autoformatting">إعداد تنسيق الكود تلقائيًا</a>
...
## <a name="CodeCompletion">إكمال الكود</a>
...
## <a name="CodeNavigation">تنقل الكود</a>
...
## <a name="CodeStructuring">هيكلة الكود</a>
...
## <a name="FindAndReplace">بحث واستبدال</a>
...
## <a name="DataPasting">مصادر البيانات ولصق الوظائف</a>
...
## <a name="SyntaxColorization">تلوين بناء الجملة</a>
