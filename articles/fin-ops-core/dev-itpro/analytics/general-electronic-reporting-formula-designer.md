...
## <a name="Transformation">تنسيق البيانات</a>
...
## <a name="Validation">التحكم في تدفق العملية</a>
...
## <a name="Enabled">التحكم بمحتوى المستند</a>
...
## <a name="TestFormula">التحقق من صحة التركيبات المكونة</a>
