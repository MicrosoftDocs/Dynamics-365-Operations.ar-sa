...
## <a name="Transformation"></a>تنسيق البيانات
...
## <a name="Validation"></a>التحكم في تدفق العملية
...
## <a name="Enabled"></a>التحكم بمحتوى المستند
...
## <a name="TestFormula"></a>التحقق من صحة المعادلات المكونة
