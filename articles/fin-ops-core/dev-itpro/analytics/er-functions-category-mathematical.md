...
ms.locfileid: "6747335"
---
# <a name="list-of-er-functions-in-the-mathematical-category"></a>قائمة وظائف التقارير الإلكترونية في الفئة الرياضية

[!include [banner](../includes/banner.md)]

يمكن استخدام الوظائف الرياضية في التقارير الإلكترونية للقيام بالعديد من الحسابات الرياضية الشائعة. يعرض هذا الموضوع ملخصًا لهذه الوظائف.
