...
تعد واجهة المستخدم الجديدة أكثر وضوحًا وراحة عند الاستخدام. تُظهر منطقة **مستند العمل** فقط القوالب التي يملكها [الموفر](tasks/er-configuration-provider-mark-it-active-2016-11.md) [النشط](general-electronic-reporting.md#Provider) الحالي والموجودة في المثيل الحالي من Dynamics 365 Finance. في واجهة المستخدم السابقة، كانت علامة تبويب **القالب** تسرد جميع القوالب التي كانت متوفرة لأي موفر. كما كانت تعرض كافة القوالب التي تم إنشاؤها وتحريرها من قبل أي مستخدم لديه نفس الدور.
...
في الأمثلة الواردة في هذا الموضوع، الموفر النشط هو Contoso، ويتم استخدامه لإنشاء قالب يستند إلى قالب يتم توفيره بواسطة Microsoft. بدلاً من ذلك، يمكنك إنشاء قالب عن طريق تحميل قالبك الخاص بتنسيق Excel.
