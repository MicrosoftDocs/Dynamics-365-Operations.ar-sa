...
> [!NOTE]
> يتم بدء وصف الوظيفة لاعلامك بتشغيل تعيين تنسيق ER. ويحتوي أيضًا على اسم مكون ER الذي تم تنفيذه.
...
>
> في Microsoft Dynamics 365 Finance الإصدار 10.0.9 (أبريل 2020) لا يتم دعم إلا اتجاه الصفحة الأفقي فقط في مستند PDF الذي يتم إنتاجه من مخرجات Excel. بانطلاق Dynamics 365 Finance الإصدار 10.0.10 (مايو 2020) ، يمكنك [تحديد اتجاه الصفحة](#SelectPdfPageOrientation) في مستند PDF التي يتم إنتاجها من مخرجات Excel أثناء قيامك بتكوين وجهة ER.
>
