...
> [!NOTE]
> يجب أن يكون خادم البروتوكول البسيط لنقل رسائل البريد (SMTP) مكونًا ومتوفرًا. يمكنك تحديد خادم SMTP في **إدارة النظام** &gt; **الإعداد‏‎** &gt; **البريد الإلكتروني** &gt; **محددات البريد الإلكتروني**.
...
يحدد الموقع المكان حيث تم حفظ الملف. بعد تمكين جهة **أرشيف**، يمكن حفظ نتائج تنفيذ التكوين في أرشيف الوظيفة. يمكنك عرض النتائج في **إدارة مؤسسة** &gt; **التقارير الإلكترونية** &gt; **الوظائف المؤرشفة لإعداد التقارير الإلكترونية**.

> [!NOTE]
> يمكنك تحديد نوع مستند لأرشيف الوظيفة في **إدارة المؤسسة** &gt; **مساحات العمل** &gt; **التقارير الإلكترونية** &gt; **معلمات التقارير الإلكترونية**.
...
عيّن الخيار **ممكّن** إلى **نعم‏‎** لاستخدام تكوين التقارير الإلكترونية لترتيب نقل البيانات من المثيل إلى خدمات Microsoft Power BI. ‏‫يتم تخزين الملفات المنقولة على مثيل Microsoft SharePoint Server تم تكوينه لهذا الغرض. لمزيد من المعلومات، راجع [استخدام تكوين التقارير الإلكترونية لتزويد Power BI بالبيانات من Finance](general-electronic-reporting-report-configuration-get-data-powerbi.md).
