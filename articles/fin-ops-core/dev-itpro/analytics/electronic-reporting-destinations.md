...
## <a name="change-page-layout-properties-of-a-template"></a><a name="change-page-layout-properties-of-a-template"></a> تغيير خصائص تخطيط الصفحة الخاصة بقالب

يمكنك تكوين وجهه واجهه مستخدم (ER) لمكون التنسيق الخاص ب ER والذي تم تصميمه لاستخدام قالب موجود Microsoft Office بتنسيق (Excel أو Word) لإنشاء التقارير. إذا لم تكن مالك هذا التنسيق وكانت هناك حاجه لتغيير خصائص تخطيط الصفحة الخاصة بقالب التنسيق ، في إصدارات المالية قبل 10.0.29 الإصدار ، يتعين عليك إنشاء تنسيق مشتق وتعديل خصائص القالب. ثم يجب عليك الاحتفاظ بتكوين التنسيق المشتق. ومع ذلك ، في الإصدار 10.0.29 و الأحدث ، يمكنك تغيير خصائص تخطيط الصفحة الخاصة بالقالب في وقت التشغيل لتجنب إنشاء وصيانة تكوين التنسيق المشتق. للقيام بذلك ، قم باعداد الخصائص المطلوبة كجزء من إعدادات الوجهة المكونة ل ER. عند تشغيل التنسيق الخاص ب ER وتنفيذ أحدي الوجات الخاصة ب ER التي تم تكوينها لاستخدام خصائص تخطيط صفحه معينه ، يتم تطبيق قيم خصائص تخطيط الصفحة للوجهة التي تم تنفيذها علي القالب الذي تستخدمه ، مستبدلا خصائص القالب الأصلي. يمكنك تكوين وجات مختلفه لنفس مكون التنسيق وذلك بتكوين خصائص تخطيط صفحه مختلفه للقالب قيد الاستخدام.

يمكن تكوين الخصائص التالية في وجهة إعداد التقارير الإلكترونية لمكون تنسيق مصمم لاستخدام قالب بتنسيق Excel أو Word:
...
> [!NOTE]
> يجب ان يتم محاذاة اتجاه الصفحة للقالب المكون بهذه الطريقة مع اتجاه الصفحة [لتحويل ](#select-a-page-orientation-for-pdf-conversion)pdf  إذا تم تكوين تحويل pdf.

يجب تحديد وحده الطول لاعداد هوامش الصفحات:

- بوصة
- سنتيمتر
- ملليمتر

![قم باعداد خصائص تخطيط الصفحة علي الصفحة وجهه التقارير الكترونيه.](./media/er_destinations-set-page-layout-properties.png)

> [!TIP]
> عند نوميناتيد قيمه الهامش بالسنتيمتر ويتم تحديدها بعلامات الأرقام العشرية المتعددة ، فانه يتم تقريبها إلى وقت التشغيل لأقرب قيمه بها العلامة العشرية 1.
>
> عندما يتم ترشيح قيمة الهامش بالمليمترات وتحديدها بكسور عشرية ، يتم تقريبها في وقت تشغيل Excel إلى أقرب قيمة عدد صحيح بدون فاصلة عشرية.
>
> عندما يتم ترشيح قيمة الهامش بالمليمترات وتحديدها بأرقام عشرية متعددة ، يتم تقريبها في وقت تشغيل Word إلى أقرب قيمة بعلامة عشرية واحدة.
