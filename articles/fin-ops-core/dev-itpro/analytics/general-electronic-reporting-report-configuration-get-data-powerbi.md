...
3. انقر فوق عنصر الإجراء لفتح الصفحة التي تعرض التقرير الذي قمت بتصميمه في Power BI.
    ...
    [![تم تصميم تقرير تفاصيل الاستيراد والتصدير في Power BI](./media/ger-power-bi-review-bi-report-in-ax-form-1024x586.png)](./media/ger-power-bi-review-bi-report-in-ax-form.png)
