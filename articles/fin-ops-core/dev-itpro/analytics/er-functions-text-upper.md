...
---
# <a name="upper-er-function"></a>UPPER ER وظيفة

[!include [banner](../includes/banner.md)]

تقوم وظيفة `UPPER` بإرجاع سلسلة النص المُحددة كقيمة *سلسلة* بعد أن تم تحويلها إلى أحرف كبيرة.
