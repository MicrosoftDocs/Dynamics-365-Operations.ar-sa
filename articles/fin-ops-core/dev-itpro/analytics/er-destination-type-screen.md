...
ms.locfileid: "3019612"
---
# <a name="ScreenDestinationType">وجهة الشاشة</a>

[!include [banner](../includes/banner.md)]

يمكنك تكوين وجهة شاشة لكل مكون "ملف" أو "مجلد" لتنسيق إعداد التقارير الإلكترونية (ER) التي يتم تكوينها لإنشاء مستندات صادرة. استنادًا إلى إعداد الوجهة، يفتح المستند المنشأ للمعاينة في علامة تبويب مستعرض منفصلة.
