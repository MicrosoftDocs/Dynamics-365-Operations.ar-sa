...
ms.locfileid: "9109101"
---
# <a name="financial-analysis"></a>التحليل المالي

[!include [banner](../includes/banner.md)]

يستخدم **التحليل المالي** Microsoft Power BI للجمع بين مؤشرات الأداء الأساسية (KPI) المالية والمخططات والقوائم المالية. Power BI مضمن في التطبيق. يكون تركيز **التحليل المالي** منصب على التقارير التحليلية. تستطيع الشخصيات عبر إحدى المؤسسات العرض والبحث والفهم والعمل. 

يجمع **التحليل المالي** البيانات من دفتر الأستاذ العام ودفاتر الأستاذ الفرعية لتوفير صورة أكثر اكتمالاً للسلامة المالية للمؤسسة.
...
تركز مساحة عمل **التحليل المالي** على السماح لك بعرض البيانات الموجودة في التقارير الموجودة وتصفيتها. ستتمكن من إضافة مرئيات جديدة إلى مساحة عمل **التحليل المالي**. تتوفر مساحة عمل **التحليل المالي** للشركة الحالية وكذلك لجميع الشركات لعرض البيانات لجميع الكيانات القانونية، بغض النظر عن الكيانات القانونية التي يمكن للدور الوصول إليها.

- [إضافة مرئيات Power BI أو تحريرها على لوحة المعلومات](/powerapps/user/add-powerbi-dashboards)

## <a name="dynamics-365-finance-setup"></a>إعداد Dynamics 365 Finance
**دفتر الأستاذ العام**

يتم استخدام نوع الحساب الرئيسي وفئات الحساب الرئيسي لملء الحسابات الرئيسية الافتراضية المناسبة في القائمة المالية **الميزانية العمومية** والقوائم المالية المختلفة **قائمة الدخل** في **التحليل المالي**.
...
|-----------------------------------------|-------|------------|
| عرض الشركة الحالية للتحليل المالي | <ul><li>المحاسب</li><li>مدير الحسابات</li><li>المشرف على المحاسبة</li><li>مُراجِع</li><li>مدير الموازنة</li><li>المدير التنفيذي</li><li>المدير المالي</li><li>المراقب المالي</li></ul> | يوفر هذا الواجب وصولاً إلى التحليل المالي. بشكل افتراضي، يتم استخدام الشركة النشطة كعامل تصفية. لا يمكنك إضافة كيانات قانونية أخرى. |
| عرض جميع الشركات للتحليل المالي   | في Microsoft Dynamics365 Finance, Enterprise edition، لم يتم تعيين هذه المهمة إلى دور. في الإصدار التالي، سيتم تعيين هذه الواجب إلى دور المدير المالي. | يوفر هذا الواجب وصولاً إلى عنصر قائمة مساحة العمل "نظرة عامة على المدير المالي". بشكل افتراضي، يتم استخدام الشركة النشطة كعامل تصفية. ومع ذلك، يمكنك إضافة جميع الكيانات القانونية، بغض النظر عما إذا كان للمستخدم حق الوصول إلى الكيانات القانونية الأخرى. |


## <a name="financial-reporting-vs-financial-analysis"></a>التقارير المالية في مقابل التحليل المالي
على الرغم من أن **التحليل المالي** يحتوي على قوائم مالية، إلا أنه ليس بديلاً للتقارير المالية في التطبيق. القوائم المالية الافتراضية في **التحليل المالي** محدودة النطاق ولا تشتمل على جميع أنواع القوائم المالية. لا تزال التقارير المالية هي الأداة الأساسية لتصميم وإنشاء وابتكار القوائم المالية القانونية.

تساعد المقارنة التالية في التمييز بين هذين الخيارين:


| الميزة                                                   | Financial Reporting                                               | التحليل المالي |
|----------------------------------------------------------|-------------------------------------------------------------------|--------------------|
...
| **الأمان**                                             | نعم الالتزام بأمان شجرة التقارير في Finance | تقارير العرض المحدود لجميع الشركات (بغض النظر عن أمان التمويل والعمليات) أو الشركة النشطة فقط |
...
![كشف ميزان المراجعة.](./media/trial-balance.png)
...
![التنقل لأسفل في ميزان المراجعة في الصفوف.](./media/trial-balance2.png)
