...
| الوظيفة | الوصف |
|----------|-------------|
| [Base64StringToContainer](er-functions-container-base64stringtocontainer.md) | تقوم هذه الوظيفة بإرجاع القيمة *الحاوية* التي تتكون من المحتوي الثنائي الذي يتم فك ترميزه من سلسله ASCII المحددة التي تمثل مجموعه Base64 الخاصة بانظمه ترميز ثنائيه النص. |
