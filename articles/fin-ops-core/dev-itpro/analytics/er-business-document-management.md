---
title: نظرة عامة على إدارة مستندات الأعمال
description: توفر هذه المقالة معلومات عن كيفية استخدام ميزة إدارة مستندات الأعمال الخاصة بإطار عمل إعداد التقارير الإلكترونية (ER).
author: kfend
ms.date: 04/23/2021
ms.topic: overview
ms.prod: ''
...
استخدم الإجراء التالي لتحرير قوالب الفواتير ذات النص الحر في مساحة عمل إدارة مستندات الأعمال. قبل إكمال هذا الإجراء، يجب إكمال كافة الإجراءات السابقة في هذه المقالة.
