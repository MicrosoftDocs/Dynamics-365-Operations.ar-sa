...
يجب استيراد تكوينات التقارير الإلكترونية التي تحتوي على قوالب مستندات الأعمال إلى المثيل الحالي. قم بتنزيل الملفات التالية وتخزينها محليًا لإكمال هذا الإجراء.
...
لمزيد من المعلومات حول تنشيط الميزات الجديدة، راجع [نظرة عامة على إدارة الميزات](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview).
...
للحصول على معلومات حول كيفية إعداد معلمات إدارة المستندات وأنواع المستندات المطلوبة، راجع [تكوين إدارة المستندات](https://docs.microsoft.com/en-us/dynamics365/fin-ops-core/fin-ops/organization-administration/configure-document-management).
