...
1. في Report Designer، في جزء التنقل، انقر فوق **تعريفات الأعمدة**.
...
1. في Report Designer، انقر فوق **تعريفات الأعمدة**، ثم قم بفتح تعريف العمود لتعديله.
...
1. في Report Designer، افتح تعريف العمود المراد تعديله.
...
1. في Report Designer، افتح تعريف العمود المراد تعديله.
2. في خلية **عرض العمود**، أدخل عدد المسافات لعرض العمود. والحد الأقصى لعرض أي عمود هو 255 حرفاً (ويشمل هذا الرقم النسب المئوية والفواصل والأقواس). وبدلاً من ذلك، لتمكين Report Designer من تحديد العرض المناسب للعمود، استنادًا إلى محتويات الخلية، انقر نقرًا مزدوجًا فوق خلية **عرض العمود**، ثم انقر فوق **الاحتواء التلقائي**.
...
1. في Report Designer من قائمة **الشركة**، انقر فوق **شركات**.
