...
description: تشرح هذه المقالة كيفية توسيع قائمة مواقع التخزين للمستندات التي تم إنشاؤها بواسطة تنسيقات التقارير الإلكترونية (ER).
author: kfend
ms.date: 10/29/2020
ms.topic: article
ms.prod: ''
...
يمكن إكمال كل المهام الموجودة في هذا الموضوع في شركة **USMF**.
