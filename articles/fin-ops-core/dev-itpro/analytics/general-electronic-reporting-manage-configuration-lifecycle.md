...
يُوضح هذا الموضوع كيفية إدارة دورة حياة تكوينات التقارير الإلكترونية (ER) لحل Dynamics 365 Finance.
...
## <a name="data-persistence-consideration"></a><a name="data-persistence-consideration" />اعتبار استمرارية البيانات
