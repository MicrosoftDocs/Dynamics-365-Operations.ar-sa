...
## <a name="Operators">عوامل التشغيل</a>
...
- يتم دعم أنواع البيانات الأولية (الأساسية) فقط للمعلمات من هذا النوع. تتضمن أنواع البيانات الأولية *عدد صحيح*، و *حقيقي*، و *منطقية*، و *سلسلة*.

## <a name="Paths">المسارات</a>
