...
### <a id='export-trace'></a>تصدير التتبع الذي تم إنشاؤه من التطبيق
...
كرر الخطوات الموجودة في قسم [استيراد تكوين التقارير الإلكترونية من خدمة التكوين التنظيمية إلى Finance and Operations‬](#import-configuration) من قبل في هذا الموضوع لاستيراد الإصدار 1.2 من تكوين **تعيين تتبع الأداء**.
