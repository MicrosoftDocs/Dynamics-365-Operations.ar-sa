...
description: تشرح هذه المقالة كيف يمكنك إعداد معلمات تنسيق التقارير الإلكترونية (ER) لكل كيان قانوني.
author: kfend
ms.date: 03/25/2022
ms.topic: article
ms.prod: ''
...
لإكمال الأمثلة الموجودة في هذه المقالة، يجب أن يكون لديك حق الوصول إلى Microsoft Dynamics 365 Finance لأحد الأدوار التالية:
...
اعتبارًا من الإصدار 10.0.24 من Finance، يمكنك تغيير السلوك الافتراضي وتجنب تلقي رسالة تحذير عن طريق تمكين ميزة **محاذاة المعلمات الخاصة بتطبيق التقارير الإلكترونية (ER) أثناء الاستيراد** في مساحة عمل **إدارة الميزات**. عند تمكين هذه الميزة ، إذا كانت بنية المعلمات الخاصة بالتطبيق التي تقوم باستيرادها تختلف عن بنية مصادر البيانات المقابلة في تنسيق التقارير الإلكترونية الهدف المحدد للاستيراد ، سينجح الاستيراد في الحالات التالية:
...
#### <a name="replicate-parameters"></a>نسخ متماثل‬ للمعلمات

اعتبارًا من الإصدار 10.0.27 من Finance، يمكنك نسخ المعلمات التي قمت بتكوينها في شركة ما إلى شركات أخرى في نفس الوقت.

لنسخ المعلمات، أكمل الخطوات التالية.
...
4. في جزء الإجراءات، على علامة تبويب **التكوينات**، في المجموعة **المعلمات الخاصة بالتطبيق**، حدد **إعداد**.
5. حدد الإصدار **1.1.1** الخاص بتنسيق التقارير الإلكترونية.
6. في جزء الإجراءات، حدد **نسخ متماثل‬**.
7. في مربع الحوار **نسخ متماثل**، على علامة تبويب **الشركات**،حدد الشركات التي ترغب في نسخ المعلمات اليها.

    > [!NOTE]
    > يتم عرض قائمة بالشركات المستهدفة فقط للمستخدمين الذين تم تعيين [دور أمان](../sysadmin/role-based-security.md#security-roles) لهم تم تكوينه لمنح حق الوصول لجميع المؤسسات.

8. حدد **موافق**.

    > [!NOTE]
    > يعلمك مربع حوار التأكيد إذا كانت بعض الشركات المستهدفة تحتوي على معلمات تم تكوينها مسبقًا للإصدار المحدد من تنسيق تقارير إلكترونية (ER). حدد **نعم** لتجاوز المعلمات عن طريق نسخها من الشركة الحالية.

    يتم الآن نسخ المجموعة المكونة من المعلمات الخاصة بالتطبيق إلى الشركات المحددة.

### <a name="reuse-existing-parameters"></a>إعادة استخدام المعلمات الموجودة

اعتبارًا من الإصدار 10.0.23 من Finance، يمكنك إعادة استخدام المعلمات الخاصة بالتطبيق التي تم تكوينها لإصدار تنسيق تقارير إلكترونية (ER) عندما تقوم بتشغيل إصدار أحدث من نفس التنسيق. لإعادة استخدام المعلمات الموجودة، قم بتمكين الميزة **استخدام المعلمات الخاصة بالتطبيق من الإصدارات السابقة لتنسيقات التقارير الإلكترونية (ER)‬** في مساحة عمل **إدارة الميزات**. عند تمكين هذه الميزة وتشغيل إصدار تنسيق تقارير إلكترونية (ER) يحاول قراءة المعلمات الخاصة بالتطبيق، سيحاول ER العثور على معلمات خاصة بالتطبيق تم تكوينها للإصدار الحالي من هذا التنسيق. وإذا لم تكن متوفرة، فسيحاول ER العثور عليها للإصدار الأدنى الأقرب لهذا التنسيق.
