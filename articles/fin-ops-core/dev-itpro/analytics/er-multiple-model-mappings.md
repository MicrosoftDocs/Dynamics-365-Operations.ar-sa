...
ويتيح كل تعريف للجذر تمثيل بيانات ذلك المجال بالطريقة الأكثر ملاءمة لأغراض اعداد التقارير المحددة. لكل تعريف جذر، يمكنك تكوين مكون تعيين نموذج إعداد التقارير الإلكترونية (ER) كتطبيق خاص بـ Microsoft Dynamics 365 Finance لنموذج بياناتك. وبهذه الطريقة ، يمكنك وصف كيفيه ملء نموذج البيانات الخاص بك في وقت التشغيل.
...
توضح الإجراءات الواردة في هذا الموضوع كيفيه أداره تكوينات تعيين طراز ER متعددة لنموذج بيانات ER عند احتواءهما علي مكونات تعيين نموذج مختلفه مكونه لنفس تعريف الجذر. 
