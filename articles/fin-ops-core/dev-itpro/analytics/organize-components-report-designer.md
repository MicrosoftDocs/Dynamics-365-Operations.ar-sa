...
يمكنك إعادة تسمية المجلدات والتقارير وكتل الإنشاء والكائنات الأخرى في Report Designer لمساعدتك في تنظيم ملفاتك. واستنادًا إلى نوع الكائن الذي قمت بإعادة تسميته، فقد تحتاج إلى تحديث الاقترانات مع ذلك الكائن.

## <a name="rename-a-folder-or-building-block-in-report-designer"></a>إعادة تسمية مجلد أو كتلة إنشاء في Report Designer
باستخدام Report Designer، يمكنك إعادة تسمية المجلدات وتعريفات كل من التقارير والصفوف والأعمدة وشجرة التقارير.

### <a name="rename-a-folder-or-building-block-in-report-designer"></a>إعادة تسمية مجلد أو كتلة إنشاء في Report Designer

1. في Report Designer، استخدم جزء التنقل لتحديد المجلد أو العنصر المطلوب إعادة تسميته.
...
1. في Report Designer، في جزء التنقل، انقر فوق **مجموعات التقارير**.
...
> [NOTE] إذا قمت بجدولة التقارير لإنشائها في فواصل زمنية محددة، فيمكنك تجاوز هذه الإعدادات وإنشاء تقرير فورًا.
...
<td>ستكون أي عملات تقارير إضافية تم تكوينها في نظام Microsoft Dynamics 365 Finance مدرجة هنا. حدد خانة الاختيار هذه لإنشاء تقارير إضافية بالعملات المُشار إليها. لعرض هذه التقارير في عارض الويب، انقر فوق زر <strong>العملة</strong> ثم حدد عملة.</td>
</tr>
<tr>
