...
| الوظيفة | ‏‏الوصف |
|----------|-------------|
| [NullContainer](er-functions-record-nullcontainer.md) | تُرجع هذه الوظيفة قيمة *حاوية (سجل)* فارغة لها نفس البنية كقائمة سجلات مُحددة أو سجل. |
| [EmptyRecord](er-functions-record-emptyrecord.md) | تُرجع هذه الوظيفة قيمة *حاوية (سجل)* فارغة لها نفس البنية كقائمة سجلات مُحددة أو سجل. |
