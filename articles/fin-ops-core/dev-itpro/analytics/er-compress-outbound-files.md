...
description: تشرح هذه المقالة كيفية ضغط المستندات الكبيرة المُنشأة بتنسيق التقارير الإلكترونية.
author: NickSelin
ms.date: 09/11/2020
ms.topic: article
ms.prod: ''
...
لمعرفة المزيد عن هذا الأسلوب، أكمل المثال في هذه المقالة.
...
قبل أن تتمكن من استكمال الإجراءات في هذه المقالة، يجب تنفيذ الخطوات التالية:
