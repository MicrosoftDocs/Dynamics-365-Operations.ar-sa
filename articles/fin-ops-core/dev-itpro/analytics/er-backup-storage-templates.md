...
description: تشرح هذه المقالة كيفية استخدام مساحة تخزين النسخ الاحتياطية للتقارير الإلكترونية لاسترداد القوالب.
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
...
يتم ترحيل النسخ الاحتياطية للقوالب إلى مثيل جديد من التمويل والعمليات كجزء من قاعدة بيانات التطبيق.
...
1. في التمويل والعمليات، افتح **إدارة المؤسسة \> التقارير الإلكترونية \> صفحة التكوينات**.
...
إذا قمت بترقية بيئتك إلى التمويل والعمليات، الإصدار 10.0.5 (أكتوبر 2019) وأردت الترحيل إلى بيئة جديدة تتضمن تنسيقات تكوينات التقارير الإلكترونية التي يمكن تشغيلها، فحدد **تعبئة مساحة تخزين النسخ الاحتياطية** في صفحة **معلمات التقارير الإلكترونية** قبل حدوث عملية الترحيل. يبدأ هذا الزر عملية إنشاء نسخ احتياطية لكافة القوالب المتوفرة، بحيث يمكن تخزينها في موقع مساحة تخزين النسخ الاحتياطية لقوالب التقارير الإلكترونية‬.
...
في التمويل والعمليات، الإصدار 10.0.5، تتوفر ميزة مساحة تخزين النسخ الاحتياطية لقوالب التقارير الإلكترونية‬ فقط في عمليات النشر السحابية.
