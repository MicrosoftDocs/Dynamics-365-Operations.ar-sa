...
description: تصف هذه المقالة محتوى ميزات Power BI.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848798"
---
# <a name="benefits-power-bi-content"></a>محتوى "الميزات" في Power BI

[!include [banner](../includes/banner.md)]

تصف هذه المقالةمحتوى **ميزات** Microsoft Power BI. يوضح هذا الموضوع كيفية الوصول إلى التقارير التي تم تضمينها في حزمة المحتوى، ويوفر معلومات حول نموذج البيانات والكيانات المستخدمة لإنشاء حزمة المحتوى.
