---
title: نظرة عامة على إعداد التقارير الإلكترونية (ER)
description: توفر هذه المقالة نظرة عامة على أداة إعداد التقارير الإلكترونية. وهو يصف المفاهيم الاساسيه والسيناريوهات المعتمدة والتنسيقات التي تعد جزءا من الحل.
author: kfend
ms.date: 11/02/2021
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "9269680"
---
# <a name="electronic-reporting-er-overview"></a>نظرة عامة على إعداد التقارير الإلكترونية (ER)

[!include [banner](../includes/banner.md)]

توفر هذه المقالة نظرة عامة على أداة إعداد التقارير الإلكترونية (ER). وهو يتضمن معلومات حول المفاهيم الأساسية، والسيناريوهات التي تدعمها التقارير الإلكترونية، وقائمة بالتنسيقات التي تم تصميمها إصدارها كجزء من الحل.
...
- تكوين واحد لإصدارات Dynamics 365 Finance المتعددة:
...
- وهي تمثل أداة واحدة مشتركة لإعداد التقارير الإلكترونية في مجالات مختلفة وتحل محل أكثر من 20 محركًا مختلفًا تقوم بنوع من التقارير الإلكترونية للتمويل والعمليات.
...
يوفر مستودع **نظام الملفات** صلاحية الوصول إلى قائمة التكوينات الموجودة كملفات XML في المجلد المحدد لنظام الملفات المحلي للجهاز حيث يتم استضافة خدمة AOS. تم تحديد المجلد المطلوب في مرحلة تسجيل المستودع. ويمكنك استيراد التكوينات من مستودع **نظام الملفات** إلى المثيل الحالي. 
...
- [مكونات التقارير الإلكترونية](er-overview-components.md)
