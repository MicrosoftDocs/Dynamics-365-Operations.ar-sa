...
#### <a name="FormatComponentOutbound"></a>مكونات التنسيق للمستندات الإلكترونية الصادرة
...
#### <a name="FormatComponentInbound"></a>مكونات التنسيق للمستندات الإلكترونية الواردة
