...
description: توفر هذه المقالة كيفية تصميم تكوين إعداد التقارير الإلكترونية (ER) وتحديد التبعية الخاصة به من مكونات البرامج الأخرى.
author: NickSelin
ms.date: 07/23/2021
...
يظهر هذا الإجراء كيفية تصميم تكوين التقارير الإلكترونية وتحديد تبعيته بالنسبة إلى مكونات البرامج الأخرى، بحيث يمكنك المساعدة في ضمان تنزيل التكوين بشكل صحيح إلى إصدار معين من التمويل والعمليات. في هذا المثال، ستقوم بإنشاء تكوينات التقارير الإلكترونية المطلوبة للشركة النموذجية Litware, Inc. 
...
26. في الشجرة، قم بتوسيع "عينة نموذج البيانات"
    ...
    * إن قمت بتسجيل الدخول إلى التمويل والعمليات، وتسجيل الموفر نفسه والوصول إلى مشروع LCS نفسه وتنزيل تكوين نموذج البيانات نفسه، فسيتم تنزيل تكوين "تعيين نموذجي (بديل)‬"، في حين سيتم تخطي تكوين "تعيين نموذجي".  
