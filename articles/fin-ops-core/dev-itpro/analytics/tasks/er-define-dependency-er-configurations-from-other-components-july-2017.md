...
26. في الشجرة، قم بتوسيع "عينة نموذج البيانات"
    ...
    * إذا قمت بتسجيل الدخول إلى Finance and Operations، وتسجيل الموفر نفسه والوصول إلى مشروع LCS نفسه وتنزيل تكوين نموذج البيانات نفسه، فسيتم تنزيل تكوين "تعيين نموذجي (بديل)‬"، في حين سيتم تخطي تكوين "تعيين نموذجي".  
