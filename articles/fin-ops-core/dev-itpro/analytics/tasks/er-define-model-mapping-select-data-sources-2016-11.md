...
description: تصف هذه المقالة كيف يمكن لمستخدم بمنصب مسؤول النظام أو مطور التقارير الإلكترونية تحديد مصادر البيانات لنموذج بيانات التقارير الإلكترونية.
author: kfend
ms.date: 08/29/2018
