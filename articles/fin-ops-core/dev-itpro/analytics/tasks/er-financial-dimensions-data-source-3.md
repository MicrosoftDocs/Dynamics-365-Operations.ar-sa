...
description: توضح هذه المقالة كيفية تكوين نموذج التقارير الإلكترونية (ER) لاستخدام الأبعاد المالية كمصدر بيانات لتقارير الإلكترونية (ER). (جزء 3)
author: NickSelin
ms.date: 05/27/2020
...
61. انقر فوق موافق.
![صفحة مصمم التنسيق‬.](../media/er-financial-dimensions-guides-format1.png)
...
45. انقر فوق حفظ.
46. قم بإغلاق الصفحة.
![صفحه مصمم التنسيق ، وهي عناصر التقرير التي تم تعيينها لمصادر البيانات.](../media/er-financial-dimensions-guides-format2.png)
