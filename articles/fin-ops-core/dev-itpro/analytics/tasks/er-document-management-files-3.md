...
description: توضح هذه المقالة كيفية تكوين تنسيق التقارير الإلكترونية لاستخدام ملفات إدارة المستندات في مخرج التقارير الإلكترونية. (جزء 3)
author: NickSelin
ms.date: 08/29/2018
