...
description: تصف هذه المقالة كيفية تكوين تنسيق التقارير الإلكترونية (ER) لاستخدام ملفات إداره المستندات (المرفقات) في إخراج التقارير الإلكتروني (ER). (جزء 5)
author: kfend
ms.date: 08/29/2018
