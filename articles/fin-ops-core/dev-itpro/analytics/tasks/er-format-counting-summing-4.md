...
description: تصف هذه المقالة كيفية تكوين تنسيق التقارير الإلكترونية للقيام بالجرد والجمع استنادًا إلى البيانات الخاصة بإخراج النص الذي تم إنشاؤه بالفعل. (جزء 4)
author: kfend
ms.date: 08/29/2018
