...
يجب أيضًا تنزيل وحفظ الملفات التالية محليًا: [Dynamics 365 Finance أمثلة على التقارير الإلكترونية](https://go.microsoft.com/fwlink/?linkid=862266): 1099model.xml، و1099formatcsv.xml، و1099entriescsv.csv.
...
5. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..*`.
...
6. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case`.
...
7. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Header: Sequence 1..1`.
...
8. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)`.
...
9. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\TransactionDate: DateTime`.
...
10. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\CountryCode: String 0..1`.
...
11. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)\Remark: Sequence 1..1 (,)`.
...
12. في الشجرة، حدد `Incoming: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Unparsed: Sequence 1..1`.
...
6. في الشجرة، قم بتوسيع `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)`.
7. في الشجرة، قم بتوسيع `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)`.
8. في الشجرة، قم بتوسيع `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)`.
9. في الشجرة، قم بتوسيع `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data`.
10. في الشجرة، قم بتوسيع `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\CountryCode: String 0..1 (CountryCode)`.
11. في الشجرة، حدد `format\Incoming: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\TransactionDate: DateTime(TransactionDate)`.
