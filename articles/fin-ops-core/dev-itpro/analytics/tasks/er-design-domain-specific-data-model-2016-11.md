...
description: تصف هذه المقالة كيفية إنشاء تكوين إعداد التقارير الإلكترونية الجديد الذي يحتوي علي نموذج بيانات لمستندات الدفع الإلكترونية.
author: NickSelin
ms.date: 08/29/2018
