...
description: توضح هذه المقالة كيفية صيانة تكوين تنسيق التقارير الإلكترونية (ER).
author: kfend
ms.date: 08/29/2018
