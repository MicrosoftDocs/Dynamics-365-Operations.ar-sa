...
---
# <a name="EmailDestinationType">وجهة البريد الإلكتروني</a>
...
[![تكوين حساب مصدر البريد الإلكتروني](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)
