...
description: تشرح هذه المقالة معلومات عن كيفية تكوين وجهة بريد إلكتروني لكل مجلد أو مكون ملف لتنسيق التقارير الإلكترونية (ER).
author: NickSelin
ms.date: 08/03/2021
ms.topic: article
ms.prod: ''
...
إذا كانت أرقام الحساب الخاصة بالمنصب الذي تم تكوينه فريدة للمثيل الكامل الخاص بـ 365‎ Finance Microsoft Dynamics يمكن أن يبقى حقل **الشركة مصدر البريد الإلكتروني** في مربع الحوار **البريد الإلكتروني** إلى فارغ.
...
يوضح الرسم التوضيحي التالي العملية، كما هو موضح في هذه المقالة لتجميع المكونات الفردية وتمكين وجهة **البريد الإلكتروني** للمجموعة الجديدة، بحيث يتم إرسال ملاحظة خطاب التحصيل مع فواتير العميل المناسبة كمرفقات بالبريد الإلكتروني.
