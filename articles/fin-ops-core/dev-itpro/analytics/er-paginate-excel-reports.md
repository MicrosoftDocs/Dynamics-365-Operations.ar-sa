...
توضح هذه المقالة كيف يمكن لمستخدم لديه دور مسؤول النظام أو المستشار الوظيفي للتقارير الإلكترونية تكوين تنسيق [التقارير الإلكترونية (ER)](general-electronic-reporting.md) لإنشاء مستندات صادرة في Microsoft Excel وإدارة فواصل صفحات المستندات.
...
اتبع الخطوات الواردة في [Dynamics 365 Finance](er-quick-start2-customize-report.md#ImportERSolution1) لإضافة تكوينات التقارير الإلكترونية القياسية إلى مثيلك الحالي من Dynamics 365 Finance. استيراد الإصدار **1.9** من تكوين تنسيق **تقرير نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي**. يتم استيراد الإصدار الأساسي 1 من تكوين **نموذج نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي** الأساسي بشكل تلقائي من المستودع.
...
1. اتبع الخطوات الموجودة في قسم [استبدال قالب Excel الحالي في تنسيق التقارير الإلكترونية المخصص](#replace-template) في هذه المقالة. ولكن، في الخطوة 7، حدد الملف **ERIntrastatReportDemo2.xlsx** file.
...
1. تأكد أولاً من وجود 24 حركة في صفحة **نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي**. كرر الخطوات الموجودة في قسم [إنشاء تقرير مراقبة إقرار نظام جمع المعلومات التجارية بين دول الاتحاد الأوروبي‬](#generate-intrastat-control-report) من هذه المقالة لإنشاء تقرير المراقبة ومراجعته.
