---
title: مساحة عمل جوال دليل الشركة
description: توفر هذه المقالة معلومات عن مساحة العمل المحمولة دليل الشركة التي تسمح للمستخدمين بعرض أسماء الموظفين الآخرين في المؤسسة والاتصال بهم.
author: jcart1106
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
