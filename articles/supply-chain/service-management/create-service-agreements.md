...
description: يوضح هذا المقال كيفية استخدام الميزات الموجودة في إدارة الخدمة وإدارة المشروع والوحدات النمطية المحاسبية لإنشاء اتفاقيات الخدمة.
author: sorenva
ms.date: 02/19/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901752"
---
# <a name="create-service-agreements"></a>إنشاء اتفاقيات خدمات

[!include [banner](../includes/banner.md)]

يوضح هذا المقال كيفية استخدام الميزات الموجودة في إدارة الخدمة وإدارة المشروع والوحدات النمطية المحاسبية لإنشاء اتفاقيات الخدمة.
...
5. اتبع الخطوات الموجودة في القسم المعنون **إنشاء اتفاقية خدمة** كما هو موضح سابقًا في هذا المقال لإدخال مرجع المشروع.
