---
title: أوامر الخدمة
description: يوفر هذا الموضوع نظرة عامة حول كيفية العمل مع أوامر الخدمة‬.
author: sorenva
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> لإنشاء أوامر الخدمة التي لا ترتبط باتفاقية خدمة، يجب عليك تحديد خانة الاختيار **السماح بدون اتفاقية خدمات** في صفحة **معلمات إدارة الخدمة**.

### <a name="scenario"></a>سيناريو

يوضح السيناريو التالي موقفًا آخر حيث يكون من المفيد إنشاء أمر خدمة غير مرتبط باتفاقية خدمة.

يستلم مرسِل الشركة مكالمة لطلب خدمة طوارئ لأحد المصاعد. لا يوجد وقت لإعداد اتفاقية خدمة ومشروع للخدمة. وبالتالي، ينشئ المرسل أمر خدمة مباشرة في النموذج **أوامر الخدمة**، ويرفق أمر الخدمة بمشروع موجود، ثم ينشئ بنود أمر الخدمة. أنشأ المرسل أيضًا مهمة أو علاقة كائن لأمر خدمة موجود بالفعل، لتسجيل عمل غير مرتبط باتفاقية الخدمة. للحصول على مزيد من المعلومات، راجع [إنشاء أوامر خدمة يدوياً](create-service-orders-manually.md) و [إنشاء علاقات مهام الخدمة](create-service-task-relations.md).
...
يريد المرسل في نهاية كل أسبوع ترحيل كل أوامر الخدمة التي تم إرفاقها بمشروع معين. وبالتالي، يقوم المرسل بتحديد موقع المشروع ذي الصلة في صفحة **المشاريع** ويرحِّل أوامر الخدمة التي تم إكمالها. لمزيد من المعلومات، راجع [ترحيل أوامر الخدمة (نموذج الفئة)](https://technet.microsoft.com/library/aa574685\(v=ax.60\)).
