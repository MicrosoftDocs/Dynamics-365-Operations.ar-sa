...
4.  في النموذج **أمر الإرجاع-رقم ترخيص المواد المسترجعة: % 1، %2**، وفي **جزء الإجراءات**، انقر فوق **العثور على أمر مبيعات**.
...
5.  في النموذج **أمر الإرجاع-رقم ترخيص المواد المسترجعة: % 1، %2**، تحقق من أنه تم إنشاء أمر إرجاع لإرجاع الصنف Test. تم تعيين كمية أمر الإرجاع على 5.00.
...
9.  افتح نموذج **حركات المخزون**. تحقق من تحديد تكلفة الإرجاع بسعر 7.00 لكل جزء باستخدام القيمة الموجودة في حل **سعر تكلفة الإرجاع**، بمجموع 35.00 في حقل **مبلغ التكلفة**. يمكنك فتح نموذج **حركات المخزون** من نموذج **أمر الإرجاع-رقم ترخيص المواد المسترجعة: % 1، %2**. في الشبكة **بنود**، انقر فوق **مخزون** \> **حركات**.
