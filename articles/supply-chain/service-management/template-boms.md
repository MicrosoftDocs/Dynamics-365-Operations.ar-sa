...
> [!NOTE]
> يمكن تطبيق قائمة مكونات صنف قالب واحدة فقط على كائن خدمة.
...
> [!NOTE]
> يتم استخدام التسلسلات الرقمية لتخصيص المعرفات للسجلات التي تحتاج إليها. قبل تعيين تسلسل أرقام لقائمة مكونات الصنف القالب أو رقم بند سجل قائمة مكونات الصنف، يجب إعداد أكواد التسلسلات الرقمية.
...
1. حدد **إدارة الخدمة‬** \> **الإعداد** \> **معلمات إدارة الخدمة**.
1. حدد **التسلسلات الرقمية**، ثم حدد كود تسلسل رقمي لمراجع التسلسل الرقمي التي قمت بإنشائها في نموذج **التسلسلات الرقمية**.
1. أغلق النموذج لحفظ التغييرات.

> [!NOTE]
> يتم استخدام رقم بند سجل قائمة مكونات الصنف بواسطة النظام لربط الحركات في سجل قائمة مكونات الصنف باتفاقية خدمة أو أمر الخدمة. لا يتم عرض الرقم في واجهة المستخدم.
