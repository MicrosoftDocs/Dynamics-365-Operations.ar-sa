...
description: يوفر Microsoft Dynamics 365 Supply Chain Management وحدتين مختلفتين للعمل مع النقل وإدارة النقل (TMS) والتكلفة المستلمة. يلخص هذا المقال الوظائف المشتركة بين الوحدتين ويسلط الضوء على الاختلافات بينهما.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
