...
تقوم إدارة النقل (TMS) بدعم إشعارات شحن مقدم (ASNs) الواردة، وجميع متغيرات الاستلام من خلال تطبيق المستودع، وجميع طرق الاستلام من خلال عميل Supply Chain Management.
...
يمكن استلام الحاويات في تكلفة الشحن من خلال نوع جديد من الاستلام يُعرف باسم *إيصال استلام البضائع أثناء النقل*، من خلال دفاتر يومية الوصول، أو من خلال استلام الأجهزة المحمولة. عند استخدام دفاتر يومية الوصول، يمكن تهيئة الكميات من البضائع في أمر النقل أو من بنود أمر الشراء الأصلية في الحاوية. توفر تكلفة الوصول نوعين من العمل للاستلام من خلال تطبيق المستودع.

لا توفر التكلفة المستلمة إشعار شحن مقدم (ASN) للاستلام الإلكتروني للبضائع. بالإضافة إلى ذلك، لا يدعم تدفقات تطبيقات المستودعات التي تعالج استلام الأحمال أو استلام لوحة الترخيص أو استلام مختلط للوحة الترخيص.
