...
> [!NOTE]
> حاويات الشحن والسجلات مرتبطة برحلة. بنود الشراء مرتبطة بحاوية شحن. بالإضافة إلى ذلك، يتم تقسيم التكاليف التي يتم إدخالها هنا على جميع بنود الشراء المرفقة.
> أمر شراء المشروع غير معتمد في التكلفة المستلمة.
