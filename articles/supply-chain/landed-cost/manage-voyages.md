...
| استلام البضائع قيد النقل | استلم جميع بنود الأمر التي هي قيد النقل في الرحلة. يعد هذا الزر أحد الخيارات الثلاثة المتوفرة لاستلام البضائع أثناء النقل في الرحلة. (الخياران الآخران هما زر **إنشاء دفتر يومية وصول** الموصوف لاحقًا في هذا الجدول، وتطبيق المستودع.) هذا الخيار هو الخيار الأبسط، وسيعالج البضائع التي يتم نقلها من مستودع البضائع أثناء النقل إلى مستودع الوجهة النهائية. إذا كنت تريد مزيدًا من التحكم في العملية، فاستخدم دفتر يومية الوصول أو جهازًا محمولًا لمعالجة استلام البضائع. |
