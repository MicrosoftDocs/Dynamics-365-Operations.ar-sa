...
description: يوضح هذا المقال كيفية العمل مع البضائع بالطريق . عند إعداد أمر أو رحلة لاستخدام معالجة البضائع بالطريق، فإنه يمكن فوترة البضائع قبل استلامها في المستودع للاستهلاك.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
