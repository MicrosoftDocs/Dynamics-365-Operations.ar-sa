...
1. يتيح معالجة دفتر يومية الوصول كما هو موضح في [تسجيل عمليات استلام الأصناف بدفتر يومية وصول الصنف](https://technet.microsoft.com/library/aa571129.aspx).
...
تشبه إعدادات التكوين لهذه العمليات إعدادات [عمليات استلام أمر الشراء ووإنشاء عمل التخزين](https://technet.microsoft.com/library/dn553216.aspx). ومع ذلك، تضيف أيضًا عملية *استلام وتخزين صنف البضائع بالنقل* الحقل التالي.

- **تمكين إكمال حاوية الشحن** – إذا تم تعيين هذا الخيار على *نعم*، عند إتمام عمل التخزين، سيوفر تطبيق المستودع بتوفير خيار إضافي يسمى **إكمال حاوية الشحن**. عند تحديد هذا الخيار، ستتم مطالبة العامل بتأكيد أن الحاوية مكتملة. وعند هذه النقطة، ستتم معالجة كافة عمليات الاستلام القصيرة على إنها ضمن الحركة.

### <a name="location-directives"></a>توجيهات الموقع

تضيف التكلفة نوع أمر عمل جديد يسمى *البضائع بالنقل* إلى الصفحة **توجيهات الموقع**. يجب تكوين نوع أمر العمل هذا بالطريقة نفسها مثل [أنواع أوامر العمل الخاصة بأمر الشراء](https://technet.microsoft.com/library/dn553184.aspx).

### <a name="work-templates"></a>قوالب العمل

تضيف التكلفة نوع أمر عمل جديد يسمى *البضائع بالنقل* إلى الصفحة **قوالب العمل**. يجب تكوين نوع أمر العمل هذا بالطريقة نفسها مثل [قوالب العمل الخاصة بأمر الشراء](https://technet.microsoft.com/library/dn553184.aspx).
