...
description: يوفر هذا المقال المعلومات التي ستساعدك في إعداد تفاصيل السياسات للمعاملات الزائدة/قيد التنفيذ، بحيث يمكن للنظام تحديد كيفية إدارة المعالجة الزائدة والمعالجة الناقصة للبضائع في وقت الاستلام.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
