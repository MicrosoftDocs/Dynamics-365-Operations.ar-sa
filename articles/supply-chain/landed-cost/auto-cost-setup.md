...
description: يوضح هذا المقال كيفية إعداد قواعد التكلفة لمختلف مستويات الرحلة الداخلية. استنادًا إلى هذه القواعد، يقوم النظام بحساب التكاليف وأضافتها تلقائياً. لذلك، لن يضطر المستخدمون إلى إضافة التكاليف يدوياً.
author: Weijiesa
ms.date: 01/21/2021
ms.topic: article
ms.prod: ''
...
للعمل باستخدام التكاليف التلقائية، انتقل إلى **التكلفة شاملة التفريغ \> إعداد التكاليف \> التكاليف التلقائية**. ثم قم بإعداد قواعد التكلفة التلقائية كما هو موضح في باقي هذا المقال.
