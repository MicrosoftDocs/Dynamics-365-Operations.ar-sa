...
description: يصف هذا المقال كيفية إعداد الرحلات متعددة المراحل لوحدة التكلفة المستلمة.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905823"
---
# <a name="multi-leg-journey-setup"></a>إعداد الرحلة متعددة المراحل

[!include [banner](../../includes/banner.md)]

يصف هذا المقال كيفية إعداد الرحلات متعددة المراحل **لوحدة التكلفة** المستلمة.
