...
description: يوضح هذا المقال كيفية إعداد معلومات الشحن للوحدة المنطقية التكلفة شاملة التفريغ.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
يوضح هذا المقال كيفية إعداد معلومات الشحن للوحدة المنطقية **التكلفة شاملة التفريغ**.
