...
ms.locfileid: "9725442"
---
# <a name="manage-folios"></a>إدارة السجلات

[!include [banner](../../includes/banner.md)]

غالبًا ما يتم تحديد السجل بواسطة لوائح الجمارك. يمكن أن تتكون من سلع مورد واحد شركة أو كيان واحد لكل شحنة. تتم إدارة البضائع الموجودة في حافظة الأوراق في حاوية واحدة.
...
| زر | الوصف |
|---|---|
| ترحيل قائمة عمليات الاستلام | قم بترحيل قائمة الإيصالات لجميع بنود أوامر الشراء في السجل.  |
| ترحيل إيصال استلام المنتجات | قم بترحيل إيصال استلام منتج لجميع بنود أوامر الشراء في السجل. |
| ترحيل فاتورة | قم بترحيل فاتورة لجميع بنود أوامر الشراء في السجل.  |
...
| زر | الوصف |
|---|---|
| قائمة الإيصالات | قم بترحيل قائمة الإيصالات لجميع بنود أوامر الشراء في السجل.  |
