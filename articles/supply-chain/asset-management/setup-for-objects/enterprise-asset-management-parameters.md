...
يمكن استخدام‏‎ الزر **معالج إنشاء البيانات** لإنشاء بيانات الإعداد تلقائيًا لأغراض الاختبار أو العرض التوضيحي في شركة في Dynamics 365 Supply Chain Management. راجع المستند التقني "إعداد بيانات الاختبار في إدارة الأصول" للحصول على معلومات حول كيفية استخدام المعالج.
...
>[!NOTE]
>التحديد المتعلق باستخدام خطة رئيسية أو عدم استخدامها في الوحدة النمطية **إدارة الأصول**، والنموذج المرتبط المستخدم للحصول على نظرة عامة على حجز القدرة الإنتاجية أو القدرة الإنتاجية هو الإعداد القياسي. بحسب إعدادك في حقل **الخطة الرئيسية**، ستتمكن من الوصول إلى معلومات حول القدرة الإنتاجية في **حجز القدرة الإنتاجية** أو **القدرة الإنتاجية** في الوحدة النمطية **إدارة المؤسسة**. لا يمكن إنشاء اعداد تظهر فيه حجوزات القدرة الإنتاجية في طريقتي العرض.  
