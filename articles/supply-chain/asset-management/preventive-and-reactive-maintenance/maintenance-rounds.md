---
title: دورات الصيانة
description: يشرح هذا المقال دورات الصيانة في إدارة الأصول.
...
1. انقر فوق **إدارة الأصول** > **دوري** > **الصيانة الوقائية** > **جدولة دورات الصيانة**، أو **إدارة الأصول** > **جدول الصيانة** > **جدول الصيانة بكامله** أو **بنود جدول الصيانة المفتوحة** أو **مجموعات جداول الصيانة المفتوحة** > حدد بند جدول صيانة في القائمة > زر **دورات الصيانة**.
