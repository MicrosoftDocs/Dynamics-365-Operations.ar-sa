...
description: يشرح هذا المقال كيفية إنشاء أنواع مواقع العمل في إدارة الأصول.
...
10. على علامة التبويب السريعة **متطلبات سمات الأصول‬**، قم بإعداد سمات الأصول‬ التي يجب إعدادها تلقائيًا على مواقع العمل الجديدة التي تستخدم نوع موقع العمل هذا. حدد **إضافة بند** وحدد السمة. تعمل متطلبات السمات هذه كإرشادات. لا يتم التحقق من صحتها مقابل السمات التي تم إعدادها على أصل (**إدارة الأصول** > **الأصول** > **كل الأصول** > حدد أصلاً في صفحة القائمة > علامة التبويب **عام** > زر **السمات**). تظهر متطلبات السمات عند تثبيت الأصول على مواقع العمل.
