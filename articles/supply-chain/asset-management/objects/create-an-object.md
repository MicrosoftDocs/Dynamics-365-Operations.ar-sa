...
يمكنك تحديد **مورد** للأصل. يؤدي تحديد المورد إلى تحديد التقويم المستخدم لجدولة أمر العمل. يستخدم تحديد المورد غالبًا للأصول الثابتة. في Dynamics 365 for Finance and Operations، يتم إعداد الموارد ومجموعات الموارد في **‏‫إدارة المؤسسة‬** > **الموارد** > **مجموعات الموارد** أو **الموارد**.
...
- ترتبط المعلومات حول الأصول الثابتة لأصل بوحدة **الأصول الثابتة** في Dynamics 365 for Finance and Operations. وهذا يعني أنه في **الأصول الثابتة** > **الأصول الثابتة** > **الأصول الثابتة**، يمكنك الحصول على نظرة عامة حول مشاريع إدارة الأصول التي قد تكون على صلة بأصل ثابت عن طريق تحديد الأصل في القائمة وعرض المحتويات في جزء **المعلومات ذات الصلة** > قسم **المشاريع المقترنة**.
