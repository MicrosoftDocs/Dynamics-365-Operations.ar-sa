...
للحصول على نظرة عامة رسومية على الأصول وأنواع مهام الصيانة وارتباطها بأوامر العمل، راجع [الأصول وأوامر العمل](../overview/functional-locations-and-objects.md).
...
يمكن استخدام قوالب قائمة فحص الصيانة كمجموعة شائعة من المهام التي يجب ان ينفذها العامل لإكمال أمر العمل بشكل صحيح. يُشار إلى القوالب من بنود قائمة فحص الصيانة في الإعدادات الافتراضية لنوع مهمة الصيانة. يمكن الإشارة إلى القوالب عبر العديد من البنود الافتراضية لأنواع مهام الصيانة. وبالتالي، يمكنك إعادة استخدام مجموعة من مهام قائمة فحص الصيانة الشائعة بسهولة. تتضمن الأمثلة عن قوالب قائمة فحص الصيانة إرشادات الأمان العامة، وقائمة بالعناصر والشروط التي يجب التحقق منها في مضخة معينة أو نماذج مشابهة لسير ناقله.
...
29. قم بتعيين الحقول في صفحة **المرفقات**. يستخدم إعداد المرفقات وظيفة إعداد المستند القياسية في Microsoft Dynamics 365 for Finance and Operations.
...
32. لعرض قائمه بالأصول أو خطط الصيانة أو دورات الصيانة التي تستخدم حاليًا البند الافتراضي لنوع مهمة الصيانة، حدد البند، ثم حدد **مستخدم بواسطة‬**.
...
في إدارة الأصول، يمكنك تحديث أي تغييرات في تنبؤات أنواع مهام الصيانة بشكل تلقائي فيما يتعلق بتكاليف الساعة وتكاليف الأصناف والمصروفات التي تم تحديثها في وحدات نمطية أخرى في Finance and Operations. وبهذه الطريقة، يمكنك أن تضمن قيام التنبؤات بأنواع مهام الصيانة باستخدام أحدث أسعار التكلفة.
