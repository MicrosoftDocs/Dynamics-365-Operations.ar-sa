...
description: يصف هذا المقال كيف يتم التخطيط لصنف تم تعيين بُعد الموقع له للتغطية. يُعد المستودع بُعدًا إلزاميًا.
author: t-benebo
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863958"
---
# <a name="master-planning-for-site-coverage-mandatory-warehouse"></a>التخطيط الرئيسي لتغطية الموقع، المستودع إلزامي

[!include [banner](../includes/banner.md)]

يصف هذا المقال كيف يتم التخطيط لصنف تم تعيين بُعد الموقع له للتغطية. يُعد المستودع بُعدًا إلزاميًا.
