...
description: يناقش هذا المقال استيفاء المخزون الاحتياطي وكيفية إعداد كمية المخزون الاحتياطي للأصناف.
author: t-benebo
ms.date: 8/23/2021
ms.topic: article
...
> [!NOTE]
> بالنسبة لجميع الأمثلة الواردة في هذا المقال، يمثل المحور السيني المخزون ويمثل المحور الصادي الأيام، وتمثل الأشرطة مستوى المخزون وتمثل الأسهم الحركات، مثل بنود أوامر المبيعات أو بنود أوامر الشراء أو الأوامر المخططة.
...
- [استخدام دفتر يومية المخزون الآمن لتحديث الحد الأدنى من التغطية للعناصر](safety-stock-journal.md)
