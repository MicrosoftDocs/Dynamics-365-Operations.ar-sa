---
title: إعداد الخطط الرئيسية
description: يصف هذا المقال الاستراتيجيات والمعلمات المهمة والمتنوعة التي تُستخدم لإعداد الخطط الرئيسية.
author: t-benebo
ms.date: 07/01/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9740647"
---
# <a name="set-up-master-plans"></a>إعداد الخطط الرئيسية

[!include [banner](../includes/banner.md)]

يصف هذا المقال الاستراتيجيات المهمة والمعلمات التي تُستخدم لإعداد التخطيط الرئيسي. ويتضمن هذا الوصف نظرة عامة على أنواع الخطط التي يستخدمها التخطيط الرئيسي، وتوضح استراتيجية الخطة التي ينبغي استخدامها، وذلك وفقًا لمتطلبات الأعمال الخاصة بك. كما يوضح المعلمات الرئيسية التي تؤثر في الخطة ويوضح كيفية تأثير هذه المعلمات على الأوامر المخططة المقترحة.
