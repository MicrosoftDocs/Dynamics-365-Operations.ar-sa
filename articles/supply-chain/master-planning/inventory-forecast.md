...
## <a name="run-forecast-planning"></a>تشغيل تخطيط التنبؤ

بعد إدخالك التنبؤ بالطلب و/أو التنبؤ بالتوريد الخاص بك، فسيُمكنك تشغيل تخطيط التنبؤ لحساب صافي المتطلبات للمواد والسعة ولإنشاء الأوامر المخططة.

1. انتقل إلى **التخطيط الرئيسي \> التنبؤ \> التخطيط الرئيسي**.
1. حدد نموذج التنبؤ في الحقل **خطة التنبؤ**.
1. قم بتمكين **تعقب وقت المعالجة** لتسجيل وقت المعالجة لكل مهمة تخطيط.
1. في الحقل **عدد السلاسل**، أدخل قيمة. (لمزيد من المعلومات، راجع [تحسين أداء التخطيط الرئيسي](master-planning-performance.md).)
1. في حقل **التعليق**، أدخل نص للحصول على معلومات إضافية مطلوبة.
1. في علامة التبويب السريعة **السجلات المطلوب تضمينها**، حدد **عامل التصفية** للحد من تحديد الأصناف.
1. في علامة التبويب السريعة **التشغيل في الخلفية**، حدد معلمات الدفعة.
1. حدد **موافق**.

لعرض المتطلبات التي يتم حسابها، افتح الصفحة **إجمالي المتطلبات**. على سبيل المثال، في الصفحة **المنتجات التي تم إصدارها**، ضمن علامة التبويب **الخطة**، في القسم **المتطلبات**، حدد **إجمالي المتطلبات**.
