...
يصف هذا المقال ميزة التخطيط حسب الأولوية لـ Microsoft Dynamics 365 Supply Chain Management. تضيف الميزة دعمًا للتخطيط المدفوع بالطلب ، والذي يعد خطوة واحدة من [تخطيط متطلبات المواد حسب الطلب (DDMRP)](ddmrp-overview.md). يمكّن التخطيط المستند إلى الأولوية "تحسين التخطيط" من إنشاء أوامر مخططة مدفوعة بأولويات التخطيط بدلاً من تواريخ المتطلبات.
