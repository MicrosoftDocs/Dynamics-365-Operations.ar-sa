...
| الطلب | تثبيت السعر |
|---|---|
| **SO1:** تاريخ التسليم = اليوم + 1 يوم ، الكمية = 2 | <p>**الكمية الفعلية:** = تاريخ انتهاء الصلاحية = اليوم + 5 أيام</p><p>**PPO1:** تاريخ الاستلام = اليوم ، الكمية = 1 ، تاريخ انتهاء الصلاحية = اليوم + 10 أيام</p> |
...
- **كود التغطية (استراتيجية التزويد):** فتره
- **فتره التغطية:** 10أيام (مساويه لعمر الصلاحية)
- **مدة الصلاحية:** 10أيام
- **أيام البيع:** 0أيام
- **زمن وصول البضاعة:** الذي تم إنشاؤه بواسطة الاتفاقيات التجارية للمورد التالي:
