...
| تعيين المورد | عند العمل بقدره لا نهائيه، يقوم مشغل التخطيط الرئيسي المضمن بتعيين كافة الأوامر المخططة إلى نفس المورد في مجموعه موارد محدده. يعمل تحسين التخطيط على تحسين ذلك عن طريق تحديد المورد بشكل عشوائي بحيث يمكن لأوامر الإنتاج المختلفة استخدام موارد مختلفة. إذا كنت ترغب في استخدام نفس المورد لكافة الأوامر المخططة، فيجب عليك تحديد هذا المورد في المسار. |
| أنواع البيانات الممتدة (EDTs) | لا يدعم تحسين التخطيط التغييرات التي تمت علي دقه الادتس. علي سبيل المثال ، إذا قمت بتوسيع دقه كميه المنتج من منزلتين عشريتين (الافتراضي) إلى أربعه ، سيستمر تحسين أمثليه التخطيط في استخدام منزلتين عشريتين فقط. |
