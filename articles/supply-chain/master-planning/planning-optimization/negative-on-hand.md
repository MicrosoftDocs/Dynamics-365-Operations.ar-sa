...
description: يوضح هذا المقال كيفية التعامل مع الكمية الفعلية السالبة.
author: t-benebo
ms.date: 07/22/2021
ms.topic: article
ms.prod: ''
...
1. يعمل التخطيط الرئيسي على تجميع الكميات الفعلية بأقل مستوى من أبعاد التغطية. (على سبيل المثال، إذا لم يقم *الموقع* بتغطية البُعد، يعمل التخطيط الرئيسي على تجميع كميات فعلية على مستوى *المستودع*.)
...
ثم تقوم بضبط كمية المنتج *FG* بحيث يصبح المخزون الفعلي 5. لأن مخزون المنتج الفعلي هو 5، فإن كمية أمر المبيعات محجوزة الآن مقابل الكمية غير المتوفرة في متناول اليد (ستكون مماثلة إذا كانت في متناول اليد تساوي 0، وفي هذه الحالة سيتم حجز أمر المبيعات مقابل المخزون السلبي ). إذا قمت بتشغيل التخطيط الرئيسي الآن، فسيتم إنشاء أمر مخطط بالكمية 5 للمنتج *FG* لإمداد أمر المبيعات، لأن التخطيط الرئيسي‬ سيستخدم دائمًا الإمداد الموجود أو سينشئ أمرًا مخططًا جديدًا لإمداد الحجز الفعلي.
