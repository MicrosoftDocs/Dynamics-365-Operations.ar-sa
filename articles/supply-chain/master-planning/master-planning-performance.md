...
يشرح هذا الموضوع الخيارات المتنوعة التي يمكن أن تساعدك في تحسين أداء التخطيط الرئيسي واستكشاف المشاكل وإصلاحها. ويتضمن معلومات حول المعلمات والإعدادات، وحول التكوينات والإجراءات الموصي بها. كما يتضمن ملخصا لكافة المعلمات الهامة التي يجب وضعها في الاعتبار عند تشغيل مهام التخطيط الرئيسية طويلة الأمد.

هذا الموضوع مخصص لمسؤولي النظام أو لمستخدمي تكنولوجيا المعلومات الذين لديهم إمكانية استكشاف الأخطاء وإصلاحها. كما أنه مخصص لعمليات الإنتاج أو مخططات التوريد، نظرا لأنه يتضمن معلومات حول المعلمات المرتبطة بمتطلبات تخطيط الأعمال. 

## <a name="parameters-that-are-related-to-master-planning-performance"></a>المعلمات المرتبطة بأداء التخطيط الرئيسي

تؤثر المعلمات المتنوعة على وقت تشغيل التخطيط الرئيسي ويجب مراعاة ذلك.

### <a name="number-of-threads"></a>عدد السلاسل

تتيح لك معلمة **عدد السلاسل** ضبط عملية الجدولة الرئيسية لمساعدتها في الأداء بشكل أفضل على مجموعة البيانات المحددة. وتحدد العدد الإجمالي للسلاسل التي سيتم استخدامها لتشغيل التخطيط الرئيسي. وتؤدي إلى توازي تشغيل التخطيط الرئيسي، وهذا التوازي يساعد في تقليل وقت التشغيل. 
...
> [!NOTE]
> يزيد الإعداد **0** (صفر) لمعلمة **عدد السلاسل** من وقت تشغيل التخطيط الرئيسي. لذلك، نوصي دائما بتعيين قيمة تكون أكبر من 0.
...
وبشكل عام، نوصي بزيادة عدد المهام عندما يكون عدد الأصناف كبيرا جدا (بمئات الآلاف). خلاف ذلك، يجب تقليل عدد المهام. مع الصناعات الخاصة التالية، ضع في اعتبارك هذه النقاط:

- في صناعات البيع بالتجزئة والتوزيع، حيث يوجد العديد من الأصناف المستقلة، استخدم العديد من المساعدين، نظرا لعدم وجود تبعية بين الأصناف. 
...
تتيح لك معلمة **‏‫استخدام التخزين المؤقت** ضبط عملية الجدولة الرئيسية لمساعدتها في الأداء بشكل أفضل على مجموعة البيانات المحددة. علي سبيل المثال، يمكنك ضبطها لتحقيق النتائج التالية:
...
من الصعب التنبؤ بالخيار الأمثل، نظرا لأن كل حالة لا تعتمد فقط على البيانات ولكن أيضا على الأجهزة. علي سبيل المثال، لأن التخزين المؤقت الأقل يتسبب في حدوث تحميل إضافي على خادم قاعدة البيانات، فمن المحتمل ألا يكون من الأفضل استخدام هذا الخيار إذا كان خادم قاعدة البيانات محملا بشكل مسبق.
...
خلال الحدود الزمنية، يمكنك أيضا العثور على معلمة **رسالة الإجراء**. يتسبب حساب رسائل الإجراء في وقت أطول في التشغيل للتخطيط الرئيسي. إذا كانت رسائل الإجراء لا يتم تحليلها بشكل منتظم وتطبيقها (يوميا، أو أسبوعيا، وهكذا) ، قم بمراعاة إيقاف تشغيل الحساب اثناء تشغيل التخطيط الرئيسي. لإيقاف تشغيل الحساب في صفحة **الخطط الرئيسية** (**التخطيط الرئيسي \> الإعداد \> الخطط \> الخطط الرئيسي**)، قم بتعين الحد الزمني لـ **رسالة الإجراء** على **0** (صفر) للخطة الرئيسية التي تقوم بتشغيلها. تأكد أيضًا من إيقاف تشغيل إعداد **رسالة الإجراء** لكافة مجموعات التغطية.
...
عند مراجعة سجل جلسة العمل، ضع في اعتبارك النقاط التالية:

- يجب ألا يستغرق **التحديث** وقتًا طويلا (بشكل عام، يجب أن يستغرق حوالي 30 دقيقة). ومع ذلك، فإنه سلسلة واحدة.
