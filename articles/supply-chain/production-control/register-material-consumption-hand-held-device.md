...
description: يصف هذا المقال سير عمل يمكّن تسجيل استهلاك المواد الخام في الإنتاج باستخدام جهاز محمول باليد.
...
ms.locfileid: "8849231"
---
# <a name="register-material-consumption-using-a-mobile-device"></a>تسجيل استهلاك المواد باستخدام جهاز محمول

[!include [banner](../includes/banner.md)]

يصف هذا المقال سير عمل يمكّن تسجيل استهلاك المواد الخام في الإنتاج باستخدام جهاز محمول باليد.
