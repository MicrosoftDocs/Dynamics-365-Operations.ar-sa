...
في التوضيح التالي، تمثل (A) قائمة مكونات الصنف للمنتج H والأجزاء F و G و (b) كشف المسار للمنتجات H وجزء F.

![مثال عن بنية قائمة مكونات الصنف في مستويين.](media/product-H-part-F.png)
...
![قائمة مكونات الصنف الهندسية للمنتج H.](media/product-H-part-B.png)
...
![نوع بند الصنف الوهمي المستخدم في بنى قائمة مكونات الصنف متعددة المستويات.](media/product-G-route-sheet-G.png)
...
![مثال عن شبكة مسارات مستخدمة في قائمة مكونات الصنف متعددة المستويات.](media/product-G-part-F.png)

في الرسم التوضيحي التالي، تمثل (a) قائمة مكونات الصنف للمنتج G والجزء F، و(b) هي كشف المسارات للمنتج G والجزء F.

![قائمة مكونات الصنف للمنتج G والقطعة F وورقه المسار للمنتج G والقطعة F.](media/product-G-part-F-with-route-sheet.png)
