---
title: إصدار بنود BOM والتركيبة‬ إلى المستودع
description: يصف هذا المقال عملية إصدار المواد الخام لبنود قائمة مكونات الصنف وبنود المعادلة للمستودع.
...
ms.locfileid: "8860598"
---
# <a name="release-bom-and-formula-lines-to-the-warehouse"></a>إصدار بنود BOM والتركيبة‬ إلى المستودع

[!include [banner](../includes/banner.md)]

يصف هذا المقال عملية إصدار المواد الخام لبنود قائمة مكونات الصنف وبنود المعادلة للمستودع. عندما تقوم بإصدار قائمة مكونات الصنف أو بند المعادلة للمستودع، فسوف يقوم النظام أولًا بتحديد ما إذا كانت المواد متوفرة فعلًا في موقع إدخال إنتاج حالة العمل حيث سيتم استهلاك المادة لعملية الإنتاج.
