...
- **طباعة البطاقة** – عيّن هذا الخيار إلى **نعم** لطباعة بطاقة لوحة الترخيص عندما يستخدم العامل جهاز بطاقة الوظيفة للإبلاغ عن الانتهاء. يتم إعداد تكوين التسمية في توجيه المستند، كما هو موضح في [تخطيطات تسمية توجيه المستند](../warehousing/document-routing-layout-for-license-plates.md).
