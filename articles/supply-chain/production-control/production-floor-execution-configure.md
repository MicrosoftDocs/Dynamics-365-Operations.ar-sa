...
## <a name="turn-on-new-features-in-feature-management"></a>تشغيل ميزات جديدة في إدارة الميزات

يجب أن يتم تشغيل بعض الإعدادات الموضحة في هذا الموضوع على النظام قبل أن تصبح متاحة لك. استخدم صفحة [إدارة الميزات](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) لتشغيل أي من الميزات التالية أو كلها بحسب ما تحتاج إليه.
...
لجعل هذه الميزة متوفرة، يمكنك تشغيل الميزة التالية في [إدارة الميزات](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md):
