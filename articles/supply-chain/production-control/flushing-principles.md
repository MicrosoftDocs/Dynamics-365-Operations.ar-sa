...
> [!NOTE]
> لا يمكنك استخدام قاعده إنهاء المسح مع أصناف التخطيط. بدلاً من ذلك، نوصي باستخدام مبدأ بدء التنظيف. تحتوي عناصر التخطيط على نوع إنتاج *صنف التخطيط*,ويمكن فقط الإبلاغ عن المنتجات المساعدة والمنتجات الثانوية كمنتهية في أوامر الدُفعة التي تم إنشاؤها لعناصر التخطيط.
