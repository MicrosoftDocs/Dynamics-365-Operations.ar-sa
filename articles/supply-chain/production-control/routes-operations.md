...
- **القدرة** – تتضمن العملية الحسابية حقل **القدرة** من مورد العمليات. ونتيجة لذلك، يعتمد الوقت على الموارد. تمثل القيمة التي تم تحديدها في مورد العمليات القدرة بالساعة. يتم حساب **وقت المعالجة** بقسمة **كمية الطلب** على **القدرة**. قيمة السعة غير محددة بوحدة قياس معينة، وبالتالي لا يتم تحويلها استنادًا إلى الحقل **وحدة السعة**، والذي يعتبر فقط حقلاً وصفيًا لا يُستخدم في عمليات الحساب.
