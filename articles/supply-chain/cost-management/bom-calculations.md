...
description: تُعرف عمليات حساب زيادة التكلفة وسعر المبيعات بعمليات حساب قائمة مكونات الصنف (BOM)، ويمكنك أن تبدأها من صفحة عمليات الحساب. يوفر هذه المقال معلومات حول حسابات قائمة مكونات الصنف.
author: JennySong-SH
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902791"
---
# <a name="bom-calculations"></a>عمليات حساب BOM

[!include [banner](../includes/banner.md)]

تُعرف عمليات حساب زيادة التكلفة وسعر المبيعات بعمليات حساب قائمة مكونات الصنف (BOM)، ويمكنك أن تبدأها من صفحة عمليات الحساب. يوفر هذه المقال معلومات حول حسابات قائمة مكونات الصنف.
