...
description: يجيب هذا المقال عن بعض الأسئلة المتداولة حول تكلفة المخزون في Microsoft Dynamics 365 Supply Chain Management.
...
ms.locfileid: "9068382"
---
# <a name="inventory-costing-faq"></a>الأسئلة المتداولة حول تكلفة المخزون

[!include [banner](../includes/banner.md)]

يجيب هذا المقال عن بعض الأسئلة المتداولة حول تكلفة المخزون في Microsoft Dynamics 365 Supply Chain Management.
...
إذا كنت تعتقد أنك قد ترغب في استخدام ميزات عمليات إدارة المستودعات (WMS) في المستقبل ، فيجب عليك تمكين **استخدام عمليات إدارة المستودعات‬**. بعد حفظ مجموعة أبعاد التخزين، لن تتمكن بعد ذلك من تغيير إعداد الخيار **استخدام عمليات إدارة المستودعات‬** لها. إذا قررت استخدام عمليات إدارة المستودعات لاحقًا، فسيتعين عليك إنشاء مستودع جديد حيث تم تمكين الخيار. لا توجد عملية تلقائية يمكنك استخدامها لنقل كل المخزون من مستودع إلى مستودع آخر، أو لنسخ التكوينات ذات الصلة إلى مستودع جديد.

### <a name="can-i-enable-the-use-warehouse-management-processes-for-the-storage-dimension-group-even-if-im-not-planning-to-use-warehouse-management-processes-wms"></a>هل يمكنني تمكين استخدام عمليات إدارة المستودعات لمجموعة أبعاد التخزين حتى إذا لم أكن أخطط لاستخدام عمليات إدارة المستودعات (WMS)؟

نعم ، حتى إذا كنت لا تخطط لاستخدام ميزات عمليات إدارة المستودعات (WMS) ، يمكنك تمكين **استخدام عمليات إدارة المستودعات** لمجموعة أبعاد التخزين. لإنشاء الحركات ومعالجتها، سيتعين عليك إكمال الحد الأدنى من التكوين، مثل التدرجات الهرمية للحجز ومجموعات تسلسل الوحدات. ومع ذلك ، يتم تجاهل إعدادات WMS بشكل عام عند معالجة قوائم الانتقاء وإيصالات التعبئة وإيصالات المنتج يدويًا (على سبيل المثال، في صفحات أوامر المبيعات وأوامر الشراء).
...
الرقم إذا كانت مؤسستك تسمح للمخزون بأن يصبح سالبًا ماديًا، وكنت تستخدم المتوسط ​​المتحرك كنموذج المخزون، فسيستخدم النظام تسلسل التكلفة الاحتياطية المعين في صفحة **معلمات إدارة المخزون والمستودعات** لتحديد كيفية تعيين التكلفة لإصداراتك. بشكل عام، نوصي بتجنب السماح لمخزونك بأن يصبح سالبًا ماديًا. لمزيد من المعلومات، راجع الجدول الأسئلة الأخرى في القسم [المخزون السالب](#negative-inventory) في هذا المقال.
...
عادةً، قد تكون هناك مشكلة قبل الاستلام إما لأنك تسمح بالمخزون السالب المادي لمجموعة نماذج الأصناف أو لأن الإصدار قديم. لمزيد من المعلومات، راجع القسم [المخزون السالب](#negative-inventory) في هذا المقال.
