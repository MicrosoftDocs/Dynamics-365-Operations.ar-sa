...
description: يناقش هذا المقال المهام التي يجب إنجازها قبل تشغيل تحويل تكلفة معيارية.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
يناقش هذا المقال المهام التي يجب إنجازها قبل تشغيل تحويل تكلفة معيارية. 
