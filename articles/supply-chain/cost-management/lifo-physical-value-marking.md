...
يعكس متوسط سعر التكلفة‬ الحالي متوسط الحركات التي تم تحديثها ماليًا، 15.00 ر.س. تظهر الرسوم التوضيحية التالية آثار نموذج المخزون ما يرد أخيرًا يصرف أولاً (LIFO) على مجموعات الحركات هذه عند عدم استخدام خيار **تضمين القيمة الفعلية**. 
...
- تتحدد قيمة العملية المخزنية فوق (أو تحت) كل سهم رأسي، على أساس الكمية بسعر الوحدة.
...
![ما يرد أولاً يصرف أولاً (LIFO) مع وضع علامة.](./media/lifowithmarking.gif) 
