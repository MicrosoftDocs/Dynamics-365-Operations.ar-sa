...
description: يقدم هذا المقال نظرة عامة على أنواع الحركات التي تؤدي إلى زيادة كميات المخزون أو تقليلها.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
يقدم هذا المقال نظرة عامة على أنواع الحركات التي تؤدي إلى زيادة كميات المخزون أو تقليلها. 
