...
يعرض الجدول التالي النتائج عند استخدام نموذج البيانات وتكوين التقرير الموصوفين سابقًا في هذا الموضوع. (في تكوين هذا التقرير، تم تعيين حقل **المستوى** إلى *المجاميع*.)
...
يعرض الجدول التالي النتائج عند استخدامك لنماذج البيانات الموضحة سابقًا في هذا الموضوع، ولكنك قمت بتغيير قيمة حقل **المستوى** إلى *الحركات* في تكوين التقرير.
