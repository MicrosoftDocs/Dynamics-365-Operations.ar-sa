...
1. في مربع حوار **قيمة المخزون** الذي يظهر، قم بتعيين القيم التالية لتحديد السجلات التي سيتم تضمينها في التقرير:
    ...
    - في علامة التبويب السريعة **المعلمات**، أدخل اسمًا فريدًا للتقرير، واستخدم الحقول الموجودة في قسم **فتره التاريخ** لتحديد السجلات التي سيتم تضمينها في التقرير. لتحديد فترة التاريخ، يمكنك إما تحديد نطاق معد مسبقًا (يتعلق بتاريخ إنشاء التقرير) في حقل **‏‫كود الفاصل الزمني‬**، أو تحديد تواريخ معينة في حقول **من تاريخ** و**إلى تاريخ**. <!-- KFM: What is the ID setting for here? What do its values mean? -->
