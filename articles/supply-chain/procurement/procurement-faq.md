...
description: يوفر هذا المقال إجابات على الأسئلة المطروحة بشكل متكرر (FAQ) حول وظيفة التدبير في Supply Chain Management
...
ms.locfileid: "8869564"
---
# <a name="procurement-faq"></a>الأسئلة المتداولة حول التدبير

[!include [banner](../includes/banner.md)]

يوفر هذا المقال إجابات على الأسئلة المطروحة بشكل متكرر (FAQ) حول وظيفة التدبير في Supply Chain Management.
