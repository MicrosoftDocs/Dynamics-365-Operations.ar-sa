...
سيتم وصف الحالات بمزيد من التفصيل في أقسام لاحقة في هذا الموضوع.
...
**ملاحظة:** لتكوين قطاع عام، تتطلب أي تغييرات تطرأ على طلب عرض الأسعار الذي تم إرسالها استخدام عملية التعديل. عند إرسال طلب عرض الأسعار، يتم تأمين الحقول، لذا يعتبر النقر فوق **إنشاء** لاستخدام عملية التعديل كما هو موضح أعلاه خطوة إلزامية لإجراء تغييرات على طلب عرض الأسعار.
يخضع ذلك لمعلمة تأمين الحقل **تأمين RFQ‬ عند إرساله** في **محددات تحديد الموارد والتدبير‬**. يتم تعيين هذه المعلمة إلى **نعم**، وبالنسبة إلى تكوين قطاع عام تعتبر هذه القيمة افتراضية ولا يمكن تغييرها. هذا يعني أنه كلما كان من الممكن معالجة عملية التعديل يدويًا في تكوين قطاع غير عام، تعتبر عملية معالجة التعديلات عن طريق تأمين الحقول بعد إرسال طلب عرض الأسعار خطوة إلزامية للقطاع العام.
...
| إضافة مورد آخر.                | تم الإنشاء                      | إرسال (تم إرسال RFQ لمورد واحد فقط.) | تم الإنشاء                    | تم الإرسال                        |
...
في بعض الأحيان، يجب عليك تغيير طلب عرض الأسعار بعد إرساله. على سبيل المثال، يمكن أن يحدث ذلك إذا طرأ تغيير على تواريخ التسليم أو إذا أردت منتجات إضافية أو كميات مختلفة من المنتجات. ويمكنك تكوين عملية التعديل بحيث تكون أكثر تقييداً أو أقل تقييداً.  
...
يمكنك قبول بعض البنود في عطاء ورفض البعض الآخر. كما يمكنك قبول بنود من موردين مختلفين. يُرجى العلم أنك إذا قبلت بعض البنود، فستتم مطالبتك برفض كافة البنود الأخرى. ولذلك، إذا كنت تريد قبول البنود الأخرى، فيجب عليك النقر فوق **إلغاء** عند تلقي المطالبة.  
