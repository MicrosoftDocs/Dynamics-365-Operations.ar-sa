...
بعد الانتهاء من إضافة الرأس والبنود إلى أمر الشراء، يجب غالبًا إكمال خطوات إضافية قبل أن يصبح الأمر جاهزًا للتأكيد. نظرًا لتوفر الكثير من الخيارات، قد تجد أنه من المفيد استخدام [إجراء البحث](../../fin-ops-core/fin-ops/get-started/action-search.md) للبحث عن عنصر القائمة ذي الصلة.  
