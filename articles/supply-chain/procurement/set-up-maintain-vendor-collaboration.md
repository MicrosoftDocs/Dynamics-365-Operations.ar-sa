...
قبل إنشاء حساب مستخدم لشخص ما سيستخدم تعاون المورد، يجب إعداد المورد للسماح ليتمكن من استخدام تعاون الموردين. لمعرفة تفاصيل حول كيفية القيام بهذا، راجع [تعاون المورد مع موردين خارجيين‬‏‫](vendor-collaboration-work-external-vendors.md).
