...
Contoso هي شركة كبيرة تتطلب قواعد الشراء المعقدة للتحكم في عملية الطلب. ولقد حددت شركة Contoso قاعدتين للتدرج الهرمي مختلفتين للمؤسسات: إدارة ومراقبة المشتريات العامة.  
...
يعمل سامي في "مبيعات المملكة المتحدة – إدارة المبيعات في مكتب المملكة المتحدة التابع لشركة Contoso. وتسري السياسات الخاصة بكلٍّ من التدرجات الهرمية للمؤسسات لمراقبة المشتريات العامة والإدارة على إدارته. وعندما يقوم سامي بإنشاء طلب شراء، يجب أن يحدد النظام السياسة المُراد تطبيقها. يقوم مسؤول النظام بإعداد معلمات سياسة الشراء لتحديد سياسات سياسات الشراء التي يجب تطبيقها بالترتيب التالي للأسبقية:
