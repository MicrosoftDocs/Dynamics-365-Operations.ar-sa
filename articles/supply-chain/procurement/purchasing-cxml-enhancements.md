...
- **حالة إرسال الأمر** – بإمكان هذا الحقل أن يتضمن إحدى القيم التالية:
    ...
    - **متوقف‬‏‫** – تم وضع علامة _متوقف‬‏‫_ على المستند قبل إرساله. (لوضع علامة _متوقف‬‏‫_على مستند قبل إرساله، حدد **توقف** في جزء الإجراءات في صفحة **طلب الشراء**.)
