...
| البريد الإلكتروني للشخص المسؤول       | عنوان البريد الإلكتروني الذي سيتم استخدامه لإنشاء مستخدم جديد في Finance and Operations، والذي سيتم تسجيله في حساب Azure Active Directory (Azure AD) للمستأجر. |
