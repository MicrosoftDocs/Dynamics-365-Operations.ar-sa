...
description: يصف هذا المقال عملية إعداد موردين جدد. كما يشرح الإجراءات التي تتطلبها عدة أدوار أثناء هذه العملية.
...
4. **معالج تسجيل المورد** - يقوم الشخص المسؤول لدى المورد بتسجيل الدخول باستخدام حساب المستخدم الجديد. يقوم الشخص بإكمال معالج تسجيل مورد لتوفير معلومات مثل العناوين ومعلومات العمل، فئات التدبير والردود على الاستبيانات.
...
يتمثل الغرض من طلب مستخدم مورد متوقع في توفير الشخص الذي قام بإرسال الطلب الأولي، بحيث يمكنه تسجيل الدخول إلى Supply Chain Management عن طريق استخدام حساب البريد الإلكتروني الوارد في طلب تسجيل المورّد المتوقع.

تتم معالجة طلب المستخدم المورد المتوقع بواسطة سير عمل طلب المستخدم. يتواصل سير العمل هذا من خلال تعاون Azure AD B2B. وينشئ مستخدماً في Supply Chain Management الذي يحتوي على إعدادات الأمان المناسبة.
...
سوف يرى مستخدم المورّد المتوقع الذي قام بتسجيل الدخول إلى Supply Chain Management الصفحة الأولى من معالج تسجيل المورد، حيث يمكنه إدخال معلومات المورد.
...
| مراجعة معلقة             | إذا كان هناك عدة مراجعين في مهمة سير عمل، يمكن لمُراجع قبول مهمة مراجعة طلب مورّد، ثم إكمال المُراجعة إذا كان هناك مُراجع واحد فقط، يمكن لذلك المشترك إكمال المراجعة بتحديد **مكتمل** في إجراء سير العمل. فلا يُعد من الضروري أن يقبل عنصر العمل أولًا. |
