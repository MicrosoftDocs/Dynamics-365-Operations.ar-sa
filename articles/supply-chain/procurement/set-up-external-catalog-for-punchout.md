...
4. قم بتكوين كتالوج المورّد الخارجي باستخدام المتطلبات لموقع الكتالوج الخارجي الخاص بالمورّد. للحصول على مزيد من التفاصيل حول هذه المهمة، راجع [تكوين كتالوج المورد الخارجي ](#configure-the-external-vendor-catalog).
