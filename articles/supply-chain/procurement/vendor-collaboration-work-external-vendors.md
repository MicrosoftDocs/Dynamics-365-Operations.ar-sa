...
description: يشرح هذا المقال كيف يستطيع وكلاء الشراء التعاون مع الموردين الخارجيين لتبادل المعلومات حول أوامر الشراء ومخزون الشحن.
...
- **نشط (تم تأكيد أمر الشراء تلقائيًا)‬**- يتم تأكيد أوامر الشراء تلقائيًا عندما يقبلها المورد من دون إجراء تغييرات. إذا قمت باستخدام هذا الخيار، فتأكد من جدولة الوظيفة الدفعية *‏‫تأكيد أوامر الشراء المقبولة من تعاون المورد‬* المسؤولة عن معالجة التأكيدات. بالنسبة للتعليمات، راجع القسم التالي.
- **نشط (لم يتم تأكيد أمر الشراء تلقائيًا)‬**- يلزم تأكيد أوامر الشراء يدويًا من قبل المؤسسة، بعد أن يقبلها المورد.

### <a name="scheduling-the-auto-confirmation-batch-job"></a>جدولة الوظيفة الدفعية للتأكيد التلقائي

في حالة استخدام الخيار **‏‫نشط (تم تأكيد أمر الشراء تلقائيًا)‬** لواحد أو أكثر من الموردين (كما هو موضح في القسم السابق)، يجب جدولة الوظيفة الدفعية *‏‫تأكيد أوامر الشراء المقبولة من تعاون المورد‬*، والتي تعتبر مسؤولة عن معالجة نقاط البيع وتأكيدها. وإلا، فإن التأكيدات التلقائية لن تحدث أبدًا. استخدم الإجراء التالي لجدولة هذه الوظيفة.

1. انتقل إلى **التدبير والتوريد \> أوامر الشراء \> تأكيد أمر الشراء \> ‏‫تأكيد أوامر الشراء المقبولة من تعاون المورد‬**.
1. في مربع الحوار **‏‫تأكيد أوامر الشراء المقبولة من تعاون المورد‬**، في علامة التبويب السريعة **التشغيل في الخلفية**، حدد **التكرار**.
1. في مربع الحوار **تحديد التكرار**، حدد الجدول الذي يجب تشغيل الوظيفة عليه. عند اختيار الجدول الخاص بك، ضع في اعتبارك الأمور التالية:

    - إذا قام النظام بمعالجة حجم كبير من البيانات وقام بتشغيل العديد من الوظائف الدفعية، فقد يكون الأداء مشكلة. في هذه الحالة، قد ينبغي عليك عدم تشغيل هذه الوظيفة أكثر من مرة كل 10 دقائق (اعتمادًا على متطلباتك الأخرى). إذا لم يكن الأداء مشكلة لك، فيمكنك تشغيلها بشكل متكرر كل دقيقة إلى دقيقتين إذا لزم الأمر.
    - إذا كان الموردون لديك يقومون بتسليم البضائع بسرعة (خلال اليوم الذي وافقوا عليه)، فيجب تكرار التكرار (كل 10 إلى 30 دقيقة أو أكثر). بهذه الطريقة، سيتمكن موظفو المستودع من استلام البضائع مقابل أمر الشراء المؤكد بعد التأكيد.
    - إذا كان لدى الموردين مدة زمنية طويلة (أكثر من 24 ساعة)، فيمكنك تعيين هذه المهمة لتشغيلها مرة واحدة في اليوم أو ما شابه.

1. حدد **موافق** لتطبيق الجدول والعودة إلى مربع الحوار **‏‫تأكيد أوامر الشراء المقبولة من تعاون المورد‬**.
1. قم بتعيين خيارات الخلفية الإضافية حسب الحاجة. يوفر مربع الحوار الخيارات المعتادة لإعداد الوظائف الدفعية في Supply Chain Management.

لمزيد من المعلومات حول الوظائف الدفعية، راجع [نظرة عامة على المعالجة الدُفعية](../../fin-ops-core/dev-itpro/sysadmin/batch-processing-overview.md).
