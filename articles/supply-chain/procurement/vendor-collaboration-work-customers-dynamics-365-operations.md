...
description: يصف هذا المقال كيفية استخدام تعاون المورد، للتعامل مع أوامر الشراء ولمراقبة مخزون الشحن.
...
ms.locfileid: "8859158"
---
# <a name="vendor-collaboration-with-customers"></a>تعاون المورد مع العملاء

[!include [banner](../includes/banner.md)]

يصف هذا المقال كيفية استخدام تعاون المورد للتعامل مع العملاء في Microsoft Dynamics 365 Supply Chain Management. يستطيع الموردون إكمال سلسلة من العمليات التجارية من مساحات العمل التالية:
...
- **فوترة** -التعامل مع الفواتير. لا يغطي هذا المقال مساحة عمل **الفوترة**. لمزيد من المعلومات عن مساحة العمل هذه، راجع [مساحة عمل فوترة تعاون المورد](../../finance/accounts-payable/vendor-portal-invoicing-workspace.md).
...
- **أوامر الشراء للمراجعة** -تحتوي هذه الصفحة على نفس المعلومات التي تحتوي عليها قائمة **أوامر الشراء للمراجعة** في مساحة العمل. راجع الوصف السابق في هذا المقال.
...
- **‏‫فتح أوامر الشراء المؤكدة‬** -تحتوي هذه الصفحة على نفس المعلومات التي تحتوي عليها قائمة **‏‫فتح أوامر الشراء المؤكدة‬** في مساحة العمل. راجع الوصف السابق في هذا المقال.
