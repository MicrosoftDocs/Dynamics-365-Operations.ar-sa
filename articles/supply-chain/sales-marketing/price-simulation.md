...
>[!NOTE]
>عند إجراء محاكاة السعر، يتم استخدام عملة المبيعات الحالية فقط لإنشاء المحاكاة. ولكن عند عرض إجماليات عرض الأسعار، يتم عرض مجموعة من عملة الشركة وعملة المبيعات.  
