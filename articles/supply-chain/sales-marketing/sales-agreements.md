...
ms.locfileid: "1560107"
---
# <a name="sales-agreements"></a>اتفاقيات المبيعات
...
عندما يقوم عميل بإرجاع منتج تم طلبه وفقًا لاتفاقية بيع، بإمكان Microsoft Dynamics 365 for Finance and Operations العثور على التزام اتفاقية البيع المرتبطة وتحديثه تلقائيًا بحيث يعكس التغيير في الكمية أو المبلغ. يمكنك من خلال إنشاء أمر إرجاع يستند إلى أمر المبيعات الأصلي المرتبط باتفاقية المبيعات، إقامة علاقة بين التزام اتفاقية المبيعات وبند أمر المبيعات وفاتورة أمر الإرجاع.  
...
في بعض الحالات حيث يتم إنشاء أوامر المبيعات بطريقة غير مباشرة، على سبيل المثال، عند إنشاء إشعار دائن أو أوامر مبيعات بين الشركات الشقيقة، يمكنك التحكم في قيام Microsoft Dynamics 365 for Finance and Operations بالبحث تلقائيًا عن اتفاقيات البيع القابلة للتطبيق.
