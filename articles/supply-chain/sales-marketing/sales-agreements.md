...
description: توفر هذه المقالة معلومات حول اتفاقيات البيع. تمثل اتفاقية المبيعات عقدًا يلتزم فيه العميل بشراء منتجات بكمية محددة أو بمبلغ معين لمدة من الزمن مقابل أسعار وخصومات خاصة.
author: Henrikan
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8903829"
---
# <a name="sales-agreements-overview"></a>نظرة عامة على اتفاقيات البيع

[!include [banner](../includes/banner.md)]

توفر هذه المقالة معلومات حول اتفاقيات البيع. تمثل اتفاقية المبيعات عقدًا يلتزم فيه العميل بشراء منتجات بكمية محددة أو بمبلغ معين لمدة من الزمن مقابل أسعار وخصومات خاصة.
