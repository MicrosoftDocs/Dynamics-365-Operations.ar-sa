...
يوضح هذا المقال كيفية تحديث أمر مبيعات عند شحن المنتجات إلى العميل. ينطبق الدليل على تدفق الاستيفاء الذي لم يتم إعداده لإدارة المستودعات (لا عمليات إدارة المستودعات الأساسية أو عمليات إدارة المستودعات (WMS)) ، وبالتالي لا يتطلب انتقاء المنتج ليتم تسجيله قبل الشحن. يمكنك تنفيذ هذا الإجراء في البيانات الخاصة بك أو في شركة بيانات العرض التوضيحي USMF. في الحالتين، قبل أن تبدأ هذه المهمة، أنشئ أمر مبيعات لمنتج مسجل في المخزون كميته أكبر من 1. لتجنب حدوث خطأ في الترحيل، يجب عليك أن تتأكد من أن كمية المنتج الفعلية في الموقع والمستودع التي حددتها في الأمر تغطي كمية الأمر.
