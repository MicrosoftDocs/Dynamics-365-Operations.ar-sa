...
description: يشرح هذا المقال كيفية حساب عمولة المبيعات وتسجيلها.
author: Henrikan
ms.date: 08/06/2019
...
ms.locfileid: "8862500"
---
# <a name="register-sales-commissions"></a>تسجيل عمولات المبيعات

[!include [banner](../../includes/banner.md)]

يشرح هذا المقال كيفية حساب عمولة المبيعات وتسجيلها. يمكنك تنفيذ هذا الإجراء في شركة بيانات العرض التوضيحي USMF أو باستخدام بياناتك الخاصة. قبل تشغيل هذا الدليل، قم بتشغيل الدليل المُسمى "إعداد قواعد عمولات المبيعات" للتأكد من وجود توفر إعداد حساب العمولات الضروري بالكامل.
