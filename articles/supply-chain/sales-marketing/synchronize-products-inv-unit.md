...
يستند القالب المستخدم **منتجات Field Service مع وحدة المخزون (Finance and Operations إلى Field Service)** إلى القالب **منتجات Field Service (Finance and Operations إلى Field Service)**. للحصول على مزيد من المعلومات، راجع [منتجات Field Service (Finance and Operations إلى Field Service)](field-service-product.md).

يصف هذا الموضوع الاختلافات بين القالبين فقط: 
- **منتجات Field Service مع وحدة المخزون (Finance and Operations إلى Sales)**
- **منتجات Field Service (Finance and Operations إلى Field Service)** 
