...
تستهدف الحملة جهات الاتصال الخاصة بالعملاء المتوقعين والعملاء المحتملين وفرص المبيعات والعملاء الذين تم اختيارهم للمشاركة في الحملة. في Microsoft Dynamics 365 for Finance and Operations، يمكنك إنشاء أنواع متعددة من الحملات، مثل حملات التسويق الهاتفي والحملات البريدية وحملات البريد الإلكتروني، لتحقيق أقصى قدر من الاستفادة من العملاء المتوقعين. ومع التقدم الحاصل في حملتك وتلقي ردود إيجابية، يمكنك بدء عملية المبيعات مع المستلمين الذين أبدوا ردود فعل إيجابية على الحملة.
