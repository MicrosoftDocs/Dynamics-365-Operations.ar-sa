...
description: يناقش هذا المقال القوالب والمهام الأساسية التي يتم استخدامها لمزامنة عمليات تحويل وتسوية المخزون من Dynamics 365 Supply Chain Management إلى Dynamics 365 Field Service.
author: Henrikan
ms.date: 04/30/2019
ms.topic: article
ms.prod: ''
...
يناقش هذا المقال القوالب والمهام الأساسية التي يتم استخدامها لمزامنة عمليات تحويل وتسوية المخزون من Dynamics 365 Supply Chain Management إلى Dynamics 365 Field Service.
...
[![تعيين القالب في تكامل البيانات، تعديل المخزون (Field Service إلى Supply Chain Management): تعديل المخزون.](./media/FSAdj1.png)](./media/FSAdj1.png)
...
[![تعيين القالب في تكامل البيانات، تحويل المخزون (Field Service إلى Supply Chain Management): تحويل المخزون.](./media/FSTrans1.png)](./media/FSTrans1.png)
