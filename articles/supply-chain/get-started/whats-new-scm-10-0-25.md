...
| التدبير وتحديد الموارد | تعطيل زر إعادة تعيين توزيع طلب الشراء | تعمل هذه الميزة على تعطيل الزر **إعادة تعيين** في صفحة **التوزيع المحاسبي** لطلبات الشراء قيد المراجعة. |
...
| Warehouse management | تعطيل عمليات الاستلام المتوقعة من أوامر الجودة التي تقوم بأخذ عينة من المخزون المحظور | تمنع هذه الميزة النظام من إنشاء حركات الاستلام المتوقعة لأوامر الجودة التي تأخذ عينة من المخزون بحالة الحظر. لأن المخزون المحظور غير متاح، ستزيل هذه الميزة عمليات الاستلام المتوقعة. يساعد هذا في التأكد من أن المخزون لا ينتهي به الأمر بحالات حظر متعددة، مما قد يؤدي إلى مشكلات في تكامل البيانات. |
...
| --- | --- | --- |
| إدارة الأصول | تطبيق القواعد لتجميع أوامر العمل أثناء تشغيل خطة الصيانة | متوفرة بشكل عام |
| إدارة الأصول | تحسينات الصيانة القائمة على العداد | متوفرة بشكل عام |
| إدارة التكلفة | مستوى حساب التكلفة | متوفرة بشكل عام |
| إدارة التكلفة | تمكين إعداد رقم الدُفعة المعرف من قِبَل المستخدم لعكس إقفال المخزون | متوفرة بشكل عام |
| إدارة التكلفة | تفاصيل تقدم إقفال المخزون | متوفرة بشكل عام |
| إدارة التكلفة | خيارات الأبعاد المالية الافتراضية لإعادة تقييم التكلفة القياسية للمخزون | متوفرة بشكل عام |
| إدارة التكلفة | تنظيف بيانات تقرير قيمة المخزون | قيد التشغيل بشكل افتراضي |
| إدارة التكلفة | ‏‫مساحة تخزين تقارير قيمة المخزون | قيد التشغيل بشكل افتراضي |
| إدارة التكلفة | إظهار سجل إقفال المخزون في الشبكة | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | تمكين إدارة التغيير على المنتجات الحالية | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | إدارة التغيير الهندسي | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | إخطارات هندسية لمسؤولي الإنتاج | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | وراثة سمات محسنة لإدارة التغيير الهندسي | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | إدارة التغييرات في المعادلات ومكوناتها | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | فحوصات جاهزية المنتج | قيد التشغيل بشكل افتراضي |
| إدارة التغيير الهندسي | إنشاء متغيرات للمنتجات الهندسية | قيد التشغيل بشكل افتراضي |
| إدارة المخزون والمستودعات | التنقل إلى إصدار BOM من بنود BOM | إلزامي |
| التخطيط الرئيسي | تأكيد الأوامر المجمعة وأوامر التعبئة المخططة ودمجها بطريقة دُفعية. | متوفرة بشكل عام |
| التخطيط الرئيسي | تخطيط الموارد مع الصيانة | متوفرة بشكل عام |
| التخطيط الرئيسي | تمكين ميزات معالج إعداد الخطة الرئيسية | إلزامي |
| التخطيط الرئيسي | تحديد نموذج التنبؤ في تفاصيل التنبؤ بالطلب | إلزامي |
| التخطيط الرئيسي | مرئيات تقدم التخطيط الرئيسي | إلزامي |
| التخطيط الرئيسي | التأكيد المتوازي للأوامر المخططة | إلزامي |
| التخطيط الرئيسي | تأكيد الأوامر المخططة بواسطة التصفية | قيد التشغيل بشكل افتراضي |
| التخطيط الرئيسي | طرق العرض المحفوظة للأوامر المخططة | قيد التشغيل بشكل افتراضي |
| التدبير وتحديد الموارد | تعطيل زر إعادة تعيين توزيع طلب الشراء | متوفرة بشكل عام |
| التدبير وتحديد الموارد | تمكين إعادة تعيين عمليات سير العمل ذات الصلة بالتدبير | متوفرة بشكل عام |
...
| التدبير وتحديد الموارد | السماح للموردين بالتطبيق على فئات التدبير من خلال تعاون المورد | قيد التشغيل بشكل افتراضي |
...
| التدبير وتحديد الموارد | الطرف المسؤول عن اتفاقية الشراء | قيد التشغيل بشكل افتراضي |
| التدبير وتحديد الموارد | طرق العرض المحفوظة لأوامر الشراء | قيد التشغيل بشكل افتراضي |
| إدارة معلومات المنتج | التحقق المُقيد من صحة كميات الأمر الافتراضية | إلزامي |
...
| إدارة معلومات المنتج | تحسينات صفحة اقتراحات المتغيرات | قيد التشغيل بشكل افتراضي |
...
| التحكم بالإنتاج | تمكين إنشاء رقم لوحة الترخيص عند الإبلاغ عن الانتهاء في ‏‫جهاز بطاقة الوظيفة‬ بشكل تلقائي. | إلزامي |
...
| التحكم بالإنتاج | ميزة قفل جهاز بطاقة العمل ومحطة بطاقة العمل بحيث يمكن تنظيفهما. | إلزامي |
| التحكم بالإنتاج | تحسينات على مربعات حوار وظائف الموافقة والتحويل | إلزامي |
| التحكم بالإنتاج | لوحة الترخيص للإبلاغ عند الانتهاء والمضافة إلى ‏‫جهاز بطاقة الوظيفة‬ | إلزامي |
| التحكم بالإنتاج | طباعة التسمية من جهاز بطاقة الوظيفة | إلزامي |
| التحكم بالإنتاج | التنفيذ في طابق الإنتاج | إلزامي |
| التحكم بالإنتاج | وظيفة إدارة الأصول لواجهة التنفيذ في طابق الإنتاج | قيد التشغيل بشكل افتراضي |
| التحكم بالإنتاج | بحث عن وظيفة لواجهة تنفيذ صالة الإنتاج‬ | قيد التشغيل بشكل افتراضي |
| التحكم بالإنتاج | تجاوز حجز الإنتاج الافتراضي | قيد التشغيل بشكل افتراضي |
| التحكم بالإنتاج | إظهار لوحة ترخيص المستخدم، والرقم التسلسلي، ورقم الدُفعة بالكامل في واجهة تنفيذ طابق الإنتاج‬ | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | تحسين أداء تفاصيل أمر المبيعات | متوفرة بشكل عام |
...
| المبيعات والتسويق | سياسة حذف أمر المبيعات إلى سطر أمر الشراء | إلزامي |
| المبيعات والتسويق | سياسة تصدير البيانات المرجعية لعرض أسعار المبيعات | إلزامي |
| المبيعات والتسويق | تحسين تصدير كيان بيانات جهة الاتصال‬ | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | تمكين البحث عن حقلي مقدمة وخاتمة مستند عرض أسعار المبيعات | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | تحسين أداء تقرير "أفضل 100" عميل | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | إعادة حساب رصيد العميل المقدر | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | تسجيل سطر أمر إرجاع المبيعات بالدقة العشرية مع وزن التعبئة وبدونه | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | طرق العرض المحفوظة للمبيعات والتسويق | قيد التشغيل بشكل افتراضي |
| المبيعات والتسويق | تأكيد أمر المبيعات بنقرة واحدة | قيد التشغيل بشكل افتراضي |
| Warehouse management | قوالب توزيع البضائع مع توجيهات المواقع | متوفرة بشكل عام |
| Warehouse management | تعطيل عمليات الاستلام المتوقعة من أوامر الجودة التي تقوم بأخذ عينة من المخزون المحظور | متوفرة بشكل عام |
| Warehouse management | سجل استلام لوحة الترخيص | متوفرة بشكل عام |
| Warehouse management | تقريب الكميات لأسفل إلى أقرب وحدة مبيعات عند الإصدار إلى المستودع | متوفرة بشكل عام |
...
| Warehouse management | استخدام واجهة برمجة تطبيقات أسرع لإقفال/إعادة فتح الحاويات في محطة التعبئة | متوفرة بشكل عام |
| Warehouse management | تحقق من صحة من القوالب المحددة لمهام التزويد | متوفرة بشكل عام |
...
| Warehouse management | تغيير حالة مخزون الأصناف التي يتم التحكم فيها بواسطة أبعاد التعقب | إلزامي |
| Warehouse management | تغيير وعاء العمل في العمل | إلزامي |
| Warehouse management | وضع نظام المجموعة ممتلئ | إلزامي |
| Warehouse management | ميزة ‏‫نظام مجموعة التخزين | إلزامي |
| Warehouse management | التأكيد والتحويل | إلزامي |
| Warehouse management | تأكيد الشحنات الخارجية من الوظائف الدفعية | إلزامي |
| Warehouse management | التحكم في عرض صفحة ملخص الاستلام على الأجهزة المحمولة | إلزامي |
| Warehouse management | المعالجة المؤجلة لعملية حركة المخزون اليدوية | إلزامي |
| Warehouse management | لا تسمح بإنشاء أحمال عمل لا تتطابق مع متطلبات قوالب إنشاء حمل عمل الموجة | إلزامي |
| Warehouse management | تخطيطات تسميات لوحات الترخيص المحسّنة | إلزامي |
| Warehouse management | تقييم جميع الإجراءات لتوجيهات مواقع وحدة SKU المتعددة | إلزامي |
...
| Warehouse management | ‏‫تحديد موضع لوحة ترخيص الموقع | إلزامي |
| Warehouse management | خلط أبعاد المنتج في الموقع | إلزامي |
...
| Warehouse management | منع استخدام ألواح الترخيص المشحونة لأمر تحويل في مستودعات أخرى غير مستودع الوجهة | إلزامي |
| Warehouse management | المطالبة بحل أسماء "الموقع/لوحة الترخيص" الملتبسة | إلزامي |
| Warehouse management | فحص الجودة | إلزامي |
| Warehouse management | إعدادات المستخدم والأيقونات وعناوين الخطوات لتطبيق المستودع الجديد | إلزامي |
| Warehouse management | مناطق مواقع إضافية | قيد التشغيل بشكل افتراضي |
| Warehouse management | إنشاء أوامر تحويل ومعالجتها من تطبيق المستودع | قيد التشغيل بشكل افتراضي |
| Warehouse management | تمكين التحقق السريع للأجهزة المحمولة للمستودع | قيد التشغيل بشكل افتراضي |
| Warehouse management | استخدام موقع دمج الأصناف | قيد التشغيل بشكل افتراضي |
| Warehouse management | الحد الأقصى لوقت التنفيذ لوظيفة تنظيف المستودعات المتاحة لإدارة المستودعات | قيد التشغيل بشكل افتراضي |
| Warehouse management | مرئيات حمل العمل الصادر | قيد التشغيل بشكل افتراضي |
| Warehouse management | معالجة أحداث تطبيق المستودع | قيد التشغيل بشكل افتراضي |
| Warehouse management | طريقة العرض المحفوظة لمنضدة عمل تخطيط الحمل | قيد التشغيل بشكل افتراضي |
| Warehouse management | طريقه العرض المحفوظة لصفحة تفاصيل العمل | قيد التشغيل بشكل افتراضي |
| Warehouse management | طريقة العرض المحفوظة لمعالجة الموجة | قيد التشغيل بشكل افتراضي |
| Warehouse management | طرق العرض المحفوظة لمعالجة الحمل | قيد التشغيل بشكل افتراضي |
| Warehouse management | طرق العرض المحفوظة لمعالجة الشحن | قيد التشغيل بشكل افتراضي |
| Warehouse management | تفاصيل وظيفة الدفعة للموجة | قيد التشغيل بشكل افتراضي |
| Warehouse management | إخطارات تنفيذ الموجة | قيد التشغيل بشكل افتراضي |
