...
description: تصف هذه المقالة الميزات الجديدة أو المتغيرة في 10.0.15. Dynamics 365 Supply Chain Management.
author: kamaybac
ms.date: 10/13/2020
ms.topic: article
ms.prod: ''
...
يصف هذا المقالا الميزات الجديدة أو المتغيرة في إصدار 10.0.15 من Microsoft Dynamics 365 Supply Chain Management. رقم بنية هذا الإصدار هي 10.0.644، وهو يتوفر كما يلي
...
- أداره وحده مقياس السحابة والحافة باستخدام أحمال التصنيع وتنفيذ المستودع<br> - لمزيد من المعلومات ، راجع [قياس الوحدات في الطوبولوجيا المختلطة الموزعة](../cloud-edge/cloud-edge-landing-page.md).
...
يتضمن الإصدار 10.0.15 من Microsoft Dynamics 365 Supply Chain Management تحديثات النظام الأساسي. لمعرفة المزيد، راجع [تحديثات النظام الأساسي للإصدار 10.0.15 من تطبيقات التمويل والعمليات (أكتوبر 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-15.md).

### <a name="bug-fixes"></a>إصلاح الأخطاء

للحصول على معلومات حول إصلاحات الأخطاء المضمنة في كل تحديث من التحديثات التي تعد جزءًا من 10.0.15، قم بتسجيل الدخول إلى Lifecycle Services (LCS) وعرض [مقالة قاعدة المعارف](https://fix.lcs.dynamics.com/Issue/Details?bugId=514518&dbType=3&qc=8fbe12733a7e1aa197e91fb11530f69fa89b9b39c08d89a19873f755c9430988).
