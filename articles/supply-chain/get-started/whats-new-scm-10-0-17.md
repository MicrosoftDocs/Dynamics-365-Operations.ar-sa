...
description: تصف هذه المقالة الميزات الجديدة أو المتغيرة في 10.0.17. Dynamics 365 Supply Chain Management.
author: kamaybac
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
...
يصف هذا المقالا الميزات الجديدة أو المتغيرة في إصدار 10.0.17 من Microsoft Dynamics 365 Supply Chain Management. رقم بنية هذا الإصدار هي 10.0.761، وهو يتوفر كما يلي
...
- [توزيع الموجة المتوازي](/dynamics365-release-plan/2021wave1/finance-operations/dynamics365-supply-chain-management/parallel-wave-allocation)<br> - لمزيد من المعلومات، راجع [توزيع الموجات](../warehousing/wave-allocation-method.md).
...
يتضمن الإصدار 10.0.17 من Microsoft Dynamics 365 Supply Chain Management تحديثات النظام الأساسي. لمعرفة المزيد، راجع [تحديثات النظام الأساسي للإصدار 10.0.17 من تطبيقات التمويل والعمليات (أبريل 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-17.md).
