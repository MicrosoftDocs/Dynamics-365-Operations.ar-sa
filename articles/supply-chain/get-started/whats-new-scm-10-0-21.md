...
**رسالة تحذير:** فشل تنفيذ البرنامج النصي [SetupDiagnostics] ضد VM

النشر ستعمل على الرغم من التحذير، ومع ذلك، قد تحدث المشكلات المعروفة التالية في Lifecycle Services ‏(LCS):
...
| المخزون&nbsp;و&nbsp;اللوجستيات | [مسح الرموز الشريطية في المستودع باستخدام معايير تنسيق GS1](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/scan-barcodes-warehouse-using-gs1-format-standards) | *قريبًا*<!-- KFM: Add doc link when ready. --> |
| المخزون&nbsp;و&nbsp;اللوجستيات | العطاءات المغلقة <!-- KFM: Add RP link when available --> | *قريبًا*<!-- KFM: Add doc link when ready. --> |
...
| المخزون&nbsp;و&nbsp;اللوجستيات | [إرشادات خطوة تطبيق المستودع](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/warehouse-management-mobile-app-step-instructions) | *قريبًا*<!-- KFM: Add doc link when ready --> |
...
| التخطيط الرئيسي | (معاينة) دعم MRP المدفوع بالأولوية لتحسين التخطيط | تتيح ميزة معاينة تحسين التخطيط التخطيط الرئيسي الذي يتم توجيهه من خلال أولوية التخطيط باستخدام نقطة إعادة الطلب. تتضمن التغييرات المميزة: حقل **أولوية التخطيط** في بنود أمر التوريد، وخطوط أمر الشراء، وتوقعات الطلب، والأوامر المخططة؛ وخيار كود تغطية جديد؛ حقل **تغطية الصنف** لنقطة إعادة الطلب؛ نماذج إعداد التخطيط الرئيسي للتحكم في إعداد أولوية التخطيط؛ وتخطيط منطق حساب التحسين لتعيين واحترام أولوية التخطيط. |
