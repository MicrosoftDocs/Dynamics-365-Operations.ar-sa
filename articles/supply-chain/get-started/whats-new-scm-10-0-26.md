...
| Warehouse management | المحلل المحسن لرموز GS1 الشريطية | تضيف هذه الميزة محللًا محسّنًا لبيانات رمز GS1. يقوم المحلل اللغوي الجديد بتنفيذ خوارزمية المواصفات العامة GS1 لتحليل رموز GS1 ويوفر تحققًا أقوى للبيانات. |
...
يتضمن الإصدار 10.0.26 من Microsoft Dynamics 365 Supply Chain Management تحديثات النظام الأساسي. لمعرفة المزيد، راجع [تحديثات النظام الأساسي للإصدار 10.0.26 من تطبيقات التمويل والعمليات (مايو 2022)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-26.md).<!-- KFM Confirm link -->
