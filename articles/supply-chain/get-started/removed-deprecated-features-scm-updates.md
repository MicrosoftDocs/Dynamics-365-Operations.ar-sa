...
| **الحالة**                         | مهملة. بحلول 1 إبريل 2022، لن يتم دعم سيناريوهات التصنيع لمحرك التخطيط الرئيسي المضمّن في Supply Chain Management. اعتبارًا من ذلك التاريخ، ستوقف Microsoft جميع عمليات التطوير النشطة في سيناريوهات التصنيع لمحرك التخطيط الضمّن، ولن تصدر أي ميزات جديدة، وستصدر فقط إصلاحات الأخطاء الهامة. بعد هذا التاريخ، يجب على جميع الشركات التي تتطلب دعمًا لسيناريوهات التصنيع استخدام "تحسين التخطيط" لحسابات التخطيط الرئيسية لديها. من المتوقع أن يدعم تحسين التخطيط سيناريوهات التصنيع بشكل كامل بحلول أكتوبر 2022. لمزيد من المعلومات، راجع [نظرة عامة حول التخطيط الرئيسي المهمل](../master-planning/deprecated-master-planning-overview.md).<br><br>قد تواصل الشركات التي لديها عمليات نشر محلية لـ Supply Chain Management استخدام محرك التخطيط الرئيسي المضمّن لسيناريوهات التصنيع بعد أبريل 2022. ومع ذلك، لن يتم توفير المزيد من تحسينات الميزات. |
