...
description: يشرح هذا المقال كيفية إنشاء صفقات إدارة الخصومات. تستخدم العروض للتحكم في الأساليب والقواعد المختلفة لحساب الخصومات والعوائد. وتتضمن قواعد لتضمينات واستثناءات.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8851583"
---
# <a name="rebate-management-deals"></a>صفقات إدارة الخصومات

[!include [banner](../includes/banner.md)]

تستخدم صفقات إدارة الخصومات للتحكم في الأساليب والقواعد المختلفة لحساب الخصومات والعوائد. وتتضمن قواعد لتضمينات واستثناءات. هناك ثلاثة أنواع من الصفقات لإدارة الخصومات: خصومات العميل وعوائد العميل وخصومات المورد. تستخدم الأنواع الثلاثة إعدادات مشابهه. يشير هذا المقال إلى الاختلافات التي يوجد بها.
...
بالنسبة لكل بند في الصفقة، يجب إعداد تفاصيل في علامة التبويب السريع **تفاصيل إدارة الخصومات**. حدد أولاً بند الصفقة في علامة التبويب السريع **إدارة الخصومات**. ثم قم بعد ذلك بتعيين قيم لبند الصفقة هذا باستخدام علامات التبويب المتعددة في علامة التبويب السريع **تفاصيل إدارة الخصومات**. تصف الأقسام الفرعية التالية كيفيه استخدام كل علامة تبويب.

### <a name="settings-on-the-general-tab"></a>الإعدادات في علامة التبويب عام

تتيح علامة التبويب **عام** في علامة التبويب السريع **تفاصيل إدارة الخصومات** لك إعداد أسلوب الحساب والأساس لبند الصفقة المحدد. ويتحكم هذا الإعداد فيما إذا كان الحد الأدنى للمشتريات مطلوبا، وملفات تعريف الترحيل المرتبطة ببند الصفقة، وتفاصيل الحساب. يصف الجدول التالي الحقول المتوفرة.‬

| الحقل | الوصف |
|---|---|
| أسلوب الحساب | حدد الطريقة المطلوب استخدامها عند دمج بند الصفقة المحدد ببنود الصفقة الأخرى (*متدرج* أو *تراكمي* أو *دوارة* أو *الإجمالي*). يمكن ان تؤثر قيمه هذا الحقل بشكل مفاجئ علي نتيجة حسابات الخصم. للحصول علي وصف كامل لكل أسلوب والامثله التي تظهر كيفيه تاثيره علي حساب الخصم، راجع قسم [أساليب الحساب لبنود الصفقة](#calc-methods) لاحقًا في هذا المقال. |
