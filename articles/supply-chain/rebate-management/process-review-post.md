...
بدلاً من معالجة صفقات أو خطوط صفقات محددة، يمكنك استخدام *منضدة عمل الخصم* لمعالجة صفقات متعددة في نفس الوقت. يمكنك اختياريا تطبيق عوامل تصفيه السجل و/أو اعداد جدوله متكررة. ليس عليك تحديد أي صفوف. سيقوم النظام بمعالجة كافة البنود التي تفي بمتطلبات التاريخ والتصفية التي قمت بإعدادها.
