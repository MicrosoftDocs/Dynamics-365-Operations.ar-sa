...
عند العمل مع المنتجات في صالة الإنتاج‬ أو في مستودع في Microsoft Dynamics ERP أو Microsoft Dynamics CRM، يجب أن يكون لديك استراتيجية جيدة لتحديد تلك المنتجات ومتغيرات المنتج.

## <a name="unique-product-numberproduct-id"></a>رقم المنتج/معرف المنتج الفريد

في Microsoft Dynamics 365 for Finance and Operations، المعرف الأساسي لمنتج هو رقم المنتج (بمعنى معرف المنتج الفريد). يمكن إنشاء هذا الرقم تلقائيًا من خلال تسلسل رقمي، أو يمكن إقرانه يدويًا باستخدام أحد المنتجات. بالنسبة لمتغيرات المنتج، يمكن تحديد الأرقام من خلال قالب مصطلحات المنتج.

في معظم الحالات، لا يتم إنشاء رقم المنتج أصلاً في Finance and Operations. بدلاً من ذلك، يتم إقرانه بمنتج في نظام إدارة دورة حياة منتج (PLM) أو نظام إدارة بيانات منتج (PDM). في هذه الحالة، يمكنك استخدام كيانات البيانات لاستيراد المنتجات ومتغيرات المنتجات. يستخدم Finance and Operations بعد ذلك الأرقام في جميع العمليات.

عند استخدامك Finance and Operations، يجب أن تُولي اهتمامًا خاصًا لاستراتيجيتك الخاصة بأرقام المنتجات. يُحسّن نظام ترقيم جيد اللوجستيات التي تتدفق ويساعد على منع الأخطاء. يحتوي معرف المنتج الجيد على 15 حرفًا كحد أقصى. وبشكل مثالي، يحتوي على أقل من 10 أحرف ويتضمن أكثر من خمسة أحرف تصنيف. يمكنك أيضًا استخدام أسماء البحث لتمكين عمليات البحث السريع. اسم البحث هو اسم إضافي يمثل تصنيفات أحد المنتجات.

عند استخدامك Common Data Service‏ (CDS)، يكون رقم المنتج في Finance and Operations هو أيضًا رقم المنتج في CDS. تتم مزامنة متغيرات المنتجات مع CDS كمنتجات مميزة.

## <a name="item-number-and-product-dimensions"></a>رقم الصنف وأبعاد المنتجات

رقم الصنف هو معرف المنتج الذي يستخدمه أحد الكيانات القانونية المحددة. وبشكل مثالي، يجب أن يكون رقم الصنف مطابقًا لرقم المنتج. إذا اختلفت المصطلحات لكل كيان قانوني، فإنه يصبح من الصعب متابعة منتج في سلسلة توريد، وتنتج عمليات إعادة التسمية والإرجاع المتعبة. للتوافق مع الإصدارات الأقدم (أي مع Microsoft Dynamics AX 2009 والإصدارات السابقة)، قمنا بالاحتفاظ بهذا النموذج. ومع ذلك، نوصي بالتخلص من المعرفات الخاصة بالكيانات القانونية عند الاستطاعة، واستخدام رقم فريد للمنتج باعتباره المعرف الأساسي بدلاً من ذلك.
...
يوفر Finance and Operations اسم بحث ثانويًا للمنتجات وكذلك للأصناف (المنتجات الصادرة). لا يلزم أن يكون اسم البحث هذا فريدًا، ويمكن تغييره بعد إنشاء منتج أو متغير منتج. نوصي باستخدام اسم البحث للبحث عن المنتجات حسب الفئات. تقوم أسماء البحث بتمكين البحث السريع، خاصةً في المبيعات وعمليات الشراء.
...
في صفحة **أوصاف الأصناف الخارجية**، يمكنك إقران رقم صنف العميل أو المورد بمنتج صادر. يجب تنفيذ هذا الإقران لكل كيان قانوني. يمكن الحصول على المعلومات التالية. لسوء الحظ، التسميات مضللة قليلاً في الإصدار الحالي من Finance and Operations. ومع ذلك، قد يمكن تغيير هذه التسميات في إصدار مستقبلي.
...
إذا كان العديد من العملاء أو الموردين يستخدمون نفس أرقام الصنف (كما هو موضح في حالة إقران شراء أو مجموعة بيع بالتجزئة مثلاً)، فيمكنك إنشاء مجموعات العملاء أو الموردين لتبسيط عملية الاحتفاظ بمعلومات المنتجات الخارجية.
...
في Finance and Operations، من المستحسن أن تحتفظ بـ GTIN ككود شريطي. ومع ذلك، يمكنك أيضًا الاحتفاظ به في صفحة **الصنف - GTIN**. لفتح هذه الصفحة، في صفحة **المنتجات الصادرة**، في علامة التبويب **إدارة المخزون**، في مجموعة **المستودع**، حدد **أكواد GTIN**. لاحظ أن GTIN غير محتفظ به كرقم عمومي. بدلاً من ذلك، فإنه يتم الاحتفاظ به بواسطة كيان قانوني.

في Finance and Operations، يمكنك تحديد متغيرات التعبئة في عمليات المستودع عن طريق تحديد وحدات قياس محددة. على سبيل المثال، قد يتم تخزين أحد الأصناف في أجزاء، في حزم من ستة، أو في أدراج عددها 18، أو في نقالات كاملة. سيتم تحديد وحدة قياس محددة لكل متغير من متغيرات التعبئة هذه. نظرًا لأن GTIN مرتبط بوحدة التعبئة لمنتج ما، تتيح لك صفحة **الصنف - GTIN** الاحتفاظ بأكواد GTIN متعددة لكل منتج ووحدة قياس. ومع ذلك، لا يمكنك استخدام نفس كود GTIN أكثر من مرة واحدة لأصناف أو متغيرات منتجات مختلفة لكيان قانوني.
