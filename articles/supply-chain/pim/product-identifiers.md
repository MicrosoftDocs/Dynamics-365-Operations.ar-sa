...
في Microsoft Dynamics 365 for Finance and Operations، المعرّف الأساسي للمنتج هو رقم المنتج (أي المعرّف الفريد للمنتج). يمكن إنشاء هذا الرقم تلقائيًا من خلال تسلسل رقمي، أو يمكن إقرانه يدويًا باستخدام أحد المنتجات. بالنسبة لمتغيرات المنتج، يمكن تحديد الأرقام من خلال قالب مصطلحات المنتج.
...
عندما تستخدم Common Data Service (CDS)، يكون رقم المنتج في Finance and Operations هو أيضًا رقم المنتج في CDS. تتم مزامنة متغيرات المنتجات مع CDS كمنتجات مميزة.
