...
description: يوضح هذا المقال كيفية تعقب المنتجات المحددة كبضائع ذات استخدام مزدوج وأرقام شهادات المتجر لكل منتج مرتبط وبلد الوجهة وطباعة أرقام الشهادات الصالحة في الفواتير ذات الصلة وإيصالات التعبئة و/أو أوامر المبيعات.
author: t-benebo
ms.date: 07/15/2020
ms.topic: article
ms.prod: ''
...
5. عندما تؤكد أمر المبيعات، يحدد النظام المعلومات التالية:
...
يوضح هذا المقال كيفيه تكوين كافة الإعدادات المطلوبة لإعداد بضائع الاستخدام المزدوج ودعم هذا السيناريو.
...
> [!NOTE]
>
> يقوم النظام باجراء العمليات المزدوجة التالية عند إنشاء تاكيد المبيعات:
>
> 1. هل يشمل الطلب أي سلع ذات استخدام مزدوج؟
> 1. إذا كان الأمر كذلك ، فهل تتطلب دولة الوجهة شهادات ذات استخدام مزدوج؟
> 1. إذا كان الأمر كذلك ، فهل توجد شهادات لكل سلعة ذات استخدام مزدوج لبلد الوجهة ، وهل هذه الشهادات صالحة لتواريخ الشحن المؤكدة؟
> 1. إذا كانت إجابات الاسئله 1 و 2 هي "نعم" وكانت الاجابه علي السؤال 3 هي "لا" ، فعندئذ يعرض النظام تحذيرا لاعلام المستخدم بان الشهادات التي تستخدم الاستخدام الثنائي مفقوده لواحد أو أكثر من السلع المزدوجة التي تستخدم في أمر التوريد. ويجب علي المستخدم الحصول علي الشهادات المطلوبة والمحاولة مره أخرى ، ولكن يمكن بدلا من ذلك تعمل التحذير ومتابعه تاكيد المبيعات إذا رغبت في ذلك.
