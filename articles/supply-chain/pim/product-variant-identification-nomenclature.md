...
description: يصف هذا المقال كيف يمكنك إعداد nomenclature رقم المنتج لاستبدال التنسيق الثابت [رقم أصل المنتج - التكوين - الحجم - اللون - النمط].
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
