...
description: يوفر هذا المقال معلومات حول الكيانات المختلفة التي يمكن استخدامها لاستيراد وتصدير بيانات المنتج.
author: t-benebo
ms.date: 01/07/2020
ms.topic: article
ms.prod: ''
...
| الصنف - اقتران الكود الشريطي | `EcoResProductBarcodeAssociationEntity` | يُستخدم هذا الكيان لتصدير المنتجات والأكواد الشريطية‬. وهو يسمح بتعقب التغييرات والتحديثات والحذف. لاستخدام الكيان، يجب ان يتم تمكين الميزة *تحسينات الصنف والكود الشريطي* في [أداره الميزات](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md). مفتاح الكيان الخاص به هو `AssociationID`، والذي يقوم بإنشاء الاقتران بين الكود الشريطي والمنتج. لإضافة دعم لهذا المفتاح، سيتم ملء الجدول `InventitemBarcodeAssociation` لبيانات الرمز الشريطي للأصناف الموجودة عند تشغيل الميزة. يتم ملء الجدول باستخدام وظيفة دُفعية وإذا كان جدول الرموز الشريطية لديك يحتوي على عدد كبير من السجلات، فقد يستغرق الأمر وقتًا طويلاً لتشغيل وظيفة المجموعة. التالي ، نوصي بالتخطيط لتمكين الميزة (التالي تشغيل وظيفة المجموعة) في الوقت الذي يناسب جدول الاعمال الخاص بك. |
