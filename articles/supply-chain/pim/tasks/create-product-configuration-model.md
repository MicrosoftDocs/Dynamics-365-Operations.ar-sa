...
1. في حقل **إستراتيجية الحلول**، حدد خيارًا.
...
1. حدد **موافق**.
1. في حقل **إعادة استخدام التكوينات**، حدد خيارًا.
...
1. قم بتوسيع قسم **السمات**.
2. حدد **إضافة**.
3. في القائمة، قم بوضع علامة للصف المحدد.
4. في الحقل **الاسم**، اكتب قيمة.
5. في حقل **اسم الحل**، أدخل قيمة.
    * يُستخدم اسم الحل بواسطة أداة حل القيود لمكون المنتج. يجب أن لا تتضمن مسافات أو أحرف خاصة ما عدا _ (الشرطة السفلية).  
6. في حقل **الوصف**، اكتب قيمة.
    * يُعرض نص الوصف لمستخدم تكوين ومن ثم يعمل كمساعدة في تحديد قيمة السمة المناسبة.  
7. في حقل **نوع السمة**، أدخل قيمة أو حددها.
...
1. قم بتوسيع قسم **المكونات الفرعية**.
2. حدد **إضافة**.
3. في القائمة، قم بوضع علامة للصف المحدد.
4. في الحقل **الاسم**، اكتب قيمة.
5. في حقل **اسم الحل**، أدخل قيمة.
6. في حقل **الوصف**، اكتب قيمة.
7. في حقل **المكون**، أدخل قيمة أو حددها.
...
8. حدد **حفظ**.
9. حدد **تفاصيل بند قائمة مكونات الصنف**.
...
17. في حقل **حسب السلسلة**، أدخل رقمًا.
18. حدد **موافق**.
