...
description: يصف هذا المقال كيفية إنشاء منتج مشترك جديد.
author: t-benebo
ms.date: 07/22/2019
...
يصف هذا المقال كيفية إنشاء منتج مشترك جديد. عادة ما يتم تنفيذها عن طريق مصمم المنتج. شركة بيانات العرض التوضيحي التي تم استخدامها لإنشاء هذه المهمة هي USMF.‬
