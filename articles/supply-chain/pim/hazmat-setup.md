...
description: يوضح هذا المقال كيفية إعداد البيانات المطلوبة لتصنيف الأصناف كمواد خطرة. عند إنشاء أمر توريد يتضمن صنفًا تم تصنيفه كمادة خطرة، يقوم النظام بإنشاء وثائق مادية خطرة لأمر التوريد هذا عند شحنه.
author: t-benebo
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
