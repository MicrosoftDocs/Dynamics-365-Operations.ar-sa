...
description: يشرح هذا المقال طريقة إعداد مستودع باستخدام قالب تكوين مستودع.
author: yufeihuang
ms.date: 11/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9070428"
---
# <a name="set-up-a-warehouse-by-using-a-warehouse-configuration-template"></a>إعداد مستودع باستخدام قالب تكوين مستودع

[!include [banner](../includes/banner.md)]

يشرح هذا المقال طريقة إعداد مستودع باستخدام قالب تكوين مستودع. هناك العديد من قوالب التكوين المعرفة مسبقاً التي يمكنك استخدامها. لمزيد من المعلومات حول كيفية استخدام هذه القوالب، راجع [قوالب بيانات التكوين](../../fin-ops-core/dev-itpro/data-entities/configuration-data-templates.md).
...
يركز هذا المقال على أول هذه السيناريوهات. حيث يشرح هذا السيناريو كيفية استخدام قالب تكوين لنسخ إعداد تكوين من بيئة اختبار إلى بيئة إنتاج.
