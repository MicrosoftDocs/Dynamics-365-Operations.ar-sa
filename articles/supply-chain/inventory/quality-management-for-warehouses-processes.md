...
description: يقدم هذا المقال معلومات حول ميزة إدارة الجودة لعمليات المستودع. تعمل هذه الميزة على توسيع قدرات إدارة الجودة وتتيح للمستخدمين تكامل عناصر التحكم لأخذ عينات الأصناف في عملية الاستلام في المستودع باستخدام إدارة المستودعات المتقدمة.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
|---|---|---|---|---|---|---|
| الأمر | لوحة ترخيص كاملة | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم _(مؤمن/غير قابل للتحرير)_</p> | لا | 3 | <p>**كميه سطر الأمر: 100 EA**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 20 EA</p><p>أمر الجودة 1 لـ 20 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP2<p>عمل أمر الشراء لـ 20 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP3<p>عمل أمر الشراء لـ 20 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 20 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP5<p>عمل أمر الشراء لـ 20 EA (الإبعاد)</p></li></ol> |
| الأمر | كمية ثابتة = 1 | ‏‏نعم | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP2<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP3<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 20 EA, LP5<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li></ol> |
| الأمر | النسبة المئوية = 10 | لا | <p>الموقع: لا</p><p>لوحة الترخيص: لا</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100 EA**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 50 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 10 EA</p><p>أمر الجودة 1 لـ 10 EA</p><p>عمل أمر الشراء لـ 40 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 50 EA, LP2<p>عمل أمر الشراء لـ 50 EA (الإبعاد)</p></li></ol> |
| الحمولة | النسبة المئوية = 5 | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: لا</p><p>لوحة الترخيص: لا</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 500 EA**</p><p>**حمولتان: الحمولة الأولى 200 EA، الحمولة الثانية 300 EA**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للحمولة الأولى لـ 100 EA<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 95 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للحمولة الأولى لـ 100 EA<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 95 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للحمولة الثانية لـ 300 EA<p>عمل لأخذ عينات أصناف الجودة لـ 15 EA</p><p>أمر الجودة 1 لـ 15 EA</p><p>عمل أمر الشراء لـ 285 EA (الإبعاد)</p></li></ol> |
| الترتيب | النسبة المئوية = 10 | نعم | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 50 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 50 EA, LP2<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 (الإبعاد)</p></li></ol> |
| تحميل | لوحة ترخيص كاملة | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم _(مؤمن/غير قابل للتحرير)_</p> | لا | 3 | <p>**صنفان:**</p><ul><li>**كميه سطر الأمر للصنف A: 120 EA (4 بالتات)**</li><li>**كميه سطر الأمر للصنف B: 90 EA (3 بالتات)**</li></ul><p>**سطور حمولة، حمولتان، مع كل سطر أمر**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP2<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP3<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر B, 30 EA, LP5<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر B, 30 EA, LP6<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP7<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li></ol> |
| تحميل | لوحة ترخيص كاملة | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم _(مؤمن/غير قابل للتحرير)_</p> | ‏‏نعم | 3 | <p>**صنفان:**</p><ul><li>**كميه سطر الأمر للصنف A: 120 EA (4 بالتات)**</li><li>**كميه سطر الأمر للصنف B: 90 EA (3 بالتات)**</li></ul><p>**سطور حمولة، حمولتان، مع كل سطر أمر**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP2<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP3<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر B, 30 EA, LP5<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر B, 30 EA, LP6<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 30 EA, LP7<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li></ol> |
| تحميل | النسبة المئوية = 10 | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: لا</p><p>لوحة الترخيص: لا</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100 EA**</p><p>**لم يتم إنشاء أية حمولات. تطبيق نطاق الأمر.**</p><ol><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 50 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق إدارة المستودع للأجهزة المحمولة للعنصر A, 50 EA, LP2<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 EA (الإبعاد)</p></li></ol> |

عند قيام أحد العاملين بالتحقق من صحة أحد أوامر الجودة المعروض في الجدول السابق، يقوم النظام تلقائيًا بإنشاء عمل أمر الجودة لنقل المخزون من موقع مراقبة الجودة إلى الموقع المحدد في التوجيه الخاص بالموقع لنوع أمر العمل لـ _أمر الجودة_. يمكنك إعداد أي موقع لهذا الغرض، مثل موقع الإرجاع أو التخزين، وفقا لنتيجة الاختبار الخاصة بأمر الجودة. للحصول على مثال لهذا الإعداد، راجع [سيناريو المثال](#example-scenario) في نهاية هذا المقال.
