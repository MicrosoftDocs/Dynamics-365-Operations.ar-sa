...
![![كيانات إدارة الجودة](media/quality-management-entity-diagram.png "كيانات إدارة الجودة")](media/quality-management-entity-diagram.png "Quality management entities")
...
1. قم بإنشاء فئات عمل منفصلة لأنواع أوامر العمل لـ _أخذ عينات صنف الجودة_ و _أمر الجودة_. بهذه الطريقة، يمكنك التأكد من إنشاء العمل المناسب تلقائيًا استنادًا إلى نوعي أوامر العمل، وأنه يمكن تشغيل هذا العمل باستخدام تطبيق Warehousing.
...
|---|---|---|---|---|---|---|
| الأمر | لوحة ترخيص كاملة | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم _(مؤمن/غير قابل للتحرير)_</p> | لا | 3 | <p>**كميه سطر الأمر: 100 EA**</p><ol><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 20 EA</p><p>أمر الجودة 1 لـ 20 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP2<p>عمل أمر الشراء لـ 20 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP3<p>عمل أمر الشراء لـ 20 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 20 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP5<p>عمل أمر الشراء لـ 20 EA (الإبعاد)</p></li></ol> |
| الأمر | كمية ثابتة = 1 | ‏‏نعم | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100**</p><ol><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP2<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP3<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 20 EA, LP5<p>عمل لأخذ عينات أصناف الجودة لـ 1 EA</p><p>أمر الجودة 1 لـ 1 EA</p><p>عمل أمر الشراء لـ 19 EA (الإبعاد)</p></li></ol> |
| الأمر | النسبة المئوية = 10 | لا | <p>الموقع: لا</p><p>لوحة الترخيص: لا</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100 EA**</p><ol><li>تسجيل الإيصال في تطبيق المستودع لـ 50 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 10 EA</p><p>أمر الجودة 1 لـ 10 EA</p><p>عمل أمر الشراء لـ 40 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 50 EA, LP2<p>عمل أمر الشراء لـ 50 EA (الإبعاد)</p></li></ol> |
| تحميل | النسبة المئوية = 5 | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: لا</p><p>لوحة الترخيص: لا</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 500 EA**</p><p>**حمولتان: الحمولة الأولى 200 EA، الحمولة الثانية 300 EA**</p><ol><li>تسجيل الإيصال في تطبيق المستودع للحمولة الأولى لـ 100 EA<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 95 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للحمولة الأولى لـ 100 EA<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 95 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للحمولة الثانية لـ 300 EA<p>عمل لأخذ عينات أصناف الجودة لـ 15 EA</p><p>أمر الجودة 1 لـ 15 EA</p><p>عمل أمر الشراء لـ 285 EA (الإبعاد)</p></li></ol> |
| الأمر | النسبة المئوية = 10 | لا | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100**</p><ol><li>تسجيل الإيصال في تطبيق المستودع لـ 50 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 50 EA, LP2<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 (الإبعاد)</p></li></ol> |
| تحميل | لوحة ترخيص كاملة | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم _(مؤمن/غير قابل للتحرير)_</p> | لا | 3 | <p>**صنفان:**</p><ul><li>**كميه سطر الأمر للصنف A: 120 EA (4 بالتات)**</li><li>**كميه سطر الأمر للصنف B: 90 EA (3 بالتات)**</li></ul><p>**سطور حمولة، حمولتان، مع كل سطر أمر**</p><ol><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP2<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP3<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر B, 30 EA, LP5<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر B, 30 EA, LP6<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP7<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li></ol> |
| تحميل | لوحة ترخيص كاملة | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: نعم</p><p>لوحة الترخيص: نعم _(مؤمن/غير قابل للتحرير)_</p> | ‏‏نعم | 3 | <p>**صنفان:**</p><ul><li>**كميه سطر الأمر للصنف A: 120 EA (4 بالتات)**</li><li>**كميه سطر الأمر للصنف B: 90 EA (3 بالتات)**</li></ul><p>**سطور حمولة، حمولتان، مع كل سطر أمر**</p><ol><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP2<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP3<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP4<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر B, 30 EA, LP5<p>عمل لأخذ عينات أصناف الجودة لـ 30 EA</p><p>أمر الجودة 1 لـ 30 EA</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر B, 30 EA, LP6<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع للعنصر A, 30 EA, LP7<p>عمل أمر الشراء لـ 30 EA (الإبعاد)</p></li></ol> |
| تحميل | النسبة المئوية = 10 | نعم _(مؤمن/غير قابل للتحرير)_ | <p>الموقع: لا</p><p>لوحة الترخيص: لا</p> | لا | غير قابل للتطبيق | <p>**كميه سطر الأمر: 100 EA**</p><p>**لم يتم إنشاء أية حمولات. تطبيق نطاق الأمر.**</p><ol><li>تسجيل الإيصال في تطبيق المستودع لـ 50 EA, LP1<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 EA (الإبعاد)</p></li><li>تسجيل الإيصال في تطبيق المستودع لـ 50 EA, LP2<p>عمل لأخذ عينات أصناف الجودة لـ 5 EA</p><p>أمر الجودة 1 لـ 5 EA</p><p>عمل أمر الشراء لـ 45 EA (الإبعاد)</p></li></ol> |
...
تم الآن إنشاء أمر شراء لكمية مقدارها 10 من الصنف A0001 للمورد 104. بعد ذلك يتم تسجيل بند أمر شراء بكمية 10 كمستلم على إحدى لوحات الترخيص باستخدام تطبيق المستودع. فيما يلي النتيجة:
...
1. انتقل إلى جهاز محمول أو محاكي يقوم بتشغيل تطبيق المستودع، ثم قم بتسجيل الدخول إلى المستودع 51 باستخدام *51* كمعرف المستخدم و *1* ككلمة المرور.
...
1. تسجيل الخروج من تطبيق المستودع.
