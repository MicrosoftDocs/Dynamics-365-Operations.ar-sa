...
يصف هذا الموضوع كيفية استخدام إدارة الجودة في Microsoft Dynamics 365 for Finance and Operations للمساعدة في تحسين جودة المنتج في سلسلة التوريد.

ويمكن أن تساعدك إدارة الجودة في إدارة تنظيم أوقات الإنتاج عندما تتعامل مع المنتجات غير المتوافقة، بغض النظر عن نقطة الأصل. ولأن أنواع التشخيص مرتبطة بالإبلاغ عن التصحيحات، بإمكان Microsoft Dynamics 365 for Finance and Operations جدولة المهام لحل المشاكل ومنع تكرارها.
