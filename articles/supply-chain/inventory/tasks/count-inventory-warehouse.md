...
description: يصف هذا المقال عملية إنشاء دفتر يومية جرد مخزون وترحيله لجرد صنف معين في موقع في المستودع.
author: yufeihuang
ms.date: 07/09/2019
...
ms.locfileid: "8870626"
---
# <a name="count-inventory-in-a-warehouse"></a>جرد المخزون في مستودع

[!include [banner](../../includes/banner.md)]

يصف هذا المقال عملية إنشاء دفتر يومية جرد مخزون وترحيله لجرد صنف معين في موقع في المستودع. وينطبق الإجراء على وظيفة "التخزين الأساسي"، المتوفرة في الوحدة النمطية "إدارة المخزون"، وليس على وظيفة التخزين المتوفرة في الوحدة النمطية "إدارة المستودع". يمكنك استعراض هذا الإجراء في شركة بيانات العرض التوضيحي USMF، أو باستخدام البيانات الخاصة بك. إذا كنت تستخدم البيانات الخاصة بك، فتأكد من إعداد المنتجات والمواقع، وتأكد أنك قد أنشأت اسم دفتر يومية لدفاتر يومية الجرد. يتم تنفيذ جرد المخزون عادة بواسطة موظف مستودع.
