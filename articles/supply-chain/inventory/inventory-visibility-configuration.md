...
| *onHandIndexQueryPreloadBackgroundService* | تتيح هذه الميزة إمكانية التحميل المسبق للاستعلامات الموجودة في رؤية المخزون لتجميع قوائم فعلية ذات أبعاد محددة مسبقًا. ويكون تكرار المزامنة الافتراضي هو مرة كل 15 دقيقة. لمزيد من المعلومات، راجع [تحميل مسبق لاستعلام على الكمية الفعلية المبسطة](inventory-visibility-power-platform.md#preload-streamlined-onhand-query). |
