---
title: أوامر الجودة
description: يصف هذا المقال كيفيه إنشاء أوامر الجودة يدويا أو تلقائيا، وكيفيه العمل معها لاجراء عمليات الفحص وتسجيل نتائج الاختبار في Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857768"
---
# <a name="quality-orders"></a>أوامر الجودة

[!include [banner](../includes/banner.md)]

يصف هذا المقال كيفيه إنشاء أوامر الجودة يدويا أو تلقائيا، وكيفيه العمل معها لاجراء عمليات الفحص وتسجيل نتائج الاختبار في Microsoft Dynamics 365 Supply Chain Management.
...
1. حدد **جديد**.
1. في مربع الحوار **أوامر الجودة**، في حقل **نوع المرجع**، حدد مرجع المخزون الذي سيرتبط أمر الجودة الخاص بك به. للحصول علي وصف لأنواع المراجع المتاحة للتحديد، راجع قسم [أنواع مرجع أمر الجودة](#ref-types) لاحقا في هذا المقال.
...
لإنشاء أوامر الجودة يدويًا وعرض جميع أوامر الجودة الحالية، انتقل إلى **إدارة المخزون \> المهام الدورية \> إدارة الجودة \> أوامر الجودة**. توفر الأقسام المتبقية من هذا المقال مزيدا من المعلومات حول كيفيه العمل مع صفحة **أوامر الجودة**.
