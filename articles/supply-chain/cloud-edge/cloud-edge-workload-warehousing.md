...
لا يتم حاليا دعم أية أنواع معالجة أخرى للمستندات المصدر أو عمل المستودع على وحدات القياس. على سبيل المثال، بالنسبة إلى حمل عمل تنفيذ المستودع على وحدة مقياس، لا يمكنك تنفيذ عملية استلام أمر التحويل (إيصال التحويل)؛ بدلاً من ذلك، يجب أن تتم معالجة هذا بواسطة مثيل المركز.
...
| <p>كافة عمليات warehouse management الأخرى المرتبطة بالإنتاج، بما في ذلك:</p><li>إصدار إلى المستودع</li><li>معالجة موجة الإنتاج</li><li>انتقاء المواد الخام</li><li>تخزين كانبان</li><li>انتقاء كانبان</li><li>الخردة من الإنتاج</li><li>البالتة الأخيرة للإنتاج</li><li>تسجيل استهلاك المواد</li><li>قيمة كانبان فارغة</li></ul> | نعم | لا |
