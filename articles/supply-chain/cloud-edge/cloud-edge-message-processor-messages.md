...
description: يوفر هذا المقال معلومات حول ميزة رسائل معالج الرسائل لأحمال عمل وحدة القياس.
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''
...
عند تشغيل طوبولوجيا مختلطة موزعة‬ مع وحدات القياس، يتم إلغاء وظيفة دفعة *معالج الرسائل* تلقائيًا عند إنشاء رسالة جديدة للمعالجة، لذا لن تحتاج إلى جدولة هذه الوظيفة يدويًا.
