...
لاتباع السيناريو النموذجي الذي تم توفيره في هذا الموضوع، يجب أولا إعداد الميزة وذلك بجعل بيانات العرض التوضيحي متوفرة وأضافه بعض السجلات المخصصة.

قبل ان تحاول القيام بأي من التمرينات الموجودة في بقية هذا الموضوع، اتبع الإرشادات الموجودة في كافة الأقسام الفرعية التالية. تقوم هذه الأقسام الفرعية أيضا بتقديم العديد من صفحات الإعدادات الهامه التي ستستخدمها عند إعداد أداره التغييرات الهندسية للمؤسسة الخاصة بك.
