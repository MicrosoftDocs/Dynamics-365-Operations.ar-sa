...
يمكنك أيضًا تطبيق عمليات التحقق من الاستعداد على المنتجات القياسية (غير الهندسية). لمزيد من المعلومات، راجع القسم [عمليات فحص الاستعداد على المنتجات القياسية](#standard-products) لاحقًا في هذا الموضوع.
