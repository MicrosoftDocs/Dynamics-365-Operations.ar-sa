...
| مجموعة أبعاد المنتجات | يساعدك اعداد **تعقب الإصدارات في الحركات** علي تحديد النوع الفرعي للمنتج. إذا قمت بتوضيح انك تريد تتبع الإصدار في الحركات ، سيتم عرض مجموعات ابعاد المنتجات التي يتم استخدام بعد *الإصدار* فيها. وإلا لن يتم عرض سوي مجموعات ابعاد المنتجات حيث لا يتم استخدام بعد *الإصدار*. |
...
استخدم حقل **سياسة جاهزيه المنتجات** لتحديد سياسة الجاهزية التي يتم تطبيقها علي المنتجات التي تنتمي إلى هذه الفئة. لمزيد من المعلومات، راجع [استعداد المنتج](product-readiness.md).
