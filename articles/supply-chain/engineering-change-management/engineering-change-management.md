...
> [!IMPORTANT]
> يتوفر الزر **إخطار الإنتاج** فقط إذا كانت ميزة *الإخطارات الهندسية للإنتاج* قيد التشغيل في النظام الخاص بك. للحصول على التعليمات، راجع [نظرة عامة على إدارة التغييرات الهندسية](product-engineering-overview.md).
...
> [!IMPORTANT]
> تتطلب القدرة على إرسال إخطارات لأوامر الإنتاج تشغيل ميزة *الإخطارات الهندسية للإنتاج* في النظام لديك. للحصول على التعليمات، راجع [نظرة عامة على إدارة التغييرات الهندسية](product-engineering-overview.md).
