...
### <a name="evaluate-the-business-impact-of-a-change-request"></a>تقييم تاثير العمل لطلب تغيير

عند مراجعه طلب تغيير ، يمكنك البحث عن التبعيات. وبهذه الطريقة ، يمكنك تقييم تاثير التغيير المطلوب في الحركات المفتوحة ، مثل أوامر التوريد وأوامر الإنتاج والمخزون الفعلي.
...
1. في حاله العثور علي المشكلة التي تتطلب أحد التغييرات لتكون حرجه، يمكنك حظر الحركات المفتوحة أو اعلام المستخدم المسؤول عن طريق استخدام الأزرار الموجودة علي شريط الادوات في مربع الحوار **التاثيرات التجارية للحركات المفتوحة**.
...
- بالنسبة لأوامر التغيير الهندسية في **شركه هندسية** ، يمكنك عمل تغييرات أساسيه علي البيانات الهندسية. علي سبيل المثال ، يمكنك إنشاء إصدارات جديده لأحد المنتجات ، وتغيير بنيه المنتج من خلال قائمة مكونات الصنف، وتغيير قيم السمات الهندسية. بالنسبة لكل منتج من المنتجات المتاثره ، حدد أحدي القيم التالية في الحقل **التاثير**:
    ...
    - **منتج جديد** -إنشاء متغير جديد أو منتج جديد بالكامل يستند إلى إصدار المنتج المحدد.
