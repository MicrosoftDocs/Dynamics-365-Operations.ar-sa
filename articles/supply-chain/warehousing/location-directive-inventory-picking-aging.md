...
description: يوضح هذا المقال كيفية استخدام استراتيجيات توجيهات الموقع ما يرد أولاً يصرف أولاً (FIFO) وما يرد أخيرًا يصرف أولاً (LIFO) أثناء الانتقاء.
author: Mirzaab
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
1. *حالة موقع المستودع* (اعتبارًا من الإصدار 10.0.29 ، هذه الميزة إلزامية ولا يمكن إيقاف تشغيلها. لمزيد من المعلومات، راجع [حالة موقع المستودع](warehouse-location-status.md).
...
1. في الجهاز المحمول أو في تطبيق *Dynamics 365 Supply Chain Management - التخزين* على جهاز الكمبيوتر، اتبع الخطوات التالية لإزالة المخزون الحالي من موقع المستودع لدعم السيناريوهات التالية:
