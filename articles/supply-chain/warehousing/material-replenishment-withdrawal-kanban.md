...
description: يصف هذا المقال كيفية استخدام كانبان السحب لتزويد المواد لأنشطة التصنيع.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863697"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>التزويد بحلول كانبان للسحب

[!include [banner](../includes/banner.md)]

يصف هذا المقال كيفية استخدام كانبان السحب لتزويد المواد لأنشطة التصنيع.
