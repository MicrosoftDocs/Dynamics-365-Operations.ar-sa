...
## <a name="turn-on-the-planned-cross-docking-feature"></a>تشغيل ميزة توزيع البضائع المخططة

لكي تتمكن من استخدام توزيع البضائع المخطط، يجب تشغيل الميزة في النظام. بإمكان المسؤولين استخدام مساحة عمل [إدارة الميزات](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) للتحقق من حالة الميزة وتشغيلها إذا كانت مطلوبة. هناك، يتم إدراج الميزة بالطريقة التالية:

- **الوحدة:** *إدارة المستودعات*
- **اسم الميزة:** *توزيع البضائع المخطط*
