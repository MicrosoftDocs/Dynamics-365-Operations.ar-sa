---
title: تكوين الحقول لتطبيق Warehouse Management للأجهزة المحمولة
description: يصف هذا المقال كيفية تحديد أسماء وأولويات الحقول المعروضة في تطبيق إدارة المستودع للأجهزة المحمولة وتكوينها.
author: Mirzaab
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
