...
## <a name="configure-warehousing-app-field-names"></a>تكوين أسماء الحقول في تطبيق المستودع
...
## <a name="configure-warehousing-app-field-priority"></a>تكوين أولوية الحقل في تطبيق المستودع
