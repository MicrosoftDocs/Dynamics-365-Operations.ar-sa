...
---
# <a name="license-plate-receiving-via-the-warehousing-mobile-app"></a>استلام لوحة الترخيص‬ عبر تطبيق المستودع للأجهزة المحمولة

يوضح هذا الموضوع كيفية إعداد تطبيق المستودع للأجهزة المحمولة‬ بحيث يدعم استخدام عملية استلام لوحة الترخيص لاستلام المخزون الفعلي.
