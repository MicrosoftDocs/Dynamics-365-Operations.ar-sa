...
لإعداد تزويد يعتمد على المنطقة، يجب تكوين العديد من أجزاء النظام. يقدم هذا القسم الإعدادات المختلفة ويوفر قيم البيانات التوضيحية التي يمكنك إدخالها إذا كنت تريد العمل بالسيناريو الموجود في نهاية هذا المقال.
...
يوضح هذا المثال كيفية تجهيز أكواد التوجيه. إذا كنت تخطط للعمل بالسيناريو الموجود في نهاية هذا المقال، فاستخدم قيم البيانات التوضيحية المتوفرة هنا. خلاف ذلك، استخدم القيم الخاصة بك.
...
يوضح هذا المثال كيفية تجهيز قالب التزويد. إذا كنت تخطط للعمل بالسيناريو الموجود في نهاية هذا المقال، فاستخدم قيم البيانات التوضيحية المتوفرة هنا. خلاف ذلك، استخدم القيم الخاصة بك.
...
لإعداد بيانات العرض التوضيحي بحيث يمكن استخدامها في السيناريو في نهاية هذا المقال، يجب إنشاء موجهي موقع: واحد للانتقاء وآخر للوضع.
...
قبل البدء في العمل خلال السيناريو، يجب تنشيط بيانات العينة وإعداد الميزة كما هو موضح في هذا القسم وفي الأقسام السابقة من هذا المقال.

#### <a name="use-the-usmf-legal-entity"></a>استخدام الكيان القانوني USMF

للعمل بالسيناريو باستخدام السجلات والقيم النموذجية المحددة هنا، يجب أن تكون في نظام تم فيه تثبيت [بيانات العرض التوضيحي](../../fin-ops-core/fin-ops/get-started/demo-data.md) القياسية. بالإضافة إلى ذلك، يجب أن تحدد الكيان القانوني **USMF** قبل البدء.

#### <a name="prepare-additional-sample-data"></a>تجهيز نموذج بيانات إضافي

بعد تحديد الكيان القانوني **USMF**، أضف بيانات المثال الإضافية المطلوبة، كما هو موضح في قسم [إعداد التزويد المعتمد على المنطقة](#setup) الموضح سابقًا في هذا المقال.
