...
---
# <a name="warehouse-work-policies-overview"></a>نظرة عامة على سياسات عمل المستودع

[!include [banner](../includes/banner.md)]

تتحكم سياسات عمل المستودع فيما إذا كان عمل المستودع ينشأ نتيجة عمليات المستودع في التصنيع، استنادًا إلى نوع أمر العمل وموقع المخزون والمنتج.
