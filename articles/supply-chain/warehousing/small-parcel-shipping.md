...
يوضح هذا المثال كيفيه إعداد SPS واستخدامها بعد إعداد النظام كما هو موضح سابقا في هذا الموضوع. يستخدم هذا السيناريو محرك معدل السعر التجريبي المذكور مسبقا.
...
1. إذا لم تكن قد قمت بالفعل بإعداد تعريف طابعه ZPL، فاستخدم تطبيق عامل توجيه المستند لإعداده. لمزيد من المعلومات، راجع [نظره عامه حول طباعه المستند](../../fin-ops-core/dev-itpro/analytics/print-documents.md) والمواضيع ذات الصله.
