...
description: يصف هذا الموضوع الوظيفة التي تجعل المعالجة المؤجلة لعمليات الوضع في عمل المستودع المتوفرة في Microsoft Dynamics 365 for Finance and Operations.
author: josaw1
manager: AnnBe
ms.date: 06/17/2019
ms.topic: article
...
يصف هذا الموضوع الوظيفة التي تجعل المعالجة المؤجلة لعمليات الوضع في عمل المستودع متوفرة في Microsoft Dynamics 365 for Finance and Operations.
...
يمكن تعيين سياسة إنشاء العمل في معلمات إدارة المستودع. كما يمكن تعيينه على مستوى المستودعات الفردية. في حاله تعيين سياسة إلى مستودع، يتم تطبيقها فقط على العمل الذي تم إنشاؤه لذلك المستودع. إذا لم يتم تعيين أي سياسة على مستوى المستودع، فسيتم تطبيق السياسة من معلمات إدارة المستودع.
...
- **مهام معالجة الوضع المؤجل الفاشلة** – يُظهر هذا الإطار المتجانب عدد المهام الفاشلة. في حاله وجود مهام فاشلة، يترتب على مدير المستودع إما إعادة معالجتها أو إلغائها، لأنه لن تتم إعادة معالجتها تلقائيًا.
