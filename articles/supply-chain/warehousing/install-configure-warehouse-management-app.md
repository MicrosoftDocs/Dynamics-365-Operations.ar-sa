...
يجب أن تجعل الشهادة متاحة محليًا على كل جهاز يتم فيه تشغيل تطبيق إدارة المستودع للأجهزة المحمولة. لمزيد من المعلومات حول كيفية إدارة الشهادات في الأجهزة المتحكم فيها بواسطة Intune إذا كنت تستخدم Intune، فراجع [استخدام الشهادات للمصادقة في Microsoft Intune](https://docs.microsoft.com/mem/intune/protect/certificates-configure).
...
1. في مربع الحوار **اعداد الاتصال**  حدد **أضافه من ملف** أو **أضافه من شفره QR**، وفقا للطريقة التي تريد بها استيراد الإعدادات:
    ...
    ![قائمه اعداد الاتصال](media/app-configure-connection-setup-flyout.png "قائمه اعداد الاتصال")
