...
ms.locfileid: "6773047"
---
# <a name="wave-creation-and-processing"></a>إنشاء الموجة ومعالجتها

[!include [banner](../includes/banner.md)]

يصف هذا الموضوع كيفية الإنشاء والمعالجة والإصدار لموجة، لإنشاء عمل انتقاء لحمل العمل أو الشحن أو أمر الإنتاج أو أمر كانبان. يمكنك إنشاء الموجات للأنواع التالية من الأوامر:
...
1. اعتمادًا على نوع الموجة التي تريد إنشاءها، قم بأحد الإجراءات التالية:
    ...
    - انتقل إلى **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات الشحن** \> **كل الموجات**. في جزء الإجراءات، حدد **موجة**.
    - انتقل إلى **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات الإنتاج** \> **كل موجات الإنتاج**. في جزء الإجراءات، حدد **موجة الإنتاج**.
    - انتقل إلى **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات كانبان** \> **كل موجات كانبان**. في جزء الإجراءات، حدد **إنشاء الموجة**.
...
1. اعتماداً على نوع الموجة المطلوب معالجتها، قم بإجراء واحد مما يلي:
    ...
    - حدد **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات الشحن** \> **كل الموجات**. في جزء الإجراءات، حدد **موجة**.
    - حدد **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات الإنتاج** \> **كل موجات الإنتاج**. في جزء الإجراءات، حدد **موجة الإنتاج**.
    - حدد **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات كانبان** \> **كل موجات كانبان**. في جزء الإجراءات، حدد **إنشاء الموجة**.
...
1. اعتماداً على نوع الموجة المطلوب إلغاؤها، قم بإجراء واحد مما يلي:
      ...
      - انتقل إلى **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات الشحن** \> **كل الموجات**.
      - انتقل إلى **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات الإنتاج** \> **كل موجات الإنتاج**.
      - انتقل إلى **إدارة المستودعات** \> **عام** \> **الموجات** \> **موجات كانبان** \> **كل موجات كانبان**.
...
### <a name="enable-the-wave-batch-job-details-page"></a>تمكين صفحة تفاصيل مهمة دفعة الموجة

إذا لم يكن نظامك يتضمن صفحة **تفاصيل وظيفة دفعة الموجة** بالفعل، فانتقل إلى [إدارة الميزات](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) وقم بتشغيل ميزة *تفاصيل وظيفة دفعة الموجة*.
