...
عند استخدام الميزة **استخدام علامات وزن التعبئة الموجودة عند الإعلام عن أوامر المنتج كمنتهية‬‏‫** مع تمكين العملية عبر عنصر قائمة جهاز محمول، يتم تحديث المخزون استنادًا إلى معلومات علامات وزن التعبئة. ونتيجة لذلك، لا يطالب تطبيق المستودع بالتقاط بيانات علامة وزن التعبئة كجزء من تقرير الإنتاج كعملية منتهية.
