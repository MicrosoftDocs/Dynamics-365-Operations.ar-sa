...
- دمج لوحات الترخيص غير مدعوم لمنتجات وزن التعبئة.
- التغييرات في حالة مخزون المستودع كجزء من مهمة دورية غير مدعومة لمنتجات وزن التعبئة.
- التغييرات في حالة المخزون التي تم تعريفها بواسطة استعلام غير مدعومة لمنتجات وزن التعبئة. (التغييرات في حالة المخزون لأمر الجودة غير مدعومة هي أيضًا.)
- بالنسبة إلى منتجات وزن التعبئة، لا يمكن تغيير حالة المخزون من الصفحة **الفعلي حسب الموقع**.
- بالنسبة إلى منتجات وزن التعبئة، لا يمكن تغيير حالة المخزون كجزء من عمل حركة تطبيق المستودع.
...
- بالنسبة إلى منتجات وزن التعبئة، لا يمكن إتمام العمل من صفحة **العمل**.
- بالنسبة إلى منتجات وزن التعبئة، لا يمكن تشغيل العمل المحدد في قالب عمل بشكل تلقائي.
- وظيفة عكس العمل غير مدعومة لمنتجات وزن التعبئة.
...
- بالنسبة إلى منتجات وزن التعبئة، يمكن تسجيل الإبلاغ كمنتهٍ بواسطة رقم مسلسل.
...
- عند معالجة عمل انتقاء لأوامر المبيعات والتحويل. (لاحظ أنه لا يمكن تسجيل علامات وزن التعبئة لانتقاء مكونات الإنتاج.)
