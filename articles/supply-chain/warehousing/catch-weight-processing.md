...
بالنسبة إلى طرق التقاط الوزن الوارد، يمكنك تحديد ما إذا كان قياس الوزن يتم لكل وحدة وزن تعبئة (بمعنى، كل صندوق)، أو ما إذا كان التقاط الوزن يتم استنادًا إلى الكمية التي ستُنتقى (على سبيل المثال، ثلاثة صناديق). تجدر الإشارة إلى استخدام متوسط الوزن لعملية انتقاء بنود الإنتاج في حال استخدام الخيار **غير ملتقط**.
...
- معالجة الأوامر بين الشركات الشقيقة غير مدعوم.
...
- عندما يتم التقاط علامات وزن التعبئة كجزء من معالجة تطبيق المستودع، يتعذر على المستخدم إلغاء سير العمل.
