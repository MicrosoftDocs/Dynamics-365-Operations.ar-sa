...
description: يصف هذا المقال كيفية تكوين عوامل تصفية منتج وتصفية رموز لتصنيف أصناف المخزون في مستودع. يمكنك أيضًا استخدام عوامل التصفية لتحديد أي العملاء الذين يمكن أن يطلبوا صنف معين وتحديد الأصناف التي يمكن شراؤها من مورد معين.
author: Mirzaab
ms.date: 01/04/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9067517"
---
# <a name="configure-product-filters-for-warehouse-transactions"></a>تكوين عوامل تصفيه المنتج لحركات المستودع

[!include [banner](../includes/banner.md)]

يصف هذا المقال كيفية تكوين عوامل تصفية منتج وتصفية رموز لتصنيف أصناف المخزون في مستودع. يمكنك أيضًا استخدام عوامل التصفية لتحديد أي العملاء الذين يمكن أن يطلبوا صنف معين وتحديد الأصناف التي يمكن شراؤها من مورد معين.
...
1. في حقل **كود عامل التصفية‬**، أدخل قيمة.
    ...
    ![إعداد عامل تصفيه منتجات.](media/Product_Filters10.png "إعداد عامل تصفيه منتجات")

1. في حقل **الوصف**، أدخل اسمًا للكود. علي سبيل المثال، قد يمثل *الكود 2* الموردين. ويمكنك بعد ذلك إنشاء عامل تصفيه منتجات لمورد معين أو مجموعه موردين محدده. لمزيد من المعلومات، راجع قسم [إعداد أكواد عامل تصفية المورد](#vendor-product-filters) فيما بعد في هذا المقال.
...
> [!IMPORTANT]
> يتم تمكين أكواد عوامل تصفية المنتج فقط للعناصر التي تستخدم إدارة المستودعات المتقدمة.
...
## <a name="set-up-customer-product-filters"></a>إعداد عوامل تصفيه منتجات العملاء
...
1. في حقل **مجموعة الأصناف**، حدد مجموعة أصناف.
1. في الحقول **الكود 1** إلى **الكود 10**، حدد أكواد التصفية لاستخدامها كمعايير لتحديد الأصناف المتوفرة للعملاء في مجموعه الأصناف المحددة. يجب اجراء تحديد لكل كود تصفيه تم إعداده لمجموعه الأصناف.

## <a name="set-up-vendor-product-filters"></a><a name="vendor-product-filters"></a>إعداد عوامل تصفيه منتجات الموردين
