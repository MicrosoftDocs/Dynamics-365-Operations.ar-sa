---
title: ارتساء
description: يشرح هذا المقال كيفية تمكين الارتساء واستخدامه.
...
ms.locfileid: "8903800"
---
# <a name="anchoring"></a>ارتساء

[!include [banner](../includes/banner.md)]

يوفر هذا المقال تفاصيل حول عملية الارتساء. وهو يصف التكوين المطلوب والمنطق الذي يتم تشغيله عندما يقوم عامل المستودع بتغيير موقع التشغيل المرحلي أو موقع التحميل.
...
يوفر هذا المقال سيناريو يوضح كيفية عمل الارتساء. أثناء السيناريو، ستقوم بإنشاء مجموعة من أوامر المبيعات وإصدارها إلى المستودع. ستقوم بعد ذلك بتجاوز موقع التشغيل المرحلي المقترح والتأكد من توجيه كامل عمل التخزين المتبقي إلى الموقع الجديد.
