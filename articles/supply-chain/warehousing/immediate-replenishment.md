---
title: الاستعاضة الفورية
description: يصف هذا المقال كيف يمكنك استخدام التزويد الفوري لتزويد المخزون عند فشل توجيه موقع في تخصيص المخزون.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
