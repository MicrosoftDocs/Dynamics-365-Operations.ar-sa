...
يتم تعيين الحد الأدنى والحد الأقصى للمبالغ في قالب التزويد. وهناك العديد من الإعدادات الأخرى في القالب تشبه الإعدادات في القوالب التي يتم استخدامها في تزويد طلب الموجة. يجب أن يحتوي القالب على بند واحد لكل صنف وموقع. عند تشغيل التزويد باستخدام وظيفة دفعية، سيقوم Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition بتقييم ما إذا كان التزويد مطلوبًا، في التسلسل الذي تم تنظيم البنود به. 
...
| المستودع               | يجب أن يكون المستودع متاحًا لعمليات إدارة المستودعات. لتمكين المستودع لعمليات إدارة المستودعات، في صفحة **المستودعات** حدد المستودع، ثم حدد الخيار **استخدام عمليات إدارة المستودعات‬**. |
