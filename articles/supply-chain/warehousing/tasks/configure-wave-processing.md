...
للعمل بهذا السيناريو باستخدام السجلات والقيم النموذجية المحددة هنا، يجب [أن تكون في نظام تم فيه تثبيت بيانات](../../../fin-ops-core/fin-ops/get-started/demo-data.md) العرض التوضيحي القياسية. كما يجب تحديد الكيان القانوني **USMF** قبل البدء.
