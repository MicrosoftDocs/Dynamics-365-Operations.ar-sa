...
1. انقر فوق "جديد".
2. في الحقل "معرف ملف تعريف الموقع"، اكتب قيمة.
3. في حقل "الاسم"، اكتب قيمة.
4. في الحقل "تنسيق الموقع"، أدخل قيمة أو حددها.
5. في الحقل "نوع الموقع‬"، أدخل قيمة أو حددها.
6. في الحقل "‏‫‏‫معرف ملف تعريف إدارة المساحات‬ "، أدخل قيمة أو حددها.
7. حدد "نعم" في حقل "‏‫‏‫السماح بالأصناف المختلطة".
8. حدد "نعم" في حقل "‏‫‏‫السماح بحالات المخزون المختلطة".
9. حدد "نعم" في حقل "‏‫السماح بالجرد الدوري‬".
10. انقر فوق "حفظ".
11. انتقل إلى إدارة المستودعات‬ > إعداد > المستودع > ملفات تعريف الموقع‬.
