...
- <span data-ttu-id="1b2e4-124">**الوحدة:** *إدارة المستودعات*</span><span class="sxs-lookup"><span data-stu-id="1b2e4-124">**Module:** *Warehouse management*</span></span>
...
1. <span data-ttu-id="1b2e4-141">انتقل إلى **إدارة المستودعات \> الإعداد \> المستودع \> ملفات تعريف الموقع**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-141">Go to **Warehouse management \> Setup \> Warehouse \> Location profiles**.</span></span>
...
### <a name="packing-profiles"></a><span data-ttu-id="1b2e4-161">ملف تعريف التعبئة</span><span class="sxs-lookup"><span data-stu-id="1b2e4-161">Packing profiles</span></span>
...
### <a name="outbound-sorting-template"></a><span data-ttu-id="1b2e4-179">قالب الفرز الصادر</span><span class="sxs-lookup"><span data-stu-id="1b2e4-179">Outbound sorting template</span></span>
...
1. <span data-ttu-id="1b2e4-196">في علامة التبويب السريعة **عام** ، عيّن القيم التالية:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-196">On the **General** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="1b2e4-211">**تعيين معايير موضع الفرز:** *استخدام الموضع الفارغ فقط*</span><span class="sxs-lookup"><span data-stu-id="1b2e4-211">**Assign sort position criteria:** *Only use empty position*</span></span>
        ...
        - <span data-ttu-id="1b2e4-214">**استخدام الموضع الفارغ فقط** – ستتم مراعاة المواضع التي لديها بالفعل مخزون مقترن بها</span><span class="sxs-lookup"><span data-stu-id="1b2e4-214">**Only use empty position** – Positions that already have inventory associated with them will be taken into account</span></span>
...
1. <span data-ttu-id="1b2e4-230">في مربع حوار الاستعلام، ضمن علامة التبويب **الفرز** ، حدد **جديد** لإضافة سطر، ثم عيِّن القيم التالية:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-230">In the query dialog box, on the **Sorting** tab, select **New** to add a line, and then set the following values:</span></span>
    ...
    - <span data-ttu-id="1b2e4-231">**الجدول:** *تفاصيل الحمل*</span><span class="sxs-lookup"><span data-stu-id="1b2e4-231">**Table:** *Load details*</span></span>
...
<span data-ttu-id="1b2e4-248">تحرير قالب الموجة المستخدم لفرز طلب الموجة.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-248">Edit the wave template that is used for wave demand sorting.</span></span>
...
1. <span data-ttu-id="1b2e4-265">في الرأس، عيّن القيم التالية:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-265">In the header, set the following values:</span></span>
    ...
    - <span data-ttu-id="1b2e4-266">**اسم عنصر القائمة:** *فرز*</span><span class="sxs-lookup"><span data-stu-id="1b2e4-266">**Menu item name:** *Sort*</span></span>
...
1. <span data-ttu-id="1b2e4-285">انتقل إلى **إدارة المستودعات ‬\> الإعداد‬ \> توجيهات الموقع**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-285">Go to **Warehouse management \> Setup \> Location directives**.</span></span>
...
1. <span data-ttu-id="1b2e4-304">في علامة التبويب السريعة **إجراءات توجيه الموقع** ، حدد **جديد** ، ثم عيِّن القيم التالية.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-304">On the **Location Directive Actions** FastTab, select **New** , and then set the following values.</span></span> <span data-ttu-id="1b2e4-305">اقبل القيم الافتراضية لكافة الحقول الأخرى.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-305">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="1b2e4-306">**رقم المسلسل:** *1*</span><span class="sxs-lookup"><span data-stu-id="1b2e4-306">**Sequence number:** *1*</span></span>
...
1. <span data-ttu-id="1b2e4-327">في السطر الذي يحتوي على الحقل **اسم الحقل** المعين على *معرف الشحنة* ، امسح خانة الاختيار **تجميع حسب هذا الحقل**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-327">On the line where the **Field name** field is set to *Shipment ID* , clear the **Group by this field** check box.</span></span>
...
1. <span data-ttu-id="1b2e4-363">انتقل إلى **المبيعات والتسويق \> أوامر المبيعات \> كافة أوامر المبيعات‬**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-363">Go to **Sales and marketing \> Sales orders \> All sales orders**.</span></span>
...
1. <span data-ttu-id="1b2e4-384">حدد **موافق**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-384">Select **OK**.</span></span>
...
1. <span data-ttu-id="1b2e4-405">اتبع الخطوات التالية لحجز مخزون لسطر المبيعات:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-405">Follow these steps to reserve inventory for the sales line:</span></span>
...
1. <span data-ttu-id="1b2e4-423">في جزء الإجراءات، حدد **معالجة**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-423">On the Action Pane, select **Process**.</span></span>
...
1. <span data-ttu-id="1b2e4-438">قم بتأكيد الإدخال.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-438">Confirm your entry.</span></span>
    ...
    <span data-ttu-id="1b2e4-439">ستكون مطالبًا بعدها بإدخال لوحة الترخيص الهدف (LP).</span><span class="sxs-lookup"><span data-stu-id="1b2e4-439">Next, you're prompted to enter a target license plate (LP).</span></span> <span data-ttu-id="1b2e4-440">لاحظ أن السطر 1 في أمر المبيعات 1 هو ما يجب انتقاؤه وإضافته إلى لوحة الترخيص الهدف.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-440">Notice that line 1 from sales order 1 is what must be picked and added to the target license plate.</span></span> <span data-ttu-id="1b2e4-441">يتم إظهار رقم الصنف والكمية ووصف الصنف وموقع الانتقاء.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-441">The item number, quantity, item description, and pick location are shown.</span></span>

1. <span data-ttu-id="1b2e4-442">في الحقل **لوحة الترخيص الهدف** ، أدخل رقم لوحة ترخيص.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-442">In the **Target LP** field, enter a license plate number.</span></span>

    <span data-ttu-id="1b2e4-443">ستنتقِ كافة السطور التي تم إنشاؤها من الموجة التي تمت معالجتها إلى نفس لوحة الترخيص الهدف.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-443">You will pick all lines that were created from the processed wave onto the same target license plate.</span></span>

1. <span data-ttu-id="1b2e4-444">قم بتأكيد الإدخال.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-444">Confirm your entry.</span></span>

    <span data-ttu-id="1b2e4-445">يقدم تطبيق الأجهزة المحمولة الآن سلسلة من صفحات **الانتقاء** التي توجهك إلى موقع الانتقاء، والصنف والكمية التي يجب انتقاؤهما.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-445">The mobile app now presents a series of **Pick** pages that point you to the picking location, and to the item and quantity that must be picked.</span></span> <span data-ttu-id="1b2e4-446">بعد إضافة الصنف المنتقى إلى لوحة الترخيص، ستقوم بتأكيد عمل الانتقاء.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-446">After the picked item is added to the license plate, you will confirm the pick work.</span></span> <span data-ttu-id="1b2e4-447">ستكون الصفحة الأخيرة هي العمل لوضع العناصر المنتقاة في موقع الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-447">The last page will be the work to put the picked items into the sorting location.</span></span>

1. <span data-ttu-id="1b2e4-448">قم بتأكيد عمل الانتقاء الأول.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-448">Confirm the first pick work.</span></span>
1. <span data-ttu-id="1b2e4-449">يتم عرض عمل الانتقاء التالي.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-449">The next pick work is shown.</span></span> <span data-ttu-id="1b2e4-450">قم بتأكيد الانتقاء.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-450">Confirm the pick.</span></span>
1. <span data-ttu-id="1b2e4-451">استمر في تأكيد عمل الانتقاء المتبقي.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-451">Continue to confirm the remaining pick work.</span></span>
1. <span data-ttu-id="1b2e4-452">الخطوة الأخيرة هي إكمال عمل الوضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-452">The last step is to complete the put work.</span></span> <span data-ttu-id="1b2e4-453">قم بتأكيد الاحتفاظ في موقع الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-453">Confirm the put-away to the sorting location.</span></span>

    <span data-ttu-id="1b2e4-454">ستتلقى رسالة "اكتمل العمل".</span><span class="sxs-lookup"><span data-stu-id="1b2e4-454">You receive a "Work completed" message.</span></span>

1. <span data-ttu-id="1b2e4-455">انهِ **انتقاء المبيعات** على تطبيق الأجهزة المحمولة.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-455">Exit **Sales Picking** on the mobile app.</span></span>

### <a name="sortingput-to-wall"></a><span data-ttu-id="1b2e4-456">الفرز/وضع على الحائط</span><span class="sxs-lookup"><span data-stu-id="1b2e4-456">Sorting/put-to-wall</span></span>

<span data-ttu-id="1b2e4-457">الآن وبعد وضع كل المخزون في موقع الفرز، يجب فرزه في موضع الفرز الصحيح.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-457">Now that all inventory has been put to the sorting location, it must be sorted to the correct sort position.</span></span>

1. <span data-ttu-id="1b2e4-458">سجِّل الدخول إلى تطبيق الأجهزة المحمولة.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-458">Sign in to the mobile app.</span></span>
1. <span data-ttu-id="1b2e4-459">من القائمة الرئيسية، حدد **خارجي**.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-459">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="1b2e4-460">في القائمة **خارجي** ، حدد **فرز** للبدء في فرز العناصر.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-460">On the **Outbound** menu, select **Sort** to start to sort the items.</span></span>
1. <span data-ttu-id="1b2e4-461">في الحقل **لوحة الترخيص/الحاوية** ، أدخل لوحة الترخيص الهدف لعمل أمر المبيعات الذي تم انتقاؤه.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-461">In the **LP/CON** field, enter the target license plate of the picked sales order work.</span></span>
1. <span data-ttu-id="1b2e4-462">قم بتأكيد الإدخال.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-462">Confirm your entry.</span></span>
1. <span data-ttu-id="1b2e4-463">أدخل رقم الصنف المراد فرزه أولاً.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-463">Enter the item number to sort first.</span></span>
1. <span data-ttu-id="1b2e4-464">يحدد النظام موضع الفرز الأول الذي ينبغي إظهاره.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-464">The system determines the first sort position that should be shown.</span></span> <span data-ttu-id="1b2e4-465">قم بتأكيد موضع الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-465">Confirm the sort position.</span></span>
1. <span data-ttu-id="1b2e4-466">أنت مطالب بتعيين لوحة ترخيص إلى موضع الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-466">You're prompted to assign a license plate to the sort position.</span></span> <span data-ttu-id="1b2e4-467">حدد الحقل **لوحة الترخيص** ، وأدخل رقم لوحة الترخيص، ثم قم بأاكيد الإدخال.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-467">Select the **LP** field, enter a license plate number, and then confirm your entry.</span></span>

    <span data-ttu-id="1b2e4-468">نظرًا لارتباط موضع الفرز بمعرف الشحنة، ستقوم بفرز الأصناف المنتقاة في لوحة ترخيص خاصة بالشحنة الخارجية وأمر المبيعات.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-468">Because the sort position is related to the shipment ID, you will sort the picked items into a license plate that is specific to the outbound shipment and sales order.</span></span>

    <span data-ttu-id="1b2e4-469">تعرض الصفحة التالية معرف الصنف والكمية ومعرف موضع الفرز ومعرفات لوحات ترخيص "من" (الانتقاء) و "إلى" (الفرز).</span><span class="sxs-lookup"><span data-stu-id="1b2e4-469">The next page shows the item ID, quantity, sort position ID, and the "from" (picking) and "to" (sorting) license plate IDs.</span></span> <span data-ttu-id="1b2e4-470">وترشدك المعلومات الموجودة في هذه الصفحة إلى فرز الأصناف والكميات المحددة من لوحة ترخيص الانتقاء إلى لوحة ترخيص الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-470">The information on this page instructs you to sort the specified item and quantities from the picking license plate into the sorting license plate.</span></span>

1. <span data-ttu-id="1b2e4-471">قم بتأكيد موضع الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-471">Confirm the sort position.</span></span>
1. <span data-ttu-id="1b2e4-472">افرز العناصر الموجودة في موضع الفرز الأول.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-472">Sort the items in the first sort position.</span></span> <span data-ttu-id="1b2e4-473">وعند الانتهاء من ذلك، يوجهك النظام إلى موضع الفرز التالي.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-473">When you've finished, the system directs you to the next sort position.</span></span>
1. <span data-ttu-id="1b2e4-474">كرر هذه العملية لكافة السطور المنتقاة في أمر العمل.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-474">Repeat this process for all picked lines on the work order.</span></span> <span data-ttu-id="1b2e4-475">وينبغي لك أيضًا استخدام هذه العملية عند وجود سطور انتقاء متعددة لها نفس رقم الصنف.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-475">You should also use this process when there are multiple pick lines that have the same item number.</span></span>

    <span data-ttu-id="1b2e4-476">بتكرار هذه العملية لكافة الأصناف، يقيِّم النظام المعايير من الصنف التالي الممسوح ضوئيًا (سطر العمل) ويحدد موضع الفرز الذي ينبغي وضعه فيه.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-476">As you repeat this process for all items, the system evaluates the criteria from the next scanned item (work line) and determines which sorting position it should be put to.</span></span> <span data-ttu-id="1b2e4-477">يتم توجيهك تلقائيًا لوضع العنصر في موضع الفرز الصحيح.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-477">You're automatically directed to put the item to the correct sort position.</span></span> <span data-ttu-id="1b2e4-478">وفقًا لإعداد التأكيد، يتم أيضًا توجيهك لتأكيد هذا الإجراء عن طريق إدخال رقم الموضع أو معرف لوحة الترخيص.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-478">Depending on the confirmation setup, you're also directed to confirm this action by entering the position number or license plate ID.</span></span>

    > [!NOTE]
    > <span data-ttu-id="1b2e4-479">في حالة تشغيل الفرز التلقائي، لا يتوفر التخطي اليدوي.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-479">If automatic sorting is turned on, manual override isn't available.</span></span>

1. <span data-ttu-id="1b2e4-480">عند الانتهاء من ذلك، في Microsoft Dynamics 365 Supply Chain Management، افتح صفحة **تعيينات موضع الفرز الخارجي** لمراجعة حالة المواضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-480">When you've finished, in Microsoft Dynamics 365 Supply Chain Management, open the **Outbound sorting position assignments** page to review the status of the positions.</span></span>

    - <span data-ttu-id="1b2e4-481">إذا كانت المواضع مغلقة تلقائيًا، فحدد **إظهار المغلق** لإظهار المواضع المغلقة.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-481">If positions are closed automatically, select **Show closed** to show the closed positions.</span></span>
    - <span data-ttu-id="1b2e4-482">لاحظ أنه يتم عرض حركات موضع الفرز.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-482">Notice that sort position transactions are shown.</span></span> <span data-ttu-id="1b2e4-483">يتم إظهار الصنف والكمية التي تمت معالجتها في الموضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-483">The item and quantity that were processed through the position are shown.</span></span>

    <span data-ttu-id="1b2e4-484">عند إعداد قالب الفرز الخارجي، عيِّن الخيار **إغلاق موضع الفرز تلقائيًا** على *نعم*.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-484">When you set up the outbound sorting template, you set the **Auto close sort position** option to *Yes*.</span></span> <span data-ttu-id="1b2e4-485">وبالتالي يتم إغلاق الموضع تلقائيًا بعد وضع آخر مخزون متوقع به.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-485">Therefore, the position is automatically closed after the last expected inventory is put to it.</span></span> <span data-ttu-id="1b2e4-486">تكون مواضع الفرز بالحالة **مغلق** ، وقد تم إنشاء العمل لنقل المخزون الذي تم فرزه إلى موقع *Baydoor*.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-486">The sort positions are in **Closed** status, and work has been created to move the sorted inventory to *Baydoor* location.</span></span>

1. <span data-ttu-id="1b2e4-487">أكمل عمل انتقاء المخزون الذي تم فرزه لنقل المخزون إلى موقع الشحن.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-487">Complete the sorted inventory picking work to move the inventory to the shipping location.</span></span> <span data-ttu-id="1b2e4-488">عندما يكون المخزون جاهزًا قم بتأكيد شحنه.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-488">When the inventory is ready, ship-confirm it.</span></span>

> [!NOTE]
> <span data-ttu-id="1b2e4-489">لكي تتم معالجة عمل انتقاء المخزون الذي تم فرزه بشكل صحيح، ينبغي استخدام عنصر قائمة الأجهزة المحمولة الذي يحتوي على معرف فئة عمل يكون الحقل **نوع أمر العمل** فيه معينًا على *انتقاء المخزون الذي تم فرزه* لعملية التحميل والحركة.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-489">For sorted inventory picking work to be processed correctly, a mobile device menu item that has a work class ID where the **Work order type** field is set to *Sorted inventory picking* should be used for the movement and loading process.</span></span>

### <a name="manually-close-a-position-optional"></a><span data-ttu-id="1b2e4-490">إغلاق موضع يدويًا (اختياري)</span><span class="sxs-lookup"><span data-stu-id="1b2e4-490">Manually close a position (optional)</span></span>

<span data-ttu-id="1b2e4-491">إذا كان ينبغي إغلاق مواضع الفرز يدويًا، يجب تعيين الخيار **إغلاق موضع الفرز تلقائيًا** لقالب الفرز الخارجي على *لا* ، ويجب إجراء الإغلاق قبل إمكانية نقل المخزون إلى منطقه باب المرسى.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-491">If sort positions should be closed manually, the **Auto close sort position** option for the outbound sorting template must be set to *No* , and closing must be done before inventory can be moved to the bay door area.</span></span> <span data-ttu-id="1b2e4-492">يمكن إغلاق المواضع بعدة طرق:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-492">Positions can be closed in various ways:</span></span>

- <span data-ttu-id="1b2e4-493">عبر تطبيق المستودع:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-493">Via the warehouse app:</span></span>

    - <span data-ttu-id="1b2e4-494">يمكن للمستخدم إجراء المسح الضوئي لأحد الأصناف الموجودة بالفعل في الموضع ثم تحديد **إغلاق** لإغلاق الموضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-494">The user can scan one of the items that are already on the position and then select **Close** to close the position.</span></span>
    - <span data-ttu-id="1b2e4-495">إذا قام المستخدم بالمسح الوئي لحاوية تم فرزها بالفعل، تظهر رسالة خطأ.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-495">If the user scans a container that has already been sorted container, an error message is shown.</span></span> <span data-ttu-id="1b2e4-496">ولكن لا يزال بإمكان المستخدم الاستمرار في إغلاق الموضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-496">However, the user can still continue to close the position.</span></span>

- <span data-ttu-id="1b2e4-497">من صفحة **تعيينات موضع الفرز الخارجي** في Microsoft Dynamics 365 Supply Chain Management:</span><span class="sxs-lookup"><span data-stu-id="1b2e4-497">From the Microsoft Dynamics 365 Supply Chain Management **Outbound sorting position assignments** page:</span></span>

    - <span data-ttu-id="1b2e4-498">يمكن للمستخدم تحديد سجل موضع الفرز الخارجي ثم تحديد **إغلاق الوضع** في جزء الإجراءات.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-498">The user can select the outbound sorting position record and then select **Close position** on the Action Pane.</span></span>

## <a name="tips"></a><span data-ttu-id="1b2e4-499">تلميحات</span><span class="sxs-lookup"><span data-stu-id="1b2e4-499">Tips</span></span>

- <span data-ttu-id="1b2e4-500">لا يمكن نقل الأصناف بين المواضع بعد تعيينها إلى موضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-500">Items can't be moved between positions after they have been assigned to one.</span></span> <span data-ttu-id="1b2e4-501">يقيِّم النظام عدد العناصر التي ينبغي نقلها إلى موضع معين.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-501">The system evaluates how many of each item should go to a specific position.</span></span>
- <span data-ttu-id="1b2e4-502">يمكن تكوين قالب الفرز لإنشاء الحاويات تلقائيًا عند إغلاق المواضع.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-502">Sorts template can be configured to automatically create containers when positions are closed.</span></span> <span data-ttu-id="1b2e4-503">سيؤدي هذا الأسلوب إلى إنشاء بنية معرف حاوية قياسية استنادًا إلى ملف تعريف التعبئة المحدد.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-503">This approach will create standard container ID structure that is based on the specified packing profile.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="1b2e4-504">بعد إنشاء عمل الحركة من موقع الفرز، يجب ألا يتم إلغاء العمل.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-504">After movement work has been created from the sorting location, you must not cancel the work.</span></span> <span data-ttu-id="1b2e4-505">وبخلاف ذلك، سيتم حذف الموضع والحاويات الموجودة فيه من النظام ولن تكون متوفرة لإجراء مزيد من المعالجة.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-505">Otherwise, the position and the containers in it will be deleted from the system and unavailable for further processing.</span></span> <span data-ttu-id="1b2e4-506">ستتم إزالة المخزون أيضًا.</span><span class="sxs-lookup"><span data-stu-id="1b2e4-506">The inventory will also be removed.</span></span>
