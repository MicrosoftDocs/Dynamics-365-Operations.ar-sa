...
description: توضح هذه المقالة كيف يمكنك استخدام Dynamics 365 Supply Chain Management - تطبيق التخزين للمساعدة في مراقبة ورصد العمل الذي يقوم به الموظفون في المستودعات.
author: perlynne
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
ms.locfileid: "2018611"
---
# <a name="manage-warehouse-workers"></a>إدارة عمال المستودعات

[!include [banner](../includes/banner.md)]

توضح هذه المقالة كيف يمكنك استخدام Dynamics 365 Supply Chain Management - تطبيق التخزين للمساعدة في مراقبة ورصد العمل الذي يقوم به الموظفون في المستودعات.
