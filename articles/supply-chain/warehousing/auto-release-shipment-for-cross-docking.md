...
description: يصف هذا المقال استراتيجية توزيع البضائع التي تتيح لك تحرير أمر الطلب تلقائيًا إلى المستودع عندما يتم الاعلام عن انتهاء أمر الإنتاج الذي يوفر كمية الطلب، بحيث يتم نقل الكمية مباشرة من موقع إخراج الإنتاج إلى الموقع الخارجي.
author: Mirzaab
ms.date: 10/15/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9067900"
---
# <a name="auto-release-shipment-for-cross-docking"></a>الإفراج التلقائي عن الشحنة لتوزيع البضائع

[!include [banner](../includes/banner.md)]

يصف هذا المقال استراتيجية توزيع البضائع التي تتيح لك تحرير أمر الطلب تلقائيًا إلى المستودع عندما يتم الاعلام عن انتهاء أمر الإنتاج الذي يوفر كمية الطلب. وبهذه الطريقة، يتم نقل الكمية المطلوبة لاستيفاء أمر الطلب مباشرة من موقع إخراج الإنتاج إلى الموقع الخارجي.
...
|---|---|
| العنصر | يجب أن يكون الصنف متاحًا لعمليات إدارة المستودعات (WMS).<p>**ملاحظه:** لا يمكن تضمين ‏‫الأصناف التي تم تمكينها لوزن التعبئة في عمليات توزيع البضائع.</p> |
| المستودع | يجب أن يكون المستودع متاحًا لعمليات إدارة المستودعات (WMS). |
