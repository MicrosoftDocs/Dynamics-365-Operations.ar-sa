...
## <a name="about-wave-step-codes"></a>حول أكواد خطوة الموجة
...
> [!NOTE]
> استخدام ميزة أكواد خطوة الموجة اختياري، ويكون التنفيذ لكل كيان قانوني. وبالتالي، في حالة استخدم كيان قانوني محدد هذه الميزة، تتم ترقية كافة أكواد خطوة الموجة الحالية في الكيان القانوني إلى البنية الجديدة.
...
2. على علامة التبويب **عام**، على علامة التبويب السريعة **معالجة الموجة‬**، عيّن الخيار **تمكين أكواد خطوة الموجة‬** إلى **نعم**.

تتم ترقية جميع النصوص الحرة لخطوة الموجة الحالية إلى البنية الجديدة. بعد اكتمال الترقية لكيان قانوني، لم يعد الخيار **تمكين أكواد خطوة الموجة** متوفرًا على صفحة **‏‫محددات إدارة المستودعات**.

يتم إجراء التحقق من الصحة أثناء الترقية، وفي حالة فشل الترقية، تظهر رسالة خطأ. قد تفشل عملية الترقية بسبب التعارضات التالية:

- وجود نصوص حرة مكررة لخطوة الموجة.
- وجود تخصيصات.
- لا يُطابق النص الحر لخطوة الموجة المقترن بمثيل أسلوب خطوة الموجة نوع القالب المتوقع.

بعد حل إيه تعارضات تم التعرف علهيا أثناء التحقق من الصحة، يمكنك إعادة تشغيل عملية الترقية.

عند نجاح الترقية، تصبح صفحة **أكواد خطوة الموجة** (**إدارة المستودعات \> إعداد \> أمواج \>أكواد خطوة الموجة**) متوفرة. تسرد هذه الصفحة أكواد خطوة الموجة التي تمت ترقيتها عند تشغيل ميزة أكواد خطوة الموجة.
