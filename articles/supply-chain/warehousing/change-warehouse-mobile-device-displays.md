...
ms.locfileid: "859749"
---
# <a name="warehouse-mobile-device-display-settings"></a>إعدادات عرض الأجهزة المحمولة للمستودع

[!include [banner](../includes/banner.md)]

> [!NOTE]
> تم إهمال هذه الميزة. للحصول على مزيد من المعلومات راجع [الميزات المهلكة أو التي تمت إزالتها‬](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
