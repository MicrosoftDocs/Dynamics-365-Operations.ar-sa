...
1. في جزء القائمة، حدد عنصر القائمة الذي ترغب في إعداده.
1. حدد **إعداد تأكيد العمل** في جزء الإجراءات.
1. قم بأحد الإجراءات التالية:
    - إذا كان هناك بند بالفعل لـ **نوع العمل** الذي ترغب في إعداده، فحدده ثم حدد **تحرير** في جزء الإجراءات.
    - في حالة عدم وجود بند مناسب، حدد **جديد** في جزء الإجراءات ثم قم بتعيين **نوع العمل** إلى النوع المناسب.
1. قم بوضع علامة على خانة الاختيار **تأكيد المنتج** للبند الجديد أو المحدد. سيسمح هذا للعاملين بالتحقق من كل جزء من المخزون باستخدام الجهاز المحمول.
