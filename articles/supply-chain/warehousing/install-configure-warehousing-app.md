...
description: يشرح هذا المقال كيفية تثبيت تطبيق المستودع على كل جهاز محمول خاص بك وتكوينه للاتصال ببيئة Microsoft Dynamics 365 Supply Chain Management الخاصة بك. يمكنك تكوين كل جهاز يدويًا، أو يمكنك استيراد إعدادات الاتصال من خلال ملف أو عن طريق مسح رمز QR.
author: Mirzaab
ms.date: 05/25/2020
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> يوضح هذا المقال كيفيه تكوين تطبيق المستودع القديم (الذي تم إهماله الآن). إذا كنت تبحث عن معلومات حول كيفية تكوين تطبيق الأجهزة المحمولة الخاص بإدارة المستودع، راجع [تثبيت تطبيق الأجهزة المحمولة لإدارة المستودعات والاتصال به](install-configure-warehouse-management-app.md).

> [!NOTE]
> يوضح هذا المقال كيفية تكوين تطبيق المستودع لعمليات توزيع المجموعة. إذا كنت تبحث عن معلومات حول كيفية تكوين تطبيق مستودع لعمليات التوزيع المحلي، فراجع [التخزين لعمليات التوزيع المحلية](../../fin-ops-core/dev-itpro/deployment/warehousing-for-on-premise-deployments.md).
...
يشرح هذا المقال كيفية تثبيت تطبيق المستودع على كل جهاز محمول خاص بك وتكوينه للاتصال ببيئة Supply Chain Management الخاصة بك. يمكنك تكوين كل جهاز يدويًا، أو يمكنك استيراد إعدادات الاتصال من خلال ملف أو عن طريق مسح رمز QR.
