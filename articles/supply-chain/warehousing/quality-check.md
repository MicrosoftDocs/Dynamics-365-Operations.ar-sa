---
title: فحص الجودة
description: يوفر هذا المقال معلومات حول ميزة فحص الجودة. تسمح هذه الميزة للعاملين في المستودع بإجراء عمليات عشوائية سريعة لفحص الجودة أثناء استلام الأصناف في منطقة الرصيف الداخلية.
author: Mirzaab
ms.date: 07/16/2020
ms.topic: article
ms.prod: ''
...
لاستخدام الوظيفة الموضحة في هذا المقال، يجب أن تكون الميزة *فحص الجودة‬‬* قيد التشغيل في النظام. هذه الميزة إلزامية ولا يمكن إيقاف تشغيلها، اعتبارًا من Supply Chain Management 10.0.25. إذا كنت تقوم بتشغيل إصدار أقدم من 10.0.25، فبإمكان المسؤولين تشغيل هذه الوظيفة أو إيقاف تشغيلها عن طريق البحث عن ميزة *فحص الجودة‬* في مساحة عمل [إدارة الميزات](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).

## <a name="set-up-the-feature-for-the-example-scenario"></a>إعداد الميزة السيناريو المثال

يوفر هذا القسم إرشادات ومثال يوضح كيفيه إعداد ميزة *فحص الجودة* وتجهيز عينة البيانات للسيناريو المثال الذي يتم توفيره لاحقًا في هذا المقال.
...
بعد جعل كافة عينات البيانات التي تم وصفها سابقًا متوفرة ثم إعدادها، يمكنك العمل عبر هذا السيناريو لتجربة ميزة *فحص الجودة*. تفترض القيم التي يتم عرضها في هذا السيناريو أنك تعمل مع بيانات العرض التوضيحي القياسية، وأنك حددت الكيان القانوني **USMF**، وأنك أعددت عينات السجلات التي ورد وصفها سابقًا في هذا المقال. يعمل هذا السيناريو أيضًا كمثال يوضح كيفية استخدام الميزة في إعداد الإنتاج.
...
يمكن الآن معالجة اختبار أمر الجودة. لم تتم تغطية اختبار الجودة في هذا المقال.
