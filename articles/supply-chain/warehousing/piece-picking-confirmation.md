...
عند تمكين انتقاء الأجزاء، يتم تحديد تأكيد المنتجات تلقائيًا. بالنسبة إلى عمليات الانتقاء من نوع العمل، يمكنك تعيين حد أقصى من عدد الأجزاء. سيسمح لك ذلك بتعيين حد أقصى لعدد الأجزاء التي يجب تأكيدها أثناء عملية العمل. تستند الكمية القصوى إلى وحدة العمل الحالية التي تتم معالجتها. لا يسمح نوع عمل الجرد بحد أقصى.
