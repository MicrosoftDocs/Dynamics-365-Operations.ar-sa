---
title: نظرة عامة على موقع التجارة الإلكترونية
description: يقدم هذا المقال نظرة عامة حول دعم مواقع التجارة الإلكترونية في Microsoft Dynamics 365 Commerce.
...
ms.locfileid: "8899111"
---
# <a name="e-commerce-site-overview"></a>نظرة عامة على موقع التجارة الإلكترونية

[!include [banner](includes/banner.md)]

يقدم هذا المقال نظرة عامة حول دعم مواقع التجارة الإلكترونية في Microsoft Dynamics 365 Commerce. وهو يتضمن معلومات حول كيفية تهيئة وإدارة متاجر التجارة الإلكترونية عبر الإنترنت في Dynamics 365 Commerce. كما يوفر روابط لمزيد من المعلومات حول المتاجر عبر الإنترنت، وحول كيفية إعداد موقع التجارة الإلكترونية وتكوينه. على الرغم من أن هذا المقال يغطي العديد من الأساسيات، إلا أنه لا يغطي كل ما هو مطلوب لإنشاء موقع تجارة إلكترونية للإنتاج. يمكن الاطلاع علي مقالات أكثر تقدمًا في وثائق Dynamics 365 Commerce .
...
تتضمن المواقع **الافتراضية** و **abrikam** قوالب وأجزاء وصفحات مكونة مسبقًا لمساعدتك علي البدء. لمزيد من المعلومات، راجع المقالات التالية:
...
لمزيد من المعلومات حول كيفية إدارة إعداد موقعك، راجع المقالات التالية:
...
لمزيد من المعلومات حول كيفية إدارة محتوى الموقع، راجع المقالات التالية:
