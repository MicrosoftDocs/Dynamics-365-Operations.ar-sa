...
description: يشرح هذا المقال كيفيه إنشاء عمليات الدفع المستردة من خلال مراكز الاتصال عند إنشاء عمليات الإرجاع أو عند إلغاء الأوامر أو بنود الأوامر.
author: hhainesms
ms.date: 01/05/2020
ms.topic: article
ms.prod: ''
