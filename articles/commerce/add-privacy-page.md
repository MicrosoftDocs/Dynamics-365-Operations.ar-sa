...
description: يصف هذا المقال كيفية إضافة صفحة سياسة الخصوصية إلى موقعك في Microsoft Dynamics 365 Commerce.
author: v-chgri
ms.date: 08/31/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9272061"
---
# <a name="add-a-privacy-policy-page"></a>إضافة صفحة سياسة الخصوصية

[!include [banner](includes/banner.md)]

يصف هذا المقال كيفية إضافة صفحة سياسة الخصوصية إلى موقعك في Microsoft Dynamics 365 Commerce.
