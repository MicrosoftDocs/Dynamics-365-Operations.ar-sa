---
title: تمكين الكشف عن المتجر استنادًا إلى الموقع
description: يوضح هذا المقال كيفية تشغيل اكتشاف المتجر استنادًا إلى الموقع‬ لموقع Dynamics 365 Commerce الخاص بك.
author: brianshook
ms.date: 07/02/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8892035"
---
# <a name="enable-location-based-store-detection"></a>تمكين الكشف عن المتجر استنادًا إلى الموقع

[!include [banner](includes/banner.md)]

يوضح هذا المقال كيفية تشغيل اكتشاف المتجر استنادًا إلى الموقع‬ لموقع Dynamics 365 Commerce الخاص بك.
...
إذا قمت بتشغيل ميزه اكتشاف المتجر استنادًا إلى الموقع، يتم إرسال المعلومات من مستعرض العميل إلى خدمه موقع Microsoft. وعندئذ يتم استخدام هذه المعلومات لتوفير محتوى العميل المرتبط بموقع العميل. وتخضع المعلومات التي يتم إرسالها من مستعرض العميل والمعلومات استنادًا إلى الموقع التي يتم إرجاعها إلى العميل إلى سياسات امتثال الخصوصية وملفات تعريف الارتباط.
