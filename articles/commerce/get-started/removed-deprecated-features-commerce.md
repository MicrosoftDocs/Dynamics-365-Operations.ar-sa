...
يصف هذا المقال الميزات التي تمت إزالتها أو تلك المخطط لإزالتها من Dynamics 365 Commerce.
...
## <a name="features-removed-or-deprecated-in-the-commerce-10029-release"></a>ميزات تمت إزالتها أو إهمالها في الإصدار 10.0.29 من Commerce

### <a name="commerce-parameters-setting---allow-price-adjustments-to-increase-product-price"></a>إعداد معلمات التجارة - السماح بتعديلات الأسعار لزيادة سعر المنتج

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | حدث هذا الاعداد للتحكم في ما إذا كانت وظيفة تعديل السعر تسمح بزيادة سعر المنتج. عند إيقاف تشغيل هذه المعلمة ، فانه يمكن فقط لاستخدام مؤسسات وظيفة تعديل السعر تعيين سعر وحده منتج اقل من السعر الأساسي وسعر مبيعات الاتفاقية التجارية. ونحن ديبريكاتي هذا الاعداد لأنه تم تحديث وظيفة تعديل السعر لدعم التعديلات ثنائيه الاتجاه (زيادة أو تقليل) الخانة. |
| **هل تم الاستبدال بميزة أخرى؟**   | لا |
| **مناطق المنتجات المتأثرة**         | التسعير والخصومات |
| **خيارات النشر**              | ‏‏الكل‬ |
| **Status**                         | مهمل: يتم تشغيل هذا الاعداد افتراضيا منذ إصدار 10.0.29 ستتم ازالته في 2023 أكتوبر. |

### <a name="commerce-parameters-setting---enable-price-report-for-retail-store"></a>اعداد محددات التجارة-تمكين تقرير السعر لمتجر البيع بالتجزئة

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | حدث هذا الاعداد للتحكم في ما إذا كانت وظيفة تقرير السعر متاحه للاستخدام في نموذج تكوين المتجر. وديبريكاتي هذا الاعداد لأنه تم تحديث نموذج تكوين المتجر لتوفير وظيفة تقرير السعر دائما كوظيفة قياسيه. |
| **هل تم الاستبدال بميزة أخرى؟**   | لا |
| **مناطق المنتجات المتأثرة**         | التسعير والخصومات |
| **خيارات النشر**              | ‏‏الكل‬ |
| **Status**                         | مهمل: ستتم أزاله هذا الاعداد في 2023 أكتوبر. |

### <a name="commerce-parameters-setting---use-todays-date-to-calculate-prices"></a>اعداد محددات التجارة-استخدام تاريخ اليوم لحساب الأسعار

| &nbsp;  | &nbsp; |
|------------|--------------------|
| **سبب الإهلاك/الإزالة** | يدعم محرك تسعير إدارة سلسلة التوريد (SCM) حساب التسعير بناءً على تاريخ الشحن المطلوب أو تاريخ الاستلام المطلوب ، جنبًا إلى جنب مع تاريخ اليوم. لا يدعم مشغل التسعير ثيكوميرسي حساب التسعير علي أساس تاريخ اليوم فقط. بالنسبة للعملاء الذين يستخدمون كلا من إمكانيات السكم والتجارة ، تم توفير هذا الاعداد والتاكد من ان العملاء يقومون بتعيينه دائما إلى **"نعم"** بحيث يمكن لمشغلي التسعير العمل معا. ونحن ديبريكاتي هذا الاعداد لأنه لا يقوم بتغيير سلوك الحساب وهو مكرر. |
| **هل تم الاستبدال بميزة أخرى؟**   | لا |
| **مناطق المنتجات المتأثرة**         | التسعير والخصومات |
| **خيارات النشر**              | ‏‏الكل‬ |
| **Status**                         | مهمل: يتم تشغيل هذا الاعداد افتراضيا منذ إصدار 10.0.29 ستتم ازالته في 2023 أكتوبر. |
...
| **خيارات النشر**              | ‏‏الكل |
| **الحالة**                         | مهمل: اعتبارا من الإصدار 10.0.21، سيتم إزالة SDK التي يتم شحنها عبر LCS VMs في أكتوبر 2023. |
...
| **خيارات النشر**              | ‏‏الكل |
| **الحالة**                         | مهمل: اعتبارًا من الإصدار 10.0.21، ستتم إزالة دعم حزم نقاط البيع المدمجة ونموذج الامتداد باستخدام ModernPos.Sln وCloudPOs.sln وPOS.Extensons.csproj في Retail SDK في أكتوبر 2023. |
...
| **خيارات النشر**              | ‏‏الكل‬|
| **Status**                         | مهملة. لا تستخدم هذا الحقل أو تغيير القيمة الموجودة فيه.|
