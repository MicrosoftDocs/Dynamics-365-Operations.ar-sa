...
| نتائج التحليلات  |  نقاط الرؤى التشغيلية لنقطه البيع (POS) لحسابك Application Insights. | [تسجيل الوصول في Application Insights](../dev-itpro/operational-insights.md#enable-diagnostic-events-in-application-insights)   |  اشتراك تكنولوجيا الدخول الخاص ب Pro/developer   |
