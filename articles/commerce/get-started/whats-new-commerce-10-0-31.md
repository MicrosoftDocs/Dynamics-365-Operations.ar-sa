...
| تتوفر لغات إضافية | تتوفر أربع لغات إضافية | تتوفر أربع لغات جديدة لاختيار المستخدم في قائمة اللغات المفضلة: الكورية والبرتغالية (البرتغال) والفيتنامية والصينية (التقليدية). لتحديد هذا الخيار، انتقل إلى **خيارات المستخدم \> التفضيلات \>تفضيلات اللغة والبلد / المنطقة**. | التفضيلات المترجمة |  
