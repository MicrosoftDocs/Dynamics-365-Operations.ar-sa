...
description: يصف هذا المقال كيفية استخدام السمات لتوفير طريقة لوصف أحد منتجات والصفات المميزة له من خلال حقول معرفة من قبل المستخدم.
author: ashishmsft
ms.date: 04/28/2018
ms.topic: article
ms.prod: ''
...
توفر *السمات* طريقة لتقديم وصف إضافي لأحد المنتجات والصفات المميزة له من خلال حقول معرفة من قبل المستخدم (مثل **حجم الذاكرة**، و **سعة القرص الثابت**، و **هل يتوافق المنتج مع نجمة الطاقة**، وهكذا). ويمكن إقران السمات بمختلف كيانات Commerce، مثل فئات المنتجات وقنوات البيع بالتجزئة، ويمكن تعيين قيم افتراضية لها. ثم ترث المنتجات السمات والقيم الافتراضية عند إقرانها بفئات المنتجات أو القنوات. يمكن تجاوز القيم الافتراضية على مستوى المنتج الفردي، على مستوى قنوات البيع بالتجزئة أو في كتالوج.
...
تستند السمات إلى *أنواع السمات*. يقوم نوع السمة بتحديد نوع البيانات التي يمكن إدخالها لسمة محددة. السمات التالية مدعومة:
...
1. قم بتسجيل الدخول إلى عميل مكتب الدعم كمدير بضائع.
...
بالنسبة إلى المنتجات، يمكن تجاوز إعدادات بيانات تعريف السمات على مستوى القناة. سوف نناقش هذه الإمكانية لاحقًا في هذا المقال.

وكما قد تلاحظ، تشمل صفحة **السمات** الخيارات المرتبطة ببيانات تعريف السمة. ضمن **بيانات تعريف السمة لنقطة البيع**، يؤثر خيار واحد يسمى **يمكن تنقيته** على سلوك قيم السمات في نقطة البيع (POS) أو بالطريقة التي يتعامل بها النظام مع قيم السمات هذه. وسوف تظهر فقط السمات التي يمكنك أن تعين لها الخيار **يمكن تنقيته** إلى **نعم**، لتنقية أو تصفية المنتجات في نقطة البيع.
...
تتيح لك إعدادات عامل التصفية للسمات تحديد كيفية إظهار عوامل التصفية للصفات في نقطة البيع. للوصول إلى إعدادات عامل التصفية لسمة، على صفحة **السمات**، حدد السمة ثم في جزء الإجراءات، حدد **إعدادات عامل التصفية**.
...
- **قيمة الحد** -هذا الإعداد مطلوب إذا قمت بتحديد **نطاق** على أنه نوع التحكم في العرض. يمكنك تحديد القيم باستخام فاصلة منقوطة (؛) كمُحدد.
    ...
    على سبيل المثال، لعامل التصفية مثل **"حجم الحقيبة"**، يمكن أن تكون قيمة الحد **10، 20; 50; 100; 200; 500; 1000; 5000**. وفي هذه الحالة، سوف تُظهر نقطة البيع النطاقات التالية. سوف تظهر أي نطاقات ليس لها أي منتجات في النتيجة باهتة.
...
بعد أن يتم تعريف السمات، يمكن أن يتم تعيينها إلى مجموعات السمات. تُستخدم *مجموعة السمات* لتجميع السمات الفردية لمكون أو مكون فرعي في نموذج تكوين منتج. يمكن تضمين سمة في أكثر من مجموعة سمات. تُساعد مجموعات السمات المستخدمين في تكوين المنتجات، نظرًا لأنه يتم ترتيب تحديدات مختلفة في سياق مُحدد. يمكن تعيين مجموعات السمات لفئات أو قنوات.
...
1. قم بتسجيل الدخول إلى عميل مكتب الدعم كمدير بضائع.
2. انتقل إلى **البيع بالتجزئة والتجارة** &gt; **إدارة الفئات والمنتجات** &gt; **التدرج الهرمي للمنتجات التجارية**.
...
>
> - البيع بالتجزئة والتجارة &gt; إدارة الفئات والمنتجات &gt; فئات التنقل في القنوات
> - البيع بالتجزئة والتجارة &gt; إدارة الفئات والمنتجات &gt; فئات المنتجات التكميلية

### <a name="assign-attribute-groups-to-stores"></a>تعيين مجموعات سمات إلى متاجر

يمكن إقران مجموعة سمات واحدة أو أكثر بمتجر واحد أو أكثر في التدرج الهرمي للمتاجر. وبعد ذلك، عند تحسين المنتجات لمتاجر مُحددة، فإنها ترث السمات المُضمنة في مجموعات السمات.

1. قم بتسجيل الدخول إلى عميل مكتب الدعم كمدير بضائع.
2. انتقل إلى **البيع بالتجزئة والتجارة** &gt; **إعداد القناة** &gt; **فئات القنوات وسمات المنتج**.
...
يمكن تجاوز القيم الافتراضية للسمات للمنتجات الفردية على مستوى المنتج. يمكن أيضًا تجاوز القيم الافتراضية للمنتجات الفردية في كتالوجات مُعينة مُستهدفة في قنوات معينة.

### <a name="override-the-attribute-values-of-an-individual-product"></a>تجاوز قيم السمات لمنتج فردي

1. قم بتسجيل الدخول إلى عميل مكتب الدعم كمدير بضائع.
2. انتقل إلى **البيع بالتجزئة والتجارة** &gt; **إدارة الفئات والمنتجات** &gt; **المنتجات المُصدرة حسب الفئة**.
...
1. قم بتسجيل الدخول إلى عميل مكتب الدعم كمدير بضائع.
2. انتقل إلى **البيع بالتجزئة والتجارة** &gt; **إدارة الكتالوج** &gt; **جميع الكتالوجات**.
