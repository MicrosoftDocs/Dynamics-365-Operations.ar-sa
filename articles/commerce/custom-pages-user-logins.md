...
1. في الحقل **URI للصفحة المخصصة** ، ادخل عنوان URL لتسجيل الدخول الكامل. ضمن اللاحقة **?preloadscripts=true** . علي سبيل المثال ، أدخل **www.\<المجال الخاص بي\>.com/sign-in?preloadscripts=true**.
