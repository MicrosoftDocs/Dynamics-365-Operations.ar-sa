...
description: يصف هذا المقال تكوين التكلفة لوظيفة إدارة الأوامر الموزعة (DOM) في Dynamics 365 Commerce.
author: josaw1
ms.date: 12/05/2018
ms.topic: index-page
ms.prod: ''
...
يوضح هذا القسم كيفية إعداد كل مجموعة من نوع مكون تكلفة **الشحن** وأساس حساب لتكاليف الشحن. ويوضح أيضًا كيف تستخدم حلول DOM كل مجموعة.
...
يوضح هذا القسم كيفية إعداد كل مجموعة من نوع مكون التكلفة **غير ذلك** ونوع تكلفة آخر للتكاليف غير المرتبطة بالشحن. ويوضح أيضًا كيف تستخدم حلول DOM كل مجموعة.
