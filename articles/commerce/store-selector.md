---
title: وحدة محدد المتجر
description: يتناول هذا المقال وحدة محدّد المتجر ويصف كيفية إضافتها إلى صفحات الموقع في Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268304"
---
# <a name="store-selector-module"></a>وحدة محدد المتجر

[!include [banner](includes/banner.md)]

يتناول هذا المقال وحدة محدّد المتجر ويصف كيفية إضافتها إلى صفحات الموقع في Microsoft Dynamics 365 Commerce.
...
### <a name="hide-a-store-from-the-store-selector-module"></a>إخفاء متجر من وحدة محدد المتجر

قد لا تكون بعض المتاجر في مجموعة تنفيذ عبارة عن مواقع استلام صالحة. للتأكد من أن مواقع التسليم الصالحة هي وحدها التي تظهر كخيارات في وحدة محدد المتجر، اتبع هذه الخطوات في Commerce headquarters.

1. انتقل إلى **البيع بالتجزئة والتجارة \> إعداد التجارة \> مجموعات التنفيذ‬ \> جميع المتاجر**.
1. في جزء الإجراءات، حدد **تحرير**.
1. ضمن **الإعداد**، لكل متجر ليس موقع تسليم صالحًا، قم بإلغاء تحديد خانة الاختيار **هو موقع تسليم**.
1. في جزء الإجراءات، حدد **حفظ**.
1. شغّل جدول توزيع 1070 **تكوين القناة**.
...
لتكوين الوحدة النمطية لمحدد المتجر لإظهار المتاجر المتاحة لصفحة مواقع المتجر، كما في الشكل التوضيحي الذي ظهر في وقت سابقًا في هذا المقال، اتبع الخطوات التالية.
...
1. في مربع الحوار **إنشاء صفحة جديدة** ضمن **اسم الصفحة**، أدخل **أماكن المتجر**، ثم حدد **التالي**.
...
1. في مربع الحوار **تحديد الوحدات**، حدد وحدة ‬‏‫**حاوية مع عمودين‬**، ثم حدد **موافق**.
...
1. في فتحة **حاوية مع عمودين‬‬‏‫‬‬‏‫**، حدد علامة القطع (**...**)، ثم حدد **إضافة وحدة**.
1. في مربع الحوار **تحديد وحدات**، حدد وحدة **الخريطة**، ثم حدد **موافق**.
