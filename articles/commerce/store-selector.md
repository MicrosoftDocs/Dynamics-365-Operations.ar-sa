...
بالنسبة إلى REST API للاقتراح التلقائي، يجب أن تتأكد من أن عناوين URL التالية مسموحة (ما يعرف أيضًا بأنها "مدرجة في قائمة بيضاء") وفق سياسة أمان محتوى الموقع (CSP). يتم اجراء هذا الإعداد في منشئ مواقع Commerce، عن طريق إضافة عناوين URL مسموح بها إلى توجيهات CSP متعددة للموقع (على سبيل المثال، **img-src**). لمزيد من المعلومات، راجع [سياسة أمان المحتوى](manage-csp.md). 
...
يمكن استخدام الوحدة النمطية لمحدد المتجر مع الوحدة النمطية للخريطة لعرض مواقع التخزين علي الخريطة. لمزيد من المعلومات حول الوحدة النمطية للخريطة، راجع [الوحدة النمطية للخريطة‬](map-module.md).
