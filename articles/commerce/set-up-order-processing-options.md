...
description: يوفر هذا المقال معلومات حول كيفية معالجة أوامر مراكز الاتصال باستخدام Dynamics 365 Commerce.
author: josaw1
ms.date: 02/04/2022
ms.topic: article
ms.prod: ''
...
قبل إمكانية معالجة مبيعات بشكل صحيح من خلال قناة مركز اتصال، قم بتصحيح [طرق الدفع](/dynamics365/unified-operations/retail/work-with-payments) ويجب تحديد أوضاع تسليم للقناة.
...
بالإضافة إلى ذلك، في حالة تشغيل إعداد **تمكين إكمال الأمر**، عندما يقوم المستخدمون بإنشاء أوامر مبيعات يكونون في وضع إدخال صنف البند، فسيتوفر حقل **المصدر** في عنوان أمر المبيعات الرئيسي. يتم استخدام حقل **المصدر** لالتقاط [كود مصدر كتالوج](/dynamics365/unified-operations/retail/call-center-catalogs) في سيناريو بيع تسويق مباشر. يمكن لهذا الكود بعد ذلك جلب الأسعار والعروض الترويجية الخاصة.
...
> [!NOTE]
> عند تمكين ميزة **مدفوعات أمر Commerce في القناة متعددة الاتجاهات‬**، سيكون زر مركز الاتصال **تمكين إكمال الأوامر‬** مخفيًا في المركز الرئيسي على علامة التبويب السريعة **عام** لقناتك في **البيع بالتجزئة والتجارة \> القنوات \> مراكز الاتصال**.
