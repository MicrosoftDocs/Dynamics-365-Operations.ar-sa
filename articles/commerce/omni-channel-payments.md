---
title: نظرة عامة على مدفوعات القناة متعددة الاتجاهات
description: يوفر هذا المقال نظرة عامة على دفعات القناة متعددة الاتجاهات في Dynamics 365 Commerce.
author: BrianShook
ms.date: 11/04/2020
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "9746115"
---
# <a name="omni-channel-payments-overview"></a>نظرة عامة على مدفوعات القناة متعددة الاتجاهات

[!include [banner](../includes/banner.md)]
[!include [banner](../includes/preview-banner.md)]

يوفر هذا المقال نظرة عامة على دفعات القناة متعددة الاتجاهات في Dynamics 365 Commerce. يتضمن قائمة شاملة من السيناريوهات المدعومة ، ومعلومات حول الوظيفة ، والإعداد ، واستكشاف الأخطاء وإصلاحها ، ووصف لبعض المشاكل المعتادة.

## <a name="key-terms"></a>المصطلحات الأساسية

| الفصل الدراسي | الوصف |
|---|---|
| الرمز المميز | سلسلة من البيانات التي يوفرها معالج الدفع كمرجع. يمكن أن تمثل الرموز أرقام بطاقات الدفع وتفويضات الدفع والتقاطات الدفع السابقة. الرموز المميزة مهمة لأنها تساعد في الحفاظ على البيانات الحساسة خارج نظام نقطة البيع (POS). ويُشار إليها أحيانًا *كمراجع*. |
...
يمكن تنفيذ جميع السيناريوهات الموضحة في هذا المقال باستخدام مجموعة تطوير برامج المدفوعات (SDK) القياسية التي يتم توفيرها مع Commerce. يوفر [موصل دفع Dynamics 365 لـ Adyen‬](/dynamics365/unified-operations/retail/dev-itpro/adyen-connector?tabs=8-1-3) تطبيقًا مبتكرًا لكل سيناريو موصوف هنا. 

### <a name="prerequisites"></a>المتطلبات الأساسية

يتطلب كل سيناريو موصوف في هذا المقال موصل دفع يدعم دفعات القناة متعددة الاتجاهات. يمكن أيضًا استخدام موصل Adyen مبتكر لأنه يدعم السيناريوهات التي يتم توفيرها من خلال دفعات SDK. لمزيد من المعلومات حول كيفية تنفيذ موصلات الدفع، وحول Retail SDK بشكل عام، يُرجى زيارة[الصفحة الرئيسية للبيع بالتجزئة لمحترفي تكنولوجيا المعلومات والمطورين](/dynamics365/unified-operations/retail/dev-itpro/dev-retail-home-page#payment-connectors).

#### <a name="supported-versions"></a>الإصدارات المدعومة

تم إصدار إمكانات الدفع للقناة متعددة الاتجاهات الموضحة في هذا المقال كجزء من إصدار Microsoft Dynamics 365 for Retail رقم 8.1.3. 
...
12. بعد دفع الإيداع ، حدد خيار استخدام نفس البطاقة للوفاء ، وانتظر حتى يكتمل الأمر. إذا تم دفع 100% من الإيداع (من الخطوة 10 أعلاه)، سيتم الحصول على الأموال مباشرة مقابل البطاقة ولن يكون الرمز المميز للمصادقة متاحًا عند الفوترة نظرًا لأنه تم بالفعل الحصول على الأموال وتعقبها كمدفوعة.
...
11. بعد دفع الإيداع ، حدد خيار استخدام نفس البطاقة للوفاء ، وانتظر حتى يكتمل الأمر. إذا تم دفع 100% من الإيداع (من الخطوة 9 أعلاه)، سيتم الحصول على الأموال مباشرة مقابل البطاقة ولن يكون الرمز المميز للمصادقة متاحًا عند الفوترة نظرًا لأنه تم بالفعل الحصول على الأموال وتعقبها كمدفوعة.
...
إذا لم تعد البطاقة التي تم استخدامها لإنشاء أمر صالحة، عند اختيار المنتجات للاستلام، فسيفشل طلب التقاط الدفع. سيحاول موصل الدفع نقطة البيع إنشاء ترخيص جديد والالتقاط باستخدام تفاصيل البطاقة نفسها. في حالة فشل التخويل الجديد أو الحصول على الدفعة، سيتم إبلاغ الصراف بأنه لا يمكن معالجة الدفعة. ويجب على الكاشير الحصول على دفعة جديدة من العميل. 
