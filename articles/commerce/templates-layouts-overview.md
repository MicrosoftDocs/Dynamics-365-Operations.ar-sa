...
description: يغطي هذا المقال القوالب والتخطيطات في Microsoft Dynamics 365 Commerce.
author: phinneyridge
ms.date: 10/26/2022
ms.topic: overview
ms.prod: ''
...
### <a name="relationship-between-template-defaults-and-page-content"></a>العلاقة بين افتراضيات القوالب ومحتوى الصفحة
