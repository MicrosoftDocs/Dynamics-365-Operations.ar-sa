---
title: تحميل ملفات غير الصور ومقاطع الفيديو
description: يصف هذا المقال كيفية تحميل ملفات ثنائية غير الصور ومقاطع الفيديو في منشئ موقع Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 03/03/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9282204"
---
# <a name="upload-files-other-than-images-and-videos"></a>تحميل ملفات غير الصور ومقاطع الفيديو

[!include [banner](includes/banner.md)]

يصف هذا المقال كيفية تحميل ملفات غير الصور ومقاطع الفيديو في منشئ موقع Microsoft Dynamics 365 Commerce.
...
## <a name="upload-a-file"></a>تحميل ملف

لتحميل ملف إلى منشئ موقع Commerce، اتبع الخطوات التالية.

1. في جزء التنقل الأيسر، حدد **مكتبة الوسائط**.
1. في شريط الأوامر، حدد **تحميل \> تحميل عناصر الوسائط**.
1. في "مستكشف الملفات"، حدد ملفًا أو أكثر، ثم حدد **فتح**.
1. في مربع الحوار **تحميل عنصر الوسائط**، أدخل بيانات تعريف العنوان والوصف والكلمات الأساسية كما تقتضي الحاجة.
1. لنشر الملف (الملفات) مباشرةً بعد التحميل، حدد خانه الاختيار **نشر عناصر الوسائط بعد التحميل**.
1. حدد **موافق**.
