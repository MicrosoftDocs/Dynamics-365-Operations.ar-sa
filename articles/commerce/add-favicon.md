...
description: ‏‫يوضح هذا المقال كيفية إضافة أيقونة مفضلة إلى الموقع الخاص بك.‬
...
ms.locfileid: "9270427"
---
# <a name="add-a-favicon"></a>إضافة أيقونة المفضلة

[!include [banner](includes/banner.md)]

‏‫يوضح هذا المقال كيفية إضافة أيقونة مفضلة إلى الموقع الخاص بك.‬
...
على الرغم من أنه يُمكنك إضافة عدة أيقونات للمفضلة بأحجام مختلفة وأنواع ملفات إلى موقعك، ويوضح هذا المقال كيفية إضافة أيقونة مفضلة واحدة. ولكن، يتم استخدام نفس العملية والموقع لإضافة أكثر من أيقونة المفضلة.
