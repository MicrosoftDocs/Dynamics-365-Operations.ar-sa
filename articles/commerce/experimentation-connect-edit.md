...
يصف هذا الموضوع كيفيه توصيل التجربة الخاصة بك في التجارة واجراء تغييرات علي التباينات الخاصة بك بحيث تتم محاذاتها مع الفرضية الخاصة بك. يوضح الرسم التخطيطي التالي كافة الخطوات المتضمنة في اعداد وتشغيل تجربه علي أحد مواقع التجارة الالكترونيه في Dynamics 365 Commerce. وتتم تغطيه الخطوات الاضافيه في موضوعات منفصلة.
...
1. لبدء تشغيل المعالج ، حدد علامة التبويب **التجارب** في منشئ الموقع ثم حدد ' **توصيل** . بدلا من ذلك، يمكن الوصول إلى المعالج من صفحه أو محرر جزء. في وضع التحرير، حدد **توصيل التجربة** في شريط الأوامر.
