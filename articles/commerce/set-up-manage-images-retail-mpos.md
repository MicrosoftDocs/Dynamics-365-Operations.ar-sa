...
> [!NOTE]
> يتم تقديم الصور التي يمكن الوصول إليها بشكل عام وبشكل مجهول على نقطة البيع. تدعم نقطة البيع تقديم الصور التي يتم استضافتها خارجيًا، مع المتطلبات التي يتم إرجاعها للصور كدفق ثماني بتات مضمن للحصول على طلبات بدون عناوين. باستخدام نهج الوصول المجهول، فإن الصور التي يستضيفها SharePoint خصيصًا تتطلب أن تحتوي عناوين الطلبات على عناوين المضيف والمستخدم ، وسيتم إرجاع الرد "ممنوع". وبالتالي، فإن إدارة الصور باستخدام SharePoint كمضيف غير مدعومة حاليًا. لا تعرض صفحة المعرض **صور الكتالوج** معاينات الصور لعنواين URL لصور قالب الوسائط. لأن عملاء Commerce Scale Unit (CSU) يعرضون صورة واحدة فقط لكل كتالوج وعميل وعامل وكيان الفئة، إذا كنت توفر بشكل صريح عنوان URL من خلال هذه الصفحة بالنسبة لكيانات الكتالوج والعامل والعميل والفئة، فإننا نوصي بأن تشير إلى الصورة التكون الصورة افتراضية. إذا كنت لا تحدد صورة افتراضية، يقوم النظام بتحديد الصورة الافتراضية ويرسلها إلى مستدعي خدمات Commerce (نقطة البيع الحديثة أو التجارة الإلكترونية).
