...
### <a name="additional-local-product-search-capabilities-conventional-sql-full-text-search"></a>قدرات بحث المنتج المحلي الاضافيه (البحث عن النص التقليدي ل SQL) 
...
> [!NOTE]
> ان التكوينات التالية **لمطابقه اي مصطلح بحث**/**مطابقه لكافة مصطلحات البحث** في ملفات تعريف وظائف نقطه البيع تنطبق فقط علي عمليات البحث عن المنتجات **المحلية** (البحث عن النص الكامل ل SQL text). ليس لهذا التكوين اي تاثير علي تجارب البحث المشغلة إلى السحابة. يحتوي محرك البحث الجديد علي خوارزميه متقدمة لأسس صله البحث الخاصة بنتائج البحث عن المنتج. 
...
تكون ترجمات الاختصارات مطلوبة إذا كنت تريد عرض الاختصارات على نقطة البيع. إذا كانت لغة قناتك مختلفة عن لغة النظام الافتراضية، فيجب عليك تحديد الترجمة لكل اختصار باللغة المتوقعة. يمكنك تحديد الترجمات عن طريق تحديد **ترجمة** لكل اختصار. 
