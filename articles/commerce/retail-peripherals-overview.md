...
عملاء نقطة البيع الحديثة لـ Windows وAndroid يشملون محطات **التخصيص** أو الأجهزة المضمنة. يمكن لهؤلاء العملاء الاتصال مباشره مع الاجهزه الطرفية باستخدام منطق الاعمال المضمن في التطبيقات. يدعم تطبيق Android أجهزه الشبكة فقط. لمزيد من المعلومات حول دعم الأجهزة الطرفية لـ Android ، يُرجى زيارة مقالة [إعداد تطبيق نقطة البيع المختلط على Android و iOS](https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/hybridApp) .
...
لمزيد من المعلومات، راجع [تثبيت تطبيق نقطة البيع المختلط على Android وiOS](https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/hybridApp).
...
4.  انقر فوق **Retail and Commerce** &gt; **تكنولوجيا معلومات البيع بالتجزئة والتجارة** &gt; **جدول التوزيع**.
...
**جديد لـ 10.0.8** طابعات شبكة Epson والادراج النقدية المتصلة بهذه الطابعات من خلال DK منفذ معتمده حاليا لتطبيق نقاط البيع الحديثة لـ Android. لمزيد من التفاصيل، يُرجى زيارة [إعداد تطبيق نقطة البيع الحديثة المختلط على Android و iOS](https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/hybridApp) .
...
5.  انقر فوق **Retail and Commerce** &gt; **تكنولوجيا معلومات البيع بالتجزئة والتجارة** &gt; **جدول التوزيع**.
...
> [!NOTE]
> إذا كانت الأجهزة تستخدم محطات أجهزة مختلفة في أغلب الأحيان، فمن المستحسن تكوين نقطة بيع حديثة لمطالبة الصرافين بتحديد محطة أجهزة عند بدء عملية تحديد الدفع. انقر فوق  **Retail and Commerce** &gt; **إعداد القناة** &gt; **إعداد نقطة البيع** &gt; **السجلات**. حدد السجل، ثم عيّن الخيار **تحديد عند الدفع‬** إلى **نعم**. استخدم جدول التوزيع **1090** لمزامنة التغييرات إلى قاعدة بيانات القناة.
