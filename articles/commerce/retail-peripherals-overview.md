...
**جديد لـ 10.0.8** طابعات شبكة Epson والادراج النقدية المتصلة بهذه الطابعات من خلال DK منفذ معتمده حاليا لتطبيق نقاط البيع الحديثة لـ Android. لمزيد من التفاصيل، يُرجى زيارة [إعداد تطبيق نقطة البيع الحديثة المختلط على Android و iOS](./dev-itpro/hybridapp.md) .
