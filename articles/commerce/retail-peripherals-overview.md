...
التنقل: انقر فوق **Retail and Commerce** &gt; **إعداد القناة** &gt; **إعداد نقطة البيع** &gt; **ملفات تعريف نقطة البيع** &gt; **ملفات تعريف الأجهزة**. يُعتبر ملف تعريف الأجهزة قائمة تتضمن الأجهزة التي تم تكوينها لسجل نقطة البيع أو محطة أجهزة. يمكن تعيين ملفا تعريف الأجهزة بشكل مباشر إلى سجل نقطة بيع أو إلى محطة أجهزة.
...
عملاء نقطة البيع الحديثة لـ Windows وAndroid يشملون محطات **التخصيص** أو الأجهزة المضمنة. يمكن لهؤلاء العملاء الاتصال مباشره مع الاجهزه الطرفية باستخدام منطق الاعمال المضمن في التطبيقات. يدعم تطبيق Android أجهزه الشبكة فقط. لمزيد من المعلومات حول دعم الأجهزة الطرفية لـ Android، يُرجى زيارة مقالة (إعداد تطبيق نقطة البيع المختلط على Android وiOS)[https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/hybridApp].

لاستخدام محطة الأجهزة المخصصة، يجب تعيين ملف تعريف أجهزة إلى سجل سيستخدم تطبيق نقطة البيع الحديثة لتطبيقات Windows أو Android. بعد ذلك، أنشئ محطة أجهزة من النوع **مخصص** للمتجر حيث سيتم استخدام السجل. يمكنك بدء تشغيل النقطة الحديثة في وضع الورق بدون درجات واستخدام عملية **إدارة محطات الأجهزة** لتشغيل إمكانات محطة الأجهزة، ستكون محطه الاجهزه المخصصة نشطه افتراضيا. بعد ذلك ، قم بتسجيل الخروج من نقطه البيع الحديثة ، ثم قم بتسجيل الدخول مره أخرى وفتح الوردية ستكون الاجهزه الطرفية المكونة في ملف تعريف الأجهزة قابله للاستخدام. 

### <a name="shared"></a>مشترك 

ويشار أحيانا إلى ذلك باسم محطه الاجهزه "IIS" ، ويتضمن "IIS" أن تطبيق نقطه البيع الحديثة تتصل بمحطه الاجهزه من خلال Microsoft Internet Information Services. يتصل تطبيق نقطة البيع بمحطة أجهزة IIS عبر خدمات الويب التي يتم تشغيلها على جهاز كمبيوتر حيث تم توصيل الأجهزة. عند استخدام محطة الأجهزة المشتركة، يمكن استخدام الأجهزة الطرفية للبيع بالتجزئة المتصلة بمحطة أجهزة من قِبل أي سجل نقطة بيع موجود على الشبكة نفسها حيث محطة أجهزة IIS. ولأن نقاط البيع الحديثة لنظام Windows وAndroid وحدها تتضمن الدعم المضمن للأجهزة الطرفية للبيع بالتجزئة، فإن كافة التطبيقات الأخرى لنقاط البيع الحديثة يجب أن تستخدم محطة أجهزة IIS للتواصل مع الأجهزة الطرفية لنقطة البيع التي تم تكوينها في ملف تعريف الأجهزة. وبالتالي، يحتاج كل مثيل لمحطة أجهزة IIS إلى جهاز كمبيوتر يقوم بتشغيل خدمة ويب والتطبيق الذي يتواصل مع الأجهزة. 

يمكن استخدام محطه الاجهزه المشتركة للسماح لعملاء البيع بالنقاط المتعددة بمشاركه الاجهزه الطرفية أو يمكن استخدامها لأداره مجموعه أو أجهزه طرفيه مخصصه لنقطه بيع واحده. 
...
للحصول على معلومات، راجع [تثبيت وتكوين محطة الأجهزة](retail-hardware-station-configuration-installation.md).

### <a name="modern-pos-for-windows-setup-and-configuration"></a>إعداد وتكوين نقطة البيع الحديثة لنظام التشغيل Windows

لمزيد من المعلومات، راجع [تكوين وتثبيت وتنشيط Retail Modern POS](retail-modern-pos-device-activation.md).
...
لمزيد من المعلومات (تثبيت تطبيق نقطة البيع المختلط على Android وiOS)[https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/hybridApp].
...
### <a name="all-modern-pos-clients-shared-an-iis-hardware-station"></a>توجد محطة أجهزة IIS مشتركة لدى كل عملاء نقطة البيع الحديثة
...
4.  انقر فوق **Retail and Commerce** &gt; **تكنولوجيا معلومات البيع بالتجزئة** &gt; **جدول التوزيع**.
...
**جديد لـ 10.0.8** طابعات شبكة Epson والادراج النقدية المتصلة بهذه الطابعات من خلال DK منفذ معتمده حاليا لتطبيق نقاط البيع الحديثة لـ Android. لمزيد من التفاصيل، يُرجى زيارة (إعداد تطبيق نقطة البيع الحديثة المختلط على Android وiOS)[https://docs.microsoft.com/en-us/dynamics365/commerce/dev-itpro/hybridApp].
...
3.  على محطة الأجهزة المخصصة، يمكنك تعيين الخصائص التالية:
    ...
    **ملاحظة:** باستطاعة نقطة بيع المجموعة حل **localhost** لتحديد الكمبيوتر المحلي حيث يتم تشغيل نقطة بيع المجموعة. ومع ذلك، يجب أن تتضمن أيضًا الشهادة المطلوبة من أجل إقران نقطة البيع بمحطة الأجهزة "Localhost" كاسم الكمبيوتر. لتجنب المشكلات، نوصي بأن تدرج مثيلاً لكل محطة أجهزة مخصصة للمتجر، كما هو مطلوب. لكل محطة أجهزة، يجب أن يكون اسم المضيف اسم الكمبيوتر المحدد حيث سيتم نشر محطة الأجهزة.
...
9.  قم بتثبيت وتنشيط نقطة بيع حديثة. لمزيد من المعلومات حول كيفية تثبيت نقطة بيع حديثة، راجع [تكوين وتثبيت وتنشيط نقطة البيع الحديثة للبيع بالتجزئة (MPOS)](retail-modern-pos-device-activation.md).
...
**ملاحظة:** سيجعل مثبت محطة الأجهزة عمليات تحرير السجل هذه جزءًا من عملية التثبيت من خلال الخدمة الذاتية بشكل تلقائي.

-   يجب تعطيل طبقة مآخذ التوصيل الآمنة (SSL).
-   يجب تمكين واستخدام فقط أمان طبقة النقل (TLS) الإصدار 1.2 (أو الإصدار الأعلى الحالي). 

**ملاحظة:** بشكل افتراضي، يكون كل من SSL وكل إصدار من TLS باستثناء TLS 1.2 معطلاً. لتحرير هذه القيم أو تمكينها، اتبع الخطوات التالية:
...
| Epson        | Tm-T88IV | OPOS      |                         |
| Epson        | TM-T88V  | OPOS      |                         |
| Epson        | TM-T88   | مخصص    | متصل عبر الشبكة   |
...
| Epson        | Tm-T88IV | OPOS      |                           |
| Epson        | TM-T88V  | OPOS      |                           |
| Epson        | TM-T88V  | مخصص    | متصل عبر الشبكة     |
| Star         | TSP650II | مخصص    | متصل عبر الشبكة     |
| HP           | F7M67AA  | OPOS      | USB مزود بالطاقة               |
