...
1. انتقل إلى **القوالب**، وقم بإنشاء قالب صفحة يسمي **قالب كتلة محتوى**.
1. في الفتحة **الرئيسية** للصفحة الافتراضية، قم بإضافة الوحدة النمطية الرئيسية.
1. قم بإيداع القالب ونشره.
1. استخدم القالب الرئيسي الذي قمت بإنشائه للتو لإنشاء صفحة تُسمى **صفحة كتلة المحتوى**.
