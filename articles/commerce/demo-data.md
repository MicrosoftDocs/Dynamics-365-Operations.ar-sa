...
description: يقدم هذا المقال معلومات حول تخطيطات الشاشة المضمنة مع بيانات العرض التوضيحي المعينة لتجارب نقطة البيع (POS) في Dynamics 365 Commerce.
author: josaw1
ms.date: 10/05/2017
ms.topic: article
ms.prod: ''
...
يقدم هذا المقال معلومات حول تخطيطات الشاشة المضمنة مع بيانات العرض التوضيحي المعينة لتجارب نقطة البيع (POS) في Dynamics 365 Commerce.

## <a name="overview"></a>نظرة عامة

تقدم نماذج تخطيطات الشاشة المضمنة مع بيانات العرض التوضيحي للتجارة المحتوى المُحسّن لمجموعة متنوعة من قطاعات البيع بالتجزئة وأدوار العاملين بالمتاجر والأجهزة. يمكن أن يحتوي تخطيط واحد على عدة أحجام للتخطيطات ومجموعات من شبكات الأزرار للمساعدة في ضمان التغطية مع تنقل عاملي المتجر بين الأجهزة والمحطات. يوضح هذا المقال الاختلافات بين هذه التخطيطات والعمليات التي توفرها والتجارب العامة التي تقدمها.
...
![‏‫تخطيطات بيانات العرض التوضيحي ل Contoso.](../commerce/media/demo-screen-layouts-fig-4-3.png)
