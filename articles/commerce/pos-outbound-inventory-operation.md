...
إذا قمت بتمكين المعلمة **تمكين التحقق من الصحة التلقائي** إلى **نعم** في **معلمات Commerce** > **المخزون** > **مخزون المتجر‬**، يتم تنفيذ التحقق من الصحة بشكل تلقائي عندما تحدد الوظيفة **إنهاء التنفيذ**.
