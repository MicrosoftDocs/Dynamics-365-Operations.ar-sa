---
title: عملية المخزون الخارجية في نقطة البيع
description: يصف هذا المقال إمكانيات عمليه المخزون الخارجية لنقطه البيع (POS).
author: hhaines
ms.date: 07/30/2020
ms.topic: article
ms.prod: ''
...
يحدث التحقق من الصحة أثناء عملية تنفيذ بنود المستند. وتتضمن عمليات التحقق من الصحة التسليم بالزيادة. إذا حاول مستخدم شحن كمية من المخزون تزيد عن تلك التي تم طلبها في أمر تحويل، ولكن لم يتم تكوين التسليم بالزيادة أو أن الكمية التي تم شحنه تجاوزت حد التسامح في التسليم بالزيادة الذي تم تكوينه لبند أمر التحويل، فسيستلم المستخدم خطًا ولن يُسمح له بشحن الكمية الزائدة.
