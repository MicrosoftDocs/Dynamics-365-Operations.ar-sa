...
4. على علامات التبويب السريعة لمختلف أنواع الأجهزة، يمكنك إعداد أنواع الأجهزة التالية.
    ...
    |---|---|---|---|
    | الطابعة | احتياطي | **Epson** أو **Star** | اسم الجهاز حساس لحالة الأحرف. يجب أن يكون **معرف ملف تعريف الإيصال** هو نفسه **معرف ملف تعريف الإيصال** المعيّن إلى طابعة الشبكة التي تم إعدادها في ملف تعريف الأجهزة المعيّن إلى محطة الأجهزة على مستوى القناة. |
...
6. في الحقل **ملف تعريف الأجهزة**، حدد ملف تعريف الأجهزة‏‎</1>‎‏ الذي أنشأته في وقت سابق لطابعة الإيصالات ودرج الأوراق النقدية.
7. حدد **حفظ**.
