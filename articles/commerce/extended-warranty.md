...
description: يغطي هذا المقال الضمانات الموسّعة ويصف كيفية إنشائها وتكوينها في Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 06/08/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268358"
---
# <a name="create-and-configure-extended-warranties"></a>إنشاء الضمانات الموسعة وتكوينها

[!include [banner](includes/banner.md)]

يغطي هذا المقال الضمانات الموسّعة ويصف كيفية إنشائها وتكوينها في Microsoft Dynamics 365 Commerce.
...
1. من صفحة **تفاصيل المنتج** في علامة التبويب السريعة **الضمان** قم بتعيين الحقلين **وحدة الوقت** و **المدة الزمنيه**.
    ...
    ![صفحة تفاصيل المنتج لصنف ضمان.](./media/ew-time-properties.png)
...
1. في صفحة **‏‫تفاصيل المنتج الذي تم إصداره‬** في علامة التبويب السريعة **الضمان** قم بتعيين الحقول **قاعدة نطاق الأسعار** و **الحد الأدنى** و **‏‫الحد الأعلى‬**.
    ...
    ![صفحة تفاصيل المنتج الذي تم إصداره‬ لصنف ضمان.](./media/ew-release-product-details.png)
...
![مثال لمطالبة بإضافة صنف ضمان لعملية الشراء الحالية.](./media/ew-sell-warranty.png)

يبين الرسم التوضيحي التالي مثالا للميزة لإضافة صنف ضمان لصنف قابل للضمان تم بيعه مسبقا.

![مثال للميزة لإضافه صنف ضمان لصنف قابل للضمان تم بيعه سابقا.](./media/ew-add-warranty-existing.png)
