---
title: إعداد موقع التجارة الإلكترونية لمتاجرة عمل-عمل
description: يوضح هذا المقال كيفية إعداد موقع التجارة الإلكترونية بين الشركات (B2B) في Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 12/03/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8881896"
---
# <a name="set-up-a-b2b-e-commerce-site"></a>إعداد موقع التجارة الإلكترونية بين الشركات

[!include [banner](../../includes/banner.md)]

توفر مواقع التجارة الإلكترونية بين الشركات (B2B) بعض الإمكانات الأساسية التي تُحسِّن سير العمل لمستخدم B2B. يوضح هذا المقال كيفيه إعداد موقع التجارة الإلكترونية بين الشركات (B2B) في Microsoft Dynamics 365 Commerce. يتطرق إلى الوحدات النمطية وإعدادات الموقع التي يجب تكوينها لتمكين سيناريوهات خاصة بالتعامل بين الشركات B2B.

## <a name="prerequisites"></a>المتطلبات الأساسية

- لإعداد موقع التجارة الإلكترونية بين الشركات B2B، يجب تمكين ميزات معينة وتكوينها في Commerce headquarters، كما هو موضح في هذا المقال.
...
- يفترض هذا المقال ان مؤلفي الموقع يفهمون أساسيات منشئ مواقع Commerce والقوالب والأجزاء والصفحات بحيث يمكنهم تمكين ميزات B2B لمواقع التجارة الإلكترونية.
...
- **تمكين مدفوعات حساب العميل** -تمكن هذه الخاصية المستخدمين من الدفع للأوامر باستخدام حسابات العملاء. والقيم المتوفرة هي **تمكين لعملاء B2B**، و **تمكين لعملاء B2C** و **تمكين لجميع العملاء**، و **تعطيل لجميع العملاء**. إذا كان موقع B2B الخاص بك يدعم حسابات العملاء، فعليك تحديد **تمكين لعملاء B2B**.
...
## <a name="add-a-bulk-purchase-module-to-a-product-details-page"></a>إضافة وحدة نمطية للشراء المجمع لصفحة تفاصيل المنتج

توفر الوحدة النمطية للشراء المجمع في صفحة تفاصيل المنتج (PDP) تجربة مستندة إلى مصفوفة تتيح للمشتري إضافة عدة متغيرات لمنتج إلى سلة التسوق بسرعة. عندما يجب على أحد مستخدمي الموقع ترتيب عدة متغيرات لنفس المنتج، فإن هذه التجربة تلغي الحاجة إلى تحديد مجموعة أبعاد المنتج، وتحديد الكمية، وإضافة المتغير إلى سلة التسوق، ثم كرر العملية لمجموعات أخرى من أبعاد المنتج.

لإضافة وحدة نمطية للشراء المجمع إلى صفحة تفاصيل المنتج (PDP) في منشئ موقع Commerce، اتبع الخطوات التالية.

1. انتقل إلى **القوالب**، وحدد قالب PDP في الموقع الخاص بك.
1. حدد **تحرير**.
1. في الفتحة **الرئيسية‏‎** في وحدة **الصفحة الافتراضية**، حدد علامة القطع (**...**)، ثم حدد **إضافة وحدة**.
1. في مربع الحوار **إضافة وحدة**، حدد وحدة ‬‏‫**الحاوية‬**، ثم حدد **موافق**.
1. في فتحة **الحاوية‬‬‏‫**، حدد علامة القطع (**...**)، ثم حدد **إضافة وحدة**.
1. في مربع الحوار **إضافة وحدة**، حدد وحدة **الشراء المجمع‬**، ثم حدد **موافق**.
1. حدد **حفظ**، وحدد **إنهاء التحرير** لإيداع القالب، ثم حدد **نشر** لنشره.
1. انتقل إلى **الصفحات**، وحدد صفحة تفاصيل المنتج (PDP) في الموقع الخاص بك.
1. في الفتحة **الرئيسية‏‎** في وحدة **الصفحة الافتراضية**، حدد علامة القطع (**...**)، ثم حدد **إضافة وحدة**.
1. في مربع الحوار **إضافة وحدة**، حدد وحدة ‬‏‫**الحاوية‬**، ثم حدد **موافق**.
1. في جزء الخصائص لوحدة **الحاوية**، ضمن **العرض**، حدد **ملء الحاوية**.
1. في فتحة **الحاوية‬‬‏‫**، حدد علامة القطع (**...**)، ثم حدد **إضافة وحدة**.
...
> [!NOTE] 
> تتوفر وحدة الشراء المجمع اعتبارًا من إصدار 10.0.24 من Commerce. إذا كنت تقوم بالتحديث من إصدار قديم من Commerce، فيجب عليك تحديث ملف appsettings.json يدويًا. للاطلاع على التعليمات، راجع [تحديثات مكتبة الوحدات وSDK](../e-commerce-extensibility/sdk-updates.md#update-the-appsettingsjson-file).
