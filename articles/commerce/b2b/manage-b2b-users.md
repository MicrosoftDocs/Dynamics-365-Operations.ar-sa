...
بعد اعتماد الطلب، ومزامنة سجلات العميل والتسلسل الهرمي للعميل مع قاعدة بيانات القناة، يمكن للطالب تسجيل الدخول إلى موقع ويب التجارة الإلكترونية بين الشركات B2B باستخدام عنوان البريد الإلكتروني الذي قام بتقديمه عند إرسال الطلب. يمكن للمستخدمين استخدام سير عمل التسجيل لتعريف كلمة المرور للحساب الخاص بهم. لتمكين ربط سجل موفر الهوية Azure AD (B2C) بسجل عميل B2B الذي تم إنشاؤه عند التسجيل أو تسجيل الدخول، اتبع الإرشادات الموجودة في [تمكين الربط التلقائي لسجلات الهوية بحسابات العملاء](../identity-record-linking.md).

## <a name="notify-b2b-prospects-when-they-are-approved-or-rejected"></a>اعلام العملاء المتوقعين في الB2B عند اعتمادهم أو رفضهم

عند اعتماد طلب إلحاق العميل المتوقع لB2B أو رفضه ، يمكنك إرسال اخطار بريد الكتروني إلى العميل المتوقع تلقائيا. 

لاعداد اعلامات البريد الكتروني في الاداره التجارية لاحداث نوع الاخطار الخاص بالعملاء المتوقعين في B2B أو الذي تم رفضه من B2B ، اتبع الخطوات التالية.

1. إنشاء قوالب البريد الكتروني لرسائل البريد الكتروني التي سيتم إرسالها إلى العملاء المتوقعين عند تشغيل نوع اخطار العميل المتوقع ل B2B أو الذي تم رفضه من B2B.

    للحصول علي معلومات حول العناصر النائبة التي اعتمدها العملاء المتوقعون في B2B والعملاء المتوقعين الذين تم رفضهم اعتماد أنواع الاخطار ، راجع [أنواع الاخطار](../email-templates-transactions.md#notification-types). لمزيد من المعلومات حول كيفيه إنشاء قوالب البريد الكتروني ، راجع [إنشاء قالب بريد الكتروني](../email-templates-transactions.md#create-an-email-template). 

1. أضافه أنواع الإخطارات التي رفضها العميل المتوقع للمؤسسة والتي وافقت علي العميل إلى ملف تعريف اخطار البريد الكتروني ، وتعيينها إلى قوالب البريد الكتروني التي قمت بإنشاءها. للحصول علي مزيد معلومات حول كيفيه اعداد ملفات تعريف إخطارات البريد الكتروني ، راجع [اعداد ملف تعريف لإخطار بالبريد الإلكتروني](../email-notification-profiles.md). 
...
بعد مزامنة سجل العميل، يتم تعيين حالة المستخدم في موقع ويب التجارة الإلكترونية بين الشركات B2B إلى **نشط** ، ويمكن للمستخدم الجديد تسجيل الدخول إلى موقع ويب التجارة الإلكترونية بين الشركات B2B باستخدام عنوان البريد الإلكتروني الخاص به. يمكن للمستخدمين استخدام سير عمل التسجيل لتعريف كلمة المرور للحساب الخاص بهم. لتمكين ربط سجل موفر الهوية Azure AD (B2C) بسجل عميل B2B الذي تم إنشاؤه عند التسجيل أو تسجيل الدخول، اتبع الإرشادات الموجودة في [تمكين الربط التلقائي لسجلات الهوية بحسابات العملاء](../identity-record-linking.md).
