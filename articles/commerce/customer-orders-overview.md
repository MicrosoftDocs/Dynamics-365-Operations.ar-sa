...
description: يقدم هذا المقال معلومات حول أوامر العميل في نقطة البيع (POS). تُعرف أوامر العملاء أيضًا بالأوامر الخاصة. يشمل المقال مناقشة المحددات ذات الصلة وتدفقات الحركة.
author: josaw1
ms.date: 08/02/2021
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8850372"
---
# <a name="customer-orders-in-point-of-sale-pos"></a>أوامر العميل في نقطة البيع (POS)

[!include [banner](includes/banner.md)]

يقدم هذا المقال معلومات حول كيفية إنشاء أوامر العميل وإدارتها في تطبيق نقطة البيع (POS). يمكن استخدام أوامر العميل لالتقاط المبيعات حيث يرغب المتسوقون في استلام المنتجات في تاريخ لاحق أو استلام المنتجات من موقع آخر أو الطلب أن يتم شحن الأصناف إليهم. 
...
- **استخدام التكاليف التلقائية المتقدمة**- قم بتعيين هذا الخيار إلى **نعم** لاستخدام التكاليف التلقائية المحتسبة بواسطة النظام عند إنشاء أوامر العميل في نقطة البيع. ويمكن استخدام هذه التكاليف التلقائية لحساب رسوم الشحن أو التكاليف الأخرى الخاصة بالأمر أو الأصناف. للحصول على معلومات حول كيفية إعداد واستخدام ميزة التكاليف التلقائية المتقدمة، راجع [التكاليف التلقائية المتقدمة ‬في القناة متعددة الاتجاهات](./omni-auto-charges.md).
...
تأكد من تكوين [تخطيط شاشة](./pos-screen-layouts.md) نقطة البيع لدعم إنشاء وإدارة أوامر العميل، ومن تكوين كافة عمليات نقطة البيع المطلوبة. فيما يلي بعض عمليات نقطة البيع الموصي بها لدعم إنشاء وإدارة أوامر العميل بشكل صحيح:
...
- **نقل منتجات محددة** – تُستخدم العملية لتحديد أنه سيتم نقل بنود محددة في سلة الحركة بواسطة العميل عند الشراء. تعتبر هذه العملية فقط في حالة [الأوامر المختلطة](./hybrid-customer-orders.md).
...
> [!IMPORTANT]
> لا يمكن تحرير كافة أوامر البيع بالتجزئة من خلال تطبيق نقطة البيع. لا يمكن تحرير الأوامر التي يتم إنشاؤها في قناة مركز الاتصال من خلال نقطع البيع إذا تم تشغيل الإعداد [تمكين إكمال الأوامر‬](./set-up-order-processing-options.md#enable-order-completion) لقناة مركز الاتصال. لضمان معالجة الدفع بشكل صحيح، يجب تحرير الأوامر التي تم إنشاؤها في قناة مركز الاتصال والتي تستخدم وظيفة "تمكين إكمال الأوامر‬" من خلال تطبيق مركز الاتصال في مركز Commerce الرئيسي.‬

> [!NOTE]
> نوصي بعدم تحرير الأوامر وعروض الأسعار في نقاط البيع التي يتم إنشاؤها بواسطة مستخدم مركز غير اتصال في مقر التجارة. لا تستخدم هذه الطلبات وعروض الأسعار محرك التسعير التجاري ، لذلك إذا تم تحريرها في نقاط البيع ، فإن محرك تسعير Commerce سيقوم بإعادة تسعيرها.
...
#### <a name="pricing-impact-when-orders-are-edited"></a>تأثير التسعير عند تحرير الطلبات

عندما يتم وضع الطلبات في نقاط البيع أو على موقع التجارة الإلكترونية للتجارة ، يلتزم العملاء بمبلغ. ويشمل هذا المبلغ سعرا، وقد يتضمن أيضا خصما. العميل الذي يضع طلب ثم يتصل بمركز الاتصال لاحقا لتغيير ذلك الأمر (على سبيل المثال، لإضافة عنصر آخر) سيكون لديه توقعات محددة حول تطبيق الخصومات. حتى إذا انتهت صلاحية العروض الترويجية على بنود الأمر الحالية، يتوقع العميل أن تظل الخصومات التي تم تطبيقها في الأصل على هذه البنود سارية المفعول. ومع ذلك، إذا لم يكن هناك خصم ساري المفعول عندما تم وضع الأمر في الأصل، ولكن تم إدخال الخصم حيز التنفيذ منذ ذلك الحين، يتوقع العميل تطبيق الخصم الجديد على الأمر الذي تم تغييره. وإلا، فقد يقوم العميل بإلغاء الأمر الموجود ثم إنشاء أمر جديد حيث يتم تطبيق الخصم الجديد. كما يظهر هذا السيناريو، يجب الحفاظ على الأسعار والخصومات التي التزم بها العملاء. وفي الوقت نفسه، يجب أن يتمتع مستخدمو نقاط البيع ومراكز الاتصال بالمرونة لإعادة حساب الأسعار والخصومات لبنود أوامر التوريد كما هو مطلوب.

عند استدعاء الطلبات وتحريرها في نقاط البيع، تعتبر أسعار وخصومات بنود الأمر الحالية "مقفلة". وبعبارة أخرى، لا تتغير، حتى إذا تم إلغاء بعض بنود الأمر أو تغييرها، أو تمت إضافة بنود أوامر جديدة. لتغيير أسعار وخصومات بنود المبيعات الحالية، يجب على مستخدم نقطة البيع تحديد **إعادة حساب**. ثم تتم إزالة تأمين السعر من بنود الأمر الموجودة. ومع ذلك، قبل إصدار التجارة الإصدار 10.0.21، لم تكن هذه الإمكانية متوفرة في مركز الاتصال. بدلا من ذلك، تسببت أي تغييرات في بنود الطلب في إعادة حساب الأسعار والخصومات.

في إصدار التجارة الإصدار 10.0.21، تتوفر ميزة جديدة تسمى **منع حساب السعر غير مقصود لأوامر التجارة** في مساحة عمل **إدارة الميزة**. تكون هذه الميزة نشطة بشكل افتراضي. عند تشغيله، تتوفر خاصية **السعر مؤمن** جديدة لجميع أوامر التجارة الإلكترونية. بعد إتمام عملية التقاط الطلبات للطلبات التي يتم وضعها من أي قناة، يتم تمكين هذه الخاصية تلقائيا (أي، يتم تحديد خانة الاختيار) لكافة بنود الأمر. ثم يستثني محرك التسعير التجاري بنود الطلب هذه من جميع حسابات السعر والخصم. لذلك، إذا تم تحرير الأمر، سيتم استبعاد بنود الأمر من حساب التسعير والخصم بشكل افتراضي. ومع ذلك، يمكن لمستخدمي مركز الاتصال تعطيل الخاصية (أي، إلغاء تحديد خانة الاختيار) لأي بند أمر ثم تحديد **إعادة الحساب** لتضمين بنود الأمر الموجودة في حسابات التسعير.

حتى عندما يطبقون خصما يدويا على بند مبيعات موجود، يجب على مستخدمي مركز الاتصال تعطيل الخاصية **السعر مؤمن** لبند المبيعات قبل تطبيق الخصم اليدوي.

يمكن لمستخدمي مركز الاتصال أيضا تعطيل الخاصية **السعر مؤمن** لبنود الطلبات بشكل مجمع عن طريق تحديد **إزالة تأمين السعر** في المجموعة **حساب** في علامة التبويب **بيع** في جزء الإجراءات في صفحة **أمر التوريد**. في هذه الحالة، تتم إزالة تأمين السعر من كافة بنود الأمر باستثناء البنود غير القابلة للتحرير (بمعنى آخر، البنود التي لها حالة **مفوترة جزئيا** أو **مفوترة**). بعد ذلك، بعد إكمال التغييرات على الأمر وإرسالها، يتم إعادة تطبيق تأمين السعر على كافة بنود الأمر.

> [!IMPORTANT]
> عند تشغيل ميزة **منع حساب السعر غير المقصود لأوامر التجارة**، سيتم تجاهل إعداد تقييم اتفاقية التجارة في سير عمل التسعير. وبعبارة أخرى، لن تعرض مربعات الحوار تقييم الاتفاقية التجارية القسم **المتعلق بالسعر**. يحدث هذا السلوك لأن إعداد تقييم اتفاقية التجارة وميزة تأمين السعر لها غرض مشابه: لمنع التغييرات السعر غير مقصودة. ومع ذلك، لا يتم قياس تجربة المستخدم لتقييم اتفاقية التجارة بشكل جيد للطلبات الكبيرة حيث يجب على المستخدمين تحديد سطر أمر واحد أو أكثر لإعادة التسعير.

> [!NOTE]
> يمكن تعطيل الخاصية **السعر مؤمن** لبنود محددة واحد أو أكثر فقط عند استخدام الوحدة النمطية **مركز الاتصال**. سلوك نقاط البيع لا يزال دون تغيير. وبعبارة أخرى، لا يمكن للمستخدم فتح أسعار بنود الأسعار المحددة. ومع ذلك، يمكنهم تحديد **إعادة الحساب** لإزالة تأمين السعر من جميع بنود الأمر الموجودة.
...
بعد إنشاء الأمر، سيتم استلام أو شحن الأصناف بواسطة العميل من موقع المتجر، وفقًا لتكوين الأمر. لمزيد من المعلومات حول هذه العملية، راجع وثائق [تنفيذ أمر المتجر](./order-fulfillment-overview.md).
