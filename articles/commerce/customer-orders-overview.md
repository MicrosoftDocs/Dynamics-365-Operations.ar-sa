...
## <a name="disable-option-to-pay-later"></a>تعطيل خيار الدفع لاحقًا

في الإصدار رقم 10.0.12 والإصدارات الأحدث من تطبيق Commerce، يُمكن للتجار إزالة خيار الدفع لاحقًا عندما يتم إنشاء أمر العميل في نقطة البيع. لتعطيل الخيار ، افتح **ملف تعريف الوظائف** للقناة التي لا يُسمح فيها بالسداد لاحقًا، ثم حدد **تحرير** في علامة التبويب **عام** ، حدد القائمة المنسدلة لـ **مطلوب الدفع للتنفيذ**. إذا لم يكن يُسمح بالدفع لاحقًا في نقطة البيع، حدد **البطاقة مطلوبة** ، ثم حدد **حفظ**. قم بتشغيل جدول توزيع **1070** لمزامنة هذه التغييرات للقناة. 
