...
1. حدد نوع الوحدة النمطية للجزء الخاص بك، ثم حدد **موافق**.
...
1. في جزء المخطط التفصيلي الموجود على اليسار، حدد زر علامة الحذف (**...**) المجاور لاسم الوحدة النمطية، ثم حدد **حفظ كجزء**. سوف يظهر مربع الحوار.
1. أدخل اسمًا وبيانات تعريف للجزء.
...
1. في جزء المخطط التفصيلي الموجود على اليسار، حدد حاوية أو فتحة يمكن إضافة وحدات نمطية تابعة إليها.
1. حدد زر علامة الحذف المجاور لاسم الحاوية أو الفتحة، ثم حدد **إضافة جزء**. سوف يظهر مربع الحوار.

    > [!NOTE]
    > إذا كانت الحاوية أو الفتحة لا تدعم وحدات تابعة جديدة، فلن يكون خيار **إضافة جزء** متوفرًا.

1. في مربع الحوار، ابحث عن جزء وحدده لإضافته. إذا لم يتم سرد الأجزاء المتوفرة، فقد تحتاج أولاً إلى إنشاء جزء من نوع الوحدة النمطية التي تدعمها الحاوية أو الفتحة المحددة.
1. حدد **موافق** لإضافة الجزء المحدد للحاوية أو الفتحة المحددة على الصفحة الخاصة بك.
...
1. في جزء المخطط التفصيلي الموجود على اليسار، حدد زر علامة الحذف المجاور لاسم الجزء المراد إزالته، ثم حدد زر سلة المهملات.
