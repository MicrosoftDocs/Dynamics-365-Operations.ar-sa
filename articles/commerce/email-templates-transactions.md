...
لتمكين الإخطارات التي تم إنشاؤها بواسطة العميل ، انتقل في Commerce headquarters التجاري إلى **البيع بالتجزئة والتجارة \> إعداد المراكز الرئيسية‬ \> المعلمات \> معلمات التجارة \> عام**. في القائمة المنسدلة لملف تعريف **اعلامات البريد** الكتروني ، حدد ملف تعريف إشعار البريد الإلكتروني الذي يحتوي على نوع الإعلام الذي أنشأه العميل. 

وبشكل افتراضي ، يتم تحميل الاحداث التي انشاها العميل إلى المركز باستخدام وظيفة مجموعه مزامنة العملاء **وطلبات القنوات**. إذا كنت تريد استخدام استدعاء خدمه الوقت الحقيقي لإرسال هذه الاحداث ، قم بتعيين معرف البريد الكتروني للقالب الذي تم إنشاؤه من قبل العميل إلى **newCust‎**. ومع ذلك ، لا ينصح بذلك نظرا لان مكالمات الخدمة في الوقت الحقيقي هي "حريق ونسيت" المكالمات ولا يتوفر لديك منطق أعاده الطلب أو منطق أعاده المحاولة الذي توفره وظائف المجموعة.
...
عند الاستدعاء من خلال مهمة المجموعة ، يدعم نوع الاخطار الذي انشاه العميل العنصر النائب التالي.

| اسم العنصر النائب | ‏‏الوصف‬                                                      |
| ---------------- | ------------------------------------------------------------ |
| customername     | الاسم الأول واسم العائلة للعميل الذي قام بإنشاء الحساب. |

عند الاستدعاء من خلال مكالمة خدمة في الوقت الفعلي ، يدعم نوع الإشعار الذي أنشأه العميل العناصر النائبة التالية.

| اسم العنصر النائب | ‏‏الوصف‬                                                      |
| ---------------- | ------------------------------------------------------------ |
| Name             | الاسم الأول واسم العائلة للعميل الذي قام بإنشاء الحساب. |
| البريد الإلكتروني            | عنوان البريد الكتروني الخاص بالعميل الذي قام بإنشاء حساب.    |
| الهاتف            | رقم هاتف العميل الذي أنشأ الحساب.      |
| عنوان URL              | عنوان URL الذي يوفره العميل عند إنشائه للحساب. |
