...
1. في جزء التنقل، انتقل إلى **الوحدات النمطية \> البيع بالتجزئة والتجارة \> إعداد المراكز الرئيسية ‬ \> ملف تعريف إخطار البريد الإلكتروني للبيع بالتجزئة**‬.
...
توضح الصورة التالية بعض أمثلة لإعدادات إخطار حدث بالبريد الإلكتروني.
