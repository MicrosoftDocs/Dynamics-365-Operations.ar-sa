...
description: يصف هذا المقال كيفية جعل توصيات المنتج المخصصة متوفرة للعملاء في Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 08/18/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864854"
---
# <a name="enable-personalized-recommendations"></a>تمكين التوصيات المخصصة

[!include [banner](includes/banner.md)]

يصف هذا المقال كيفية جعل توصيات المنتج المخصصة متوفرة للعملاء في Microsoft Dynamics 365 Commerce.
