---
title: وحدة أككورديون
description: يتناول هذا المقال وحدات أكورديون ويصف كيفية إضافتها إلى صفحات الموقع في Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853814"
---
# <a name="accordion-module"></a>وحدة أككورديون

[!include [banner](includes/banner.md)]

يتناول هذا المقال وحدات أكورديون ويصف كيفية إضافتها إلى صفحات الموقع في Microsoft Dynamics 365 Commerce.
...
1. في مربع الحوار **تحديد وحدات**، حدد وحدة **الأكورديون‬‬‏‎**، ثم حدد **موافق**.
...
1. في مربع الحوار **تحديد وحدات**، حدد وحدة **عنصر الأكورديون‬‬‏‎**، ثم حدد **موافق**.
