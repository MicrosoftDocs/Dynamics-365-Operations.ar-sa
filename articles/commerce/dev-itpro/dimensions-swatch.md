...
لتمكين أبعاد العرض كميزة عينات ألوان في مركز Commerce الرئيسي، انتقل إلى **مساحات العمل \> إدارة الميزات**، وقم بتشغيل الميزة **تمكين دعم الصورة لقيم أبعاد المنتج**. عند تمكين علامة الميزة هذه، تتم إضافة ثلاثة حقول جديدة لكل بُعد في الجداول الملائمة في مركز Commerce **رمز سداسي عشري** وعنوان **URL** (للصور) و **RefinerGroup**.
