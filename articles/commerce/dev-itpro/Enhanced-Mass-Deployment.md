...
description: يشرح هذا الموضوع كيفية استخدام اطار العمل لمثبتات مكونات الخدمة الذاتية لتنفيذ التثبيت الصامت وعمليات نشر الخدمات.
author: jashanno
ms.date: 05/11/2022
ms.topic: article
...
| --Install | معلمة تحدد ما إذا كان يجب تثبيت المكون الذي يقدمه هذا المثبت. هذه المعلمة غير مطلوبة. |
...
من الضروري إزالة مكون نقطة البيع الحديثة القديم ذاتي الخدمة. لمزيد من المعلومات، انظر خطوات الترحيل السابقة في هذا الموضوع.
...
> [!NOTE]
> ملف التكوين غير مطلوب لنقطة البيع الحديثة. يحتوي المثبت الآن على معلمات (تم عرضها سابقًا في هذا الموضوع) للقيم المختلفة المستخدمة أثناء تنشيط الجهاز.
...
> [!NOTE]
> ملف التكوين غير مطلوب لمحطة الأجهزة. يحتوي المثبت الآن على معلمات (تم عرضها سابقًا في هذا الموضوع) للقيم المختلفة المطلوبة.
...
من الضروري إزالة مكون CSU (مستضافة ذاتيًا) القديم ذاتي الخدمة. لمزيد من المعلومات، انظر خطوات الترحيل السابقة في هذا الموضوع.
