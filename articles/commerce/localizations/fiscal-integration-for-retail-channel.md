...
1. يحدد CRT ما إذا كان الحدث الحالي يحتاج إلى تسجيل مالي.
1. استنادًا إلى إعدادات عملية التسجيل المالي، يحدد CRT موصلاً ماليًا وموفر المستندات المالية المناظر لاستخدامه في التسجيل المالي.
1. يشغل CRT موفر المستندات المالية المسؤول عن إنشاء مستند مالي (على سبيل المثال، مستند XML) يمثل الحدث أو الحركة.
1. ترسل نقطة البيع المستند المالي الذي يقوم CRT بإعداده إلى محطة أجهزة.
1. تشغّل محطة الأجهزة الموصل المالي الذي يعالج المستند المالي وتبلغ عنه الجهاز المالي أو الخدمة المالية.
1. تحلل نقطة البيع استجابة الجهاز المالي أو الخدمة المالية لتحديد ما إذا كان التسجيل المالي قد تم بنجاح.
1. يحفظ CRT الاستجابة في قناة قاعدة البيانات.
