...
تعتبر وظيفة التكامل المالي إطار عمل يوفر حلاً مشتركًا لمزيد من التطوير والتخصيص للتكامل بين Retail POS والأجهزة والخدمات المالية. وتتضمن الوظيفة أيضًا نماذج التكامل المالي التي تدعم السيناريوهات الأساسية للبيع بالتجزئة لبلدان أو مناطق محددة، والتي تصلح لخدمات أو أجهزة مالية محددة. يتكون نموذج التكامل المالي من عدة ملحقات لمكونات Commerce وهو مضمن في مجموعة تطوير البرنامج (SDK). للحصول على مزيد من المعلومات حول عينات التكامل المالي، راجع [نظرة عامة على عينات التكامل المالي في Retail SDK](#fiscal-integration-samples-in-the-retail-sdk). للحصول على مزيد من المعلومات حول كيفية تثبيت واستخدام Retail SDK، راجع [بنية مجموعة تطوير برنامج Retail](../dev-itpro/retail-sdk/retail-sdk-overview.md).
