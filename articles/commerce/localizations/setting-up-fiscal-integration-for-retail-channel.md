...
1. تحميل تكوينات الموصلات المالية وموفري المستندات المالية.
    ...
    1. في صفحة **موفرو المستندات المالية** (**البيع بالتجزئة والتجارة \> إعداد القناة \> التكامل المالي \> موفرو المستندات المالية**)، قم بتحميل تكوين XML لكل جهاز أو خدمة تخطط لاستخدامها لأغراض تتعلق بالتكامل المالي.
...
1. إنشاء ملفات تعريف وظيفية وملفات تعريف تقنية للموصلات‬‏‎.
    ...
    1. في صفحة **ملفات التعريف التقنية للموصلات‬** (**البيع بالتجزئة والتجارة \> إعداد القناة \> التكامل المالي \> ملفات التعريف التقنية للموصلات‬**)، أنشئ ملف تعريف تقنيًا للموصل لكل موصل مالي.

        1. حدد اسم موصل.
        1. حدد نوع موصل. بالنسبة إلى الأجهزة المتصلة بمحطة أجهزة، حدد **محلي**.
...
1. إنشاء عملية تسجيل مالي.
    ...
    1. إضافة خطوات التسجيل للعملية:

        1. حدد **إضافة**.
        1. حدد نوع موصل مالي.
        1. في حقل **رقم المجموعة**، حدد مجموعة الموصلات المالية المناسب.

1. تعيين كيانات عملية التسجيل المالي إلى ملفات تعريف نقطة البيع.
...
1. في صفحة **عملية التسجيل المالي** (**البيع بالتجزئة والمتجر \> إعداد القناة \> التكامل المالي \> عمليات التسجيل المالي**)، حدد **التحقق من الصحة** للتحقق من صحة عملية تسجيل المالي.
