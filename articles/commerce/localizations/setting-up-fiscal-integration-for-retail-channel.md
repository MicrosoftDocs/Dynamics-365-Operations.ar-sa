...
1. البحث عن الميزات التالية وتمكينها:
    ...
    - **تجاوزات ملف التعريف الفني للتكامل المالي‬** – تتيح هذه الميزة إمكانية توسيع تكوين التكامل المالي وتضيف القدرة على تجاوز معلمات ملف تعريف تقني. علي سبيل المثال ، من الممكن تحديد سلاسل اتصال الجهاز المالي علي مستوي تسجيل نقطه البيع الفردية. كما تقوم الميزة باضافه الاحتمال للتحقق من معلمات الاتصال في **صفحه الإعدادات** الخاصة بسجل نقطه البيع. 
    ...
    - **التكامل المالي النسخ الاحتياطي التخزين المحلي** - تعمل هذه الميزة على توسيع إمكانيات معالجة الأخطاء لإطار عمل التكامل المالي من خلال تمكين النسخ الاحتياطي التلقائي لبيانات التسجيل المالي ، بحيث يمكن استعادة البيانات الموجودة في التخزين المحلي أثناء تنشيط الجهاز.
    - **تاجيل تسجيل المستندات** -تعمل هذه الميزة علي توسيع قدرات معالجه الأخطاء الخاصة بإطار عمل التكامل المالي من خلال تمكين الخيار لتاجيل التسجيل المالي في حاله فشل التسجيل المالي واستخدام خيار التسجيل المالي للنسخ الاحتياطي أو إكمال التسجيل المالي في وقت لاحق بواسطة آخر بخلاف اطار عمل التكامل المالي.
...
## <a name="enable-manual-execution-of-deferred-fiscal-registration"></a>تفعيل التنفيذ اليدوي للتسجيل المالي المؤجل.

لتمكين التنفيذ اليدوي للتسجيل المالي المؤجل ، يجب إضافة زر جديد إلى تخطيط نقطة البيع.
