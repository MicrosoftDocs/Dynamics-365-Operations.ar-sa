---
title: وحدة صندوق الشراء
description: يتناول هذا المقال وحدات مربع الشراء ويصف كيفية إضافتها إلى صفحات الموقع في Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863538"
---
# <a name="buy-box-module"></a>وحدة صندوق الشراء

[!include [banner](includes/banner.md)]

يتناول هذا المقال وحدات مربع الشراء ويصف كيفية إضافتها إلى صفحات الموقع في Microsoft Dynamics 365 Commerce.
...
1. في مربع الحوار **تحديد جزء‬‏‫**، حدد **جزء مربع الشراء** الذي أنشأته، ثم حدد **موافق**.
1. حدد **حفظ**، وحدد **إنهاء التحرير** لإيداع القالب، ثم حدد **نشر** لنشره.
1. انتقل إلى **الصفحات**، ثم حدد **جديد** لإنشاء صفحة جديدة.
1. في مربع الحوار **إنشاء صفحة جديدة**، تحت **اسم الصفحة**، أدخل **محتوى PDP**، ثم حدد **التالي**.
1. ضمن **اختيار قالب**، حدد **قالب PDP**، ثم حدد **التالي**.
