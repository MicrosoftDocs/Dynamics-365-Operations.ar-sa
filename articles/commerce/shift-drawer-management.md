...
description: يشرح هذا المقال كيفية إعداد الورديات واستخدامها في نقطة بيع Commerce.
author: josaw1
ms.date: 05/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9287447"
---
# <a name="shift-and-cash-drawer-management"></a>إدارة الورديات وأدراج النقد

[!include [banner](includes/banner.md)]

يشرح هذا المقال كيفية إعداد الورديات واستخدامها في نقطة بيع Commerce.
...
يمكن إجراء عمليات مختلفة لتغيير حالة أحد الورديات، أو لزيادة أو تقليل مبلغ المال في درج النقدية. يصف هذا القسم عمليات الوردية في  Modern POS وCloud POS.
