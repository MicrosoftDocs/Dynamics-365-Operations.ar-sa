...
يوضح هذا الموضوع كيفية إدارة التقييمات والمراجعات باستخدام أداة الإشراف على تقييمات ومراجعات Microsoft Dynamics 365 Commerce .

## <a name="overview"></a>نظرة عامة

Dynamics 365 Commerce يستخدم Microsoft Azure Cognitive Service للإشراف تلقائيًا على مرجعة النصوص عن طريق تنقيح الكلمات البذيئة. بالإضافة إلى ذلك، يمكن للمشرفين استخدام أداه التقييمات والمراجعات للمهام اليدوية التالية:
...
## <a name="access-ratings-and-reviews-moderation-features"></a>الوصول إلى ميزات الإشراف على التقييمات والمراجعات

للوصول إلى ميزات الإشراف على التقييمات والمراجعات في أداة إدارة موقع التجارة الإلكترونية، اتبع الخطوات التالية.

1. سجل الدخول إلى [Microsoft Lifecycle Services (LCS)](https://lcs.dynamics.com).
1. افتح المشروع الذي يحتوي علي البيئة التي ترغب في تهيئة التجارة الإلكترونية فيها.
1. في قسم **البيئات** ، حدد البيئة.
1. ضمن **ميزات البيئة**، حدد **إدارة البيع بالتجزئة**
1. في علامة التبويب **التجارة الإلكترونية** ضمن **الارتباطات**، حدد **أداة إدارة موقع التجارة الإكترونية**.
...
للاستجابة لمراجعة، اتبع الخطوات التالية.
...
لاستبعاد مراجعة، اتبع الخطوات التالية.

1. انتقل إلى **الصفحة الرئيسية‬ \> المراجعات \> الإشراف**.
1. ابحث عن المراجعة التي يجب استبعادها وحددها.
1. في جزء الخصائص الموجود علي اليسار، حدد سبب الاستبعاد، ثم حدد **استبعاد**.
...
للبحث عن بيانات العميل وحذفها، اتبع الخطوات التالية.

1. انتقل إلى **الصفحة الرئيسية‬ \> المراجعات \> حذف**.
1. في حقل **بحث عن المستخدمين باستخدام عنوان البريد الإلكتروني**، أدخل عنوان البريد الإلكتروني للعميل، ثم حدد **بحث**.
...
تتيح أداة الإشراف على التقييمات والمراجعات للمشرفين إمكانية استيراد بيانات التقييمات والمراجعات مجمّعة، بحيث يمكنهم تحليل الاتجاهات. يتوفر قالب Power BI يتضمن القياسات الأساسية. يمكن للمشرفين استخدام هذا القالب للاتصال بالبيانات المستوردة المجمّعة وعرض لوحة معلومات. ولا يلزمهم إنشاء لوحة معلومات مخصصة. كما يمكن للمشرفين تخصيص قالب Power BI لتلبية احتياجاتهم المحددة. 

لتحميل بيانات التقييمات والمراجعات، اتبع الخطوات التالية.

1. انتقل إلى **الصفحة الرئيسية‬ \> المراجعات \> ‏‫إعداد التقارير‬‬**.
1. حدد **تنزيل بيانات المراجعات** لتنزيل بيانات التقييمات والمراجعات بشكل مجمع بتنسيق قيم مفصولة بفواصل (CSV).
...
لعرض اتجاهات التقييمات والمراجعات، اتبع الخطوات التالية.
