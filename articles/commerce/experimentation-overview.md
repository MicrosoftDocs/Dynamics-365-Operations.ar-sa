...
يمكنك إنشاء وتحرير وأداره عمليات معالجة المحتوي والصفحة المعروفة باسم **التباينات** في منشئ الموقع. تتكامل التجارة مع خدمات الجهات الأخرى التي يمكنك استخدامها لإنشاء تعيينات التجارب والمعالجة. تتيح تدفقات الاحداث في الوقت الحقيقي التي تم التقاطها في التجارة التحليلات التي تحدد نتائج التجربة في الخدمة التابعة لجهة خارجية. يمكنك بعد ذلك زيادة هذه التحليلات للمساعدة في دعم الفرضية الخاصة بك أو دحضها.

## <a name="set-up-prerequisites"></a> متطلبات الإعداد الأساسية
1. **الحصول علي الإصدار الصحيح من التجارة** - ترقيه مكتبه الوحدة النمطية ومجموعة SDK لقابلية توسعة القنوات عبر الإنترنت والإصدار 10.0.13 من Commerce Scale Unit أو ما بعده.
...
> [!NOTE]
> لمعرفه المكان الذي توجد فيه التجارب في دوره الحياة، انتقل إلى علامة التبويب **التجارب** في منشئ الموقع. يتم عرض قائمه بالتجارب بحاله كل تجربه في كل من التجارة التجارية وخدمه الجهة الخارجية. لمزيد من المعلومات ، راجع [مراجعه حاله التجربة ](experimentation-status.md).
