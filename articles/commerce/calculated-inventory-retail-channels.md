...
- **GetEstimatedAvailabilty** – استخدم واجهة برمجة التطبيقات هذه للحصول على إمكانية توفر المخزون للصنف في مستودع قناة التجارة الإلكترونية أو كافة المستودعات التي تم ربطها بتكوين مجموعة التنفيذ لقناة التجارة الإلكترونية. يمكن استخدام واجهة برمجة التطبيقات هذه أيضًا للمستودعات الموجودة في منطقة بحث أو نصف قطر معينة، استنادًا إلى بيانات خط الطول وخط العرض.
- **ProductWarehouseInventoryAvailabilities** – استخدم واجهة برمجة التطبيقات هذه لطلب مخزون لعنصر ما من مستودع معين. على سبيل المثال، يمكنك استخدامه لإظهار إتاحة المخزون في السيناريوهات التي تتضمن انتقاء الأمر.
...
قبل أن تقوم باستخدام واجهتي برمجة التطبيقات التي تم ذكرها مسبقًا، فإنه يجب عليك أن تقوم بتغيير معلمة في Commerce Headquarters لضمان أن لقطة قيم المخزون التي يقوم Commerce Headquarters بحسابها باستخدام وظيفة **توفر المنتجات** تقوم بإدخال البينات في الجداول الصحيحة.

لتعيين المعلمة، اتبع هذه الخطوات.

1. انتقل إلى **Retail and Commerce \> إعداد Headquarters \> المعلمات \> معلمات Commerce المشتركة**.
1. في علامة التبويب **المخزون**، في القسم **وظيفة توفر المنتج**، حدد **استخدام عملية محسنة لوظيفة توفر المنتجات**. يضمن هذا الإعداد أنه يتم استخدام مجموعة الميزات المثلى لحساب المخزون المتوفر الخاص بالقناة من خلال خادم Commerce.
...
عندما يتم طلب توفر المخزون من واجهة برمجة التطبيقات **GetEstimatedAvailabilty** أو **ProductWarehouseInventoryAvailabilities**، فإنه يتم إجراء عملية حسابية لمحاولة الحصول على أفضل تقدير ممكن لمخزون المنتج. وتشير العملية الحسابية إلى أي أوامر عميل في التجارة الإلكترونية موجودة في قاعدة بيانات القناة ولكن لم يتم تضمينها في بيانات اللقطة في وظيفة 1130 المقدمة. ويتم أداء هذا المنطق من خلال تعقب آخر حركة مخزون تمت معالجتها من Commerce Headquarters ومقارنتها بالحركات في قاعدة بيانات القناة. ويوفر أساسًا لمنطق حساب جانب القناة، بحيث يمكن تحليل حركات المخزون الإضافية التي حدثت لحركات مبيعات أمر العميل في قاعدة بيانات قناة التجارة الإلكترونية إلى قيمة المخزون المقدرة التي تقدم واجهة برمجة التطبيقات.
...
لاستخدام منطق حساب جانب القناة وإيقاف تشغيل استدعاءات خدمة في الوقت الحقيقي لعمليات بحث المخزون من تطبيق نقطة البيع، فإنه يجب عليك أولاً إجراء تغييرين للمعلمة. يجب عليك بعد ذلك مزامنة التغييرات إلى القناة من خلال عملية جدولة التوزيع.

لتعيين المعلمة الأولى، اتبع هذه الخطوات.

1. انتقل إلى **Retail and Commerce \> إعداد Headquarters \> المعلمات \> معلمات Commerce المشتركة**.
1. في علامة التبويب **المخزون**، في القسم **وظيفة توفر المنتج**، حدد **استخدام عملية محسنة لوظيفة توفر المنتجات**. يضمن هذا الإعداد أنه يتم استخدام مجموعة الميزات المثلى لحساب المخزون المتوفر الخاص بالقناة من خلال خادم Commerce.

لتعيين المعلمة الثانية، اتبع هذه الخطوات.
...
لتحديث الخوادم، اتبع هذه الخطوات.
