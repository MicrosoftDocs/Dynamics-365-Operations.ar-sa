...
description: يصف هذا المقال كيفية استخدام شركة Microsoft Dynamics 365 Commerce لعرض توافر المنتجات الحالي المقدر في قنوات عبر الإنترنت وقنوات المتجر.
author: hhainesms
ms.date: 09/01/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8884101"
---
# <a name="calculate-inventory-availability-for-retail-channels"></a>حساب توفر المخزون لقنوات البيع بالتجزئة

[!include [banner](../includes/banner.md)]

يصف هذا المقال كيفية استخدام شركة Microsoft Dynamics 365 Commerce لعرض توافر المنتجات الحالي المقدر في قنوات عبر الإنترنت وقنوات المتجر.
...
لاستخدام حساب المخزون في جانب القناة، يجب تمكين ميزة **حساب إتاحة المنتج المحسنة**.

إذا كانت بيئة Commerce الخاصة بك من الإصدار **10.0.8 حتى 10.0.11**، فاتبع الخطوات التالية.

1. في المركز الرئيسي لـ Commerce، انتقل إلى **تجارة التجزئة والتجارة** \> **معلمات Commerce المشتركة**.
1. في علامة التبويب **المخزون**، في حقل **وظيفة توفر المنتج**، حدد **استخدام عملية محسنة لوظيفة إتاحة المنتجات**.

إذا كانت بيئة Commerce الخاصة بك من الإصدار **10.0.12 أو ما يليه**، فاتبع الخطوات التالية.

1. في المركز الرئيسي لـ Commerce، انتقل إلى **مساحات العمل \> إدارة المنتج**، وقم بتمكين ميزة **حساب توافر المنتج المحسنة**.
1. إذا كانت القنوات عبر الإنترنت والمتجر الخاصة بك تستخدم نفس مستودعات التنفيذ، فيجب أيضا تمكين ميزة **منطق حساب المخزون في جانب قناة التجارة الإلكترونية المحسنة**. وبهذه الطريقة، سيقوم منطق الحساب في جانب القناة بمراعاة الحركات غير المرحلة التي تم إنشاؤها في قناة المتجر. (يمكن أن تكون تلك الحركات من الحركات النقدية والموازنة وأوامر العملاء والمرتجعات.)
1. قم بتشغيل وظيفة **1070** (**تكوين القناة**).

إذا تمت ترقيه بيئة Commerce الخاصة بك من إصدار Commerce سابق لـ 10.0.8، فبعد تمكين ميزة **حساب إتاحة المنتج المحسنة**، يجب أيضًا تشغيل **تهيئة برنامج جدولة التجارة** لكي تصبح الميزة سارية المفعول. لتشغيل التهيئة، انتقل **تجارة التجزئة والتجارة** \> **إعداد المراكز الرئيسية** \> **مجدول Commerce**.
...
على الرغم من أن واجهات برمجة التطبيقات الأخرى المتوفرة في Commerce يمكنها الانتقال مباشره إلى Headquarters لإحضار كميات حالية للمنتجات، إلا أننا لا نوصي باستخدامها في بيئة تجارة إلكترونية نظرًا لوجود مشكلات محتملة في الأداء والتأثير المرتبط بالطلبات المتكررة هذه يمكن أن تكون موجودة على خوادم Headquarters الخاصة بك. بالإضافة إلى ذلك، مع الحساب في جانب القناة، يمكن أن توفر واجهتا API المذكورتان أعلاه تقديرًا أكثر دقة لتوافر المنتج من خلال مراعاة الحركات التي تم إنشاؤها في القنوات غير المعروفة بعد للمراكز الرئيسية.
