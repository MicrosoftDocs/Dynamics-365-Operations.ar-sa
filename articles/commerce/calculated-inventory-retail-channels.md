...
قبل استخدام واجهتي برمجة التطبيقات التي سبق ذكرها، يجب تمكين ميزة **الحساب المحسن لتوفر المنتج** من خلال مساحة عمل **إدارة الميزات** في Commerce Headquarters.
...
لاستخدام منطق الحساب بجانب القناة وإيقاف تشغيل استدعاءات الخدمة في الوقت الحقيقي لعمليات البحث الخاصة بالمخزون من تطبيق نقطة البيع، يجب أولا تمكين ميزة **الحساب المحسن لتوفر المنتج** من خلال مساحة عمل **إدارة الميزات** في Commerce Headquarters. بالإضافة إلى تمكين الميزة، يجب إجراء تغييرات على **ملف تعريف الوظائف**.
