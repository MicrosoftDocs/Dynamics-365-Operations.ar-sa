...
1. بالنسبة إلى **عنوان URI لإعادة التوجيه**، أدخل عناوين URL للردود المخصصة كنوع **الويب**. للحصول على معلومات حول عناوين URL للرد وكيفية تنسيقها، راجع [عناوين URL للردود](#reply-urls) أدناه.
1. للحصول على **الأذونات**، حدد **منح موافقة المسؤول على أذونات openid و offline_access**.
1. حدد **السجل**.
1. حدد التطبيق الذي تم إنشاؤه حديثا وانتقل إلى قائمه **المصادقة**. يمكنك هنا إضافة **عناوين URI لإعادة التوجيه** الإضافية عند اللزوم (الآن أو لاحقًا). تابع إلى الخطوة التالية إذا لم تكن هناك حاجة إليها حاليًا.
...
1. ضمن **موفرو الهوية**، حدد **تسجيل الدخول إلى البريد الإلكتروني**.
...
1. تأكد من تعيين التطبيق الخاص بك إلى تطبيق Azure AD B2C المقصود الذي تم إنشاؤه أعلاه، ثم حدد الارتباط ضمن رأس **تشغيل سير عمل المستخدم** الذي يتضمن ``.../.well-known/openid-configuration?p=<B2CSIGN-INPOLICY>``.
1. يتم عرض صفحه بيانات التعريف في علامة تبويب المستعرض الخاصة بك. انسخ عنوان URL الخاص بمصدر موفر الهوية (قيمة **المُصدر**).
