...
1. في مدخل Azure، حدد **التطبيقات (قديمة)** ثم حدد **إضافة**.
...
[يُعيد تحميل عنوان URL التوجيه بالإجمال](upload-bulk-redirects.md)إقران موقع Dynamics 365 Commerce بقناة عبر الإنترنت

[إعداد صفحات مخصصة لعمليات تسجيل دخول المستخدمين](custom-pages-user-logins.md)

[تكوين العديد من مستأجرين شركة إلى عميل في بيئة Commerce](configure-multi-B2C-tenants.md)
