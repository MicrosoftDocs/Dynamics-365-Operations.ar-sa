...
description: يوضح هذا المقال كيفية تحرير وتدقيق حركات الدفع نقدًا والاستلام فورًا وإدارة النقد في Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 11/04/2020
ms.topic: index-page
ms.prod: ''
...
يوضح هذا المقال كيفية تحرير وتدقيق حركات الدفع نقدًا والاستلام فورًا وإدارة النقد في Microsoft Dynamics 365 Commerce.
