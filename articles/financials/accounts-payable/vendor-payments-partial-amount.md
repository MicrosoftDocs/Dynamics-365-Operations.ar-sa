...
عندما تقوم بسداد دفعة جزئية، قد تخطط لسداد دفعة جزئية إضافية لتسوية الفاتورة بالكامل. وللحصول على خصم نقدي لدفعة جزئية، يجب عليك تعيين خيار <strong>حساب الخصومات النقدية لمدفوعات جزئية** إلى **نعم</strong> في صفحة <strong>معلمات الحسابات الدائنة</strong>. 
...
قد تقوم بإرجاع بعض الأصناف في إحدى الفواتير وتتلقى إشعار دائن. إذا تم الحصول على خصم نقدي في الفاتورة الأصلية، فإنه يمكنك طرح قيمة الخصم والحصول على استرداد بالمبلغ الصحيح. وإذا تم تعيين <strong>خيار **حساب الخصومات النقدية للإشعارات الدائنة إلى **نعم</strong> في صفحة <strong>معلمات الحسابات الدائنة</strong>، فإنه يتم حساب الخصم تلقائياً لإشعار الدائن. 
