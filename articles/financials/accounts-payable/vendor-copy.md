...
لنسخ مورد، حدد **جديد** في صفحة **جميع الموردين** لفتح صفحة **جميع الموردين، سجل جديد**. تجدر الإشارة إلى أنه لا يتم تعيين معرف المورد الجديد مباشرةً. يختلف هذا السلوك عن السلوك في الإصدارات السابقة من Microsoft Dynamics 365 for Finance and Operations. نظرًا لأنه لم تحدد مجموعة الموردين حتى الآن، يتعذر على النظام تحديد التسلسل الرقمي الصحيح لاستخدامه. بالإضافة إلى ذلك، لا يمكن تحديد ما إذا كنت تريد إنشاء مورد جديد أو نسخ أحد الموردين. ولذلك، لم يتم تعيين معرف المورد حتى تحدد **حفظ** في أسفل الصفحة.
