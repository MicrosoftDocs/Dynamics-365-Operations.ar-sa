...
سيكون لمثيل سير العمل الذي توقف بسبب خطأ لا يمكن إصلاحه حالة سير العمل **غير قابل للاسترداد**. عندما تكون حالة سير عمل فاتورة المورد هي **غير قابلة للاسترداد**، يمكنك تعيينها إلى **مسودة**. يمكنك تحرير فاتورة المورّد بعد ذلك. تتوفر هذه الميزة في حالة تشغيل معلمة **إعادة تعيين حالة المسودة لسير عمل فاتور المورد** في صفحة **إدارة الميزات**.

يمكنك استخدام صفحة **إعادة تعيين حالة سير عمل فواتير الموردين** لإعادة تعيين حالة سير العمل إلى **مسودة**. ويمكنك فتح هذه الصفحة من تنقل **المهمة الدورية**. تعرض الصفحة كافة فواتير الموردين التي لها حالة سير عمل **غير قابلة للاسترداد** في الكيان القانوني الحالي. كما يوضح المستخدم الذي قام بتقديم كل فاتورة إلى سير العمل ومعرف الفاتورة، كما يوفر ارتباطًا لمحفوظات سير العمل. لإعادة تعيين حالة سير العمل إلى **مسودة**، قم بتمييز فاتورة واحده أو أكثر، ثم حدد **تحديث إلى مسودة**. بعد إعادة تعيين حالة سير العمل إلى **مسودة**، تصبح متوفرة للتحرير في صفحة **فاتورة المورد**.

يمكنك الوصول إلى صفحة **إعادة تعيين حالة سير عمل فواتير الموردين** فقط في حالة إعادة تعيين مهمة الأمان **الحفاظ على حالة سير عمل فاتورة المورد** وامتياز **إعادة تعيين الحالة لسير عمل فاتورة المورد** لك.
