...
<a name="prerequisites"></a><span data-ttu-id="2c8d1-109">المتطلبات الأساسية</span><span class="sxs-lookup"><span data-stu-id="2c8d1-109">Prerequisites</span></span>
-------------
...
<li><span data-ttu-id="2c8d1-158">تاريخ الاستحقاق</span><span class="sxs-lookup"><span data-stu-id="2c8d1-158">Due date</span></span></li>
...
<td><span data-ttu-id="2c8d1-178">نعم</span><span class="sxs-lookup"><span data-stu-id="2c8d1-178">Yes</span></span></td>
</tr>
</tbody>
</table>
...
10. <span data-ttu-id="2c8d1-236">انقر فوق **تم** لإنهاء وضع التحرير.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-236">Click **Done** to exit edit mode.</span></span>
...
7. <span data-ttu-id="2c8d1-256">أدخل عنوان صفحة، مثل **تفاصيل الفاتورة**، ووصفًا، مثل **عرض رأس الفاتورة وتفاصيل البنود**.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-256">Enter a page title, such as **Invoice details**, and a description, such as **View invoice header and line details**.</span></span>
...
### <a name="workflow-actions"></a><span data-ttu-id="2c8d1-281">إجراءات سير العمل</span><span class="sxs-lookup"><span data-stu-id="2c8d1-281">Workflow actions</span></span>
...
#### <a name="create-a-js-file"></a><span data-ttu-id="2c8d1-302">إنشاء ملف .js</span><span class="sxs-lookup"><span data-stu-id="2c8d1-302">Create a .js file</span></span>
...
4. <span data-ttu-id="2c8d1-318">عيّن الخيار **إدارة المستندات** إلى **نعم** كما هو موضح أدناه.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-318">Set the **Document management** option to **Yes** as shown below.</span></span> <span data-ttu-id="2c8d1-319">**ملاحظة:** في حال عدم وجود أي متطلبات تتعلق بإظهار المرفقات على جهاز محمول، يمكنك ترك هذا الخيار معينًا إلى **لا**، وهو الإعداد الافتراضي.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-319">**Note:** If there are no requirements to show attachments on the mobile device, you can leave this option set to **No**, which is the default setting.</span></span>
   <span data-ttu-id="2c8d1-320">![إدارة المستندات](./media/docmanagement-216x300.png)</span><span class="sxs-lookup"><span data-stu-id="2c8d1-320">![Document management](./media/docmanagement-216x300.png)</span></span>
...
1.  <span data-ttu-id="2c8d1-356">افتح ملف.js الذي أنشأته مسبقًا، وأضف البنود المميزة في التعليمات البرمجية التالية.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-356">Open the .js file that you created earlier, and add the lines that are highlighted in the following code.</span></span> <span data-ttu-id="2c8d1-357">تقوم هذه التعليمات البرمجية بأمرين:</span><span class="sxs-lookup"><span data-stu-id="2c8d1-357">This code does two things:</span></span>
...
<li><span data-ttu-id="2c8d1-384">تاريخ الفاتورة</span><span class="sxs-lookup"><span data-stu-id="2c8d1-384">Invoice date</span></span></li>
<li><span data-ttu-id="2c8d1-385">وصف الفاتورة</span><span class="sxs-lookup"><span data-stu-id="2c8d1-385">Invoice description</span></span></li>
<li><span data-ttu-id="2c8d1-386">تاريخ الاستحقاق</span><span class="sxs-lookup"><span data-stu-id="2c8d1-386">Due date</span></span></li>
<li><span data-ttu-id="2c8d1-387">عملة الفاتورة</span><span class="sxs-lookup"><span data-stu-id="2c8d1-387">Invoice currency</span></span></li>
</ol></td>
</tr>
<tr class="even">
<td><span data-ttu-id="2c8d1-388">ما هي الحقول من سطور الفاتورة التي سيحتاج المستخدم إلى رؤيتها في تجربة المحمول، وبأي ترتيب؟‬</span><span class="sxs-lookup"><span data-stu-id="2c8d1-388">What fields from the invoice lines will the user want to see in the mobile experience, and in what order?</span></span></td>
<td><ol>
<li><span data-ttu-id="2c8d1-389">فئة التدبير</span><span class="sxs-lookup"><span data-stu-id="2c8d1-389">Procurement category</span></span></li>
<li><span data-ttu-id="2c8d1-390">الكمية</span><span class="sxs-lookup"><span data-stu-id="2c8d1-390">Quantity</span></span></li>
<li><span data-ttu-id="2c8d1-391">سعر الوحدة</span><span class="sxs-lookup"><span data-stu-id="2c8d1-391">Unit price</span></span></li>
<li><span data-ttu-id="2c8d1-392">المبلغ الصافي للسطر</span><span class="sxs-lookup"><span data-stu-id="2c8d1-392">Line net amount</span></span></li>
<li><span data-ttu-id="2c8d1-393">مبلغ 1099</span><span class="sxs-lookup"><span data-stu-id="2c8d1-393">1099 amount</span></span></li>
</ol></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="2c8d1-394">ما عدد سطور الفاتورة الموجودة في فاتورة؟</span><span class="sxs-lookup"><span data-stu-id="2c8d1-394">How many invoice lines are there in an invoice?</span></span> <span data-ttu-id="2c8d1-395">يمكنك هنا تطبيق القاعدة 80-20، والتحسين إلى 80 في المائة.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-395">Apply the 80-20 rule here, and optimize for the 80 percent.</span></span></td>
<td><span data-ttu-id="2c8d1-396">5</span><span class="sxs-lookup"><span data-stu-id="2c8d1-396">5</span></span></td>
</tr>
<tr class="even">
<td><span data-ttu-id="2c8d1-397">هل سيرغب المستخدمون في رؤية التوزيع المحاسبي (أكواد الفواتير) على الجهاز المحمول أثناء المراجعات؟</span><span class="sxs-lookup"><span data-stu-id="2c8d1-397">Will users want to see accounting distributions (invoice coding) on the mobile device during reviews?</span></span></td>
<td><span data-ttu-id="2c8d1-398">نعم</span><span class="sxs-lookup"><span data-stu-id="2c8d1-398">Yes</span></span></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="2c8d1-399">ما عدد التوزيعات المحاسبية (السعر المفصل وضريبة المبيعات والمصاريف وغير ذلك) لبند الفاتورة؟</span><span class="sxs-lookup"><span data-stu-id="2c8d1-399">How many accounting distributions (extended price, sales tax, charges, and so on) are there for an invoice line?</span></span> <span data-ttu-id="2c8d1-400">مرة أخرى، يجب تطبيق القاعدة 80-20.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-400">Again, apply the 80-20 rule.</span></span></td>
<td><span data-ttu-id="2c8d1-401">السعر المفصل: 2 ضريبة المبيعات: 2 المصروفات: 2</span><span class="sxs-lookup"><span data-stu-id="2c8d1-401">Extended price: 2 Sales tax: 2 Charges: 2</span></span></td>
</tr>
<tr class="even">
<td><span data-ttu-id="2c8d1-402">هل تتضمن الفواتير توزيعات محاسبية على رأس الفاتورة؟</span><span class="sxs-lookup"><span data-stu-id="2c8d1-402">Do the invoices also have accounting distributions on the invoice header?</span></span> <span data-ttu-id="2c8d1-403">إذا كان الأمر كذلك، فيجب أن تكون هذه التوزيعات المحاسبية متوفرة على الجهاز؟</span><span class="sxs-lookup"><span data-stu-id="2c8d1-403">If so, should these accounting distributions be available on the device?</span></span></td>
<td><span data-ttu-id="2c8d1-404">غير مستخدم</span><span class="sxs-lookup"><span data-stu-id="2c8d1-404">Not used</span></span></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="2c8d1-405">هل سيحتاج المستخدمون لمشاهدة مرفقات الفاتورة على الجهاز؟</span><span class="sxs-lookup"><span data-stu-id="2c8d1-405">Will users want to see attachments for the invoice on the device?</span></span></td>
<td><span data-ttu-id="2c8d1-406">نعم</span><span class="sxs-lookup"><span data-stu-id="2c8d1-406">Yes</span></span></td>
</tr>
</tbody>
</table>

### <a name="next-steps"></a><span data-ttu-id="2c8d1-407">الخطوات التالية</span><span class="sxs-lookup"><span data-stu-id="2c8d1-407">Next steps</span></span>

<span data-ttu-id="2c8d1-408">يمكن تنفيذ الأشكال المختلفة التالية للسيناريو الأول، استنادًا إلى متطلبات السيناريو الثاني.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-408">The following variations can be done for scenario 1, based on the requirements for scenario 2.</span></span> <span data-ttu-id="2c8d1-409">يمكنك استخدام هذا المقطع لتحسين تجربتك في استخدام تطبيقات المحمول.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-409">You can use this section to improve your mobile app experience.</span></span>

1.  <span data-ttu-id="2c8d1-410">نظرًا لتوقع المزيد من بنود الفاتورة في السيناريو 2، تساعد التغييرات التالية على التصميم في تحسين تجربة المستخدم على الجهاز المحمول:</span><span class="sxs-lookup"><span data-stu-id="2c8d1-410">Because more invoice lines are expected in scenario 2, the following changes to the design will help optimize the user experience on the mobile device:</span></span>
    1.  <span data-ttu-id="2c8d1-411">بدلاً من عرض بنود الفاتورة على صفحة "التفاصيل" (كما في السيناريو 1)، باستطاعة المستخدمين اختيار عرض البنود في صفحة محمول منفصلة.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-411">Instead of viewing invoice lines on the details page (as in scenario 1), users can choose to view lines on a separate mobile page.</span></span>
    2.  <span data-ttu-id="2c8d1-412">نظرً لتوقع أكثر من بند فاتورة في هذا السيناريو، إذا تم استخدام صفحة **VendMobileInvoiceAllDistributionTree** لتصميم صفحة التوزيعات للمحمول (كما في السيناريو 1)، فقد يشكل ربط البنود بالتوزيعات مصدر إرباك للمستخدم.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-412">Because more than one invoice line is expected in this scenario, if the **VendMobileInvoiceAllDistributionTree** page is used to design the distributions page for mobile (as in scenario 1), it might be confusing for the user to correlate lines to distributions.</span></span> <span data-ttu-id="2c8d1-413">ولذلك، استخدم صفحة **VendMobileInvoiceLineDistributionTree‎** لتصميم صفحة التوزيعات.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-413">Therefore, use the **VendMobileInvoiceLineDistributionTree** page to design the distributions page.</span></span>
    3.  <span data-ttu-id="2c8d1-414">ومن الناحية المثالية، ينبغي أن تظهر التوزيعات في سياق بند فاتورة في هذا السيناريو.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-414">Ideally, the distributions should be shown in the context of an invoice line in this scenario.</span></span> <span data-ttu-id="2c8d1-415">لذلك، تأكد من أنه باستطاعة المستخدم الانتقال إلى البند لرؤية صفحة التوزيعات.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-415">Therefore, make sure that the user can drill into a line to see the distributions page.</span></span> <span data-ttu-id="2c8d1-416">استخدم القدرة على ربط الصفحة لتأسيس عملية تنقل، تمامًا كما فعلت للرأس وصفحة التفاصيل في السيناريو 1.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-416">Use the page link capability to establish the drill-through, just as you did for the header and details pages in scenario 1.</span></span>

2.  <span data-ttu-id="2c8d1-417">نظرًا لتوقع أكثر من نوع مبلغ واحد على التوزيعات في السيناريو 2 (رسوم ضريبة المبيعات وغير ذلك)، سيكون من المفيد عرض الوصف الخاص بنوع المبلغ.</span><span class="sxs-lookup"><span data-stu-id="2c8d1-417">Because more than one amount type is expected on the distributions in scenario 2 (sales tax, charges, and so on), it will be useful to show the description of the amount type.</span></span> <span data-ttu-id="2c8d1-418">(لقد حذفنا هذه المعلومات في السيناريو 1.)</span><span class="sxs-lookup"><span data-stu-id="2c8d1-418">(We omitted this information in scenario 1.)</span></span>
