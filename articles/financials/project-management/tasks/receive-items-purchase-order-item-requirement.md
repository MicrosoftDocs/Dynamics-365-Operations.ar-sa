...
---
# <a name="receive-items-on-purchase-order-from-item-requirement"></a>تلقي الأصناف على أمر شراء من متطلبات الصنف

[!include [task guide banner](../../includes/task-guide-banner.md)]

يوضح هذا الموضوع كيفية استلام الأصناف في أمر شراء من طلب الصنف.
...
4. حدد **متطلبات الصنف‬**.
5. حدد **جديد**.
6. في الصف الجديد، أدخل أو حدد قيمة في حقل **رقم الصنف**.
...
14. حدد **موافق**.
15. في جزء التنقل، انتقل إلى **الوحدات النمطية > الحسابات الدائنة‬ > أوامر الشراء > جميع أوامر الشراء**.
16. في القائمة، حدد الارتباط في الصف المحدد.
17. في جزء الإجراءات، انقر فوق **شراء**.
18. حدد **تأكيد**.
19. في جزء الإجراءات، حدد **استلام**.
20. حدد **إيصال استلام المنتجات**.
21. في حقل **إيصال استلام المنتجات**، اكتب قيمة.
22. حدد **موافق**.
