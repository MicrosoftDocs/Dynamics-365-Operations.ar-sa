...
أنشئ مخطط الحسابات في صفحة **مخطط الحسابات**. ويمكن إنشاء الحسابات الرئيسية من صفحة **مخطط الحسابات** أو صفحة **الحسابات الرئيسية**. ويجب ألا تستخدم الحسابات الرئيسية الخاصة بك أية أحرف خاصة تُستخدم كمحددات لمخطط الحسابات. وإذا كان لديك حرف خاص هو نفسه محدد مخطط الحسابات، فقد تواجه عدم الاستقرار أو الحاجة إلى استخدام عمليات البحث دائمًا أو القائمة المنبثقة عند إدخال مجموعات الحسابات والأبعاد. لمزيد من المعلومات، راجع [إنشاء حساب رئيسي](tasks/create-main-account.md).
...
استخدم صفحة **تكوين بنيات الحسابات** لإنشاء بنيات الحسابات. تحدد بنيات الحسابات المجموعات الصالحة. وتشكل المجموعات، جنبا إلى جنب مع الحسابات الرئيسية، مخطط حسابات.  لمزيد من المعلومات، راجع [إنشاء بُنى الحساب](tasks/create-account-structures.md).
