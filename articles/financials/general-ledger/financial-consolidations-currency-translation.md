...
> [!NOTE]
> يُستخدم المصطلح *كيان قانوني* في Finance and Operations، ويُستخدم المصطلح *شركة* في إعداد التقارير المالية. وقد تم استخدام المصطلحين في هذا الموضوع. ومع ذلك، فإن معناهما هو نفسه، لأغراض تتعلق بهذا الموضوع.
...
يستخدم Finance and Operations كيانًا قانونيًا منفصلاً لمعالجة عملية الدمج. وهو يمكّن دمج مثيل واحد ولكنه يوفر خيار إحضار البيانات من مصادر أخرى. يجب تشغيل عملية الدمج في كل مرة يتم إجراء تغييرات في الكيانات القانونية المصدر.
...
![الكيان القانوني المستخدم لكل من الدمج والاستبعاد](./media/sep-elimination-company.png "الكيان القانوني المستخدم لكل من الدمج والاستبعاد")
...
![حساب الدمج الافتراضي محدد في صفحة الحسابات الرئيسية](./media/main-accounts.png "حساب الدمج الافتراضي محدد في صفحة الحسابات الرئيسية")
...
![التعيين في صفحة حسابات الدمج الإضافية](./media/additional-consolidation-accounts.png "التعيين في صفحة حسابات الدمج الإضافية")

## <a name="consolidating-online"></a>الدمج عبر الإنترنت
لمعرفة كيفية إدخال تفاصيل الدمج عبر الإنترنت، راجع [الدمج عبر الإنترنت](./consolidate-online.md).
...
- في قائمة حركات الدمج في صفحة **عمليات الدمج**، استعرض الأرصدة التي تم إنشاؤها بحسب التاريخ لكل شركة مصدر لكل فترة.
    ...
    ![حركات الدمج في صفحة عمليات الدمج](./media/managing-consolidation-transactions.png "حركات الدمج في صفحة عمليات الدمج")
...
عند إعداد قواعد الاستبعاد في Finance and Operations، يمكنك إنشاء بعد مالي يتم استخدامه لأغراض الاستبعاد على وجه التحديد. يطلق معظم العملاء على هذا البعد الاسم **شريك تجاري** أو شيء من هذا القبيل. إذا قررت عدم استخدام بعد مالي، فتأكد من أن لديك حسابات رئيسية تُستخدم للحركات بين الشركات الشقيقة فقط.
...
![الخصائص الأساسية لقاعدة استبعاد](./media/ledger-elimination-rule-journal.png "الخصائص الأساسية لقاعدة استبعاد")
...
حدد الحسابات المصدر. يمكنك استخدام علامة النجمة (\*) كحرف بدل. على سبيل المثال، يحدد الرقم **1\*** جميع الحسابات التي تبدأ بالرقم **1** كمصدر للتوزيع.
...
- **عمق البيانات** – يمكنك إنشاء تقارير مدمجة تجمع معًا البيانات الفعلية وبيانات الموازنة على مستوى الحساب ومستوى الأبعاد على حدٍ سواء. بالنسبة إلى Finance and Operations، تتضمن هذه البيانات بيانات من كل من رقابة الموازنة وتخطيط الموازنة.
...
- **تسهيل تحويل العملة** - بعد الحد الأدنى من الإعداد في Finance and Operations، يمكنك تحويل أي تقرير مالي إلى أي عملة تقارير تم إعدادها. بالإضافة إلى ذلك، يمكنك إعداد عدد غير محدد من عملات التقارير.
