...
يوفر هذا الموضوع نظرة عامة ومعلومات حول إعداد الرسائل الإلكترونية في Microsoft Dynamics 365 for Finance and Operations.
...
- **معالجة الرسائل الإلكترونية** -عبارة عن سلسلة من الإجراءات، تكون إما مرتبطة أو غير مرتبطة، والتي يتعين تشغيلها لجميع البيانات المطلوبة وإنشاء التقارير وتخزين البيانات في مخزن البيانات الثنائية كبيرة الحجم في Microsoft Azure وإرسال تقارير خارج النظام والحصول على الاستجابات من خارج النظام وتحديث قاعدة البيانات بناءً على المعلومات المستلمة.
...
- إنشاء الرسائل يدويًا وإنشاء تقارير تستند على تنسيقات ER تصدير مرتبطة من مختلف الأنواع: Microsoft Excel و XML وJavaScript Object Notation (JSON) وPDF و text و Microsoft Word.
...
يوضح الجدول التالي الحقول في صفحة **الحقول الإضافية**.
...
| قيمة الحقل          | أدخل قيمة الحقل المستخدمة فيما يتعلق بعنصر الرسالة في أثناء إعداد التقارير. |
| وصف الحقل    | أدخل وصفًا لقيمة الحقل المستخدمة فيما يتعلق بعنصر الرسالة في أثناء إعداد التقارير. |
...
| عنوان الإنترنت        | أدخل عنوان البريد الإلكتروني لخدمة الويب. |
...
| نوع صنف الرسالة       | حدد أنواع السجلات التي يجب تقييم الإجراء بالنسبة لها. يتوفر هذا الحقل فقط للإجراءات الخاصة بأنواع **مستوى تنفيذ صنف الرسالة**، **تصدير التقارير الإلكترونية**، و **استيراد التقارير الإلكترونية**، فضلًا عن بعض الأنواع الأخرى. إذا تركت هذا الحقل فارغًا، يتم تقييم كافة أنواع عناصر الرسائل المُحددة لمعالجة الرسائل. |
...
- **تعبئة السجلات** – يجب إعداد إجراء**تعبئة السجلات** مسبقًا. إقران الإجراء بإجراء من النوع **تعبئة السجلات** لتمكين تضمنيه في المعالجة. من المفترض أن يتم استخدام نوع الإجراء هذا للإجراء الأول في معالجة الرسالة. وبالتالي، يمكن فقط إعداد حالة النتيجة لإجراء من هذا النوع. يتعذر إعداد الحالة الأولية.
...
- **خدمة الويب** -استخدم هذا النوع للإجراءات التي يجب أن ترسل تقرير تم إنشاؤه إلى خدمة ويب. لم يتم استخدام نوع الإجراء هذا لتقارير اتصالات فواتير المبيعات والشراء الإيطالية.
...
> [!NOTE]
> لا تتوفر علامة التبويب السريعة**الحالات الأولية**للإجراءات التي تحتوي على نوع أولى من **تعبئة السجلات** أو **إنشاء رسالة**.
...
يمثل معالجة الرسائل الإلكترونية مفهومًا أساسيًا لوظيفة الرسائل الإلكترونية. يقوم ذلك بتجميع الإجراءات التي يتعين تقييمها للرسالة الإلكترونية. يمكن ربط الإجرايات من خلال حالة أولية وحالة نتيجة. بدلًا من ذلك، يمكن بدء الإجراءات من النوع **معالجة المستخدم** بشكل مستقل. في صفحة **معالجة الرسائل الإلكترونية** (**الضرائب** \> **الإعداد** \> **الرسائل الإلكترونية** \> **معالجة الرسائل الإلكترونية**)، يمكنك أيضًا تحديد حقول إضافيه يتعين دعمها للمعالجة.

تسمح لك علامة التبويب السريعة**إجراء** بإضافة الإجراءات المُعرفة مسبقًا إلى المعالجة. يمكنك تحديد ما إذا كان يجب تشغيل إجراء بشكل منفصل، أو بدئه من خلال المعالجة. (يجب تشغيل إجراءات المستخدمين بشكل منفصل.)
...
توضح علامة التبويب السريعة**سجل الإجراءات** معلومات حول كافة الإجراءات التي يتم تشغيلها للرسالة المحددة.
...
توضح علامة التبويب السريعة **أصناف الرسائل** كافة أصناف الرسائل المتعلقة بالرسالة المُحددة.
