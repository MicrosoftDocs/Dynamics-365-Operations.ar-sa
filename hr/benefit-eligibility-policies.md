...
description: "توفر هذه المقالة معلومات حول سياسات استحقاق المزايا، التي تساعدك على المؤهلين لمزايا معينة."
author: rschloma
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
يوفر هذا الموضوع معلومات حول ميزة نهج الأهلية، التي تساعد تعريف يكون مستوفيا لشروط الحصول على استحقاقات معينة.
...
يتم استخدام المكونات التالية في لإنشاء نهج الأهلية:
