...
يوضح الرسم التخطيطي التالي كيف ترتبط المكونات الأساسية لإدارة الأداء ببعضها البعض. [![نظرة عامة حول عملية الأداء](./media/hcm_performanceoverviewdiagram-300x189.png)](./media/hcm_performanceoverviewdiagram.png)    
...
2.  المراجعة النهائية. إضافة هذا العنصر التحكم بتغيير الحالة من **جاهزة للمراجعة** إلى **المراجعة النهائية**. تغيير التعيين لاستخدام التدرج الهرمي الإداري حيث مستوى إدارة Employee.line = 1 إذا أردت إدارة الموافقة على الاستعراض النهائي. قم بتغيير التعيين إلى مستخدم سير العمل إذا كنت تريد أن يوافق الموظف عليه. إذا كنت تريد أن يوافق عليه كل من المدير والموظف عليه، عليك بإضافة خطوتين في سير العمل وإعداد التعيين المناسب لكل خطوة بالترتيب الذي تريد أن تتبعه الموافقات.
