...
يشير التعويض الثابت إلى الأجر أو الراتب الإجمالي المنتظم للموظف. يصف هذا الموضوع العناصر التي يجب إعدادها قبل إنشاء خطة تعويض ثابت وتسجيل الموظفين.

يمكن حساب مبالغ التعويض الثابت للموظفين، على أساس عوامل مثل الأداء والمنطقة وزيادات الموازنة. يدعم Microsoft Dynamics 365 للعمليات خطوة ودرجة ونطاق أنواع التعويض.

## <a name="fixed-compensation-components"></a>مكونات التعويض الثابت
### <a name="compensation-levels"></a>مستويات التعويض

يمكنك استخدام **مستويات التعويض** لتعيين التعويض على مهن مختلفة للمساعدة في ضمان أن الموظفين الذين يشغلون الوظائف التي تدفع إلى حد ما. على **مستويات التعويض** صفحة، يمكنك إعداد مستويات التعويض المطلوبة لكل خطوة ودرجة خطة الفرقة. واستخدام الزرين **لأعلى** و**لأسفل** لوضع المستويات بالترتيب الصحيح، وفقًا لنوعها. ومن خلال تعيين مستويات التعويض في وظيفة، تساعد على ضمان دفع الأجور لجميع الموظفين الذين يشغلون منصب في تلك الوظيفة بنفس المستوى.

### <a name="reference-points"></a>النقاط المرجعية

**النقاط المرجعية** هي الأعمدة الموجودة في الشبكة والتي تحدد نطاقات التعويض لكل مستوى. مستوى التعويض هو الصف في الشبكة. هي نقاط مرجعية نموذجية لخطة عمل من نوع الصف الحد أدنى ونقطة وسط والحد أقصى. إنشاء نقاط مرجعية على **إعدادات النقطة المرجعية** الصفحة.
...
**قاعدة التوظيف** إعداد يتيح لك تحديد ما إذا كان يجب أن يتلقى جميع الموظفين نفس الزيادة، بغض النظر عن التاريخ الذي تم التعاقد مع (**قاعدة التوظيف** = **أي**)، أو ما إذا كان ينبغي أن يتلقى الموظفون نسبة مئوية من التعويض، استناداً إلى المدة كانوا يعملون أثناء الدورة (**قاعدة التوظيف** = **في المائة**). 
...
الخطوة الأولى في تسجيل الموظفين في خطة تعويض ثابت هي تحديد الشخص المؤهل للتعويض المحدد في الخطة. وحتى يمكنك تحديد الأهلية، لن تتمكن من تعيين الخطة لأي موظفين. لإعداد الأهلية، فتح **قواعد الأهلية** الصفحة. هنا، يمكنك إنشاء استحقاق جديد القاعدة لخطة التعويض وتحديد المعايير التي يجب أن تستوفيها موظف ليكون مؤهلاً لخطة. يمكنك تقييد الأهلية استنادًا إلى القسم أو اتحاد العمال منطقة التعويض (الموقع) أو المهمة أو الوظيفة أو نوع الوظيفة أو مستوى التعويض. ولا يمكن تسجيل الموظفين في خطة تعويض إلا إذا كانوا يستوفون كافة الشروط التي تم تعيينها في قاعدة الأهلية. 
...
تعتبر قاعدة الأهلية أيضا اتحادات العمال المرتبطة بالموظف (على **الموظفين** الصفحة، ومن **العامل** ، انقر فوق **المعلومات الشخصية**&gt;**اتحادات العمال**).
...
يمكنك الآن تعيين موظف جديد لخطة تعويض ثابت. افتح صفحة **الموظفين**، وقم بتحديد الموظف لتسجيله في خطة التعويض. في "جزء الإجراءات"، انقر فوق **التعويض**&gt;**الخطة الثابتة**. يمكنك الآن إنشاء إجراء تعويض ثابت جديد لهذا الموظف. 
