...
يمكن حساب مبالغ التعويض الثابت للموظفين، على أساس عوامل مثل الأداء والمنطقة وزيادات الموازنة. يدعم Microsoft Dynamics 365 for Operations الخطوة والدرجة وأنواع تعويض النطاق.
