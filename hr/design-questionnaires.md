...
>**ملاحظة** إذا قمت بتعديل نص الإجابات في مجموعات الإجابات التي تم استخدامها في وقت سابق في استبيانات المكتملة، قد يصعب تقييم البيانات، وقد لا تعود نتائج الاستبيان صالحة. إذا كان يجب تغيير مجموعة إجابات، فراع إنشاء مجموعة إجابات جديدة بدلاً من تغيير مجموعة موجودة. لا يمكنك حذف مجموعات الإجابات المرفقة بسؤال أو إجابة أو تلك التي تمت إجابتها.
...
-   وتتطلب الأسئلة ذات النهايات المغلقة قائمة بخيارات الإجابات المحددة مسبقًا، ويمكن تنظيم الأسئلة للسماح للمستجيب بتحديد الإجابات المتعددة. ويجب تصميم الأسئلة للحصول على معلومات محددة من المستجيب ويجب ربطها بمجموعة إجابات توفر خيارات الإجابة لكل سؤال ذي نهاية مغلقة. 
    >**ملاحظة** قبل أن تتمكن من إعداد الأسئلة ذات النهايات المغلقة، يجب عليك إنشاء مجموعات الإجابات والإجابات.
...
>**ملاحظة**
>  قبل أن تتمكن من إعداد استبيان، يجب عليك إعداد الأسئلة والإجابات والمتطلبات الأساسية. 
...
>**تحذير** توخ الحذر عند تغيير الاستبيانات التي تمت الإجابة عنها بالفعل. قد تؤدي التغييرات إلى الحد من دقة الإحصائيات ومن ثم جعلها أساسًا ضعيفًا للتقييم. عليك بمراعاة إنشاء سؤال جديد بدلاً من تغيير سؤال تمت الإجابة عنه بالفعل.
...
> **ملاحظة**
>   قبل أن تتمكن من إعداد مجموعات النتائج، يجب عليك إكمال المهام التالية:
...
#### مثال: النقاط/النصوص لمجموعة النتائج 3
...
### التدرجات الهرمية للأسئلة المشروطة
<a id="conditional-question-hierarchies" class="xliff"></a>

تكون التدرجات الهرمية للأسئلة المشروطة اختيارية عند إعداد استبيان. 

> **ملاحظة**
>   قبل أن تتمكن من إعداد تدرج هرمي للأسئلة المشروطة، يجب إرفاق الأسئلة التي تم تعيين مجموعات إجابات إليها بالاستبيان. 
