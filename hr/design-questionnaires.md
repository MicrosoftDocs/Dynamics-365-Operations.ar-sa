---
title: "تصميم استبيان"
description: "يصف هذا الموضوع عملية إنشاء استبيان. والخطوة الأولى هو تصميم الاستبيان. عندما تقوم بتصميم استبيان، لا تقوم سوى بكتابة الأسئلة والإجابات، بل وتُنشئ أيضًا البنية التي تتيح إمكانية تسجيل الإجابات وجدولتها."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
يصف هذا الموضوع عملية إنشاء استبيان. والخطوة الأولى هو تصميم الاستبيان. عندما تقوم بتصميم استبيان، لا تقوم سوى بكتابة الأسئلة والإجابات، بل وتُنشئ أيضًا البنية التي تتيح إمكانية تسجيل الإجابات وجدولتها. 
...
ويتم استخدام أكواد المسلسلات الرقمية لتنظيم الأسئلة والأجوبة. استناداً إلى هذه أكواد التسلسل الرقمي، يتم تلقائياً تعيين قيم للعناصر. 
...
استبيانات تتضمن ثلاثة عناصر رئيسية: الرد على المجموعات التي تحتوي على الإجابات للاختيار من متعدد الأسئلة وأسئلة الاستبيان ذاته. يمكنك بشكل اختياري تجميع الأسئلة في استبيان إلى مجموعات النتائج. تمكّنك مجموعات النتائج من تصنيف الأسئلة وإجراء المزيد من التحليل في الاستبيان. 

[![قوستيونايريكومبونينتس](./media/questionnairecomponents-1024x615.png)](./media/questionnairecomponents.png)
