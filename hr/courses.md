...
# <a name="set-up-training-courses"></a>إعداد دورات تدريبية
...
-   إنشاء وصف للدورة التدريبية، حيث يمكنك الإعلان عنه على الخدمة الذاتية للموظف
  ...
  >**ملاحظة** يمكنك حذف دورة تدريبية فقط إذا تم تسجيل أي شخص له. 
...
الموظفين الذين يقومون بالتسجيل لدورة من خلال **الموظف الخدمة الذاتية** يمكن أن تحتوي الصفحة على التسجيل عن طريق سير العمل للموافقة.  يمكن تعيين سير عمل الدورة تدريبية على **عام** العمل على **الدورات** الصفحة.
