...
عرض الموظفين السجلات الخاصة بالعناصر التي تم إقراضها لهم استخدام مساحة عمل الموظف الخدمة الذاتية. يمكنهم أيضا تحرير سجلات موجودة أو إدخال أصناف القرض الجديد، إذا تلقيت عناصر إضافية فعلية.  يمكن إعداد سير عمل لتوجيه تغييرات أصناف القرض جديدة أو موجودة من خلال عملية موافقة. 
