---
title: "تنظيم قوة العمل استخدام الإدارات والوظائف والمناصب"
...
# <a name="organize-your-workforce-using-departments-jobs-and-positions"></a>تنظيم قوة العمل استخدام الإدارات والوظائف والمناصب
...
|**Accounting**|المشرف على المحاسبة|مدير الحسابات|
|**Accounting**|محاسبة أ|المحاسب|
|**Human resources**|مدير الموارد البشرية (شرق)|مدير الموارد البشرية|
|**Human resources**|مدير الموارد البشرية (غرب)|مدير الموارد البشرية|
|**Human resources**|مدير الموارد البشرية (المركزي)|مدير الموارد البشرية|
...
تشبه مهام الوظيفة أدوار الوظيفة. تصف مهمة الوظيفة واحدة أو أكثر من المهام أو الواجبات أو المسؤوليات التي يتم تعيينها لوظيفة. يمكن تعيين مهام إلى مهام الوظيفة والمستخدمة لإعداد وتنفيذ قواعد الأهلية لخطط التعويض. أمثلة لمهام الوظيفة المسرودة في الجدول التالي.
...
المناصب هي عنصر مهم في مستوى أقل للتدرج الهرمي للمؤسسات. يعتبر أي منصب هو مثيل فردي لوظيفة ما. على سبيل المثال، موضع "مدير المبيعات (شرق)،" ليست سوى واحدة من المناصب المقترن بالمهمة، "مدير المبيعات". يوجد في قسم المناصب وتعيينها إلى العاملين.
### <a name="position-creation-and-maintenance"></a> إنشاء المنصب والاحتفاظ بها
