...
<a name=""></a>=======
---
# <a name="required-metadata"></a>بيانات التعريف المطلوبة

العنوان: توزيع وإكمال وصف الاستبيان. يوضح هذا الموضوع كيفية توزيع الاستبيانات التي تقوم بتصميمها، بحيث تكون متوفرة لشخص أو مجموعة الأشخاص الذين سيقومون بإكمالها. الكاتب: مسؤول twheeloc: AnnBe ms.date: 06/20/2017 ms.topic: article ms.prod: ms.service: Dynamics365Operations ms.technology: 

# <a name="optional-metadata"></a>بيانات تعريف اختيارية

ms.search.form: KMConnectionType, KMKnowledgeCollectorPlanningTabel, SysEmailParameters
# <a name="robots"></a>الروبوت: 
الجمهور: مستخدم التطبيق
...
ms.author: twheeloc ms.search.validFrom: 2016-02-28 ms.dyn365.ops.version: AX 7.0.0, Talent تحديث يوليو 2017

---

# <a name="distribute-and-complete-a-questionnaire"></a>توزيع وإكمال استبيان
...
واستخدام صفحة **أنواع المراجع** لإعداد أنواع المرجع لاستبيان. ويتوافق كل نوع مرجع مع جدول في Microsoft Dynamics 365 for Finance and Operations, Enterprise edition. وعند إنشاء جداول الاستبيان، يمكنك تحديد السجلات الفردية في الجدول أو مجموعة السجلات التي سيتم إقران الاستبيان بها. 
...
**ملاحظة:** يجب أن يكون المستجيبون مستخدمين في Microsoft Dynamics 365 for Finance and Operations, Enterprise edition لإكمال استبيان.
