...
قد يتضمن القسم مجموعة من مراكز التكلفة. ويمكن تعيين مناصب للأقسام. لإنشاء قسم، انقر **الموارد البشرية**&gt;**الأقسام**&gt;**إدارة**. يصف الجدول التالي الحقول المتوفرة.
...
1.  انقر فوق **الموارد البشرية**&gt;**الأقسام**&gt;**إدارة التسلسل الهرمي**.
...
5.  ‏‏قم بحفظ التغييرات التي قمت بإجرائها. تظهر رسالة أنه قد تم إنشاء نسخة مسودة من التسلسل الهرمي.
6.  عندما تكون جاهزاً، انقر فوق **نشر** في "مصمم" التسلسل الهرمي ". يمكنك إدخال تاريخ سريان تشير إلى متى سيتم نشر التسلسل الهرمي. على سبيل المثال، لإضافة قسم جديد في بداية السنة التقويمية التالية، قم بتعيين تاريخ السريان إلى 1 كانون الثاني/يناير من السنة التقويمية الجديدة. وستصبح التغييرات على التدرج الهرمي نافذة المفعول في ذلك التاريخ.
