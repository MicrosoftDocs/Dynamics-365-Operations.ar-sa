---
title: "طرق الدفع"
description: "يجب تكوين كل نوع الدفع الذي يقبل أحد بائعي تجزئة في البيع بالتجزئة والتجارة في Microsoft Dynamics 365 للعمليات عند إعداد النظام. تصف هذه المقالة أنواع الدفع التي يمكنك إعدادها وتصف عملية إعدادها."
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
يجب تكوين كل نوع الدفع الذي يقبل أحد بائعي تجزئة في البيع بالتجزئة والتجارة في Microsoft Dynamics 365 للعمليات عند إعداد النظام. تصف هذه المقالة أنواع الدفع التي يمكنك إعدادها وتصف عملية إعدادها.

يستطيع تجار التجزئة قبول أنواع مختلفة من الدفع مقابل المنتجات والخدمات التي يبيعونها. وعلى الرغم من أن النقد أكثر الطرق شيوعاً للدفع، إلا أن تجار التجزئة يمكنهم أيضًا تلقي المدفوعات في شكل شيكات، وبطاقات، وإيصالات، وهكذا. يجب تكوين كل نوع الدفع الذي يقبل بائع التجزئة في ديناميات 365 للعمليات-البيع بالتجزئة عند إعداد النظام. تصف القائمة التالية كل نوع الدفع التي يتم إعدادها في ديناميات 365 للعمليات-البيع بالتجزئة:
...
-   **نقاط الولاء** – النقاط التي تتراكم من خلال برامج ولاء العملاء. إذا قمت بإنشاء برامج الولاء، يمكن كسب نقاط العملاء واسترجاعها بعد ذلك بعدة طرق. على سبيل المثال، في بعض برامج الولاء، يمكن للعملاء استرجاع نقاط الولاء في شكل خصم أو حتى استخدامها كطريقة دفع.

لإعداد طرق الدفع في التجارة والبيع بالتجزئة، يجب عليك إتمام المهام التالية.

1.  إعداد طرق الدفع لمؤسسة. أنشئ طرق الدفع التي تم قبولها من قِبل المؤسسة بأكملها.
2.  إنشاء أنواع البطاقات على نطاق المنظمة وأرقام البطاقات. إذا تم قبول البطاقات الائتمانية أو بطاقات السحب، يجب إنشاء طريقة واحدة لبطاقات، وقم بإنشاء أنواع البطاقات على نطاق المنظمة وأرقام بطاقات.
3.  قم بإعداد طريقة الدفع المخزن. إقران كل متجر طرق الدفع ومن ثم أدخل الإعدادات الخاصة بالمخزن لكل أسلوب الدفع.
4.  إعداد طرق الدفع بطاقة للمخازن. لأية أساليب الدفع بطاقة يقبل المتجر، باستكمال إعداد بطاقة.
