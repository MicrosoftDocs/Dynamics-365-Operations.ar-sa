...
تجار التجزئة غالباً ما تقدم خصومات مختلفة في قنوات مختلفة. هذا قد فعله لمعالجة ظروف السوق المحلية أو إلى التعامل مع تجار التجزئة المنافسة.

البيع بالتجزئة والتجارة في Microsoft Dynamics 365 لعمليات استخدام مجموعات الأسعار لتعريف الخصومات الخاصة بالقناة. ويمكن تعيين مجموعات الأسعار لواحدة أو أكثر من الوحدات التالية: القنوات والكتالوجات والتبعيات وبرامج الولاء. وتتناول هذه المقالة القنوات، لكن نفس المفاهيم تنطبق على خصومات الكتالوج وخصومات التبعيات وخصومات الولاء.

## <a name="price-groups"></a>مجموعات الأسعار
\[عنوان معرف = "مرفق\_256084" محاذاة = "اليجنوني" width = "640"\][![مجموعات السعر](./media/price-groups-1024x608.png)](./media/price-groups.png) سعر ارتباطات المجموعة للبيع بالتجزئة\[/عنوان\]

يوضح الرسم البياني أعلاه العلاقة بين الكيانات التي قد تكون حركة (القناة، كتالوج، الانضمام، العميل، بطاقة الولاء) ومختلف أنواع الخصم التي يمكن تكوينها. تحدث كافة الحركات في قناة، حيث يتم ضمان القناة على حركة. الكيانات المتبقية اختيارية. وفي كل صفحة من صفحات البيانات الرئيسية، هناك رابط إلى صفحة مجموعات الأسعار ذات الصلة، حيث يمكنك عرض وإضافة مجموعات الأسعار عند اللزوم. يستخدم مجموعة أسعار لربط أربعة أنواع مختلفة من الكيانات إلى تعديلات الأسعار والخصومات الاتفاقيات التجارية. نوصي بأن خطة استراتيجية لكيف سيتم تسمية مجموعات الأسعار الخاصة بك للحفاظ على تنظيمها. خيار واحد يتمثل في استخدام حرف أو بادئة أو لاحقة الرقم للتمييز بين الأنواع المختلفة. على سبيل المثال، 1-xxxxx لمجموعات الأسعار القناة و 2 كسكسكسكسكس لمجموعات سعر كتالوج. وهناك أربع صفحات استعلام تركز على كل كيان من كيانات البيع بالتجزئة يمكن أن تكون الخصومات مقترنة بها.
