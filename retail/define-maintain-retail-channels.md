...
description: "توفر هذه المقالة نظرة عامة على عملية إعداد الطوب وهاون مخازن، التي يشار إليها كمتاجر البيع بالتجزئة في Microsoft Dynamics 365 للعمليات. وهي تتضمن معلومات حول المهام التي يجب إكمالها قبل إعداد متجر البيع بالتجزئة وبعده."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
11. إعداد أعضاء الفريق. **ملاحظة:** يجب أيضا تعيين الأذونات المناسبة للعمال، وبذلك يمكن تسجيل الدخول وتنفيذ المهام باستخدام 365 ديناميات عمليات النظام Retail POS.
