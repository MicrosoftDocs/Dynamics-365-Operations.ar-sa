---
title: "إعداد وظيفة تسجيل الدخول الموسعة لنقاط البيع مجموعة النظراء ومبوس"
description: "تتناول مقالة wiki هذه الخيارات الخاصة بإعداد تسجيل الدخول الموسع لنقاط بيع المجموعة ونقاط البيع الحديثة للبيع بالتجزئة (MPOS)."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-extended-logon-functionality-for-cloud-pos-and-mpos"></a>إعداد وظيفة تسجيل الدخول الموسعة لنقاط البيع مجموعة النظراء ومبوس

تتناول مقالة wiki هذه الخيارات الخاصة بإعداد تسجيل الدخول الموسع لنقاط بيع المجموعة ونقاط البيع الحديثة للبيع بالتجزئة (MPOS).

<a name="setting-up-extended-logon"></a>إعداد تسجيل الدخول الموسع
=========================

يمكنك العثور على الإعداد الكود الشريطي الأقنعة في **البيع بالتجزئة والتجارة**&gt;**إعداد القناة**&gt;**إعداد نقاط البيع**&gt;**ملفات تعريف نقاط البيع**&gt;**ملفات تعريف الوظائف**. تتضمن علامة التبويب السريعة **الوظائف** الخيارات التالية المتعلقة بتسجيل دخول موسع.
...
بشكل افتراضي، يستطيع المديرون فقط تعيين تسجيل الدخول الموسع للعاملين. لتعيين تسجيل الدخول الموسعة، انتقل إلى **سجل موسع على** في نقطة البيع. ثم البحث عن عامل عن طريق إدخال معرف مستخدم له أو لها في حقل البحث. حدد العامل، ثم انقر فوق **تعيين**. في الصفحة التالية، اسحب تسجيل الدخول الموسع أو امسحه لتعيين العامل. إذا تمت قراءة السحب أو المسح بنجاح، يصبح الزر **موافق **متوفرًا. انقر فوق **موافق** لحفظ تسجيل الدخول الموسع لهذا العامل.
