...
description: "يصف هذا الموضوع كيفية استخدام مسجل المهام في نقطة بيع التجزئة الحديثة (MPOS) ونقطة بيع المجموعة."
author: mugunthanm
manager: AnnBe
ms.date: 2017-05-15
ms.topic: article
...
يصف هذا الموضوع كيفية استخدام مسجل المهام في نقطة بيع التجزئة الحديثة (MPOS) ونقطة بيع المجموعة.
...
4.  انقر فوق **حفظ**.
5.  انتقل إلى **البيع بالتجزئة والتجارة** &gt; **تقنية معلومات البيع بالتجزئة** &gt; **جدول التوزيع**.
...
3.  أدخل اسمًا ووصفًا للتسجيل، ثم انقر فوق **البدء‬**. تبدأ جلسة التسجيل بمجرد النقر فوق **البدء‬**. **ملاحظة:** إذا نقرت فوق الزر **إغلاق** (**X**) في الزاوية العلوية اليسرى بينما يكون التسجيل قيد التقدم، فسيتم إغلاق جزء **مسجل المهام**، ولكن من دون إنهاء جلسة التسجيل. لإعادة فتح جزء مسجل المهام، انقر فوق الزر "تعليمات" (علامة استفهام) في الجزء العلوي من الشاشة. 
...
باستطاعة مسجل المهام التقاط لقطات الشاشة‬ لواجهة مستخدم نقطة البيع الحديثة للبيع بالتجزئة بينما تقوم بتسجيل عملية تجارية. يستخدم مسجل المهام لقطات الشاشة في حالة تنزيل التسجيل كمستند Word. لتشغيل ميزة التقاط لقطات الشاشة‬، عيّن الخيار **التقاط لقطات الشاشة‬** إلى **نعم**. ملاحظة: وظيفة التقاط لقطات الشاشة‬ غير مدعومة في نقطة بيع المجموعة‬.
...
## <a name="help-at-retail-modern-pos-and-cloud-pos"></a>نظام التعليمات في نقطة البيع الحديثة للبيع بالتجزئة ونقطة بيع المجموعة
لإظهار تسجيلات المهام المخصصة الخاصة بك في جزء المساعدة في نقطة البيع الحديثة للبيع بالتجزئة ونقطة بيع المجموعة بحيث يمكن عرضها كنص، يجب عليك حفظ تسجيلات المهام إلى مكتبة BPM، ثم تحديث محددات نظام التعليمات‬ بحيث تشير إلى مكتبة BPM. لمزيد من المعلومات، راجع [الاتصال بنظام التعليمات.](https://ax.help.dynamics.com/en/wiki/working-with-help/#connecting-the-help-system) يبحث نظام تعليمات نقطة البيع الحديثة للبيع بالتجزئة ونقطة بيع المجموعة‬ في LCS في‬ الوقت الحقيقي. وهو يبحث عبر كافة مكتبات BPM التي تم تحديدها في محددات نظام تعليمات Microsoft Dynamics AX ويعرض النتائج ذات الصلة. للوصول إلى القائمة **تعليمات**، انقر فوق الزر **تعليمات** في الجزء العلوي من الشاشة، ثم اكتب اسم عمليتك في مربع البحث واضغط الزر بحث. 

[![الزر تعليمات](./media/help.jpg)](./media/help.jpg) 

عندما تنقر فوق دليل مهام في نتائج البحث، يمكنك عرض الخطوات كموضوع تعليمات أو تصدير الخطوات إلى مستند Word. ملاحظة: لا يقوم نظام التعليمات في نقطة البيع الحديثة للبيع بالتجزئة ونقطة بيع المجموعة‬ بإحضار دلائل المهام بشكل تلقائي استنادًا إلى النموذج أو العمليات، يجب عليك كتابة اسم العملية في مربع البحث، ثم ضغط الزر بحث للحصول على النتائج.
