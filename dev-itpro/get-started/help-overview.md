...
لمزيد من المعلومات حول مسجل المهام، راجع [مسجل المهام في Finance and Operations](../user-interface/task-recorder.md).
...
يسرد الجدول التالي مواقع ويب التي توفر محتوى Unified Operations. ويتم تنظيم مواقع ويب المحتوى لدعم دورة حياة العميل. وكل مرحلة مدعومة بمجموعة مختلفة من المواقع. وتتطلب بعض المواقع التي تحتوي على العلامة النجمية (\*) بجوار الاسم قيامك بتسجيل الدخول باستخدام حساب مقترن بخطة خدمة.
...
--------
[نظام تعليمات Finance and Operations (ورقة حقائق قابلة للتنزيل)](https://mbs.microsoft.com/files/public/CS/AX2012R3/DynamicsAXHelpSystemFactSheet.pdf)
