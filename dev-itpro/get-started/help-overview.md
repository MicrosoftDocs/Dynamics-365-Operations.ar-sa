...
موقع docs.microsoft.com ([docs.microsoft.com/dynamics365/operations](/dynamics365/#pivot=solutions&panel=solutions_operations) هو المصدر الأساسي لوثائق المنتج Dynamics 365 for Operations. يقدم الموقع الميزات التالية:
...
يمكنك قراءة المحتوى على docs. الآن -- فهو عام ويمكن البحث فيه دون الحاجة إلى تسجيل الدخول. ويمكنك استخدام أيٍّ من محركات البحث المفضلة للعثور على المحتوى. يمكنك التعليق على المقالات الموجودة بالموقع إذا أردت، وذلك من خلال تسجيل الدخول.
...
للوصول إلى محتوى التعليمات ضمن Dynamics 365 for Operations، انقر فوق أيقونة **التعليمات** (**؟**) أو اضغط على Ctrl+Shift+?. وفي كلتا الحالتين، يتم فتح جزء المساعدة. وفي جزء التعليمات، يمكنك الوصول إلى مقالات أو دلائل المهام. [![جزء التعليمات](./media/help-pane-wiki-1024x684.png)](./media/help-pane-wiki.png)
