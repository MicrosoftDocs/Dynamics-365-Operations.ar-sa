...
| إنشاء مصروفات غير مرفقة بتقرير مصروفات والمحافظة عليها.    | يمكن للمستخدم الآن إنشاء مصروفات والمحافظة عليها (على سبيل المثال، بإرفاق أو تصنيف الإيصالات أو تعيين الضيوف) من دون الحاجة إلى إنشاء تقرير مصروفات أولاً. يمكن تحديد بند مصروفات أو أكثر وإضافته إلى تقرير مصروفات جديد، بحيث يتم إرساله للموافقة عليها. تتوفر صفحة جديدة للحفاظ على المصروفات عند **إدارة المصروفات**&gt;**المصروفات الخاصة بي**&gt;**المصروفات**.                                                                                                                                                                                                                                                       |
...
| الوصول إلى خمسة "ثنائي الطاقة" المحتوى حزم جديدة للموارد البشرية                                     | حزم محتوى جديدة تتيح لمديري الموارد البشرية المؤسسات والموارد البشرية لتحليل ما يلي: القوة العاملة قياسات • السكانية الأعطال حسب السن والجنس والحالة الاجتماعية • مقارنة السنة معدلات التناقص الطبيعي خلال السنة ومشاهدة قائمة الأسباب التي منحت الموظفين لترك • المؤسسة عرض قائمة المراكز المفتوحة، بالإضافة إلى مقارنة بين المراكز المفتوحة إلى مغلق التعويض والفوائد • مقارنة الساعة وعرض • اجيرا عدد الموظفين المسجلين في الاستحقاقات المتاحة • عرض الموظفين حسب نوع العمالة • توظيف تحليل مقدمي الطلبات استناداً إلى عدد مقدمي الطلبات، حيث أنهم القادمة من، والمناصب التي تقوم بتطبيق للتدريب التنظيمي • أثناء التسجيل من موقع • الحضور تتسبب بحالة • قائمة الموظفين تسجيل • تطوير قائمة بالمهارات واختصاصات الموظفين دورات عقدتها • الموظفين تصنيف أنواع المهارات بعضو الفريق |
...
<td>البنك المتنوعة لخطاب الاعتماد تنسيق تخصيص المصاريف للمملكة العربية السعودية</td>
</tr>
<tr class="odd">
...
<td>تعتبر هذه الميزة بمثابة تحسين في الإنتاجية. <strong>المثال</strong> بيع منتج باسم "تي شيرت بولو". ويتوفر هذا المنتج بلونين: الأخضر والأزرق. كما أنه يتوفر بحجمين: صغير ومتوسط. يعتبر اللون والحجم من أبعاد المنتج النشطة لقميص بولو. عندما تقوم بإدخال بند مبيعات قميص بولو أخضر اللون وبحجم صغير، لا يلزم إدخال البيانات في حقول <strong>رقم الصنف</strong> و<strong>اللون</strong> و<strong>الحجم</strong>. يمكنك إنشاء البند باتباع إحدى الخطوات التالية:
<ul>
...
| ما الذي يمكنك فعله؟                                                                                                                                                                                                                                                                        | لماذا يعتبر هذا الأمر مهمًا؟                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| عرض توصيات المنتج المخصصة في بوينت متعددة في نقطة البيع (POS) لتحديد من قد تكون مهتما بأحد العملاء استناداً إلى محفوظات الشراء، العناصر الموجودة في قائمة بهم، وأصناف شراء العملاء الآخرين عبر إنترنت وفي مخازن الطوب وهاون | لتجار التجزئة الكتالوجات كبيرة، التوصيات المخصصة تعليمات العميل مع اكتشاف المنتج وتمكين الشركاء في مخزن كلينتيلينج الذكي. بعرض منتجات تستهدف المصالح والعادات الشرائية للعميل، يمكن أن يساعد تجار التجزئة بسيل توصيات المنتج وتحسين الاحتفاظ بالعملاء. في ديناميات 365-عمليات البيع بالتجزئة، توصيات المنتج يتم بواسطة الخدمات المعرفية ومايكروسوفت أزور آلة التعلم. |
...
| معرفة المزيد حول دعم الشحن في Dynamics 365 for Operations                                                                                                         | لمزيد من المعلومات حول دعم عمليات الشحن، [الشحن](/dynamics365/operations/scm/inventory/consignment)، [إعداد الشحن](/dynamics365/operations/scm/inventory/set-up-consignment)، [إنشاء أمر استعاضة شحن (إرشادات المهمة)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/)، و [تغيير ملكية المخزون الشحن بناء على طلب الإنتاج (إرشادات المهمة)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>تعريف، على بنود أمر المبيعات بشكل مباشر، المكان الذي يجب توريد الطلب منه وكيفية توريده. <strong>المثال</strong> إنشاء بند أمر توريد، وتحديد تسليم مباشر كنوع التسليم. وتتم إضافة المورد الأساسي إلى بند أمر المبيعات كنقطة التوريد.</td>
...
<tr class="even">
<td>إنشاء التعهد بالأمر‬ مباشرة من بنود أمر المبيعات. <strong>المثال</strong> إنشاء بند أمر توريد توريد من مورد بين الشركات شقيقة. اترك البند. يتم حساب تواريخ التسليم وفقًا للتوافر في شركة التوريد.</td>
