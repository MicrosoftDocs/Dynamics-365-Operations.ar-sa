---
title: "ما هو الجديد أو تم تغييرها في Dynamics AX 7.0 (شباط/فبراير 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>ما هو الجديد أو تم تغييرها في Dynamics AX 7.0 (شباط/فبراير 2016)
...
| تنفيذ عمليات الإنشاء والاختبار والنشر بشكل تلقائي.                                                                            | متوفر جزئيًا                                                                                                                                                                                | انشر طوبولوجيا المطور باستخدام المطور والجهاز الظاهري للتصميم. وقم تلقائيًا بتكوين الجهاز الظاهري للتصميم لاكتشاف وتصميم النماذج من Visual Studio Online ‏(VSO)، وإجراء الاختبارات. ج\# ويتم دعم ترجمة الوحدة النمطية X + + والمراجع. | بعمل على زيادة إنتاجية المطورين بتقليل التكلفة والجهد للاختبارات وعمليات التحقق من الصحة.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| استفد من موصل الأعمال لكتابة منطق الأعمال ودعم سيناريوهات التكامل.         | يتوفر business connector للاتصال في كود X + + من تعليمات برمجية تمت إدارتها. نوصي باستخدام business connector فقط لكاتب منطق تسلسل العمل في ج\#، وليس للسيناريوهات. | لم يعد موصل الأعمال مدعومًا. يتوفر شرط التأليف من حقيقة أن X++ يتم تحويله برمجياً إلى كود مُدار. ولذلك، فإن interop أسهل. تتم تلبية سيناريوهات التكامل باستخدام OData.       | لا يمكنك استخدام موصل الأعمال للمضي قُدمًا.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>تمت إضافة خيارات التقرير، حيث أنه يمكن تطبيق عوامل تصفية مختلفة عندما يقوم مستخدم بعرض تقرير. ثم يتم إنشاء تقرير جديد استناداً إلى عوامل التصفية هذه.</td>
...
<td>تحليل البيانات المالية باستخدام محتوى ثنائي الطاقة "لمراقبة الأداء المالي".</td>
<td>غير متوفر</td>
...
<td>يعرض نظام التعليمات في الإصدار الحالي من Dynamics AX دلائل المهام المخزنة في ‏‫حزمة BPM‬ الخاصة بـ Microsoft Dynamics Lifecycle Services (LCS). يعرض نظام التعليمات أيضًا مواضيع من Microsoft wiki. لمزيد من المعلومات، راجع [Dynamics AX المساعدة-الشروع في](help-overview.md) و [المهام الجديدة الأدلة المتوفرة (شباط/فبراير 2016)](new-task-guides-available-february-2016.md).</td>
<td>توفر دلائل المهام خبرة إرشادية تفاعلية تقودك خلال الخطوات الخاصة بمهمة أو عملية أعمال. يمكنك تحميل وتخصيص دلائل المهام التي تقدمها Microsoft. توفر صفحة wiki طريقة أسرع وأكثر مرونة لإنشاء وثائق المنتج وتقديمها وتحديثها. ولذلك، فهو يساعد على ضمان إمكانية الوصول إلى أحدث المعلومات التقنية.</td>
</tr>
</tbody>
</table>
...
<td>وتم تنفيذ الميزة كتكوين تقارير إلكترونية. تتوفر الوظيفة في ألمانيا والنمسا.</td>
...
<td>يتم تطبيق قائمة الرصيد مع تقرير إجمالي الحسابات مجموعة كتقرير SSRS (ليدجيراككونتسوم\_FR).</td>
...
<td>يتم دمج قائمة منفصلة أكواد سلع الاتحاد الأوروبي مع الترتيب الهرمي للمنتج من نوع كود السلعة.</td>
...
<td>كود السلعة دول يحتوي حقل نص لتحديد الوحدات الإضافية، و * * المنتج * * بطاقة تحتوي على حقل لتحديد كمية وحدات إضافية بالكيلو جرام.</td>
...
<tr class="odd">
<td>تحليل بيانات المبيعات قنوات البيع بالتجزئة باستخدام محتوى ثنائي الطاقة "قناة البيع بالتجزئة مراقبة الأداء".</td>
<td>غير متوفر</td>
...
<li>ويوفر حزم "جاهز" بديلة، مثل وضع مجموعة موقع/مستودع/متغير/نقل، استناداً إلى المعيار (أقرب تاريخ إتاحة) التسليم أسرع المستخدم الاختيار من بينها.</li>
