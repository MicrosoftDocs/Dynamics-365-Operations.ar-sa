---
title: "إرشادات المهمة الجديدة أو المحدثة (أيار/مايو 2016)"
description: "تسرد هذه المقالة المهمة الجديدة أو المحدثة (قد 2016-جميع اللغات) مكتبة الموحد APQC ل Microsoft Dynamics AX الأدلة التي تم إصدارها إلى Microsoft. لم يتم إصدار مكتبة بدء استخدام جديدة."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="new-or-updated-task-guides-may-2016"></a>إرشادات المهمة الجديدة أو المحدثة (أيار/مايو 2016)

تسرد هذه المقالة المهمة الجديدة أو المحدثة (قد 2016-جميع اللغات) مكتبة الموحد APQC ل Microsoft Dynamics AX الأدلة التي تم إصدارها إلى Microsoft. لم يتم إصدار مكتبة بدء استخدام جديدة. 

<a name="task-guides-in-the-may-2016---all-languages-apqc-unified-library-for-microsoft-dynamics-ax"></a>[]()المهمة وأدلة في (أيار/مايو 2016-جميع اللغات) مكتبة الموحد APQC ل Microsoft Dynamics AX
------------------------------------------------------------------------------------------------

(أيار/مايو 2016) يحتوي على مكتبة الموحدة APQC المهمة تحديث 2016 قد الأدلة التي يعتزم استخدامها للحصول على تعليمات Microsoft Dynamics AX وإصدار فبراير 2016 Microsoft Dynamics AX. الإصدارات المترجمة من الأدلة المهمة التي تم إصدارها في (شباط/فبراير 2016) مكتبة الموحدة APQC متوفرة في هذه المكتبة. لمزيد من المعلومات حول كيفية توصيل نظام التعليمات إلى مكتبة دليل مهام، راجع [الشروع في تعليمات](help-overview.md). **ملاحظة:** علامة نجمة (**\***) بجوار عنوان مصمم نماذج عملية الأعمال (BPM) البند إلى أنه تم إنشاء دليل المهمة لهذه العملية التجارية لتحديث 2016 قد Dynamics AX وغير معتمدة في الإصدارات السابقة من Microsoft Dynamics AX.
...
| **\***ER Select service provider                                           | عمومي         |
...
| إنشاء... تكوينات \financial-dimensions\dimension-based                    | عمومي         |
...
| **\***الإبلاغ منته إلى موقع يمكنك التحكم فيه ترخيص لوحة | عمومي         |
...
| **\***Set up warehouse work policies                                | عمومي         |
...
[أدلة مهمة جديدة أو محدثة (آب/أغسطس 2016)](new-updated-task-guides-available-august-2016.md)
