---
title: "أدلة مهمة جديدة (في شباط/فبراير 2016)"
description: "يسرد هذا wiki الأدلة المهمة التي تم إصدارها للمكتبات تصنيع منتجات Microsoft اعتبارا من شباط/فبراير عام 2016.  تتضمن المكتبات التي تم نشرها (شباط/فبراير 2016) APQC الموحدة مكتبة Microsoft Dynamics 365 للعمليات و (شباط/فبراير 2016) الشروع في العمل."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="new-task-guides-february-2016"></a>أدلة مهمة جديدة (في شباط/فبراير 2016)

يسرد هذا wiki الأدلة المهمة التي تم إصدارها للمكتبات تصنيع منتجات Microsoft اعتبارا من شباط/فبراير عام 2016.  تتضمن المكتبات التي تم نشرها (شباط/فبراير 2016) APQC الموحدة مكتبة Microsoft Dynamics 365 للعمليات و (شباط/فبراير 2016) الشروع في العمل.

<a name="task-guides-in-the-february-2016-apqc-unified-library-for-microsoft-dynamics-365-for-operations"></a>المهام الأدلة في (شباط/فبراير 2016) APQC الموحدة مكتبة Microsoft Dynamics 365 للعمليات
---------------------------------------------------------------------------------

(شباط/فبراير 2016) الموحدة APQC مكتبة تحتوي على إرشادات المهمة التي يعتزم استخدامها للحصول على تعليمات Dynamics 365 لتحرير العمليات 7.0.0. إذا كنت تحتاج الإصدارات المترجمة من خطوط الإرشاد هذه المهمة، كانت متوفرة في (أيار/مايو 2016) APQC الموحدة مكتبة Microsoft Dynamics 365 للعمليات. لمزيد من المعلومات حول كيفية توصيل نظام التعليمات إلى مكتبة دليل مهام، راجع [الشروع في تعليمات](help-overview.md).
...
| التنسيق الخاص بمجال تصميم الإبلاغ الإلكتروني                | عمومي             |
...
| إنشاء... \financial-dimensions\dimension-based المنتج الرئيسي               | عمومي             |
...
| إصدار... \financial-dimensions\dimension-based المنتج الرئيسي              | عمومي             |
