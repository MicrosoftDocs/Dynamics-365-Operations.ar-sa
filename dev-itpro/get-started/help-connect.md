...
بعد إكمال هذه الخطوات، يمكنك فتح جزء **المساعدة**، ثم انقر فوق علامة التبويب **دلائل المهام**. سترى الآن دلائل المهام التي تنطبق على الصفحة التي تعمل عليها حاليًا في Finance and Operations. إذا لم تعثر على دلائك المهام، فيمكنك إدخال كلمات أساسية لتنقية البحث.
