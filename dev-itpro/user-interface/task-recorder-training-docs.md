...
يشرح هذا المقال ما هو مسجل المهام ودلائل المهام‬، وكيفية إنشاء تسجيلات المهام، وكيفية تخصيص دلائل المهام‬ لمنتجات Unified Operations وتضمينها في نظام التعليمات الخاص بك.

> [!IMPORTANT]
> لا يمكنك إنشاء دلائل مهام مخصصة لتطبيق Dynamics 365 for Talent. يتصل نظام تعليمات Talent بشكل تلقائي بدلائل المهام الخاصة بالمنتج. 
