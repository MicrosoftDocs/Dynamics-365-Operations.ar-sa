...
توفر لوحة **الملخص** نظرة عامة على العملية، وتتضمن مؤشرات لمساعدتك على مواصلة عملية التحقق من البيانات. يمكنك الاطلاع على كافة المهام المتبقية والمهام المكتملة، في المهام قيد التقدم، والمهام التي لم يتم بدء تشغيلها في العملية. هذه المعلومات لكافة الشركات التي تم تضمينها في مشروع التحقق من صحة البيانات المحدد.
...
اسم المهمة عبارة عن ارتباط تشعبي إلى صفحة the Microsoft Dynamics 365 for Finance and Operations الEnterprise edition حيث يتعين على المستخدم الانتقال إليها لإكمال العمل. يمكنك تعيين هذا الارتباط التشعبي باستخدام حقل **اسم عنصر قائمة** عندما تقوم بتحرير أو إنشاء مهمة من نموذج **تكوين مشروع التحقق من صحة بيانات**.
