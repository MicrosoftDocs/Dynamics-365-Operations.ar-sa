...
|------------------------------|-------------------------------------------------------------------------------------------|
| سبب الإهلاك       | لم يعد تنسيق الدفع هذا مستخدمًا.                                                     |
| هل تم الاستبدال بميزة أخرى؟ | الرقم سيتم استبدال التنسيق بتنسيقات ملف الاستيراد عبارة 20022 ISO في الإصدارات المستقبلية. |
| الوحدات المتأثرة             | الحسابات المدينة                                                                       |
...
|------------------------------|------------------------------------------------------------------------------------------|
| سبب الإهلاك       | الاستخدام المحدود                                                                            |
| هل تم الاستبدال بميزة أخرى؟ | الرقم سيتم استبدال الأداة بتقارير تصدر في المستقبل تكوينات الإلكتروني. |
| الوحدات المتأثرة             | دفتر الأستاذ العام                                                                           |
...
| هل تم الاستبدال بميزة أخرى؟ | الرقم يتم استبدال تنسيقات الدفع التي لم تعد مستخدمة بتنسيق الدفع نقل الائتمان ISO20022 لبلجيكا. |
| الوحدات المتأثرة             | حسابات دائنة                                                                                                     |
...
|------------------------------|--------------------------------------------------------------------------------------------|
| سبب الإهلاك       | لم تعد تنسيقات الدفع هذه مستخدمة.                                                    |
| هل تم الاستبدال بميزة أخرى؟ | الرقم سيتم استبدال التنسيقات بتنسيقات ملف الاستيراد عبارة 20022 ISO في الإصدارات المستقبلية. |
| الوحدات المتأثرة             | الحسابات المدينة                                                                        |
...
| هل تم الاستبدال بميزة أخرى؟ | الرقم أهداف مرئية للمديرين من خلال موقع الخدمة الذاتي لإدارة، ويمكن تغييره ويطلع المدير. |
...
### <a name="radio-frequency-identifier"></a>معرف تردد الراديو

تعريف التردد اللاسلكي (RFID) هو تقنية لجمع بيانات تستخدم علامات إلكترونية لتخزين بيانات التعريف وقارئ لا خط الرؤية لالتقاط بيانات التعريف.

|                              |                                               |
|------------------------------|-----------------------------------------------|
| سبب الإهلاك       | تعيين استخدام العملاء منخفضة وميزة محدودة. |
| هل تم الاستبدال بميزة أخرى؟ | لا                                            |
...
توفر التشريعات اللاتفية قواعد محددة حول كيفية ترقيم فواتير المبيعات. الوظيفة يتيح لك تعيين الأرقام المعينة لفواتير المبيعات، استناداً إلى مستخدم أو مجموعة مستخدمين. ثم يمكنك إنشاء تقرير أو ملف XML. يمكنك أيضًا طباعة تقرير حول أرقام الفواتير التي يتم استخدامها.
...
| هل تم الاستبدال بميزة أخرى؟ | الرقم يمكن للمستخدمين استخدام "العامة الإلكترونية" أداة الإبلاغ لتكوين العبارة إذا لزم الأمر تحت ظروف معينة. |
...
|                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| سبب الإهلاك       | تم تقديم تقسيمات البيانات في Microsoft Dynamics AX 2012 R2 لتمكين عزل البيانات. في سيناريو شائع، هناك شركة لها شركات فرعية، ويجب ألا تكون البيانات من إحدى الشركات الفرعية مرئية في شركة فرعية أخرى، على الرغم من خضوع الشركتين الفرعيتين لإدارة قسم تقنية المعلومات نفسه. ومع ذلك، برزت الحاجة إلى مصروفات إضافية تتعلق بالبرامج النصية والإدارة عبر البرنامج بكامله من أجل إنشاء تقسيمات جديدة وتعبئتها بالبيانات، ولإجراء نسخ احتياطي للبيانات الموجودة في التقسيمات. في السحابة، حيث لدينا إمكانية الوصول إلى النظام الأساسي كخدمات قاعدة بياناتك خدمة (PaaS) (قاعدة Microsoft SQL Azure)، من المستحسن استخدام قاعدة بيانات كحاوية عزل بدلاً من إجراء العزل في البرنامج لأن هذا الإجراء يُعد أكثر فاعلية. بغض النظر عما إذا كان تقسيم البيانات مطلوبًا للشركات الفرعية، أو لعدة مستأجرين، أو فقط كمقياس، نعتقد بأنه يمكن التعامل مع السيناريوهات بشكل أفضل من خلال قواعد بيانات متعددة أو مثيلات Dynamics AX متعددة. |
...
### <a name="ssas-demand-forecasting-strategy"></a>استراتيجية تقدير الطلب اتفاقات الخدمة الخاصة

|                              |                                                                              |
|------------------------------|------------------------------------------------------------------------------|
| سبب الإهلاك       | لا يمكن اعتماد تصميم الميزة في السحابة البنية الجديدة. |
| هل تم الاستبدال بميزة أخرى؟ | تقدير استراتيجية الطلب "آلة التعلم" azure                           |
