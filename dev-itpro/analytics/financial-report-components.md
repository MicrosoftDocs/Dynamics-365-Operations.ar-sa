...
يمكنك تصدير مجموعة كتلة الإنشاء أو كتل إنشاء تقرير محدد في مجموعة كتلة الإنشاء. يمكنك استخدام مجموعة كتلة الإنشاء الذي تم تصديره كنسخة احتياطية. يمكنك أيضا نسخ البيانات المصدرة بين كتلة إنشاء مجموعات أو Dynamics 365 التثبيتات العمليات. مصمم التقرير يتضمن أنماط الخطوط المشار إليها وبعد تعيين جنبا إلى جنب مع مجموعة كتلة الإنشاء.
1.  في مصمم التقارير، في قائمة **الشركة**، انقر فوق **مجموعات كتل الإنشاء**.
