...
-   خذ بعين الاعتبار الطريقة التي استخدمتها لإعداد بنية مؤسستك، ثم ارسم مخططًا تنظيميًا لشركتك. وستساعدك الخريطة التنظيمية تساعدك على تصور كيفية تجميع وحدات التقارير في شجرة تقارير واحدة أو أكثر.
...
|---|---|
| الشركة               | اسم الشركة لوحدة التقارير. **@ANY**القيمة التي يتم تعيينها عادة إلى مستوى التلخيص فقط، تمكن شجرة التقارير المراد استخدامه لكافة الشركات. ويتم تعيين شركة لكافة الفروع التابعة.|
...
| تعريفات الصفوف       | اسم تعريف الصف لوحدة التقارير. يتم استخدام نفس تعريف الصف لكل وحدة شجرة تقارير. عند إنشاء تقرير، يتم استخدام تعريف الصف هذا لكل وحدة تقارير. بإمكان تعريف الصف أن يتضمن ارتباطات متعددة الأبعاد المالية. إذا تم تحديد تعريف صف في شجرة التقارير، فحدد خانة الاختيار **استخدام تعريف صف من شجرة تقارير** في علامة تبويب **التقرير** لتعريف التقرير.|
| ارتباط الصف              | ارتباط الصف المراد استخدامه في وحدة التقارير. ويتم تحديد ارتباطات الصفوف لتعريف الصف لتحديد الأبعاد المالية للارتباط بها.|
| ارتباط خارجي         | ارتباط الصف المراد استخدامه في وحدة التقارير هذه. ويتم تحديد ارتباطات الصفوف لتعريف الصف لتحديد التقرير لإنشاء الارتباط إليه.|
...
1.  افتح مصمم التقرير.
2.  انقر فوق **ملف**&gt;**جديدة**&gt;**تقارير تعريف شجرة**.
3.  انقر فوق **تحرير**&gt;**إدراج وحدات الإبلاغ من أبعاد**.
...
4.  انقر فوق **ملف**&gt;**حفظ** لحفظ التغييرات.
...
1.  في مصمم التقارير، افتح تعريف شجرة التقارير المراد تعديله.
2.  انقر نقراً مزدوجاً فوق خلية **أمان الوحدة** لصف وحدة التقارير لتقييد الوصول إليها.
...
[![كونتوسونتيرتاينمينتسومماريريبورتستروكتوري](./media/contosoentertainmentsummaryreportstructure.png)](./media/contosoentertainmentsummaryreportstructure.png)

### <a name="reporting-unit-structure--example-2"></a>بنية وحدة التقارير – المثال 2

في الرسم التخطيطي التالي، تتسم شجرة التقارير بهيكل تنظيمي مقسم حسب وظائف الأعمال. [![سوماريوفالونيتسكونتوسو](./media/summaryofallunitscontoso.png)](./media/summaryofallunitscontoso.png)
...
يعرض الشكل التوضيحي التالي مثالاً عن مربع الحوار **إدراج وحدات التقارير من الأبعاد**. على سبيل المثال، سترجع النتائج مجموعة من وحدات الأعمال ومراكز التكلفة والأقسام. [![إينسيرتريبورتينجونيتس](./media/insertreportingunits.png)](./media/insertreportingunits.png) تعريف شجرة التقارير الناتجة يتم فرز حسب وحدة الأعمال، ثم بمركز التكلفة، ثم حسب القسم. البعد لوحدة إعداد التقارير الخامس **"وحدة الأعمال" = \[001\]، مركز التكلفة =\[\]، قسم = \[022\]**، ويعرف وحدة إعداد تقارير للحسابات الخاصة بالقسم 022 و 001 وحدة الأعمال. [![ريبورتينجتري](./media/reportingtree-1024x646.png)](./media/reportingtree.png)
...
[![موتليكومبانيرولوب](./media/mutlicompanyrollup.png)](./media/mutlicompanyrollup.png)

#### <a name="example-2"></a>مثال 1

[![كروسكومبانيديبارتمينترولوب](./media/crosscompanydepartmentrollup.png)](./media/crosscompanydepartmentrollup.png)
