...
-   يمثل أداة مشتركة واحدة للإبلاغ الإلكتروني في مجالات مختلفة، واستبدال محركات مختلفة أكثر من 20 القيام بنوع من الإبلاغ الإلكتروني ل Microsoft Dynamics 365 للعمليات.
-   يجعل بمعزل عن 365 الديناميات الحالية لتنفيذ عمليات تنسيق التقرير. (وبعبارة أخرى، التنسيق قابل للتطبيق لإصدارات مختلفة من 365 ديناميات عمليات.)
...
-   تدفق البيانات في نموذج تعيين تحديد الارتباطات 365 ديناميات العمليات مصادر البيانات إلى عناصر فردية من نموذج البيانات الذي يحدد وقت التشغيل وقواعد العمل البيانات السكانية لبيانات النموذجية المكون.
...
-   -شركة&gt; المورد-&gt; حركات الدفع الخاصة بمجال الحسابات الدائنة
-   العميل-&gt; -شركة&gt; حركات الدفع الخاصة بمجال الحسابات المدينة
...
-   استخدام 365 ديناميات مختلفة لأنواع بيانات العمليات كمصدر بيانات لنموذج بيانات. على سبيل المثال، يمكنه استخدام الجداول أو كيانات البيانات أو الأساليب أو التعدادات.
...
-   تعتمد التحويل 365 ديناميات عمليات البيانات إلى المجموعات المطلوبة والتصفية، والفرز، وجمع البيانات، وأيضا إلحاق بالمنطقية حساب الحقول التي تم تصميمها من خلال Microsoft Excel على غرار الصيغ (للحصول على مزيد من التفاصيل، راجع [مصمم الصيغة في الإبلاغ الإلكتروني](general-electronic-reporting-formula-designer.md)).

[![محرر الصيغة Excel مثل](./media/pic-formula-1024x615.png)](./media/pic-formula.png) تم تصميم مكون طراز بيانات لكل الأعمال مجال الذي يجب استخدامه كمصدر بيانات موحدة لتقديم التقارير الذي يعزل التقارير من التنفيذ الفعلي لديناميات 365 لمصادر البيانات عمليات، ويمثل المفاهيم الخاصة بمجال الأعمال والوظائف بشكل يجعل تصميم استمارة الإبلاغ وكذلك الصيانة أكثر فعالية.
...
-   **مكتمل** إصدار يمكن تحويلها إلى **المشتركة** الإصدار. هذا الإصدار نشر في دائرة السوقيات والاتصالات واستخدامها في عمليات الإبلاغ العالمية.
-   يمكن تحويل إصدار **مشترك **إلى إصدار **متوقف**. ثم يمكن حذف هذا الإصدار.

الإصدارات التي تحتوي على أي * * * * مكتمل أو **المشتركة** حالة متوفرة لتبادل البيانات الأخرى. ويمكن تنفيذ الإجراءات التالية على مكونات لديها هذه الحالات:

-   يمكن إجراء تسلسل بتنسيق XML وتصديرها من 365 ديناميات عمليات كملف بتنسيق XML.
-   يمكن ريسيرياليزيد من ملف XML واستيراده 365 ديناميات عمليات كإصدار جديد من عنصر ER.

#### <a name="component-date-effectivity"></a>فاعلية تاريخ المكون

تُعد إصدارات مكون ‏‫التقارير الإلكترونية سارية التاريخ. يمكن تحديد التاريخ** ‏‫سارٍ من‬ **لمكون ‏‫التقارير الإلكترونية لتحديد التاريخ الذي يصبح به هذا المكون ساريًا لعمليات إعداد التقارير. 365 ديناميات عمليات تاريخ الجلسة يستخدم لتحديد ما إذا كان مكون صالحاً للتنفيذ. في حال وجود أكثر من إصدار واحد صالح لتاريخ معين، سيتم استخدام الإصدار الأخير لعمليات إعداد التقارير.

#### <a name="component-access"></a>إمكانية الوصول إلى المكونات

يتوقف الوصول إلى مكونات تنسيق ‏‫التقارير الإلكترونية على إعداد ‏‫كود ISO للبلد/المنطقة. عندما فارغة لإصدار محدد من تنسيق تكوين هذا الإعداد، يمكن الوصول مكون تنسيق من أي 365 حيوية لعمليات الشركة في وقت التشغيل. عندما يحتوي هذا الإعداد على رموز البلد/المنطقة ISO، يتوفر عنصر تنسيق فقط من 365 ديناميات عمليات الشركات التي لها عنوان الأساسية المحددة لأحد رموز البلد/المنطقة ISO مكون تنسيق. قد تحتوي إصدارات مختلفة من مكون تنسيق البيانات على إعدادات مختلفة لأكواد ISO للبلد/المنطقة‬.

#### <a name="configuration"></a>تكوين

يُعد تكوين ‏‫التقارير الإلكترونية برنامج التضمين لمكون تقارير إلكترونية معين، إما **نموذج بيانات **أو **تنسيق**. بإمكان التكوين أن يتضمن إصدارات مختلفة من مكون تقارير إلكترونية معين. يتم تمييز كل تكوين كما هو مملوك بواسطة موفر تكوين معين. **مشروع** يمكن تحرير إصدار مكون تكوين عند تحديد مالك التكوين كموفر نشط في إعدادات ل ER في ديناميات 365 للعمليات. يحتوي كل تكوين نموذج على مكون **نموذج بيانات**. ويمكن إنشاء تكوين تنسيق جديد (استخراجه) من تكوين نموذج بيانات محدد. وسيتم تقديم تكوين التنسيق الذي تم إنشاؤه في شجرة تكوين كتابع لتكوين نموذج البيانات الأصلي. يحتوي تكوين التنسيق الذي تم إنشاؤه على مكون **تنسيق**. وسيتم إدراج مكون **نموذج البيانات** لتكوين النموذج الأصلي في مكون **التنسيق **بشكل تلقائي لتكوين تنسيق التابع كمصدر بيانات افتراضي. تتم مشاركة تهيئة ER لديناميات 365 لعمليات الشركات.

#### <a name="provider"></a>موفر

موفر التقارير الإلكترونية هو معرف الطرف المستخدم للإشارة إلى مؤلف (مالك) كل تكوين من تكوينات التقارير الإلكترونية. وتسمح لك التقارير الإلكترونية بإدارة قائمة موفري التكوين. تنسيق التكوينات التي تم إصدارها للمستندات الإلكترونية كجزء من 365 ديناميات عمليات حل يتم تمييزها المملوكة **Microsoft** موفر التكوين.

#### <a name="repository"></a>المستودع

يخزّن مستودع التقارير الإلكترونية تكوينات هذه التقارير. الأنواع التالية من المستودعات ER معتمدة حاليا: **موارد العمليات** و **المشروع دائرة السوقيات والاتصالات**. * * عمليات * الموارد * المستودع وصولاً إلى قائمة التكوينات التي تم إصدارها كجزء من 365 ديناميات عمليات حل من قبل Microsoft كموفر تكوين ل ER. يمكن استيرادها إلى 365 الديناميات الحالية لمثيل عمليات هذه التكوينات واستخدامها للإبلاغ الإلكتروني. ويمكن استخدامها أيضًا لإجراء ترجمات/تخصيصات إضافية. يوفر مستودع **مشروع LCS **إمكانية الوصول إلى قائمة التكوينات الخاصة بمشروع LCS معين (مكتبة أصول مشروع LCS) تم تحديده في مرحلة تسجيل المستودع. يتيح لك إضافة تكوينات المشتركة من 365 الديناميات الحالية لمثيل عمليات معينة ER **المشروع دائرة السوقيات والاتصالات** المستودع. يمكنك أيضا استيراد تكوينات من معينة **المشروع دائرة السوقيات والاتصالات** المستودع إلى 365 الديناميات الحالية لمثيل العمليات. مطلوب **المشروع دائرة السوقيات والاتصالات** المستودعات يمكن تسجيل كل على حدة لكل موفر التكوين من 365 الديناميات الحالية لمثيل العمليات. ويمكن تخصيص كل مستودع لموفر تكوين معين.

## <a name="supported-scenarios"></a>السيناريوهات المدعومة
### <a name="building-a-data-model"></a>إنشاء نموذج بيانات

تقدم التقارير الإلكترونية مصمم نموذج يمكنك استخدامه لإنشاء نموذج بيانات لمجال عمل معين. يمكن تقديم كل الكيانات التجارية الخاصة بمجال معين والعلاقات بينها في نموذج بيانات كبنية ذات تدرج هرمي. يبين الرسم التوضيحي التالي مثالاً عن هذا النوع من نماذج البيانات (نموذج بيانات مجال الدفع). [![مثال لنموذج البيانات](./media/pic-data-model-1024x550.png)](./media/pic-data-model.png) لتصبح أكثر اطلاعاً على تفاصيل هذا السيناريو، تقوم **ER تصميم نموذج بيانات محددة المجال** دليل المهمة (جزء من **7.5.4.3 مكونات خدمة/الحلول الحصول/تطوير "تكنولوجيا" (10677)** العملية التجارية).

### <a name="translating-data-model-content"></a>ترجمة محتوى نموذج البيانات

يمكن ترجمة محتوى نموذج بيانات (العلامات والأوصاف) إلى اللغات الأخرى التي تدعم 365 ديناميات عمليات. قد تحتاج إلى ترجمة محتوى نموذج البيانات للأسباب التالية:
...
-   في وقت التشغيل، إلى جعل المحتوى المستخدم أكثر ودية عن طريق تقديم المطالبات وتعليمات حول معلمات وقت التشغيل، وأيضا تكوين رسائل التحقق من الصحة (الأخطاء والتحذيرات)، باللغة التي تفضل 365 Dynamics حاليا تسجيل الدخول للمستخدم العمليات

يبين الرسم التوضيحي التالي مثالاً حول كيفية ترجمة محتوى نموذج بيانات من اللغة الإنجليزية إلى اللغة اليابانية. [![نموذج بيانات محتوى باللغة الإنجليزية](./media/pic-translate-en-1024x495.png)](./media/pic-translate-en.png)[![نموذج بيانات المحتوى ترجمة إلى اللغة اليابانية](./media/pic-translate-ja-1024x495.png)](./media/pic-translate-ja.png)

### <a name="configuring-data-model-mappings"></a>تكوين تعيينات نموذج البيانات

يوفر ER مصمم تعيين نموذج يسمح للمستخدمين بتعيين نماذج البيانات كما نحو 365 Dynamics المحددة لمصادر بيانات العمليات. يبين الشكل التوضيحي التالي مثالاً عن هذا النوع من تعيين نموذج البيانات (تعيين نموذج **تحويل ائتمان سيبا** لنموذج بيانات مجال الدفع). [![مثال لتعيين طراز البيانات ](./media/pic-model-mapping-1024x551.png)](./media/pic-model-mapping.png)لتصبح أكثر اطلاعاً على تفاصيل هذا السيناريو، تقوم **ER تعريف نموذج تعيين وتحديد مصادر البيانات** و **ER مخطط طراز البيانات إلى مصادر البيانات المحددة** أدلة مهمة (جزء من **7.5.4.3 مكونات خدمة/الحلول الحصول/تطوير "تكنولوجيا" (10677)** العملية التجارية).

### <a name="storing-a-designed-model-component-as-a-model-configuration"></a>تخزين مكون نموذج مصمم كتكوين نموذج

يمكن تخزين ER طراز بيانات تصميم جنبا إلى جنب مع تعيينات البيانات المقترنة كتكوين طراز 365 الديناميات الحالية لمثيل عمليات. يبين الرسم التوضيحي التالي مثالاً عن هذا النوع من تكوين نموذج البيانات (تكوين نموذج الدفع). [![المثال تكوين نموذج البيانات ](./media/pic-model-configuration-1024x585.png)](./media/pic-model-configuration.png)لتصبح أكثر اطلاعاً على تفاصيل هذا السيناريو، تقوم **ER مخطط طراز البيانات إلى مصادر البيانات المحددة** دليل المهمة (جزء من **7.5.4.3 مكونات خدمة/الحلول الحصول/تطوير "تكنولوجيا" (10677)** العملية التجارية).

### <a name="building-a-format-that-uses-a-data-model-as-a-base"></a>إنشاء تنسيق يستخدم نموذج بيانات كأساس

تدعم التقارير الإلكترونية مصمم تنسيق يمكنك استخدامه لإنشاء تنسيق مستند إلكتروني معين لمجال أعمال محدد من خلال تحديد مكون النموذج كأساس. ويسمح لك مصمم تنسيق التقارير الإلكترونية نفسه بتعيين تنسيق تقوم بإنشائه إلى تعيين نموذج بيانات خاص بمجال محدد كمصدر بيانات. يبين الرسم التوضيحي التالي مثالاً على هذا النوع من التنسيق (تكوين التنسيق الذي يدعم **BACS** تنسيق الدفع للمملكة المتحدة). [![مثال للتنسيق الذي يحتوي على نموذج بيانات كأساس](./media/pic-format-1024x690.png)](./media/pic-format.png) لتصبح أكثر اطلاعاً على تفاصيل هذا السيناريو، تقوم **تنسيق محدد في مجال التصميم ل ER** دليل المهمة (جزءا من **7.5.4.3 مكونات خدمة/الحلول الحصول/تطوير "تكنولوجيا" (10677)** العملية التجارية).
...
يمكن استخدام مصمم تنسيق التقارير الإلكترونية لإنشاء مستند إلكتروني معين بتنسيق ورقة العمل OPENXML. يبين التوضيح التالي مثال لهذا النوع من التنسيق (تكوين تنسيق لإنشاء ورقة عمل OPENXML بتفاصيل دفتر يومية الدفع المحدد):[![الموافقة المسبقة عن علم-ER-تنسيق-Excel](./media/pic-er-format-excel.jpg)](./media/pic-er-format-excel.jpg) لتصبح أكثر اطلاعاً على تفاصيل هذا السيناريو، تقوم **ER إنشاء تكوين للتقارير في تنسيق OPENXML** دليل المهمة (جزء من **7.5.4.3 مكونات خدمة/الحلول الحصول/تطوير "تكنولوجيا" (10677)** العملية التجارية). استخدم المشار أدناه ملف Excel كقالب نموذج تصميم ER لإكمال الخطوة استيراد قالب تنسيق هذا الدليل المهام: ["قالب لتقرير دفع" (SampleVendPaymWsReport.xlsx)](https://go.microsoft.com/fwlink/?linkid=845202)

### <a name="storing-a-designed-format-component-in-a-format-configuration"></a>تخزين مكون تنسيق مصمم في تكوين التنسيق

يمكن تخزين ER تنسيق تصميم جنبا إلى جنب مع تعيينات البيانات المكونة كتكوين تنسيق 365 الديناميات الحالية لمثيل عمليات. يبين الرسم التوضيحي السابق مثال على هذا النوع من تكوين التنسيق (**BACS (المملكة المتحدة)**، وهو تكوين تابع لتكوين **نموذج الدفع**). لكي تصبح ملمًا بتفاصيل هذا السيناريو، يمكنك تشغيل دليل المهمة **تصميم تنسيق خاص بالمجال في التقارير الإلكترونية** (جزء من العملية التجارية **7.5.4.3 اكتساب/تطوير مكونات خدمة تكنولوجيا المعلومات/الحلول (10677)**).

### <a name="configuring-dynamics-365-for-operations-to-start-to-use-a-created-format-internally"></a>تكوين 365 ديناميات عمليات البدء في استخدام تنسيق التي تم إنشاؤها داخليا

يمكن تكوين dynamics 365 للعمليات للبدء في استخدام تنسيق التي تم إنشاؤها لإنشاء التقارير الإلكترونية. يجب أن يتم تعريف المرجع إلى تكوين التنسيق الذي تم إنشاؤه في الإعدادات الخاصة بمجال معين. على سبيل المثال، لتبدأ في استخدام تهيئة تنسيق ER لمدفوعات المورد الإلكترونية في الشكل BACS، تنسيق التكوين يجب الإشارة في أساليب محددة للدفع، كما هو موضح في الأمثلة التوضيحية التالية: 

[![تكوين تنسيق BACS (المملكة المتحدة)](media/ger-bacs-uk-format-configuration.png) 

[![الرجوع إلى تنسيق BACS (المملكة المتحدة) في طريقة الدفع](media/ger-bacs-uk-format-method.png) 
...
ER يتيح لك استيراد أية مكونات من دائرة السوقيات والاتصالات إلى 365 الديناميات الحالية لمثيل العمليات. يلزم وجود مستودع لنوع **مشروع LCS**. عند استيراد مكون ل ER من دائرة السوقيات والاتصالات إلى 365 الديناميات الحالية لمثيل العمليات، يصبح مالك مثيل مستهلك الخدمة التي يتم توفيرها من قبل المالك (الكاتب) المكونات المستوردة. على سبيل المثال، إذا تم تصميم عنصر تنسيق لإنشاء مستند إلكتروني معين من 365 ديناميات عمليات تنسيق خاصة بالبلد/المنطقة (سيناريو الترجمة)، يفترض أنه مستهلك الخدمة سوف تكون قادرة على الحصول على أي تحديثات تتم على هذا الشكل، لجعله متوافقاً مع المتطلبات التشريعية. لكي تصبح ملمًا بتفاصيل هذا السيناريو، يمكنك تشغيل دليل المهمة **استيراد تكوين من Lifecycle Services في التقارير الإلكترونية** (جزء من العملية التجارية **7.5.4.3 اكتساب/تطوير مكونات خدمة تكنولوجيا المعلومات/الحلول (10677)**).
...
## <a name="list-of-er-configurations-that-are-delivered-in-the-dynamics-365-for-operations-solution"></a>قائمة التكوينات ER التي يتم تسليمها في 365 ديناميات عمليات حل
