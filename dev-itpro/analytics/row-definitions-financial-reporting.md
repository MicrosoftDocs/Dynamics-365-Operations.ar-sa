...
-   ارتباطات للبيانات المالية، التي يمكن أن تتضمن قيم في Microsoft Dynamics 365 لعمليات أبعاد **ملاحظة:** يمكنك إعداد تعريف صف لسحب البيانات من النظام المالي أبعاد كل مرة يتم إنشاء التقرير.
...
| خيار                | الوصف                                                                                                                                                                                                                                                                      |
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| البعد             | النمط الذي يحدد البُعد المراد إضافته إلى تعريف الصف. يحتوي هذا النمط على حرف واحد (&) أو علامة الأرقام (\#) لكل وظيفة في الأبعاد. بشكل عام، استخدم كافة علامات العطف لبُعد الحساب الرئيسي وجميع علامات الأرقام للأبعاد الأخرى. |
...
4.  لتحديد تعريف الصف بحيث يقتصر على نطاق محدد من قيم الأبعاد، أدخل قيمة بُعد البداية في خلية ** بداية نطاق الأبعاد **، ثم أدخل قيمة بُعد النهاية في خلية **نهاية نطاق الأبعاد**. ولتضمين كافة القيم للبُعد المحدد، اترك هذه الخلايا فارغة. **ملاحظة:** أحرف البدل (\* أو؟) في البعد النطاقات قد لا يرجع كافة النتائج التي تريدها، تبعاً لكيفية تجميع قاعدة بيانات تخطيط البيانات.
5.  في حقل **كود صف البداية**، حدد كود الصف لقيمة البُعد الأول المراد إضافته إلى تعريف الصف.
6.  في حقل **زيادة كل صف بمقدار**، حدد الفجوة بين أكواد الصفوف المتتالية. على سبيل المثال، التعليمات البرمجية الموجودة في الصف الأول هو 100، وقيمة الزيادة هو 30، الصفوف الجديدة الأولى تكون رموز 100 و 130 160 190 و 220. استخدم قيمة زيادة توفر مساحة كافية لإدراج صفوف شكل وصيغة جديدة.
...
3.  انقر فوق زر شريط الأدوات للتنسيق المراد تطبيقه. على سبيل المثال، لإنشاء مسافة بادئة على التوالي، حدد الصف ومن ثم انقر فوق **"زيادة المسافة البادئة"**!["زيادة المسافة البادئة"](https://i-technet.sec.s-msft.com/dynimg/IC679497.gif ""زيادة المسافة البادئة"") على شريط الأدوات.
