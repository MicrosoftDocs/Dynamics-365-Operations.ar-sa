...
| أمر | ‏‏الوصف                                                  |
|---------|--------------------------------------------------------------|
| تعليمات    | افتح صفحة wiki لتعليمات Dynamics 365 for Operations لإعداد التقارير المالية. |
|         |                                                              |
...
[إنشاء تقرير مالي](\financials\general-ledger\generate-financial-report.md)
