...
-   تحتوي منطقة الرؤوس في تعريف العمود على نص العنوان والتنسيق الذي يظهر في التقرير. يمكن تطبيق العنوان على عمود بيانات واحد، ويمكن أن يمتد عبر عدة أعمدة، أو يمكن تطبيقه على الأعمدة على أساس مشروط. يمكن أن يتضمن تعريف العمود العديد من صفوف رؤوس الأعمدة حسب رغبتك. **ملاحظة:** تنطبق رؤوس الأعمدة على كل عمود بيانات في التقرير. تنطبق عناوين التقرير على التقرير الكامل. يمكنك تحديد رؤوس التقرير في علامة التبويب **الرؤوس والتذييلات** في تعريف التقرير.
...
باستطاعة مصمم التقارير أن ينشئ رؤوس الأعمدة تلقائيًا، استناداً إلى أكواد النص التلقائي. وأكواد النص التلقائي عبارة عن متغيرات يتم تحديثها في كل مرة يتم فيها إنشاء تقرير. ويمكن أن يشتمل كل رأس عمود على هذه الأكواد لتحديد معلومات التقرير التي قد تكون مختلفة، مثل التواريخ أو أرقام الفترات. ولذلك، يمكنك استخدام تعريف عمود واحد لعدة تعريفات تقارير وفترات زمنية وأشجار تقارير. ونظراً لاستناد أكواد النص التلقائي إلى معلومات التقويم من صفوف التفاصيل في تعريف العمود، فإنه يتم دعمها فقط لأعمدة **CALC**، و**FD**، و**WKS**. وتؤثر الطريقة التي يظهر بها كود النص التلقائي في خلية رأس العمود على مدى ظهور تلك المعلومات في التقرير. وفي مربع حوار **رأس العمود**، تظهر أكواد النص التلقائي بحالة مختلطة. ولذلك، يظهر النص في حالة مختلطة في التقرير. على سبيل المثال، في سنة تقويم قياسية، يحول **@CalMonthLong** شهر **7** إلى **يوليو**. إذا كان اسم الشهر يجب أن يكون بأحرف كبيرة (على سبيل المثال **JULY**)، فأدخل كود النص التلقائي بأحرف كبيرة في حقل **نص رأس العمود**. على سبيل المثال، أدخل **@CALMONTHLONG**. يمكن خلط الأكواد والنص. على سبيل المثال، قمت بإدخال نص الرأس التالي: **فترة @FiscalPeriod-@FiscalYear من @StartDate إلى @EndDate**. ويشبه عنوان التقرير الذي تم إنشاؤه النص التالي: **الفترة 1-02 من 02/01/01 إلى 31/01/02**. **ملاحظة:** يعتمد تنسيق بعض النص، مثل التاريخ الطويل، على إعداداتك الإقليمية على خادم Dynamics 365 for Operations. ولتغيير هذه الإعدادات، انقر فوق الزر **ابدأ**، وانقر فوق **لوحة التحكم**، ثم انقر فوق **المنطقة واللغة**. يسرد الجدول التالي خيارات النص التلقائي المتوفرة لرؤوس الأعمدة.
...
-   إذا قمت بتحديد رؤوس الأعمدة المتداخلة، فإنها تتداخل عند طباعتها في التقرير. يتم إنشاء التقرير، ولكن تظهر رسالة التحذير التالية في حقل **‏‫حالة قائمة انتظار التقارير‬**: "تستخدم رؤوس الأعمدة أساس يتقاطع مع رؤوس الأعمدة الأخرى وقد يتسبب في نص متداخل". على سبيل المثال، يمثل تعريف الرأس في العمود ب هو B إلى أساس+1، وتعريف الرأس في العمود د هو أساس+1 إلى D. في هذه الحالة، يتم طباعة الرؤوس فوق بعضها البعض وتصبح غير مقروءة. عندما تُستخدم BASE في تعريف **الانتشار من/الانتشار إلى**، تأكد من عرض التقرير الذي تم إنشاؤه، لمعرفة ما إذا كانت الرؤوس متداخلة.
...
يُستخدم عامل تصفية الأبعاد لتقييد عمود **FD** على قيم أبعاد محددة. ويمكن لعامل التصفية الاشتمال على بعد واحد أو نطاق من الأبعاد أو مجموعة من الأبعاد. ويمكن أن تتضمن عامل التصفية مجموعات قيم الأبعاد. ولأن قيم الأبعاد يمكن أن تختلف، فلا يلزم .\financial-dimensions\dimension-based أن يتوافق مع طول محدد. ويتم تطبيق عامل التصفية، بغض النظر عن ما إذا كان التقرير يتضمن شجرة تقارير أو لا. ويمكنك استخدام أحرف بدل (\* or ?) في أي موضع. وعند تحديد عدة حسابات، ،ضع فاصلة بين الحسابات، كما في المثال التالي: +الحساب=\[1200\], +حساب=\[1100\], القسم=\[01?\] ولتلقي جميع الأقسام لحساب معين، يمكنك استبعاد بعد القسم من أبعاد عامل التصفية. على سبيل المثال، تتم معالجة كلٍّ من عاملي تصفية الأبعاد التاليين بنفس الطريقة:
...
-   **عرض العملة** – يحدد نوع العملة (الطبيعية أو الوظيفية أو التقارير) المعروضة في الحركات. يشار أحياناً إلى هذه الوظيفة كتحويل العملة. وتحويل العملة هو القدرة على الإبلاغ عن مبالغ دفتر الأستاذ العام بعملة قد لا تكون بالعملة الوظيفية للشركة أو بالعملة التي تم إدخال الحركة بها.
...
**ملاحظة:** قد تختلف الخيارات الموصوفة هنا، وفقًا لنظام ERP. ولمزيد من المعلومات، راجع [ وثائق نظام Microsoft ERP ](https://www.microsoft.com/en-us/download/details.aspx?id=5916).
...
| العملة الوظيفية من معلومات الشركة | فارغ                | **$2,310\*\*** – تعرض النتيجة كافة البيانات بالعملة الوظيفية المحددة في معلومات الشركة. **ملاحظة:** هذا المبلغ هو مجموع كافة الحركات بالعملة الوظيفية. |
