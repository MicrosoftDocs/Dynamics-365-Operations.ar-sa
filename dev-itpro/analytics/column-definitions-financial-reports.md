...
> [!NOTE]
> لإنشاء التقارير التي تستخدم عملات متعددة، يجب عليك تحديد خانة الاختيار **تضمين كافة عملات التقارير** على علامة التبويب **تقرير** في تعريف التقرير. لتحديد العملة الوظيفية للشركة، اتبع الخطوات التالية.
...
> [!NOTE]
> قد تختلف الخيارات الموصوفة هنا، وفقًا لنظام ERP. ولمزيد من المعلومات، راجع [ وثائق نظام Microsoft ERP ](https://www.microsoft.com/en-us/download/details.aspx?id=5916).
