---
title: "مقدمة إلى Dynamics 365 للعمليات"
description: "Microsoft Dynamics 365 للعمليات هو تطبيق العمل في Microsoft للشركات. تساعدك هذه الصفحة على التعرف والحصول على البدء في استخدام المنتج."
author: margoc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
---
# <a name="introduction-to-dynamics-365-for-operations"></a>مقدمة إلى Dynamics 365 للعمليات

[!include[banner](includes/banner.md)]

Microsoft Dynamics 365 للعمليات هو تطبيق العمل في Microsoft للشركات. وهي تمكن الأشخاص من سرعة اتخاذ قرارات أكثر ذكاء من خلال واجهة مستخدم ذكي الذي يوفر الوصول إلى البيانات ومعلومات المباشرة في الوقت الحقيقي. وهي تمكن الشركات للتحويل وإيننوفاتي عن طريق توفير منطق تسلسل العمل التي أثبتت جدارتها يسمح لهم بإعادة تصميم عمليات الأعمال أسرع. أنه يعطي الشركات مرونة لزيادة حجم وفق خطوات خاصة بهم وتربطها علاقة أعمال تجارية تقريبا في أي مكان وفي أي وقت، مما يسمح لهم بتحسين قابلية العمليات الخاصة بها عالمي تلبية احتياجات العمل. 

دليل المستخدم يمكن أن تساعدك في التعرف على كيفية عمل Dynamics 365 لعمليات العمل لصالح نشاطك التجاري.    
...
<p><a href="dev-itpro/lcs-solutions/country-region.md">ميزات الإقليمية</a></p>
<p>الموارد البشرية</p>
   <ul>
  <li><a href="human-resources/departments-jobs-positions.md">استراتيجية الموارد البشرية</a></li>
  <li><a href="human-resources/manage-recruiting-process.md">توظيف والتوظيف وتحفيز</a></li>
  <li><a href="human-resources/performance-management-overview.md">لتدريب الموظف</a></li>
  ...
  <li><a href="human-resources/localizations/noam-usa-payroll.md">الميزات التي الولايات المتحدة</a></li>
</ul></td>
  <td>
  <p>‏‫البيع بالتجزئة‬</p>
  <ul>
<li><a href="retail/call-center-functionality.md">Call center</a></li>
  ...
  <li><a href="retail/define-maintain-channel-clients-registers-hw-stations.md">نقطة البيع MPOS ومجموعة النظراء</a></li>
  <li><a href="retail/dev-itpro/dev-retail-home-page.md">إدارة والمطورين البيع بالتجزئة</a></li></ul>
...
<li><a href="supply-chain/cost-management/costing-sheets.md">Cost management</a></li>
  ...
  <li><a href="dev-itpro/mobile-apps/mobile-platform.md">تطبيقات الهاتف الجوال</a></li>
