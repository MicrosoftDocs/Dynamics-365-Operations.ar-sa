...
يحدد Microsoft Dynamics 365 لعمليات الوحدة النمطية التي تقوم بالعمل في أنواع سير العمل التي يمكنك إنشاؤها. اتبع الخطوات التالية لتحديد نوع سير العمل لإنشاء محرر سير العمل وفتحه.
...
2.  انقر فوق **الإعداد**&gt;**\[اسم الوحدة النمطية\] مهام سير العمل**.
