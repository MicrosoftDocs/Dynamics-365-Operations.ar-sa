...
description: "توضح هذه المقالة نظام سير العمل في Microsoft Dynamics 365 للعمليات."
author: sericks007
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
توضح هذه المقالة نظام سير العمل في Microsoft Dynamics 365 للعمليات.
...
سير العمل نظام التي يتم تثبيتها مع ديناميات 365 للعمليات والتي يتم تشغيلها على خادم كائن التطبيق (AOS). يوفر نظام سير العمل الوظائف التي يمكن استخدامها في إنشاء سير عمل فردي، أو عمليات تجارية.
