...
description: "تشرح هذه المقالة كيف يمكنك تخصيص Microsoft Dynamics 365 for Finance and Operations."
author: RobinARH
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
تشرح هذه المقالة كيف يمكنك تخصيص Microsoft Dynamics 365 for Finance and Operations.
...
بعد تخصيص صفحة، يمكنك مشاركة تخصيصاتك مع مستخدمين آخرين. ما عليك سوى تصدير الصفحة المخصصة. يمكن عندئذٍ الطلب من المستخدمين الآخرين الانتقال إلى الصفحة المخصصة واستيراد ملف التخصيص الذي قمت بإنشائه.

باستطاعة المستخدمين ممن لديهم امتيازات المسؤول إدارة التخصيصات للمستخدمين الآخرين في صفحة **التخصيص**. تحتوي هذه الصفحة على أربع علامات تبويب: **النظام** و**المستخدمون** و**استيراد** و**مسح**.
