...
> [!NOTE] 
> إذا كنت ترغب في إعادة إنشاء نفس الخطوات أدناه، يمكنك استخدام بيانات العرض التوضيحي. يمكن تنزيل بيانات العرض التوضيحي على PartnerSource
...
> [!NOTE]
> يعتبر إعداد وضع العلامات يدويًا في علامة التبويب **تفاصيل السطر** لكل بند في كشف الأرباح عنصرًا أساسيًا لإدخال أرصدة بداية كشف الرواتب لكل عامل.
...
#### <a name="why-disable-accounting-checkbox-needs-to-be-turned-on-when-generating-pay-statements"></a>لماذا يجب تشغيل خانة الاختيار "تعطيل المحاسبة" عند تشغيل قوائم الأجور؟
يؤدي هذا إلى منع توزيع أي بنود في قائمة الأجور وترحيلها إلى دفتر الأستاذ العام. إنك لا تحتاج إلى ترحيل قوائم الأجور لرصيد البداية نظرًا لوجود قيمه في دفتر الأستاذ العام من النظام القديم. يتم استخدام تحميل الرصيد هذا لأغراض إعداد التقارير والتقييد فقط.
...
5. في علامة تبويب **خصومات الميزة‬** أدخل ما يلي: 
...
6. في علامة تبويب **مساهمات الميزة‬** أدخل ما يلي:
...
8. في علامة تبويب **خصومات الضريبة‬‬** أدخل ما يلي:
...
بعد عكس قائمة الأجور، يمكنك إنشاء قائمة أجور جديدة للعامل من كشف الأرباح‬ الذي أنشأته في وقت سابق في الإجراء "إنشاء كشوفات الأرباح وقوائم الأجور ذات أرصدة البداية" الذي ورق سابقًا في هذا الموضوع. احرص على إصلاح أي بنود غير صحيحة في كشف الأرباح قبل إنشاء قوائم الأجور الجديدة، ثم كرر الإجراء "تحديث قوائم الأجور ذات أرصدة بداية للميزات والضرائب" الذي ورد في هذا الموضوع.
