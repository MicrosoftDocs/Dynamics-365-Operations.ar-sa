...
ويحتوي استعلام مقترح الدفع على علامات تبويب مختلفة، كل منها يحتوي على خيارات مختلفة لتحديد الفواتير للدفع. **معلمة** تحتوي علامة التبويب على الخيارات التي تستخدمها معظم المؤسسات في أغلب الأحيان. على **السجلات لتضمين** العمل، يمكنك تحديد أي فواتير أو الموردين لتضمين للدفع بتعريف نطاقات للخصائص المختلفة. على سبيل المثال، إذا أردت الدفع نطاق محدد من الموردين، يمكنك تعريف عامل تصفية لمجموعة الموردين. هذه الوظيفة غالباً لتحديد الفواتير معين لطريقة الدفع. على سبيل المثال، إذا قمت بتعريف عامل تصفية حيث **طريقة الدفع** = **التحقق من**، يتم تحديد الفواتير التي تحتوي على طريقة الدفع للدفع، شريطة أن تفي بالمعايير الأخرى التي تم تحديدها في الاستعلام. تحتوي علامة التبويب **المعلمات المتقدمة** على خيارات إضافية قد لا يكون بعضها مناسباً للمؤسسة الخاصة بك. على سبيل المثال، تتضمن علامة التبويب هذه خيارات لدفع الفواتير للمدفوعات المركزية.

## <a name="parameters"></a>المعلمات
-   **تحديد الفواتير ب** -الفواتير في نطاق التاريخ الذي يحدده **من تاريخ** و **حتى الآن** حقول يمكن تحديدها بواسطة تاريخ الاستحقاق، تاريخ الخصم النقدي أو كليهما. في حالة استخدام تاريخ الخصم النقدي، النظام أولاً بالبحث عن الفواتير وتاريخ خصم النقدي بين من تاريخ وإلى تاريخ. ويحدد النظام فيما بعد ما إذا كانت الفاتورة مؤهلة للخصم النقدي باستخدام تاريخ الجلسة للتأكد من أن تاريخ الخصم النقدي لم يمر بالفعل.
...
-   **الحد الأدنى لتاريخ الدفع** -أدخل الحد الأدنى لتاريخ الدفع. على سبيل المثال، **من تاريخ** و **للتاريخ** حقول تحديد نطاق من 1 أيلول/سبتمبر إلى 10 أيلول/سبتمبر، وهو تاريخ دفع الحد الأدنى 5 أيلول/سبتمبر. في هذه الحالة، كافة الفواتير بتاريخ استحقاق من 1 أيلول/سبتمبر إلى 5 أيلول/سبتمبر ودفع بتاريخ 5 أيلول/سبتمبر. ومع ذلك، كافة الفواتير بتاريخ استحقاق من 5 أيلول/سبتمبر إلى 10 أيلول/سبتمبر تحتوي على تاريخ دفع تساوي تاريخ الاستحقاق لكل فاتورة.
-   **حد المبلغ** – أدخل الحد الأقصى للمبلغ الإجمالي لكافة المدفوعات.
-   **إنشاء المدفوعات دون معاينة الفاتورة** – إذا تم تعيين هذا الخيار إلى **نعم**، سيتم إنشاء مدفوعات مباشرة على **مدفوعات المورد** الصفحة. **مقترح الدفع** يتم تخطي الصفحة. ولذلك، سيتم إنشاء المدفوعات بشكل أسرع. ولا يزال يمكن تعديل المدفوعات من صفحة **مدفوعات المورد**. وبدلاً من ذلك، يمكنك الرجوع إلى صفحة **مقترح الدفع** باستخدام الزر **تحرير الفواتير لدفعة محددة**.

## <a name="advanced-options"></a>خيارات متقدمة
-   **التحقق من رصيد المورد** – إذا تم تعيين هذا الخيار إلى **نعم**، يتحقق النظام من مورد ليس لديه رصيد مدين قبل أن يتم دفع أي فاتورة. إذا كان لديك مورد رصيد مدين، يتم إنشاء أية مدفوعات. على سبيل المثال، قد يكون المورد مذكرات الائتمان أو المدفوعات التي تم ترحيلها ولكن لم تتم تسويتها بعد. وفي هذه الحالات، يجب عدم الدفع للمورد. وبدلاً من ذلك، ينبغي أن تتم تسوية مذكرات الائتمان أو المدفوعات في مقابل الفواتير المعلقة.
...
-   **عمله الدفع** -العملة التي يتم إنشاء كافة المدفوعات في تحديد هذا الحقل. إذا لم يتم تحديد عمله، يدفع كل فاتورة بعمله الفاتورة.
...
-   **نوع الحساب المقابل** و **الحساب المقابل** – تعيين هذه الحقول لتحديد نوع حساب محدد (مثل **الأستاذ** أو **بنك**) والمقابل في الحساب (مثل حساب بنكي معين). تعريف طريقة الدفع للفاتورة نوع الحساب المقابل الافتراضي والحساب المقابل، ولكن يمكنك استخدام هذه الحقول لتجاوز القيم الافتراضية.
-   **عوامل تصفية إضافية** – على **السجلات لتضمين** العمل، يمكنك تعريف نطاقات معايير إضافية. على سبيل المثال، إذا كنت تريد أن تدفع سوى مجموعة من الموردين، يمكنك تعريف عامل تصفية لمجموعة الموردين. هذه الوظيفة غالباً لتحديد الفواتير معين لطريقة الدفع. على سبيل المثال، إذا قمت بتعريف عامل تصفية حيث **طريقة الدفع** = **التحقق من**، يتم تحديد الفواتير التي تحتوي على طريقة الدفع للدفع، شريطة أن تفي بالمعايير الأخرى التي تم تحديدها في الاستعلام.
...
تحدد فوزية **الخصم النقدي** كنوع المقترح. وقالت أنها تدخل تاريخ نطاق من 26 يونيو حتى 10 يوليو. الفواتير التالية مضمنة في العرض:
...
تحدد فوزية **لكل تاريخ استحقاق** كنوع المقترح. وقالت أنها تدخل تاريخ نطاق من 26 يونيو حتى 10 يوليو. الفواتير التالية مضمنة في العرض:
...
تحدد فوزية **تاريخ الاستحقاق والخصم النقدي** كنوع المقترح. وقالت أنها تدخل تاريخ نطاق من 26 يونيو حتى 10 يوليو. الفواتير التالية مضمنة في العرض:
...
-   تنشيط حقل **التحكم في البُعد** وتمكين الأبعاد الإضافية. يمكنك الآن تعريف كيفية نسخ الأبعاد إلى دفتر اليومية. على سبيل المثال: • تحديد **وحدة الأعمال** خانة الاختيار لإنشاء مقترح دفع لكل وحدة الأعمال الخاصة بطريقة الدفع، حدد • **كوستسينتير** خانة الاختيار لإنشاء مقترح دفع لكل مركز التكلفة للطريقة الدفع
