...
عندما تطلب صنفًا من مورد وتقوم بتعيين هذا الصنف إلى مشروع، تحدد خاصية البند التي تحددها لبند أمر شراء لهذا الصنف فوترة الصنف المشتري لعميل أو لا. إذا تم إعداد خصائص الخط الافتراضي، يتم عرضها للصنف الموجود في بند أمر الشراء (تفاصيل خط &gt;مشروع &gt;خط الخاصية). هناك طريقتان لتعديل خاصية البند:
