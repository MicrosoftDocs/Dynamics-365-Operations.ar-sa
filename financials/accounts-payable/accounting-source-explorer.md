...
مستكشف مصدر المحاسبة هو صفحة جديدة تعرض معلومات المصدر. يمكنك استخدام مستكشف مصدر المحاسبة كأداة مستقلة أو لتحليل التفاصيل خلف القيود المحاسبية في دفتر الأستاذ العام. على سبيل المثال، يمكنك استخدام مستكشف مصدر المحاسبة للحصول على معلومات المصدر الأكثر تفصيلاً لتحقيق توازن في الميزانية سجل أو لحركة إيصال. ويمكنك استخدام ميزة التصدير إلى MS Excel لتقسيم وتجزئة المعلومات بشكل أكبر في Microsoft Excel (على سبيل المثال، في PivotTable أو تقرير PivotTable).
...
لكافة المستندات التي تستخدم إطار عمل مستند مصدر، مصدر المحاسبة explorer يعرض معلومات إضافية، استناداً إلى التوزيعات المحاسبية وأن أمكن، محاسبة المشروع التوزيعات. تتضمن هذه المعلومات نوع مبلغ نقدي ومشروع نشاط الفئة وخاصية البند. فيما يلي بعض الأمثلة على التحليل الذي يمكنك القيام به:
