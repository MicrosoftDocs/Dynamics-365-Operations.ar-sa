---
title: "نظرة عامة على فواتير المورد"
...
# <a name="vendor-invoices-overview"></a>نظرة عامة على فواتير المورد
...
فاتورة المورد من أمر شراء عبارة عن فاتورة يتم إنتاجها عند تلقي المنتجات أو الخدمات وفقًا لأمر شراء الذي تم وضعه مع أحد الموردين. فاتورة المورد يحتوي على رأس، وبند واحد أو أكثر لأصناف أو خدمات. فاتورة مورد إكمال الدورة من أمر الشراء للمنتجات لفاتورة المورد. 
...
-   سجل فواتير المورد يتيح لك إدخال الفواتير التي لا تشير إلى أمر شراء، بسرعة بحيث يمكن استحقاق المصروفات. باستخدام دفتر يومية اعتماد الفواتير المورد، يمكنك تحديد هذه الفواتير وترحيلها إلى رصيد المورد لعكس الاستحقاق.
...
يمكنك إضافة بند جديد وليس على أمر الشراء لفاتورة المورد. يجب تحديد فئة التدبير أو رقم صنف. ويمكنك فيما بعد إضافة الكميات والأسعار والمبالغ إلى البند. سيتم تضمين البند فقط في سياسات مطابقة إجماليات الفواتير.
