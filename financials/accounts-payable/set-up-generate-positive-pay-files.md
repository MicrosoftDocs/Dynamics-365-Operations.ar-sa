...
يمكن أن تحتوي ملفات الدفع الإيجابي على معلومات هامة حول المستفيدين ومبالغ الشيكات. لذلك، تأكد من استخدام تدابير أمنية مناسبة اعتبارًا من وقت إنشاء الملفات وحى استلام البنك لها. يتم تنزيل ملفات الدفع الإيجابي إلى الموقع المحدد بواسطة مستعرض ويب. لأن ملفات الدفع الإيجابي يمكن أن تحتوي على معلومات حساسة، من المهم أن المستخدمين المخولين فقط الوصول لإنشاء وعرض هذه المعلومات في Microsoft Dynamics 365 للعمليات. استخدم الجدول التالي للمساعدة في تحديد الامتيازات المطلوبة.
