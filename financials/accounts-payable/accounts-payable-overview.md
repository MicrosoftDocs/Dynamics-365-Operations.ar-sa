...
description: "تصف هذه المقالة الصفحات التي تستخدمها لإعداد الوظائف الأساسية والاختيارية للحسابات الدائنة في Microsoft Dynamics AX. وتصف أيضًا خطوات الإعداد التي يجب إكمالها قبل بدء إعداد الحسابات الدائنة."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
تصف هذه المقالة الصفحات التي تستخدمها لإعداد الوظائف الأساسية والاختيارية للحسابات الدائنة في Microsoft Dynamics AX. وتصف أيضًا خطوات الإعداد التي يجب إكمالها قبل بدء إعداد الحسابات الدائنة.
...
-   في الصفحة مجموعة تكاليف المورد، إنشاء وصيانة مجموعات المصاريف للموردين.
...
-   على **الحقول 1099** صفحة والتحقق منها وتحديث الحد الأدنى من المبالغ التي يجب الإبلاغ عنها لخدمة الإيرادات الداخلية (IRS)، استناداً إلى آخر متطلبات IRS.

## <a name="optional-setup-for-other-modules"></a>**إعداد الوحدات النمطية الأخرى اختيارية**
