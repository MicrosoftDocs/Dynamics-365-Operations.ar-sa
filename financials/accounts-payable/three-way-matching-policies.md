...
2.  تقوم فوزية، وهي منسق الحسابات الدائنة في شركة الاتحاد للتصنيع، بإدخال والتحقق من صحة الفواتير التي قدمتها شركة "التعمير". وتتحقق من صحة المعلومات التالية:
    ...
    -   للعناصر التي تتطلب ثنائية أو ثلاثية مطابقة الأسعار على بند الفاتورة نطاق الاختلافات التي تم تعريفها في Microsoft Dynamics 365 للأنواع التالية من مطابقة السعر Operations.This:
...
في Microsoft Dynamics 365 للعمليات، يتضمن بند الفاتورة المعلومات التالية.
...
2.  تقوم فوزية، وهي منسق الحسابات الدائنة في شركة الاتحاد للتصنيع، بإدخال والتحقق من صحة الفواتير التي قدمتها شركة "التعمير". وتتحقق من صحة المعلومات التالية:
    -   بالنسبة للأصناف التي تتطلب المطابقة ثلاثية الاتجاهات، تتطابق الكمية الموجودة في بند الفاتورة مع الكمية التي تم استلامها. وتتم الإشارة إلى الكمية المستلمة في إيصال استلام المنتج المطابق للفاتورة.
    -   للأصناف التي تتطلب مطابقة ثنائية أو ثلاثية، الأسعار على بند الفاتورة نطاق الاختلافات التي تم تعريفها في Microsoft Dynamics 365 للعمليات. وهذا يتضمن الأنواع التالية من مطابقة السعر:
...
لمزيد من المعلومات، راجع [الحسابات مطابقة فاتورة مستحقة الدفع](accounts-payable-invoice-matching.md).
