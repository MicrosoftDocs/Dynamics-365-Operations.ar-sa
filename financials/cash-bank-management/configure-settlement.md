...
المعلمات التالية تؤثر على كيفية معالجة التسويات في Microsoft Dynamics 365 للعمليات. والتسوية هي عملية تسوية فاتورة مقابل دفعة أو إشعار دائن. وهذه المعلمات الموجودة في منطقة **التسوية** في صفحتي **معلمات الحسابات المدينة** و**معلمات الحسابات الدائنة**.
...
-   **إدارة الخصم النقدي** – تحديد مدى [معالجة الخصم النقدي عند يتم زائدة فاتورة](cash-discount-handling-overpayments.md). للزيادة، يمكن تخفيض الخصم النقدي، يمكن معاملتها كفرق، أو يمكن أن تبقى في الحساب الخاص بالمورد أو العميل.
...
-   **‏‫حساب الخصومات النقدية للإشعارات الدائنة** – قم بتعيين هذا الخيار إلى **نعم** لحساب خصم نقدي للإشعارات الدائنة تلقائياً. وفي الحسابات المدينة، تكون حركة إشعار الدائن حركة سالبة تشتمل على قيمة في حقل **الفاتورة** في صفحة **فاتورة النص الحر** أو إرجاع في صفحة **أمر المبيعات**.
    -   ويعتمد تأثير هذا الخيار على القيمة الواردة في حقل **استخدام الخصم النقدي** في صفحة **تسوية الحركات**. إذا تم تعيين هذا الخيار إلى **نعم**، الخصم عندما تؤخذ * * * تم تعيين استخدام الخصم النقدي * الحقل إلى **عادي**. عند * * * تم تعيين استخدام الخصم النقدي * الحقل إلى **دوماً**، دائماً الخصم النقدي أخذ، بغض النظر عن الإعداد لهذا الحقل. عند * * * تم تعيين استخدام الخصم النقدي * الحقل إلى **ابدأ**، عدم أخذ الخصم النقدي، بغض النظر عن الإعداد لهذا الحقل.
...
-   **تحديد أولوية التسوية (الحسابات المدينة فقط)** – قم بتعيين هذا الخيار إلى **نعم** لتمكين زر **التمييز حسب الأولوية** في صفحتي **إدخال مدفوعات العميل** و**تسوية الحركات**. يتيح هذا الزر للمستخدمين تعيين أمر التسوية محددة سلفا للحركات.  بعد تطبيق ترتيب التسوية لحركة، يمكن تعديل الترتيب وتوزيع الدفع قبل الترحيل.
-   **استخدم الأولوية للمستوطنات التلقائية** – تعيين هذا الخيار إلى **نعم** أن يستخدم ترتيب الأولوية المحددة عند تسوية الحركات تلقائياً. يتوفر هذا الحقل فقط في حالة **إعطاء الأولوية لتسوية** و **تسوية تلقائية** تم تعيين خيارات ل **نعم**.
