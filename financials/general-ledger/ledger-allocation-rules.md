...
-   **المصدر** -هذا المكون هو الذي يقوم فيه المستخدم بتحديد البيانات المصدر للتوزيع. يمكن تخصيص إلى أرصدة دفتر الأستاذ (**مصدر بيانات** = **الأستاذ**) أو مبالغ ثابتة (**مصدر البيانات** = **قيمة ثابتة**). وعند تعيين **مصدر بيانات** إلى **دفتر الأستاذ**، يجب تحديد معايير عامل التصفية المصدر لقاعدة توزيع دفتر الأستاذ (على سبيل المثال، نفقات الإعلان).
