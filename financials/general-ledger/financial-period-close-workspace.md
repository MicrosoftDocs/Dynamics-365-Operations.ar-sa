...
توفر تجانبات **الملخص** نظرة عامة على العملية، وتساعدك مؤشرات على مواصلة عملية الإقفال. يمكنك رؤية المهام التي تجاوزت تاريخ الاستحقاق والمهام المتبقية لليوم الحالي والمهام التي تستحق اليوم ولكنها محظورة بسبب التبعيات وكافة المهام المتبقية للعملية. هذه المعلومات هي لكافة الشركات التي تم تضمينها في جدول الإقفال المحدد.
...
قبل أن تتمكن من استخدام مساحة عمل **إقفال الفترة المالية**، يجب عليك تكوين العملية في Microsoft Dynamics 365 for Operations باستخدام صفحة **تكوين إقفال الفترة المالية**. (انقر فوق **دفتر الأستاذ العام** &gt; **إقفال الفترة** &gt; **تكوين إقفال الفترة المالية**.)
...
يرتبط عنصر القائمة **ارتباط المهمة** بجهد عمل المهمة ويمكن استخدامه للانتقال مباشرةً إلى الصفحة المقترنة من ارتباط المهام في مساحة العمل. على سبيل المثال، يمكن ربط مهمة إقفال لتنفيذ عملية إعادة تقييم العملة للحسابات الدائنة في صفحة **إعادة تقييم العملة الأجنبية** في Microsoft Dynamics 365 for Operations. كما يمكنك ربطه بعنوان URL خارجي. 
