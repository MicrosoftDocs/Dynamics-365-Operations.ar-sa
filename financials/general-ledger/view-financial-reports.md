...
-   لتطبيق عوامل التصفية بعد تقرير، حدد **إضافة عامل تصفية بعد**. حدد البعد، ثم اكتب معرف البعد أو حدد البعد في القائمة. ولإزالة عامل تصفية بعد، انقر فوق **مسح**.
...
يمكنك عرض التقارير للشهر الحالي أو الأشهر السابقة دون إعادة إنشاء التقرير. انقر لفتح التقرير لشهر سابق **إظهار**، ثم انقر فوق **التقارير السابق**. تظهر قائمة الأشهر السابقة التي تم إنشاؤها للتقرير. وقم بتوسيع الشهر لعرض التقرير الخاص به، وحدد التاريخ، ثم انقر فوق **موافق**. يتم عرض تقرير الشهر السابق. وللرجوع إلى تقرير الشهر الحالي، انقر فوق **إلغاء**.
