...
description: "يوفر هذا الموضوع نظرة عامة حول التالية لعملية إعادة تقييم العملة الأجنبية دفتر الأستاذ العام-إعداد تشغيل عملية حساب للعملية، وكيفية عكس حركات إعادة التقييم، إذا لزم الأمر."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
يوفر هذا الموضوع نظرة عامة حول التالية لعملية إعادة تقييم العملة الأجنبية دفتر الأستاذ العام-إعداد تشغيل عملية حساب للعملية، وكيفية عكس حركات إعادة التقييم، إذا لزم الأمر. 
...
> [!NOTE]
> يتوفر أيضا إعادة تقييم العملة الأجنبية في الحسابات المدينة (باللغة العربية) والحسابات الدائنة (AP). إذا كنت تستخدم هذه الوحدات النمطية، يجب تقييمها المعاملات المعلقة استخدام إعادة تقييم العملة الأجنبية في هذه الوحدات النمطية. ستؤدي إعادة تقييم العملة الأجنبية في الحسابات المدينة (AR) والحسابات الدائنة (AP) إلى إنشاء إدخال محاسبة في دفتر الأستاذ العام لعكس الخسائر والأرباح غير المحققة، مما يضمن إمكانية التسوية بين دفاتر الأستاذ الفرعية ودفتر الأستاذ العام. ولأن إعادة تقييم العملة الأجنبية في الحسابات المدينة (AR) والحسابات الدائنة (AP) تؤدي إلى إنشاء إدخالات محاسبة في دفتر الأستاذ العام، يجب استثناء الحسابات الرئيسية للحسابات المدينة والحسابات الدائنة من إعادة تقييم العملة الأجنبية لدفتر الأستاذ العام. 

عندما تقوم بتشغيل عملية إعادة التقييم، سيُعاد تقييم الرصيد في كل حساب رئيسي تم ترحيله بعملة أجنبية. يقوم النظام بإنشاء حركات الأرباح أو الخسائر غير المحققة التي تنشأ أثناء عملية إعادة التقييم. الحركتين قد تنشأ، لعمله المحاسبة وثانية لعمله التقارير، إذا كان ذلك مناسباً. بعد كل إدخال محاسبة أرباح غير محققة أو الخسائر وحساب رئيسي يتم تقييمها.
...
**تاريخ معدل** يمكن استخدامها لتحديد التاريخ الذي ينبغي أن سعر الصرف الافتراضي. على سبيل المثال، يمكنك إعادة تقييم الأرصدة بين تاريخ نطاق من شهر يناير 1 إلى 31 كانون الثاني/يناير، ولكن استخدام سعر الصرف المحدد في الأول من شباط/فبراير. 

حدد الحسابات الرئيسية لإعادة تقييمها: الكل أو الميزانية العمومية أو الأرباح والخسائر. وسوف يعاد تقييم الحسابات الرئيسية المميزة لإعادة التقييم (في صفحة الحساب الرئيسي). إذا كنت ترغب في تقييد نطاق الحسابات الرئيسية كذلك، استخدام السجلات **لتضمين** علامة التبويب لتحديد نطاق الحسابات الرئيسية أو الحسابات الفردية الرئيسية. 

يمكن تشغيل عملية إعادة التقييم لواحد أو أكثر من الكيانات القانونية. سيتم عرض البحث فقط الكيانات القانونية التي لديك حق الوصول. حدد الكيانات القانونية التي تريد تشغيل عملية إعادة التقييم. 

يمكن تشغيل عملية إعادة التقييم لعملة أجنبية واحدة أو أكثر. سيتضمن البحث كافة العملات التي تم ترحيلها في نطاق التاريخ المناسب لنوع الحساب الرئيسي (الميزانية أو الأرباح والخسائر) للكيانات القانونية المحددة لإعادة تقييم. عمله المحاسبة التي ستدرج في القائمة، ولكن لا شيء سيتم تقييمها إذا تم تحديد عمله المحاسبة. 

تعيين **المعاينة قبل الترحيل** إلى **نعم** إذا كنت تريد مراجعة نتيجة إعادة تقييم دفتر الأستاذ العام. المعاينة بشكل عام دفتر الأستاذ يختلف عن المحاكاة في إعادة تقييم العملة الأجنبية الحسابات المدينة والحسابات الدائنة. تقرير يتم المحاكاة في الحسابات المدينة والحسابات الدائنة، لكن الأستاذ العام معاينة التي يمكن ترحيلها، دون الحاجة إلى تشغيل عملية إعادة التقييم مرة أخرى. يمكن تصدير نتائج المعاينة إلى Microsoft Excel للاحتفاظ بالمحفوظات المتعلقة بكيفية حساب المبالغ. لا يمكنك استخدام المعالجة الدُفعية إذا كنت تريد معاينة نتائج إعادة التقييم. من المعاينة، يستطيع المستخدم ترحيل نتائج كافة الكيانات القانونية باستخدام الزر **ترحيل**. في حال وجود مشكلة تتعلق بالنتائج لكيان قانوني، فبإمكان المستخدم أيضًا ترحيل مجموعة فرعية من الكيانات القانونية باستخدام الزر **تحديد الكيانات القانونية للترحيل**. 

بعد اكتمال عملية إعادة تقييم العملة الأجنبية، يمكن إنشاء سجل لتعقب محفوظات كل تشغيل.  سيتم إنشاء سجل منفصل لكل كيان قانوني وطبقة الترحيل.

## <a name="calculate-unrealized-gainloss"></a>حساب الربح/الخسارة غير المحققة
يتم إنشاء حركات الأرباح/الخسائر غير المحققة بطريقة مختلفة بين عملية إعادة تقييم دفتر الأستاذ العام وعملية إعادة تقييم الحسابات المدينة والحسابات الدائنة. في الحسابات المدينة والحسابات الدائنة، تكون عملية إعادة التقييم السابقة معكوسة بشكل تام (بافتراض عدم تسوية الحركة حتى الآن) ويتم إنشاء حركة إعادة تقييم جديدة للأرباح/الخسائر غير المحققة على أساس سعر الصرف الجديد. وهذا لأننا نعمل على إعادة تقييم كل حركة ففردية في الحسابات المدينة والحسابات الدائنة. في دفتر الأستاذ العام، لم يتم عكس إعادة التقييم السابق. بدلاً من ذلك، يتم إنشاء حركة للدلتا بين رصيد الحساب الرئيسي، بما في ذلك أية مبالغ إعادة التقييم السابق، واستنادا إلى سعر الصرف "تاريخ معدل" القيمة الجديدة. 

**المثال** توجد أرصدة التالية لحساب الرئيسي 110110.
...
يعاد تقييم الحساب الرئيسي في 31 كانون الثاني/يناير.  يتم حساب الربح/الخسارة غير المحصلة كما يلي.
...
يتم ترحيل أية حركات جديدة في شهر شباط/فبراير.  يعاد تقييم الحساب الرئيسي في 28 شباط/فبراير.
...
يمكنك عكس نتائج إعادة تقييم خارج الترتيب حتى الآن، ولكن قد تحتاج لعكس أيضا إعادة تقييم أحدث للتأكد من الأرصدة الصحيحة لكل حساب رئيسي تمت إعادة تقييمها. يمكن أن تحدث عمليات العكس أمر قديم لعدم وجود أي وسيلة للتحكم في الحسابات الرئيسية التي يتم تقييمها وتكرار عند تقييمها. على سبيل المثال، قد تختار مؤسسة إعادة تقييم الحسابات الرئيسي النقدية الخاصة بها على أساس ربع سنوي، ولكن جميع الحسابات الرئيسية شهريا.
