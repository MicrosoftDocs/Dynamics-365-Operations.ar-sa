...
> [!NOTE]
> بشكل عام، عندما يصبح المبلغ الذي يحسب باستخدام نسبة 150 في المائة طريقة إهلاك الرصيد أقل من المقدار الذي يحسب باستخدام طريقة القسط الثابت، يكون هناك تحويل لطريقة القسط الثابت للمدة المتبقية.
