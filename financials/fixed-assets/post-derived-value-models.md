...
# <a name="post-with-derived-books"></a>نشر الكتب المشتقة
...
عند ترحيل امتلاك لأصل ثابت بدفتر VM 1، يتم ترحيل الامتلاك على VM 1، بل أيضا على الكتاب المشتقة VM 2. يتم تحديث حالة كل من دفاتر الأصول الثابتة لفتح.

> [!NOTE]                                                                                                         
> إذا لم تستخدم الدفاتر المشتقة، فيجب عليك ترحيل الاستحواذ على الأصل الثابت لكل من الدفتر VM 1 والدفتر VM 2.

لمزيد من المعلومات، راجع [المستمدة من الكتب](derived-books.md)
