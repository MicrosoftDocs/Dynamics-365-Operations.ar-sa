---
title: "نظرة عامة حول التحكم في الموازنة"
description: "هذا المقال يقدم التحكم في الموازنة ويوفر معلومات لمساعدتك في تكوين التحكم في الموازنة في Microsoft Dynamics 365 للعمليات بحيث يمكنك إدارة الموارد المالية."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="budget-control-overview"></a>نظرة عامة حول التحكم في الموازنة

هذا المقال يقدم التحكم في الموازنة ويوفر معلومات لمساعدتك في تكوين التحكم في الموازنة في Microsoft Dynamics 365 للعمليات بحيث يمكنك إدارة الموارد المالية.

<a name="overview"></a>نظرة عامة
--------

يعتمد التحكم في الموازنة في Microsoft Dynamics 365 لعمليات إدارة الموارد المالية للمنظمة من خلال مخطط الحسابات ومهام سير العمل، مجموعات المستخدمين، والمستندات المصدر ودفاتر اليومية، وحساب عتبات ودورات الميزانية والأموال المتاحة القابلة للتكوين. وعندما يتم وضع الضوابط، ستتمكن المؤسسة من تخطيط مواردها المالية وقياسها وإدارتها والتنبؤ بها طوال سنتها المالية. 

بعد أن تمت الموافقة على الميزانيات في ديناميات 365 للعمليات، يمكنك استخدام خطط الميزانية لإنشاء إدخالات سجل الموازنة لتسجيل نفقات ميزانية مؤسسة. بدلاً من ذلك، يمكنك إنشاء أو استيراد إدخالات سجل الموازنة من برنامج تابع لجهة خارجية بدلاً من استخدام وظيفة تخطيط الميزانية. 
...
[![بودجيتينجسيكلي](./media/budgetingcycle-300x198.png)](./media/budgetingcycle.png) 

يمكنك تكوين التحكم في الموازنة وفقا لعدة عوامل:
...
-   **مصدر الوثائق** – التي يجب تقييمها المستندات المصدر للتحكم في الموازنة؟ وينبغي تقييم الوثائق كل سطر أو كل مستند؟
...
يتم إكمال الخطوات التالية في التكوين في علامات التبويب المختلفة على **تكوين التحكم في الموازنة** الصفحة.
...
> [!NOTE] 
> إذا تم تعديل الحساب أثناء دورة ميزانية، لن تؤثر التغييرات على أية مستندات التي مرت يقوم تحكم موازنة مسبقاً، والتي تم ترحيلها أو إكمال.
...
> [!Important]
> سيتم تمكين التحكم في الموازنة لأي حساب رئيسي **الأرباح والخسائر**، **المصروفات**، **الإيرادات والميزانية المسؤولية والإنصاف** أو **الأصل** نوع. إذا تضمنت علامة التبويب هذه قاعدة ذات معايير فارغة، فسيتم تمكين رقابة الموازنة في **كافة **مجموعات الأبعاد المالية التي تتضمن حسابات رئيسية من هذه الأنواع. وبالتالي، تأكد من إنشاء قواعد رقابة الموازنة التي تحدد فقط نطاقات مجموعات الأبعاد المالية حيث يكون تشغيل رقابة الموازنة أمرًا مهمًا.  

### <a name="select-main-accounts"></a>تحديد الحسابات الرئيسية

إذا لم يكن **الحساب الرئيسي** محددًا كبعد لرقابة الموازنة في صفحة **تحديد المحددات‬**، ولكن النفقات المحددة جارٍ إدارتها، فيمكنك تحديد هذه النفقات على علامة التبويب. **تحديد الحسابات الرئيسية**. أما إذا كان **الحساب الرئيسي** محددًا كبعد لرقابة الموازنة، فلا إدخالات مطلوبة.  
...
> [!Important]
> بعد تشغيل التحكم في الموازنة ونشطة، وبعد ترحيل الحركات، فإنه يجب عدم إيقاف منتصف السنة. عندما يتوقف تشغيل رقابة الموازنة، لن يتم تسجيل الأنشطة لأغراض تتعلق برقابة الموازنة وسيتوقف تنفيذ عمليات فحص الموازنة. وبالتالي، فإن المستندات التي تم ترحيلها بالفعل قد لا تعكس أي مبالغ أو أرصدة إعفاء في الاستعلامات والتقارير المتعلقة برقابة الميزانية. وتشمل هذه إحصائيات رقابة الموازنة بالنسبة للمراحل النهائية أو ضبط المستندات ودفاتر اليومية. 
...
من هذه الصفحة المستخدمين النفاذ إلى **إحصائيات التحكم في الموازنة حسب الفترة** صفحة لعرض تفاصيل توفر الميزانية وعمليات الحجز لمجموعة أبعاد عنصر تحكم محدد في ميزانية. باستطاعة المستخدمين أيضًا التنقل في صفحة **إحصاء رقابة الموازنة **لعرض توفر الموازنة لكافة مجموعات الأبعاد المالية التي يتم استخدامها في رقابة الموازنة. 
