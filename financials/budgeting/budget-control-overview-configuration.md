...
توفر هذه المقالة مقدمة إلى رقابة الموازنة وتوفر معلومات لمساعدتك في تكوين رقابة الموازنة في Microsoft Dynamics 365 for Finance and Operations, Enterprise edition لكي تتمكن من إدارة الموارد المالية.

<a name="overview"></a>نظرة عامة
--------

تدعم رقابة الموازنة في Microsoft Dynamics 365 for Finance and Operations إدارة الموارد المالية للمؤسسة من خلال مخطط الحسابات ومهام سير العمل ومجموعات المستخدمين ودفاتر اليومية والمستندات المصدر والحساب القابل للتكوين للأموال المتوفرة ودورات الموازنة والحدود. وعندما يتم وضع الضوابط، ستتمكن المؤسسة من تخطيط مواردها المالية وقياسها وإدارتها والتنبؤ بها طوال سنتها المالية. 

بعد أن تتم الموافقة على الموازنات في Finance and Operations، يمكنك استخدام خطط الموازنة لإنشاء إدخالات سجل الموازنة لتسجيل موازنة النفقات للمؤسسة. أو، يمكنك إنشاء أو استيراد إدخالات سجل الموازنة من برنامج تابع لجهة خارجية بدلاً من استخدام وظيفة تخطيط الموازنة. 
