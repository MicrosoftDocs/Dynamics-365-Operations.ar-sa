...
عندما تفهم المفاهيم والمصطلحات المستخدمة في Microsoft Dynamics 365 للعمليات، سيكون أسهل بالنسبة لك لتنفيذ تخطيط الموازنة في المؤسسة الخاصة بك.
...
-   **مهام سير عمل تخطيط الموازنة** – تشتمل مهام سير عمل تخطيط الموازنة على وتحدد مراحل تخطيط الموازنة. وترتبط مهام سير تخطيط الموازنة بمهام سير عمل إعداد الموازنة. مهام سير عمل الموازنة هي عبارة عن عمليات التلقائية واليدوية التي تنقل خطط الموازنة من خلال مراحل تخطيط الموازنة.

[![مصطلحات تخطيط الميزانية](./media/budgetplanning-terms-1024x504.png)](./media/budgetplanning-terms.png)
...
-   دمج عدة خطط موازنة من مستوى أقل للمنظمة في خطة موازنة أصلية وحيدة على مستوى أعلى في المؤسسة. يمكنك أيضًا وضع خطة موازنة واحدة على مستوى أعلى للمؤسسة وتوزيع الموازنة لمستويات أكثر انخفاضًا للمنظمة.

تخطيط الميزانية وتتكامل مع أخرى Microsoft Dynamics 365 لعمليات الوحدات النمطية. ولذلك، يمكنك إحضار المعلومات من الموازنات السابقة، والمصروفات الفعلية، والأصول الثابتة، والموارد البشرية. ولأن تخطيط الموازنة يتكامل مع Microsoft Excel وMicrosoft Word، يمكنك استخدام هذين البرنامجين للعمل مع بيانات تخطيط الموازنة. على سبيل المثال، يمكن لمدير الموازنة تصدير طلب موازنة قسم من سيناريو خطة موازنة إلى  ورقة عمل Excel. يمكن تحليل البيانات وتحديثها، وتخطيطها في ورقة العمل ثم نشرها مرة أخرى على سطور خطة الموازنة.
...
[![مخطط عام تخطيط الميزانية](./media/budgetplanninggenericschema-300x145.png)](./media/budgetplanninggenericschema.png) 

في المثال التالي، مقر الشركة تقدير مبالغ الموازنة الأولى الأساس وتوزيعها على أقسام المبيعات. وبعد ذلك، تقوم أقسام المبيعات بتقدير وإرسال التنبؤ الخاص بها مرة أخرى إلى المقر الرئيسي، حيث يقوم مدير الموازنة بتجميع وتعديل التنبؤ. وأخيراً، يرسل مدير الموازنة مبالغ الموازنة المعدلة إلى المدير المالي للمراجعة والتعديلات النهائية والموافقة. 

[![مثال مخطط تخطيط الميزانية](./media/budgetplanningexampleschema-300x145.png)](./media/budgetplanningexampleschema.png)
...
وتقوم بإنشاء عملية سير إعداد الموازنة لتخطيط الموازنة في صفحة **عمليات سير عمل إعداد الموازنة**. العملية تشبه عملية إنشاء مهام سير العمل في Microsoft Dynamics 365 للعمليات. يبين الرسم التوضيحي التالي مثالاً على عملية سير العمل في المقر الرئيسي. 

[![سير عمل الميزنة لتخطيط الميزانية](./media/budgetingworkflowforbudgetplanning-300x300.png)](./media/budgetingworkflowforbudgetplanning.png) 

سير العمل يتضمن عناصر للتخصيص لأقسام المبيعات وتجميع التقارير، مراجعتها بواسطة مدير الميزانية، وتوافق عليها كبير المدراء الماليين ومرحلة الانتقال بين كل مرحلة. 
...
-   **التوزيع عبر الفترات** – يمكنك استخدام مفتاح توزيع الفترة لتوزيع بنود خطة الموازنة من سيناريو خطة موازنة المصدر عبر الفترات في سيناريو الوجهة. **ملاحظة:** قبل توزيع عبر فترات، يجب إعداد مفاتيح توزيع الفترة في * فئات * صفحة تخصيص الفترة.
-   **التوزيع على الأبعاد** - يتم توزيع بنود خطة الموازنة من سيناريو خطة الموازنة المصدر على الأبعاد المالية في سيناريو الوجهة. **ملاحظة:** قبل توزيع للأبعاد، يجب إعداد شروط توزيع الميزانية على * * * شروط * صفحة تخصيص الموازنة.
...
### <a name="stage-allocations"></a>توزيعات المرحلة

يتم استخدام توزيعات المرحلة لتوزيع سطور خطة الموازنة تلقائيًا أثناء عملية سير العمل. وعند استخدام توزيعات المرحلة، يمكن إنشاء بنود خطة الموازنة في سيناريو الوجهة وتعديلها دون تدخل مُعِد خطة موازنة أو المراجع لإنشاء السطور.

عند إعداد توزيع المرحلة، يمكنك إقران عملية سير عمل تخطيط الموازنة ومرحلتها مع مراعاة جدول التوزيع. تخطيط سير العمل الموازنة يجب أن تقترن بسير عمل إعداد الموازنة التي تستخدم * تخطيط مرحلة التوزيع * الموازنة التلقائية مهمة سير العمل. عندما تصل عملية سير العمل إلى المرحلة المحددة، يحدث التوزيع تلقائياً. يمكن استخدام المهمة المؤتمتة هذه لإنشاء سطور خطة الموازنة في سيناريو جديد. 
...
[![مرحلة التوزيع](./media/stageallocation-204x300.png)](./media/stageallocation.png) 

بالإضافة إلى ذلك، في مخطط المثال تجميع يتم من خطط الميزانية والسيناريوهات في قسم المبيعات المرحلة الإرسال إلى خطة أصلية في مرحلة التجميع المقر الرئيسي. يبين الرسم التوضيحي التالي الجزء ذي الصلة من مثال المخطط.
...
يمكنك أيضا تعيين ما إذا كان كل عنصر التخطيط (عمود) للتحرير، وما إذا كان متوفراً في أي قالب ورقة العمل الذي تم إنشاؤه لهذا التخطيط. وفي مثال المخطط، في التخطيط الذي يُستخدم لمرحلة التقدير، تكون أعمدة التنبؤ قابلة للتحرير، بينما أعمدة مبيعات PY والعقود للقراءة فقط.
...
> [!NOTE] 
> يجب حفظ القالب إلى موقع المستخدم لديه حق الوصول إلى، ذلك أنه يمكن تحميل التخطيط عند الانتهاء من تحرير. وبهذه الطريقة، سيتم استخدام القالب مع خطط الميزانية التي تستخدم التخطيط.
