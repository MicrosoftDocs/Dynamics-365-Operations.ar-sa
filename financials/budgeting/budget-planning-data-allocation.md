...
description: "توضح هذه المقالة طرق التخصيص المختلفة المتوفرة في Microsoft Dynamics 365 للعمليات وكيفية استخدامها."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
توضح هذه المقالة طرق التخصيص المختلفة المتوفرة في Microsoft Dynamics 365 للعمليات وكيفية استخدامها.  

يمكنك توزيع البيانات في خطة موازنة عدة طرق لتصور المبالغ المتوقعة بدقة.

## <a name="allocation-methods"></a>أساليب التوزيع
ويمكن لطرق التوزيع الثلاثة (التوزيع عبر فترات، والتوزيع للأبعاد، واستخدام قواعد توزيع دفتر الأستاذ) إنشاء بنود خطة المموازنة التي تستند إلى بنود في خطة الموازنة ذاتها. ويمكن لثلاثة طرق أخرى (التجميع والتوزيع والنسخ من خطة الموازنة) إنشاء بنود خطة الموازنة في خطط الموازنة الأخرى. وبالنسبة لكافة طرق التوزيع الستة، يمكنك تحديد سيناريو الوجهة. ويمكن أن يكون سيناريو الوجهة نفس الشيء مثل السيناريو المصدر أو مختلفًا عن السيناريو المصدر. بالإضافة إلى ذلك، يمكنك تحديد ما إذا كان يتم إلحاق بنود جديدة بخطة الموازنة أو استبدال البنود الحالية في خطة الموازنة.

[![اللوكاتيكروسبيريودس](./media/allocateacrossperiods-300x259.png)](./media/allocateacrossperiods.png)<ph id="t1">
</ph>**التخصيص عبر فترات** – يستخدم فئة تخصيص فترة لتخصيص بنود خطة الميزانية من سيناريو خطة الميزانية المصدر عبر فترات في سيناريو الوجهة. ويتم تعيين المبلغ المصدر لعدة بنود في سيناريو الوجهة، استناداً إلى النسبة المئوية والتاريخ اللذين تم تحديدهما في فئة توزيع الفترة.         
...
[![بودجيتبلاننينجستاجيلوكيشنز](./media/budgetplanningstageallocations-300x300.png)](./media/budgetplanningstageallocations.png)
