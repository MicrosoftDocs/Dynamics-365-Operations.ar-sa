...
ويمكنك تنشيط رقابة الموازنة للحسابات الرئيسية من النوع **إجمالي**. ويتم اعتماد هذه الوظيفة من خلال استخدام مجموعات الموازنة. لكل حساب الرئيسي الإجمالي، يجب إنشاء الموازنة التي ينبغي مراقبتها لمجموعة موازنة على * * تكوين التحكم في الموازنة * * الصفحة. يجب أن تتضمن المعايير التي تحددها إجمالي الحساب الرئيسي ونطاق الحسابات. ولتسريع عملية إنشاء مجموعات الموازنة، يمكنك الاستفادة من وحدة بيانات مجموعات رقابة الموازنة. 
