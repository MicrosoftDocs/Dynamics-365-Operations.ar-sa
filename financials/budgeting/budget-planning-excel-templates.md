...
يمكن عرض مستندات خطة الموازنة وتحريرها باستخدام تخطيط واحد أو أكثر. يمكن أن يكون لكل تخطيط قالب مستند خطة موازنة مقترن لعرض وتحرير بيانات خطة الموازنة في ورقة عمل Excel. في هذا الموضوع، سوف يتم إنشاء قالب مستند خطة الموازنة باستخدام تكون تخطيط موجود. افتح **قائمة خطط الموازنة** (**الموازنة**&gt; **خطط الموازنة**). انقر فوق **جديد** لإنشاء مستند خطة موازنة جديد. [![bpt1](./media/bpt11-1024x552.png)](./media/bpt11.png) 
