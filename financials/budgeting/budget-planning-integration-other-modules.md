...
-   **إنشاء خطة موازنة جديدة** إنشاء خطة جديدة الذي يحتوي على السمات التي تم تحديدها في * * الهدف * * القسم. لا يلزم أن تكون هذه السمات فريدة. ولذلك، يمكن أن تشتمل خطتان نفس الاسم وقيم أخرى.
...
لكافة العمليات **مصدر** تسمح لك علامة تبويب تصفية البيانات باستخدام **عامل تصفية** الزر. بشكل افتراضي، تتم إضافة الحقول الخاصة بعامل تصفية لكل عملية. على سبيل المثال، في عملية **إنشاء خطة الموازنة من دفتر الأستاذ العام**، تتوفر فئات **حساب دفتر الأستاذ** و**الحساب الرئيسي**، وتظهر في صفحة الإنشاء. كما تتم إضافة أي حقول التي تقوم بإضافتها إلى عامل تصفية إلى الصفحة، مع أي المعايير تقوم بإضافتها.
...
وتصبح العديد من الحقول الموجودة في علامة التبويب **الهدف** قابلة للتحرير أو للقراءة فقط، وفقًا للإجراء الذي تقوم بتحديده. وعندما تقوم بالتغيير من إنشاء خطة موازنة جديدة إلى تحديث إحدى الخطط الموجودة حاليًا، يصبح حقل **اسم خطة الموازنة** غير متوفر، وتتوفر الحقول المرتبطة بتحديد خطة موجودة. على حد سواء **الهدف** علامة التبويب و * * المصدر * *، **الأستاذ** لا يتوفر الحقل دائماً، لأنه يتم تحديد القيمة بواسطة عملية تخطيط الموازنة المحددة. 
...
ويتيح لك حقل **الحد الأدنى** إمكانية تعيين مبلغ الحد لإنشاء بند خطة موازنة. وإذا كان مبلغ المصدر أقل من هذا الرقم، لا يتم إنشاء بند خطة الموازنة. قيمة **0.00** يسمح كافة المبالغ ولكن لا تحديد خطوط للمبالغ الموجبة. (خطوط للمبالغ الموجبة يحد أية قيمة. المبالغ السالبة مضمنة دائماً وعادة ما تمثل مدخلات الائتمان.)
...
لا تشمل عملية **إنشاء خطة الموازنة من الأصول الثابتة** أي خيار من للتجميع حسب الفترة أو اليوم. لا يوجد أيضا أي خيار لإعداد الخطة كالتاريخية. يمكنك استخدام هذه العملية الدورية لتضمين الحركات المتوقعة للأصول الثابتة في تخطيط الميزانية.
...
يتم تجميع البنود في خطة الميزانية حسب حساب دفتر الأستاذ والموضع. ومع ذلك، يمكنك استبعاد رقم الموضع، يتم تجميع البنود حسب حساب دفتر الأستاذ. وفي علامة التبويب **الهدف**، قم بتعيين خيار **تضمين الموضع في خطة الموازنة** إلى **لا**.
...
ولتحديد التكاليف أو الإيرادات لبنود خطة الموازنة فقط، استخدم عامل التصفية لتحديد **تحديثات الموازنة: نوع المبلغ = التكلفة**. ولتحديد نوع واحد فقط من التنبؤ، استخدم عامل التصفية لتحديد **تحديثات الموازنة: نوع الحركة = *xxx***. 
