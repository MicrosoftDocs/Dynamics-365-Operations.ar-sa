...
في Microsoft Dynamics 365 للعمليات، يمكنك استخدام أساليب متعددة لإنشاء أوامر شراء لمشروع. يتوقف الأسلوب الذي تستخدمه على غرض أمر الشراء، والوقت الذي يتم فيه استهلاك الأصناف التي تم شراؤها، والوقت الذي يتم فيه تحميل المشروع تكاليف الأصناف.
...
> [!NOTE] 
> عند تحديث فاتورة المورد أو كشف التعبئة، ستتم مطالبتك بتحديث كشف التعبئة الخاص بمتطلبات الصنف.
