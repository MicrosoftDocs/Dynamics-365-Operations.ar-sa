...
كان مشروع مجموعة من الأنشطة التي تم تصميمها لتوفير خدمة أو إنتاج منتج أو تحقيق نتيجة. المشاريع استهلاك الموارد والتوصل إلى نتائج مالية في شكل العائدات أو الموجودات.
...
في مركز الاتصال، يمكن استخدام بطاقة لوصف مجموعة الإجراءات اللازمة لحل اتصال. الشركات الاستشارية، مثل إدارة التقنية استشارة منظمات أو وكالات، الإعلان تشير إلى أنشطتهم كمشاريع. في مجال التسويق، يمثل حملة مجموعة العمل يجب أن يتم تسليم. وفي التصنيع القائم على المشاريع، يرتبط أمر إنتاج بالعمل المختلف الذي يجب تنفيذه لإنتاج بعض السلع النهائية. يتم استخدام أي اسم من الأسماء الخاصة بها، تتضمن هذه المشاريع التكاليف والجداول الزمنية والموارد، وإدارة المشاريع والمهام المحاسبية في Microsoft Dynamics 365 للعمليات يمكن أن تساعد في تخطيط وتنفيذ وتحليل لهذه المشاريع.
...
أثناء بدء تشغيل المشروع، تحدث العديد من العمليات الرئيسية. يمكنك استخدام عرض أسعار مشروع للاتصال العمالة المقدرة والمصروفات، ومواد للعميل. يمكنك تسجيل شروط وحدود واتفاقيات الفاتورة في عقد مشروع. يمكنك استخدام هيكل تنظيم عمل (WBS) لتخطيط وتقدير العمل. يمكنك إعداد التنبؤات والموازنات لتوجيه تنفيذ المشروع. يبين الرسم التوضيحي التالي بنية المشروع. [![هيكل المشروع](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
يمكنك إنشاء أنواع المشاريع الستة في Microsoft Dynamics 365 للعمليات. يتم إعداد كل نوع المشروع بطريقة مختلفة لإثبات الإيرادات والتكاليف. يعتمد نوع المشروع الذي تختاره على الغرض من هذا المشروع. يوضح الجدول التالي الاستخدام النموذجي لكل نوع مشروع.
...
| السعر الثابت       | في المشاريع ثابتة السعر، تتكون الفواتير من حركات على الحساب. فوترة مشروع ثابت سعر حسب جدول زمني فوترة استناداً إلى عقد مشروع. ويمكن حساب إيراد المشروع ثابت السعر وترحيله خلال المشروع باستخدام طريقة النسبة المئوية المكتملة. وبدلاً من ذلك، يتم حساب الإيراد وترحيله عند اكتمال المشروع، باستخدام طريقة العقد المكتمل. غالباً ما تستفيد الشركات من استخدام قيمة الأعمال تحت التنفيذ (WIP) لحساب درجة اكتمال المشروع أو مجموعة من المشاريع.                                                                                                                                     |
...
> [!NOTE] 
> لا تظهر الحركات الموجودة في مشاريع الاستثمار على **ترحيل التكاليف**، **الإيراد المستحق**، أو **إنشاء مقترحات الفاتورة** الصفحة.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | مشروع التكلفة | مثل مشاريع الاستثمار، مشاريع التكلفة تستخدم عادة لتعقب المشاريع الداخلية، فقط الساعات والمصروفات، ويتم تسجيل العناصر الخاصة بها. ومع ذلك، عادةً ما تكون مشاريع التكلفة ذات مدة أقصر من مشاريع الاستثمار. بالإضافة إلى ذلك، خلافًا لمشاريع الاستثمار، لا يمكن رسملة مشاريع التكلفة لحسابات الميزانية العمومية. بدلًا من ذلك، يتم ترحيل حركات المشروع فقط إلى حسابات الأرباح والخسائر. 
[!NOTE] 
> الحركات الموجودة في مشاريع التكلفة لا تنعكس على **ترحيل التكاليف**، **الإيراد المستحق**، أو **إنشاء مقترحات الفاتورة** الصفحة. لأن تكلفة مشاريع تستخدم عادة لتعقب المشاريع الداخلية، ليس لديهم عادة أن تكون مقترنة بحساب عميل. ومع ذلك، إذا كان الإعداد الخاص بك يتطلب إنشاء متطلبات الصنف لأوامر الشراء، عليك إقران مشروع التكلفة بعميل. ويُتطلب هذا الإقران بسبب أن متطلبات الصنف تتم إدارتها كبنود أمر المبيعات، ويتطلب النظام تحديد عميل. ومع ذلك، لن يتسبب هذا الإعداد في أن يتم إنشاء متطلبات الصنف تلقائياً من أمر شراء. في مشاريع التكلفة، يتم تجاهل إعداد **إنشاء متطلب صنف**. إذا كنت تحتاج متطلب صنف في مشروع تكلفة، يمكنك إنشاؤه يدوياً، طالما أنه هناك عميل مرتبط بالمشروع. | | الداخلية | تستخدم المشاريع الداخلية لتتبع تكاليف مشروع داخلي للمؤسسة الخاصة بك. المشاريع الداخلية يمكن أن توفر أداة لتخطيط لإدارة استهلاك الموارد. **ملاحظة:** الحركات الموجودة في المشاريع الداخلية لا تنعكس على **الإيراد المستحق** أو **إنشاء مقترحات الفاتورة** الصفحة.                                                                                                                                                                                                                                                                       | | وقت | يتم استخدام مشاريع الوقت لتعقب الوقت الذي يقترن بالأنشطة غير الخاضعة للرسوم وغير المنتجة، مثل مشروع لتعقب إجازة مرضية للعاملين. لا يتم ترحيل الحركات في مشاريع الوقت إلى دفتر الأستاذ. بدلاً من ذلك، يتم تضمينها في تقارير استخدام العامل. ويمكن فقط تسجيل حركات الساعة في مشاريع الوقت. استخدم دفتر يومية الساعات أو الجدول الزمني لتسجيل هذه الساعات للمشروع. بعد تسجيل الساعات، تظهر كحركات المشروع ولكن لم يكن لديك حركات الإيصال المقابل.

> [!NOTE] 
> الحركات الموجودة في مشاريع الوقت لا تنعكس على **ترحيل التكاليف**، **الإيراد المستحق**، أو **إنشاء مقترحات الفاتورة** الصفحة.                                                                                                                                                                                       |
...
فيما يلي بعض الطرق التي يمكنك استخدامها في جدولة وظائف الموارد:
...
هناك طريقتان لإدارة ومراقبة المشاريع: مشروع التنبؤات وميزانيات المشاريع. يمكنك استخدم التنبؤات إذا كانت مؤسستك لديها منظور تشغيلي، وتركز على الإيرادات والتكاليف المستمدة من حركات محددة. ومع ذلك، يمكنك استخدام إعداد الموازنة إذا كانت مؤسستك تركز على المبالغ المالية بشكل أكبر.
...
-   صنف مستهلك/عدم الارتباط بأمر *-ارتباط المشروع لمتطلبات صنف. وباستخدام هذه الطريقة، يُمكنك عرض تكاليف المشروع الفعلية عندما تكون حالة الإنتاج **تم البدء** أو عند الإبلاغ عنها كمنتهية. ويتم ترحيل التكلفة في صورة حركات أصناف مشروع متعددة للمواد الخام وساعات الإنتاج المستهلكة. كما يمكنك تحديد المستوى في تدرج هرمي قائمة مكونات الصنف الذي يتم فيه تتبع المشاريع في عملية الإنتاج.
...
-   في حالة الرغبة في طلب أصناف من مخزون الشركة، فإنه يجب إدخال الأمر كطلب صنف. إذا قمت باستخدام **متطلبات الأصناف** صفحة، يمكنك إعداد الطلب حيث أن يتم استلام الأصناف كعمليات تسليم جزئية. لذلك، يمكن تأجيل استهلاك كمية من الأصناف إلى أن تكون الأصناف المطلوبة.
-   لطلب أصناف من مورد خارجي، فإنه يجب عليك إنشاء هذا الأمر كأمر شراء في صفحة **أمر الشراء**.

> [!NOTE] 
> لا يمكن إلغاء كشف التعبئة لأمر توريد المتعلقة بالمشروع إذا تم تمييزها العناصر مسبقاً للتعبئة. 
...
Microsoft Dynamics 365 لعمليات لا تلقائياً تخفيض التقديرات المتوقعة. ولذلك، إنها لفكرة جيدة أن يتم الاحتفاظ بنموذج تنبؤ أصلي في مشروع سعر ثابت، لوضع أساس للمقارنة عند اكتمال المشروع. 
> [!NOTE]عند تحديد هذا الأسلوب، استخدام نماذج التنبؤ اثنين على الأقل. يجب أن يتضمن النموذج الواحد على التنبؤ الأصلي. وفي النموذج الآخر، يمكنك نسخ حركات التنبؤ من نموذج آخر. وهذه الطريقة صالحة فقط للمشاريع ثابتة السعر ومشاريع الاستثمار.</td>
> </tr>
<tr class="odd">
...
-   **تاريخ الفاتورة:** 31 مارس 2010. يتم تحديد هذا التاريخ استناداً إلى تكرار الفاتورة. على سبيل المثال، يمكنك تعيين تكرار الفاتورة للشهر الحالي. ولذلك، تتم فوترة كافة الحركات التي تم ترحيلها في شهر آذار/مارس في اليوم الأخير من الشهر.
-   **تاريخ الاستحقاق:** 14 نيسان/أبريل 2012. يتم تحديد هذا التاريخ استناداً إلى شروط الدفع التي تم تعيينها للمشروع. على سبيل المثال، يمكنك تحديد مدة الدفع إلى 14 يومًا. ولذلك، تتم إضافة 14 يومًا إلى تاريخ الفاتورة للوصول إلى تاريخ الاستحقاق 14 نيسان/أبريل 2012.
-   **تاريخ دفع المبيعات المتوقع:** 27 نيسان/أبريل 2012. يتم حساب هذا التاريخ عن طريق إضافة عدد الأيام في **أيام الاحتياطي العام** الحقل على **إدارة المشاريع ومعايير المحاسبة** الصفحة لعدد الأيام في **أيام الاحتياطي الفردية** الحقل على **عقود المشروع** الصفحة ومن ثم إضافة الإجمالي لعدد الأيام في **تاريخ الاستحقاق** الحقل. على سبيل المثال، يمكنك إدخال **3** في حقل **الأيام الاحتياطية العامة** و**10** في حقل **الأيام الاحتياطية الفردية**. ولذلك، تتم إضافة 13 يومًا إلى تاريخ استحقاق الوصول إلى تاريخ دفع المبيعات المتوقع 27 نيسان/أبريل 2012.
...
-   **تاريخ الاستحقاق:** 16 مارس 2010. يتم تعيين شروط الدفع لمدة 14 يوما.
-   **تاريخ دفع المبيعات المتوقع:** 29 مارس 2010. يتضمن الحساب ثلاثة أيام الاحتياطي العام والمخزن المؤقت كل 10 أيام.
...
> [!NOTE] 
> يستند تاريخ الاستحقاق لأمر الشراء في حركة المورد عند إنشاء أمر شراء مشروع. لا يتم تحديد تاريخ الاستحقاق حسب أي إعدادات افتراضية. 
...
> [!NOTE] 
> عند استخدام **مراقبة التكاليف** صفحة لعرض الحالة الحالية لتكاليف المشروع، واستخدام نماذج التنبؤ التي تم تحديدها للموازنة الأصلية والمتبقية. إذا قمت بتحديد نماذج التنبؤ الأخرى عند حساب التكاليف، لن تكون نتائج الحساب دقيقة.
