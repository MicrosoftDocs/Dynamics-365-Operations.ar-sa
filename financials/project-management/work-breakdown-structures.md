...
هياكل تنظيم العمل (WBS) عبارة عن وصف للعمل الذي سيتم إنجازه لمشروع. إنها تدرج هرمي للمهام التي تمثل فهم فريق المشروع لتكوين العمل، وحجم، وتكلفة، ومدة كل مكون أو مهمة. تشتمل WBS على ثلاثة أغراض رئيسية:
...
وإنشاء هيكل تنظيم الأعمال عبارة عن عملية مكثفة وعادةً ما تتم لفترة طويلة، وتتطلب التعاون والمعلومات الواردة من مجموعة متنوعة من الأشخاص. يصف هذا الموضوع كيفية استخدام تحسينات WBS في Microsoft Dynamics 365 للعمليات لتلبية متطلبات التعقب والتقديرات.
...
لاستخدام إمكانيات الجدولة كاملة الميزات WBS، إكمال الإعداد التالية:

1.  قم بإعداد تقويم مشروع وتقويم افتراضي:
    1.  انقر فوق **مشروع المحاسبة وإدارة**&gt;**الإعداد**&gt;**الجدولة**. في حقل **تقويم العمل الافتراضي** ، حدد تقويمًا افتراضيًا. سيكون هذا تقويم العمل الافتراضي لأي مشروع جديد يتم إنشاؤه.
...
2.  إعداد أيام العمل وساعات العمل القياسية. سيتم استخدام التقويم الذي تقوم بتعيينه كتقويم عمل للمشروع في هيكل تنظيم الأعمال لتحديد المعلومات التالية:

-   أيام العمل وأيام العطل
-   عدد ساعات العمل في اليوم

لإعداد أيام العمل وساعات العمل لوضع جدول زمني، أو لإنشاء تقويم جديد، انقر فوق **إدارة مؤسسة**&gt;**العامة**&gt;**تقويمات**.

### <a name="prerequisites-for-estimating-the-cost-of-work"></a>المتطلبات المسبقة لتقدير تكلفة العمل

لاستخدام إمكانيات التكلفة الكاملة في هيكل تنظيم الأعمال، يجب عليك إعداد التكاليف وأسعار المبيعات للعاملين، وفئات العمالة، والرسوم، والمصروفات، والأصناف.

-   لإعداد التكلفة وسعر المبيعات الخاص بالعمالة والمصروفات والرسوم الفئات، انقر فوق **مشروع المحاسبة وإدارة**&gt;**الإعداد**&gt;**أسعار**.
...
يشمل إنشاء هيكل تنظيم الأعمال ثلاثة أنشطة:
...
تناقش المقاطع التالية كيفية مساعدة القدرات WBS مع كل من هذه الأنشطة.

### <a name="work-decomposition"></a>تجزئة العمل

إنشاء تقسيم أو تجزئة العمل عادةً ما تكون الخطوة الأولى في عملية إنشاء WBS. يدعم وظيفة WBS البنيات الأساسية التالية لتنظيم العمل أو التحليل. 
...
> [!NOTE] 
> عند تقليل مستوى المهام ضمن مهمة تم عقده طرفية قبل العملية المسافة البادئة، يفقد المهمة الموجزة التي تم إنشاؤها حديثا التواريخ والجهد وعدد الموارد الخاصة بها. وتستخدم الآن ملخصاً للقيم المهام المكونة الجديدة. 
...
تقدير الجدولة هو عادةً الخطوة الثانية في إنشاء هيكل تنظيم الأعمال. وكممارسة مثلى، يجب إكمال تقدير الجدولة بعد إنشاء المهام. **هيكل تنظيم العمل** الصفحة في Microsoft Dynamics 365 للعملية على قسمين. ويتم استخدام الجزء العلوي بغرض تقدير الجدولة، ويتضمن الجزء السفلي علامة التبويب **التكاليف والإيرادات المقدرة** التي يمكن استخدامها لتقدير التكلفة. 
...
**مهام الجدولة في Microsoft Dynamics 365 لعمليات** جدولة المهام عقده طرفية تحدد العوامل التالية:
...
جدولة * القواعد عند مساعدة الجدولة التلقائية قيد التشغيل، يتم تطبيق القواعد التالية لجدولة المهمة للمهام عقده طرفية:
...
عدد الأشخاص × × مدة عدد الساعات في يوم العمل قياسية في تقويم المشروع. 

في بعض الحالات، قد تحتاج إلى الخروج عن هذه القواعد. يمكنك إيقاف الجدولة التلقائية لمنع Microsoft Dynamics 365 للعمليات من تعيين تلقائياً أو تصحيح أية خصائص المهام عقده طرفية. وعند إدخال معلومات لمهمة تؤدي إلى مخالفة لأيٍّ من قواعد الجدولة، يتم عرض رمز خطأ جدولة للمهمة. وإذا كنت لا تريد جدولة الأخطاء لعرضها، فانقر فوق **يتم عرض أخطاء الجدولة** لإيقاف تشغيل الميزة. 

> [!NOTE] 
> لا تزال القيم الخاصة بمهمة الموجزة أو حاوية حساب كمجموع قيم المهام المكونة، بغض النظر عن ما إذا كان تشغيل المساعدة الجدولة التلقائية أو إيقاف تشغيلها. 
...
**إصلاح كافة أخطاء جدولة** إذا أردت Microsoft Dynamics 365 عمليات إصلاح كافة أخطاء الجدولة في هيكل تنظيم العمل، في "جزء الإجراءات"، انقر فوق **إصلاح كافة تعارضات الجدولة**. 

> [!NOTE] 
> هذه الميزة يمكن أن يؤدي إدخال تعديلات هامة على هيكل تنظيم العمل. يتم تصحيح الأخطاء بالترتيب التالي:
...
> [!NOTE] 
> لا يمكنك تعديل تقدير التكلفة لمهمة التلخيص أو الحاوية. يساوي تقدير التكلفة لكل مهمة ملخص مجموع تقدير التكلفة لمهام العقدة الطرفية الخاصة بها. يتم حساب التكلفة الإجمالية المقدرة لكل مهمة كمجموع مبالغ التكلفة المقدرة لأنواع الحركات التالية:
...
تقدير التكلفة وسعر المبيعات لكل العمال أو المصروفات تعتمد على الإعداد المحددة لكل فئة في الجداول التسعير في خط **مشروع المحاسبة وإدارة**&gt;**الإعداد**&gt;**التسعير**. وبالنسبة للأصناف، تتم إضافة التكلفة وسعر المبيعات افتراضيًا من اتفاقيات التجارة أو الصنف في صفحة قائمة **المنتجات الصادرة** في إدارة معلومات المنتج.
...
يحتوي Microsoft Dynamics 365 لعمليات ثلاث طرق عرض لهيكل تنظيم العمل مشروع: عرض التخطيط وعرض تعقب جهود تعقب عرض التكلفة.
...
-   جهد المتبقية (تعرف أيضا بالتقدير إلى-التكملة \[إلخ\]) = الجهد المخطط – الجهود الفعلية للتاريخ
...
هناك طريقتان مديري المشاريع تعديل الجهد على المهام:
...
> [!NOTE] 
> عندما تقوم بمراجعة الجهد لمهمة WBS في عرض تعقب جهد لجنة مكافحة الإرهاب المهمة، ومجموعة شرق أفريقيا، تستهلك نسبة التكلفة، وتباين التكلفة المقدرة كافة إعادة حساب تكلفة تعقب عرض. ومع ذلك، لا تؤثر المراجعات في القيم الموجودة في طريقة عرض تعقب الجهد، نظراً لأنه لا تتم مراجعة التكلفة حسب نوع الحركة (العمالة أو المادة أو المصروفات) أو فئة المشروع. 
...
يستخدم Microsoft Dynamics 365 لعمليات 0:100 كسب القاعدة عندما يقوم كذلك القيمة المخططة. وعملاً بهذه المادة، يتم ترحيل قيمة المهمة إلى المهمة اعتبارًا من تاريخ انتهائها. لا يتم ترحيل أية قيمة حتى اكتمال المهمة بنسبة 100 بالمائة. 
...
يستخدم Microsoft Dynamics 365 لعمليات 0:100 كسب القاعدة عند القيمة المكتسبة لقطع الأراضي الخاصة به. وعملاً بهذه المادة، يتم ترحيل قيمة المهمة إلى المهمة اعتبارًا من تاريخ انتهائها. لا يتم ترحيل أية قيمة حتى اكتمال المهمة بنسبة 100 بالمائة. 
...
> [!NOTE] 
> في الوقت الحالي، ليس لديها نظام لتعقب WBS هياكل البيانات لتخزين نسب تقدما تاريخيا في كل مهمة. ولذلك، يمكن الإبلاغ عن القيمة المكتسبة فقط اعتبارًا من وقت معالجة المكعب. وقم بمعالجة معالجة المكعب بشكل دوري لتحديث بيانات القيمة المكتسبة التي يتم عرضها في مركز الأدوار. 
...
## <a name="wbs-templates"></a>قوالب هيكل تنظيم العمل
يمكنك استخدام وظيفة WBS القوالب لإنشاء نماذج موحدة للمشاريع. وإذا كانت المشاريع التي تقدمها شركتك تشتمل على كثير من العمل القابل للتكرار، يجب عليك مراعاة إنشاء قالب هيكل تنظيم العمل. 
