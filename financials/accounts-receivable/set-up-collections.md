...
## <a name="set-up-journal-names-settlement-writeoff-and-nsf"></a>إعداد أسماء دفاتر اليومية (التسوية وريتيوف NSF)
...
## <a name="set-up-a-reason-code-for-writeoff-transactions"></a>قم بإعداد كود سبب لحركات ريتيوف
...
## <a name="set-up-a-writeoff-account"></a>قم بإعداد حساب ريتيوف
...
> [!NOTE] 
> إذا لم يتم تحديد جهة اتصال مجموعات لأحد العملاء، يتم استخدام جهة الاتصال الأساسية للعميل. وإذا لم يتم تحديد جهة اتصال أساسية، فإنه يتم إرسال رسائل البريد الإلكتروني إلى أول عنوان تم إدراجه في صفحة **جهات الاتصال**.
