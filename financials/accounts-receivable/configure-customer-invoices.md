...
**فاتورة عميل لأمر المبيعات** هي فاتورة ترتبط بعملية بيع وتعطيها مؤسسة لعميل. ويتم إنشاء هذا النوع من فاتورة العميل استنادًا إلى أمر المبيعات، الذي يتضمن بنود الأوامر وأرقام الأصناف. ويتم تحديد أرقام الأصناف وترحيلها في دفتر الأستاذ. إدخالات دفتر اليومية في دفتر الأستاذ الفرعي غير متوفرة لفاتورة عميل لأمر توريد. 
...
ويمكنك تحديد العديد من الفواتير في صفحة قائمة **أمر المبيعات**، ثم استخدام **إنشاء الفواتير** لتجميعها. على **ترحيل الفاتورة** الصفحة، يمكنك تغيير **ملخص الأمر** الإعداد لتلخيص حسب رقم أمر (حيث يوجد كشوف تعبئة متعددة لأمر توريد واحد) أو حسب حساب الفاتورة (حيث يوجد أوامر التوريد المتعددة لحساب فاتورة واحدة). الاستخدام **ترتيب** زر توحيد أوامر التوريد في فواتير واحد، استناداً **ملخص الأمر** إعدادات.
