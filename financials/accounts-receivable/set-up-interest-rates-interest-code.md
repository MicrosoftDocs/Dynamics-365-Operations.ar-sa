...
-   **النسبة المئوية** محدداً * * * * في **حساب الفائدة على أساس** الحقل على **إعداد أكواد الفائدة** الصفحة.

على سبيل المثال، قم بإعداد كود فائدة تقييم الفائدة 5 في المائة لكل شهرين أن يتجاوز دفع فاتورة الحركة تاريخ الاستحقاق، ستقوم بإدخال 2 في **حساب الفائدة كل** الحقل وحدد **شهر**.
...
-   ويمكن إدخال حدود مبلغ الفائدة الاختيارية.
-   * * المبلغ * * محدداً في **حساب الفائدة على أساس** حقل على **إعداد أكواد الفائدة** الصفحة.

على سبيل المثال، قم بإعداد كود فائدة تقييم الفائدة 25.00 لكل 20 يوما أن يتجاوز دفع فاتورة الحركة تاريخ الاستحقاق، ستقوم بإدخال 20 في **حساب الفائدة كل** الحقل وحدد **اليوم**.
