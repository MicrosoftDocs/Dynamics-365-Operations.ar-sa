---
title: "تسوية تلقائية وتحديد الأولويات"
...
# <a name="automatic-settlement-and-prioritization"></a>تسوية تلقائية وتحديد الأولويات
...
لديك خياران عند تسوية المدفوعات بالفواتير وحركات أخرى. يمكنك يدوياً تحديد الحركات للتسوية، أو Microsoft Dynamics 365 لعمليات تحديد الحركات تلقائياً باستخدام وظيفة التسوية التلقائية. ويمكنك أيضًا تخصيص طريقة معالجة التسويات التلقائية باستخدام خيار **إعطاء الأولوية للتسوية**. هذه الخيارات هي جزء من تسوية المعلمات التي تم تعريفها على **محددات الحسابات المدينة** الصفحة. يمكن أن تختلف طريقة تسوية الحركات تلقائيًا، اعتمادًا على الطريقة التي تستخدمها للتسوية التلقائية. تتوفر الطرق التالية:
...
| إشعار الفائدة | 15 أكتوبر  | 7.00   |                     |                    | يتم إشعار الفائدة للفاتورة 1 و 2 من الفاتورة. ويحسب المبلغ كفائدة 2 في المائة على المبالغ يوم 30 أو أكثر بعد الاستحقاق. على سبيل المثال، 0.02 × (100.00 + 250.00) = 7.00. |

## <a name="userdefined-settlement-priority"></a>أولوية التسوية Userdefined
