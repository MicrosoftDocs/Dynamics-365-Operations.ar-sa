...
إدارة حسابات المدينة مجموعات المعلومات العرض المركزية واحد باستخدام Microsoft Dynamics 365 "مجموعات عمليات" الصفحة. بإمكان مدراء الائتمانات والتحصيلات استخدام طريقة العرض المركزية هذه لإدارة التحصيلات. وبإمكان وكلاء التحصيلات بدء عملية التحصيل من قوائم العملاء التي يتم إنشاؤها باستخدام معايير التحصيل المعرفة مسبقًا أو من صفحة العملاء.
...
بشكل افتراضي، عرض Microsoft Dynamics 365 للمستخدمين العمليات كافة معلومات العملاء على مجموعات صفحات القوائم. ويمكنك استخدام سجلات وكلاء التحصيلات لتحديد أوعية العملاء المتوفرة لتصفية المعلومات في صفحات قوائم التحصيلات وفي صفحة التحصيلات. 

وكيل التحصيلات هو شخص يعمل مع العملاء للتأكد من أنه يتم جمع المدفوعات في الوقت مناسب. في Microsoft Dynamics 365 للعمليات، هي عوامل مجموعات العمال الذين تم تعيينهم للمستخدمين في صفحة الإعداد المستخدم.
...
<li>بشكل افتراضي، Microsoft Dynamics 365 لعمليات مستخدم لديه حق الوصول إلى كافة العملاء الذين لديهم شيخوخة لقطة.</li>
...
يعرض الجزء العلوي حالات للعميل المحدد. يعرض الجزء الأوسط الحركات الخاصة بالعميل. يعرض الجزء السفلي أنشطة للعميل. ويمكنك إنشاء حالات التحصيلات لتعقب معلومات التحصيلات لواحد أو أكثر من الحركات والأنشطة. ويمكن تصفية المعلومات الواردة في الجزئين العلوي والسفلي حسب الحالة. 
...
## <a name="create-writeoff-transactions"></a>إنشاء حركات ريتيوف
...
يتم إنشاء حركة الشطب بعملة الحركة.
 معالجة دفعات الأرصدة غير الكافية (NSF)  
--------------------------------------------
