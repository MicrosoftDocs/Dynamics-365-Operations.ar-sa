...
**ملاحظة:** في الإصدارات السابقة، كانت تعرف تأخيرات المحسوب ك *رسائل العمليات الآجلة*، كان يعرف التاريخ المتأخر *تاريخ العمليات الآجلة*، وحركة مؤجل كان يشار *حركة التي تم تعيين المستقبلية*.
