...
## <a name="example-2-transactions--reduction-key-forecast-reduction-principle"></a>مثال 2: مفتاح خفض حركات التنبؤ قاعدة التخفيض
...
## <a name="example-3-transactions--dynamic-period-forecast-reduction-principle"></a>مثال 3: فترة حيوية حركات التنبؤ قاعدة التخفيض
