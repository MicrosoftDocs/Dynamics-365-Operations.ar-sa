---
title: "التخطيط لتغطية الموقع والمستودع، ليس إلزامياً المستودع الرئيسي"
...
# <a name="master-planning-for-site-and-warehouse-coverage-warehouse-not-mandatory"></a>التخطيط لتغطية الموقع والمستودع، ليس إلزامياً المستودع الرئيسي
...
-   تم تعيين المستودع إلى يدوي. انقر فوق **إدارة مخزون &gt;الإعداد &gt;تصنيف المخزون &gt;مستودعات**. وفي علامة التبويب السريع **التخطيط الرئيسي**، راجع حقل **الدليل**.
