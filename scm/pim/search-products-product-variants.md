...
في بعض الأحيان، تواجه أيضا الكثير من شيء ليس الوضع أفضل في، وهذا ينطبق بشكل خاص إذا قمت ببيع عدد من المنتجات المشابهة وتحاول تذكر أرقام الأصناف أو أسماء المنتجات البحث للعثور على المنتج المناسب بوضع أمر توريد. يمكنك استخدام **رقم الصنف** الحقل في بند أمر توريد أو بند أمر شراء كحقل بحث. يمكنك إدخال أي جزء من اسم المنتج أو الرقم أو البُعد والحصول على بحث يعرض كافة الأصناف التي تطابق كلمة البحث.
...
تستخدم الأمثلة التالية المنتجات ومتغيرات المنتجات لتوضيح كيفية التعامل مع البحث في سيناريوهات متعددة. **شرط أساسي:** تحت **المبيعات والتسويق &gt;الإعداد &gt;البحث &gt;معلمات البحث**&gt;**نوع البحث**، حدد **التطابق الكامل** الخيار.
...
يمكنك تحديد عدد نتائج البحث باستخدام **عدد النتائج** الحقل على **المبيعات والتسويق &gt;الإعداد &gt;البحث &gt;معلمات البحث** الصفحة. إذا قمت بتعيين هذا الحقل إلى 0، يتم إرجاع كافة نتائج البحث. إذا قمت بتعيينه إلى 10، على سبيل المثال، فسيُرجع 10 نتائج بحث كحد أقصى.

## <a name="configure-the-product-search"></a>تكوين البحث عن المنتج
قبل استخدام ميزة البحث عن المنتجات ومتغيرات المنتجات، اتبع هذه الخطوات لتكوين البحث عن المنتج. [![ثلاث خطوات لتكوين البحث عن المنتج\_أكسابفال](./media/3-steps-to-configure-product-search_axappfall.png)](./media/3-steps-to-configure-product-search_axappfall.png)
...
اذهب إلى **المبيعات والتسويق &gt;الإعداد &gt;البحث &gt;معايير البحث** الصفحة. تسمح لك صفحة **معايير البحث** بتعريف المعايير الخاصة بالعملاء والعملاء المتوقعين والبحث عن المنتج. تأكد من تصفية الصفحة باستخدام معايير البحث عن المنتج. يمكنك القيام بذلك عن طريق التبديل إلى **المنتج** في قائمة الصفحة.  

لإضافة رقم المنتج عرض معايير البحث، انقر فوق **جديد** في قائمة الصفحة. سيقوم هذا بإضافة سجل جديد في **معايير البحث** الشبكة. افتح عمود البحث **اسم الحقل** واختر **DisplayProductNumber**. لإضافة تكوين المنتج إلى معايير البحث، قم بإنشاء سجل جديد في * * معايير البحث * * الشبكة واختار **كونفيجيد** في **اسم الحقل** عمود. بطريقة ماثلة، قم بإنشاء سجل مع **اسم الحقل** **InventColorId** لبُعد اللون و**InventSizeId** لبُعد الحجم و**InventStyleId** لبُعد النمط.
...
في صفحة **معايير البحث**، انقر فوق الزر **تحديث بيانات البحث**. في مربع الحوار **تحديث بيانات البحث**، تأكد من تعيين **المصدر** إلى **المنتج**، ثم انقر فوق **موافق**. تجميع النظام في جدول واحد كافة معايير البحث المحددة المحدد في الخطوة 1. إذا كان لديك كثير من المنتجات ومتغيرات المنتج، يمكن أن تكون هذه العملية تستغرق وقتاً طويلاً وقد تتلقى رسالة تحذير. نوصي بأن تقوم بجدولة تعبئة جدول البحث على خادم الدُفعة‬ عندما لا يكون الخادم كثير الانشغالات.  
...
يمكنك تمكين هذه الوظيفة عن طريق الانتقال إلى **المبيعات والتسويق &gt;الإعداد &gt;البحث &gt;معلمات البحث** والإعداد **تمكين البحث للبحث** إلى **نعم** على **عام** علامة التبويب.  
