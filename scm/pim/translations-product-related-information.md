---
title: "ترجمة الأسئلة المتداولة المتعلقة بالمنتج"
...
# <a name="product-related-translations-faq"></a>ترجمة الأسئلة المتداولة المتعلقة بالمنتج
...
## <a name="how-do-i-create-translations-for-productrelated-information"></a>كيف يمكنني إنشاء ترجمات للمعلومات برودوكتريلاتيد؟
لإنشاء ترجمات للمنتج، اتبع الخطوات التالية:
1.  انقر فوق **إدارة معلومات المنتج**&gt;**العامة**&gt;**المنتجات التي تم إصدارها**.
2.  تحديد منتج، وفي "جزء الإجراءات"، في **لغات** المجموعة، انقر فوق **ترجمات**.
3.  في صفحة **ترجمة النص**، في حقل **اللغة**، حدد لغة. لإضافة المزيد من اللغات، قم بتوسيع **لغة** حقل ومن ثم انقر فوق **موافق**.
...
4.  في صفحة **ترجمة النص**، في حقل **اللغة**، حدد لغة. لإضافة المزيد من اللغات، قم بتوسيع **لغة** حقل ومن ثم انقر فوق **موافق**.
...
5.  في صفحة **ترجمة النص**، في حقل **اللغة**، حدد لغة. لإضافة المزيد من اللغات، قم بتوسيع **لغة** حقل ومن ثم انقر فوق **موافق**.
6.  في **النص المترجم** المجموعة، قم بإدخال الترجمة في **اسم** و **وصف** الحقول.
...
اسم متغير منتج يستند إلى البعد تقدر الصغيرة والأحمر **\#3:Small:Red**.  

يريد عميل شراء بعض القمصان الصغيرة والحمراء بالإضافة إلى ضرورة إظهار اسم القميص باللغة الفرنسية على الفاتورة. ترجمة قيم الأبعاد، صغيرة وأحمر، إلى اللغة الفرنسية، واسم متغير المنتج **\#3: بوتي: الحمر**.
<table>
<colgroup>
<col width="100%" />
</colgroup>
...
<ol>  
<li>انقر فوق <strong>المبيعات والتسويق</strong>&gt;<strong>العامة</strong>&gt;<strong>العملاء</strong>&gt;<strong>كافة</strong> <strong>العملاء</strong>.</li>
...
3.  انقر فوق **جديد**، ثم قم بإدخال اسم للمجموعة في **حجم****مجموعة**، **مجموعة اللون**، أو **مجموعة النمط** الحقل. انقر فوق **الأحجام** أو **الألوان** أو  **الأنماط** لإنشاء بنود للمجموعات.
4.  في **حجم****مجموعة** خطوط، **اللون****مجموعة****خطوط**، أو **نمط بنود مجموعة** الصفحة، انقر فوق **جديد**، ثم إنشاء أحجام وألوان الأنماط للمجموعات.
...
2.  انقر فوق **ترجمة النص**. في **ترجمة النص** الصفحة في **النص المترجم** المجموعة، قم بإدخال الترجمة في **اسم** و **وصف** الحقول.

## <a name="when-can-translations-of-productrelated-information-be-managed"></a>عند يمكن إدارة ترجمة المعلومات برودوكتريلاتيد؟
