---
title: "قم بإعداد نموذج تكوين المنتج"
...
# <a name="set-up-a-product-configuration-model"></a>قم بإعداد نموذج تكوين المنتج

توضح هذه المقالة الخطوات اللازمة لإعداد نموذج تكوين المنتج وإنشائه.

| المهمة                                                        | ‏‏الوصف                                                                                                                                                                                                                                                                                                                                                                                        |
|-------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| إنشاء أصل منتج.                                    | قم بإنشاء أصل منتج من قائمة **أصل المنتج**. إصدار المنتج الرئيسي لكافة الشركات ذات الصلة. لأصل منتج الذي يتم استخدامه كنسخة لنموذج تكوين منتج أو كمكون فرعي، **المستندة إلى قيد التكوين** يجب تحديد كما يجب تحديد تقنية التكوين وبعد التكوين فقط لمجموعة أبعاد المنتج. |
