...
تتضمن معلومات قائمة مكونات الصنف المُستخدمة في حساب قائمة مكونات الصنف للتكلفة القياسية المعلومات التالية:
-   إصدار قائمة مكونات الصنف - إصدار قائمة مكونات الصنف الذي تم تعيينه للصنف المصنع له تواريخ سريان من وإلى، وحالة معتمد ونشط. يمكن أن يكون إصدار الكمبيالة شاملاً للشركة أو خاصًا بموقع معين، ويمكن أن يعكس اختياريًا نقاط توقف الكمية.
-   كمية صنف بند قائمة مكونات الصنف - عادةً ما تكون للمكون كمية متغيرة مطلوبة، ولكنها يمكن أن تكون ثابتة. وعادةً ما يتم استخدام كمية المكون لإنتاج صنف رئيسي واحد، ولكن ربما يتم استخدامها لكل 100 أو لكل 1000 لكي تعالج إصدارات للدقة العشرية. ويمكن حساب كمية المكون أيضًا بناءً على القياسات.
-   خردة صنف بند قائمة مكونات الصنف - يمكن أن تكون للمكون كمية متغيرة أو ثابتة للخردة المخططة.
-   التواريخ الصالحة لصنف بند قائمة مكونات الصنف - يمكن أن تكون للمكون صلاحية تواريخ من وإلى.
-   نوع صنف قائمة مكونات الإنتاج - سيعكس حجم لوط التكلفة لاستهلاك التكاليف الثابتة كمية حساب قائمة مكونات الصنف وحالة عملية تحديد إجمالي المكونات المطلوبة لتقديم طلب، بسبب أن حساب قائمة مكونات الصنف يفترض أنه سيتم إنتاج المكون المصنع للكمية الفعلية بدلاً من كمية الأمر القياسي.
...
-   تجاوز معلومات مورد العمليات في عمليات المسار - سيتم اكتساب معلومات المورد حول فئات التكلفة بواسطة العمليات، حيث يمكن أن يتم تجاوزها. ستستخدم حسابات قائمة مكونات الصنف معلومات فئة التكلفة المُحددة في عمليات المسار.
...
تتضمن معلومات المسار المُستخدمة في حساب قائمة مكونات الصنف للتكلفة القياسية المعلومات التالية:
...
-   فئات التكلفة لعملية المسار - يتم اكتساب معلومات مور العمليات حول فئات التكلفة بواسطة العمليات، حيث يمكن أن يتم تجاوزها. ستستخدم حسابات قائمة مكونات الصنف معلومات فئة التكلفة المحددة في عمليات المسار.

تتضمن معلومات المصروفات العامة للتصنيع المُستخدمة في حساب قائمة مكونات الصنف للتكلفة القياسية المعلومات التالية:
...
تتضمن معلومات إصدار التكلفة المُستخدمة في حساب قائمة مكونات الصنف للتكلفة القياسية المعلومات التالية:
-   نوع التكلفة - يجب أن يتضمن إصدار التكلفة التكاليف القياسية. يتم تطبيق العديد من القيود على حسابات قائمة مكونات الصنف التي تستخدم التكاليف القياسية. على سبيل المثال، تحدد القيود المصاريف المتنوعة التي يجب تضمينها في تكاليف الوحدة ويجب أن يكون حالة تحديد المكونات المطلوبة لحساب قائمة مكونات الصنف في مستوى واحد.
...
-   علامة حظر للتكاليف المعلقة - يمكن لعلامة الحظر منع حسابات قائمة مكونات الصنف للتكلفة المعلقة الخاصة بالأصناف المصنعة.
-   المُحدد من تاريخ - سيعمل المحدد من تاريخ كتاريخ حساب افتراضي لكافة حسابات قائمة مكونات الصنف المضمنة في إصدار التكلفة.
-   الموقع المُحدد - سيقوم الموقع المحدد بحصر حسابات قائمة مكونات الصنف في موقع واحد.
...
يمكن تحديد العديد من مصادر المعلومات عند بدء حساب قائمة مكونات الصنف. ويتضمن هذا الموقع، وتاريخ الحساب، وإصدار التكلفة.
