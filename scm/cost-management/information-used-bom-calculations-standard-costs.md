---
title: "حسابات شجرة المواد مع التكاليف المعيارية"
description: 
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
...
# <a name="bom-calculations-with-standard-costs"></a>حسابات شجرة المواد مع التكاليف المعيارية



تتضمن معلومات الصنف الذي تم شراؤه والمُستخدمة في حساب شجرة المواد للتكاليف القياسية المعلومات التالية:
-   التكلفة - يتم الاحتفاظ بتكاليف الصنف الذي تم شراؤه كسجلات تكلفة خاصة بالموقع داخل إصدار تكلفة للتكاليف القياسية. ولكل سجل تكلفة تاريخ سريان خاص به، حيث يحدد تاريخ حساب شجرة المواد أي سجل تكلفة سيتم استخدامه. على سبيل المثال، ربما يستخدم حساب شجرة المواد مع تاريخ الحساب المستقبلي سجل تكلفة بالحالة معلق وتاريخ سريان مستقبليًا.
...
تتضمن معلومات الصنف المصنع المُستخدمة في حساب شجرة المواد للتكلفة القياسية المعلومات التالية:
-   كمية أمر التوريد القياسية للمخزون - تعمل كمية أمر التوريد القياسية للصنف للمخزون كحجم لوط للحساب الافتراضي لاستهلاك التكاليف الثابتة في حساب شجرة المواد. سيعكس أيضًا حجم لوط الحساب كمية أمر التوريد المتعددة إذا تم تحديده.
-   شروط التحذير المضمنة في مجموعة حساب قائم مكونات الصنف تعمل على تمكين حساب قائمة مكونات الصنف لتحديد المشكلات المحتملة. قد يكون مثال واحد صنف مصنع لا يشتمل على قائمة مكونات الصنف أو مسار. يمكن تجاوز شروط التحذير القابلة للتطبيق عند بدء حساب شجرة المواد.
...
-   نوع صنف شجرة مواد الإنتاج - سيعكس حجم لوط التكلفة لاستهلاك التكاليف الثابتة كمية حساب شجرة المواد وحالة عملية تحديد إجمالي المكونات المطلوبة لتقديم طلب، بسبب أن حساب قائمة مكونات الصنف يفترض أنه سيتم إنتاج المكون المصنع للكمية الفعلية بدلاً من كمية الأمر القياسي.
-   شجرة المواد الفرعية للمكون المصنّع - يمكن أن يكون للمكون المصنع إصدار شجرة مواد محدد اختياريًا، حيث سيتم استخدامه بدلاً من إصدار شجرة المواد النشط الحالي في حساب شجرة المواد.
-   المسار الفرعي للمكون المصنع - يمكن أن يكون للمكون المصنع إصدار مسار محدد اختياريًا، والذي سيتم استخدامه بدلاً من إصدار المسار النشط الحالي في حساب شجرة المواد.
...
-   تجاهل صنف بند شجرة مواد في حسابات التكلفة - يمكن أن يتم تجاهل المكون لأغراض حساب شجرة المواد.

تتضمن معلومات مورد العمليات المُستخدمة في حساب شجرة المواد للتكلفة القياسية المعلومات التالية:
