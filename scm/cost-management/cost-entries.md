...
يتم تسجيل حدث دفتر يومية نقل. نقل الحدث قطعة واحدة من البند ألف من موقع 1 إلى الموقع 2. بعد مخزون الموقع يعتبر جزءا من كائن التكلفة. ولذلك، يُنشئ الحدث حركتي مخزون وإدخالي تكلفة.
...
تتيح صفحة **إدخالات التكلفة** التصفية حسب معرف المستند وتاريخ المستند. **ملاحظة:** تكلفة الإدخالات تكون متوفرة فقط من أجل [تكلفة الكائنات](cost-object.md) أو المنتجات التي تم إصدارها.
