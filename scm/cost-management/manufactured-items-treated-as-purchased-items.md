---
title: "إعداد المنتجات التي يمكن إنتاجها أو شراؤها"
description: "يمكن توريد المنتجات بطرق مختلفة-يمكن إنتاجها (المصنع) أو مدبر (المشتري). توضح هذه المقالة بعض النقاط النموذجية التي يجب أخذها في الاعتبار عند تكوين المنتجات لدعم استخدام مصادر متعددة."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>إعداد المنتجات التي يمكن إنتاجها أو شراؤها

يمكن توريد المنتجات بطرق مختلفة-يمكن إنتاجها (المصنع) أو مدبر (المشتري). توضح هذه المقالة بعض النقاط النموذجية التي يجب أخذها في الاعتبار عند تكوين المنتجات لدعم استخدام مصادر متعددة. 
