...
## <a name="orderspecific-bom-calculations"></a>حسابات قائمة مكونات الصنف الخاصة بالأمر
يمثل حساب قائمة مكونات الصنف الخاصة بالأمر شكلاً من أشكال حساب قائمة مكونات الصنف لصنف تم تصنيعه. يتم تنفيذ حساب قائمة مكونات الصنف في سياق أمر مبيعات أو عرض أسعار مبيعات أو بند أمر خدمة. ينشئ حساب قائمة مكونات الصنف الخاصة بالأمر سجل حساب يظهر في صفحة **نتائج حساب قائمة مكونات الصنف**. ويتضمن سجل الحساب وزنًا محسوبًا وتكلفة محسوبة تستند إلى سجلات تكلفة نشطة بالإضافة إلى سعر مبيعات محسوب. يتم بشكل فريد تعريف سجل عملية الحساب الذي تقوم كل عملية حساب قائمة مكونات الصنف الخاصة بالأمر بإنشائه في صفحة **نتائج حساب قائمة مكونات** بواسطة رقم عملية حساب. ويمكن تحويل نتائج سجل الحساب بشكلٍ اختياري إلى البند الأصلي. يختلف حساب قائمة مكونات الصنف الخاصة بالأمر عن حساب قائمة مكونات الصنف لصنف مصنّع من ناحيتين:
