---
title: "مجموعات حسابات شجرة المواد"
...
# <a name="bom-calculations-groups"></a>مجموعات حسابات شجرة المواد

توفر هذه المقالة معلومات حول مجموعات الحساب لقائمة مكونات الصنف وكيفية إعدادها. لتشغيل حساب قائمة مكونات الصنف، يجب إما إعداد مجموعات الحساب وتعيينها إلى أصناف فردية، أو تعيين مجموعة حساب افتراضية. ويتم عندئذٍ استخدام إعدادات الحساب من مجموعة الحساب كقيم افتراضية في صفحة حساب قائمة مكونات الصنف عند حساب قائمة مكونات الصنف. 

يجب أن تتوفر مجموعة حساب افتراضية في صفحة **محددات إدارة المستودعات والمخزون‬**، أو مجموعة حساب خاصة بالمنتجات في صفحة **تفاصيل المنتجات الصادرة**. النظام أولاً بالبحث عن إعداد مجموعة الحساب **ونشرت تفاصيل المنتج** الصفحة. إذا لم يعثر هناك مجموعة حساب، يظهر على **معلمات إدارة المخزون والمستودعات** الصفحة. يتعذر على النظام العثور مجموعة حساب، يتلقى المستخدم رسالة إعلام بخطأ أثناء الحساب. تحتوي مجموعة حساب على سياسات لنموذج سعر التكلفة ونموذج سعر المبيعات وقائمة اختيار التحذيرات. ويتم استخدام إعدادات الحساب من مجموعة الحساب كقيم افتراضية في صفحة **حساب قائمة مكونات الصنف** عند حساب قائمة مكونات الصنف.
