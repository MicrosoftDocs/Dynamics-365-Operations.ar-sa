...
يوفر نظام إدارة المستودعات في Microsoft Dynamics 365 for Operations طرقًا مرنة لتحديد تخطيط مستودعك لتلبية الاحتياجات المتغيرة، بحيث يمكنك تحقيق الكفاءة المثلى للمستودع.
...
لاستخدام إدارة المستودع في Microsoft Dynamics 365 for Operations، يجب عليك إنشاء مستودع وتمكينه لأنشطة إدارة المستودع الأكثر تقدمًا أو تخصصًا. في صفحة **المستودعات**، حدد خيار **استخدام عمليات إدارة المستودع**.
...
يتم استخدام الكيانات التي تقوم بإنشائها لتعريف تخطيط المستودع الخاص بك في الاستعلامات التي قمت بتعيينها في قوالب العمل لتشغيل أوامر العمل في المستودع. ولذلك، عند تحديد المناطق، وأنواع المواقع، وغيرها، راع مدى استخدام المناطق المختلفة في المستودع لعمليات مختلفة. بالإضافة إلى ذلك، ضع في الاعتبار عوامل من قبيل الخصائص المادية لمنطقة معينة. على سبيل المثال، قد يكون هناك مناطق حيث يمكنك استخدام نوع معين فقط من شاحنة الرافعة الشوكية. أو، إذا كان لدى شركتك في كل من الإنتاج والسلع التامة الصنع في نفس المرفق، قد تحتاج إلى إنشاء مستودع واحد في ديناميات 365 للعمليات ولكن ثم فصل العمليتين بإنشاء مجموعتين من المنطقة. منح الكيانات أسماء وصفية، حيث أنه من السهل التعرف عليها عند استخدامها في الاستعلامات القالب.
...
وضع مخزون موقع حدود المساعدة في ضمان أن العمل لم يتم إنشاء لطلب هذا المخزون في موقع الذي لا يملك القدرة المادية للمخزون. على سبيل المثال، إذا كان يمكن أن تعقد بعض المواقع داخل مستودع بآلته واحدة فقط كل موقع، يمكن تمكين موقع تخزين حدود. * * الكمية * * يمكن تعيين قيمة **1**، و * * وحدة * * يمكن تعيين قيمة **رر** داخل تجميع ملف تعريف موقع محدد. 
...
لإنشاء مواقع داخل مستودع بسرعة، يمكنك استخدام * * إعداد موقع * * المعالج. وكجزء من هذه العملية، يمكنك بسهولة الاحتفاظ بتنسيق أسماء المواقع.
...
[تكوين المواقع في مستودع تمكين WMS (إرشادات المهمة)](https://ax.help.dynamics.com/en/wiki/configure-locations-in-a-wms-enabled-warehousing/)
