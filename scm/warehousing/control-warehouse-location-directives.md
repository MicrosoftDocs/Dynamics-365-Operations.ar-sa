---
title: "العمل مستودع التحكم باستخدام قوالب العمل والتوجيهات المتعلقة بالموقع"
...
# <a name="control-warehouse-work-by-using-work-templates-and-location-directives"></a>العمل مستودع التحكم باستخدام قوالب العمل والتوجيهات المتعلقة بالموقع
...
ويمكنك تعيين استعلام للتحكم عند استخدام قالب عمل معين. على سبيل المثال، يمكنك تعيين قيد حتى يمكن استخدام قالب معين للعمل في مستودع معين فقط. وبدلاً من ذلك، قد يكون لديك العديد من القوالب التي يتم استخدامها لإنشاء عمل لأمر المبيعات الصادرة، استناداً إلى أصل المبيعات. يستخدم النظام **رقم التسلسل** حقل لتحديد الترتيب الذي يتم تقييم القوالب العمل المتوفرة في. ولذلك، إذا كان لديك استعلام محدد جداً لقالب عمل معين، يجب تقديم رقم تسلسل منخفض. وبعد ذلك، يتم تقييم هذا الاستعلام قبل استعلامات عامة أخرى كثيرة. 
...
تتضمن توجيهات الموقع مستوى إضافي واحد للتفاصيل: *إجراءات توجيهات الموقع*. ويمكنك تحديد العديد من إجراءات توجيه الموقع لكل بند. مرة أخرى، يتم استخدام رقم تسلسل لتحديد الترتيب الذي يتم تقييم الإجراءات في. على هذا المستوى، يمكن إعداد استعلام لتحديد كيفية العثور على أفضل موقع في المستودع. ويمكنك أيضًا استخدام إعدادات **الاستراتيجية **المحددة مسبقًا للعثور على موقع أمثل.
