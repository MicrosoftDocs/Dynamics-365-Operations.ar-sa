...
-   **&lt;control name&gt;** – اسم عنصر التحكم (على سبيل المثال، زر) الذي يتم تقديمه في HTML.
-   **(&lt;key name&gt;)** – اسم مفتاح لوحة المفاتيح التي تقوم بإنشاء الاختصار له.
-   **&lt;Key code&gt;** – كود الحرف الرقمي للمفتاح المراد استخدامه كمفتاح اختصار.
...
-   **&lt;user host address&gt;** – تعبير NET. العادي الذي يطابق عنوان IP للطالب.
-   **&lt;user host name&gt;** – تعبير NET. العادي الذي يطابق اسم شبكة الطالب.
-   **&lt;user agent&gt;** – تعبير NET. العادي الذي يطابق معرف المستعرض الذي يستخدمه الطالب.
