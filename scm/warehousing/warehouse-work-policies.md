...
تتحكم سياسة العمل هذه في إنشاء عمل المستودع لعمليات المستودع في التصنيع. ويمكنك إعداد سياسة العمل باستخدام مجموعة تتكون من **أنواع أوامر العمل** و**موقع المخزون** و**منتج**. على سبيل المثال، المنتجات L0101 يتم الإعلام عن الانتهاء إلى موقع إخراج 001. يستهلك البضائع الجاهزة فيما بعد آخر أمر الإنتاج في موقع الإخراج 001. في هذه الحالة، يمكنك إعداد نهج عمل لمنع إنشاء عند الإبلاغ المنتج L0101 انتهائها إلى موقع إخراج 001 العمل للسلع التامة الصنع وضع بعيداً. تُعد سياسة العمل كيانًا فرديًا يمكن وصفه من خلال المعلومات التالية:
