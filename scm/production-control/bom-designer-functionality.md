...
<li>عند تعيين القاعدة <strong>المحددة/نشطة أو المحددة</strong>، يمكنك تحديد إصدار شجرة المواد أو إصدار المسار بالنقر فوق <strong>شجرة</strong>&gt;<strong>إصدارات شجرة المواد</strong> أو <strong>المسار</strong>&gt;<strong>إصدارات المسار</strong>.</li>
</ul></td>
</tr>
<tr class="even">
<td>تاريخ الإصدار</td>
...
عند استخدام مصمم قائمة مكونات الصنف لمراجعة قائمة مكونات الصنف التي تتألف من واحد أو أكثر من مستويات الأصناف الوهمية، يمتد المسار المرتبط بالصنف الأعلى عادةً ليشمل التسلسل الهرمي لقائمة مكونات الصنف بالكامل. لتبسيط النظرة العامة، يمكنك تأمين المسار الأعلى مستوى في العرض عن طريق النقر فوق **طريقة عرض**&gt;**تأمين المسار**. لإلغاء تأمين التوجيه، انقر فوق **طريقة عرض**&gt;**فتح المسار**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>إضافة وتحرير قوائم مكونات الصنف وبنودها
الاستخدام * * بنود شجرة المواد * * أو **شجرة** وظائف لتعديل بنود شجرة المواد أو شجرة المواد. وعندما تحدد عقده في الشجرة، يحدد نوع العقدة الوظائف المتوفرة.
...
| بنود قائمة مكونات الصنف &gt;إضافة قبل السطر      | افتح مربع حوار حيث يمكنك تحديد منتج متغير لتضمينه قبل بند قائمة مكونات الصنف المحدد.         | تتوفر هذه الوظيفة عند تحديد عقده بند قائمة مكونات الصنف.                                                                                                                                                                                                                                   |
| بنود قائمة مكونات الصنف &gt;إضافة إلى عنصر شجرة المواد | افتح مربع حوار حيث يمكنك تحديد منتج متغير لتضمينه في نهاية قبل بند قائمة مكونات الصنف المحدد.       | تتوفر هذه الوظيفة عندما تشتمل العقده المحددة على قائمة مكونات صنف محددة. أما إذا لم تتوفر هذه الوظيفة، قد يكون إصدار قائمة مكونات الصنف مفقودًا لمتغير الصنف المحدد. في هذه الحالة، يمكنك النقر فوق **شجرة**&gt;**إنشاء إصدار** لإنشاء الإصدار المفقود للعقدة المحددة. |
| بنود قائمة مكونات الصنف &gt;إضافة بعد سطر       | افتح مربع حوار حيث يمكنك تحديد منتج متغير لتضمينه بعد بند قائمة مكونات الصنف المحدد.          | تتوفر هذه الوظيفة عند تحديد عقده بند قائمة مكونات الصنف.                                                                                                                                                                                                                                   |
| شجرة &gt;إنشاء الإصدار             | قم بإنشاء إصدار قائمة مكونات صنف أو قائمة مكونات صنف جديدة لمتغير المنتج الخاص يالعقدة المحددة.                             | تتوفر هذه الوظيفة عند ربط عقدة بند قائمة مكونات الصنف الذي تم تحديده لأي صنف يحتوي على نوع الإنتاج **قائمة مكونات الصنف** أو **المعادلة**.                                                                                                                                                  |
| شجرة &gt;الحساب                | افتح مربع حوار حيث يمكنك حساب التكلفة أو سعر المبيعات لمتغير المنتج المحدد. | تتوفر هذه الوظيفة عندما ترتبط العقدة المحددة بإصدار قائمة مكونات صنف.                                                                                                                                                                                                         |
| شجرة &gt;التحقق                      | تحقق من صحة وافحص قائمة مكونات الصنف المحددة.                                                                      | تتوفر هذه الوظيفة عندما ترتبط العقدة المحددة بإصدار قائمة مكونات صنف.                                                                                                                                                                                                         |
