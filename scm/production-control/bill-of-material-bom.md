...
description: "توفر هذه المقالة معلومات حول شجرة المواد (Bom) والصيغ، التي هي جزء أساسي من تعريف متغيرات المنتجات والمنتجات. شجرة المواد وصيغ تحديد المواد المطلوبة أو المكونات لمنتج معين. تحديد صيغ أيضا المنتجات المساعدة والمنتجات الثانوية التي ترد في سياق إنتاج معينة."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
توفر هذه المقالة معلومات حول شجرة المواد (Bom) والصيغ، التي هي جزء أساسي من تعريف متغيرات المنتجات والمنتجات. شجرة المواد وصيغ تحديد المواد المطلوبة أو المكونات لمنتج معين. تحديد صيغ أيضا المنتجات المساعدة والمنتجات الثانوية التي ترد في سياق إنتاج معينة. 
...
قائمة مكونات الصنف هو كيان فردية المذكورة بالمعلومات التالية:
...
المعادلة هي نوع فرعي من قائمة مكونات الصنف يتم استخدامه غالبًا لعملية التصنيع. وبالإضافة إلى المكونات والعناصر، توضح المعادلة المنتجات المساعدة والمنتجات الثانوية. في الإصدار الفعلي، يتطلب تعريف المنتجات المساعدة والمنتجات الثانوية للصيغة إصدار الصيغة. يتم عادة تعريف صيغة واحدة محددة المنتج النهائي (الصيغة أو عنصر التخطيط) التي تم تعريفها في إصدار الصيغة.
...
تعتمد أنواع شجرة المواد التي تستخدم فعلا في تطبيق على التنفيذ وعلى سيناريوهات العمل ومتطلباتها. وفي تطبيقات البسيطة، يمكن تصميم قائمة مكونات صنف التخطيط وقائمة مكونات صنف الإنتاج وقائمة مكونات صنف التكاليف كقائمة مكونات صنف واحدة. والبيئات التي تحتوي على تغييرات هندسية متكررة والعديد من الطرق البديلة، من المحتمل أن يُتطلب وجود مجموعة كبيرة من أنواع قائمة مكونات الصنف.
...
لتعيين قائمة مكونات صنف أو معادلة معينة كإصدار افتراضي لقائمة مكونات الصنف أو المعادلة الذي يتم استخدامه من قِبل التخطيط الرئيسي أو لإنشاء أوامر الإنتاج، يجب عليك تنشيط الإصدار. عندما يتم تنشيط نسخة، يتم التحقق من الطابع الفريد للإصدار لقيود معينة (على سبيل المثال، فترة أو الموقع أو الكمية). تتلقى رسالة إعلام بخطأ إذا كان الإصدار الذي تحاول تنشيط يتعارض مع إصدار الذي نشط بالفعل. ويجب عليك بعد ذلك إلغاء تنشيط الإصدار المتعارض أو تعديل قيود الإصدار (عادةً ما تكون الفترة) لمنع التنشيط الملتبس.
