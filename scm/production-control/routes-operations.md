...
تُعد العملية بمثابة خطوة في مرحلة الإنتاج. في Finance and Operations، تتميز كل عملية بمعرف ووصف بسيط. تظهر الجداول التالية أمثلة نموذجية عن عمليات من متجر أجهزة.
