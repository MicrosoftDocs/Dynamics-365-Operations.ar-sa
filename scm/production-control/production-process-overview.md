---
title: "نظرة عامة حول عملية الإنتاج"
description: "يقدم هذا المقال نظرة عامة حول عمليات الإنتاج. فهو يصف المراحل المتعددة لأوامر الإنتاج والأوامر الدفعية كانبان، من إنشاء الأمر لإقفال الفترة المالية."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="production-process-overview"></a>نظرة عامة حول عملية الإنتاج

يقدم هذا المقال نظرة عامة حول عمليات الإنتاج. فهو يصف المراحل المتعددة لأوامر الإنتاج والأوامر الدفعية كانبان، من إنشاء الأمر لإقفال الفترة المالية. 
...
**مراقبة الإنتاج** الوحدة النمطية مرتبطة بالوحدات النمطية الأخرى، مثل **إدارة معلومات المنتج**، **إدارة مخزون**، **دفتر الأستاذ العام**، **إدارة المستودعات**، **محاسبة المشروع**، و **إدارة مؤسسة**. ويدعم هذا التكامل تدفق المعلومات المطلوبة لاكتمال تصنيع الصنف المنتهي.  

وتتأثر عملية الإنتاج بشكل عام بطرق محاسبة التكاليف وتقييم المخزون التي يتم اختيارها لعملية إنتاج معينة. Dynamics 365 لعمليات تدعم كلا من التكلفة الفعلية (أولاً، أولاً خارج \[FIFO\]؛ وآخر، يصرف أولاً \[LIFO\]؛ معدل النقل؛ والمتوسط المرجح الدورية) وأساليب إلى التكلفة المعيارية. وتُنفذ Lean manufacturing استناداً إلى مبدأ تحديد تكاليف الإصدار التلقائي.  
...
تتطلب طبولوجيات الإنتاج والمنتجات المختلفة استخدام أنواع الأوامر المختلفة. ديناميكيات 365 لعمليات تطبيق مختلف أنواع أمر في وضع مختلط. وبعبارة أخرى، تحدث جميع أنواع الأوامر أثناء العملية الشاملة لإنتاج منتج نهائي واحد.
...
2.  **مقدرة‬** – يمكنك حساب تقديرات استهلاك المواد والموارد. يُنشئ التقدير حركات المخزون للمواد الخام التي لها حالة **تحت الطلب**. يتم إنشاء عمليات الاستلام للمنتجات الرئيسية والمنتجات المساعدة والمنتجات الثانوية عند أوامر الإنتاج أو يتم تقدير الأوامر الدفعية. إذا كانت شجرة المواد تحتوي على أسطر **العرض المرتبط** كتابة أوامر الشراء للمواد أو إنشاء خدمات عملية التعاقد من الباطن ومرتبطة بأمر الإنتاج أو أمر المجموعة. ويتم حجز الأصناف أو الأوامر وفقًا لاستراتيجية الحجز لأمر الإنتاج، ويتم حساب سعر السلع المنتهية بناءً على إعدادات المعلمة.
...
4.  **تم الإصدار** - يمكنك إصدار أمر الإنتاج أو أمر الدُفعة عند انتهاء الجدولة وتوفر المواد ليتم التقاطها أو إعدادها. ويساعد التحقق من توفر المواد المشرف في صالة الغنتاج على تقييم توافر المواد لأوامر الإنتاج أو أوامر الدُفعة. ويمكن أيضًا طباعة مستندات أمر الإنتاج، مثل قوائم الانتقاء، وبطاقة الوظيفة، وبطاقة المسار، ووظيفة المسار. وعند إصدار أمر الإنتاج، تتغير حالة الأمر لكي تشير إلى إمكانية بدء عملية الإنتاج. عند استخدام إدارة المستودع، يؤدي إصدار أمر الإنتاج أو أمر الدُفعة إلى إصدار بنود قائمة مكونات الصنف لإدارة المستودع. ويتم فيما بعد إنشاء موجات المستودع وعمل المستودع وفقًا لإعداد المستودع.
5.  **تحضير**/**منتقاة** – عندما تم تجهيز جميع المواد والموارد في موقع الإنتاج، بنود شجرة مواد الإنتاج أو يتم تحديث البنود كانبان حالة **منتقاة**. ويتم عادةً إكمال أوامر التوريد مثبتة السعر وعمل المستودع ذي الصلة في هذه المرحلة. يجب تعيين وطباعة بطاقات كانبان أو بطاقات الوظيفة المطلوبة للإبلاغ عن مستوى تقدم الإنتاج.
