...
توفر هذه المقالة نظرة عامة على عمليات الإنتاج.‬ وهي تصف مختلف مراحل أوامر الإنتاج والأوامر الدفعية وكانبان، اعتبارًا من عملية إنشاء الأمر وصولاً إلى إقفال الفترة المالية. 
...
وتتأثر عملية الإنتاج بشكل عام بطرق محاسبة التكاليف وتقييم المخزون التي يتم اختيارها لعملية إنتاج معينة. ويدعم Dynamics 365 for Operations طريقتي التكلفة الفعلية (ما يرد أولاً يصرف أولاً \[FIFO\]، وما يرد أخيرًا يصرف أولاً‬ \[LIFO\]، ومتوسط تكلفة النقل، والمتوسط المرجح الدوري) والتكلفة المعيارية. وتُنفذ Lean manufacturing استناداً إلى مبدأ تحديد تكاليف الإصدار التلقائي.  
...
تتطلب طبولوجيات الإنتاج والمنتجات المختلفة استخدام أنواع الأوامر المختلفة. ويمكن لنظام Dynamics 365 for Operations استخدام أنواع أوامر مختلفة في الوضع المختلط. وبعبارة أخرى، تحدث جميع أنواع الأوامر أثناء العملية الشاملة لإنتاج منتج نهائي واحد.
...
[نماذج تكوين المنتجات](../pim/product-configuration-models.md)
