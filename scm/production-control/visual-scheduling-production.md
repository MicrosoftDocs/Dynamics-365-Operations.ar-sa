...
في شبكة من الأنشطة، مثل الوظائف التي تنتمي إلى أمر الإنتاج نفسه، يمكنك استخدام وظيفة **جدولة الوظائف السابقة** لجدولة الوظائف السابقة المتعلقة بوظيفة محددة على الشبكة. في المثال التالي، النشاط المميز هو الوظيفة المحددة.
...
يمكنك استخدام وظيفة **جدولة الوظائف التالية** لجدولة الوظائف التالية المتعلقة بوظيفة محددة في شبكة من الأنشطة. في المثال التالي، النشاط المميز هو الوظيفة المحددة.
...
يمكنك استخدام وظيفة **جدولة حول الوظيفة** لجدولة الوظيفة التالية والوظيفة السابقة المتعلقة بوظيفة محددة في شبكة من الأنشطة. في المثال التالي، النشاط المميز هو الوظيفة المحددة.
...
يمكنك استخدام الوظيفة **ترتيب** لتنظيم أنشطة محددة على المورد نفسه. بإمكان هذه الأنشطة أن تكون في شبكة الأنشطة نفسها، ولكن بإمكانها أيضًا أن تنتمي إلى شبكات مختلفة. عندما تستخدم وظيفة الترتيب، ستُزال الفجوات الزمنية بين الأنشطة المحددة. يمكنك استخدام هذه الوظيفة لتحسين استخدام قدرة الموارد.
...
| **الصفحة**                                                                                     | **الوصف**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **قائمة أمر الإنتاج والتفاصيل**                                                         | في صفحة **قائمة أمر الإنتاج والتفاصيل**، يمكنك فتح مخطط جانت من واحد أو أكثر من الأوامر المحددة. يؤدي فتح المخطط من عنصر قائمة **مخطط جانت** إلى تحميل كافة الوظائف المرتبطة بأوامر الإنتاج المحددة، وأيضًا الوظائف من أوامر الإنتاج الأخرى المجدولة في الموارد نفسها. يؤدي فتح المخطط من عنصر قائمة **مخطط جانت – عرض سريع** إلى تحميل فقط الوظائف المرتبطة بأوامر الإنتاج المحددة. في طريقة العرض هذه، من غير الممكن جدولة المهام. |
| **المورد**                                                                                 | في صفحة **الموارد**، يمكنك فتح مخطط جانت من عنصر القائمة **"مخطط جانت"**. عند تحديد عنصر القائمة هذا، سيتم تحميل كافة الوظائف المجدولة إلى المخطط في فترة زمنية محددة.                                                                                                                                                                                                                                                                                                   |
| **مجموعة الموارد**                                                                           | في صفحة **مجموعة الموارد**، يمكنك فتح مخطط جانت من عنصر القائمة **"مخطط جانت"**. عند تحديد عنصر القائمة هذا، ستظهر كافة الوظائف المجدولة على الموارد في مجموعة الموارد في فترة زمنية محددة.                                                                                                                                                                                                                                                                                    |
| **مخططات جانت**                                                                             | في صفحة **مخططات جانت**، يمكنك تكوين مخططات جانت حسب الموارد ومجموعات الموارد. على سبيل المثال، إذا كنت تريد التحكم في أنشطة الإنتاج لمجموعات موارد محددة، يمكنك عندئذٍ إنشاء تكوينات فردية لتلك الموارد في صفحة **مخططات جانت**. يمكنك عندئذٍ فتح مخطط جانت من كل تكوين.                                                                                                                                                    |
| **التنبؤات بالساعات‬** (المشروع)                                                                 | يمكن جدولة وظائف أنشطة المشروع من النوع **التنبؤ بالساعات‬** على الموارد. في صفحة **التنبؤ بالساعات** في قائمة **الجدولة**، يمكنك فتح مخطط جانت على أمر للاطلاع على أنشطة المشروع المجدولة الوظائف من نوع التنبؤ بالساعات.                                                                                                                                                                                                                                                             |
| **الوظيفة لإكمالها** (قائمة في مساحة العمل **إدارة طابق الإنتاج‬**)                      | تُظهر مساحة عمل **قائمة الوظائف لإكمالها في إدارة طابق الإنتاج‬** الوظائف من أوامر الإنتاج والأوامر الدفعية قيد التقدم على الموارد المحددة في مساحة العمل. في عنصر قائمة **مخطط جانت**، يمكنك فتح مخطط جانت، حيث سيتم تحميل كافة الوظائف التي تم تحديدها في القائمة إلى المخطط.                                                                                                                                                                                |
