---
title: "دعم لوحة التحويل كانبان للماسحات الضوئية الرمز الشريطي"
description: "تدعم لوحة تحويل كانبان‬ إدخال الماسح الضوئي من ماسح ضوئي للكود الشريطية لعنصر واجهة مستخدم لتحديد وظيفة كانبان وبدء تنفيها وإكمالها وإفراغها."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="kanban-transfer-board-support-for-barcode-scanners"></a>دعم لوحة التحويل كانبان للماسحات الضوئية الرمز الشريطي

تدعم لوحة تحويل كانبان‬ إدخال الماسح الضوئي من ماسح ضوئي للكود الشريطية لعنصر واجهة مستخدم لتحديد وظيفة كانبان وبدء تنفيها وإكمالها وإفراغها.
...
عند استخدام قارئ رمز الشريطي لتحديد مهمة وضع عرض التغييرات لوحة كانبان. في هذا الوضع، يتم تطبيق الشروط التالية:
...
-   يمكنك تحديث المعلومات الموجودة في القائمة المهام يدوياً بالنقر فوق **تحديث** (Shift + F5) في "جزء الإجراءات". وبعد تحديث المعلومات، يتم عرض النتائج الكاملة لعامل تصفية الوظائف مرة أخرى.
