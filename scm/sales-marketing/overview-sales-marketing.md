...
# <a name="sales-and-marketing"></a>المبيعات والتسويق
...
تستهدف الحملة جهات الاتصال الخاصة بالعملاء المتوقعين والعملاء المحتملين وفرص المبيعات والعملاء الذين تم اختيارهم للمشاركة في الحملة. في Microsoft Dynamics 365 للعمليات، يمكنك إنشاء أنواع متعددة من الحملات، مثل حملات البريد الإلكتروني، تحقيق أقصى قدر من العملاء المحتملين ومراسلات التسويق الهاتفي. ومع التقدم الحاصل في حملتك وتلقي ردود إيجابية، يمكنك بدء عملية المبيعات مع المستلمين الذين أبدوا ردود فعل إيجابية على الحملة.
...
يُعد البيع التكميلي والبيع الإضافي من الأساليب المتبعة لبيع المنتجات عند إدخال أمر مبيعات لأحد العملاء. في البيع الإضافي، يتم اقتراح منتج آخر بدلاً من المنتج الحالي. أما في البيع التكميلي، فيتم اقتراح منتج بالإضافة إلى المنتج الحالي. عند إعداد قوائم المنتجات، يمكنك إنشاء قواعد معينة للإشارة إلى عندما اقترح منتج كمنتج عبر بيع أو بيع ما يصل.
