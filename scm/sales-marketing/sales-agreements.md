...
في بعض الحالات حيث يتم إنشاء أوامر المبيعات بطريقة غير مباشرة، مثل عند إنشاء إشعار دائن أو أوامر المبيعات بين الشركات الشقيقة، يمكنك التحكم في ما إذا كان Microsoft Dynamics 365 for Operations يبحث تلقائياً عن اتفاقيات البيع القابلة للتطبيق.
