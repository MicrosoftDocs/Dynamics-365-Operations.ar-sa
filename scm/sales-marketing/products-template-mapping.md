...
-   تأكد من أن **الأرقام العشرية المعتمدة** لوحدة القياس تتطابق مع متطلباتك في **CDS-\> الوجهة**. إذا احتجت إلى قيم مختلفة لكل وحدة قياس، فيمكن إجراء ذلك من خلال **ValueMap** من الوحدة، على سبيل المثال، [كل واحد: 0] & [رطل: 2].

    -   قيمة القالب هي بشكل افتراضي 0.
