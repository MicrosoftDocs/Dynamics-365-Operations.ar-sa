...
تم تعيين الموعد النهائي لإدخال الأمر في أيام الثلاثاء إلى 16:00. وفي يوم ثلاثاء معين، في الساعة 17:00، تحاول تعيين التاريخ الحالي كتاريخ للشحن. (لاحظ أن هناك عدم وجود مهلة زمنية على سبيل المثال). إذا كان **التحكم في تاريخ التسليم** خانة الاختيار، تتلقى تحذير تنص على أن التاريخ غير صحيح. ويظهر هذا التحذير في صفحة **تواريخ الشحن والاستلام المتاحة**، حيث يمكنك تحديد تواريخ بديلة.
...
| يوم من الأسبوع             | ج: ترتيب المواعيد النهائية لإدخال (PST) | ب: ترتيب المواعيد النهائية لإدخال (EST) |
|-----------------------------|--------------------------------|--------------------------------|
| الاثنين                      | 13:00                          | 00:14                          |
...
| مواقع PST أ:         | موقع MST أ:        | الموقع المقدر ب:           | موقع MST ب:        |
|---------------------|--------------------|-----------------------|--------------------|
