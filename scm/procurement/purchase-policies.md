...
# <a name="purchasing-policies"></a>نُهُج الشراء
...
إعداد سياسات الشراء حسب الكيان القانوني المنظمات الصغيرة وأقل تعقيداً، واستخدام فقط الشركات التدرج الهرمي للمؤسسات.  
...
وتُنشئ شركة الاتحاد للتصنيع سياستي شراء. تطبيق نهج أ كيان قانوني في الولايات المتحدة، 1111. تطبيق نهج ب كيانه القانوني الكندي، 2222. عندما يقوم موظف في الكيان القانوني 1111 طلب شراء، قواعد السياسة مستمدة من نهج أ. على سبيل المثال، كتالوج المنتجات الذي يراه الموظف المحدد في قاعدة سياسة كتالوج لنهج أ.  

عندما يقوم موظف في الكيان القانوني 2222 طلب شراء، قواعد السياسة مستمدة من نهج "ب".  
...
قاعدة التحكم في طلب الشراء هي قاعدة اختيارية. عند قيامك بإنشاء قواعد من هذا النوع، يمكنك تعيين الخيارات في علامات التبويب المتعددة:

-   في علامة التبويب **تقديم سير العمل**، يمكنك تكوين الحقول التي يجب إدخالها في بند طلب للطلب المُراد تقديمه للموافقة عليه، عنما يكون الغرض من الطلب هو **استهلاك**.
...
شراء ترتيب الإنشاء والطلب التوحيد تعرف القاعدة قواعد السياسة استخدامه عند إنشاء أمر شراء من طلب شراء معتمد. عند قيامك بإنشاء قواعد من هذا النوع، يمكنك تعيين الخيارات في علامات التبويب المتعددة:
...
-   في علامة التبويب **تفاوت السعر‬**، يمكنك تحديد طلبات الشراء المعتمدة للخلف عبر عملية المراجعة عندما يزيد سعر صنف في كتالوج تدبير. وقم بتعيين الحد الأقصى الذي يمكن أن يصل إليه المبلغ الصافي لصنف البند في طلب الشراء بين وقت الموافقة على طلب الشراء ووقت إنشاء أمر الشراء. يتم حساب المبلغ الصافي باستخدام الصيغة التالية: (\[الكمية × (سعر الوحدة – الخصم) وحدة السعر ÷\] + مصاريف الشراء المتنوعة) عقد (100 – نسبة الخصم) × ÷ 100 بنود طلب الشراء التي تتجاوز تفاوت السعر التي قمت بتعيينها من أجل المعالجة اليدوية. تحدد القواعد التي تقوم بتكوينها في علامة التبويب **معالجة الأخطاء** الكيفية التي تتم بها معالجة بنود طلب الشراء.
