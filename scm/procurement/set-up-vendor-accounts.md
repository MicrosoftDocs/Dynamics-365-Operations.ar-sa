...
# <a name="set-up-vendor-accounts"></a>قم بإعداد حسابات المورد
...
لتسريع عملية إنشاء حسابات المورّدين، يمكنك إنشاء قوالب. لإنشاء قالب، على **المورد** صفحة، في "جزء الإجراءات"، انقر فوق **خيارات**&gt;**معلومات التسجيل**. ثم انقر فوق **قالب حسابات الشركة**. تتم مشاركة قوالب حسابات الشركة مع مستخدمين آخرين.  
...
لإضافة جهات الاتصال لمورد، على **كافة الموردين** الصفحة، ومن **المورد** علامة التبويب، في **إعداد** المجموعة، انقر فوق **جهات الاتصال**&gt;**إضافة جهات اتصال**.  
...
يمكنك إضافة جهات اتصال المورد إلى جهات الاتصال الشخصية الخاصة بك في Microsoft Office 365. ومع ذلك، يجب أولاً إعداد المزامنة بين 365 ديناميات عمليات و Office 365 في كل مزامنة Microsoft Exchange Server ومعالج إعداد Microsoft Outlook.
