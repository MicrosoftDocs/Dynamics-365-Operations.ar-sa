...
-   حدد أي المنتجات التي تريد أن يتمكن الموظفين طلبها. يمكنك إظهار أو إخفاء منتجات محددة في عقده كتالوج، أو يمكنك إظهار أو إخفاء كافة المنتجات في عقده.
...
ويحدد الكتالوج المنتجات التي تتوفر عند إنشاء طلبات الشراء، ولكن يمكنك استخدام قواعد سياسات الوصول إلى الفئات لتطبيق قيود إضافية. ونظراً لأن العقدات في كتالوج عبارة عن فئات التدبير، يمكن منعها بواسطة قاعدة سياسة الوصول إلى فئة. في هذه الحالة، المنتجات في هذه الفئة غير متوفرة للموظفين باستخدام طلبات. تعريف قواعد سياسة الوصول للفئة على **سياسات الشراء** الصفحة. يصف الجدول التالي المهام التي يجب إكمالها لإعداد كتالوج.
...
[إعداد تدرج هرمي لفئات تدبير (إرشادات المهمة)](http://ax.help.dynamics.com/en/wiki/set-up-a-procurement-category-hierarchy/)
