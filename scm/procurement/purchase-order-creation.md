...
بعد الانتهاء من إضافة الرأس والبنود إلى أمر الشراء، يجب غالبًا إكمال خطوات إضافية قبل أن يصبح الأمر جاهزًا للتأكيد. نظرًا لتوفر الكثير من الخيارات، قد تجد أنه من المفيد استخدام [إجراء البحث](/dynamics365/unified-operations/fin-and-ops/get-started/action-search) للبحث عن عنصر القائمة ذي الصلة.  
