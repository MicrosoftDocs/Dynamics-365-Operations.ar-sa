...
على الرغم من أنه يمكنك إنشاء أوامر الشراء يدوًيا، إلا أنها تنشأ عادةً من عمليات أخرى. يمكن إنشاء الأوامر تلقائيًا استنادًا إلى مستندات أخرى، كالطلبات مثلاً. بدلاً من ذلك، يمكنك إنشاء كجزء من التخطيط العملية من خلال نقاط البيع المخطط الرئيسي. إذا كنت تستخدم اتفاقات الشراء، يمكن إنشاء نقطة البيع **إصدار أمر** الإجراء. هناك أيضًا أساليب أكثر تقدمًا لإنشاء أمر الشراء بشكل تلقائي. على سبيل المثال، يمكنك إنشاء الأوامر عندما تستخدم التسليم المباشر أو سلاسل الأوامر بين الشركات الشقيقة.
...
بعد الانتهاء من إضافة الرأس والبنود إلى أمر الشراء، يجب غالبًا إكمال خطوات إضافية قبل أن يصبح الأمر جاهزًا للتأكيد. نظرًا لتوفر الكثير من الخيارات، قد تجد أنه من المفيد استخدام [إجراء البحث](/dynamics365/operations/action-search) للبحث عن عنصر القائمة ذي الصلة.  
