...
-   **قائمة الأعمال المركزية**، يمكن للمستخدمين عرض قائمة أعمال مركزية لعرض مهام سير العمل واعتمادات معينة لها عبر مشاركتها في كافة مهام سير العمل. يكون هذا متوفراً في الصفحة عناصر العمل.
...
لإنشاء سير عمل، انتقل إلى التدبير وتحديد الموارد &gt;الإعداد &gt;التدبير وتحديد الموارد مهام سير العمل وإنشاء سير عمل جديد عن طريق تحديد نوع سير العمل الذي تريد إنشاءه.  
