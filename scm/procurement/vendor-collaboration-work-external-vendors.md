...
<tr class="odd">
<td>المورد <strong>يقبل الأمر بالتغييرات</strong>. ويتم اقتراح تغييرات على مستوى خط. من الممكن قبول أو رفض بنود فردية. وتشمل التغييرات الأخرى المحتملة:
<ul>
...
<td>يتم تسجيل استجابة المورد ك <strong>تم القبول مع تغييرات</strong>، <strong></strong>وتبقى حالة أمر الشراء <strong>"في الاستعراض الخارجي"</strong>.</td>
</tr>
</tbody>
</table>

يمكنك استخدام **أمر الشراء****إعداد** مساحة العمل لمراقبة نقاط البيع التي استجابت للمورد. تحتوي مساحة العمل هذه على قائمتين تحتوي على أوامر الشراء بحالة **"في الاستعراض الخارجي"**:
...
يصف هذا القسم الحالات المختلفة التي قد يمر بها أمر الشراء وصولاً إلى وقت تأكيده، كما يصف المرحلة التي ستكون فيها الإصدارات الجديدة من أمر الشراء متوفرة للمورد. هناك اختلافات في هذا الصدد، اعتماداً على ما إذا كنت تستخدم إدارة التغيير لأوامر الشراء. 
