...
يمكن استخدام أوامر إدخال مخزن الفحص لحظر المخزون. على سبيل المثال، قد تحتاج لعزل العناصر لأسباب تتعلق بالجودة. يتم تحويل المخزون تم الحجر الصحي إلى مستودع فحص. **ملاحظة:** إذا كنت تستخدم عمليات إدارة المستودعات المتقدمة (في إدارة المستودعات)، فإن معالجة أوامر إدخال مخزن الفحص تُستخدم فقط لأوامر المبيعات المرتجعة.

## <a name="quarantine-onhand-inventory-items"></a>الفحص onhand أصناف المخزون
...
عند إنهاء أمر إدخال مخزن الفحص، يتم نقل الصنف من مستودع الفحص مرة أخرى إلى المستودع العادي. ويتم تعيين حالة حركة الصنف إلى **مباع** في مستودع العزل و**مشترى** في المستودع العادي.

## <a name="quarantine-order-scrap"></a>خردة أمر العزل
