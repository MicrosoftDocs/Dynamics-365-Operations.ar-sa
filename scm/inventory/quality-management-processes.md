...
تصف حالة عدم المطابقة صنفًا به مشكلة في الجودة.** **وتسمح لك عملية عدم المطابقة بإنشاء أمر عدم مطابقة يصف كمية من المواد غير المتطابقة، ومصدر المشكلة، ونوع المشكلة، والمذكرات التفسيرية. ويمكنك تحديد تصنيف لأنواع المشاكل لتيسير عملية تحليل المواد غير المتوافقة. ويمكنك أيضًا طباعة علامة عدم توافق وتقرير عدم توافق لتحديد ترتيب المواد غير المتوافقة. على سبيل المثال، قد تشير العلامة والتقرير إلى شرط **غير قابل للاستخدام** أو **الاستخدام المقيد**. يسرد الجدول التالي أنواع عدم التوافق الافتراضية الستة ويصف المعلومات التي يجب تسجيلها لكل نوع.
...
[أوامر إدخال مخزن الفحص](quarantine-orders.md)

[إعداد أوامر الجودة (دليل المهام)](http://ax.help.dynamics.com/en/wiki/set-up-quality-orders/)
